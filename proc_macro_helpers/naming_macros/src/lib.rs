...
pub fn generate_upper_camel_and_snake_case_stringified_and_token_stream_from_naming_constants(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .map(|element| {
        ...
        let phrase_part_upper_camel_case_token_stream = {
            phrase_part_upper_camel_case_stringified.parse::<proc_macro2::TokenStream>()
        ...
        let phrase_part_snake_case_token_stream = {
            phrase_part_snake_case_stringified.parse::<proc_macro2::TokenStream>()
        ...
        let generate_display_implementation_token_stream = |
            struct_name_token_stream: &proc_macro2::TokenStream,
            write_content_token_stream: &proc_macro2::TokenStream,
        |quote::quote!{
        ...
        let upper_camel_case_display_implementation_token_stream = generate_display_implementation_token_stream(
            &phrase_part_upper_camel_case_upper_camel_case_token_stream,
            &phrase_part_upper_camel_case_quotes_token_stream
        );
        let snake_case_display_implementation_token_stream = generate_display_implementation_token_stream(
            &phrase_part_snake_case_upper_camel_case_token_stream,
            &phrase_part_snake_case_quotes_token_stream
        );
        let generate_to_tokens_implementation_token_stream = |
            struct_name_token_stream: &proc_macro2::TokenStream,
            quote_content_token_stream: &proc_macro2::TokenStream,
        |quote::quote!{
        ...
        let upper_camel_case_to_tokens_implementation_token_stream = generate_to_tokens_implementation_token_stream(
            &phrase_part_upper_camel_case_upper_camel_case_token_stream,
            &phrase_part_upper_camel_case_token_stream
        );
        let snake_to_tokens_implementation_token_stream = generate_to_tokens_implementation_token_stream(
            &phrase_part_snake_case_upper_camel_case_token_stream,
...
pub fn generate_self_upper_camel_and_snake_case_stringified_and_token_stream_from_naming_constants(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .map(|element| {
        ...
        let (
            ...
            let generate_pub_trait_declaration_token_stream = |
            ...
            let upper_camel_case_stringified_trait_declaration_upper_camel_case_token_stream = generate_pub_trait_declaration_token_stream(
                &upper_camel_case_stringified_trait_name_upper_camel_case_token_stream,
                &upper_camel_case_stringified_trait_function_name_snake_case_token_stream,
                &std_string_string
            );
            let snake_case_stringified_trait_declaration_upper_camel_case_token_stream = generate_pub_trait_declaration_token_stream(
                &snake_case_stringified_trait_name_upper_camel_case_token_stream,
                &snake_case_stringified_trait_function_name_snake_case_token_stream,
                &std_string_string
            );
            let upper_camel_case_token_stream_trait_declaration_upper_camel_case_token_stream = generate_pub_trait_declaration_token_stream(
                &upper_camel_case_token_stream_trait_name_upper_camel_case_token_stream,
                &upper_camel_case_token_stream_trait_function_name_snake_case_token_stream,
                &proc_macro2_token_stream
            );
            let snake_case_token_stream_trait_declaration_upper_camel_case_token_stream = generate_pub_trait_declaration_token_stream(
                &snake_case_token_stream_trait_name_upper_camel_case_token_stream,
                &snake_case_token_stream_trait_function_name_snake_case_token_stream,
                &proc_macro2_token_stream
            );
