...
use naming::{
    ...
    BodyBytesSc, BodySc, BySc, CheckBodySizeSc, CheckBodySizeUcc, CodeOccurenceSc, ColumnSc,
    ColumnsSc, CommitSc, CommonAdditionalErrorVariantsSc, CommonAdditionalLogicSc,
    CommonReadOnlyIdsReturnedFromCreateOneSc, ConfigSc, CreateExtensionIfNotExistsPgJsonschemaUcc,
    CreateExtensionIfNotExistsUuidOsspUcc, CreateIntoPostgresJsonTypeOptionVecWhereLengthEqualSc,
    CreateIntoPostgresJsonTypeOptionVecWhereLengthGreaterThanSc,
    CreateIntoPostgresTypeOptionVecWhereDimensionOneEqualSc, CreateManyAdditionalErrorVariantsSc,
    ...
    GenColumnQuealsValueCommaUpdateOneQueryPartSc, GenPostgresTablePrimaryKeySc,
    ...
    OrderSc, PaginationSc, ParametersSc, PayloadSc, PayloadUcc, PoolConnectionSc, PoolSc,
    PostgresCrudSc, PostgresPoolForTokioSpawnSyncMoveSc, PostgresPoolSc, PostgresSc,
    PostgresTypeOptionVecWhereGreaterThanTestSc, PostgresTypeUcc, PostgresUcc, PrefixSc,
    PrepareExtensionsSc, PreparePostgresSc, PreparePostgresTableSc, PreparePostgresUcc,
    PrimaryKeyQueryPartSc, PrimaryKeySc, QueryBindSc, QueryPartErrorNamedUcc, QueryPartSc,
    QueryPartUcc, QuerySc, QueryStringSc, ReadIntoTableTypeDeclarationSc,
    ReadManyAdditionalErrorVariantsSc, ReadManyAdditionalLogicSc, ReadOneAdditionalErrorVariantsSc,
    ReadOneAdditionalLogicSc, ReadOnlyIdsIntoReadSc, ReadOnlyIdsIntoTableTypeDeclarationSc,
    ReadOnlyIdsIntoUpdateSc, ReadOnlyIdsMergedWithCreateIntoOptionVecWhereEqualToJsonFieldSc,
    ...
    ReadOnlyIdsMergedWithTableTypeDeclarationIntoPostgresTypeOptionWhereGreaterThanSc,
    ReadOnlyIdsSc, ReadOnlyIdsUcc, ReadUcc, RequestSc, ReqwestSc, ReqwestUcc, ResponseSc,
    ResponseTextSc, RollbackSc, RoutesHandleSc, RoutesSc, RowAndRollbackUcc, RowSc, RowsSc,
    ...
    UpdateForQueryUcc, UpdateForQueryVecSc, UpdateManyAdditionalErrorVariantsSc,
    ...
    parameter::{
        ...
        SelfDeleteManyPayloadUcc, SelfDeleteOneErrorNamedWithSerializeDeserializeUcc,
        SelfDeleteOneParametersUcc, SelfDeleteOnePayloadUcc,
        SelfErrorNamedWithSerializeDeserializeSc, SelfGenPostgresTableModSc, SelfHandleSc,
        SelfPayloadExampleSc, SelfPreparePostgresErrorNamedUcc,
        SelfReadOneErrorNamedWithSerializeDeserializeUcc,
        SelfReadOnlyIdsToTwoDimensionalVecReadInnerAccSc, SelfReadOnlyIdsUcc, SelfReadUcc,
        SelfSelectUcc, SelfTableTypeDeclarationUcc, SelfTestsSc, SelfTryDeleteOneErrorNamedUcc,
        SelfTryReadOneErrorNamedUcc, SelfUpdateForQueryUcc, SelfUpdateManyParametersUcc,
        SelfUpdateManyPayloadUcc, SelfUpdateTryNewErrorNamedUcc, SelfUpdateUcc,
        SelfWhereManyTryNewErrorNamedUcc, SelfWhereManyUcc, SelfWhereUcc,
        StdOptionOptionSelfWhereManyUcc, TryFromSqlxPostgresPgRowWithNotEmptyUniqueVecSelfSelectSc,
...
#[must_use]
pub fn gen_postgres_table(input: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    #[derive(Debug)]
    ...
    impl Operation {
        ...
        const fn gen_postgres_table_attribute_additional_error_variants(
            self,
        ) -> GenPostgresTableAttribute {
            match self {
                Self::CreateMany => GenPostgresTableAttribute::CreateManyAdditionalErrorVariants,
                Self::CreateOne => GenPostgresTableAttribute::CreateOneAdditionalErrorVariants,
                Self::ReadMany => GenPostgresTableAttribute::ReadManyAdditionalErrorVariants,
                Self::ReadOne => GenPostgresTableAttribute::ReadOneAdditionalErrorVariants,
                Self::UpdateMany => GenPostgresTableAttribute::UpdateManyAdditionalErrorVariants,
                Self::UpdateOne => GenPostgresTableAttribute::UpdateOneAdditionalErrorVariants,
                Self::DeleteMany => GenPostgresTableAttribute::DeleteManyAdditionalErrorVariants,
                Self::DeleteOne => GenPostgresTableAttribute::DeleteOneAdditionalErrorVariants,
            }
        }
        const fn gen_postgres_table_attribute_additional_logic(self) -> GenPostgresTableAttribute {
            match self {
                Self::CreateMany => GenPostgresTableAttribute::CreateManyAdditionalLogic,
                Self::CreateOne => GenPostgresTableAttribute::CreateOneAdditionalLogic,
                Self::ReadMany => GenPostgresTableAttribute::ReadManyAdditionalLogic,
                Self::ReadOne => GenPostgresTableAttribute::ReadOneAdditionalLogic,
                Self::UpdateMany => GenPostgresTableAttribute::UpdateManyAdditionalLogic,
                Self::UpdateOne => GenPostgresTableAttribute::UpdateOneAdditionalLogic,
                Self::DeleteMany => GenPostgresTableAttribute::DeleteManyAdditionalLogic,
                Self::DeleteOne => GenPostgresTableAttribute::DeleteOneAdditionalLogic,
            }
        }
        ...
        fn operation_error_named_with_serialize_deserialize_sc(
            self,
        ) -> SelfErrorNamedWithSerializeDeserializeSc {
            SelfErrorNamedWithSerializeDeserializeSc::from_display(&self)
        }
    ...
    enum GenPostgresTableAttribute {
    ...
    impl GenPostgresTableAttribute {
    ...
    struct GenPostgresTableConfig {
        create_many_content_write_into_gen_postgres_table_create_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        create_one_content_write_into_gen_postgres_table_create_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        read_many_content_write_into_gen_postgres_table_read_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        read_one_content_write_into_gen_postgres_table_read_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        update_many_content_write_into_gen_postgres_table_update_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        update_one_content_write_into_gen_postgres_table_update_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        delete_many_content_write_into_gen_postgres_table_delete_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        delete_one_content_write_into_gen_postgres_table_delete_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        tests_content_write_into_gen_postgres_table_tests:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        common_content_write_into_gen_postgres_table_common:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        whole_content_write_into_gen_postgres_table: macros_helpers::ShouldWriteTokenStreamIntoFile,
    }
    ...
    let postgres_crud_default_option_some_vec_one_el_call_ts =
        token_patterns::PostgresCrudDefaultOptionSomeVecOneElCall;
    ...
    let return_err_query_part_error_named_write_into_buffer_ts =
        postgres_crud_macros_common::gen_return_err_query_part_error_named_write_into_buffer_ts(
            import_path,
        );

    // let postgres_crud_all_variants_default_option_some_vec_one_el_call_ts = token_patterns::PostgresCrudAllEnumVariantsArrayDefaultOptionSomeVecOneElCall;
    let syn_derive_input: syn::DeriveInput =
        syn::parse2(input).expect("991c614f-5cf9-4a53-873a-5280b62e2dfa");
    let gen_postgres_table_config = serde_json::from_str::<GenPostgresTableConfig>(
        &macros_helpers::get_macro_attribute_meta_list_ts(
            &syn_derive_input.attrs,
            &format!(
                "{}::gen_postgres_table_config",
        ...
        if let syn::Data::Struct(data_struct) = &syn_derive_input.data {
            if let syn::Fields::Named(fields_named) = &data_struct.fields {
                ...
                for el_2e7b44a3 in &fields_named.named {
                    ...
                    let max_postgres_column_length = 63;
                    //todo write runtime check
                    assert!(
                        field_ident_len <= max_postgres_column_length,
                        ...
                        for el_f4d3785c in &el_2e7b44a3.attrs {
                            if el_f4d3785c.path().segments.len() == 1 {
                                let first_segment_ident = &el_f4d3785c
                                    ...
                                    .ident;
                                let gen_postgres_table_primary_key_sc_str =
                                    GenPostgresTablePrimaryKeySc.to_string();
                                if first_segment_ident == &gen_postgres_table_primary_key_sc_str {
    ...
    let ident_try_read_one_error_named_ucc = SelfTryReadOneErrorNamedUcc::from_tokens(&ident);
    let ident_read_one_error_named_with_serialize_deserialize_ucc =
        SelfReadOneErrorNamedWithSerializeDeserializeUcc::from_tokens(&ident);
    let ident_try_delete_one_error_named_ucc = SelfTryDeleteOneErrorNamedUcc::from_tokens(&ident);
    let ident_delete_one_error_named_with_serialize_deserialize_ucc =
        SelfDeleteOneErrorNamedWithSerializeDeserializeUcc::from_tokens(&ident);
    let std_vec_vec_primary_key_field_type_read_ts =
        postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
            &primary_key_field_type_as_postgres_type_read_ucc,
        );
    ...
    let gen_select_postgres_crud_not_empty_unique_vec_ident_select_ts =
        |should_add_borrow: &ShouldAddBorrow| {
            quote! {#SelectSc: #should_add_borrow postgres_crud::NotEmptyUniqueVec<#ident_select_ucc>}
        };
    let select_borrow_postgres_crud_not_empty_unique_vec_ident_select_ts =
        gen_select_postgres_crud_not_empty_unique_vec_ident_select_ts(&ShouldAddBorrow::True);
    let select_postgres_crud_not_empty_unique_vec_ident_select_ts =
        gen_select_postgres_crud_not_empty_unique_vec_ident_select_ts(&ShouldAddBorrow::False);
    let pub_select_postgres_crud_not_empty_unique_vec_ident_select_ts = {
        quote! {pub #select_postgres_crud_not_empty_unique_vec_ident_select_ts}
    };
    ...
    let impl_ident_ts = {
        let ident_prepare_postgres_error_named_ucc =
            SelfPreparePostgresErrorNamedUcc::from_tokens(&ident);
        let content_ts = quote! {
            #[eo_to_std_string_string]
            error: sqlx::Error,
            code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
        };
        let ident_prepare_postgres_error_named_ts =
            macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
                ...
                .build_enum(
                    &ident_prepare_postgres_error_named_ucc,
                    &quote! {{
        ...
        let fn_primary_key_ts = {
            let primary_key_field_ident_double_quotes_ts =
                gen_quotes::double_quotes_ts(&primary_key_field_ident);
            quote! {
        ...
        let pub_async_fn_prepare_extensions_ts = quote! {
            pub async fn #PrepareExtensionsSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>) -> Result<(), #ident_prepare_postgres_error_named_ucc> {
                if let Err(#ErrorSc) = sqlx::query("create extension if not exists pg_jsonschema").execute(#PoolSc).await {
                    return Err(#ident_prepare_postgres_error_named_ucc::#CreateExtensionIfNotExistsPgJsonschemaUcc {
                        #ErrorSc,
                        code_occurence: error_occurence_lib::code_occurence!()
                    });
                }
                if let Err(#ErrorSc) = sqlx::query("create extension if not exists \"uuid-ossp\"").execute(#PoolSc).await {
                    return Err(#ident_prepare_postgres_error_named_ucc::#CreateExtensionIfNotExistsUuidOsspUcc {
                        #ErrorSc,
                        code_occurence: error_occurence_lib::code_occurence!()
                    });
                }
        ...
        let pub_async_fn_prepare_postgres_table_ts = {
            let prepare_postgres_double_quotes_ts = gen_quotes::double_quotes_ts(&format!(
            ...
            let serde_json_to_string_schemars_schema_for_generic_unwrap_ts = {
                let gen_field_type_as_postgres_crud_create_table_column_query_part_create_table_query_part_ts =
                    |field_type: &syn::Type, field_ident: &syn::Ident, is_primary_key: bool| {
                        ...
                        let field_type_postgres_type_ts = gen_as_postgres_type_ts(&field_type);
                        quote! {
                            #field_type_postgres_type_ts #CreateTableColumnQueryPartSc(&#field_ident_double_quotes_ts, #is_primary_key_ts)
                        }
                    };
                once(
                    gen_field_type_as_postgres_crud_create_table_column_query_part_create_table_query_part_ts(
            ...
            quote! {
                pub async fn #PreparePostgresTableSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>, table: &str) -> Result<(), #ident_prepare_postgres_error_named_ucc> {
                    if let Err(error) = sqlx::query(&format!(
                        #prepare_postgres_double_quotes_ts,
                        #(#serde_json_to_string_schemars_schema_for_generic_unwrap_ts),*
                    )).execute(#PoolSc).await {
                        return Err(#ident_prepare_postgres_error_named_ucc::#PreparePostgresUcc {
                            error,
                            code_occurence: error_occurence_lib::code_occurence!()
                        });
                    }
        ...
        let pub_async_fn_prepare_postgres_ts = quote! {
            pub async fn #PreparePostgresSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>) -> Result<(), #ident_prepare_postgres_error_named_ucc> {
                Self::#PrepareExtensionsSc(#PoolSc).await?;
                Self::#PreparePostgresTableSc(#PoolSc, #ident_sc_double_quotes_ts).await?;
                Ok(())
            }
        };
        ...
        let fn_gen_select_query_part_ts = {
            let variants_ts = gen_fields_named_with_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let initialization_ts = {
                        let field_ident_string_double_quotes_ts =
                            gen_quotes::double_quotes_ts(&element.field_ident);
                        let as_postgres_crud_postgres_type_postgres_type_ts =
                            gen_as_postgres_type_ts(&element.field_type);
                        quote! {
                            => match #as_postgres_crud_postgres_type_postgres_type_ts #SelectQueryPartSc(
                                #ColumnSc,
            ...
            quote! {
                fn #GenSelectQueryPartSc(#select_borrow_postgres_crud_not_empty_unique_vec_ident_select_ts) -> Result<#string_ts, #import_path ::#QueryPartErrorNamedUcc> {
        ...
        impl_ident_vec_ts.push(quote! {
            ...
            #pub_async_fn_prepare_postgres_table_ts
            #pub_async_fn_prepare_postgres_ts
            #pub_fn_allow_methods_ts
            #fn_gen_select_query_part_ts
        });
        quote! {
            #ident_prepare_postgres_error_named_ts
        }
    };
    ...
    let gen_operation_error_initialization_eprintln_response_creation_ts =
        |operation: &Operation,
         ...
         line: u32,
         column: u32| {
            let ident_operation_error_named_ucc = gen_ident_operation_error_named_ucc(operation);
            ...
            let syn_variant_initialization_ts =
                gen_initialization_ts(syn_variant_wrapper, file, line, column);
            ...
            quote! {
                let #ErrorSc = #ident_operation_error_named_ucc::#syn_variant_initialization_ts;
                // eprintln!("{error}");
    ...
    let query_part_syn_variant_wrapper = new_syn_variant_wrapper(
        ...
        vec![(
            ...
            macros_helpers::gen_simple_syn_punctuated_punctuated(&[
                &PostgresCrudSc.to_string(),
                &QueryPartErrorNamedUcc.to_string(),
            ]),
        )],
    );
    ...
    let ident_create_ts = {
            ...
            .build_struct(&ident_create_ucc, &{
                let content_ts = gen_fields_named_without_primary_key_with_comma_ts(
                    &|element: &macros_helpers::SynFieldWrapper| {
                        ...
                        let el_syn_field_ty_as_postgres_type_create_ts =
                            gen_as_postgres_type_create_ts(&element.field_type);
                        quote! {
                            pub #field_ident: #el_syn_field_ty_as_postgres_type_create_ts
                        }
                    },
                );
                quote! {{#content_ts}}
        ...
        let impl_ident_create_ts = {
            let primary_key_field_type_as_default_option_some_vec_one_el_call_ts = {
                let primary_key_field_type_as_postgres_type_create_ts =
                    gen_as_postgres_type_create_ts(&primary_key_field_type);
                quote! {
                    <
                        #primary_key_field_type_as_postgres_type_create_ts as #PostgresCrudSc::#DefaultOptionSomeVecOneElUcc
            ...
            let fn_create_query_part_ts = {
                let gen_match_as_postgres_crud_postgres_type_postgres_type_create_query_part_ts =
                    |field_type: &syn::Type, content_ts: &dyn ToTokens| {
                        ...
                        quote! {
                            match #as_postgres_crud_postgres_type_postgres_type_ts #CreateQueryPartSc(
                                &#content_ts,
                                #IncrementSc
                            ) {
                                Ok(value_c3f0b59a) => {
                ...
                let primary_key_content_ts =
                    gen_match_as_postgres_crud_postgres_type_postgres_type_create_query_part_ts(
                        primary_key_field_type,
                ...
                quote! {
                    fn #CreateQueryPartSc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, postgres_crud::#QueryPartErrorNamedUcc> {
            ...
            let fn_create_query_bind_ts = {
                let gen_query_as_postgres_crud_postgres_type_postgres_type_create_query_bind_ts =
                    |field_type: &syn::Type, content_ts: &dyn ToTokens| {
                        let as_postgres_crud_postgres_type_postgres_type_ts =
                            gen_as_postgres_type_ts(&field_type);
                        quote! {
                            match #as_postgres_crud_postgres_type_postgres_type_ts #CreateQueryBindSc(
                                #content_ts,
                                #QuerySc
                            ) {
                                Ok(value_3c55d2e1) => {
                ...
                let primary_key_content_ts =
                    gen_query_as_postgres_crud_postgres_type_postgres_type_create_query_bind_ts(
                        primary_key_field_type,
                        &primary_key_field_type_as_default_option_some_vec_one_el_call_ts,
                    );
                let binded_query_modifications_ts =
                    gen_fields_named_without_primary_key_without_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| {
                            gen_query_as_postgres_crud_postgres_type_postgres_type_create_query_bind_ts(&element.field_type, &{
                        let field_ident = &element.field_ident;
        ...
        let impl_postgres_crud_default_option_some_vec_one_el_for_ident_create_ts =
            gen_impl_postgres_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                &ident_create_ucc,
                &{
        ...
        quote! {
            ...
            #impl_postgres_crud_default_option_some_vec_one_el_for_ident_create_ts
        }
    };
    ...
    let ident_where_many_ts = {
        let fields_declaration_ts = gen_fields_named_with_comma_ts(
            &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                let field_ident = &element.field_ident;
                let el_syn_field_ty_as_postgres_type_where_ts =
                    gen_as_postgres_type_where_ts(&element.field_type);
                let std_option_option_postgres_type_where_syn_field_ty_as_postgres_type_where_ts =
                    postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                        &quote! {postgres_crud::PostgresTypeWhere<#el_syn_field_ty_as_postgres_type_where_ts>},
                    );
                quote! {
                    #field_ident: #std_option_option_postgres_type_where_syn_field_ty_as_postgres_type_where_ts
                }
            },
        );
        let ident_where_many_ts = {
        ...
        let impl_pub_try_new_for_ident_where_many_ts =
            macros_helpers::gen_impl_pub_try_new_for_ident_ts(
                ...
                &{
                    ...
                    quote! {
                        if matches!((#fields_ts), (#fields_named_with_comma_none_ts)) {
                            return Err(#ident_where_many_try_new_error_named_ucc::#NoFieldsProvidedUcc {
                                code_occurence: error_occurence_lib::code_occurence!(),
                            });
                        }
        ...
        let impl_serde_deserialize_for_ident_where_many_ts =
            postgres_crud_macros_common::gen_impl_serde_deserialize_for_struct_ts(
                ...
                &|_: &syn::Ident, syn_type: &syn::Type| {
                    let syn_type_as_postgres_type_where_ts =
                        gen_as_postgres_type_where_ts(&syn_type);
                    postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                        &quote! {postgres_crud::PostgresTypeWhere<#syn_type_as_postgres_type_where_ts>},
                    )
                },
            );
        let impl_postgres_crud_default_option_some_vec_one_el_for_ident_where_many_ts =
            gen_impl_postgres_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                &ident_where_many_ucc,
                &{
        ...
        quote! {
            ...
            #impl_postgres_crud_default_option_some_vec_one_el_for_ident_where_many_ts
        }
    };
    ...
    let std_option_option_ident_where_many_ts = {
        ...
        let impl_postgres_type_where_filter_for_std_option_option_ident_where_many_ts =
            postgres_crud_macros_common::impl_postgres_type_where_filter_for_ident_ts(
                ...
                &postgres_crud_macros_common::ColumnParameterUnderscore::True,
                ...
                &{
                    ...
                    quote! {
                        if let Some(value_da0f0616) = &#ValueSc.#field_ident {
                            match postgres_crud::PostgresTypeWhereFilter::query_part(
                                value_da0f0616,
                                increment,
                    ...
                    quote! {
                        Ok(match &self.0 {
                            Some(value) => {
                                let mut #AdditionalParametersSc = #string_ts::from("where");
                        ...
                        &|element: &macros_helpers::SynFieldWrapper| {
                            ...
                            quote! {
                                if let Some(value_b12d6fe0) = value_27176ffb.#field_ident {
                                    match postgres_crud::PostgresTypeWhereFilter::query_bind(value_b12d6fe0, #QuerySc) {
                                        Ok(value_edaee3b2) => {
        ...
        let impl_postgres_crud_default_option_some_vec_one_el_for_std_option_option_ident_where_many_ts =
            gen_impl_postgres_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                &std_option_option_ident_where_many_ucc,
                &quote! {Self(Some(#postgres_crud_default_option_some_vec_one_el_call_ts))},
            );
        quote! {
            #std_option_option_ident_where_many_ts
            #impl_postgres_type_where_filter_for_std_option_option_ident_where_many_ts
            #impl_postgres_crud_default_option_some_vec_one_el_for_std_option_option_ident_where_many_ts
        }
    };
    let pub_where_many_std_option_option_ident_where_many_ts =
        quote! {pub #WhereManySc: #std_option_option_ident_where_many_ucc};
    let where_many_postgres_crud_default_option_some_vec_one_el_call_ts = quote! {
        #WhereManySc: #postgres_crud_default_option_some_vec_one_el_call_ts
    };
    ...
    let gen_query_postgres_type_where_filter_query_bind_parameters_payload_where_many_query_ts =
        |operation: &Operation| {
            ...
            quote! {
                match postgres_crud::PostgresTypeWhereFilter::query_bind(#ParametersSc.#PayloadSc.#WhereManySc, #QuerySc) {
                    Ok(value_03a58371) => {
    ...
    let try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_sc =
        TryFromSqlxPostgresPgRowWithNotEmptyUniqueVecSelfSelectSc::from_display(&ident);
    ...
    let postgres_syn_variant_wrapper = new_syn_variant_wrapper(
        &PostgresUcc,
        Some(macros_helpers::StatusCode::InternalServerError500),
        vec![(
    ...
    let gen_match_ident_read_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts =
        |read_many_or_read_one: &ReadManyOrReadOne| {
            let content_ts_995d3d1d =
                gen_operation_error_initialization_eprintln_response_creation_ts(
                    &Operation::from(read_many_or_read_one),
                    &postgres_syn_variant_wrapper,
                    file!(),
                    line!(),
                    column!(),
                );
            quote! {
                match #ident_read_ucc::#try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_sc(
                    &value_b27d7d79,
    ...
    let select_ts = {
        let ident_select_ts = {
            ...
            .build_enum(
                &ident_select_ucc,
                &{
                    let variants = gen_fields_named_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| {
                        let serialize_deserialize_ident_ts = gen_quotes::double_quotes_ts(&element.field_ident);
                        let field_ident_ucc_ts = ToTokensToUccTs::case_or_panic(&element.field_ident);
                        let el_syn_field_ty_as_postgres_type_select_ts = gen_as_postgres_type_select_ts(&element.field_type);
                        quote! {
                            #[serde(rename(serialize = #serialize_deserialize_ident_ts, deserialize = #serialize_deserialize_ident_ts))]
                            #field_ident_ucc_ts(#el_syn_field_ty_as_postgres_type_select_ts)
                        }
                    });
                    quote!{{#variants}}
                }
        ...
        let impl_postgres_crud_all_variants_default_option_some_vec_one_el_for_ident_select_ts = postgres_crud_macros_common::gen_impl_postgres_crud_all_variants_default_option_some_vec_one_el_ts(&ident_select_ucc, &{
            let elements_ts = gen_fields_named_with_comma_ts(&|el_5282570d: &macros_helpers::SynFieldWrapper| {
                let field_ident_ucc_ts = ToTokensToUccTs::case_or_panic(&el_5282570d.field_ident);
                quote! {
                    Self::#field_ident_ucc_ts(#postgres_crud_default_option_some_vec_one_el_call_ts)
                }
            });
        ...
        quote! {
            ...
            #impl_postgres_crud_all_variants_default_option_some_vec_one_el_for_ident_select_ts
        }
    };
    let select_postgres_crud_default_option_some_vec_one_el_call_ts = quote! {
        #SelectSc: #postgres_crud_default_option_some_vec_one_el_call_ts
    };
    let ident_read_ts = {
        let ident_read_ts = {
            ...
            .build_struct(
                ...
                &{
                    let field_option_primary_key_ts = {
                        let std_option_option_value_primary_key_field_type_as_postgres_type_read_ts = postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_postgres_type_read_ts(&primary_key_field_type)));
                        quote! {
                            #field_attribute_serde_skip_serializing_if_option_is_none_ts
                            pub #primary_key_field_ident: #std_option_option_value_primary_key_field_type_as_postgres_type_read_ts
                        }
                    };
                    let fields_options_without_primary_key_ts = gen_fields_named_without_primary_key_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        ...
                        let field_ident = &element.field_ident;
                        let std_option_option_value_field_type_as_postgres_type_read_ts = postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_postgres_type_read_ts(&element.field_type)));
                        quote! {
                            #field_attribute_serde_skip_serializing_if_option_is_none_ts
                            #field_visibility #field_ident: #std_option_option_value_field_type_as_postgres_type_read_ts
                        }
                    });
                    quote!{{
            ...
            let fn_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts = {
                ...
                let declaration_without_primary_key_ts =
                    gen_fields_named_without_primary_key_without_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| {
                            ...
                            let std_option_option_value_field_type_as_postgres_type_read_ts = postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_postgres_type_read_ts(&element.field_type)));
                            quote! {
                                let mut #field_ident: #std_option_option_value_field_type_as_postgres_type_read_ts = None;
                            }
                        },
                    );
                //todo reuse code?
                ...
                let assignment_variants_without_primary_key_ts = fields_without_primary_key
                    ...
                    .map(|el_3ce946f9| {
                        ...
                        let field_ident_string_double_quotes_ts = gen_quotes::double_quotes_ts(&el_3ce946f9.field_ident);
                        let el_syn_field_ty_as_postgres_type_read_ts = gen_as_postgres_type_read_ts(&el_3ce946f9.field_type);
                        quote! {
                            #ident_select_ucc::#field_ident_ucc_ts(_) => match sqlx::Row::try_get::<
                                #el_syn_field_ty_as_postgres_type_read_ts,
                                #ref_std_primitive_str
                            >(
                                value,
                                #field_ident_string_double_quotes_ts
                ...
                quote! {
                    fn #try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_sc(
                        #ValueSc: &sqlx::postgres::PgRow,
                        #select_borrow_postgres_crud_not_empty_unique_vec_ident_select_ts
        ...
        let ident_read_only_ids_ts = {
            ...
            .build_struct(
                ...
                &{
                    ...
                    let primary_key_ts = gen_field_ts(&primary_key_field_ident, &primary_key_field_type, &WrapIntoOption::False);
                    let content_ts = gen_fields_named_without_primary_key_with_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| gen_field_ts(
                            &element.field_ident,
                            &element.field_type,
                            &WrapIntoOption::True
                        )
        ...
        let impl_sqlx_row_for_ident_read_only_ids_ts = {
            ...
            let where_field_types_ts = gen_fields_named_with_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let el_syn_field_ty_as_postgres_type_read_only_ids_ts =
                        gen_as_postgres_type_read_only_ids_ts(&field_type);
                    quote! {
                        #el_syn_field_ty_as_postgres_type_read_only_ids_ts: ::sqlx::decode::Decode<'lifetime, R::Database>
                    }
                },
            );
            let primary_key_ts = {
                let el_syn_field_ty_as_postgres_type_read_only_ids_ts =
                    gen_as_postgres_type_read_only_ids_ts(&primary_key_field_type);
                let field_ident_double_quotes_ts =
                    gen_quotes::double_quotes_ts(&primary_key_field_ident);
                quote! {
                    let #primary_key_field_ident = match sqlx::Row::try_get::<#el_syn_field_ty_as_postgres_type_read_only_ids_ts, &str>(
            ...
            let fields_initialization_ts = gen_fields_named_without_primary_key_without_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_type = &element.field_type;
                    let field_ident_double_quotes_ts =
                        gen_quotes::double_quotes_ts(&quote! {#field_ident});
                    let el_syn_field_ty_as_postgres_type_read_only_ids_ts =
                        gen_as_postgres_type_read_only_ids_ts(&field_type);
                    quote! {
                        let #field_ident = sqlx::Row::try_get::<
                            #el_syn_field_ty_as_postgres_type_read_only_ids_ts,
                            &str
            ...
            let self_fields_ts =
                gen_fields_named_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    quote! {#field_ident}
                });
            quote! {
    ...
    let postgres_crud_order_by_ts = quote! {#PostgresCrudSc::#OrderByUcc};
    ...
    let ident_update_ts = {
        let gen_option_value_field_type_as_postgres_type_update_ts = |syn_type: &syn::Type| {
            let path_value_ts = {
                let value = format!("{PostgresCrudSc}::{ValueUcc}");
                value
                    .parse::<proc_macro2::TokenStream>()
                    .expect("dbdbb7f2-7801-49e7-917e-f7daa9b4dd91")
            };
            let syn_type_as_postgres_type_update_ts = gen_as_postgres_type_update_ts(&syn_type);
            postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                &quote! {#path_value_ts<#syn_type_as_postgres_type_update_ts>},
            )
        };
        let fields_declaration_ts = {
            let fields_named_without_primary_key_ts =
                gen_fields_named_without_primary_key_with_comma_ts(
                    &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        let field_ident = &element.field_ident;
                        let option_value_field_type_as_postgres_type_update_ts =
                            gen_option_value_field_type_as_postgres_type_update_ts(
                                &element.field_type,
                            );
                        quote! {
                            #field_ident: #option_value_field_type_as_postgres_type_update_ts
                        }
                    },
                );
            quote! {
                ...
                &{
                    ...
                    quote! {
                        if matches!(#left_ts, #right_ts) {
                            return Err(#ident_update_try_new_error_named_ucc::#NoFieldsProvidedUcc {
                                code_occurence: error_occurence_lib::code_occurence!(),
                            });
                        }
                        Ok(Self {#fields_inialization_ts})
            ...
            postgres_crud_macros_common::gen_impl_serde_deserialize_for_struct_ts(
                ...
                &|syn_ident: &syn::Ident, syn_type: &syn::Type| {
                    if syn_ident == primary_key_field_ident {
                        ...
                        gen_option_value_field_type_as_postgres_type_update_ts(syn_type)
                    }
                },
            );
        let impl_postgres_crud_default_option_some_vec_one_el_for_ident_update_ts =
            gen_impl_postgres_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                &ident_update_ucc,
                &{
                    let primary_key_field_with_default_option_some_vec_one_el_ts = {
                        quote! {
                            #primary_key_field_ident: #postgres_crud_default_option_some_vec_one_el_call_ts
                        }
                    };
                    let fields_without_primary_key_with_default_option_some_vec_one_el_ts =
                        gen_fields_named_without_primary_key_with_comma_ts(
                            &|element: &macros_helpers::SynFieldWrapper| {
                                let field_ident = &element.field_ident;
                                quote! {
                                    #field_ident: Some(postgres_crud::Value{
                                        #ValueSc: #postgres_crud_default_option_some_vec_one_el_call_ts
                                    })
                                }
                            },
                        );
    ...
    let ident_update_for_query_ts = {
            ...
            .build_struct(
                ...
                &{
                    let fields_named_without_primary_key_ts = gen_fields_named_without_primary_key_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        let field_ident = &element.field_ident;
                        let option_value_field_type_as_postgres_type_update_for_query_ts = {
                            let path_value_ts = {
                                let value = format!("{PostgresCrudSc}::{ValueUcc}");
                                value.parse::<proc_macro2::TokenStream>().expect("2b09d4ae-757c-4c6b-a9ba-edd2ea95128a")
                            };
                            let syn_type_as_postgres_type_update_for_query_ts = gen_as_postgres_type_update_for_query_ts(&element.field_type);
                            postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&quote! {#path_value_ts<#syn_type_as_postgres_type_update_for_query_ts>})
                        };
                        quote! {#field_ident: #option_value_field_type_as_postgres_type_update_for_query_ts}
                    });
                    quote!{{
        ...
        let impl_ident_update_for_query_ts = {
            let update_query_part_primary_key_ts = {
                quote! {
                    fn #update_query_part_primary_key_sc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, #PostgresCrudSc::#QueryPartErrorNamedUcc> {
                        match #primary_key_field_type_as_postgres_type_ts #UpdateQueryPartSc(
            ...
            let update_query_part_fields_ts = gen_fields_named_without_primary_key_without_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let field_type_as_postgres_crud_postgres_type_postgres_type_ts =
                        gen_as_postgres_type_ts(&element.field_type);
                    quote! {
                        fn #update_query_part_field_ident_sc(
                            #ValueSc: &postgres_crud::Value<#field_type_as_postgres_crud_postgres_type_postgres_type_ts #UpdateForQueryUcc>,
                            #IncrementSc: &mut u64
                        ) -> Result<#string_ts, #PostgresCrudSc::#QueryPartErrorNamedUcc> {
                            match #field_type_as_postgres_crud_postgres_type_postgres_type_ts #UpdateQueryPartSc(
                                &#ValueSc.#ValueSc,
                                #field_ident_double_quotes_ts,
                                #field_ident_double_quotes_ts,
                                "",
            ...
            let select_only_updated_ids_query_part_ts = {
                let primary_key_content_ts = {
                    let primary_key_field_ident_double_quotes_ts =
                        gen_quotes::double_quotes_ts(&primary_key_field_ident);
                    quote! {
                        acc_88c91f52.push_str(&match <#primary_key_field_type as postgres_crud::PostgresType>::#SelectOnlyUpdatedIdsQueryPartSc(
                            &self.#primary_key_field_ident,
                            #primary_key_field_ident_double_quotes_ts,
                            increment,
                        ){
                ...
                let content_ts = fields_without_primary_key.iter().map(|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_ident_double_quotes_ts = gen_quotes::double_quotes_ts(&field_ident);
                    let field_type_as_postgres_crud_postgres_type_postgres_type_ts = gen_as_postgres_type_ts(&element.field_type);
                    quote! {
                        if let Some(value_90f79b11) = &self.#field_ident {
                            acc_88c91f52.push_str(&match #field_type_as_postgres_crud_postgres_type_postgres_type_ts #SelectOnlyUpdatedIdsQueryPartSc(
                ...
                quote! {
                    fn #SelectOnlyUpdatedIdsQueryPartSc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, postgres_crud::QueryPartErrorNamed> {
            ...
            let update_handle_ts = gen_from_handle_ts(&ident_update_ucc, &{
                let primary_key_field_type_as_postgres_type_update_for_query_ts =
                    gen_as_postgres_type_update_for_query_ts(&primary_key_field_type);
                let fields_named_without_primary_key_ts =
                    gen_fields_named_without_primary_key_with_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                            let field_ident = &element.field_ident;
                            let value_initialization_ts = gen_import_path_value_initialization_ts(
                                &{
                                    let field_type_as_postgres_type_update_for_query_ts =
                                        gen_as_postgres_type_update_for_query_ts(
                                            &element.field_type,
                                        );
                                    quote! {
                                         #field_type_as_postgres_type_update_for_query_ts::from(value_0e64c53a.#ValueSc)
                                    }
                                },
                            );
                            quote! {
                ...
                quote! {
                    Self {
                        #primary_key_field_ident: #primary_key_field_type_as_postgres_type_update_for_query_ts::from(#ValueSc.#primary_key_field_ident),
                        #fields_named_without_primary_key_ts
                    }
                }
            });
    ...
    let sqlx_query_sqlx_postgres_ts = quote! {sqlx::query::<sqlx::Postgres>};
    let (
        postgres_crud_postgres_type_where_filter_query_part_ts,
        postgres_crud_postgres_type_where_filter_query_bind_ts,
    ) = {
        let postgres_crud_postgres_type_where_filter_ts =
            quote! {#PostgresCrudSc::PostgresTypeWhereFilter::};
        (
            quote! {#postgres_crud_postgres_type_where_filter_ts #QueryPartSc},
            quote! {#postgres_crud_postgres_type_where_filter_ts #QueryBindSc},
        )
    };

    let std_vec_vec_struct_options_ident_ts =
        postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_read_ucc);
    ...
    let gen_additional_error_variants =
        |current_syn_derive_input: &syn::DeriveInput,
         gen_postgres_table_attribute: GenPostgresTableAttribute|
         -> Vec<syn::Variant> {
            let gen_postgres_table_attribute_str = gen_postgres_table_attribute.to_string();
            let common_additional_error_variants_attribute_ts =
                macros_helpers::get_macro_attribute_meta_list_ts(
                    &current_syn_derive_input.attrs,
                    &gen_postgres_table_attribute.gen_path_to_attribute(),
                );
            ...
            assert!(
                value_ident_str == gen_postgres_table_attribute_str,
    ...
    let common_additional_logic_ts = macros_helpers::get_macro_attribute_meta_list_ts(
        &syn_derive_input.attrs,
        &GenPostgresTableAttribute::CommonAdditionalLogic.gen_path_to_attribute(),
    );
    ...
    let gen_match_postgres_transaction_rollback_await_ts =
        |operation: &Operation,
         postgres_file: &'static str,
         postgres_line: u32,
         postgres_column: u32,
         ...
         row_and_rollback_column: u32| {
            ...
            quote! {{
                if let Err(#error_1_ts) = #ExecutorSc.#RollbackSc().await {
                    #row_and_rollback_syn_variant_error_initialization_eprintln_response_creation_ts
                }
                #content_ts_91f19090
            }}
        };
    let gen_drop_rows_match_postgres_transaction_rollback_await_handle_ts =
        |operation: &Operation,
         postgres_file: &'static str,
         postgres_line: u32,
         postgres_column: u32,
         ...
         row_and_rollback_column: u32| {
            let match_postgres_transaction_rollback_await_ts =
                gen_match_postgres_transaction_rollback_await_ts(
                    operation,
                    postgres_file,
                    postgres_line,
                    postgres_column,
    ...
    let gen_fetch_ts = |executor_name_ts: &dyn ToTokens,
        ...
        let content_ts = quote! {
            ...
            while let Some(value_d9cc2c36) = match #PostgresCrudSc::TryStreamExt::try_next(&mut #RowsSc).await {
    ...
    let wrap_content_into_postgres_transaction_begin_commit_value_ts =
        |operation: &Operation, content_ts: &dyn ToTokens| {
            let postgres_transaction_begin_ts = {
                ...
                quote! {
                    let mut #ExecutorSc = match #sqlx_acquire::#BeginSc(#ExecutorAcquireSc).await {
            ...
            let postgres_transaction_commit_ts = {
                let postgres_syn_variant_error_initialization_eprintln_response_creation_ts =
                    gen_operation_error_initialization_eprintln_response_creation_ts(
                        operation,
                        &postgres_syn_variant_wrapper,
                        file!(),
                ...
                quote! {
                    if let Err(#error_0_ts) = #ExecutorSc.#CommitSc().await {
                        #postgres_syn_variant_error_initialization_eprintln_response_creation_ts
                    }
                }
            };
            quote! {
         ...
         -> proc_macro2::TokenStream {
            ...
            let impl_ident_operation_response_variants_ts = {
                let from_handle_ts = gen_from_handle_ts(&ident_operation_error_named_ucc, &{
                    ...
                    let ident_operation_error_named_with_serialize_deserialize_ucc = gen_ident_operation_error_named_with_serialize_deserialize_ucc(operation);
                    quote! {
                        #ident_operation_error_named_with_serialize_deserialize_ucc::#variant_ident {
                            #fields_mapped_into_ts
                        } => Self::#variant_ident {
                            #fields_mapped_into_ts
                        }
            ...
            let ident_operation_error_named_ts = {
                ...
                quote! {
                    ...
                    pub enum #ident_operation_error_named_ucc {
                        #(#variants_ts),*
                    }
                }
            };
    ...
    let gen_parameters_payload_and_default_ts =
        |operation: &Operation,
         ...
         default_init_content_ts: &dyn ToTokens| {
            ...
            let impl_postgres_crud_default_option_some_vec_one_el_for_operation_payload_ts =
                gen_impl_postgres_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
            ...
            quote! {
                ...
                #impl_postgres_crud_default_option_some_vec_one_el_for_operation_payload_ts
            }
        };
    let gen_type_variants_from_request_response_syn_variants =
        |syn_variants: &Vec<&syn::Variant>, operation: &Operation| -> Vec<syn::Variant> {
            ...
            for el_60533068 in gen_additional_error_variants(
                &syn_derive_input,
                operation.gen_postgres_table_attribute_additional_error_variants(),
            ) {
     ...
     -> proc_macro2::TokenStream {
        ...
        let request_parts_preparation_ts = {
            ...
            quote! {
                ...
                //     }
                // }
                let body_bytes = match #PostgresCrudSc::check_body_size::check_body_size(#BodySc, *#AppStateSc.get_maximum_size_of_http_body_in_bytes()).await {
        ...
        let additional_validators_ts = {
            let operation_additional_logic_ts = macros_helpers::get_macro_attribute_meta_list_ts(
                &syn_derive_input.attrs,
                &operation
                    .gen_postgres_table_attribute_additional_logic()
        ...
        let acquire_pool_and_connection_ts = {
            let postgres_syn_variant_wrapper_error_initialization_eprintln_response_creation_ts =
                gen_operation_error_initialization_eprintln_response_creation_ts(
                    operation,
                    &postgres_syn_variant_wrapper,
                    file!(),
            ...
            quote! {
                let mut #PoolConnectionSc = match #AppStateSc.get_postgres_pool().acquire().await {
                    Ok(value_4535ee48) => value_4535ee48,
                    Err(#error_0_ts) => {
                        #postgres_syn_variant_wrapper_error_initialization_eprintln_response_creation_ts
                    }
                };
    ...
    let gen_try_operation_ts = |operation: &Operation, type_variants_from_request_response_syn_variants: &[syn::Variant], result_ok_type_ts: &dyn ToTokens, desirable_from_or_try_from_desirable_with_serialize_deserialize_ts: &dyn ToTokens| {
        ...
        let ident_operation_parameters_ucc = gen_ident_operation_parameters_ucc(operation);
        let payload_ts = {
            let serde_json_to_string_syn_variant_initialization_ts = gen_initialization_ts(&serde_json_to_string_syn_variant_wrapper, file!(), line!(), column!());
            quote! {
                let #PayloadSc = {
                    match serde_json::to_string(&#ParametersSc.#PayloadSc) {
                        Ok(value_1772a83e) => value_1772a83e,
                        Err(#error_0_ts) => {
                            return Err(#ident_try_operation_error_named_ucc::#serde_json_to_string_syn_variant_initialization_ts);
                        }
                    }
                };
            }
        ...
        let url_ts = {
            let format_handle_ts = gen_quotes::double_quotes_ts(&format!("{{endpoint_location}}/{{table}}/{}", operation.self_sc_str()));
        ...
        let future_ts = {
            ...
            let application_json_double_quotes_ts = gen_quotes::double_quotes_ts(&"application/json");
        ...
        let response_ts = {
            let reqwest_syn_variant_initialization_ts = gen_initialization_ts(&reqwest_syn_variant_wrapper, file!(), line!(), column!());
            quote! {
                let #ResponseSc = match #FutureSc.await {
                    Ok(value_180559e9) => value_180559e9,
                    Err(#error_0_ts) => {
                        return Err(#ident_try_operation_error_named_ucc::#reqwest_syn_variant_initialization_ts);
                    }
                };
            }
        };
        let error_0_response_status_ts = quote! {
            let #error_0_ts = #ResponseSc.status();
        };
        let headers_ts = quote! {
            let #error_1_ts = #ResponseSc.headers().clone();
        };
        let response_text_ts = {
            let failed_to_get_response_text_syn_variant_initialization_ts = gen_initialization_ts(&failed_to_get_response_text_syn_variant_wrapper, file!(), line!(), column!());
            quote! {
                let #error_2_ts = match #ResponseSc.text().await {
                    Ok(value_6a62b2b9) => value_6a62b2b9,
                    Err(#error_2_ts) => {
                        return Err(#ident_try_operation_error_named_ucc::#failed_to_get_response_text_syn_variant_initialization_ts);
                    }
                };
            }
        };
        let ident_operation_response_variants_ucc = gen_ident_operation_response_variants_ucc(operation);
        let expected_response_ts = {
            let deserialize_response_syn_variant_initialization_ts = gen_initialization_ts(&deserialize_response_syn_variant_wrapper, file!(), line!(), column!());
            quote! {
                let #ExpectedResponseSc = match serde_json::from_str::<#ident_operation_response_variants_ucc>(&#error_2_ts) {
                    Ok(value_563d2a75) => value_563d2a75,
                    Err(#error_3_ts) => {
                        return Err(#ident_try_operation_error_named_ucc::#deserialize_response_syn_variant_initialization_ts);
                    }
                };
            }
        };
        let try_operation_logic_error_named_with_serialize_deserialize_ucc = gen_ident_operation_error_named_with_serialize_deserialize_ucc(operation);
        let operation_error_named_with_serialize_deserialize_sc = &operation.operation_error_named_with_serialize_deserialize_sc();
            ...
            let try_operation_logic_response_variants_to_try_operation_logic_error_named_with_serialize_deserialize = type_variants_from_request_response_syn_variants.iter().map(|el_f83d5272| {
                ...
                quote! {
                    #ident_operation_response_variants_ucc::#variant_ident {
                        #fields_idents_ts
                    } => #try_operation_logic_error_named_with_serialize_deserialize_ucc::#variant_ident { #fields_idents_ts }
                }
            });
            quote! {
                let #operation_error_named_with_serialize_deserialize_sc = match #ExpectedResponseSc {
        ...
        let return_error_ts = {
            let field_code_occurence_new_6ac7b78e_da5d_4274_b58c_67bb9625d008_ts = macros_helpers::gen_field_code_occurence_new_ts(file!(), line!(), column!());
            quote! {
                Err(#ident_try_operation_error_named_ucc::#try_operation_logic_error_named_with_serialize_deserialize_ucc {
                    #operation_error_named_with_serialize_deserialize_sc,
                ...
                &match &create_or_update_or_delete_many {
                    CreateOrUpdateOrDeleteMany::Create | CreateOrUpdateOrDeleteMany::Update => {
                        let content_ts = gen_match_ident_read_only_ids_as_from_row_from_row_ts(&{
                            let content_ts =
                                gen_drop_rows_match_postgres_transaction_rollback_await_handle_ts(
                                    &current_operation,
                                    file!(),
                                    line!(),
                                    column!(),
        ...
        |create_or_update_or_delete_one: &CreateOrUpdateOrDeleteOne| {
            ...
            wrap_into_value_ts(&gen_fetch_one_ts(
                ...
                &gen_sqlx_row_try_get_primary_key_ts(
                    &quote! {#primary_key_field_type_as_postgres_type_read_ucc},
                    &quote! {value_69ecb6a9},
                    &gen_match_postgres_transaction_rollback_await_ts(
                        &current_operation,
                        file!(),
                        line!(),
    ...
    let gen_operation_payload_example_ts = |operation: &Operation| {
        ...
        let wraped_into_axum_response_ts = wrap_into_axum_response_ts(
            &{
                let ident_operation_payload_ucc = gen_ident_operation_payload_ucc(operation);
                quote! {<#ident_operation_payload_ucc as postgres_crud::#DefaultOptionSomeVecOneElUcc>::#DefaultOptionSomeVecOneElSc()}
            },
    ...
    let increment_initialization_ts = quote! {let mut #IncrementSc: u64 = 0;};
    let column_names = {
    ...
    let column_names_double_quotes_ts = gen_quotes::double_quotes_ts(&column_names);
    let gen_select_only_ids_query_part_ts = |operation: &Operation| {
        let select_only_ids_query_part_initialization_ts = fields.iter().map(|element: &macros_helpers::SynFieldWrapper| {
            ...
            quote! {
                match #field_type_as_postgres_crud_postgres_type_postgres_type_ts #SelectOnlyIdsQueryPartSc(#field_ident_double_quotes_ts) {
                    Ok(value_aa341baf) => {
    ...
    let gen_write_into_buffer_query_part_syn_variant_error_initialization_eprintln_response_creation_ts =
        |operation: &Operation| {
            let query_part_error_named_write_into_buffer_ts =
                postgres_crud_macros_common::gen_query_part_error_named_write_into_buffer_ts(
                    import_path,
                );
    ...
    let create_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {(vec![#postgres_crud_default_option_some_vec_one_el_call_ts])},
            ),
        );
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &std_vec_vec_ident_read_only_ids_ts, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    quote! {#PostgresCrudSc::gen_create_many_query_string(
                        #TableSc,
                ...
                let postgres_logic_ts =
                    wrap_content_into_postgres_transaction_begin_commit_value_ts(
                        &operation,
                        &gen_create_update_delete_many_fetch_ts(
        ...
        let try_operation_ts = {
            let try_operation_error_named_ts = gen_ident_try_operation_error_named_ts(
                &operation,
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.create_many_content_write_into_gen_postgres_table_create_many,
        "gen_postgres_table_create_many",
        &create_many_ts,
                ...
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &ident_read_only_ids_ucc, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    let select_only_ids_query_part_ts =
                        gen_select_only_ids_query_part_ts(&operation);
                    quote! {
                        #PostgresCrudSc::gen_create_one_query_string(
                            #TableSc,
                            #column_names_double_quotes_ts,
                ...
                let binded_query_ts = {
                    ...
                    quote! {
                        let mut #QuerySc = #sqlx_query_sqlx_postgres_ts(&#QueryStringSc);
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.create_one_content_write_into_gen_postgres_table_create_one,
        "gen_postgres_table_create_one",
        &create_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let read_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {{
                    ...
                    #pub_select_postgres_crud_not_empty_unique_vec_ident_select_ts,
                    pub #OrderBySc: #postgres_crud_order_by_ts<#ident_select_ucc>,
                    pub #PaginationSc: postgres_crud::PaginationStartsWithZero,
                }},
                &quote! {{
                    #where_many_postgres_crud_default_option_some_vec_one_el_call_ts,
                    #select_postgres_crud_default_option_some_vec_one_el_call_ts,
                    #OrderBySc: postgres_crud::OrderBy {
                    ...
                    #PaginationSc: #postgres_crud_default_option_some_vec_one_el_call_ts,
                }},
            ),
        );
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &std_vec_vec_struct_options_ident_ts, &type_variants_from_request_response_syn_variants);
            {
                let parameters_logic_ts = gen_parameters_logic_ts(&operation);
                let query_string_ts = {
                    ...
                    let additional_paramaters_initialization_ts =
                        gen_read_or_delete_many_additional_paramaters_initialization_ts(
                            &ReadManyOrDeleteMany::ReadMany,
                        );
                    let additional_parameters_order_by_handle_ts =
                        gen_quotes::double_quotes_ts(&format!("{{}}{OrderSc} {BySc} {{}} {{}}"));
                    ...
                    let if_write_is_err_curly_braces_0_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                        &quote! {
                            ...
                            #ParametersSc.#PayloadSc.#OrderBySc.#OrderSc.as_ref().map_or_else(
                                || postgres_crud::Order::default().to_sc_str(),
                    ...
                    let if_write_is_err_curly_braces_1_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                        &quote! {
                            #AdditionalParametersSc,
                            "{prefix}{}",
                            match #postgres_crud_postgres_type_where_filter_query_part_ts(
                    ...
                    quote! {#PostgresCrudSc::gen_read_many_query_string(
                        #TableSc,
                        &#select_query_part_parameters_payload_select_ts,
                        &{
                            #increment_initialization_ts
                            let mut #AdditionalParametersSc = #additional_paramaters_initialization_ts;
                ...
                let binded_query_ts = {
                    let query_postgres_type_where_filter_query_bind_parameters_payload_where_many_query_ts = gen_query_postgres_type_where_filter_query_bind_parameters_payload_where_many_query_ts(&operation);
                    let postgres_syn_variant_error_initialization_eprintln_response_creation_ts =
                        gen_operation_error_initialization_eprintln_response_creation_ts(
                            &operation,
                            &try_bind_syn_variant_wrapper,
                    ...
                    quote! {
                        let mut #QuerySc = #sqlx_query_sqlx_postgres_ts(&#QueryStringSc);
                        #query_postgres_type_where_filter_query_bind_parameters_payload_where_many_query_ts
                        match #postgres_crud_postgres_type_where_filter_query_bind_ts(
                            #ParametersSc.#PayloadSc.pagination,
                            #QuerySc,
                        ) {
                            Ok(value_9f7e487b) => {
                ...
                let postgres_logic_ts = {
                    let fetch_ts = gen_fetch_ts(
                        &ExecutorAcquireSc,
                        &{
                            let match_ident_read_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts = gen_match_ident_read_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts(&ReadManyOrReadOne::ReadMany);
                            quote! {Some(#match_ident_read_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts)}
                        },
                        &gen_operation_error_initialization_eprintln_response_creation_ts(
                            &operation,
                            &postgres_syn_variant_wrapper,
        ...
        let try_operation_ts = {
            let try_operation_error_named_ts =
                gen_ident_try_operation_error_named_ts(&operation, &{
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.read_many_content_write_into_gen_postgres_table_read_many,
        "gen_postgres_table_read_many",
        &read_many_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let read_one_ts = {
        ...
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts = gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &ident_read_ucc, &type_variants_from_request_response_syn_variants);
            {
                let parameters_logic_ts = gen_parameters_logic_ts(&operation);
                let query_string_ts = {
                    let select_query_part_parameters_payload_select_ts =
                    ...
                    quote! {#PostgresCrudSc::gen_read_one_query_string(
                        #TableSc,
                        &#select_query_part_parameters_payload_select_ts,
                        &match #postgres_crud_postgres_type_where_filter_query_part_ts(
                ...
                let binded_query_ts = {
                    let binded_query_modifications_ts = {
                        ...
                        quote! {
                            match #postgres_crud_postgres_type_where_filter_query_bind_ts(#ParametersSc.#PayloadSc.#primary_key_field_ident, #QuerySc) {
                                Ok(value_80ee6983) => {
                ...
                let postgres_logic_ts = gen_fetch_one_ts(
                    &ExecutorAcquireSc,
                    &gen_match_ident_read_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts(&ReadManyOrReadOne::ReadOne),
                    &gen_operation_error_initialization_eprintln_response_creation_ts(&operation, &postgres_syn_variant_wrapper, file!(), line!(), column!()),
                );
                impl_ident_vec_ts.push(gen_operation_ts(
                    &operation,
                    &common_additional_logic_ts,
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.read_one_content_write_into_gen_postgres_table_read_one,
        "gen_postgres_table_read_one",
        &read_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    ...
    let update_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(&operation, {
            ...
            let ident_operation_payload_try_new_error_named_ts =
                macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
                    .make_pub()
                    .derive_debug()
                    .derive_thiserror_error()
                    ...
                    &quote! {
                        ...
                        for el_35facc3a in &#ValueSc {
                            if acc_6bf275fc.contains(&&el_35facc3a.#primary_key_field_ident) {
                                return Err(#ident_operation_payload_try_new_error_named_ucc::#not_unique_primary_key_ucc {
            ...
            let impl_serde_deserialize_for_ident_update_many_payload_ts = {
                let tuple_struct_ident_operation_payload_double_quotes_ts =
                    gen_quotes::double_quotes_ts(&format!(
                        "tuple struct {ident_operation_payload_ucc}"
                    ));
                ...
                let match_ident_update_many_payload_try_new_field0_ts =
                    postgres_crud_macros_common::gen_match_try_new_in_deserialize_ts(
                        &ident_operation_payload_ucc,
                        &quote! {__field0},
                    );
                let ident_operation_payload_double_quotes_ts =
                    gen_quotes::double_quotes_ts(&ident_operation_payload_ucc);
                quote! {
            ...
            let impl_postgres_crud_default_option_some_vec_one_el_for_operation_payload_ts =
                gen_impl_postgres_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                    &ident_operation_payload_ucc,
                    &quote! {
                        Self(vec![#postgres_crud_default_option_some_vec_one_el_call_ts])
                    },
                );
            quote! {
                                ...
                                quote! {
                                    {
                                        ...
                                        if #is_field_ident_update_exists_sc {
                                            acc_b86a253a.push_str(&
                                                postgres_crud::gen_column_equals_case_acc_else_column_end_comma_update_many_query_part(
                                                    #field_ident_double_quotes_ts,
                                                    &{
                                                        ...
                                                        for el_defbc401 in &#UpdateForQueryVecSc {
                                                            if let Some(value_3ea04126) = &el_defbc401.#field_ident {
                                                                acc_8ad06c8c.push_str(&#PostgresCrudSc::#gen_when_column_id_then_value_update_many_query_part_sc(
                                                                    Self::#PrimaryKeySc(),
                    ...
                    quote! {
                        {
                            ...
                            postgres_crud::gen_update_many_query_string(
                                #TableSc,
                                &elements,
                                Self::#PrimaryKeySc(),
                                &primary_keys,
                ...
                let binded_query_ts = {
                                ...
                                quote! {
                                    for el_4b24f8f0 in &#UpdateForQueryVecSc {
                                        if let Some(value_2edaa480) = &el_4b24f8f0.#field_ident {
                                            ...
                                            match #as_postgres_crud_postgres_type_postgres_type_ts #UpdateQueryBindSc(
                    ...
                    let primary_key_update_assignment_ts = quote! {
                        for el_323f7dfc in &#UpdateForQueryVecSc {
                            match #primary_key_field_type_as_postgres_type_ts #UpdateQueryBindSc(
                                ...
                                quote! {
                                    for el_a1660ed1 in &#UpdateForQueryVecSc {
                                        if let Some(value_47030ac2) = &el_a1660ed1.#field_ident {
                                            match #as_postgres_crud_postgres_type_postgres_type_ts select_only_updated_ids_query_bind(
                                                &value_47030ac2.#ValueSc,
                                                #QuerySc
                                            ) {
                                                Ok(value_c5b79b95) => {
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.update_many_content_write_into_gen_postgres_table_update_many,
        "gen_postgres_table_update_many",
        &update_many_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let update_one_ts = {
                            ...
                            &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                quote! {
                                    if let Some(value_2d144436) = &#UpdateForQuerySc.#field_ident {
                                        acc_683e37b8.push_str(&#PostgresCrudSc::#gen_column_queals_value_comma_update_one_query_part_sc(
                                            #field_ident_double_quotes_ts,
                    ...
                    quote! {
                        {
                            ...
                            #PostgresCrudSc::gen_update_one_query_string(
                                #TableSc,
                                &#ColumnsSc,
                                Self::#PrimaryKeySc(),
                        ...
                        gen_fields_named_without_primary_key_without_comma_ts(
                            &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                let as_postgres_crud_postgres_type_postgres_type_ts =
                                    gen_as_postgres_type_ts(&element.field_type);
                                quote! {
                                    if let Some(value_ed87c152) = &#UpdateForQuerySc.#field_ident {
                                        match #as_postgres_crud_postgres_type_postgres_type_ts #UpdateQueryBindSc(
                                            value_ed87c152.#ValueSc.clone(),//todo is there a way to remove .clone here?
                                            #QuerySc
                                        ) {
                                            Ok(value_c3c1b857) => {
                        ...
                        gen_fields_named_without_primary_key_without_comma_ts(
                            &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                let as_postgres_crud_postgres_type_postgres_type_ts =
                                    gen_as_postgres_type_ts(&element.field_type);
                                quote! {
                                    if let Some(value_b2902425) = &#UpdateForQuerySc.#field_ident {
                                        match #as_postgres_crud_postgres_type_postgres_type_ts select_only_updated_ids_query_bind(
                                            &value_b2902425.#ValueSc,
                                            #QuerySc
                                        ) {
                                            Ok(value_cc6145f8) => {
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.update_one_content_write_into_gen_postgres_table_update_one,
        "gen_postgres_table_update_one",
        &update_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    ...
    let delete_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {{#where_many_postgres_crud_default_option_some_vec_one_el_call_ts}},
            ),
        );
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &std_vec_vec_primary_key_field_type_read_ts, &type_variants_from_request_response_syn_variants);
            {
                let parameters_logic_ts = gen_parameters_logic_ts(&operation);
                let query_string_ts = {
                    let additional_paramaters_initialization_ts =
                    ...
                    quote! {#PostgresCrudSc::gen_delete_many_query_string(
                        #TableSc,
                        &{
                            #increment_initialization_ts
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.delete_many_content_write_into_gen_postgres_table_delete_many,
        "gen_postgres_table_delete_many",
        &delete_many_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let delete_one_ts = {
        ...
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &primary_key_field_type_as_postgres_type_read_ucc, &type_variants_from_request_response_syn_variants);
            {
                let parameters_logic_ts = gen_parameters_logic_ts(&operation);
                let query_string_ts = quote! {#PostgresCrudSc::gen_delete_one_query_string(
                    #TableSc,
                    Self::#PrimaryKeySc(),
                )};
                let binded_query_ts = {
                    ...
                    quote! {
                        let mut #QuerySc = #sqlx_query_sqlx_postgres_ts(&#QueryStringSc);
                        match postgres_crud::PostgresTypeWhereFilter::query_bind(
                            #ParametersSc.#PayloadSc.#primary_key_field_ident,
                            #QuerySc
                        ) {
                            Ok(value_3099ea0f) => {
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.delete_one_content_write_into_gen_postgres_table_delete_one,
        "gen_postgres_table_delete_one",
        &delete_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
            ...
            let operation_routes_ts = [
                ...
                let (
                    ...
                    let gen_slash_route_double_quotes_ts = |
                        value: &dyn Display
                    | gen_quotes::double_quotes_ts(&format!("/{value}"));
                    (
                ...
                quote!{
                    .route(#slash_operation_double_quotes_ts, axum::routing::#method_ts({
                        ...
                        async move |
                            app_state_99328dfe: axum::extract::State<std::sync::Arc<dyn postgres_crud::CombinationOfAppStateLogicTraits>>,
    ...
    let ident_tests_ts = {
        ...
        let ident_double_quotes_ts = gen_quotes::double_quotes_ts(&DisplayToScStr::case(&ident));
        ...
        let gen_postgres_type_where_try_new_primary_key_content_ts = quote! {
            #import_path::PostgresTypeWhere::try_new(
                logical_operator,
                vec
        ...
        let ident_create_default_fields_initialization_without_primary_key_ts =
            gen_fields_named_without_primary_key_with_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_type_as_postgres_type_create_ts =
                        gen_as_postgres_type_create_ts(&element.field_type);
                    quote! {
                        #field_ident: <#field_type_as_postgres_type_create_ts as postgres_crud::DefaultOptionSomeVecOneEl>::default_option_some_vec_one_el()
                    }
                },
            );
        let fields_none_initialization_ts = gen_fields_named_without_primary_key_with_comma_ts(
            &|element: &macros_helpers::SynFieldWrapper| {
                let field_ident = &element.field_ident;
        ...
        let select_default_all_with_max_page_size_not_empty_unique_vec_ts = {
            ...
            quote! {
                let select_default_all_with_max_page_size = postgres_crud::NotEmptyUniqueVec::try_new(vec![
                    #content_ts
            ...
            |method_ts: &dyn ToTokens, parameters_ts: &dyn ToTokens| {
                quote! {
                    <
                        #primary_key_field_type
                        as
                        postgres_crud::PostgresTypePrimaryKey
                    >::#method_ts(
                        #parameters_ts
                    )
                }
        ...
        let primary_key_field_type_as_postgres_type_update_as_postgres_type_primary_key_read_only_ids_into_update_ts = {
            let method_call_ts =
                gen_primary_key_field_type_as_postgres_type_primary_key_method_call_ts(
                 ...
                 should_add_dot_clone: &ShouldAddDotClone| {
                    gen_fields_named_without_primary_key_with_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| {
                            ...
                            quote! {
                                #current_field_ident: <#current_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(
        ...
        let common_read_only_ids_returned_from_create_one_ts = {
            ...
            let value_initialization_ts =
                gen_import_path_value_initialization_ts(&primary_key_read_clone_ts);
            quote! {
                let #CommonReadOnlyIdsReturnedFromCreateOneSc = {
                    let read_only_ids_from_try_create_one = gen_read_only_ids_from_try_create_one_default(&#UrlSc, &table_initialization).await;
        ...
        let mut fill_table_field_idents_vec_ts = |test_names: Vec<&str>| {
            for el_8f39799f in test_names {
                ...
                table_field_idents_initialization_vec_ts.push(gen_fields_named_without_primary_key_without_comma_ts(&|el_51b56762: &macros_helpers::SynFieldWrapper| {
                    ...
                    let format_content_ts = gen_quotes::double_quotes_ts(&format!("{el_8f39799f}_{field_ident}"));
                    quote! {
                    ...
                    gen_fields_named_without_primary_key_without_comma_ts(
                        &|el_785024b5: &macros_helpers::SynFieldWrapper| {
                            ...
                            let initialization_variable_name_ts =
                                gen_initialization_variable_name_ts(field_ident);
                            quote! {&#initialization_variable_name_ts,}
                        },
                    ),
                );
            }
        ...
        let table_create_into_postgres_type_option_vec_where_dimension_one_equal_name =
            "72940b0e_cd26_493f_9ec1_2d999d9a4401";
        let table_read_only_ids_merged_with_table_type_declaration_into_postgres_type_option_where_greater_than_name =
            "5a52af33_a590_403b_808e_961df6d7e7aa";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_one_equal_name =
            "1f388ef8_dc28_489d_bed9_ca4e7f640dd5";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_two_equal_name =
            "581c947f_9b0f_452f_8e52_524088bbb2e7";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_three_equal_name =
            "de556c26_9297_4adb_9483_22d474cf1e7d";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_four_equal_name =
            "35b26a97_abdd_4cf9_b4e5_aa9b47aa1a0d";
        let table_create_into_postgres_json_type_option_vec_where_length_equal_name =
            "1ce53b67_1e94_413e_83cf_c6d7094289a8";
        let table_create_into_postgres_json_type_option_vec_where_length_greater_than_name =
            "6b6bdfe0_c7b8_43fd_ac2e_854a47c0b64c";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_greater_than_name =
            "35a01678_f7e2_482d_9803_c3b5a23d36ad";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_between_name =
            "33a3706a_ef28_4c80_88e0_b8e7fb720de2";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_in_name =
            "a3e2165c_e030_4b31_ab3d_dcd29f27f90b";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_regular_expression_name =
            "427ac837_383b_4af1_b956_3e64a78e1449";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_contains_el_greater_than_name =
            "fe3267a0_f49a_42ce_8e51_2a10e5360eb8";
        let table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_contains_el_regular_expression_name =
        ...
        fill_table_field_idents_vec_ts(vec![
            ...
            &table_create_into_postgres_type_option_vec_where_dimension_one_equal_name,
            &table_read_only_ids_merged_with_table_type_declaration_into_postgres_type_option_where_greater_than_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_one_equal_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_two_equal_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_three_equal_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_four_equal_name,
            &table_create_into_postgres_json_type_option_vec_where_length_equal_name,
            &table_create_into_postgres_json_type_option_vec_where_length_greater_than_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_greater_than_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_between_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_in_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_regular_expression_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_contains_el_greater_than_name,
            &table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_contains_el_regular_expression_name,
        ]);
                                ...
                                if field_ident == current_field_ident {
                                    quote! {
                                        if let Some(value_a5f7e6cd) = &common_read_only_ids_returned_from_create_one.#current_field_ident {
                                            for el_b3522b7d in <#current_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(value_a5f7e6cd) {
        ...
        let gen_read_only_ids_current_elements_ts = {
                    ...
                    &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                        ...
                        quote! {
                            #current_field_ident: el_f108da5a.#current_field_ident.as_ref().map_or_else(
                                ...
                                <#current_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_option_value_read_default_option_some_vec_one_el
                            )
                        }
                    },
                );
            quote! {
                async fn gen_read_only_ids_current_elements(
                    url: &str,
                    current_table: &str,
                    select_default_all_with_max_page_size: postgres_crud::NotEmptyUniqueVec<#ident_select_ucc>,
                            ...
                            read_only_ids_current_elements.iter().map(|el_f108da5a| {
                                #ident_read_ucc {
                                    #primary_key_field_ident: <
                                        #primary_key_field_type as postgres_crud::PostgresTypeTestCases
        ...
        let create_many_tests_ts = {
            let create_many_tests_ts = gen_fields_named_without_primary_key_without_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    quote! {
                        for el_fce0969c in <#field_type as postgres_crud::PostgresTypeTestCases>::#OptionVecCreateSc().unwrap_or(Vec::new())
                            .chunks(10)
                            .map(Vec::from)
                        {
                            ...
                            acc_9189f86e.push(futures::FutureExt::boxed(async move {
                                                ...
                                                gen_postgres_type_where_try_new_primary_key(
                                                    postgres_crud::LogicalOperator::Or,
                                                    {
                                                        ...
                                                        for el_bf356906 in &read_only_ids_from_try_create_many {
                                                            acc_1381c719.push(#primary_key_field_type_as_postgres_type_where_ts::Equal(postgres_crud::PostgresTypeWhereEqual {
                                                                logical_operator: postgres_crud::LogicalOperator::Or,
                                                                //todo must use trait type instead
                                                                #ValueSc: #primary_key_field_type_table_type_declaration_ts::new(<#primary_key_field_type as postgres_crud::PostgresType>::into_inner(
                                                                    #primary_key_field_type_read_only_ids_into_read_el_bf356906_primary_key_field_ident_ts
                                                                )),
                                                            }));
                                                        }
                                ...
                                let read_only_ids_from_try_delete_many = itertools::Itertools::sorted(
                                        ...
                                        #ident_delete_many_parameters_ucc {
                                            ...
                                            payload: #ident_delete_many_payload_ucc {
                                                where_many: #std_option_option_ident_where_many_ucc(Some(
                                                    #ident_where_many_ucc {
                                                        #primary_key_field_ident: Some(gen_postgres_type_where_try_new_or_primary_keys(
                                    ...
                                    .into_iter()
                                ).collect::<Vec<<#primary_key_field_type as postgres_crud::PostgresType>::Read>>();
                                assert_eq!(
                                    ...
                                    ).collect::<Vec<#primary_key_field_type_as_postgres_type_read_ts>>(),
                                                ...
                                                gen_postgres_type_where_try_new_primary_key(
                                                    postgres_crud::LogicalOperator::Or,
                                                    {
                                                        ...
                                                        for el_a37bca54 in &read_only_ids_from_try_delete_many {
                                                            acc_87ea12c9.push(#primary_key_field_type_where_ts::Equal(postgres_crud::PostgresTypeWhereEqual {
                                                                logical_operator: postgres_crud::LogicalOperator::Or,
                                                                #ValueSc: #primary_key_field_type_table_type_declaration_ts::new(
                                                                    <#primary_key_field_type as postgres_crud::PostgresType>::into_inner(el_a37bca54.clone())
                                                                ),
                                                            }));
                                                        }
                                                        acc_87ea12c9
        ...
        let create_one_tests_ts = {
            let create_one_tests_ts = gen_fields_named_without_primary_key_without_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let value_initialization_ts = gen_import_path_value_initialization_ts(&primary_key_field_type_read_only_ids_into_read_read_only_ids_from_try_create_one_primary_key_field_ident_ts);
                    quote! {
                        for el_7632d698 in <#field_type as postgres_crud::PostgresTypeTestCases>::#OptionVecCreateSc().unwrap_or(Vec::new()) {
        ...
        let add_create_one_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_ts =
            |content_ts: &dyn ToTokens| {
                quote! {
                    ...
                    #content_ts
                    let _: #primary_key_field_type_as_postgres_type_read_ts = gen_try_delete_one_handle(
                        &url_cloned,
                        #primary_key_field_type_read_only_ids_into_read_read_only_ids_from_try_create_one_primary_key_field_ident_ts,
                        &current_table
        ...
        let read_many_tests_ts = {
                            ...
                            gen_try_read_many_order_by_primary_key_with_big_pagination(
                                ...
                                gen_ident_where_many_pripery_key_others_none(
                                    Some(
                                        gen_postgres_type_where_try_new_primary_key(
                                            postgres_crud::LogicalOperator::Or,
                                            std::iter::repeat_with(|| #primary_key_field_type_as_postgres_type_where_ts::Equal(
                                                postgres_crud::PostgresTypeWhereEqual {
                                                    logical_operator: postgres_crud::LogicalOperator::Or,
                                                    #ValueSc: #primary_key_field_type_table_type_declaration_ts::new(
                                                        uuid::Uuid::new_v4()
                            ...
                            #ident::try_delete_many_handle(
                                ...
                                #ident_delete_many_parameters_ucc {
                                    payload: #ident_delete_many_payload_ucc {
                                        where_many: #std_option_option_ident_where_many_ucc(Some(
                                            #ident_where_many_ucc {
                                                #primary_key_field_ident: Some(gen_postgres_type_where_try_new_or_primary_keys(&read_only_ids_from_try_create_many)),
                                                #std_option_option_ident_where_many_content_ts
                                            }
                                        )),
                                    },
                ...
                |ident_where_many_try_new_parameters_content_ts: &dyn ToTokens| {
                    quote! {
                        assert_eq!(
                            vec![
                                #ident_read_ucc {
                                    #primary_key_field_ident: <
                                        #primary_key_field_type
                                        as
                                        postgres_crud::PostgresTypeTestCases
                                    >::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                            ...
                            gen_try_read_many_order_by_primary_key_with_big_pagination(
                                &url_cloned,
                                #ident_where_many_ucc::try_new(#ident_where_many_try_new_parameters_content_ts).expect("83c2d430-9ca6-4131-8ca0-8ce8ecf6af1a"),
                                #select_default_all_with_max_page_size_cloned_clone_ts,
                                &current_table
            ...
            let gen_option_vec_create_call_unwrap_or_vec_ts =
                |_: &syn::Ident, field_type: &syn::Type| {
                    quote! {
                        <#field_type as postgres_crud::PostgresTypeTestCases>::#OptionVecCreateSc().unwrap_or(Vec::new())
                    }
                };
            let gen_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_ts =
                |field_ident: &syn::Ident, field_type: &syn::Type| {
                    quote! {
                        <#field_type as postgres_crud::PostgresTypeTestCases>::#OptionVecCreateSc()
                        .filter(|el_bba28182| !el_bba28182.is_empty())
                        .unwrap_or_else(|| vec![ident_create_default.#field_ident.clone()])
                    }
                };
            let gen_postgres_type_option_vec_where_greater_than_test_unwrap_or_else_vec_call_ts =
                |_: &syn::Ident, field_type: &syn::Type| {
                    quote! {
                        <#field_type as #import_path::PostgresTypeTestCases>::#PostgresTypeOptionVecWhereGreaterThanTestSc()
                                            ...
                                            gen_ident_where_many_pripery_key_others_none(
                                                Some(
                                                    gen_postgres_type_where_try_new_primary_key(
                                                        postgres_crud::LogicalOperator::Or,
                                                        vec![
                                                            #primary_key_field_type_where_ts::Equal(postgres_crud::PostgresTypeWhereEqual {
                                                                logical_operator: postgres_crud::LogicalOperator::Or,
                                                                #ValueSc: #primary_key_field_type_table_type_declaration_ts::new(
                                                                    <#primary_key_field_type as postgres_crud::PostgresType>::into_inner(
                                                                        #primary_key_field_type_read_only_ids_into_read_read_only_ids_returned_from_create_one_primary_key_field_ident_ts
            ...
            let some_primary_key_where_initialization_ts = quote! {
                Some(
                    gen_postgres_type_where_try_new_primary_key(
                        postgres_crud::LogicalOperator::And,
                        vec![
                            <#primary_key_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_merged_with_create_into_where_equal(
                                read_only_ids_returned_from_create_one.#primary_key_field_ident,
                                #postgres_crud_default_option_some_vec_one_el_call_ts
                            )
                        ]
            ...
            let (
                ...
                let gen_test_read_many_by_equal_one_column_value_ts = |test_name: &str, equal_or_equal_using_fields: &postgres_crud_macros_common::EqualOrEqualUsingFields| {
                    gen_read_test_ts(
                        test_name,
                        ...
                        &|element: &macros_helpers::SynFieldWrapper| {
                            let field_ident = &element.field_ident;
                            gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_ac437d52: &macros_helpers::SynFieldWrapper| {
                                ...
                                if current_field_ident == primary_key_field_ident {
                                    ...
                                    let method_content_ts = {
                                        ...
                                        quote!{
                                            <#current_field_type as postgres_crud::PostgresTypeTestCases>::#method_ts(
                                    ...
                                    match &equal_or_equal_using_fields {
                                        postgres_crud_macros_common::EqualOrEqualUsingFields::Equal => gen_some_postgres_type_where_try_new_and_ts(&quote!{
                                            vec![#method_content_ts]
                                        }),
                                        postgres_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields => quote!{
                                            Some(#import_path::PostgresTypeWhere::new(
                ...
                (
                    gen_test_read_many_by_equal_one_column_value_ts(table_read_only_ids_merged_with_create_into_where_equal_name, &postgres_crud_macros_common::EqualOrEqualUsingFields::Equal),
                    gen_test_read_many_by_equal_one_column_value_ts(table_read_only_ids_merged_with_create_into_vec_where_equal_using_fields_name, &postgres_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields),
                )
            };
            let read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_ts = gen_read_test_ts(table_read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_name, &gen_option_vec_create_call_unwrap_or_vec_ts, &gen_ident_create_content_el_ts, &|element: &macros_helpers::SynFieldWrapper| {
                let field_ident = &element.field_ident;
                let field_type = &element.field_type;
                let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_97d8a089: &macros_helpers::SynFieldWrapper| {
                    let current_field_ident = &el_97d8a089.field_ident;
                    if current_field_ident == primary_key_field_ident {
                        some_primary_key_where_initialization_ts.clone()
                    } else if current_field_ident == field_ident {
                        gen_some_postgres_type_where_try_new_and_ts(&quote! {vec![el_48a3d976]})
                    } else {
                        none_ts.clone()
                    }
                }));
                quote! {
                    if let Some(value_d5cd3c70) = <#field_type as postgres_crud::PostgresTypeTestCases>::#ReadOnlyIdsMergedWithCreateIntoOptionVecWhereEqualToJsonFieldSc(
            ...
            let create_into_postgres_type_option_vec_where_dimension_one_equal_ts =
                gen_read_test_ts(
                    table_create_into_postgres_type_option_vec_where_dimension_one_equal_name,
                    &gen_option_vec_create_call_unwrap_or_vec_ts,
                    &gen_ident_create_content_el_ts,
                    &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                &gen_fields_named_with_comma_ts(
                                    &|el_483e5312: &macros_helpers::SynFieldWrapper| {
                                        ...
                                        if primary_key_field_ident == current_field_ident {
                                            ...
                                            gen_some_postgres_type_where_try_new_and_ts(
                                                &quote! {vec![el_39d1fb5d]},
                                            )
                                        } else {
                                            none_ts.clone()
                                        }
                        ...
                        quote! {
                            if let Some(value_b02d763d) = <#field_type as postgres_crud::PostgresTypeTestCases>::#CreateIntoPostgresTypeOptionVecWhereDimensionOneEqualSc(
                                ident_create.#field_ident.clone()
                            ) {
            ...
            let read_only_ids_merged_with_table_type_declaration_into_postgres_type_option_where_greater_than_ts = gen_read_test_ts(
                table_read_only_ids_merged_with_table_type_declaration_into_postgres_type_option_where_greater_than_name,
                &gen_postgres_type_option_vec_where_greater_than_test_unwrap_or_else_vec_call_ts,
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_type = &element.field_type;
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_a8bfc0c0: &macros_helpers::SynFieldWrapper| {
                        let current_field_ident = &el_a8bfc0c0.field_ident;
                        if current_field_ident == primary_key_field_ident {
                            some_primary_key_where_initialization_ts.clone()
                        } else if current_field_ident == field_ident {
                            gen_some_postgres_type_where_try_new_and_ts(&quote! {vec![value_60baba1f]})
                        } else {
                            none_ts.clone()
                        }
                    }));
                    quote! {
                        if let Some(value_60baba1f) = <#field_type as postgres_crud::PostgresTypeTestCases>::#ReadOnlyIdsMergedWithTableTypeDeclarationIntoPostgresTypeOptionWhereGreaterThanSc(
                            #ElementSc.variant,
            ...
            let (
                ...
                let gen_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_number_equal_ts =
                    |test_name: &str, dimension: &postgres_crud_macros_common::Dimension| {
                        ...
                        gen_read_test_ts(test_name, &gen_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_ts, &gen_ident_create_content_el_ts, &|element: &macros_helpers::SynFieldWrapper| {
                        let field_ident = &element.field_ident;
                        let field_type = &element.field_type;
                        let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_a9b23eca: &macros_helpers::SynFieldWrapper| {
                            let current_field_ident = &el_a9b23eca.field_ident;
                            if current_field_ident == primary_key_field_ident {
                                some_primary_key_where_initialization_ts.clone()
                            } else if current_field_ident == field_ident {
                                gen_some_postgres_type_where_try_new_and_ts(&quote! {vec![el_3efa0bb4]})
                            } else {
                                none_ts.clone()
                            }
                        }));
                        quote! {
                            if let Some(value_bb67b871) = <#field_type as postgres_crud::PostgresTypeTestCases>::#read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_number_equal_sc(
                ...
                (
                    gen_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_one_equal_name, &postgres_crud_macros_common::Dimension::One),
                    gen_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_two_equal_name, &postgres_crud_macros_common::Dimension::Two),
                    gen_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_three_equal_name, &postgres_crud_macros_common::Dimension::Three),
                    gen_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_four_equal_name, &postgres_crud_macros_common::Dimension::Four),
                )
            };
            let create_into_postgres_json_type_option_vec_where_length_equal_ts = gen_read_test_ts(
                table_create_into_postgres_json_type_option_vec_where_length_equal_name,
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(
                        &gen_fields_named_with_comma_ts(
                            &|el_94f00070: &macros_helpers::SynFieldWrapper| {
                                let current_field_ident = &el_94f00070.field_ident;
                                if current_field_ident == primary_key_field_ident {
                                    some_primary_key_where_initialization_ts.clone()
                                } else if current_field_ident == field_ident {
                                    gen_some_postgres_type_where_try_new_and_ts(
                                        &quote! {vec![el_c09ef321]},
                                    )
                                } else {
                                    none_ts.clone()
                                }
                    ...
                    quote! {
                        if let Some(value_f825e068) = <#field_type as postgres_crud::PostgresTypeTestCases>::#CreateIntoPostgresJsonTypeOptionVecWhereLengthEqualSc(
                            ident_create.#field_ident.clone()
                        ) {
            ...
            let create_into_postgres_json_type_option_vec_where_length_greater_than_ts = gen_read_test_ts(
                table_create_into_postgres_json_type_option_vec_where_length_greater_than_name,
                &gen_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_ts,
                &gen_ident_create_content_el_ts,
                &|element: &macros_helpers::SynFieldWrapper|{
                    ...
                    let field_type = &element.field_type;
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(
                        &gen_fields_named_with_comma_ts(&|el_c927ab80: &macros_helpers::SynFieldWrapper|{
                            let current_field_ident = &el_c927ab80.field_ident;
                            if current_field_ident == primary_key_field_ident {
                                some_primary_key_where_initialization_ts.clone()
                            }
                            else if current_field_ident == field_ident {
                                gen_some_postgres_type_where_try_new_and_ts(&quote!{vec![el_527b546b]})
                            } else {
                                none_ts.clone()
                            }
                        })
                    ...
                    quote!{
                        if let Some(value_cd4aa374) = <#field_type as postgres_crud::PostgresTypeTestCases>::#CreateIntoPostgresJsonTypeOptionVecWhereLengthGreaterThanSc(
                            ident_create.#field_ident.clone()
                        ) {
            ...
            let (
                ...
                let gen_read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_filter_ts =
                    ...
                    &|element: &macros_helpers::SynFieldWrapper|{
                        ...
                        let field_type = &element.field_type;
                        let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(
                            &gen_fields_named_with_comma_ts(&|el_16b8a9cc: &macros_helpers::SynFieldWrapper|{
                                let current_field_ident = &el_16b8a9cc.field_ident;
                                if current_field_ident == primary_key_field_ident {
                                    some_primary_key_where_initialization_ts.clone()
                                }
                                else if current_field_ident == field_ident {
                                    gen_some_postgres_type_where_try_new_and_ts(&quote!{match el_feacc53b {
                        ...
                        quote!{
                            if let Some(value_0b85c066) = <#field_type as postgres_crud::PostgresTypeTestCases>::#method_ts(
        ...
        let read_one_tests_ts = quote! {
            acc_9189f86e.push({
                ...
                futures::FutureExt::boxed(async move {
                    gen_check_no_rows_returned_from_ident_try_read_one_handle_primary_key(
                        &url_cloned,
                        #primary_key_field_type_as_postgres_type_read_ts::new(uuid::Uuid::new_v4()),
                        #select_default_all_with_max_page_size_cloned_clone_ts,
                                            ...
                                            gen_ident_where_many_pripery_key_others_none(
                                                Some(
                                                    gen_postgres_type_where_try_new_primary_key(
                                                        postgres_crud::LogicalOperator::Or,
                                                        vec![
                                                            #primary_key_field_type_as_postgres_type_where_ts::Equal(
                                                                postgres_crud::PostgresTypeWhereEqual {
                                                                    logical_operator: postgres_crud::LogicalOperator::Or,
                                                                    value: #primary_key_field_type_table_type_declaration_ts::new(
                                                                        #primary_key_field_type_as_postgres_type_ts into_inner(
                                                                            #primary_key_field_type_read_only_is_into_read_read_only_ids_current_el_primary_key_field_ident_ts
                                                                        )
                                                                    ),
                                                                }
                        ...
                        let ident_read_only_ids_upper_fields_initialization_without_primary_key_ts =
                            gen_fields_named_without_primary_key_with_comma_ts(
                                &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                                    ...
                                    let current_field_type = &syn_field_wrapper.field_type;
                                    if field_ident == current_field_ident {
                                        quote! {#current_field_ident: Some(<#current_field_type as postgres_crud::PostgresTypeTestCases>::update_to_read_only_ids(&update))}
                                    } else {
                                        quote! {#current_field_ident: None}
                                    }
                                },
                            );
                        let ident_update_parameters_initialization_without_primary_key_ts =
                            gen_fields_named_without_primary_key_with_comma_ts(
                                &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                                    ...
                                    if field_ident == current_field_ident {
                                        let value_initialization_ts =
                                            gen_import_path_value_initialization_ts(&quote! {
                                                #UpdateSc.clone()
                                            });
                        ...
                        let ident_read_fields_initialization_without_primary_key_after_update_one_ts =
                            gen_fields_named_without_primary_key_with_comma_ts(
                                &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                                    ...
                                    if field_ident == current_field_ident {
                                        let value_initialization_ts =
                                            gen_import_path_value_initialization_ts(&{
                                                let current_field_type =
                                                    &syn_field_wrapper.field_type;
                                                quote! {
                                                    <#current_field_type as postgres_crud::PostgresTypeTestCases>::previous_read_merged_with_option_update_into_read(
                                                        <#current_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                                                            &read_only_ids_current_element.#current_field_ident.clone().expect("96213542-59eb-4767-b120-d9ba575087c8")
                                                        ).expect("bf0d6f55-7457-4ec1-8b79-50efad297ccb").#ValueSc,
                                                        Some(#UpdateSc.clone())
                                                    )
                                                }
                                            });
                            ...
                            for (index_7f181188, read_only_ids_current_element) in gen_read_only_ids_current_elements(
                                ...
                                acc_9189f86e.push(futures::FutureExt::boxed(async move {
                                    ...
                                    >::read_inner_into_update_with_new_or_try_new_unwraped({
                                        ...
                                        for el_76abae3a in <#field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(
                                            ...
                                            #ident_update_many_parameters_ucc {
                                                payload: #ident_update_many_payload_ucc::try_new(vec![
                                                    #ident_update_ucc::try_new(
                                                        #primary_key_field_type_as_postgres_type_update_as_postgres_type_primary_key_read_only_ids_into_update_ts,
                                        ...
                                        let value_initialization_ts =
                                            gen_import_path_value_initialization_ts(&quote! {
                                                ...
                                                >::previous_read_merged_with_option_update_into_read(
                                                    ...
                                                    ).expect("c7685b19-9bca-47bc-a3a5-8fc543b174a5").#ValueSc,
                                                    Some(#UpdateSc.clone())
                                                )
                                            });
                                        quote! {
                            ...
                            for (index_26824592, read_only_ids_current_element) in gen_read_only_ids_current_elements(
                                ...
                                acc_9189f86e.push(futures::FutureExt::boxed(async move {
                                    ...
                                    >::read_inner_into_update_with_new_or_try_new_unwraped({
                                        ...
                                        let mut option_test_case = None;
                                        for el_3a9a65ee in <#field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(
                            ...
                            #ident_delete_many_parameters_ucc {
                                payload: #ident_delete_many_payload_ucc {
                                    where_many: #std_option_option_ident_where_many_ucc(Some(#ident_where_many_ucc {
                                        #primary_key_field_ident: Some(
                                            gen_postgres_type_where_try_new_primary_key(
                                                postgres_crud::LogicalOperator::Or,//here
                                                read_only_ids_from_try_create_many.iter().map(|el_3bb88958| #primary_key_field_type_as_postgres_type_where_ts::Equal(
                                                    postgres_crud::PostgresTypeWhereEqual {
                                                        logical_operator: postgres_crud::LogicalOperator::Or,
                        ...
                        assert_eq!(
                            read_only_ids_from_try_delete_many,
                            {
                                read_only_ids_from_try_create_many.iter().map(|el_ba0f6b1c|
                                    <#primary_key_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                                        &el_ba0f6b1c.#primary_key_field_ident
                                    ).expect("3ee5ee86-05dc-4dc8-9262-8ffa1855d5e4").#ValueSc
                                ).collect::<Vec<#primary_key_field_type_as_postgres_type_read_ts>>()
                            },
                            ...
                            gen_try_read_many_order_by_primary_key_with_big_pagination(
                                ...
                                gen_ident_where_many_pripery_key_others_none(
                                    Some(
                                        gen_postgres_type_where_try_new_primary_key(
                                            postgres_crud::LogicalOperator::Or,
                                            read_only_ids_from_try_delete_many.into_iter().map(|el_adcc8db3| #primary_key_field_type_as_postgres_type_where_ts::Equal(
                                                postgres_crud::PostgresTypeWhereEqual {
                                                    logical_operator: postgres_crud::LogicalOperator::Or,
        ...
        let delete_one_tests_ts = {
            let value_initialization_ts = gen_import_path_value_initialization_ts(&primary_key_field_type_read_only_ids_into_read_read_only_ids_returned_from_create_one_primary_key_field_ident_ts);
            quote! {
                acc_9189f86e.push({
                    ...
                    futures::FutureExt::boxed(async move {
                        if let Err(#ErrorSc) = gen_try_delete_one_handle(
                            ...
                            if let #ident_try_delete_one_error_named_ucc::#ident_delete_one_error_named_with_serialize_deserialize_ucc {
                                delete_one_error_named_with_serialize_deserialize,
                                ..
                            } = #ErrorSc {
                                if let #ident_delete_one_error_named_with_serialize_deserialize_ucc::Postgres {
                                    postgres,
                                    ..
                                } = delete_one_error_named_with_serialize_deserialize {
                                    assert!(postgres == no_rows_returned_by_a_query_that_expected_to_return_at_least_one_row(), "c9261bb8-d391-4c4b-9707-3a2c4278ad90");
                                } else {
            ...
            mod #ident_tests_sc {
                ...
                fn crud() {
                    fn gen_ident_where_many_pripery_key_others_none(
                        option_postgres_type_where: Option<#import_path::PostgresTypeWhere<#primary_key_field_type_as_postgres_type_where_ts>>,
                    ) -> #ident_where_many_ucc {
                        #ident_where_many_ucc::try_new(
                            option_postgres_type_where,
                            #fields_named_without_primary_key_with_comma_none_ts
                        )
                        .expect("5fb2b219-8bd7-4edd-9722-b475826707f5")
                    }
                    fn gen_postgres_type_where_try_new_primary_key(
                        logical_operator: #import_path::LogicalOperator,
                        vec: Vec<#primary_key_field_type_where_ts>
                    ) -> #import_path::PostgresTypeWhere<#primary_key_field_type_as_postgres_type_where_ts> {
                        #gen_postgres_type_where_try_new_primary_key_content_ts
                    }
                    fn gen_postgres_type_where_try_new_or_primary_keys(
                        vec_read_only_ids: &[#ident_read_only_ids_ucc]
                    ) -> #import_path::PostgresTypeWhere<#primary_key_field_type_as_postgres_type_where_ts> {
                        gen_postgres_type_where_try_new_primary_key(
                            #import_path::LogicalOperator::Or,
                            vec_read_only_ids.iter().map(|el_9530b728| #primary_key_field_type_where_ts::Equal(#import_path::PostgresTypeWhereEqual {
                                logical_operator: #import_path::LogicalOperator::Or,
                                value: #primary_key_field_type_table_type_declaration_ts::new(
                                    #primary_key_field_type_as_postgres_type_ts into_inner(
                                        <#primary_key_field_type as #import_path::PostgresTypePrimaryKey>::read_only_ids_into_read(
                    ...
                    async fn gen_try_read_many_order_by_primary_key_with_big_pagination(
                        ...
                        current_ident_where_many: #ident_where_many_ucc,
                        select: #import_path::NotEmptyUniqueVec<#ident_select_ucc>,
                        table: &str
                    ) -> Result<Vec<#ident_read_ucc>, #ident_try_read_many_error_named_ucc> {
                                ...
                                payload: #ident_read_many_payload_ucc {
                                    ...
                                    order_by: #import_path::OrderBy {
                                        column: #ident_select_ucc::#primary_key_field_ident_ucc_ts(
                                            #primary_key_field_type_as_postgres_type_select_ts::default()
                                        ),
                    ...
                    async fn gen_ident_try_read_one_handle_primary_key(
                        url: &str,
                        primary_key_column: #primary_key_field_type_as_postgres_type_read_ts,
                        select: #import_path::NotEmptyUniqueVec<#ident_select_ucc>,
                        table: &str,
                    ) -> Result<#ident_read_ucc, #ident_try_read_one_error_named_ucc> {
                    ...
                    async fn gen_check_no_rows_returned_from_ident_try_read_one_handle_primary_key(
                        ...
                        if let Err(#ErrorSc) = gen_ident_try_read_one_handle_primary_key(
                            ...
                            if let #ident_try_read_one_error_named_ucc::#ident_read_one_error_named_with_serialize_deserialize_ucc {
                                read_one_error_named_with_serialize_deserialize,
                                ..
                            } = error {
                                if let #ident_read_one_error_named_with_serialize_deserialize_ucc::Postgres { postgres, .. } = read_one_error_named_with_serialize_deserialize {
                                    assert!(postgres == no_rows_returned_by_a_query_that_expected_to_return_at_least_one_row(), "58b9a6a4-cf9b-49f3-a20f-7007deea40fd");
                                } else {
                    ...
                    async fn gen_try_delete_one_handle(
                        #UrlSc: &str,
                        #primary_key_field_ident: #primary_key_field_type_as_postgres_type_read_ts,
                        table: &str,
                    ) -> Result<#primary_key_field_type_as_postgres_type_read_ts, #ident_try_delete_one_error_named_ucc> {
                    ...
                    fn gen_vec_ident_read_from_vec_ident_read_only_ids_with_vec_ident_create(
                        ...
                        for (read_only_ids, create) in read_only_ids_from_try_create_many.into_iter().zip(ident_vec_create.into_iter()) {
                            acc_1debe8fb.push(#ident_read_ucc {
                                #primary_key_field_ident: <#primary_key_field_type as postgres_crud::PostgresTypeTestCases>::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                    ...
                    tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                        ...
                        let #PostgresPoolSc = sqlx::postgres::PgPoolOptions::new()
                        .max_connections(50)
                        ...
                        //do not make it concurrent. would be postgres error: "duplicate key value violates unique constraint \"pg_class_relname_nsp_index\""
                        for el_dac43b91 in table_names {
                            #ident::prepare_postgres_table(
                                &#PostgresPoolSc,
                                el_dac43b91,
                            ).await.expect("c7952247-dc94-441b-9aef-368b8fdc593c");
                        }
                        let #PostgresPoolForTokioSpawnSyncMoveSc = #PostgresPoolSc.clone();
                        ...
                        let #underscore_unused_ts = tokio::spawn(async move {
                            let tcp_listener = tokio::net::TcpListener::bind(app_state::GetServiceSocketAddress::get_service_socket_address(&#ConfigSc)).await.expect("663ae29e-bc00-4ea1-a7e9-4dddceb5b53a");
                            let #AppStateSc = std::sync::Arc::new(server_app_state::ServerAppState {
                                #PostgresPoolSc: #PostgresPoolForTokioSpawnSyncMoveSc.clone(),
                                #ConfigSc,
                        ...
                        let #SelectPrimaryKeySc = postgres_crud::NotEmptyUniqueVec::try_new(vec![
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.tests_content_write_into_gen_postgres_table_tests,
        "gen_postgres_table_Tests",
        &ident_tests_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let common_ts = quote! {
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.common_content_write_into_gen_postgres_table_common,
        "gen_postgres_table_common",
        &common_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let gend = {
        let ident_gen_postgres_table_mod_sc = SelfGenPostgresTableModSc::from_tokens(&ident);
        ...
        quote! {
            #[allow(unused_qualifications)]
            #[allow(clippy::absolute_paths)]
            mod #ident_gen_postgres_table_mod_sc {
                use super::#ident;
                #content_ts_1c0e3fcd
            }
            pub use #ident_gen_postgres_table_mod_sc::*;
        }
    };
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_table_config.whole_content_write_into_gen_postgres_table,
        "gen_postgres_table",
        &gend,
        &macros_helpers::FormatWithCargofmt::True,
    );
