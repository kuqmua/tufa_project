use naming::{
    ...
    EqualUcc, ErrorSc, GenPostgresJsonTypesModSc, IncrementSc, JsonbSetAccumulatorSc, NewSc,
    NumberUcc, OptionUpdateSc, OptionVecCreateSc, PostgresJsonTypeUcc, QuerySc, ReadInnerUcc,
...
pub fn gen_postgres_json_types(input_ts: &Ts2) -> Ts2 {
    ...
    impl From<&PostgresJsonType> for RustTypeName {
        fn from(value: &PostgresJsonType) -> Self {
            match &value {
                PostgresJsonType::StdPrimitiveI8AsJsonbNumber => Self::StdPrimitiveI8,
                PostgresJsonType::StdPrimitiveI16AsJsonbNumber => Self::StdPrimitiveI16,
                PostgresJsonType::StdPrimitiveI32AsJsonbNumber => Self::StdPrimitiveI32,
                PostgresJsonType::StdPrimitiveI64AsJsonbNumber => Self::StdPrimitiveI64,
                PostgresJsonType::StdPrimitiveU8AsJsonbNumber => Self::StdPrimitiveU8,
                PostgresJsonType::StdPrimitiveU16AsJsonbNumber => Self::StdPrimitiveU16,
                PostgresJsonType::StdPrimitiveU32AsJsonbNumber => Self::StdPrimitiveU32,
                PostgresJsonType::StdPrimitiveU64AsJsonbNumber => Self::StdPrimitiveU64,
                PostgresJsonType::StdPrimitiveF32AsJsonbNumber => Self::StdPrimitiveF32,
                PostgresJsonType::StdPrimitiveF64AsJsonbNumber => Self::StdPrimitiveF64,
                PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean => Self::StdPrimitiveBool,
                PostgresJsonType::StdStringStringAsJsonbString => Self::StdStringString,
                PostgresJsonType::UuidUuidAsJsonbString => Self::UuidUuid,
            }
        }
    }
    #[derive(Debug)]
    enum PostgresJsonTypeName {
        Boolean,
        Number,
        String,
    }
    impl Display for PostgresJsonTypeName {
    ...
    impl From<&PostgresJsonType> for PostgresJsonTypeName {
        fn from(value: &PostgresJsonType) -> Self {
            match &value {
                ...
                | PostgresJsonType::StdPrimitiveI64AsJsonbNumber
                | PostgresJsonType::StdPrimitiveU8AsJsonbNumber
                | PostgresJsonType::StdPrimitiveU16AsJsonbNumber
                | PostgresJsonType::StdPrimitiveU32AsJsonbNumber
                | PostgresJsonType::StdPrimitiveU64AsJsonbNumber
                | PostgresJsonType::StdPrimitiveF32AsJsonbNumber
                | PostgresJsonType::StdPrimitiveF64AsJsonbNumber => Self::Number,
                PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean => Self::Boolean,
                PostgresJsonType::StdStringStringAsJsonbString
                | PostgresJsonType::UuidUuidAsJsonbString => Self::String,
            }
        }
    }
    #[allow(clippy::arbitrary_source_item_ordering)]
    ...
    impl TryFrom<&PostgresJsonTypePattern> for ArrayDimension {
        type Error = ();
        fn try_from(value: &PostgresJsonTypePattern) -> Result<Self, Self::Error> {
            match &value {
                PostgresJsonTypePattern::Standart => Err(()),
                PostgresJsonTypePattern::ArrayDimension1 { .. } => Ok(Self::ArrayDimension1),
                ...
                PostgresJsonTypePattern::ArrayDimension4 {
                    dimension1_not_null_or_nullable,
                    dimension2_not_null_or_nullable,
                    dimension3_not_null_or_nullable,
                    ..
    ...
    struct PostgresJsonTypeRecord {
        postgres_json_type: PostgresJsonType,
        not_null_or_nullable: NotNullOrNullable,
        postgres_json_type_pattern: PostgresJsonTypePattern,
    }
    #[allow(clippy::arbitrary_source_item_ordering)]
    #[derive(Debug, serde::Deserialize)]
    enum GenPostgresJsonTypesConfigVariant {
        All,
        WithoutDimensions,
        WithDimensionOne,
        WithDimensionTwo,
        WithDimensionThree,
        WithDimensionFour,
        Concrete(Vec<PostgresJsonTypeRecord>),
    }
    #[allow(clippy::arbitrary_source_item_ordering)]
    #[derive(Debug, serde::Deserialize)]
    struct GenPostgresJsonTypesConfig {
        postgres_table_columns_content_write_into_postgres_table_columns_using_postgres_json_types:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        whole_content_write_into_gen_postgres_json_types:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        variant: GenPostgresJsonTypesConfigVariant,
    }
    ...
    let (fields_ts, postgres_json_type_array) = {
        {
            let gen_standart = |acc_29796d99: &mut Vec<PostgresJsonTypeRecord>, postgres_json_type: PostgresJsonType|{
                for el_2f39e657 in NotNullOrNullable::into_array() {
                    acc_29796d99.push(PostgresJsonTypeRecord {
                        postgres_json_type: postgres_json_type.clone(),
                        not_null_or_nullable: el_2f39e657,
                        postgres_json_type_pattern: PostgresJsonTypePattern::Standart,
                    });
                }
            };
            let gen_array_dimension1 = |acc_5b22a398: &mut Vec<PostgresJsonTypeRecord>, postgres_json_type: PostgresJsonType|{
                for el_29854486 in NotNullOrNullable::into_array() {
                    for el_6440cc9c in NotNullOrNullable::into_array() {
                        acc_5b22a398.push(PostgresJsonTypeRecord {
                            postgres_json_type: postgres_json_type.clone(),
                            not_null_or_nullable: el_29854486,
                            postgres_json_type_pattern: PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable: el_6440cc9c },
                        });
                    }
                }
            };
            let gen_array_dimension2 = |acc_e59f7158: &mut Vec<PostgresJsonTypeRecord>, postgres_json_type: PostgresJsonType|{
                for el_a6ba4c3e in NotNullOrNullable::into_array() {
                    for el_4b5a815d in NotNullOrNullable::into_array() {
                        for el_2e4896dd in NotNullOrNullable::into_array() {
                            acc_e59f7158.push(PostgresJsonTypeRecord {
                                postgres_json_type: postgres_json_type.clone(),
                                not_null_or_nullable: el_a6ba4c3e,
                                postgres_json_type_pattern: PostgresJsonTypePattern::ArrayDimension2 {
            ...
            let gen_array_dimension3 = |acc_77498dc3: &mut Vec<PostgresJsonTypeRecord>, postgres_json_type: PostgresJsonType|{
                    ...
                    for el_a27b642f in NotNullOrNullable::into_array() {
                        for el_dc57e9b7 in NotNullOrNullable::into_array() {
                            for el_4361fee5 in NotNullOrNullable::into_array() {
                                acc_77498dc3.push(PostgresJsonTypeRecord {
                                    postgres_json_type: postgres_json_type.clone(),
                                    not_null_or_nullable: el_8f03b1c2,
                                    postgres_json_type_pattern: PostgresJsonTypePattern::ArrayDimension3 {
            ...
            let gen_array_dimension4 = |acc_7c8a3329: &mut Vec<PostgresJsonTypeRecord>, postgres_json_type: PostgresJsonType|{
                        ...
                        for el_69b59c5c in NotNullOrNullable::into_array() {
                            for el_d7efbd09 in NotNullOrNullable::into_array() {
                                for el_c16cb65b in NotNullOrNullable::into_array() {
                                    acc_7c8a3329.push(PostgresJsonTypeRecord {
                                        postgres_json_type: postgres_json_type.clone(),
                                        not_null_or_nullable: el_daf10957,
                                        postgres_json_type_pattern: PostgresJsonTypePattern::ArrayDimension4 {
            ...
            let acc_d97120ed = match gen_postgres_json_types_config.variant {
                GenPostgresJsonTypesConfigVariant::All => PostgresJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_e2f65a79, postgres_json_type| {
                    for el_644643cd in PostgresJsonTypePattern::into_array() {
                        match &el_644643cd {
                            PostgresJsonTypePattern::Standart => gen_standart(&mut acc_e2f65a79, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_e2f65a79, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_e2f65a79, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension3 { .. } => gen_array_dimension3(&mut acc_e2f65a79, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension4 { .. } => gen_array_dimension4(&mut acc_e2f65a79, postgres_json_type.clone()),
                        }
                    }
                    acc_e2f65a79
                }),
                GenPostgresJsonTypesConfigVariant::WithoutDimensions => PostgresJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_3d95645c, postgres_json_type| {
                    for el_fccf1979 in PostgresJsonTypePattern::into_array() {
                        match &el_fccf1979 {
                            PostgresJsonTypePattern::Standart => gen_standart(&mut acc_3d95645c, postgres_json_type.clone()),
                ...
                GenPostgresJsonTypesConfigVariant::WithDimensionOne => PostgresJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_66a17cae, postgres_json_type| {
                    for el_e69bd1fc in PostgresJsonTypePattern::into_array() {
                        match &el_e69bd1fc {
                            PostgresJsonTypePattern::Standart => gen_standart(&mut acc_66a17cae, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_66a17cae, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension2 { .. } |
                            PostgresJsonTypePattern::ArrayDimension3 { .. } |
                            PostgresJsonTypePattern::ArrayDimension4 { .. } => (),
                        }
                ...
                GenPostgresJsonTypesConfigVariant::WithDimensionTwo => PostgresJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_c5ffb796, postgres_json_type| {
                    for el_345fd6bd in PostgresJsonTypePattern::into_array() {
                        match &el_345fd6bd {
                            PostgresJsonTypePattern::Standart => gen_standart(&mut acc_c5ffb796, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_c5ffb796, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_c5ffb796, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension3 { .. } |
                            PostgresJsonTypePattern::ArrayDimension4 { .. } => (),
                        }
                    }
                ...
                GenPostgresJsonTypesConfigVariant::WithDimensionThree => PostgresJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_78b27c00, postgres_json_type| {
                    for el_88e3b8fe in PostgresJsonTypePattern::into_array() {
                        match &el_88e3b8fe {
                            PostgresJsonTypePattern::Standart => gen_standart(&mut acc_78b27c00, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_78b27c00, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_78b27c00, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension3 { .. } => gen_array_dimension3(&mut acc_78b27c00, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension4 { .. } => (),
                        }
                    }
                    acc_78b27c00
                }),
                GenPostgresJsonTypesConfigVariant::WithDimensionFour => PostgresJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_172c62ad, postgres_json_type| {
                    for el_80434642 in PostgresJsonTypePattern::into_array() {
                        match &el_80434642 {
                            PostgresJsonTypePattern::Standart => gen_standart(&mut acc_172c62ad, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_172c62ad, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_172c62ad, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension3 { .. } => gen_array_dimension3(&mut acc_172c62ad, postgres_json_type.clone()),
                            PostgresJsonTypePattern::ArrayDimension4 { .. } => gen_array_dimension4(&mut acc_172c62ad, postgres_json_type.clone()),
                        }
                    }
                    acc_172c62ad
                }),
                GenPostgresJsonTypesConfigVariant::Concrete(value) => value,
            };
            ...
            for el_7ae8d2ae in {
                #[derive(Clone)]
                struct PostgresJsonTypeRecordHandle {
                    not_null_or_nullable: NotNullOrNullable,
                    postgres_json_type_pattern: PostgresJsonTypePattern,
                }
                fn gen_postgres_json_type_record_handle_vec(postgres_json_type_record_handle: PostgresJsonTypeRecordHandle) -> Vec<PostgresJsonTypeRecordHandle> {
                    let gen_vec = |current_postgres_json_type_record_handle: PostgresJsonTypeRecordHandle| gen_postgres_json_type_record_handle_vec(
                        current_postgres_json_type_record_handle
                    ).into_iter().chain(once(postgres_json_type_record_handle.clone())).collect();
                    match (&postgres_json_type_record_handle.not_null_or_nullable, &postgres_json_type_record_handle.postgres_json_type_pattern) {
                        (NotNullOrNullable::NotNull, PostgresJsonTypePattern::Standart) => vec![postgres_json_type_record_handle],
                        (NotNullOrNullable::Nullable, PostgresJsonTypePattern::Standart) => gen_vec(PostgresJsonTypeRecordHandle {
                            not_null_or_nullable: NotNullOrNullable::NotNull,
                            postgres_json_type_pattern: PostgresJsonTypePattern::Standart,
                        }),
                        (NotNullOrNullable::NotNull, PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable }) => gen_vec(PostgresJsonTypeRecordHandle {
                            not_null_or_nullable: *dimension1_not_null_or_nullable,
                            postgres_json_type_pattern: postgres_json_type_record_handle.postgres_json_type_pattern.down_by_1().expect("0e970a4f-eeec-421e-aa30-f90fc536d388"),
                        }),
                        (NotNullOrNullable::NotNull, PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. }) => gen_vec(PostgresJsonTypeRecordHandle {
                            not_null_or_nullable: *dimension1_not_null_or_nullable,
                            postgres_json_type_pattern: postgres_json_type_record_handle.postgres_json_type_pattern.down_by_1().expect("85f8ed83-aa1f-4f52-8f8f-80aeb86f8083"),
                        }),
                        (
                        ...
                        ) => gen_vec(PostgresJsonTypeRecordHandle {
                            not_null_or_nullable: *dimension1_not_null_or_nullable,
                            postgres_json_type_pattern: PostgresJsonTypePattern::ArrayDimension2 {
                                dimension1_not_null_or_nullable: *dimension2_not_null_or_nullable,
                                dimension2_not_null_or_nullable: *dimension3_not_null_or_nullable,
                        ...
                        (NotNullOrNullable::Nullable, PostgresJsonTypePattern::ArrayDimension1 { .. } | PostgresJsonTypePattern::ArrayDimension2 { .. } | PostgresJsonTypePattern::ArrayDimension3 { .. } | PostgresJsonTypePattern::ArrayDimension4 { .. }) => gen_vec(PostgresJsonTypeRecordHandle {
                            not_null_or_nullable: NotNullOrNullable::NotNull,
                            postgres_json_type_pattern: postgres_json_type_record_handle.postgres_json_type_pattern.clone(),
                        }),
                    }
                }
                gen_postgres_json_type_record_handle_vec(PostgresJsonTypeRecordHandle {
                    not_null_or_nullable: el_c4f9bf8f.not_null_or_nullable,
                    postgres_json_type_pattern: el_c4f9bf8f.postgres_json_type_pattern,
                })
            } {
                let postgres_json_type_record = PostgresJsonTypeRecord {
                    postgres_json_type: el_c4f9bf8f.postgres_json_type.clone(),
                    not_null_or_nullable: el_7ae8d2ae.not_null_or_nullable,
                    postgres_json_type_pattern: el_7ae8d2ae.postgres_json_type_pattern,
                };
                if !acc_5e43269c.contains(&postgres_json_type_record) {
                    acc_5e43269c.push(postgres_json_type_record);
                }
            }
            acc_5e43269c
        })
    ...
    .into_iter()
    .enumerate()
    .collect::<Vec<(usize, PostgresJsonTypeRecord)>>()
    .par_iter()
    ...
    .map(|(index, el_1d376874)| {
        ...
        // }
        let postgres_json_type = &el_1d376874.postgres_json_type;
        let not_null_or_nullable = &el_1d376874.not_null_or_nullable;
        let postgres_json_type_pattern = &el_1d376874.postgres_json_type_pattern;
        let rust_type_name = RustTypeName::from(postgres_json_type);
        let postgres_json_type_name = PostgresJsonTypeName::from(postgres_json_type);
        let is_standart_not_null = if matches!((&postgres_json_type_pattern, &not_null_or_nullable), (PostgresJsonTypePattern::Standart, NotNullOrNullable::NotNull)) {
            IsStandartNotNull::True
        } else {
            IsStandartNotNull::False
        };
        let is_standart_not_null_uuid = if matches!((&not_null_or_nullable, &postgres_json_type_pattern, &postgres_json_type), (NotNullOrNullable::NotNull, PostgresJsonTypePattern::Standart, PostgresJsonType::UuidUuidAsJsonbString)) {
            IsStandartNotNullUuid::True
        } else {
            IsStandartNotNullUuid::False
        };
        let import_path = ImportPath::PostgresCrudCommon;
        ...
        let gen_ident_ts = |current_not_null_or_nullable: &NotNullOrNullable, current_postgres_json_type_pattern: &PostgresJsonTypePattern| {
            ...
            let (rust_part, postgres_part) = match &current_postgres_json_type_pattern {
                PostgresJsonTypePattern::Standart => (rust_type_name.to_string(), postgres_json_type_name.to_string()),
                PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                    let d1 = dimension1_not_null_or_nullable;
                    let d1_rust = dimension1_not_null_or_nullable.rust();
                    (format!("{vec_of_ucc}{d1_rust}{rust_type_name}"), format!("{array_of_ucc}{d1}{postgres_json_type_name}"))
                }
                PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => {
                    let d1 = dimension1_not_null_or_nullable;
                    let d1_rust = dimension1_not_null_or_nullable.rust();
                    let d2 = dimension2_not_null_or_nullable;
                    let d2_rust = dimension2_not_null_or_nullable.rust();
                    (format!("{vec_of_ucc}{d1_rust}{vec_of_ucc}{d2_rust}{rust_type_name}"), format!("{array_of_ucc}{d1}{array_of_ucc}{d2}{postgres_json_type_name}"))
                }
                PostgresJsonTypePattern::ArrayDimension3 {
                    dimension1_not_null_or_nullable,
                    dimension2_not_null_or_nullable,
                    ...
                    (
                        ...
                        format!("{array_of_ucc}{d1}{array_of_ucc}{d2}{array_of_ucc}{d3}{postgres_json_type_name}"),
                    )
                }
                PostgresJsonTypePattern::ArrayDimension4 {
                    dimension1_not_null_or_nullable,
                    ...
                    (
                        ...
                        format!("{array_of_ucc}{d1}{array_of_ucc}{d2}{array_of_ucc}{d3}{array_of_ucc}{d4}{postgres_json_type_name}"),
                    )
                }
            };
            format!("{not_null_or_nullable_rust}{rust_part}{AsUcc}{current_not_null_or_nullable}{postgres_part}").parse::<Ts2>().expect("998d1471-be98-4669-8bd3-ca6c4a1a5853")
        };
        ...
        let ident_not_null_ts = gen_ident_ts(&NotNullOrNullable::NotNull, postgres_json_type_pattern);
        let ident_ts = {
        ...
        let ident_read_inner_standart_not_null_alias_ts = {
            let content_ts: &dyn ToTokens = match &postgres_json_type {
                PostgresJsonType::StdPrimitiveI8AsJsonbNumber => &StdPrimitiveI8,
                PostgresJsonType::StdPrimitiveI16AsJsonbNumber => &StdPrimitiveI16,
                PostgresJsonType::StdPrimitiveI32AsJsonbNumber => &StdPrimitiveI32,
                PostgresJsonType::StdPrimitiveI64AsJsonbNumber => &StdPrimitiveI64,
                PostgresJsonType::StdPrimitiveU8AsJsonbNumber => &StdPrimitiveU8,
                PostgresJsonType::StdPrimitiveU16AsJsonbNumber => &StdPrimitiveU16,
                PostgresJsonType::StdPrimitiveU32AsJsonbNumber => &StdPrimitiveU32,
                PostgresJsonType::StdPrimitiveU64AsJsonbNumber => &std_primitive_u64_ts,
                PostgresJsonType::StdPrimitiveF32AsJsonbNumber => &StdPrimitiveF32,
                PostgresJsonType::StdPrimitiveF64AsJsonbNumber => &StdPrimitiveF64,
                PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean => &StdPrimitiveBool,
                PostgresJsonType::StdStringStringAsJsonbString => &std_string_string_ts,
                PostgresJsonType::UuidUuidAsJsonbString => &UuidUuid,
            };
            quote! {#content_ts}
        };
        ...
        let maybe_const_fn = match &postgres_json_type_pattern {
        ...
        let maybe_derive_copy = match &postgres_json_type_pattern {
            PostgresJsonTypePattern::Standart => match &postgres_json_type {
                PostgresJsonType::StdPrimitiveI8AsJsonbNumber |
                PostgresJsonType::StdPrimitiveI16AsJsonbNumber |
                PostgresJsonType::StdPrimitiveI32AsJsonbNumber |
                PostgresJsonType::StdPrimitiveI64AsJsonbNumber |
                ...
                PostgresJsonType::UuidUuidAsJsonbString => macros_helpers::DeriveCopy::True,
                PostgresJsonType::StdStringStringAsJsonbString => macros_helpers::DeriveCopy::False,
            },
            PostgresJsonTypePattern::ArrayDimension1 {..} |
            PostgresJsonTypePattern::ArrayDimension2 {..} |
            PostgresJsonTypePattern::ArrayDimension3 {..} |
            PostgresJsonTypePattern::ArrayDimension4 {..} => macros_helpers::DeriveCopy::False,
        };
        let ident_origin_ts = {
            let gen_current_ident_origin_non_wrapping = |
                current_not_null_or_nullable: &NotNullOrNullable,
                current_postgres_json_type_pattern: &PostgresJsonTypePattern
            | SelfOriginUcc::from_tokens(&gen_ident_ts(current_not_null_or_nullable, current_postgres_json_type_pattern));
            ...
            //         | PostgresJsonType::StdPrimitiveU16AsJsonbNumber
            //         | PostgresJsonType::StdPrimitiveU32AsJsonbNumber
            //         | PostgresJsonType::StdPrimitiveU64AsJsonbNumber => SchemarsJsonSchema::Impl(SchemaObjectTokenStream {
            ...
            //         }),
            //         PostgresJsonType::StdPrimitiveF32AsJsonbNumber | PostgresJsonType::StdPrimitiveF64AsJsonbNumber | PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean | PostgresJsonType::StdStringStringAsJsonbString => SchemarsJsonSchema::Derive,
            //         PostgresJsonType::UuidUuidAsJsonbString => SchemarsJsonSchema::Impl(SchemaObjectTokenStream {
            //             metadata: &metadata_4167ee5c_732b_4787_9b37_e0060b0aa8de_ts,
            ...
            let ident_origin_ts = macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
                ...
                .derive_schemars_json_schema_if(
                    ...
                    if matches!(&is_standart_not_null, IsStandartNotNull::True) {
                        match &postgres_json_type {
                            PostgresJsonType::UuidUuidAsJsonbString => macros_helpers::DeriveSchemarsJsonSchema::False,
                            PostgresJsonType::StdPrimitiveI8AsJsonbNumber
                            | PostgresJsonType::StdPrimitiveI16AsJsonbNumber
                            | PostgresJsonType::StdPrimitiveI32AsJsonbNumber
                            | PostgresJsonType::StdPrimitiveI64AsJsonbNumber
                            ...
                            | PostgresJsonType::StdPrimitiveF64AsJsonbNumber
                            | PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean
                            | PostgresJsonType::StdStringStringAsJsonbString => macros_helpers::DeriveSchemarsJsonSchema::True,
                        }
                    } else {
                    ...
                    &{
                        let content_ts: &dyn ToTokens = {
                            ...
                            match &postgres_json_type_pattern {
                                ...
                                PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => &{
                                    let (current_not_null_or_nullable, current_postgres_json_type_pattern): (&NotNullOrNullable, &PostgresJsonTypePattern) = match &not_null_or_nullable {
                                        NotNullOrNullable::NotNull => (dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("e994797d-7334-4e30-b180-af24c16b68b1")),
                                        NotNullOrNullable::Nullable => (&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                                    };
                                    gen_current_ident_origin(current_not_null_or_nullable, current_postgres_json_type_pattern)
                                },
                                PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => &{
                                    let (current_not_null_or_nullable, current_postgres_json_type_pattern): (&NotNullOrNullable, &PostgresJsonTypePattern) = match &not_null_or_nullable {
                                        NotNullOrNullable::NotNull => (dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("76eb44e3-3099-4c9a-a935-da3e6f6e4210")),
                                        NotNullOrNullable::Nullable => (&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                                    };
                                    gen_current_ident_origin(current_not_null_or_nullable, current_postgres_json_type_pattern)
                                },
                                PostgresJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => &{
                                    let (current_not_null_or_nullable, current_postgres_json_type_pattern): (&NotNullOrNullable, &PostgresJsonTypePattern) = match &not_null_or_nullable {
                                        NotNullOrNullable::NotNull => (dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("1b996c86-0b08-476a-b963-373dd6838496")),
                                        NotNullOrNullable::Nullable => (&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                                    };
                                    gen_current_ident_origin(current_not_null_or_nullable, current_postgres_json_type_pattern)
                                },
                                PostgresJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => &{
                                    let (current_not_null_or_nullable, current_postgres_json_type_pattern): (&NotNullOrNullable, &PostgresJsonTypePattern) = match &not_null_or_nullable {
                                        NotNullOrNullable::NotNull => (dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("d24b7481-27d9-40c0-8476-344a16d08f27")),
                                        NotNullOrNullable::Nullable => (&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                                    };
                                    gen_current_ident_origin(current_not_null_or_nullable, current_postgres_json_type_pattern)
                                },
            ...
            let ident_origin_impl_new_self_content_ts = {
                ...
                match &postgres_json_type_pattern {
                    ...
                    PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgres_json_type_pattern, current_not_null_or_nullable): (&PostgresJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => (&postgres_json_type_pattern.down_by_1().expect("1160d3df-2e2b-4a33-a297-6b48546b9ca8"), dimension1_not_null_or_nullable),
                            NotNullOrNullable::Nullable => (postgres_json_type_pattern, &NotNullOrNullable::NotNull),
                        };
                        gen_current_ident_origin_non_wrapping(current_not_null_or_nullable, current_postgres_json_type_pattern)
                    }),
                    PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgres_json_type_pattern, current_not_null_or_nullable): (&PostgresJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => (&postgres_json_type_pattern.down_by_1().expect("8ab62f4e-611b-4228-a295-3e731e934b9c"), dimension1_not_null_or_nullable),
                            NotNullOrNullable::Nullable => (postgres_json_type_pattern, &NotNullOrNullable::NotNull),
                        };
                        gen_current_ident_origin_non_wrapping(current_not_null_or_nullable, current_postgres_json_type_pattern)
                    }),
                    PostgresJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgres_json_type_pattern, current_not_null_or_nullable): (&PostgresJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => (&postgres_json_type_pattern.down_by_1().expect("ed64919d-4679-45da-9d14-22ddee84716b"), dimension1_not_null_or_nullable),
                            NotNullOrNullable::Nullable => (postgres_json_type_pattern, &NotNullOrNullable::NotNull),
                        };
                        gen_current_ident_origin_non_wrapping(current_not_null_or_nullable, current_postgres_json_type_pattern)
                    }),
                    PostgresJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgres_json_type_pattern, current_not_null_or_nullable): (&PostgresJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => (&postgres_json_type_pattern.down_by_1().expect("25646d29-5a30-49fb-b91a-7b49ed8c5b0a"), dimension1_not_null_or_nullable),
                            NotNullOrNullable::Nullable => (postgres_json_type_pattern, &NotNullOrNullable::NotNull),
                        };
                        gen_current_ident_origin_non_wrapping(current_not_null_or_nullable, current_postgres_json_type_pattern)
                    }),
            ...
            let maybe_impl_schemars_json_schema_for_ident_origin_ts = if matches!(&is_standart_not_null, IsStandartNotNull::True) {
                match &postgres_json_type {
                    PostgresJsonType::UuidUuidAsJsonbString => {
            ...
            let maybe_impl_is_string_empty_for_ident_origin_ts = if matches!(&is_standart_not_null, IsStandartNotNull::True) {
                match &postgres_json_type {
                    ...
                    PostgresJsonType::UuidUuidAsJsonbString => postgres_crud_macros_common::gen_impl_crate_is_string_empty_for_ident_content_ts(
                        &ident_origin_ucc,
                ...
                let content_ts = match &postgres_json_type_pattern {
                    PostgresJsonTypePattern::Standart => match &not_null_or_nullable {
                        NotNullOrNullable::NotNull => match &postgres_json_type {
                            ...
                            | PostgresJsonType::StdPrimitiveF32AsJsonbNumber
                            | PostgresJsonType::StdPrimitiveF64AsJsonbNumber
                            | PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean => quote! {Default::default()},
                            PostgresJsonType::StdStringStringAsJsonbString => quote! {String::default()},
                            PostgresJsonType::UuidUuidAsJsonbString => quote! {uuid::Uuid::new_v4()},
                        },
                        NotNullOrNullable::Nullable => quote! {Some(#PostgresCrudCommonDefaultOptionSomeVecOneElCall)},
                    },
                    PostgresJsonTypePattern::ArrayDimension1 { .. } | PostgresJsonTypePattern::ArrayDimension2 { .. } | PostgresJsonTypePattern::ArrayDimension3 { .. } | PostgresJsonTypePattern::ArrayDimension4 { .. } => match &not_null_or_nullable {
                        NotNullOrNullable::NotNull => quote! {vec![#PostgresCrudCommonDefaultOptionSomeVecOneElCall]},
                        NotNullOrNullable::Nullable => quote! {Some(#PostgresCrudCommonDefaultOptionSomeVecOneElCall)},
                    },
                };
                quote! {Self(#content_ts)}
            });
            let impl_sqlx_type_sqlx_postgres_for_ident_origin_ts = postgres_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_origin_ucc, &postgres_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&ident_read_inner_ucc));
            let impl_sqlx_encode_sqlx_postgres_for_ident_origin_ts = postgres_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_origin_ucc, &quote! {sqlx::types::Json(&#SelfSc.0)});
            quote! {
                #ident_origin_ts
        ...
        let ident_table_type_declaration_ts = {
            ...
            let impl_default_option_some_vec_one_el_for_ident_table_type_declaration_ts =
                postgres_crud_macros_common::gen_impl_postgres_crud_common_default_option_some_vec_one_el_ts(&ident_table_type_declaration_ucc, &quote! {Self(#PostgresCrudCommonDefaultOptionSomeVecOneElCall)});
            ...
            //todo maybe add to trait?
            let impl_sqlx_type_sqlx_postgres_for_ident_table_type_declaration_ts = postgres_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_table_type_declaration_ucc, &postgres_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&ident_read_inner_ucc));
            quote! {
        ...
        let ident_create_ts = {
            ...
            let impl_default_option_some_vec_one_el_for_ident_create_ts =
                postgres_crud_macros_common::gen_impl_postgres_crud_common_default_option_some_vec_one_el_ts(&ident_create_ucc, &quote! {Self(#PostgresCrudCommonDefaultOptionSomeVecOneElCall)});
            quote! {
                #ident_create_ts
        ...
        let ident_create_for_query_ts = {
            ...
            let impl_sqlx_encode_sqlx_postgres_for_ident_create_for_query_ts = postgres_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_create_for_query_ucc, &quote! {sqlx::types::Json(&#SelfSc.0)});
            let impl_sqlx_type_sqlx_postgres_for_ident_create_for_query_ts = postgres_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_create_for_query_ucc, &ident_origin_ucc);
        ...
        let ident_select_ts = {
            let ident_select_ts = macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
                ...
                .build_struct(
                    &ident_select_ucc,
                    &ArrayDimension::try_from(postgres_json_type_pattern).map_or_else(
                        |()| quote! {;},
                        |array_dimension| {
                ...
                let content_ts = ArrayDimension::try_from(postgres_json_type_pattern).map_or_else(
                    ...
                    |array_dimension| {
                        let content_ts: &dyn ToTokens = match &default_some_one_or_default_some_one_with_max_page_size {
                            postgres_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne => &PostgresCrudCommonDefaultOptionSomeVecOneElCall,
                            postgres_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize => &PostgresCrudCommonDefaultOptionSomeVecOneElMaxPageSizeCall,
                        };
                        let mut arguments_ts = Vec::new();
            ...
            let impl_default_option_some_vec_one_el_for_postgres_json_type_ident_select_ts =
                postgres_crud_macros_common::gen_impl_postgres_crud_common_default_option_some_vec_one_el_ts(&ident_select_ucc, &gen_default_some_one_content_ts(&postgres_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne));
            let impl_default_option_some_vec_one_el_max_page_size_for_postgres_json_type_ident_select_ts =
                postgres_crud_macros_common::gen_impl_postgres_crud_common_default_option_some_vec_one_el_max_page_size_ts(&ident_select_ucc, &gen_default_some_one_content_ts(&postgres_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize));
            quote! {
                #ident_select_ts
                #impl_default_option_some_vec_one_el_for_postgres_json_type_ident_select_ts
                #impl_default_option_some_vec_one_el_max_page_size_for_postgres_json_type_ident_select_ts
            }
        };
        let ident_read_ucc = SelfReadUcc::from_tokens(&ident);
        let ident_where_ts = match &not_null_or_nullable {
            NotNullOrNullable::NotNull => postgres_crud_macros_common::gen_postgres_type_where_ts(
                &AllowClippyArbitrarySourceItemOrdering,
                &{
                    #[derive(Debug, Clone)]
                    enum PostgresJsonTypeSpecific {
                        Bool,
                        Number,
                        String,
                    }
                    impl From<&PostgresJsonType> for PostgresJsonTypeSpecific {
                        fn from(value: &PostgresJsonType) -> Self {
                            match value {
                                PostgresJsonType::StdPrimitiveI8AsJsonbNumber
                                | PostgresJsonType::StdPrimitiveI16AsJsonbNumber
                                ...
                                | PostgresJsonType::StdPrimitiveF32AsJsonbNumber
                                | PostgresJsonType::StdPrimitiveF64AsJsonbNumber => Self::Number,
                                PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean => Self::Bool,
                                PostgresJsonType::StdStringStringAsJsonbString | PostgresJsonType::UuidUuidAsJsonbString => Self::String,
                            }
                        }
                    }
                    let postgres_json_type_specific = PostgresJsonTypeSpecific::from(postgres_json_type);
                    let common_postgres_json_type_filters = vec![postgres_crud_macros_common::PostgresJsonTypeFilter::Equal { ident: quote! {#ident_table_type_declaration_ucc} }];
                    let ident_table_type_declaration_ucc_ts = quote! {#ident_table_type_declaration_ucc};
                    match &postgres_json_type_pattern {
                        PostgresJsonTypePattern::Standart => {
                            let common_standart_postgres_json_type_filters = {
                                let mut vec = common_postgres_json_type_filters;
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::In {
                                    ident: ident_table_type_declaration_ucc_ts.clone(),
                                });
                                vec
                            };
                            match &postgres_json_type_specific {
                                PostgresJsonTypeSpecific::Number => {
                                    let mut vec = common_standart_postgres_json_type_filters;
                                    vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::GreaterThan {
                                        ident: ident_table_type_declaration_ucc_ts.clone(),
                                    });
                                    vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::Between { ident: ident_table_type_declaration_ucc_ts });
                                    vec
                                }
                                PostgresJsonTypeSpecific::Bool => common_standart_postgres_json_type_filters,
                                PostgresJsonTypeSpecific::String => {
                                    let mut vec = common_standart_postgres_json_type_filters;
                                    vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::RegularExpression);
                                    vec
                                }
                            }
                        }
                        PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("21eaebaf-cd7a-4625-9232-0e23788a5432")));
                                quote! {#value}
                            };
                            let common_array_dimension1_postgres_json_type_filters = {
                                let mut vec = common_postgres_json_type_filters;
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneContainsAllElementsOfArray {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneOverlapsWithArray {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::AllElementsEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneIn {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec
                            };
                            match &postgres_json_type_specific {
                                PostgresJsonTypeSpecific::Number => {
                                    let mut filters = common_array_dimension1_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneGreaterThan {
                                        ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneBetween {
                                        ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::ContainsElGreaterThan {
                                        ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::AllElementsGreaterThan {
                                        ident: array_dimension1_inner_el_ident_table_type_declaration_ucc,
                                    });
                                    filters
                                }
                                PostgresJsonTypeSpecific::Bool => common_array_dimension1_postgres_json_type_filters,
                                PostgresJsonTypeSpecific::String => {
                                    let mut filters = common_array_dimension1_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::ContainsElRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::AllElementsRegularExpression);
                                    filters
                                }
                            }
                        }
                        PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => {
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("0c4491c4-8364-4c27-9478-227aefadb086")));
                                quote! {#value}
                            };
                            let array_dimension2_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension2_not_null_or_nullable, &postgres_json_type_pattern.down_by_2().expect("2d4ee5d4-490e-4503-91a7-ed29f73e6219")));
                                quote! {#value}
                            };
                            let common_array_dimension2_postgres_json_type_filters = {
                                let mut vec = common_postgres_json_type_filters;
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoEqual {
                                    ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoContainsAllElementsOfArray {
                                    ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoOverlapsWithArray {
                                    ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::AllElementsEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneAllElementsEqual {
                                    ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneIn {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc,
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoIn {
                                    ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec
                            };
                            match &postgres_json_type_specific {
                                PostgresJsonTypeSpecific::Number => {
                                    let mut filters = common_array_dimension2_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoGreaterThan {
                                        ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoBetween {
                                        ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneContainsElGreaterThan {
                                        ident: array_dimension2_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneAllElementsGreaterThan {
                                        ident: array_dimension2_inner_el_ident_table_type_declaration_ucc,
                                    });
                                    filters
                                }
                                PostgresJsonTypeSpecific::Bool => common_array_dimension2_postgres_json_type_filters,
                                PostgresJsonTypeSpecific::String => {
                                    let mut filters = common_array_dimension2_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneContainsElRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneAllElementsRegularExpression);
                                    filters
                                }
                            }
                        }
                        PostgresJsonTypePattern::ArrayDimension3 {
                            ...
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("3450bef4-e5f3-4bcd-b2de-4e4c67143336")));
                                quote! {#value}
                            };
                            let array_dimension2_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension2_not_null_or_nullable, &postgres_json_type_pattern.down_by_2().expect("3c0d10f4-6d7d-45d0-b929-5e307c7d79b1")));
                                quote! {#value}
                            };
                            let array_dimension3_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension3_not_null_or_nullable, &postgres_json_type_pattern.down_by_3().expect("9aaf9e82-0a92-4848-bfd4-de49013972a5")));
                                quote! {#value}
                            };
                            let common_array_dimension3_postgres_json_type_filters = {
                                let mut vec = common_postgres_json_type_filters;
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeEqual {
                                    ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeContainsAllElementsOfArray {
                                    ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeOverlapsWithArray {
                                    ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::AllElementsEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoAllElementsEqual {
                                    ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneIn {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc,
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeIn {
                                    ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec
                            };
                            match &postgres_json_type_specific {
                                PostgresJsonTypeSpecific::Number => {
                                    let mut filters = common_array_dimension3_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeGreaterThan {
                                        ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeBetween {
                                        ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoContainsElGreaterThan {
                                        ident: array_dimension3_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoAllElementsGreaterThan {
                                        ident: array_dimension3_inner_el_ident_table_type_declaration_ucc,
                                    });
                                    filters
                                }
                                PostgresJsonTypeSpecific::Bool => common_array_dimension3_postgres_json_type_filters,
                                PostgresJsonTypeSpecific::String => {
                                    let mut filters = common_array_dimension3_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoContainsElRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoAllElementsRegularExpression);
                                    filters
                                }
                            }
                        }
                        PostgresJsonTypePattern::ArrayDimension4 {
                            ...
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("550d313b-e925-496d-8a57-87931c573155")));
                                quote! {#value}
                            };
                            let array_dimension2_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension2_not_null_or_nullable, &postgres_json_type_pattern.down_by_2().expect("7bda1424-64c0-402e-9bf8-44d5fb3b9903")));
                                quote! {#value}
                            };
                            let array_dimension3_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension3_not_null_or_nullable, &postgres_json_type_pattern.down_by_3().expect("b43aa5bd-9bba-4f3e-b93b-a41f108262ff")));
                                quote! {#value}
                            };
                            let array_dimension4_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension4_not_null_or_nullable, &postgres_json_type_pattern.down_by_4().expect("a246885a-ca72-4e37-a396-b7220e237c7e")));
                                quote! {#value}
                            };
                            let common_array_dimension4_postgres_json_type_filters = {
                                let mut vec = common_postgres_json_type_filters;
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourEqual {
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourLengthEqual);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::LengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionTwoLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourLengthGreaterThan);
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourContainsAllElementsOfArray {
                                    ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourOverlapsWithArray {
                                    ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::AllElementsEqual {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc.clone(),
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeAllElementsEqual {
                                    ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionOneIn {
                                    ident: array_dimension1_inner_el_ident_table_type_declaration_ucc,
                                ...
                                vec.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourIn {
                                    ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                });
                                vec
                            };
                            match &postgres_json_type_specific {
                                PostgresJsonTypeSpecific::Number => {
                                    let mut filters = common_array_dimension4_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourGreaterThan {
                                        ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourBetween {
                                        ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeContainsElGreaterThan {
                                        ident: array_dimension4_inner_el_ident_table_type_declaration_ucc.clone(),
                                    });
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeAllElementsGreaterThan {
                                        ident: array_dimension4_inner_el_ident_table_type_declaration_ucc,
                                    });
                                    filters
                                }
                                PostgresJsonTypeSpecific::Bool => common_array_dimension4_postgres_json_type_filters,
                                PostgresJsonTypeSpecific::String => {
                                    let mut filters = common_array_dimension4_postgres_json_type_filters;
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionFourRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeContainsElRegularExpression);
                                    filters.push(postgres_crud_macros_common::PostgresJsonTypeFilter::DimensionThreeAllElementsRegularExpression);
                                    filters
                                }
                            }
                        }
                ...
                .iter()
                .map(|el_f992f593| {
                    let handle: &dyn postgres_crud_macros_common::PostgresFilter = el_f992f593;
                    handle
                })
                .collect(),
                &ident,
                &postgres_crud_macros_common::ShouldDeriveUtoipaToSchema::True,
                &postgres_crud_macros_common::ShouldDeriveSchemarsJsonSchema::True,
            ...
            NotNullOrNullable::Nullable => quote! {
                pub type #ident_where_ucc = #import_path::NullableJsonObjectPostgresTypeWhereFilter<
                    <#ident_not_null_ts as #import_path::PostgresJsonType>::Where
                >;
            }
        };
        ...
        let ident_read_ts = {
            ...
            let impl_default_option_some_vec_one_el_for_ident_read_ts =
                postgres_crud_macros_common::gen_impl_postgres_crud_common_default_option_some_vec_one_el_ts(&ident_read_ucc, &quote! {Self(#PostgresCrudCommonDefaultOptionSomeVecOneElCall)});
            let impl_sqlx_encode_sqlx_postgres_for_ident_read_ts = postgres_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_read_ucc, &quote! {&#SelfSc.0});
            let impl_sqlx_type_sqlx_postgres_for_ident_read_ts = postgres_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_read_ucc, &postgres_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&ident_read_inner_ucc));
            quote! {
                #ident_read_ts
                #impl_ident_read_ts
                        ...
                        match &postgres_json_type_pattern {
                            PostgresJsonTypePattern::Standart => {
                                let ts1 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_read_inner_standart_not_null_alias_ts),
                                };
                                quote! {#ts1}
                            }
                            PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                                ...
                                let ts2 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts1),
                                };
                                quote! {#ts2}
                            }
                            PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => {
                                ...
                                let ts3 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts2),
                                };
                                quote! {#ts3}
                            }
                            PostgresJsonTypePattern::ArrayDimension3 {
                                ...
                                let ts4 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts3),
                                };
                                quote! {#ts4}
                            }
                            PostgresJsonTypePattern::ArrayDimension4 {
                                ...
                                let ts5 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts4),
                                };
                                quote! {#ts5}
                            }
                        }
        ...
        let ident_read_inner_ts = {
            let type_ts = match &postgres_json_type_pattern {
                PostgresJsonTypePattern::Standart => match &not_null_or_nullable {
                    NotNullOrNullable::NotNull => &ident_read_inner_standart_not_null_alias_ts,
                    NotNullOrNullable::Nullable => &postgres_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_read_inner_standart_not_null_alias_ts),
                },
                ...
                PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => &{
                    ...
                    let dimension1_type = dimension1_not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension2_type));
                    not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension1_type))
                },
                PostgresJsonTypePattern::ArrayDimension3 {
                    dimension1_not_null_or_nullable,
                    ...
                    let dimension2_type = dimension2_not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension3_type));
                    let dimension1_type = dimension1_not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension2_type));
                    not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension1_type))
                },
                PostgresJsonTypePattern::ArrayDimension4 {
                    ...
                    let dimension3_type = dimension3_not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension4_type));
                    let dimension2_type = dimension2_not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension3_type));
                    let dimension1_type = dimension1_not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension2_type));
                    not_null_or_nullable.maybe_option_wrap(postgres_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension1_type))
                },
            ...
            let impl_std_convert_from_ident_origin_for_ident_read_inner_ts = {
                ...
                let into_inner_content_ts = match &postgres_json_type_pattern {
                    ...
                    PostgresJsonTypePattern::ArrayDimension2 {..} |
                    PostgresJsonTypePattern::ArrayDimension3 {..} |
                    PostgresJsonTypePattern::ArrayDimension4 {..} => match &not_null_or_nullable {
        ...
        let ident_update_ts = {
            ...
            let impl_default_option_some_vec_one_el_for_ident_update_ts =
                postgres_crud_macros_common::gen_impl_postgres_crud_common_default_option_some_vec_one_el_ts(&ident_update_ucc, &quote! {Self(#PostgresCrudCommonDefaultOptionSomeVecOneElCall)});
            quote! {
                #ident_update_ts
        ...
        let ident_update_for_query_ts = {
            ...
            let impl_sqlx_encode_sqlx_postgres_for_ident_update_for_query_ts = postgres_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_update_for_query_ucc, &quote! {sqlx::types::Json(&#SelfSc.0)});
        ...
        let postgres_crud_macros_common_import_path_postgres_crud_common = ImportPath::PostgresCrudCommon;
        let impl_postgres_json_type_for_ident_ts = {
            ...
            let select_only_created_or_updated_ids_query_part_ts = if matches!(&postgres_json_type, PostgresJsonType::UuidUuidAsJsonbString) {
                quote! {
                ...
                quote! {Ok(gen_postgres_json_types_common::field_ident_jsonb_build_object_value(field_ident))}
            };
            let select_only_created_or_updated_ids_query_bind_ts = if matches!(&postgres_json_type, PostgresJsonType::UuidUuidAsJsonbString) {
                quote! {
            ...
            postgres_crud_macros_common::gen_impl_postgres_json_type_ts(
                &postgres_crud_macros_common_import_path_postgres_crud_common,
                &ident,
                &ident_table_type_declaration_ucc,
                &ident_create_ucc,
                &ident_create_for_query_ucc,
                &ident_select_ucc,
                &match &postgres_json_type_pattern {
                    PostgresJsonTypePattern::Standart => postgres_crud_macros_common::IsSelectQueryPartSelfSelectUsed::False,
                    PostgresJsonTypePattern::ArrayDimension1 { .. } | PostgresJsonTypePattern::ArrayDimension2 { .. } | PostgresJsonTypePattern::ArrayDimension3 { .. } | PostgresJsonTypePattern::ArrayDimension4 { .. } => postgres_crud_macros_common::IsSelectQueryPartSelfSelectUsed::True,
                },
                &postgres_crud_macros_common::IsSelectQueryPartColumnNameAndMaybeFieldGetterForErrorMessageUsed::False,
                &postgres_crud_macros_common::IsSelectQueryPartIsPostgresTypeUsed::False,
                &{
                    let format_handle = {
                        ...
                        let format_handle = ArrayDimension::try_from(postgres_json_type_pattern).map_or_else(
                    ...
                    let maybe_dimensions_start_end_initialization = ArrayDimension::try_from(postgres_json_type_pattern).ok().into_iter().flat_map(|array_dimension| {
                ...
                &postgres_crud_macros_common::IsUpdateQueryPartSelfUpdateUsed::False,
                &postgres_crud_macros_common::IsUpdateQueryPartJsonbSetTargetUsed::False,
                ...
                &if matches!(&postgres_json_type, PostgresJsonType::UuidUuidAsJsonbString) {
                ...
                &if matches!(&postgres_json_type, PostgresJsonType::UuidUuidAsJsonbString) {
                    ...
                    postgres_crud_macros_common::IsSelectOnlyCreatedIdsQueryBindMutable::False
                },
                &select_only_created_or_updated_ids_query_bind_ts,
            )
        };
        let maybe_impl_postgres_json_type_object_vec_el_id_for_ident_origin_ts = if matches!(&is_standart_not_null_uuid, IsStandartNotNullUuid::True) {
            let (query_bind_string_as_postgres_text_create_for_query_ts, query_bind_string_as_postgres_text_update_for_query_ts) = {
                enum CreateForQueryOrUpdateForQuery {
                    CreateForQuery,
                    UpdateForQuery,
                }
                let gen_query_bind_string_as_postgres_text_ts = |create_for_query_or_update_for_query: &CreateForQueryOrUpdateForQuery| {
                    let name_ts = format!(
                        "query_bind_string_as_postgres_text_{}_for_query",
                    ...
                    quote! {
                        fn #name_ts(
                            #ValueSc: <Self::PostgresJsonType as #import_path::PostgresJsonType>::#type_ts,
                ...
                (gen_query_bind_string_as_postgres_text_ts(&CreateForQueryOrUpdateForQuery::CreateForQuery), gen_query_bind_string_as_postgres_text_ts(&CreateForQueryOrUpdateForQuery::UpdateForQuery))
            };
            quote! {
                #AllowClippyArbitrarySourceItemOrdering
                impl #import_path::PostgresJsonTypeObjectVecElementId for #ident {
                    ...
                    #query_bind_string_as_postgres_text_create_for_query_ts
                    #query_bind_string_as_postgres_text_update_for_query_ts
                    fn get_inner(#ValueSc: &<Self::PostgresJsonType as #import_path::PostgresJsonType>::#CreateForQueryUcc) -> &Self::#ReadInnerUcc {
                        &#ValueSc.0.0
                    }
        ...
        let impl_postgres_json_type_test_cases_for_ident_ts = {
            ...
            let gen_read_or_read_inner_into_update_with_new_or_try_new_unwraped_ts = |read_or_update: &postgres_crud_macros_common::ReadOrUpdate| {
                ...
                quote! {<#SelfUcc::#PostgresJsonTypeUcc
                    as
                    #postgres_crud_macros_common_import_path_postgres_crud_common::#PostgresJsonTypeUcc
                >::#read_or_update_ucc::#NewSc(#ValueSc)}
            };
            let standart_not_null_test_cases_vec_name_ts = match &postgres_json_type {
                PostgresJsonType::StdPrimitiveI8AsJsonbNumber => quote! {std_primitive_i8_test_cases_vec},
                PostgresJsonType::StdPrimitiveI16AsJsonbNumber => quote! {std_primitive_i16_test_cases_vec},
                PostgresJsonType::StdPrimitiveI32AsJsonbNumber => quote! {std_primitive_i32_test_cases_vec},
                PostgresJsonType::StdPrimitiveI64AsJsonbNumber => quote! {std_primitive_i64_test_cases_vec},
                PostgresJsonType::StdPrimitiveU8AsJsonbNumber => quote! {std_primitive_u8_test_cases_vec},
                PostgresJsonType::StdPrimitiveU16AsJsonbNumber => quote! {std_primitive_u16_test_cases_vec},
                PostgresJsonType::StdPrimitiveU32AsJsonbNumber => quote! {std_primitive_u32_test_cases_vec},
                PostgresJsonType::StdPrimitiveU64AsJsonbNumber => quote! {std_primitive_u64_test_cases_vec},
                PostgresJsonType::StdPrimitiveF32AsJsonbNumber => quote! {std_primitive_f32_test_cases_vec},
                PostgresJsonType::StdPrimitiveF64AsJsonbNumber => quote! {std_primitive_f64_test_cases_vec},
                PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean => quote! {std_primitive_bool_test_cases_vec},
                PostgresJsonType::StdStringStringAsJsonbString => quote! {std_string_string_test_cases_vec},
                PostgresJsonType::UuidUuidAsJsonbString => quote! {uuid_uuid_test_cases_vec},
            };
            let gen_array_dimension_equal_ts = |dimension: &postgres_crud_macros_common::Dimension| {
                let dimension_index_number_max = postgres_crud_macros_common::DimensionIndexNumber::from(dimension);
                    ...
                    let content_ts_c85923bd = {
                        ...
                        let mut content_ts_4c106eea = {
                            let content_ts_f1ffd3b2 = {
                                ...
                                let to_number_starting_with_one_word_str = |dimension_index_number: &postgres_crud_macros_common::DimensionIndexNumber| match dimension_index_number {
                                    postgres_crud_macros_common::DimensionIndexNumber::Zero => "One",
                                    postgres_crud_macros_common::DimensionIndexNumber::One => "Two",
                                ...
                                let current_value_ident_table_type_declaration_ucc = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(
                                    ...
                                    &match dimension_index_number_max {
                                        postgres_crud_macros_common::DimensionIndexNumber::Zero => postgres_json_type_pattern.down_by_1().expect("1a47af86-470b-41dd-aee1-01dfccef56a1"),
                                        postgres_crud_macros_common::DimensionIndexNumber::One => postgres_json_type_pattern.down_by_2().expect("d8260225-71af-4ea5-a354-075432088e96"),
                                        postgres_crud_macros_common::DimensionIndexNumber::Two => postgres_json_type_pattern.down_by_3().expect("473ac422-6c8c-417f-a115-8a7c0743ca08"),
                                        postgres_crud_macros_common::DimensionIndexNumber::Three => postgres_json_type_pattern.down_by_4().expect("6a143218-a98e-4893-ad2b-ed028a20ef39"),
                                    }
                                ));
                                let vec_content_ts = {
                                    let content_ts_0dc5a500 = (
                                        0i32..=match dimension_index_number_max {
                                            postgres_crud_macros_common::DimensionIndexNumber::Zero => 0i32,
                                            postgres_crud_macros_common::DimensionIndexNumber::One => 1i32,
                                            postgres_crud_macros_common::DimensionIndexNumber::Two => 2i32,
                                            postgres_crud_macros_common::DimensionIndexNumber::Three => 3i32,
                                        }
                                    )
                                    .map(|el_db559599| {
                                ...
                                quote! {
                                    #current_where_ident_where_ucc::#dimension_number_starting_with_one_equal_ts(
                                        where_filters::#postgres_json_type_where_dimension_number_starting_with_one_equal_ts {
                            ...
                            match not_null_or_nullable {
                                ...
                                NotNullOrNullable::Nullable => quote! {
                                    match #import_path::NotEmptyUniqueVec::try_new(vec![#content_ts_f1ffd3b2]) {
                                        Ok(value_9328b66f) => {
                                            acc_049ff0b3.push(#import_path::NullableJsonObjectPostgresTypeWhereFilter(Some(value_9328b66f)));
                                        },
                ...
                match &postgres_json_type_pattern {
                    PostgresJsonTypePattern::Standart => none_ts.clone(),
                    PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => match dimension_index_number_max {
                        postgres_crud_macros_common::DimensionIndexNumber::Zero => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                        ]),
                        postgres_crud_macros_common::DimensionIndexNumber::One | postgres_crud_macros_common::DimensionIndexNumber::Two | postgres_crud_macros_common::DimensionIndexNumber::Three => none_ts.clone(),
                    },
                    PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => match dimension_index_number_max {
                        postgres_crud_macros_common::DimensionIndexNumber::Zero => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                        ]),
                        postgres_crud_macros_common::DimensionIndexNumber::One => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                            dimension2_not_null_or_nullable
                        ]),
                        postgres_crud_macros_common::DimensionIndexNumber::Two | postgres_crud_macros_common::DimensionIndexNumber::Three => none_ts.clone(),
                    },
                    PostgresJsonTypePattern::ArrayDimension3 {
                        dimension1_not_null_or_nullable,
                        dimension2_not_null_or_nullable,
                        ...
                        postgres_crud_macros_common::DimensionIndexNumber::Two => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                            dimension2_not_null_or_nullable,
                            dimension3_not_null_or_nullable
                        ]),
                        postgres_crud_macros_common::DimensionIndexNumber::Three => none_ts.clone(),
                    },
                    PostgresJsonTypePattern::ArrayDimension4 {
                        dimension1_not_null_or_nullable,
                        dimension2_not_null_or_nullable,
                        ...
                        match dimension_index_number_max {
                            ...
                            postgres_crud_macros_common::DimensionIndexNumber::Three => gen_dimension_index_number_ts(&[
                                dimension1_not_null_or_nullable,
                                dimension2_not_null_or_nullable,
                                dimension3_not_null_or_nullable,
                                dimension4_not_null_or_nullable
            ...
            let option_vec_create_ts = {
                let gen_some_acc_content_ts = |current_not_null_or_nullable: &NotNullOrNullable, current_ident_ts: &dyn ToTokens| {
                    ...
                    //     PostgresJsonTypePattern::ArrayDimension2 { .. } |
                    //     PostgresJsonTypePattern::ArrayDimension3 { .. } |
                    //     PostgresJsonTypePattern::ArrayDimension4 { .. } => quote!{.clone()},
                    // };
                    quote! {Some({
                        let mut acc_50e99088 = Vec::new();
                        if let Some(value_8de026a4) = <#current_ident_ts as #import_path::PostgresJsonTypeTestCases>::#OptionVecCreateSc() {
                            for el_88131059 in value_8de026a4 #maybe_dot_clone_ts {
                                acc_50e99088.push(<Self as #import_path::PostgresJsonType>::Create::new(#new_content_ts));
                            }
                ...
                let content_ts = match &postgres_json_type_pattern {
                    PostgresJsonTypePattern::Standart => match &not_null_or_nullable {
                        NotNullOrNullable::NotNull => quote! {
                            Some(
                                #import_path::#standart_not_null_test_cases_vec_name_ts().into_iter().map(<Self as #import_path::PostgresJsonType>::Create::new).collect()
                            )
                        },
                        NotNullOrNullable::Nullable => gen_some_acc_content_ts(not_null_or_nullable, &gen_ident_ts(&NotNullOrNullable::NotNull, &PostgresJsonTypePattern::Standart)),
                    },
                    PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("dec468c0-09fd-4db3-98e7-7fa9cd565909")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                        },
                    ),
                    PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("4010ebf7-d6e2-4d6e-a562-a299201c92ec")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                        },
                    ),
                    PostgresJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("acdbb564-b169-40db-9815-2653c0150a4c")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                        },
                    ),
                    PostgresJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("5abf9504-cde0-4c6c-adb9-145b385918a5")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgres_json_type_pattern),
                        },
                    ),
                };
                match &postgres_json_type {
                    ...
                    | PostgresJsonType::StdPrimitiveF64AsJsonbNumber
                    | PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean
                    | PostgresJsonType::StdStringStringAsJsonbString => content_ts,
                    PostgresJsonType::UuidUuidAsJsonbString => quote! {None},
                }
            };
                ...
                let content_ts = match &postgres_json_type_pattern {
                    PostgresJsonTypePattern::Standart => match &not_null_or_nullable {
                        ...
                        NotNullOrNullable::Nullable => quote! {
                            ...
                            for el_8f3646f9 in <#ident_standart_not_null_ucc as #import_path::PostgresJsonTypeTestCases>::#ReadOnlyIdsToTwoDimensionalVecReadInnerSc(&#ident_read_only_ids_standart_not_null_ucc(read_only_ids.0.clone())) {
                    ...
                    PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_acc_content_handle_ts(
                        &gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("d6f89137-9a47-4f74-afce-0e1959d3dc59")),
                    ...
                    PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_acc_content_handle_ts(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("38774398-d485-4c14-84e8-92e06c36c23b")), &has_len_greater_than_one_ts),
                    PostgresJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_acc_content_handle_ts(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("053f4bab-0a8e-457f-9176-50e519b312bb")), &has_len_greater_than_one_ts),
                    PostgresJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_acc_content_handle_ts(&gen_ident_ts(dimension1_not_null_or_nullable, &postgres_json_type_pattern.down_by_1().expect("860f8f15-72ac-4557-a2c6-87b1aa958eb4")), &has_len_greater_than_one_ts),
                };
                match &postgres_json_type {
                    PostgresJsonType::StdPrimitiveI8AsJsonbNumber
                    | PostgresJsonType::StdPrimitiveI16AsJsonbNumber
                    ...
                    | PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean
                    | PostgresJsonType::StdStringStringAsJsonbString => content_ts,
                    PostgresJsonType::UuidUuidAsJsonbString => quote! {Vec::new()},
                }
            };
            ...
            let read_only_ids_into_option_value_read_inner_ts = {
                let content_ts = gen_import_path_value_initialization_ts(&if matches!(&is_standart_not_null_uuid, IsStandartNotNullUuid::True) {
                    ...
                    quote! {
                        <Self as #import_path::PostgresJsonType>::into_inner(
                            <
                                <Self as #import_path::PostgresJsonType>::Read
                                as
            ...
            let update_to_read_only_ids_ts = {
                let value_initialization_ts = gen_import_path_value_initialization_ts(&if matches!(&postgres_json_type, PostgresJsonType::UuidUuidAsJsonbString) {
                    ...
                    match &postgres_json_type_pattern {
                        ...
                        PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                ...
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => postgres_json_type_pattern.down_by_1().expect("e84064c3-5c31-4fa6-8dbc-ba454128c9da"),
                                    NotNullOrNullable::Nullable => postgres_json_type_pattern.clone(),
                                },
                            ),
                            not_null_or_nullable,
                        ),
                        PostgresJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => *dimension1_not_null_or_nullable,
                                ...
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => postgres_json_type_pattern.down_by_1().expect("226c6318-6be3-4b85-b2cd-c0b53a2d6bf9"),
                                    NotNullOrNullable::Nullable => postgres_json_type_pattern.clone(),
                                },
                            ),
                            not_null_or_nullable,
                        ),
                        PostgresJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => *dimension1_not_null_or_nullable,
                                ...
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => postgres_json_type_pattern.down_by_1().expect("3ae1e9f8-84ec-4369-a633-eca188d9b10a"),
                                    NotNullOrNullable::Nullable => postgres_json_type_pattern.clone(),
                                },
                            ),
                            not_null_or_nullable,
                        ),
                        PostgresJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => *dimension1_not_null_or_nullable,
                                ...
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => postgres_json_type_pattern.down_by_1().expect("44d51dc5-1b15-4807-ad63-c4fcfb01251c"),
                                    NotNullOrNullable::Nullable => postgres_json_type_pattern.clone(),
                                },
                            ),
                            not_null_or_nullable,
            ...
            let read_only_ids_to_option_value_read_default_option_some_vec_one_el_ts = {
                let value_initialization_ts = gen_import_path_value_initialization_ts(&if matches!(&postgres_json_type, PostgresJsonType::UuidUuidAsJsonbString) {
                    ...
                    quote! {#PostgresCrudCommonDefaultOptionSomeVecOneElCall}
                });
            ...
            let read_only_ids_merged_with_create_into_option_value_read_ts = {
                let value_initialization_ts = gen_import_path_value_initialization_ts(&quote! {
                    <Self as #import_path::PostgresJsonTypeTestCases>::#ReadOnlyIdsMergedWithCreateIntoReadSc(
                        #ReadOnlyIdsSc,
                        #CreateSc
                    )
                });
                    ...
                    NotNullOrNullable::Nullable => {
                        ...
                        quote! {
                            #import_path::NullableJsonObjectPostgresTypeWhereFilter(
                                #CreateSc.0.0.map(|value_18544acf| postgres_crud_common::NotEmptyUniqueVec::try_new(
            ...
            let read_only_ids_merged_with_create_into_vec_where_equal_using_fields_ts = quote! {
                #import_path::NotEmptyUniqueVec::try_new(vec![
                    <Self as #import_path::PostgresJsonTypeTestCases>::#ReadOnlyIdsMergedWithCreateIntoWhereEqualSc(
                        #ReadOnlyIdsSc,
                        #CreateSc
                    )
                ]).expect("56eb9ad4-8f4f-4833-9618-7327f42b0014")
            };
            let read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_ts = quote! {<Self as #import_path::PostgresJsonTypeTestCases>::#ReadOnlyIdsMergedWithCreateIntoVecWhereEqualUsingFieldsSc(
                #ReadOnlyIdsSc,
                #CreateSc
            )};
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_one_equal_ts = gen_array_dimension_equal_ts(&postgres_crud_macros_common::Dimension::One);
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_two_equal_ts = gen_array_dimension_equal_ts(&postgres_crud_macros_common::Dimension::Two);
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_three_equal_ts = gen_array_dimension_equal_ts(&postgres_crud_macros_common::Dimension::Three);
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_four_equal_ts = gen_array_dimension_equal_ts(&postgres_crud_macros_common::Dimension::Four);
                            ...
                            quote! {
                                ::LengthEqual(
                                    where_filters::PostgresJsonTypeWhereLengthEqual {
                                        logical_operator: #import_path::LogicalOperator::Or,
                                        #ValueSc: postgres_crud_common::UnsignedPartOfStdPrimitiveI32::try_from(
                    ...
                    let content_ts = {
                            ...
                            quote! {
                                ::LengthGreaterThan(
                                    where_filters::PostgresJsonTypeWhereLengthGreaterThan {
                                        logical_operator: #import_path::LogicalOperator::Or,
                                        #ValueSc: if let Ok(value_762dae1f) = postgres_crud_common::UnsignedPartOfStdPrimitiveI32::try_from(
                        ...
                        match &not_null_or_nullable {
                            ...
                            NotNullOrNullable::Nullable => {
                                let current_ident_where_ucc = SelfWhereUcc::from_tokens(&ident_not_null_ts);
                                quote! {
                                    #import_path::NullableJsonObjectPostgresTypeWhereFilter(match #create_dot_zero_dot_zero {
            ...
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_greater_than_ts = if matches!(&postgres_json_type_pattern, PostgresJsonTypePattern::Standart) &&
                matches!(&not_null_or_nullable, NotNullOrNullable::NotNull)
            {
                ...
                match &postgres_json_type {
                    ...
                    PostgresJsonType::StdPrimitiveU16AsJsonbNumber |
                    PostgresJsonType::StdPrimitiveU32AsJsonbNumber |
                    PostgresJsonType::StdPrimitiveU64AsJsonbNumber => int_greater_than_one_less_ts,
                    PostgresJsonType::StdPrimitiveF32AsJsonbNumber => float_32_greater_than_one_less_ts,
                    PostgresJsonType::StdPrimitiveF64AsJsonbNumber => float_64_greater_than_one_less_ts,
                    PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean |
                    PostgresJsonType::StdStringStringAsJsonbString |
                    PostgresJsonType::UuidUuidAsJsonbString => none_ts.clone(),
                }
            }
            else {
                none_ts.clone()
            };
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_between_ts = if matches!(&postgres_json_type_pattern, PostgresJsonTypePattern::Standart) &&
                matches!(&not_null_or_nullable, NotNullOrNullable::NotNull)
            {
                let (
                    ...
                    |quote!{
                        if let (Some(start), Some(end)) = (#less_ts, #more_ts) {
                            match where_filters::Between::try_new(
                                ...
                                Ok(value_cdde02cc) => match postgres_crud_common::NotEmptyUniqueVec::try_new(vec![
                ...
                match &postgres_json_type {
                    ...
                    PostgresJsonType::StdPrimitiveU16AsJsonbNumber |
                    PostgresJsonType::StdPrimitiveU32AsJsonbNumber |
                    PostgresJsonType::StdPrimitiveU64AsJsonbNumber => between_one_less_and_one_more_int_ts,
                    PostgresJsonType::StdPrimitiveF32AsJsonbNumber |
                    PostgresJsonType::StdPrimitiveF64AsJsonbNumber => between_one_less_and_one_more_float_ts,
                    PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean |
                    PostgresJsonType::StdStringStringAsJsonbString |
                    PostgresJsonType::UuidUuidAsJsonbString => none_ts.clone()
                }
            ...
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_in_ts = if matches!(&postgres_json_type_pattern, PostgresJsonTypePattern::Standart) &&
                matches!(&not_null_or_nullable, NotNullOrNullable::NotNull)
            {
                match &postgres_json_type {
                    PostgresJsonType::StdPrimitiveI8AsJsonbNumber |
                                ...
                                #import_path::SingleOrMultiple::Single(
                                    #ident_where_ucc::In(
                                        where_filters::PostgresJsonTypeWhereIn {
                                            logical_operator: #import_path::LogicalOperator::Or,
                                            value: where_filters::PostgresJsonTypeNotEmptyUniqueVec::try_new(
            ...
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_regular_expression_ts = if matches!(&postgres_json_type_pattern, PostgresJsonTypePattern::Standart) &&
                matches!(&not_null_or_nullable, NotNullOrNullable::NotNull)
            {
                match &postgres_json_type {
                    PostgresJsonType::StdPrimitiveI8AsJsonbNumber |
                    ...
                    PostgresJsonType::StdPrimitiveBoolAsJsonbBoolean |
                    PostgresJsonType::UuidUuidAsJsonbString => none_ts.clone(),
                    PostgresJsonType::StdStringStringAsJsonbString => quote!{
                        match #import_path::NotEmptyUniqueVec::try_new(vec![
                            #import_path::SingleOrMultiple::Single(
            ...
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_contains_el_greater_than_ts = match &postgres_json_type_pattern {
                PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                ...
                PostgresJsonTypePattern::ArrayDimension2 {..} |
                PostgresJsonTypePattern::ArrayDimension3 {..} |
                PostgresJsonTypePattern::ArrayDimension4 {..} => none_ts.clone()
            };
            //todo add contains_el_regular_expression for dimension 2,3,4
            let read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_contains_el_regular_expression_ts = match &postgres_json_type_pattern {
                PostgresJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                    if matches!((&not_null_or_nullable, &dimension1_not_null_or_nullable), (
                        NotNullOrNullable::NotNull,
                        NotNullOrNullable::NotNull
        ...
        let generated = quote! {
            ...
            #ident_update_ts
            #ident_update_for_query_ts
            #impl_postgres_json_type_for_ident_ts
            #maybe_impl_postgres_json_type_object_vec_el_id_for_ident_origin_ts
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgres_json_types_config.postgres_table_columns_content_write_into_postgres_table_columns_using_postgres_json_types,
        "postgres_table_columns_using_postgres_json_types",
        &{
    ...
    let generated = {
        ...
        quote! {
            #[allow(unused_qualifications)]
            #[allow(clippy::absolute_paths)]
            mod #gen_postgres_json_types_mod_sc {
                #(#content_ts)*
            }
            pub use #gen_postgres_json_types_mod_sc::*;
        }
    };
    macros_helpers::maybe_write_ts_into_file(
