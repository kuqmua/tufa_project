    ...
    .map(|(index, element)| {
        ...
        let impl_postgres_type_test_cases_for_ident_ts = {
            ...
            let read_only_ids_to_option_value_read_default_option_some_vec_one_el_ts = {
                //todo that is not correct for array of gend by postgres primary keys but maybe just need to remove this variants and thats it?
                    ...
                    PostgresTypePattern::Standart => match &not_null_or_nullable {
                        NotNullOrNullable::NotNull => {
                            ...
                            match &postgres_type {
                                ...
                                PostgresType::StdPrimitiveI16AsSmallSerialInitializedByPostgres |//todo diffrent test logic for autogend?
                                PostgresType::StdPrimitiveI32AsSerialInitializedByPostgres |//todo diffrent test logic for autogend?
                                PostgresType::StdPrimitiveI64AsBigSerialInitializedByPostgres |//todo diffrent test logic for autogend?
                                PostgresType::SqlxPostgresTypesPgMoneyAsMoney |
                                PostgresType::StdPrimitiveBoolAsBool |
                                PostgresType::StdStringStringAsText |
                                PostgresType::StdVecVecStdPrimitiveU8AsBytea |
