pub use postgres_crud_common_and_macros_common::*;
...
trait_alias!(WhereAlias = DebugClonePartialEqSerializeDeserializeAlias + for<'__> PostgresTypeWhereFilter<'__>);
...
pub trait PostgresType {
    //difference between Create and TableTypeDeclaration - Create may not contain gend by postgres id
...
#[allow(clippy::arbitrary_source_item_ordering)]
pub trait PostgresTypePrimaryKey {
    type PostgresType: PostgresType;
    type TableTypeDeclaration: TableTypeDeclarationAlias + PartialOrd;
    fn read_only_ids_into_table_type_declaration(
        value: <Self::PostgresType as PostgresType>::ReadOnlyIds,
    ) -> <Self::PostgresType as PostgresType>::TableTypeDeclaration;
    fn read_only_ids_into_read(
        value: <Self::PostgresType as PostgresType>::ReadOnlyIds,
    ) -> <Self::PostgresType as PostgresType>::Read;
    fn read_only_ids_into_update(
        value: <Self::PostgresType as PostgresType>::ReadOnlyIds,
    ) -> <Self::PostgresType as PostgresType>::Update;
    fn read_into_table_type_declaration(
        value: <Self::PostgresType as PostgresType>::Read,
    ) -> <Self::PostgresType as PostgresType>::TableTypeDeclaration;
}
#[allow(clippy::arbitrary_source_item_ordering)]
pub trait PostgresTypeNotPrimaryKey {
    type PostgresType: PostgresType;
    type Create: CreateAlias + SqlxEncodePostgresSqlxTypePostgresAlias;
}
#[allow(clippy::arbitrary_source_item_ordering)]
pub trait PostgresJsonTypeObjectVecElementId {
    type PostgresJsonType: PostgresJsonType;
    type CreateForQuery: CreateForQueryAlias
        + From<<Self::PostgresJsonType as PostgresJsonType>::Create>
        + From<<Self::PostgresJsonType as PostgresJsonType>::Update>;
    type Update: UpdateAlias
        + UtoipaToSchemaAndSchemarsJsonSchemaAlias
        + error_occurence_lib::ToStdStringString;
    type ReadInner: ReadInnerAlias;
    fn query_bind_string_as_postgres_text_create_for_query(
        value: <Self::PostgresJsonType as PostgresJsonType>::CreateForQuery,
        query: Query<'_, Postgres, PgArguments>,
    ) -> Result<Query<'_, Postgres, PgArguments>, String>;
    fn query_bind_string_as_postgres_text_update_for_query(
        value: <Self::PostgresJsonType as PostgresJsonType>::UpdateForQuery,
        query: Query<'_, Postgres, PgArguments>,
    ) -> Result<Query<'_, Postgres, PgArguments>, String>;
    fn get_inner(
        value: &<Self::PostgresJsonType as PostgresJsonType>::CreateForQuery,
...
pub trait PostgresTypeTestCases {
    type PostgresType: PostgresType;
    type Select: SelectAlias + DefaultOptionSomeVecOneElMaxPageSize;
    fn option_vec_create() -> Option<Vec<<Self::PostgresType as PostgresType>::Create>>;
    fn read_only_ids_to_two_dimensional_vec_read_inner(
        read_only_ids: &<Self::PostgresType as PostgresType>::ReadOnlyIds,
    ) -> Vec<Vec<<Self::PostgresType as PostgresType>::ReadInner>>;
    fn read_inner_into_read_with_new_or_try_new_unwraped(
        value: <Self::PostgresType as PostgresType>::ReadInner,
    ) -> <Self::PostgresType as PostgresType>::Read;
    fn read_inner_into_update_with_new_or_try_new_unwraped(
        value: <Self::PostgresType as PostgresType>::ReadInner,
    ) -> <Self::PostgresType as PostgresType>::Update;
    fn update_to_read_only_ids(
        value: &<Self::PostgresType as PostgresType>::Update,
    ) -> <Self::PostgresType as PostgresType>::ReadOnlyIds;
    fn read_only_ids_to_option_value_read_default_option_some_vec_one_el(
        value: &<Self::PostgresType as PostgresType>::ReadOnlyIds,
    ) -> Option<Value<<Self::PostgresType as PostgresType>::Read>>;
    fn previous_read_merged_with_option_update_into_read(
        read: <Self::PostgresType as PostgresType>::Read,
        option_update: Option<<Self::PostgresType as PostgresType>::Update>,
    ) -> <Self::PostgresType as PostgresType>::Read;
    fn read_only_ids_merged_with_create_into_read(
        read_only_ids: <Self::PostgresType as PostgresType>::ReadOnlyIds,
        create: <Self::PostgresType as PostgresType>::Create,
    ) -> <Self::PostgresType as PostgresType>::Read;
    ...
    //todo add prefix postgres_type or postgres_json_type ?
    fn read_only_ids_merged_with_create_into_where_equal(
        read_only_ids: <Self::PostgresType as PostgresType>::ReadOnlyIds,
        create: <Self::PostgresType as PostgresType>::Create,
    ) -> <Self::PostgresType as PostgresType>::Where;
    fn read_only_ids_merged_with_create_into_vec_where_equal_using_fields(
        read_only_ids: <Self::PostgresType as PostgresType>::ReadOnlyIds,
        create: <Self::PostgresType as PostgresType>::Create,
    ) -> NotEmptyUniqueVec<<Self::PostgresType as PostgresType>::Where>;
    fn read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field(
        read_only_ids: <Self::PostgresType as PostgresType>::ReadOnlyIds,
        create: <Self::PostgresType as PostgresType>::Create,
    ) -> Option<NotEmptyUniqueVec<<Self::PostgresType as PostgresType>::Where>>;
    fn create_into_postgres_type_option_vec_where_dimension_one_equal(
        create: <Self::PostgresType as PostgresType>::Create,
    ) -> Option<NotEmptyUniqueVec<<Self::PostgresType as PostgresType>::Where>>;
    fn postgres_type_option_vec_where_greater_than_test()
    -> Option<NotEmptyUniqueVec<PostgresTypeGreaterThanTest<Self::PostgresType>>>;
    fn read_only_ids_merged_with_table_type_declaration_into_postgres_type_option_where_greater_than(
        greater_than_variant: PostgresTypeGreaterThanVariant,
        read_only_ids: <Self::PostgresType as PostgresType>::ReadOnlyIds,
        table_type_declaration: <Self::PostgresType as PostgresType>::TableTypeDeclaration,
    ) -> Option<<Self::PostgresType as PostgresType>::Where>;
    ...
    fn read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_greater_than(
        read_only_ids: <Self::PostgresType as PostgresType>::ReadOnlyIds,
        create: <Self::PostgresType as PostgresType>::Create,
    ) -> Option<NotEmptyUniqueVec<SingleOrMultiple<<Self::PostgresType as PostgresType>::Where>>>;
...
pub struct PostgresTypeGreaterThanTest<T: PostgresType> {
    pub variant: PostgresTypeGreaterThanVariant,
    pub create: <T as PostgresType>::Create,
    pub greater_than: <T as PostgresType>::TableTypeDeclaration,
}
#[allow(clippy::arbitrary_source_item_ordering)]
#[derive(Debug)]
pub struct PostgresTypeLengthGreaterThanTest<T: PostgresType> {
    pub variant: PostgresJsonTypeLengthGreaterThanVariant,
    pub create: <T as PostgresType>::Create,
    pub length_greater_than: UnsignedPartOfStdPrimitiveI32,
}
#[allow(clippy::arbitrary_source_item_ordering)]
#[derive(Debug)]
pub struct PostgresJsonTypeLengthGreaterThanTest<T: PostgresJsonType> {
    pub variant: PostgresJsonTypeLengthGreaterThanVariant,
    pub create: <T as PostgresJsonType>::Create,
    pub length_greater_than: UnsignedPartOfStdPrimitiveI32,
}
#[allow(clippy::arbitrary_source_item_ordering)]
#[cfg(feature = "test-utils")]
pub trait PostgresJsonTypeTestCases {
    type PostgresJsonType: PostgresJsonType;
    type Select: SelectAlias
        + UtoipaToSchemaAndSchemarsJsonSchemaAlias
        + DefaultOptionSomeVecOneElMaxPageSize;
    fn option_vec_create() -> Option<Vec<<Self::PostgresJsonType as PostgresJsonType>::Create>>;
    fn read_only_ids_to_two_dimensional_vec_read_inner(
        read_only_ids: &<Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
    ) -> Vec<Vec<<Self::PostgresJsonType as PostgresJsonType>::ReadInner>>;
    fn read_inner_into_read_with_new_or_try_new_unwraped(
        value: <Self::PostgresJsonType as PostgresJsonType>::ReadInner,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::Read;
    fn read_inner_into_update_with_new_or_try_new_unwraped(
        value: <Self::PostgresJsonType as PostgresJsonType>::ReadInner,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::Update;
    fn read_only_ids_into_option_value_read_inner(
        value: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
    ) -> Option<Value<<Self::PostgresJsonType as PostgresJsonType>::ReadInner>>;
    fn update_to_read_only_ids(
        value: &<Self::PostgresJsonType as PostgresJsonType>::Update,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds;
    fn read_only_ids_to_option_value_read_default_option_some_vec_one_el(
        value: &<Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
    ) -> Option<Value<<Self::PostgresJsonType as PostgresJsonType>::Read>>;
    fn previous_read_merged_with_option_update_into_read(
        read: <Self::PostgresJsonType as PostgresJsonType>::Read,
        option_update: Option<<Self::PostgresJsonType as PostgresJsonType>::Update>,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::Read;
    fn read_only_ids_merged_with_create_into_read(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::Read;
    fn read_only_ids_merged_with_create_into_option_value_read(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ...
    fn read_only_ids_merged_with_create_into_table_type_declaration(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::TableTypeDeclaration;

    fn read_only_ids_merged_with_create_into_where_equal(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ) -> <Self::PostgresJsonType as PostgresJsonType>::Where;
    fn read_only_ids_merged_with_create_into_vec_where_equal_using_fields(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ) -> NotEmptyUniqueVec<<Self::PostgresJsonType as PostgresJsonType>::Where>;
    ...
    fn read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_one_equal(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ) -> Option<NotEmptyUniqueVec<<Self::PostgresJsonType as PostgresJsonType>::Where>>;
    fn read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_dimension_two_equal(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
    ) -> Option<NotEmptyUniqueVec<<Self::PostgresJsonType as PostgresJsonType>::Where>>;
    ...
    fn read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_greater_than(
        ...
        NotEmptyUniqueVec<SingleOrMultiple<<Self::PostgresJsonType as PostgresJsonType>::Where>>,
    >;
    fn read_only_ids_merged_with_create_into_postgres_json_type_option_vec_where_between(
        read_only_ids: <Self::PostgresJsonType as PostgresJsonType>::ReadOnlyIds,
        create: <Self::PostgresJsonType as PostgresJsonType>::Create,
...
pub trait PostgresTypeWhereFilter<'query_lifetime> {
    fn query_bind(
        self,
...
pub struct NullableJsonObjectPostgresTypeWhereFilter<
    T: Debug
        + PartialEq
        + Clone
        + for<'lifetime> PostgresTypeWhereFilter<'lifetime>
        + AllEnumVariantsArrayDefaultOptionSomeVecOneEl,
>(pub Option<NotEmptyUniqueVec<T>>);
impl<'query_lifetime, T> PostgresTypeWhereFilter<'query_lifetime>
    for NullableJsonObjectPostgresTypeWhereFilter<T>
where
    T: Debug
        + PartialEq
        + Clone
        + for<'t_lifetime> PostgresTypeWhereFilter<'t_lifetime>
        + AllEnumVariantsArrayDefaultOptionSomeVecOneEl,
{
    fn query_bind(
        self,
...
impl<T> error_occurence_lib::ToStdStringString for NullableJsonObjectPostgresTypeWhereFilter<T>
where
    T: Debug
        + PartialEq
        + Clone
...
pub struct PostgresTypeWhere<T> {
    logical_operator: LogicalOperator,
    value: NotEmptyUniqueVec<T>,
}
impl<T: PartialEq + Clone> PostgresTypeWhere<T> {
    #[must_use]
...
const _: () = {
        ...
        for PostgresTypeWhere<T>
    {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            #[doc(hidden)]
            struct __Visitor<'de, PostgresTypeWhere> {
                marker: _serde::__private228::PhantomData<PostgresTypeWhere>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            impl<'de, T: Debug + PartialEq + Clone + _serde::Deserialize<'de>>
                _serde::de::Visitor<'de> for __Visitor<'de, T>
            {
                type Value = PostgresTypeWhere<T>;
                fn expecting(&self, __f: &mut Formatter<'_>) -> _serde::__private228::fmt::Result {
                    Formatter::write_str(__f, "struct PostgresTypeWhere")
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let Some(__field0) =
                        ...
                        return Err(_serde::de::Error::invalid_length(
                            0usize,
                            &"struct PostgresTypeWhere with 2 elements",
                        ));
                    };
                    ...
                    match PostgresTypeWhere::try_new(__field0, __field1) {
                        Ok(value) => Ok(value),
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    match PostgresTypeWhere::try_new(__field0_value, __field1_value) {
                        Ok(value) => Ok(value),
                        Err(error) => Err(serde::de::Error::custom(format!("{error:?}"))),
                    }
                }
...
impl<'query_lifetime, T: PostgresTypeWhereFilter<'query_lifetime>>
    PostgresTypeWhereFilter<'query_lifetime> for PostgresTypeWhere<T>
{
    fn query_bind(
        self,
        ...
        for el_4e314a75 in self.value.0 {
            match PostgresTypeWhereFilter::query_bind(el_4e314a75, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
    ...
    fn query_part(
        ...
        for el_a38b9c67 in &self.value.0 {
            match PostgresTypeWhereFilter::query_part(
                el_a38b9c67,
                increment,
                column,
...
impl<T: Debug + PartialEq + Clone + AllEnumVariantsArrayDefaultOptionSomeVecOneEl>
    DefaultOptionSomeVecOneEl for PostgresTypeWhere<T>
{
...
impl<'query_lifetime> PostgresTypeWhereFilter<'query_lifetime> for PaginationBase {
    fn query_bind(
        self,
        mut query: Query<'query_lifetime, Postgres, PgArguments>,
    ) -> Result<Query<'query_lifetime, Postgres, PgArguments>, String> {
...
impl<'query_lifetime> PostgresTypeWhereFilter<'query_lifetime> for PaginationStartsWithZero {
    fn query_bind(
        self,
        query: Query<'query_lifetime, Postgres, PgArguments>,
    ) -> Result<Query<'query_lifetime, Postgres, PgArguments>, String> {
...
impl<'query_lifetime, T> PostgresTypeWhereFilter<'query_lifetime> for NotEmptyUniqueVec<T>
where
    T: Debug
        + PartialEq
        + Clone
...
pub struct NonPrimaryKeyPostgresTypeReadOnlyIds(pub Value<Option<()>>);
impl Decode<'_, Postgres> for NonPrimaryKeyPostgresTypeReadOnlyIds {
...
impl Type<Postgres> for NonPrimaryKeyPostgresTypeReadOnlyIds {
...
impl Default for NonPrimaryKeyPostgresTypeReadOnlyIds {
    fn default() -> Self {
...
pub trait PostgresTypeEqualOperator {
...
pub struct UnsignedPartOfStdPrimitiveI32(i32); //todo why exactly i32? maybe different types for postgres type and postgres json type
#[derive(
    Debug,
    Clone,
    PartialEq,
