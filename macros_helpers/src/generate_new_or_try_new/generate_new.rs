...
pub fn generate_const_new_token_stream(
    ...
    super::const_space_content_token_stream(&generate_new_token_stream(
...
pub fn generate_pub_new_token_stream(
    ...
    super::pub_space_content_token_stream(&generate_new_token_stream(
        parameters_token_stream,
        content_token_stream
    ))
}
pub fn generate_pub_const_new_token_stream(
    ...
    super::pub_space_content_token_stream(&generate_const_new_token_stream(
        parameters_token_stream,
        content_token_stream
    ))
}
