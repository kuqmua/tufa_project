...
pub fn generate_const_try_new_token_stream(
    ...
    super::const_space_content_token_stream(&generate_try_new_token_stream(
...
pub fn generate_pub_try_new_token_stream(
    ...
    super::pub_space_content_token_stream(&generate_try_new_token_stream(
        parameters_token_stream,
        err_type_token_stream,
        content_token_stream
    ))
...
pub fn generate_pub_const_try_new_token_stream(
    ...
    super::pub_space_content_token_stream(&generate_const_try_new_token_stream(
        parameters_token_stream,
        err_type_token_stream,
        content_token_stream
    ))
...
pub fn generate_impl_try_new_for_ident_token_stream(
    ...
    super::impl_ident_content_token_stream(
        ident_token_stream,
