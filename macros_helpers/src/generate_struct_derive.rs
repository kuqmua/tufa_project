...
impl StructDeriveTokenStreamBuilder {
    ...
    pub fn make_pub_if(mut self, condition: IsPub) -> Self {
    ...
    pub fn derive_debug_if(mut self, condition: DeriveDebug) -> Self {
    ...
    pub fn derive_default_if(mut self, condition: DeriveDefault) -> Self {
    ...
    pub fn derive_clone_if(mut self, condition: DeriveClone) -> Self {
    ...
    pub fn derive_copy_if(mut self, condition: DeriveCopy) -> Self {
    ...
    pub fn derive_partial_eq_if(mut self, condition: DerivePartialEq) -> Self {
    ...
    pub fn derive_eq_if(mut self, condition: DeriveEq) -> Self {
    ...
    pub fn derive_partial_ord_if(mut self, condition: DerivePartialOrd) -> Self {
    ...
    pub fn derive_ord_if(mut self, condition: DeriveOrd) -> Self {
    ...
    pub fn derive_serde_serialize_if(mut self, condition: DeriveSerdeSerialize) -> Self {
    ...
    pub fn derive_serde_deserialize_if(mut self, condition: DeriveSerdeDeserialize) -> Self {
    ...
    pub fn derive_utoipa_to_schema_if(mut self, condition: DeriveUtoipaToSchema) -> Self {
    ...
    pub fn derive_schemars_json_schema_if(mut self, condition: DeriveSchemarsJsonSchema) -> Self {
