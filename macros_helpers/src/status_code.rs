#[derive(Debug, strum_macros::Display, PartialEq, Eq, Clone, Copy, Hash, macros_assistants::EnumWithUnitFieldsToUpperCamelCaseStringified, macros_assistants::EnumWithUnitFieldsToSnakeCaseStringified)]
pub enum StatusCode {
    Continue100,
