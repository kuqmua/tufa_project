#[derive(Debug, strum_macros::Display, PartialEq, Eq, Clone, Copy, Hash, naming_conventions::EnumWithUnitFieldsToUpperCamelCaseStringified, naming_conventions::EnumWithUnitFieldsToSnakeCaseStringified)]
pub enum StatusCode {
    Continue100,
