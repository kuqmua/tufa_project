...
pub fn generate_pub_new_token_stream(
    ...
    pub_space_content_token_stream(&generate_new_token_stream(
        parameters_token_stream,
        content_token_stream,
    ))
}
...
pub fn generate_impl_new_for_ident_token_stream(
    ...
    impl_ident_content_token_stream(
        ident_token_stream,
        &generate_new_token_stream(parameters_token_stream, content_token_stream),
    )
}
...
pub fn generate_impl_pub_new_for_ident_token_stream(
    ...
    impl_ident_content_token_stream(
        ident_token_stream,
        &generate_pub_new_token_stream(parameters_token_stream, content_token_stream),
    )
}
pub fn generate_impl_pub_const_new_for_ident_token_stream(
    ...
    impl_ident_content_token_stream(
        ident_token_stream,
        &generate_pub_const_new_token_stream(parameters_token_stream, content_token_stream),
    )
}
