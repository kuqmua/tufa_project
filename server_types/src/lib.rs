...
pub struct TableExample {
    ...
    pub column_142: AnimalAsNotNullJsonbObject,
    pub column_143: OptionAnimalAsNullableJsonbObject,
    pub column_144: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId,
