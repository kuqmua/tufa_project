...
naming_macros::generate_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["read", "only", "ids", "merged", "with", "create", "into", "vec", "where", "element", "equal", "using", "fields"],
    ["equal", "operator"],
    ...
    ["read", "only", "ids", "merged", "with", "create", "into", "where", "element", "equal", "to", "json", "field"],
    ["option", "vec", "create"],
    ["read", "only", "ids", "to", "two", "dimensional", "vec", "read", "inner"],
    ["read", "only", "ids", "merged", "with", "create", "into", "option", "vec", "where", "element", "equal", "to", "json", "field"],
    ["read", "only", "ids", "merged", "with", "create", "into", "vec", "where", "element", "equal", "to", "json", "field"],
    ...
    ["postgresql", "type", "vec", "greater", "than", "test"],
    ...
    ["routes"],
    ["routes", "handle"],
    ["create", "into", "postgresql", "json", "type", "option", "vec", "where", "element", "length", "greater", "than"],
    ["create", "into", "postgresql", "json", "type", "option", "vec", "where", "element", "length", "equal"]
]);
