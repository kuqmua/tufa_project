...
naming_macros::generate_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["jsonb"],
    ["regular", "expression"],
    ["dimension", "one", "position", "regular", "expression"],
    ["dimension", "two", "position", "regular", "expression"],
    ["dimension", "three", "position", "regular", "expression"],
    ["dimension", "four", "position", "regular", "expression"],
