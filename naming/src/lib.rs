...
naming_macros::gen_ucc_and_sc_str_and_ts!([
    ...
    ["dim", "one", "contains", "all", "elements", "of", "arr"],
    ["dim", "two", "contains", "all", "elements", "of", "arr"],
    ["dim", "three", "contains", "all", "elements", "of", "arr"],
    ["dim", "four", "contains", "all", "elements", "of", "arr"],
    ["contained", "in", "arr"],
