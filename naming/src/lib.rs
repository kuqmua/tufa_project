...
naming_macros::generate_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["dimension", "one", "length", "more", "than"],
    ["dimension", "two", "length", "more", "than"],
    ["dimension", "three", "length", "more", "than"],
    ["dimension", "four", "length", "more", "than"],
    ...
    ["update", "query", "part", "postgresql", "type"],
