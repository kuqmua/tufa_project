...
naming_macros::gen_ucc_and_sc_str_and_ts!([
    ...
    ["order", "by"],
    ["primary", "ks"],
    ["not", "unique", "primary", "k"],
    ["res", "vrts"],
    ["tvfrr", "extraction", "logic"],
    ["bind", "query"],
    ["into", "serde", "version"],
    ["checked", "add"],
    ["primary", "k", "from", "row", "and", "rollback"],
    ["non", "existing", "primary", "ks"],
    ["non", "existing", "primary", "ks", "and", "rollback"],
    ["commit", "failed"],
    [
        "operation",
        "done",
    ...
    ["into", "res"],
    [
        "primary", "k", "inner", "type", "try", "from", "primary", "k", "inner", "type", "with",
        "serde", "in", "client"
    ],
    ["check", "commit"],
    ["check", "commit", "er"],
    ...
    ["rollback", "er"],
    ["not", "unique", "primary", "k", "with", "serde"],
    ["not", "unique"],
    ["no", "payload", "fields", "primary", "k"],
    ["no", "primary", "ks"],
    ["row", "and", "rollback"],
    ["pg", "transaction"],
    ["results", "vec"],
    ...
    ["pg", "base", "type"],
    ["pg", "base", "type", "self"],
    ["pg", "base", "type", "primary", "k"],
    ["pg", "base", "type", "primary", "k", "self"],
    ...
    [
        "vec", "of", "primary", "ks", "returned", "from", "create", "many"
    ],
    ["select", "primary", "k"],
    [
        "sort", "vec", "of", "ident", "read", "with", "primary", "k", "by", "primary", "k"
    ],
    ["gen", "el"],
    [
