...
naming_macros::gen_ucc_and_sc_str_and_ts!([
    ...
    ["serde", "json"],
    ["unexpected", "rows", "len"],
    ["unexpected", "rows", "len", "and", "rollback"],
    ["expected", "len"],
    ["got", "len"],
    ["pool", "connection"],
    ["type"],
    ...
    ["not", "unq", "field", "filter"],
    ["pgn"],
    ["field", "vec"],
    ["obj", "acc"],
    ["std", "opt", "opt", "obj", "acc"],
    ["cr", "upd", "del", "check", "fields", "are", "empty"],
    ["not", "unq", "id", "in", "json", "upd", "arr"],
    ...
    ["contains", "el", "case", "sensitive", "rgx"],
    ["contains", "el", "case", "insensitive", "rgx"],
    ...
    ["dim", "one", "arr", "len", "dim", "one"],
    ["dim", "one", "arr", "len", "greater", "than", "dim", "one"],
    [
        "dim",
        "one",
        "eq",
