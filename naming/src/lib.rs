...
naming_macros::gen_ucc_and_sc_str_and_ts!([
    ...
    ["all", "elements", "case", "sensitive", "regex"],
    ["all", "elements", "case", "insensitive", "regex"],
    ["contains", "el"],
    ["equal", "second", "dim"],
    ["from", "calendar", "date"],
    ...
    ["dim", "one", "all", "elements", "regex"],
    ["dim", "two", "all", "elements", "regex"],
    ["dim", "three", "all", "elements", "regex"],
    ["dim", "four", "all", "elements", "regex"],
    ["dim", "one", "equal"],
    ["dim", "two", "equal"],
    ["dim", "three", "equal"],
    ["dim", "four", "equal"],
