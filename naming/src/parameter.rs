naming_macros::generate_self_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["postgresql", "json", "type", "object", "self", "option", "to", "update", "try", "generate", "postgresql", "query", "part", "error", "named"],
    ["postgresql", "json", "type", "std", "option", "option", "object", "self", "option", "to", "update", "try", "generate", "postgresql", "query", "part", "error", "named"],
    ["postgresql", "json", "type", "std", "vec", "vec", "object", "with", "id", "self", "option", "to", "update", "try", "generate", "postgresql", "query", "part", "error", "named"],
    ["postgresql", "json", "type", "std", "option", "option", "std", "vec", "vec", "object", "with", "id", "self", "option", "to", "update", "try", "generate", "postgresql", "query", "part", "error", "named"],
    ["postgresql", "json", "type", "object", "self", "option", "to", "update", "try", "generate", "postgresql", "query", "part", "error", "named", "with", "serialize", "deserialize"],
    ["postgresql", "json", "type", "self", "option", "to", "update", "try", "generate", "postgresql", "query", "part", "error", "named", "with", "serialize", "deserialize"],
    ["postgresql", "json", "type", "self", "options", "to", "read", "with", "or", "without", "id", "try", "from", "error", "named"],
    ["postgresql", "type", "object", "self", "column"],
    ["postgresql", "type", "std", "option", "option", "object", "self", "column"],
    ["postgresql", "type", "std", "vec", "vec", "object", "with", "id", "self", "column"],
    ["postgresql", "type", "std", "option", "option", "std", "vec", "vec", "object", "with", "id", "self", "column"],
    ["object", "self", "to", "update"],
    ["std", "option", "option", "object", "self", "to", "update"],
    ["std", "vec", "vec", "object", "with", "id", "self", "to", "update"],
    ["std", "option", "option", "std", "vec", "vec", "object", "with", "id", "self", "to", "update"]
]);
