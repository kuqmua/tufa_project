naming_macros::generate_self_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["postgresql", "type", "self", "where", "between", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "in"],
    ["postgresql", "type", "self", "where", "in", "try", "new", "error", "named"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "equal"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "greater", "than"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "between"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "in"],
    ["std", "option", "option", "self", "where"],
    ["postgresql", "type", "self", "where", "case", "sensitive", "regular", "expression"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "case", "sensitive", "regular", "expression"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "case", "insensitive", "regular", "expression"],
    ["postgresql", "type", "self", "where", "case", "insensitive", "regular", "expression"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "hexadecimal", "notation", "equal"],
    ["postgresql", "type", "self", "where", "hexadecimal", "notation", "equal"],
    ["postgresql", "type", "self", "where", "length", "greater", "than"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "length", "greater", "than"],
    ["postgresql", "type", "self", "where", "length", "greater", "than", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "equal", "to", "encoded", "string", "representation"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "equal", "to", "encoded", "string", "representation"],
    ["postgresql", "type", "self", "where", "value", "is", "contained", "within", "range"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "value", "is", "contained", "within", "range"],
    ["postgresql", "type", "self", "where", "contains", "another", "range"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "contains", "another", "range"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "is", "null"],
    ...
    ["postgresql", "type", "self", "where", "position", "equals", "try", "new", "error", "named"],
    ...
    ["postgresql", "json", "type", "self", "where", "between", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "in"],
    ["postgresql", "json", "type", "self", "where", "in", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "case", "sensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "case", "sensitive", "regular", "expression"],
    ["postgresql", "json", "type", "self", "where", "case", "sensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "case", "insensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "case", "insensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "case", "insensitive", "regular", "expression"],
    ["postgresql", "json", "type", "std", "option", "option", "self", "where", "is", "null"],
    ...
    ["postgresql", "json", "type", "self", "where", "length", "greater", "than", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "length", "greater", "than"],
    ["postgresql", "json", "type", "self", "where", "position", "equals", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "position", "equals"],
    ["postgresql", "type", "self", "where", "bit", "vec", "position", "equals", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "bit", "vec", "position", "equals"],
    ["postgresql", "json", "type", "self", "where", "bit", "vec", "position", "equals", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "bit", "vec", "position", "equals"],
    ["postgresql", "type", "self", "where", "position", "greater", "than", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "position", "greater", "than", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "position", "greater", "than"],
    ["postgresql", "json", "type", "self", "where", "position", "greater", "than"],
    ["postgresql", "json", "type", "self", "where", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "position", "case", "sensitive", "regular", "expression"],
    ["postgresql", "json", "type", "self", "where", "position", "case", "sensitive", "regular", "expression"],
    ["postgresql", "type", "self", "where", "position", "case", "sensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "position", "case", "sensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "position", "case", "insensitive", "regular", "expression"],
    ["postgresql", "json", "type", "self", "where", "position", "case", "insensitive", "regular", "expression"],
    ["postgresql", "type", "self", "where", "position", "case", "insensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "position", "case", "insensitive", "regular", "expression", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "contains", "all", "elements", "of", "array", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "contains", "all", "elements", "of", "array", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "contains", "all", "elements", "of", "array"],
    ["postgresql", "json", "type", "self", "where", "contains", "all", "elements", "of", "array"],
    ...
    ["postgresql", "type", "where", "self", "try", "new", "error", "named"],
    ["postgresql", "type", "where", "self", "try", "new", "error", "named", "with", "serialize", "deserialize"],
    ["postgresql", "json", "type", "where", "self"],
    ["postgresql", "json", "type", "where", "self", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "where", "self", "try", "new", "error", "named", "with", "serialize", "deserialize"],
    ...
    ["self", "read", "one", "error", "named", "with", "serialize", "deserialize"],
