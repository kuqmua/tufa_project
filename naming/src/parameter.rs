naming_macros::generate_self_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["self", "as", "postgresql", "jsonb", "update", "query", "part", "error", "named"],
    ["self", "as", "postgresql", "jsonb", "not", "null", "update", "query", "part", "error", "named"],
    ...
    ["postgresql", "json", "type", "self", "where", "element", "second", "dimension"],
    ["self", "visitor"],
