naming_macros::generate_self_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["postgresql", "type", "self", "where", "element", "length"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "element", "length"],
    ["postgresql", "type", "self", "where", "element", "length", "try", "new", "error", "named"],
    ["postgresql", "type", "self", "where", "element", "encode"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "element", "encode"],
    ["postgresql", "type", "self", "where", "element", "binary", "pattern"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "element", "binary", "pattern"]
]);
