naming_macros::generate_self_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["postgresql", "type", "self", "where", "element", "length", "greater", "than"],
    ["postgresql", "type", "std", "option", "option", "self", "where", "element", "length", "greater", "than"],
    ["postgresql", "type", "self", "where", "element", "length", "greater", "than", "try", "new", "error", "named"],
    ...
    ["postgresql", "json", "type", "self", "where", "element", "length", "greater", "than", "try", "new", "error", "named"],
    ["postgresql", "json", "type", "self", "where", "element", "length", "greater", "than"],
