...
pub async fn net_check_availability<T: app_state::GetStartingCheckLink + std::marker::Send + std::marker::Sync>(config: T) -> Result<(), Box<NetCheckAvailabilityErrorNamed>> {
