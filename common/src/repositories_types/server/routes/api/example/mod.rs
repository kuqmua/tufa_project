...
pub struct Animal {
    ...
    // pub field_5: postgresql_crud::OptionVecOfOptionStdPrimitiveI8AsNullableArrayOfNullableJsonbNumber,s
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        let mut acc = vec![];
        if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create.field_2) {
            for element in value.clone() {
                acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 479db858-6f36-48ba-9ab0-741b7df7956c")));
            }
            let whole = AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error beaeb784-58ea-4836-9c54-73924493bfb4"));
...
impl postgresql_crud::PostgresqlTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for OptionAnimalAsNullableJsonbObject {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        match create.0 {
            Some(create) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
...
impl postgresql_crud::PostgresqlTypeTestCases for OptionAnimalAsNullableJsonbObject {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        ...
        for (index, create) in create.0.clone().into_iter().into_iter().enumerate() {
            ...
            >::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(
                create.field_2
            ) {
                for element in value.clone() {
                    acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(
                        postgresql_crud::PostgresqlTypeWhere::try_new(
                            postgresql_crud::LogicalOperator::And,
                            vec![element]
                        )
                ...
                let whole = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(
                    postgresql_crud::PostgresqlTypeWhere::try_new(
                        postgresql_crud::LogicalOperator::And,
                        value
                    )
        ...
        acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::LengthEqual(
            postgresql_crud::PostgresqlJsonTypeWhereElementLengthEqual {
                logical_operator: postgresql_crud::LogicalOperator::And,//todo Or And ?
                value: postgresql_crud::UnsignedPartOfStdPrimitiveI32::try_from(
                    std::primitive::i32::try_from(create.0.len()).expect("error 1fbbd897-2fae-4271-9fac-4b4007aecf32")
...
impl postgresql_crud::PostgresqlTypeTestCases for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        match create.0 {
            Some(create) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
...
impl postgresql_crud::PostgresqlTypeTestCases for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
