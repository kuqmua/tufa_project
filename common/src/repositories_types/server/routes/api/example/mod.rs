...
impl ExampleUpdate {
    ...
    fn update_query_part_column_0(
        value: &postgresql_crud::Value<<postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Update>,
                    ...
                    for element in &parameters.payload.0 {
                        if let Some(value) = &element.column_0 {
                            acc.push_str(&format!(
                                ...
                                match ExampleUpdate::update_query_part_column_0(
                                    &value,
                                    &mut increment
                                ) {
                                    Ok(value) => value,
    ...
    pub async fn try_update_one_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let query_string = {
            ...
            if let Some(value) = &parameters.payload.column_0 {
                let value = match <postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::update_query_part(&value.value, &"", &"column_0", &"", &mut increment) {
                    Ok(value) => value,
                    Err(error_0) => {
            ...
            if let Some(value) = &parameters.payload.animal_as_not_null_jsonb_object {
                let value = match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::update_query_part(&value.value, &"", &"animal_as_not_null_jsonb_object", &"", &mut increment) {
                    Ok(value) => value,
                    Err(error_0) => {
                        let error = ExampleTryUpdateOneRouteLogicErrorNamed::QueryPart {
                            error: error_0,
            ...
            query.push_str(&format!(
                ...
                match parameters.payload.update_query_part_primary_key(&mut increment) {
                    Ok(value) => value,
                    Err(error_0) => {
                        let error = ExampleTryUpdateOneRouteLogicErrorNamed::QueryPart {
                            error: error_0,
