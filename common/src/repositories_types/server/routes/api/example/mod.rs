...
impl postgresql_crud::PostgresqlType for AnimalAsNotNullJsonbObject {
    ...
    fn update_query_bind<'a>(value: Self::Update, 
        // mut 
        query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::Update, 
    // mut 
    query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
...
impl postgresql_crud::PostgresqlJsonType for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    type CreateForQuery = AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery;
    fn create_query_part(value: &Self::Create, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        let mut increments = std::string::String::from("");
        match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::create_query_part(&value.field_0, increment) {
            Ok(value) => {
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        vec![vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
            ...
            field_1: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(read_only_ids.0.value.field_1.clone()),
        }]]
    }
...
impl postgresql_crud::PostgresqlJsonType for OptionAnimalAsNullableJsonbObject {
    ...
    fn create_query_bind(value: Self::Create, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        match value.0 {
            Some(value) => <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::create_query_bind(value, query),
            None => {
...
#[derive(Debug, serde :: Serialize)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery(std::vec::Vec<<AnimalWithIdAsNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::CreateForQuery>);
impl std::convert::From<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn from(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate) -> Self {
        Self(value.0.into_iter().map(|element| <AnimalWithIdAsNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(element)).collect())
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl postgresql_crud::PostgresqlJsonType for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn create_query_part(value: &Self::Create, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in &value.0 {
            match <AnimalWithIdAsNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::create_query_part(element, increment) {
                Ok(value) => {
...
impl postgresql_crud::PostgresqlJsonType for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn create_query_bind(value: Self::Create, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        match value.0 {
            Some(value) => <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::create_query_bind(value, query),
            None => {
