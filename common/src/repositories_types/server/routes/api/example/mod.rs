        ...
        std::thread::Builder::new()
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().unwrap().block_on(async {
                    ...
                    // for element in <postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::tests::PostgresqlTypeTestCases<<postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::ReadInner>>::test_cases() {
                    //     let some_value_update = Some(postgresql_crud::Value {
                    ...
                    //     );
                    // }
                    for element in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases<
                    ...
                    >>::test_cases()
                    {
                        ...
                        let select_primary_key_field_ident = postgresql_crud::NotEmptyUniqueEnumVec::try_new(
                            vec![
                                ...
                                super::ExampleSelect::Column154(
                                    <
                                        <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Select
                                        as
                                        postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()
                                )
                            ]
                        ...
                        let vec_of_ident_read_returned_from_read_many = vec_of_ident_read_with_primary_key_sort_by_primary_key(
                            super::Example::try_read_many(
                                &url,
                                {
                                    let f = super::ExampleReadManyParameters {
                                        payload: super::ExampleReadManyPayload {
                                            where_many: where_many_1_and_2_primary_keys.clone(),
                                            select: select_primary_key_field_ident.clone(),
                                            order_by: postgresql_crud::OrderBy {
                        ...
                        //     primary_key_read_returned_from_create_one.clone(),
                        //     primary_key_returned_from_update_one,
                        //     "try_update_one result different for column_154: crate :: repositories_types :: server :: routes :: api :: example ::AnimalAsNotNullJsonbObject"
                        // );
                        // let ident_read_returned_from_read_one = super::Example::try_read_one(
                        //     &url,
                        //     super::ExampleReadOneParameters {
                        ...
                        //     },
                        //     ident_read_returned_from_read_one,
                        //     "try_read_one result different after try_update_one for column_154: crate :: repositories_types :: server :: routes :: api :: example ::AnimalAsNotNullJsonbObject"
                        // );
                    }
                    //here
                    {
                        ...
                        let column_154_test_cases = <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases<<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadInner>>::test_cases();
                        let vec = (0..column_0_test_cases.len().max(column_154_test_cases.len()))
                        .map(|i| (
                            column_0_test_cases.get(i),
                            column_154_test_cases.get(i),
                            vec![
                                super::ExampleUpdate::try_new(
                        ...
                        .collect::<std::vec::Vec<(
                            std::option::Option<&<postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::ReadInner>,
                            std::option::Option<&<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadInner>,
                            std::vec::Vec<crate::repositories_types::server::routes::api::example::ExampleUpdate>
                        )>>();
                        for element in vec {
                            let current_option_column_0 = element.0;
                            let current_option_column_154 = element.1;
                            let vec_of_primary_keys_returned_from_update_many = {
                                let mut value = super::Example::try_update_many(
                                    &url,
                                    super::ExampleUpdateManyParameters {
                                        payload: super::ExampleUpdateManyPayload::try_new(element.2).unwrap(),
                                    },
                                )
                                .await
                                .unwrap();
                            ...
                            let select_primary_key_field_ident = postgresql_crud::NotEmptyUniqueEnumVec::try_new(
                                vec![
                                    ...
                                    super::ExampleSelect::Column0(
                                        <
                                            <postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Select
                                            as
                                            postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()
                                    ),
                                    super::ExampleSelect::Column154(
                            ...
                            let vec2 = vec![
                                super::ExampleRead {
                                    ...
                                    column_0: match current_option_column_0 {
                                        Some(value) => Some(postgresql_crud::Value {
                                    ...
                                    column_154: match current_option_column_154 {
                                        Some(value) => Some(postgresql_crud::Value {
