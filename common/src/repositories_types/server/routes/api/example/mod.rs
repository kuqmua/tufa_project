...
//     "value": [
//       {
//         "id": "59b85e20-0061-4103-b4cc-d061cd3e645d",
...
pub async fn try_read_many_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
    ...
    // let json_input = r#"{"vec_of_doggie_with_id_as_not_null_array_of_not_null_jsonb_object_with_id": {"value": [{"id": "59b85e20-0061-4103-b4cc-d061cd3e645d","column_7bd2f76f_276c_4855_8ee0_4b6ce0ac5015": 0,"column_f85f2f57_f85b_4126_be0f_cb5830f0475d": 0}]}}"#;
    // println!("{}");
    // let body_bytes = serde_json::to_vec(&json_input).unwrap();
...
//     vec_of_doggie_with_id_as_not_null_array_of_not_null_jsonb_object_with_id: Some(
//         Value {
//             value: VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead {
//                 column_7bd2f76f_276c_4855_8ee0_4b6ce0ac5015: Some(
//                     Value {
...
//                     },
//                 ),
//                 column_f85f2f57_f85b_4126_be0f_cb5830f0475d: Some(
//                     Value {
//                         value: StdPrimitiveI16AsNotNullJsonbNumberOrigin(
//                             0,
//                         ),
//                     },
//                 ),
...
//     ),
// }
                        use postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement;
                        let f = <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Read::default_but_option_is_always_some_and_vec_always_contains_one_element();
                        println!("{f:#?}");
                        for element in &parameters.payload.select {
                            match element {
