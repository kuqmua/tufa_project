            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().unwrap().block_on(async {
                    ...
                    ident_create_default = super :: ExampleCreate
                    {
                        ...
                        ::
                        default_but_option_is_always_some_and_vec_always_contains_one_element(),
                        column_112 : < < postgresql_crud :: postgresql_type ::
                        SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range as
                        postgresql_crud :: PostgresqlType > :: Create as
                        postgresql_crud ::
                        DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement >
                        ::
                    ...
                    for element in <postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::tests::PostgresqlTypeTestCases>::test_cases() {
                        let some_value_update = Some(postgresql_crud::Value {
                            value: <postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Update::new_or_try_new_unwraped_for_test(element.clone()),
                        });
                        let vec_of_primary_keys_returned_from_update_many = {
                            let mut value = super::Example::try_update_many(
                                &url,
                        ...
                        let some_value_field_ident_read = Some(postgresql_crud::Value {
                            value: <postgresql_crud::postgresql_type::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Read::new_or_try_new_unwraped_for_test(element),
                        });
                        assert_eq!(
                            vec_of_ident_read_with_primary_key_sort_by_primary_key(vec![
                                super::ExampleRead {
                    ...
                    for element in <postgresql_crud::postgresql_type::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range as postgresql_crud::tests::PostgresqlTypeTestCases>::test_cases() {
                        let some_value_update = Some(postgresql_crud::Value {
                            value: <postgresql_crud::postgresql_type::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range as postgresql_crud::PostgresqlType>::Update::new_or_try_new_unwraped_for_test(element.clone()),
                        });
                        let vec_of_primary_keys_returned_from_update_many = {
                            let mut value = super::Example::try_update_many(
                                &url,
                        ...
                        assert_eq!(
                            ...
                            vec_of_primary_keys_returned_from_update_many,
                            "try_update_many result different for column_112: postgresql_crud :: postgresql_type ::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range"
                        );
                        let select_primary_key_field_ident = postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec!
                        [super :: ExampleSelect ::
                        PrimaryKeyColumn(< < postgresql_crud :: postgresql_type ::
                        ...
                        default_but_option_is_always_some_and_vec_always_contains_one_element()),
                        super :: ExampleSelect ::
                        Column112(< < postgresql_crud :: postgresql_type ::
                        SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range as
                        postgresql_crud :: PostgresqlType > :: Select as
                        postgresql_crud ::
                        DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement >
                        ...
                        let some_value_field_ident_read = Some(postgresql_crud::Value {
                            value: <postgresql_crud::postgresql_type::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range as postgresql_crud::PostgresqlType>::Read::new_or_try_new_unwraped_for_test(element),
                        });
                        //here
                        assert_eq!(
                            {
                                ...
                                vec_of_ident_read_with_primary_key_sort_by_primary_key(vec![
                                    super::ExampleRead {
                                        primary_key_column: some_value_primary_key_read_returned_from_create_many1.clone(),
                                        column_112: some_value_field_ident_read.clone(),
                                        column_0: None
                                    },
                                    super::ExampleRead {
                                        primary_key_column: some_value_primary_key_read_returned_from_create_many2.clone(),
                                ...
                                ])
                                {
                                    acc.push(super::ExampleRead {
                                        primary_key_column: element.primary_key_column,
                                        //here
                                        column_112: match element.column_112 {
                            ...
                            vec_of_ident_read_returned_from_read_many,
                            "try_read_many result different after try_update_many for column_112: postgresql_crud :: postgresql_type ::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range"
                        );
                        let primary_key_returned_from_update_one = super::Example::try_update_one(
                            &url,
                            super::ExampleUpdateOneParameters {
                        ...
                        assert_eq!(
                            primary_key_read_returned_from_create_one.clone(),
                            primary_key_returned_from_update_one,
                            "try_update_one result different for column_112: postgresql_crud :: postgresql_type ::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range"
                        );
                        let ident_read_returned_from_read_one = super::Example::try_read_one(
                            &url,
                            super::ExampleReadOneParameters {
                        ...
                        assert_eq!(
                            super::ExampleRead {
                                primary_key_column: some_value_primary_key_read_returned_from_create_one.clone(),
                                //here
                                column_112: match some_value_field_ident_read.clone() {
                                    Some(value) => Some(postgresql_crud::Value {
                                        value: value.value.normalize()
                                    }),
                                    None => None
                            ...
                            ident_read_returned_from_read_one,
                            "try_read_one result different after try_update_one for column_112: postgresql_crud :: postgresql_type ::SqlxPostgresTypesPgRangeStdPrimitiveI32AsNotNullInt4Range"
                        );
                    }
                    let vec_of_primary_keys_returned_from_delete_many = {
                        let mut value = super::Example::try_delete_many(
