        ...
        for element in value.0.to_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field0(value) => {
                    match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(&value.value, query) {
                        Ok(value) => {
                            query = value;
                        },
                        Err(error) => {
...
impl postgresql_crud::PostgresqlJsonType for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn select_only_updated_ids_query_part(value: &Self::Update, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            //here
            // let mut current_acc = format!("jsonb_build_object('id',jsonb_build_object('value','{}'))||", element.id.get_inner());
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        vec![vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
            ...
            field_0: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(read_only_ids.0.value.field_0.clone()),
        }]]
    }
...
impl Example {
    ...
    pub async fn prepare_postgresql(pool: &sqlx::Pool<sqlx::Postgres>) -> Result<(), ExamplePreparePostgresqlErrorNamed> {
        ...
        let prepare_postgresql_query_stringified = format!(
            ...
            <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::TableTypeDeclaration::create_table_column_query_part(&"primary_key_column", true),
            <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::TableTypeDeclaration::create_table_column_query_part(&"column_156", false)
        );
    ...
    fn generate_select_query_part(select: &postgresql_crud::NotEmptyUniqueEnumVec<ExampleSelect>) -> std::string::String {
        ...
        for element in select.to_vec() {
            value.push_str(&match element {
                ...
                ExampleSelect::Column156(value) => <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::select_query_part(value, "column_156"),
            });
            value.push_str(",");
        }
...
pub struct ExampleCreate {
    pub column_156: <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Create,
}
impl ExampleCreate {
    fn create_query_part(&self, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        let mut acc = std::string::String::default();
        ...
        match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::create_query_part(&self.column_156, increment) {
            Ok(value) => {
                acc.push_str(&format!("{value},"));
            }
            Err(error_0) => {
    ...
    fn create_query_bind(self, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        ...
        match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::create_query_bind(self.column_156, query) {
            Ok(value) => {
                query = value;
            }
            Err(error_0) => {
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleCreate {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            column_156: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        }
    }
}
...
pub struct ExampleWhereMany {
    ...
    column_156: std::option::Option<postgresql_crud::PostgresqlTypeWhere<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::WhereElement>>,
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "column_156" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                fn visit_bytes<__E>(self, __value: &[u8]) -> _serde::__private::Result<Self::Value, __E>
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"column_156" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    let __field1 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::WhereElement>>>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct ExampleWhereMany with 2 elements"));
                        }
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field1: serde::__private::Option<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::WhereElement>>> = serde::__private::None;
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                if serde::__private::Option::is_some(&__field0) {
                            ...
                            __Field::__field1 => {
                                if serde::__private::Option::is_some(&__field1) {
                                    return serde::__private::Err(<__A::Error as serde::de::Error>::duplicate_field("column_156"));
                                }
                                __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::WhereElement>>>(&mut __map)?);
                            }
                            _ => {
                                let _ = _serde::de::MapAccess::next_value::<_serde::de::IgnoredAny>(&mut __map)?;
                            }
                    ...
                    let __field1 = match __field1 {
                        serde::__private::Some(__field1) => __field1,
                        serde::__private::None => serde::__private::de::missing_field("column_156")?,
                    };
                    match ExampleWhereMany::try_new(__field0, __field1) {
                        Ok(value) => serde::__private::Ok(value),
                        Err(error) => {
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["primary_key_column", "column_156"];
            _serde::Deserializer::deserialize_struct(
                __deserializer,
                "ExampleWhereMany",
                FIELDS,
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleWhereMany {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            ...
            column_156: Some(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
        }
    }
}
#[derive(
    ...
    fn query_part(&self, increment: &mut std::primitive::u64, _: &dyn std::fmt::Display, _: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(match &self.0 {
            Some(value) => {
                ...
                if let Some(value) = &value.column_156 {
                    match postgresql_crud::PostgresqlTypeWhereFilter::query_part(value, increment, &"column_156", is_first_push_to_additional_parameters_already_happend) {
                        Ok(value) => {
                            additional_parameters.push_str(&value);
                        }
                        Err(error_0) => {
...
pub enum ExampleSelect {
    ...
    #[serde(rename(serialize = "column_156", deserialize = "column_156"))]
    Column156(<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Select),
}
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleSelect {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![
            ExampleSelect::PrimaryKeyColumn(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
            ExampleSelect::Column156(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
        ]
    }
}
...
pub struct ExampleRead {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub column_156: std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Read>>,
}
impl ExampleRead {
    fn try_from_sqlx_postgres_pg_row_with_not_empty_unique_enum_vec_example_select(value: sqlx::postgres::PgRow, select: &postgresql_crud::NotEmptyUniqueEnumVec<ExampleSelect>) -> Result<Self, sqlx::Error> {
        ...
        let mut column_156: std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Read>> = None;
        for element in select.to_vec() {
            match element {
                ...
                ExampleSelect::Column156(_) => match sqlx::Row::try_get::<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Read, &std::primitive::str>(&value, "column_156") {
                    Ok(value) => {
                        column_156 = Some(postgresql_crud::Value { value: value });
                    }
                    Err(error_0) => {
                        return Err(error_0);
                    }
...
pub struct ExampleReadOnlyIds {
    ...
    pub column_156: std::option::Option<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::ReadOnlyIds>,
}
impl std::convert::TryFrom<sqlx::postgres::PgRow> for ExampleReadOnlyIds {
    ...
    fn try_from(value: sqlx::postgres::PgRow) -> Result<Self, Self::Error> {
        ...
        let column_156 = if let Ok(value) = sqlx::Row::try_get::<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::ReadOnlyIds, &std::primitive::str>(&value, "column_156") {
            Some(value)
        } else {
            None
        };
...
pub struct ExampleUpdate {
    ...
    column_156: std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Update>>,
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
...
impl ExampleUpdate {
    pub fn try_new(primary_key_column: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlUpdate, column_156: std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Update>>) -> Result<ExampleUpdate, ExampleUpdateTryNewErrorNamed> {
        if let None = &column_156 {
    ...
    fn update_query_part_column_156(value: &postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Update>, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::update_query_part(&value.value, &"column_156", &"column_156", &"", increment) {
            Ok(value) => Ok(value),
            Err(error_0) => Err(error_0),
        }
    }
    fn select_only_updated_ids_query_part(&self, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        if let Some(value) = &self.column_156 {
            acc.push_str(&match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::select_only_updated_ids_query_part(&value.value, "column_156", increment, false) {
                Ok(value) => value,
                Err(error) => {
                    return Err(error);
                }
    ...
    //here
    // fn select_only_updated_ids_query_bind<'a>(&self, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
    //     if let Some(value) = &self.column_156 {
    //         match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::select_only_updated_ids_query_bind(&value, query) {
    //             Ok(value) => {
    //                 query = value;
    //             },
    //             Err(error) => {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    let __field1 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Update>>>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct ExampleUpdate with 2 elements"));
                        }
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field1: serde::__private::Option<std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Update>>> = serde::__private::None;
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                if serde::__private::Option::is_some(&__field0) {
                            ...
                            __Field::__field1 => {
                                ...
                                __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::Value<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Update>>>(&mut __map)?);
                            }
                            _ => {
                                let _ = _serde::de::MapAccess::next_value::<_serde::de::IgnoredAny>(&mut __map)?;
                            }
...
impl Example {
    pub async fn create_many(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request) -> axum::response::Response {
        ...
        {
            let error = ExampleCreateManyErrorNamed::HeaderContentTypeApplicationJsonNotFound {
        ...
        let body_bytes = match postgresql_crud::check_body_size::check_body_size(body, *app_state.get_maximum_size_of_http_body_in_bytes()).await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleCreateManyErrorNamed::CheckBodySize {
        ...
        let parameters = ExampleCreateManyParameters {
            payload: match serde_json::from_slice::<ExampleCreateManyPayload>(&body_bytes) {
                ...
                Err(error_0) => {
                    let error = ExampleCreateManyErrorNamed::SerdeJson {
                        serde_json: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
            ...
            "primary_key_column,column_156",
            {
                ...
                for element in &parameters.payload.0 {
                    match element.create_query_part(&mut increment) {
                        ...
                        Err(error_0) => {
                            let error = ExampleCreateManyErrorNamed::QueryPart {
                                error: error_0,
                                code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                    file!().to_owned(),
                                    line!(),
        ...
        let binded_query = {
            ...
            for element in parameters.payload.0 {
                match element.create_query_bind(query) {
                    ...
                    Err(error_0) => {
                        let error = ExampleCreateManyErrorNamed::TryBind {
                            try_bind: error_0,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                file!().to_owned(),
                                line!(),
...
impl Example {
    pub async fn try_create_many(endpoint_location: &std::primitive::str, parameters: ExampleCreateManyParameters) -> Result<std::vec::Vec<ExampleReadOnlyIds>, ExampleTryCreateManyErrorNamed> {
        ...
        Err(ExampleTryCreateManyErrorNamed::ExampleCreateManyErrorNamedWithSerializeDeserialize {
...
impl Example {
    pub async fn create_one(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request) -> axum::response::Response {
        ...
        from_static("application/json"))
        {
            let error = ExampleCreateOneErrorNamed::HeaderContentTypeApplicationJsonNotFound {
                code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                    file!().to_owned(),
                    line!(),
                    column!(),
        ...
        let body_bytes = match postgresql_crud::check_body_size::check_body_size(body, *app_state.get_maximum_size_of_http_body_in_bytes()).await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleCreateOneErrorNamed::CheckBodySize {
                    check_body_size: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
        ...
        let parameters = ExampleCreateOneParameters {
            payload: match serde_json::from_slice::<ExampleCreate>(&body_bytes) {
                ...
                Err(error_0) => {
                    let error = ExampleCreateOneErrorNamed::SerdeJson {
                        serde_json: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
        ...
        let query_string = postgresql_crud::generate_create_one_query_string(
            ...
            &{
                let mut acc = std::string::String::new();
                acc.push_str(&<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::select_only_ids_query_part("primary_key_column", true));
                acc.push_str(&<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::select_only_ids_query_part("column_156", false));
                let _ = acc.pop();
                acc
            },
        );
        ...
        let binded_query = {
            ...
            match parameters.payload.create_query_bind(query) {
                ...
                Err(error_0) => {
                    let error = ExampleCreateOneErrorNamed::TryBind {
                        try_bind: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
...
impl Example {
    pub async fn try_create_one(endpoint_location: &std::primitive::str, parameters: ExampleCreateOneParameters) -> Result<ExampleReadOnlyIds, ExampleTryCreateOneErrorNamed> {
        ...
        Err(ExampleTryCreateOneErrorNamed::ExampleCreateOneErrorNamedWithSerializeDeserialize {
            ...
            };
            {
                ...
                additional_parameters.push_str(&format!(
                    ...
                    &match &value.column {
                        ...
                        ExampleSelect::Column156(_) => "column_156",
                    },
                    order,
                ));
            }
    ...
    fn try_new(value: std::vec::Vec<ExampleUpdate>) -> Result<Self, ExampleUpdateManyPayloadTryNewErrorNamed> {
        ...
        for element in &value {
            if !acc.contains(&&element.primary_key_column) {
                ...
                return Err(ExampleUpdateManyPayloadTryNewErrorNamed::NotUniquePrimaryKey {
...
impl Example {
    pub async fn update_many(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request) -> axum::response::Response {
        ...
        from_static("application/json"))
        {
            let error = ExampleUpdateManyErrorNamed::HeaderContentTypeApplicationJsonNotFound {
                code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                    file!().to_owned(),
                    line!(),
                    column!(),
        ...
        let body_bytes = match postgresql_crud::check_body_size::check_body_size(body, *app_state.get_maximum_size_of_http_body_in_bytes()).await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleUpdateManyErrorNamed::CheckBodySize {
                    check_body_size: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
        ...
        let parameters = ExampleUpdateManyParameters {
            payload: match serde_json::from_slice::<ExampleUpdateManyPayload>(&body_bytes) {
                ...
                Err(error_0) => {
                    let error = ExampleUpdateManyErrorNamed::SerdeJson {
                        serde_json: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
        ...
        let query_string = {
            ...
            let elements = {
                let mut acc = std::string::String::default();
                {
                    let mut is_column_156_update_exist = false;
                    for element in &parameters.payload.0 {
                        if element.column_156.is_some() {
                            is_column_156_update_exist = true;
                            break;
                        }
                    }
                    if is_column_156_update_exist {
                        acc.push_str(&postgresql_crud::generate_column_equals_case_acc_else_column_end_comma_update_many_query_part(&"column_156", {
                            let mut acc = std::string::String::default();
                            for element in &parameters.payload.0 {
                                if let Some(value) = &element.column_156 {
                                    acc.push_str(&postgresql_crud::generate_when_column_id_then_value_update_many_query_part(
                                        ...
                                        match element.update_query_part_primary_key(&mut increment) {
                                            Ok(value) => value,
                                            Err(error_0) => {
                                                let error = ExampleUpdateManyErrorNamed::QueryPart {
                                                    error: error_0,
                                                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                                        file!().to_owned(),
                                                        line!(),
                                        ...
                                        match ExampleUpdate::update_query_part_column_156(&value, &mut increment) {
                                            Ok(value) => value,
                                            Err(error_0) => {
                                                let error = ExampleUpdateManyErrorNamed::QueryPart {
                                                    error: error_0,
            ...
            for element in &parameters.payload.0 {
                if let Some(value) = &element.column_156 {
                    if let Err(error_0) = query.try_bind(element.primary_key_column.clone()) {
                        ...
                        let error = ExampleUpdateManyErrorNamed::TryBind {
                            try_bind: error_0,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                file!().to_owned(),
                                line!(),
                    ...
                    match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::update_query_bind(value.value.clone(), query) {
                        Ok(value) => {
                            query = value;
                        }
                        Err(error_0) => {
        ...
        let mut pool_connection = match app_state.get_postgres_pool().acquire().await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleUpdateManyErrorNamed::Postgresql {
                    postgresql: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
                        ...
                        Some(value) => match sqlx::Row::try_get::<<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::PrimaryKey, &std::primitive::str>(&value, &Example::primary_key()) {
                            ...
                            Err(error_0) => {
                                ...
                                match executor.rollback().await {
                                    ...
                                    Err(error_1) => {
                                        let error = ExampleUpdateManyErrorNamed::RowAndRollback {
                                            row: error_0,
                                            rollback: error_1,
                                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                                file!().to_owned(),
...
impl Example {
    pub async fn try_update_many(endpoint_location: &std::primitive::str, parameters: ExampleUpdateManyParameters) -> Result<std::vec::Vec<<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::PrimaryKey>, ExampleTryUpdateManyErrorNamed> {
        ...
        Err(ExampleTryUpdateManyErrorNamed::ExampleUpdateManyErrorNamedWithSerializeDeserialize {
...
impl Example {
    pub async fn update_one(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let query_string = {
            ...
            let columns = {
                let mut acc = std::string::String::default();
                if let Some(value) = &parameters.payload.column_156 {
            ...
            println!("RETURN COLUMNS {return_columns}\n\n----------");
        ...
        let binded_query = {
            let mut query = sqlx::query::<sqlx::Postgres>(&query_string);
            //here
            // let payload_cloned: bool = parameters.payload;
            if let Some(ref value) = parameters.payload.column_156 {
                match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::update_query_bind(value.value.clone(), query) {
                    Ok(value) => {
                        query = value;
                    }
                    Err(error_0) => {
                        let error = ExampleUpdateOneErrorNamed::TryBind {
                            try_bind: error_0,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                file!().to_owned(),
                                line!(),
            ...
            match <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::update_query_bind(parameters.payload.primary_key_column, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error_0) => {
            ...
            //here
            if let Some(value) = &parameters.payload.column_156 {
                match <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::select_only_updated_ids_query_bind(&value.value, query) {
                    Ok(value) => {
                        query = value;
                    },
                    Err(error_0) => {
...
impl Example {
    pub async fn delete_many(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let body_bytes = match postgresql_crud::check_body_size::check_body_size(body, *app_state.get_maximum_size_of_http_body_in_bytes()).await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleDeleteManyErrorNamed::CheckBodySize {
                    check_body_size: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
        ...
        let parameters = ExampleDeleteManyParameters {
            payload: match serde_json::from_slice::<ExampleDeleteManyPayload>(&body_bytes) {
                ...
                Err(error_0) => {
                    let error = ExampleDeleteManyErrorNamed::SerdeJson {
                        serde_json: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
        ...
        let query_string = postgresql_crud::generate_delete_many_query_string(
            &Example::table_name(),
            {
                ...
                let additional_parameters = match postgresql_crud::PostgresqlTypeWhereFilter::query_part(&parameters.payload.where_many, &mut increment, &"", false) {
                    Ok(value) => value,
                    Err(error_0) => {
                        let error = ExampleDeleteManyErrorNamed::QueryPart {
                            error: error_0,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                file!().to_owned(),
                                line!(),
        ...
        let binded_query = {
            ...
            match postgresql_crud::PostgresqlTypeWhereFilter::query_bind(parameters.payload.where_many, query) {
                ...
                Err(error_0) => {
                    let error = ExampleDeleteManyErrorNamed::TryBind {
                        try_bind: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
        ...
        let mut pool_connection = match app_state.get_postgres_pool().acquire().await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleDeleteManyErrorNamed::Postgresql {
                    postgresql: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
                        ...
                        Some(value) => match sqlx::Row::try_get::<<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::PrimaryKey, &std::primitive::str>(&value, &Example::primary_key()) {
                            ...
                            Err(error_0) => {
                                ...
                                match executor.rollback().await {
                                    ...
                                    Err(error_1) => {
                                        let error = ExampleDeleteManyErrorNamed::RowAndRollback {
                                            row: error_0,
                                            rollback: error_1,
                                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                                file!().to_owned(),
...
impl Example {
    pub async fn delete_one(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request) -> axum::response::Response {
        ...
        from_static("application/json"))
        {
            let error = ExampleDeleteOneErrorNamed::HeaderContentTypeApplicationJsonNotFound {
                code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                    file!().to_owned(),
                    line!(),
                    column!(),
        ...
        let body_bytes = match postgresql_crud::check_body_size::check_body_size(body, *app_state.get_maximum_size_of_http_body_in_bytes()).await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleDeleteOneErrorNamed::CheckBodySize {
                    check_body_size: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
        ...
        let parameters = ExampleDeleteOneParameters {
            payload: match serde_json::from_slice::<ExampleDeleteOnePayload>(&body_bytes) {
                ...
                Err(error_0) => {
                    let error = ExampleDeleteOneErrorNamed::SerdeJson {
                        serde_json: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
        ...
        let binded_query = {
            ...
            match postgresql_crud::PostgresqlTypeWhereFilter::query_bind(parameters.payload.primary_key_column, query) {
                ...
                Err(error_0) => {
                    let error = ExampleDeleteOneErrorNamed::TryBind {
                        try_bind: error_0,
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                            file!().to_owned(),
                            line!(),
        ...
        let mut pool_connection = match app_state.get_postgres_pool().acquire().await {
            Ok(value) => value,
            Err(error_0) => {
                let error = ExampleDeleteOneErrorNamed::Postgresql {
                    postgresql: error_0,
                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                        file!().to_owned(),
                        line!(),
                ...
                match binded_query.fetch_one(executor.as_mut()).await {
                    Ok(value) => match sqlx::Row::try_get::<<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::PrimaryKey, &std::primitive::str>(&value, &Example::primary_key()) {
                        ...
                        Err(error_0) => match executor.rollback().await {
                            ...
                            Err(error_1) => {
                                let error = ExampleDeleteOneErrorNamed::RowAndRollback {
                                    row: error_0,
                                    rollback: error_1,
                                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                        file!().to_owned(),
...
impl Example {
    pub async fn try_delete_one(endpoint_location: &std::primitive::str, parameters: ExampleDeleteOneParameters) -> Result<<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::PrimaryKey, ExampleTryDeleteOneErrorNamed> {
        ...
        Err(ExampleTryDeleteOneErrorNamed::ExampleDeleteOneErrorNamedWithSerializeDeserialize {
...
impl Example {
    pub fn routes(app_state: std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>) -> axum::Router {
        axum::Router::new().nest(
            ...
            axum::Router::new()
                .route("/create_many", axum::routing::post(Example::create_many))
                .route("/create_many_payload_example", axum::routing::get(Example::create_many_payload_example))
                .route("/create_one", axum::routing::post(Example::create_one))
                .route("/create_one_payload_example", axum::routing::get(Example::create_one_payload_example))
                .route("/read_many", axum::routing::post(Example::read_many))
                .route("/read_many_payload_example", axum::routing::get(Example::read_many_payload_example))
                .route("/read_one", axum::routing::post(Example::read_one))
                .route("/read_one_payload_example", axum::routing::get(Example::read_one_payload_example))
                .route("/update_many", axum::routing::patch(Example::update_many))
                .route("/update_many_payload_example", axum::routing::get(Example::update_many_payload_example))
                .route("/update_one", axum::routing::patch(Example::update_one))
                .route("/update_one_payload_example", axum::routing::get(Example::update_one_payload_example))
                .route("/delete_many", axum::routing::delete(Example::delete_many))
                .route("/delete_many_payload_example", axum::routing::get(Example::delete_many_payload_example))
                .route("/delete_one", axum::routing::delete(Example::delete_one))
                .route("/delete_one_payload_example", axum::routing::get(Example::delete_one_payload_example))
                        ...
                        for element0 in <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlTypeTestCases>::test_cases(&value) {
                            for element1 in element0 {
                                ...
                                acc.push(futures::FutureExt::boxed(async move {
                                    ...
                                    let read_only_ids_returned_from_create_one = super::Example::try_create_one(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create_default_cloned }).await.expect("error 870927ab-3ba2-445f-96b5-0f7b8618fc63 column_156");
