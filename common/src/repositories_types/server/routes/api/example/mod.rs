...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn read_new_or_try_new_unwraped_for_test(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Read {
        <Self::Element as postgresql_crud::PostgresqlType>::Read::try_new(match value.field_0 {
            Some(value) => Some(postgresql_crud::Value {
                value: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value),
            }),
            None => None,
        })
        .unwrap()
            ...
            postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                ...
                if let Some(value) = value.field_0 {
                    acc.push(AnimalAsNotNullJsonbObjectUpdateElement::Field0(postgresql_crud::Value {
                        value: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(value.value),
                    }));
                }
                acc
            })
    ...
    fn read_from_previous_read_unwraped_merged_with_update(read: <Self::Element as postgresql_crud::PostgresqlJsonType>::Read, option_update: std::option::Option<<Self::Element as postgresql_crud::PostgresqlJsonType>::Update>) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Read {
        match option_update {
            Some(value) => {
                ...
                AnimalAsNotNullJsonbObjectRead {
                    field_0: Some(postgresql_crud::Value {
                        value: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(read.field_0.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").value, field_0),
                    }),
                }
            }
            None => read,
    ...
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::Element as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::Element as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectRead::try_new(<postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.0.value.field_0, create.field_0)).expect("error 52ad3994-8392-4fc5-8427-4ca42d87d726"),
        })
    }
}
#[cfg(feature = "test-utils")]
...
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate {
    pub fn try_new(create: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>, update: postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>, delete: std::vec::Vec<<postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Update>) -> Result<Self, VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed> {
        ...
        {
            let mut acc: std::vec::Vec<&<postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Update> = vec![];
                ...
                for element in &delete {
                    if delete_acc.contains(&element) {
                        return Err(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonDeleteArray {
                            error: format!("custom serde error deserializing VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json delete array: {}", <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeElementId>::get_inner(&element.clone().into())),
            ...
            for element in update_acc {
                if delete_acc.contains(&&element) {
                    return Err(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonUpdateAndDeleteArrays {
                        error: format!("custom serde error deserializing VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json update and delete arrays: {}", <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeElementId>::get_inner(&element.clone().into())),
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
                }
            }
...
impl postgresql_crud::PostgresqlJsonType for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn update_query_bind(value: Self::UpdateForQuery, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        for element in value.update.into_vec() {
            //here1
            println!("1111");
            match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeElementId>::query_bind_string_as_postgresql_text_update_for_query(element.id, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
        ...
        for element in value.delete {
            //here2
            println!("2222");
            match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeElementId>::query_bind_string_as_postgresql_text_update_for_query(element, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        ...
        for element in value.update.to_vec() {
            //here3
            println!("3333");
            match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeElementId>::query_bind_string_as_postgresql_text_update_for_query(element.id.clone(), query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
        ...
        for element in &value.create {
            match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeElementId>::query_bind_string_as_postgresql_text_create_for_query(element.id.clone(), query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
        ...
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead::new({
            ...
            for element in value {
                acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                    id: match element.id {
                        Some(value) => Some(postgresql_crud::Value {
                            value: <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value),
                        }),
                        None => None,
                    },
                    field_0: match element.field_0 {
            ...
            postgresql_crud::UniqueVec::<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>::try_new(
                value
                    ...
                    .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                        ...
                        fields: <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(AnimalAsNotNullJsonbObjectReadInner { field_0: element.field_0 }),
                    })
                    .collect(),
            )
            ...
            Some(value) => VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead({
                ...
                for update_element in value.update.into_vec() {
                    ...
                    acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                        ...
                        field_0: Some(postgresql_crud::Value {
                            value: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(found_read_element.field_0.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").value, field_0),
                        }),
                    });
                }
                acc
    ...
    fn create_vec() -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::Create> {
        let mut acc = vec![];
        {
            ...
            let create_vec = <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::create_vec();
            let option_additional = {
                let mut option_additional = None;
                for element in &create_vec {
        ...
        std::thread::Builder::new()
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    //                                         acc.push(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                    //                                             logical_operator: postgresql_crud::LogicalOperator::Or,
                    //                                             value: element.primary_key_column.clone().into_read().into(),
                    //                                         }));
                    //                                     }
                    //                                     acc
                    //                                 })
                    ...
                    //                         .iter()
                    //                         .map(|element| <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&element.primary_key_column).unwrap().value)
