            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    // let create_one_elapsed = start.elapsed();
                    {
                                            ...
                                            Some(
                                                postgresql_crud::PostgresqlTypeWhere::try_new(
                                                    postgresql_crud::LogicalOperator::Or,
                                                    {
                                                        ...
                                                        for _ in 1..=length {
                                                            acc.push(
                                                                <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement::Equal(
                        ...
                        //here start new
                        let read_only_ids_from_try_create_one = super::Example::try_create_one(
                            &url,
                        ...
                        // let f = super::Example::try_read_many(
                        //     &url,
                        //     super::ExampleReadManyParameters {
                        //         payload: super::ExampleReadManyPayload {
                        //             where_many: super::StdOptionOptionExampleWhereMany(Some(
                        ...
                        //                                             )
                        //                                         //
                        //                                         // postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead::new(
                        //                                         //     // uuid::Uuid::new_v4()
                        //                                         //     // read_only_ids_from_try_create_one.into_inner()
                        //                                         //     <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::into_inner(
                        //                                         //         read_only_ids_from_try_create_one.primary_key_column.clone().0
                        //                                         //     )
                        //                                         // )
                        //                                     }
                        //                                 )
                        ...
                        //                 column: super::ExampleSelect::PrimaryKeyColumn(
                        //                     <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Select::default()
                        //                 ),
                        ...
                        //     },
                        // )
                        // .await.expect("error 42cd9ad7-d80e-49ce-bb07-b8215f932198");
                        // println!("{f:#?}");
                        assert_eq!(
                            vec![
                                super::ExampleRead {
                                    primary_key_column: Some(postgresql_crud::Value {
                                        value: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(
                                            read_only_ids_from_try_create_one.primary_key_column.clone()
                                        )
                                    }),
                                    column_0: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(
                                        read_only_ids_from_try_create_one.column_0.expect("error 23a79f15-caae-4673-844c-fa4366adf267"),
                                        ident_create_default.column_0
                                    )
                                }
                            ],
                            ...
                            //             primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(
                            //                 read_only_ids_from_try_create_one.primary_key_column.clone()
                            //             ),
                            //             select: select_default_all_with_max_page_size_cloned.clone()
                            //         }
