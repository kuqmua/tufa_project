                    ...
                    for index in 0..column_155_test_cases.len() {
                        ...
                        let column_155_some_value_update = match column_155_test_cases.get(index) {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::tests::PostgresqlTypeTestCases>::update_new_or_try_new_unwraped_for_test(value.clone()),
                            }),
                            None => None,
                        };
                        println!("column_155_test_cases {:#?}", column_155_test_cases.get(index));
                        assert_eq!(
                            {
                                let f = super::ExampleReadOnlyIds {
                                    primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone(),
                                    column_155: if column_155_test_cases.get(index).is_some() { read_only_ids_returned_from_create_one.column_155.clone() } else { None }
                                };
                                println!("LEFT {f:#?}");
                                f
                            },
                            {
                                ...
                                println!("RIGHT {f:#?}");
                                let end = super::Example::try_read_one(
                                    &url,
                                    super::ExampleReadOneParameters {
                                        payload: super::ExampleReadOnePayload {
                                            primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone(),
...
impl postgresql_crud::PostgresqlJsonType for DoggieAsNotNullJsonbObject {
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!("jsonb_build_object('field_0',{})", <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_0'")))
    }
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for DoggieAsNotNullJsonbObject {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        ...
        for field_0 in <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::test_cases(&read_only_ids.field_0) {
            acc.push(DoggieAsNotNullJsonbObjectReadInner { field_0: Some(postgresql_crud::Value { value: field_0 }) });
        }
        acc
    }
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for OptionDoggieAsNullableJsonbObject {
    ...
    fn read_only_ids_to_option_value_read_inner(value: <Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner>> {
        todo!()
        // OptionDoggieAsNullableJsonbObjectReadOnlyIds(match )
    }
}
#[cfg(test)]
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        ...
        //     .iter()
        //     .map(|element| {
        //         vec![DoggieWithIdAsNotNullJsonbObjectWithIdReadInner {
        //             id: Some(postgresql_crud::Value { value: element.id.clone() }),
        //             field_0: Some(postgresql_crud::Value { value: {  } }),
        //         }]
        //     })
        //     .collect()
        ...
        VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::try_new(
            ...
            value
                ...
                .map(|element| DoggieWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                    ...
                    fields: DoggieAsNotNullJsonbObjectUpdate::new(
                        postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                            let mut acc = vec![];
