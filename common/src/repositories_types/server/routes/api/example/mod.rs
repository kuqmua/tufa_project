            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    let ident_create_default = super::ExampleCreate {
                        column_1: <<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
                    };
                    ...
                    //                             acc.push(super::ExampleCreate { column_1: element });
                    //                         }
                    //                         acc
                    //                     };
                    ...
                    //                                     column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_1.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), create.column_1),
                    //                                 });
                    //                             }
                    //                             acc.sort_by(|a, b| {
                    ...
                    //                                                             value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead::new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::into_inner(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(element.primary_key_column.clone()))),
                    //                                                         }));
                    //                                                     }
                    //                                                     acc
                    //                                                 })
                    ...
                    //                 let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                    //                 acc.push(futures::FutureExt::boxed(async move {
                    //                     let ident_create = super::ExampleCreate { column_1: element };
                    ...
                    //                             }),
                    //                             column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_1.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_1)
                    //                         },
                    //                         super::Example::try_read_one(
                    //                             &url_cloned,
                    //                             super::ExampleReadOneParameters {
                                    ...
                                    acc.push(futures::FutureExt::boxed(async move {
                                        ...
                                        assert_eq!(
                                            vec![super::ExampleRead {
                                                ...
                                                column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_1.clone().expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_1.clone())
                                            }],
                                            super::Example::try_read_many(
                                                &url_cloned,
                                                super::ExampleReadManyParameters {
                                                    payload: super::ExampleReadManyPayload {
                                                        where_many: super::StdOptionOptionExampleWhereMany(Some(
                                                            super::ExampleWhereMany::try_new(
                                                                ...
                                                                Some(
                                                                    postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                                        vec![<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                            logical_operator: postgresql_crud::LogicalOperator::Or,
                                                                            value: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_1.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_1.clone())
                                                                                .unwrap()
                                                                                .value,
                                                                        })]
                                                                    })
                                        ...
                                        //     acc
                                        // };
                                        // assert_eq!(read_only_ids_from_try_delete_many, vec![<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_returned_from_create_one.primary_key_column.clone())], "error 9fc29fa5-caba-403d-99da-ca9107d0c2e9");
                                        // match super::Example::try_read_many(
                                        //     &url_cloned,
                                        //     super::ExampleReadManyParameters {
                                        //         payload: super::ExampleReadManyPayload {
                    ...
                    //                                         column_1: Some(<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)),
                    //                                     });
                    //                                     acc
                    //                                 },
                    ...
                    //                                                 <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_1.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129"))
                    ...
                    //             }),
                    //             column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_1.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create_default.column_1)
                    //         },
                    //         super::Example::try_read_one(
                    //             &url,
                    //             super::ExampleReadOneParameters {
