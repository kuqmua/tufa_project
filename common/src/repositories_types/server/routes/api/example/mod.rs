...
// impl AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds {
//     // fn test_cases(&self) -> std::vec::Vec<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdReadInner>> {
//     //     vec![vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
//     //         id: Some(postgresql_crud::Value { value: self.0.value.id.0.value.clone() }),
//     //         field_0: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(self.0.value.field_0.clone()),
//     //         field_1: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(self.0.value.field_1.clone()),
//     //     }]]
//     // }
//     // fn read_only_ids_to_option_value_read_inner(self) -> std::option::Option<postgresql_crud::Value<AnimalWithIdAsNotNullJsonbObjectWithIdReadInner>> {
//     //     Some(postgresql_crud::Value {
//     //         value: AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
//     //             id: match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(self.0.value.id) {
...
//     //                 }),
//     //             },
//     //             field_0: match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(self.0.value.field_0) {
//     //                 Some(value) => Some(value),
//     //                 None => Some(postgresql_crud::Value {
...
//     //                 }),
//     //             },
//     //             field_1: match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(self.0.value.field_1) {
//     //                 Some(value) => Some(value),
//     //                 None => Some(postgresql_crud::Value {
...
// }
// #[cfg(feature = "test-utils")]
// impl AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
//     fn read_new_or_try_new_unwraped_for_test(self) -> AnimalWithIdAsNotNullJsonbObjectWithIdRead {
//         AnimalWithIdAsNotNullJsonbObjectWithIdRead {
//             id: match self.id {
//                 Some(value) => Some(postgresql_crud::Value {
...
//         self.0.into_iter().map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdRead::into_inner(element)).collect()
//     }
// }
// impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead {
...
//         let animal_with_id_as_not_null_jsonb_object_with_id_select = {
//             let mut acc = std::string::String::default();
//             let column_name_and_maybe_field_getter_field_ident = format!("value->'{field_ident}'");
//             let column_name_and_maybe_field_getter_for_error_message_field_ident = format!("value.{field_ident}");
...
//                 acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdReadInner::read_new_or_try_new_unwraped_for_test(element));
//             }
//             acc
//         })
//     }
...
//                 });
//                 //
//                 // if let Some(value) = AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds::read_only_ids_to_option_value_read_inner(element) {
...
//         match self.0 {
//             Some(value) => Some(value.0.into_iter().map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdRead::into_inner(element)).collect()),
//             None => None,
//         }
//     }
// }
