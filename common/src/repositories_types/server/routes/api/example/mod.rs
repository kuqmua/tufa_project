...
pub struct Example {
    ...
    //todo what if there are only autogenerated in insert types ? how insert would look like?
    ...
    #[generate_postgresql_crud_primary_key]
    pub std_primitive_i16_as_small_serial_not_null_prime: postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI16AsPostgresqlSmallSerialNotNull,
