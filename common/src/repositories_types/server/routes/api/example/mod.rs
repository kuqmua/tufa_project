            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                fn expecting(
                    ...
                    _serde::__private::Formatter::write_str(
                        __formatter,
                        "tuple struct ExampleUpdateManyPayload",
                    )
                }
                #[inline]
                ...
                {
                    let __field0: std::vec::Vec<ExampleUpdate> = <std::vec::Vec<
                        ExampleUpdate,
                        ...
                        _serde::__private::None => {
                            return _serde::__private::Err(
                                _serde::de::Error::invalid_length(
                                    0usize,
                                    &"tuple struct ExampleUpdateManyPayload with 1 element",
                                ),
                            );
                        }
                    };
                    // _serde::__private::Ok(ExampleUpdateManyPayload(__field0))
                    match ExampleUpdateManyPayload::try_new(__field0) {
                        Ok(value) => _serde::__private::Ok(value),
                        Err(error) => Err(_serde::de::Error::custom(format!("{error:?}"))),
                    }
