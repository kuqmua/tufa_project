                ...
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                                    ...
                                    assert_eq!(
                                        {
                                            ...
                                            for (read_only_ids, create) in read_only_ids_from_try_create_many.clone().into_iter().zip(ident_create_vec.into_iter()).collect::<std::vec::Vec<(super::ExampleReadOnlyIds, super::ExampleCreate)>>() {
                                                acc.push(super::ExampleRead { primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids.primary_key_column), column_0: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_0, create.column_0), column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_1, create.column_1) });
                                            }
                                            acc.sort_by(|a, b| {
                        ...
                        futures::stream::iter({
                            ...
                            for element in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                                ...
                                acc.push(futures::FutureExt::boxed(async move {
                                    ...
                                    assert_eq!(super::ExampleRead { primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_from_try_create_one.primary_key_column.clone().into_read() }), column_0: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_0, ident_create.column_0), column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_1, ident_create.column_1) }, super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_from_try_create_one.primary_key_column.clone().into_read(), select: select_default_all_cloned.clone() } }).await.expect("error 35141faa-387c-4302-aa7a-c529966f974b"), "try_read_one result different after try_create_one");
                    ...
                    futures::StreamExt::for_each_concurrent(
                        futures::stream::iter({
                            ...
                            //             let select_default_all_cloned = select_default_all.clone();
                            //             acc.push(futures::FutureExt::boxed(async move {
                            //                 let previous_read = super::Example::try_read_many(
                            //                     &url_cloned,
                            //                     super::ExampleReadManyParameters {
                            //                         payload: super::ExampleReadManyPayload {
                            //                             where_many: super::StdOptionOptionExampleWhereMany(Some(
                                ...
                                if read_inner_vec_vec_acc.is_empty() {
                                    ...
                                    for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(super::ExampleRead { primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_current_element.primary_key_column.clone().into_read() }), column_0: Some(postgresql_crud::Value { value: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_0.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129")).expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5").value, Some(update.clone())) }), column_1: previous_read.column_1 }, super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_current_element.primary_key_column.clone().into_read(), select: select_default_all_cloned } }).await.expect("error 35141faa-387c-4302-aa7a-c529966f974b"), "try_read_one result different after try_create_one");
                                        }));
                                    }
                                }
                            }
                                ...
                                if read_inner_vec_vec_acc.is_empty() {
                                    ...
                                    for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(super::ExampleRead { primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_current_element.primary_key_column.clone().into_read() }), column_0: previous_read.column_0, column_1: Some(postgresql_crud::Value { value: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_1.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129")).expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5").value, Some(update.clone())) }) }, super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_current_element.primary_key_column.clone().into_read(), select: select_default_all_cloned } }).await.expect("error 35141faa-387c-4302-aa7a-c529966f974b"), "try_read_one result different after try_create_one");
                                        }));
                                    }
                                }
                            }
