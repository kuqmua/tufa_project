...
//     // pub field_11: postgresql_crud::OptionVecOfVecOfOptionStdPrimitiveI8AsNullableArrayOfNotNullArrayOfNullableJsonbNumber,
//     // pub field_12: postgresql_crud::OptionVecOfOptionVecOfStdPrimitiveI8AsNullableArrayOfNullableArrayOfNotNullJsonbNumber,
//     // pub field_13: postgresql_crud::OptionVecOSfOptionVecOfOptionStdPrimitiveI8AsNullableArrayOfNullableArrayOfNullableJsonbNumber,
// }
        ...
        std::thread::Builder::new()
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    async fn drop_table_if_exists(postgres_pool: &sqlx::Pool<sqlx::Postgres>, table: &std::primitive::str) {
                    ...
                    let _unused = tokio::spawn(async move {
                        super::Example::prepare_extensions(&postgres_pool_for_tokio_spawn_sync_move).await.expect("error 0633ff48-ebc4-460f-a282-d750511f5d78");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table).await.expect("error 0c29cf7d-1af7-459c-b0c6-69855ca98bef");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_create_many_cloned).await.expect("error 141d990c-91e5-4518-8978-7660fcf88784");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_create_one_cloned).await.expect("error cdd3b111-5e8b-4201-896e-bd38dc8b4d7c");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_read_many_cloned).await.expect("error 878298c2-3320-4b54-ad8d-e67000cc4955");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_read_one_cloned).await.expect("error 425e8574-6cdd-43b5-9b7b-75efce9b750d");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_update_many_cloned).await.expect("error ab50eb74-29ab-49b3-bdd4-ff6c6c6b700a");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_update_one_cloned).await.expect("error de8885ae-34f5-430b-a3b4-bf91c999b2c8");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_delete_many_cloned).await.expect("error 2bb3d5ec-1069-470c-a758-60afe3bd5224");
                        super::Example::prepare_postgresql_table(&postgres_pool_for_tokio_spawn_sync_move, &table_delete_one_cloned).await.expect("error e5cc2f6f-65a2-472d-8a1e-56e23fbc165a");
                        ...
                        axum::serve(
                            ...
                            axum::Router::new()
                                ...
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_create_many_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_create_one_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_read_many_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_read_one_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_update_many_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_update_one_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_delete_many_cloned))
                                .merge(super::Example::routes_handle(std::sync::Arc::<crate::repositories_types::server::routes::app_state::AppState<'_>>::clone(&app_state), &table_delete_one_cloned))
                                .into_make_service(),
                        )
                        .await
                    ...
                    let select_default_all_with_max_page_size = postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec![
                        ...
                        super::ExampleSelect::Column0(<<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Select as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize>::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
                    ])
                    ...
                    let start = std::time::Instant::now();
                    {
                        futures::StreamExt::for_each_concurrent(
                            futures::stream::iter({
                                ...
                                for chunk in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create()
                                    .unwrap_or(vec![])
                                    .chunks(10)
                                    .map(|element| element.to_vec())
                                    .collect::<std::vec::Vec<std::vec::Vec<<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Create>>>()
                                {
                                    ...
                                    acc.push(futures::FutureExt::boxed(async move {
                                        ...
                                        let read_only_ids_from_try_create_many = super::Example::try_create_many_handle(&url_cloned, super::ExampleCreateManyParameters { payload: super::ExampleCreateManyPayload(ident_vec_create.clone()) }, &table_create_many_cloned2_cloned.clone())
                                            .await
                                            .expect("error 5eecedc4-bb02-454a-acd9-0af758f30b2e");
                                        assert_eq!(
                                            {
                                                let mut acc = vec![];
                                            ...
                                            super::Example::try_read_many_handle(
                                                &url_cloned,
                                        ...
                                        let read_only_ids_from_try_delete_many = {
                                            let mut acc = super::Example::try_delete_many_handle(
                                                &url_cloned,
                                        ...
                                        match super::Example::try_read_many_handle(
                                            &url_cloned,
                                            super::ExampleReadManyParameters {
                                                payload: super::ExampleReadManyPayload {
                                                    where_many: super::StdOptionOptionExampleWhereMany(Some(
                            ...
                            futures::stream::iter({
                                ...
                                for element in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create().unwrap_or(vec![]) {
                                    ...
                                    acc.push(futures::FutureExt::boxed(async move {
                                        ...
                                        let read_only_ids_from_try_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_create_one_cloned2_cloned).await.expect("error 32e30b87-b46a-4f39-aeb0-39694fc52d30");
                                        assert_eq!(
                                            super::ExampleRead {
                                            ...
                                            super::Example::try_read_one_handle(
                                                &url_cloned,
                                                super::ExampleReadOneParameters {
                                                    payload: super::ExampleReadOnePayload {
                                        ...
                                        let read_only_ids_from_try_delete_one = super::Example::try_delete_one_handle(
                                            &url_cloned,
                                            super::ExampleDeleteOneParameters {
                                                payload: super::ExampleDeleteOnePayload {
                                                    primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::read_only_ids_into_read(read_only_ids_from_try_create_one.primary_key_column.clone()),
                                        ...
                                        if let Err(error) = super::Example::try_read_one_handle(
                                            &url_cloned,
                                            super::ExampleReadOneParameters {
                                                payload: super::ExampleReadOnePayload {
                                                    primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::read_only_ids_into_read(read_only_ids_from_try_create_one.primary_key_column.clone()),
                    ...
                    // {
                    //     let generate_test_read_many_by_non_existent_primary_keys = async |length: std::primitive::usize| match super::Example::try_read_many_handle(
                    //         &url,
                    //         super::ExampleReadManyParameters {
                    //             payload: super::ExampleReadManyPayload {
                    //                 where_many: super::StdOptionOptionExampleWhereMany(Some(
                    ...
                    //             acc
                    //         };
                    //         let read_only_ids_from_try_create_many = super::Example::try_create_many_handle(&url, super::ExampleCreateManyParameters { payload: super::ExampleCreateManyPayload(ident_vec_create.clone()) }, &table_read_many_cloned2_cloned)
                    //             .await
                    //             .expect("error d775179f-f7b1-41d3-9c83-4ca8bd1abeec");
                    //         assert_eq!(
                    //             {
                    //                 let mut acc = vec![];
                    ...
                    //                 acc.push(futures::FutureExt::boxed(async move {
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     assert_eq!(
                    ...
                    //                                                     vec![<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(
                    ...
                    //                                                 postgresql_crud::PostgresqlTypeWhere::try_new(
                    //                                                     postgresql_crud::LogicalOperator::Or,
                    //                                                     <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_0.clone())
                    //                                                 )
                    //                                                 .expect("error c10cf3d9-f531-442a-99f0-f36c80fee4b1"),
                    //                                             )
                    //                                         )
                    ...
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) = <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_vec_where_element_equal_to_json_field(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_0.clone()) {
                    ...
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) = <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_into_postgresql_type_option_vec_where_element_dimension_one_equal(ident_create.column_0.clone()) {
                    //                         for element in value {
                    //                             assert_eq!(
                    //                                 vec![super::ExampleRead {
                    //                                     primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    ...
                    //         futures::stream::iter({
                    //             let mut acc: std::vec::Vec<futures::future::BoxFuture<'static, ()>> = vec![];
                    //             for element in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::vec_greater_than_test() {
                    //                 let url_cloned = url.clone();
                    //                 let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                    //                 acc.push(futures::FutureExt::boxed(async move {
                    //                     let ident_create = super::ExampleCreate { column_0: element.create };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) =
                    //                         <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_element_greater_than(element.variant, read_only_ids_returned_from_create_one.column_0.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), element.greater_than)
                    //                     {
                    //                         assert_eq!(
                    //                             vec![super::ExampleRead {
                    //                                 primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    ...
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) = <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_0.clone()) {
                    //                         for element in value {
                    //                             assert_eq!(
                    //                                 vec![super::ExampleRead {
                    //                                     primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    ...
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) = <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_0.clone()) {
                    //                         for element in value {
                    //                             assert_eq!(
                    //                                 vec![super::ExampleRead {
                    //                                     primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    ...
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) = <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_0.clone())
                    //                     {
                    //                         for element in value {
                    //                             assert_eq!(
                    //                                 vec![super::ExampleRead {
                    ...
                    //                     let ident_create = super::ExampleCreate { column_0: element };
                    //                     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }, &table_read_many_cloned2_cloned).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                    //                     if let Some(value) = <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_0.clone())
                    //                     {
                    //                         for element in value {
                    //                             assert_eq!(
                    //                                 vec![super::ExampleRead {
                    ...
                    //                                 .map(|element| {
                    //                                     let url_cloned = url.clone();
                    //                                     futures::FutureExt::boxed(async move { super::Example::try_create_many_handle(&url_cloned, super::ExampleCreateManyParameters { payload: super::ExampleCreateManyPayload(element) }, &table_update_many_cloned2_cloned).await.expect("error 0aedfa07-149b-4028-a131-a64ccdda6b98") })
                    //                                 })
                    ...
                    //                         },
                    //                         {
                    //                             let mut acc = super::Example::try_read_many_handle(
                    //                                 &url,
                    //                                 super::ExampleReadManyParameters {
                    //                                     payload: super::ExampleReadManyPayload {
                    //                                         where_many: super::StdOptionOptionExampleWhereMany(Some(
                    ...
                    //                                     acc
                    //                                 },
                    //                                 super::Example::try_update_many_handle(
                    //                                     &url_cloned,
                    ...
                    //                                 .map(|element| {
                    //                                     let url_cloned = url.clone();
                    //                                     futures::FutureExt::boxed(async move { super::Example::try_create_many_handle(&url_cloned, super::ExampleCreateManyParameters { payload: super::ExampleCreateManyPayload(element) }, &table_update_one_cloned2_cloned).await.expect("error 0aedfa07-149b-4028-a131-a64ccdda6b98") })
                    //                                 })
                    //                                 .collect::<std::vec::Vec<futures::future::BoxFuture<'static, std::vec::Vec<super::ExampleReadOnlyIds>>>>(),
                    //                         )
                    //                         .buffer_unordered(5)
                    ...
                    //                                     column_0: Some(<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update))
                    //                                 },
                    //                                 super::Example::try_update_one_handle(
                    //                                     &url_cloned,
                    ...
                    // {
                    //     {
                    //         let generate_test_delete_many_by_non_existent_primary_keys = async |length: std::primitive::usize| match super::Example::try_delete_many_handle(
                    //             &url,
                    //             super::ExampleDeleteManyParameters {
                    //                 payload: super::ExampleDeleteManyPayload {
                    //                     where_many: super::StdOptionOptionExampleWhereMany(Some(super::ExampleWhereMany {
                    ...
                    //                 },
                    //             },
                    //             &table_delete_many_cloned2_cloned,
                    //         )
                    //         .await
                    //         {
                    //             Ok(value) => {
                    ...
                    //             let read_only_ids_from_try_create_many = super::Example::try_create_many_handle(
                    //                 &url,
                    ...
                    //             let read_only_ids_from_try_delete_many = super::Example::try_delete_many_handle(
                    //                 &url,
                    //                 super::ExampleDeleteManyParameters {
                    //                     payload: super::ExampleDeleteManyPayload {
                    //                         where_many: super::StdOptionOptionExampleWhereMany(Some(super::ExampleWhereMany {
                    ...
                    // {
                    //     if let Err(error) = super::Example::try_delete_one_handle(
                    //         &url,
                    //         super::ExampleDeleteOneParameters {
                    //             payload: super::ExampleDeleteOnePayload {
                    //                 primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Read::new(uuid::Uuid::new_v4()),
                    ...
                    //     }
                    //     let read_only_ids_returned_from_create_one = super::Example::try_create_one_handle(&url, super::ExampleCreateOneParameters { payload: ident_create_default.clone() }, &table_delete_one_cloned2_cloned).await.expect("error 8be80909-0e8d-42f9-a5c8-fa08244cb592");
                    //     assert_eq!(
                    //         super::ExampleRead {
                    //             primary_key_column: Some(postgresql_crud::Value {
