...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ReadManyPayload {
    pub std_primitive_i32_as_postgresql_int4: std::option::Option<
    // std::vec::Vec<
    postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI32AsPostgresqlInt4Where
    // >
    >,
    pub std_primitive_i32_as_postgresql_int4_not_null: std::option::Option<
    // std::vec::Vec<
    postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI32AsPostgresqlInt4NotNullWhere
    // >
    >,
    pub std_primitive_i64_as_postgresql_big_serial_not_null: std::option::Option<
    // std::vec::Vec<
    postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI64AsPostgresqlBigSerialNotNullWhere
    // >
    >,
    pub select: std::vec::Vec<PostgresqlTypeExampleColumn>,
    pub order_by: postgresql_crud::OrderBy<PostgresqlTypeExampleColumn>,
...
pub enum TryReadManyRouteLogicResponseVariants {
    ...
    NotUniqueStdPrimitiveI32AsPostgresqlInt4 {
        std_primitive_i32_as_postgresql_int4: std::string::String,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
    NotUniqueStdPrimitiveI32AsPostgresqlInt4NotNull {
        std_primitive_i32_as_postgresql_int4_not_null: std::string::String,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
impl std::convert::From<TryReadManyRouteLogicErrorNamed> for TryReadManyRouteLogicResponseVariants {
    fn from(value: TryReadManyRouteLogicErrorNamed) -> Self {
        match value.into_serialize_deserialize_version() {
            ...
            TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniquePrimaryKey { not_unique_primary_key, code_occurence } => Self::NotUniquePrimaryKey { not_unique_primary_key, code_occurence },
            TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniqueColumn { not_unique_column, code_occurence } => Self::NotUniqueColumn { not_unique_column, code_occurence },
            TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniqueStdPrimitiveI32AsPostgresqlInt4 { std_primitive_i32_as_postgresql_int4, code_occurence } => Self::NotUniqueStdPrimitiveI32AsPostgresqlInt4 { std_primitive_i32_as_postgresql_int4, code_occurence },
            TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniqueStdPrimitiveI32AsPostgresqlInt4NotNull {
                std_primitive_i32_as_postgresql_int4_not_null,
                code_occurence,
            } => Self::NotUniqueStdPrimitiveI32AsPostgresqlInt4NotNull {
                std_primitive_i32_as_postgresql_int4_not_null,
                code_occurence,
            },
        }
...
pub enum TryReadManyRouteLogicErrorNamed {
    ...
    NotUniqueStdPrimitiveI32AsPostgresqlInt4 {
        #[eo_to_std_string_string]
        std_primitive_i32_as_postgresql_int4: postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
    NotUniqueStdPrimitiveI32AsPostgresqlInt4NotNull {
        #[eo_to_std_string_string]
        std_primitive_i32_as_postgresql_int4_not_null: postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4NotNull,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
pub async fn try_read_many_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
    ...
    let query_string = {
        format!(
            "select {} from example {}",
            {
                ...
                for element in &parameters.payload.select {
                    value.push_str(&match element {
                        PostgresqlTypeExampleColumn::StdPrimitiveI32AsPostgresqlInt4(value) => {
                            <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4 as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_column_query_part(value, "std_primitive_i32_as_postgresql_int4")
                        }
                        PostgresqlTypeExampleColumn::StdPrimitiveI32AsPostgresqlInt4NotNull(value) => {
                            <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4NotNull as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_column_query_part(value, "std_primitive_i32_as_postgresql_int4_not_null")
                        }
                        PostgresqlTypeExampleColumn::StdPrimitiveI64AsPostgresqlBigSerialNotNull(value) => {
                            <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI64AsPostgresqlBigSerialNotNull as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_column_query_part(
                                value,
            ...
            },
            {
                ...
                if let Some(value) = &parameters.payload.std_primitive_i32_as_postgresql_int4 {
                    // additional_parameters.push_str(&format!(
                    //     "{} {}",
                    //     match additional_parameters.is_empty() {
                    //         true => "where",
                    ...
                    //             match postgresql_crud::BindQuerySecond::try_generate_bind_increments(element, &mut increment) {
                    //                 Ok(value) => {
                    //                     let handle = format!("std_primitive_i32_as_postgresql_int4 {value} ");
                    //                     match index == 0 {
                    //                         true => {
                    //                             acc.push_str(&handle);
                    //                         }
                    ...
                    //     }
                    // ));
                    match <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4 as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_where_try_generate_bind_increments(
                        value,
                        &mut increment,
                        &"std_primitive_i32_as_postgresql_int4",
                ...
                if let Some(value) = &parameters.payload.std_primitive_i32_as_postgresql_int4_not_null {
                    // additional_parameters.push_str(&format!(
                    //     "{} {}",
                    //     match additional_parameters.is_empty() {
                    //         true => "where",
                    ...
                    //             match postgresql_crud::BindQuerySecond::try_generate_bind_increments(element, &mut increment) {
                    //                 Ok(value) => {
                    //                     let handle = format!("std_primitive_i32_as_postgresql_int4_not_null {value} ");
                    //                     match index == 0 {
                    //                         true => {
                    //                             acc.push_str(&handle);
                    //                         }
                    ...
                    //     }
                    // ));
                    match <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4NotNull as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_where_try_generate_bind_increments(
                        value,
                        &mut increment,
                        &"std_primitive_i32_as_postgresql_int4_not_null",
                        is_first_push_to_additional_parameters_already_happend,//todo generate is in proc macro (first element ignore)
                ...
                println!("why rust lint here forses me to read the value? {is_first_push_to_additional_parameters_already_happend}");
                {
                    let prefix = match additional_parameters.is_empty() {
                        true => "",
                        false => " ",
    ...
    let binded_query = {
        ...
        if let Some(value) = parameters.payload.std_primitive_i32_as_postgresql_int4 {
            ...
            //     query = postgresql_crud::BindQuerySecond::bind_value_to_query(value, query);
            // }
            query = <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4 as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_where_bind_value_to_query(
                value,
                query
            );
        }
        if let Some(value) = parameters.payload.std_primitive_i32_as_postgresql_int4_not_null {
            ...
            //     query = postgresql_crud::BindQuerySecond::bind_value_to_query(value, query);
            // }
            query = <postgresql_crud::postgresql_type::postgresql_type::StdPrimitiveI32AsPostgresqlInt4NotNull as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::postgresql_type_self_where_bind_value_to_query(
                value,
                query
            );
        }
        ...
        let value = {
            ...
            .await
            {
                Ok(value) => match value {
                    Some(value) => Some({
                        let mut std_primitive_i64_as_postgresql_big_serial_not_null: std::option::Option<postgresql_crud::Value<postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI64AsPostgresqlBigSerialNotNullToRead>> = None;
                        let mut std_primitive_i32_as_postgresql_int4: std::option::Option<postgresql_crud::Value<postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI32AsPostgresqlInt4ToRead>> = None;
                        let mut std_primitive_i32_as_postgresql_int4_not_null: std::option::Option<postgresql_crud::Value<postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI32AsPostgresqlInt4NotNullToRead>> = None;
                        for element in &parameters.payload.select {
                            match element {
                                PostgresqlTypeExampleColumn::StdPrimitiveI64AsPostgresqlBigSerialNotNull(_) => {
                                    match sqlx::Row::try_get::<postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI64AsPostgresqlBigSerialNotNullToRead, &std::primitive::str>(&value, "std_primitive_i64_as_postgresql_big_serial_not_null") {
                                ...
                                PostgresqlTypeExampleColumn::StdPrimitiveI32AsPostgresqlInt4(_) => match sqlx::Row::try_get::<postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI32AsPostgresqlInt4ToRead, &std::primitive::str>(&value, "std_primitive_i32_as_postgresql_int4")
                                {
                                    Ok(value) => {
                                        std_primitive_i32_as_postgresql_int4 = Some(postgresql_crud::Value { value: value });
                                    }
                                    Err(error_0) => {
                                        let error = TryReadManyRouteLogicErrorNamed::Postgresql {
                                            postgresql: error_0,
                                ...
                                PostgresqlTypeExampleColumn::StdPrimitiveI32AsPostgresqlInt4NotNull(_) => {
                                    match sqlx::Row::try_get::<postgresql_crud::postgresql_type::postgresql_type::PostgresqlTypeStdPrimitiveI32AsPostgresqlInt4NotNullToRead, &std::primitive::str>(&value, "std_primitive_i32_as_postgresql_int4_not_null") {
                                        Ok(value) => {
                                            std_primitive_i32_as_postgresql_int4_not_null = Some(postgresql_crud::Value { value: value });
                                        }
                                        Err(error_0) => {
                                            let error = TryReadManyRouteLogicErrorNamed::Postgresql {
                                                postgresql: error_0,
...
pub async fn try_read_many(server_location: &std::primitive::str, parameters: ReadManyParameters) -> Result<std::vec::Vec<ExampleOptions>, TryReadManyErrorNamed> {
    ...
    let try_read_many_route_logic_error_named_with_serialize_deserialize = match expected_response {
        ...
        TryReadManyRouteLogicResponseVariants::NotUniquePrimaryKey { not_unique_primary_key, code_occurence } => TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniquePrimaryKey { not_unique_primary_key, code_occurence },
        TryReadManyRouteLogicResponseVariants::NotUniqueColumn { not_unique_column, code_occurence } => TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniqueColumn { not_unique_column, code_occurence },
        TryReadManyRouteLogicResponseVariants::NotUniqueStdPrimitiveI32AsPostgresqlInt4 { std_primitive_i32_as_postgresql_int4, code_occurence } => {
            TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniqueStdPrimitiveI32AsPostgresqlInt4 { std_primitive_i32_as_postgresql_int4, code_occurence }
        }
        TryReadManyRouteLogicResponseVariants::NotUniqueStdPrimitiveI32AsPostgresqlInt4NotNull {
            std_primitive_i32_as_postgresql_int4_not_null,
            code_occurence,
        } => TryReadManyRouteLogicErrorNamedWithSerializeDeserialize::NotUniqueStdPrimitiveI32AsPostgresqlInt4NotNull {
            std_primitive_i32_as_postgresql_int4_not_null,
...
impl postgresql_crud::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement for ReadManyPayload {
    fn std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> Self {
        Self {
            std_primitive_i32_as_postgresql_int4: Some(
                // vec![
                postgresql_crud::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement::std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
                // ]
            ),
            std_primitive_i32_as_postgresql_int4_not_null: Some(
                // vec![
                postgresql_crud::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement::std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
                // ]
            ),
