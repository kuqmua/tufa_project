                ...
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    futures::StreamExt::for_each_concurrent(
                        futures::stream::iter({
                                ...
                                acc.push(futures::FutureExt::boxed(async move {
                                    let ident_create_vec = {
                                        ...
                                        for element in chunk {
                                            acc.push(super::ExampleCreate { column_0: element, column_1: <<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element() });
                                        }
                                        acc
                                    };
                                    ...
                                    assert_eq!(
                                        {
                                            ...
                                            for (read_only_ids, create) in read_only_ids_from_try_create_many.clone().into_iter().zip(ident_create_vec.into_iter()).collect::<std::vec::Vec<(super::ExampleReadOnlyIds, super::ExampleCreate)>>() {
                                                acc.push(super::ExampleRead {
                                                    ...
                                                    column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_1, create.column_1),
                                                });
                                            }
                                            acc.sort_by(|a, b| {
                            ...
                            for chunk in <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_vec().chunks(10).map(|element| element.to_vec()).collect::<std::vec::Vec<std::vec::Vec<<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlType>::Create>>>() {
                                let url_cloned = url.clone();
                                let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                                acc.push(futures::FutureExt::boxed(async move {
                                    let ident_create_vec = {
                                        let mut acc = vec![];
                                        for element in chunk {
                                            acc.push(super::ExampleCreate { column_0: <<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(), column_1: element });
                                        }
                                        acc
                                    };
                                    let read_only_ids_from_try_create_many = super::Example::try_create_many(&url_cloned, super::ExampleCreateManyParameters { payload: super::ExampleCreateManyPayload(ident_create_vec.clone()) }).await.expect("error 5eecedc4-bb02-454a-acd9-0af758f30b2e");
                    ...
                    futures::StreamExt::for_each_concurrent(
                        futures::stream::iter({
                            ...
                            for element in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                                ...
                                let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                                acc.push(futures::FutureExt::boxed(async move {
                                    let ident_create = super::ExampleCreate { column_0: element, column_1: <<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element() };
                                    ...
                                    assert_eq!(
                                        super::ExampleRead {
                                            ...
                                            column_0: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_0, ident_create.column_0),
                                            column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_1, ident_create.column_1)
                                        },
                                        super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_from_try_create_one.primary_key_column.clone().into_read(), select: select_default_all_with_max_page_size_cloned.clone() } }).await.expect("error 35141faa-387c-4302-aa7a-c529966f974b"),
                                    ...
                                    if let Err(error) = super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_from_try_create_one.primary_key_column.clone().into_read(), select: select_default_all_with_max_page_size_cloned } }).await {
                            ...
                            for element in <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                                let url_cloned = url.clone();
                                let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                                acc.push(futures::FutureExt::boxed(async move {
                                    let ident_create = super::ExampleCreate { column_0: <<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(), column_1: element };
                                    let read_only_ids_from_try_create_one = super::Example::try_create_one(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create.clone() }).await.expect("error 32e30b87-b46a-4f39-aeb0-39694fc52d30");
                                    assert_eq!(
                                        super::ExampleRead {
                                            primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_from_try_create_one.primary_key_column.clone().into_read() }),
                    ...
                    futures::StreamExt::for_each_concurrent(
                        futures::stream::iter({
                                    ...
                                    assert_eq!(
                                        {
                                            ...
                                            for element in &read_only_ids_current_elements {
                                                acc.push(super::ExampleRead {
                                                    ...
                                                    column_1: match &element.column_1 {
                                                        Some(value) => <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&value),
                                                        None => Some(postgresql_crud::Value { value: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element() }),
                                                    },
                                                });
                                            }
                                    ...
                                    for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(
                                                {
                                                    let mut acc = vec![];
                                                    acc.push(super::ExampleReadOnlyIds { primary_key_column: read_only_ids_current_element.primary_key_column.clone(), column_0: Some(<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)), column_1: None });
                                                    acc
                                                },
                            ...
                            }
                            {
                                let read_inner_vec_vec_acc = {
                                    let mut acc = vec![];
                                    if let Some(value) = &common_read_only_ids_returned_from_create_one.column_1 {
                                        for element in <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_inner_vec_vec(&value) {
                                            for _ in element {
                                                acc.push(ident_create_default.clone());
                                            }
                                        }
                                ...
                                println!("update_many len {}", read_inner_vec_vec_acc.len());
                                if read_inner_vec_vec_acc.is_empty() {
                                    println!("PostgresqlTypeTestCases read_inner_vec_vec is empty for column_1");
                                } else {
                                    let read_only_ids_current_elements = {
                                        use futures::StreamExt;
                                        futures::stream::iter(
                                    ...
                                    for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let update = <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::update_new_or_try_new_unwraped_for_test({
                                                let mut local_increment = 0;
                                                let mut option_test_case = None;
                                                for element_0 in <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_inner_vec_vec(&read_only_ids_current_element.column_1.clone().expect("error c4d98a71-f30f-410e-b410-a75f4672f2f7")) {
                                                    let mut should_break = false;
                                                    for element_1 in element_0 {
                                                        if local_increment == increment {
                                                            option_test_case = Some(element_1);
                                            ...
                                            assert_eq!(
                                                {
                                                    let mut acc = vec![];
                                                    acc.push(super::ExampleReadOnlyIds { primary_key_column: read_only_ids_current_element.primary_key_column.clone(), column_0: None, column_1: Some(<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)) });
                                                    acc
                                                },
                                                super::Example::try_update_many(
                                                    &url_cloned,
                                                    super::ExampleUpdateManyParameters {
                                                        payload: super::ExampleUpdateManyPayload::try_new({
                                                            let mut acc = vec![];
                                                            acc.push(super::ExampleUpdate::try_new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Update::from(read_only_ids_current_element.primary_key_column.clone().into_read()), None, Some(postgresql_crud::Value { value: update.clone() })).expect("error 0e5d65a5-12c8-4c48-a24c-0f1fe376ada2"));
                                                            acc
                                                        })
                                                        .expect("error 69e1bd8a-fe78-4301-85ca-f4f3958d7493")
                                                    }
                                            ...
                                            assert_eq!(
                                                {
                                                    ...
                                                    for element in previous_read {
                                                        acc.push(super::ExampleRead {
                                                            ...
                                                            column_1: Some(postgresql_crud::Value {
                                                                value: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(<postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_1.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129")).expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5").value, Some(update.clone())),
                                                            }),
                                                        });
                                                    }
                                                    acc
                                        ...
                                        super::ExampleWhereMany::try_new(
                                            Some(
                                                postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                    let mut acc = vec![];
                                                    for i in 1..=length {
                                                        acc.push(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual { logical_operator: postgresql_crud::LogicalOperator::Or, value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlOrigin::new(uuid::Uuid::new_v4()) }));
                                                    }
                                                    acc
                                                })
                                                .expect("error 6de1e731-a28a-4f74-8a73-0f8f8ec34a43"),
                                ...
                                if read_inner_vec_vec_acc.is_empty() {
                                    ...
                                    for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(super::ExampleReadOnlyIds { primary_key_column: read_only_ids_current_element.primary_key_column.clone(), column_0: Some(<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)), column_1: None }, super::Example::try_update_one(&url_cloned, super::ExampleUpdateOneParameters { payload: super::ExampleUpdate::try_new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Update::from(read_only_ids_current_element.primary_key_column.clone().into_read()), Some(postgresql_crud::Value { value: update.clone() }), None).expect("error 0e5d65a5-12c8-4c48-a24c-0f1fe376ada2") }).await.expect("error d2de0bd6-1b01-4ef2-b074-a60878241b52"), "error 564de31c-3664-4c62-85fc-e03793372f8f");
                                            assert_eq!(
                                                super::ExampleRead {
                                                    primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_current_element.primary_key_column.clone().into_read() }),
                                                    column_0: Some(postgresql_crud::Value { value: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(<postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_0.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129")).expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5").value, Some(update.clone())) }),
                                                    column_1: previous_read.column_1
                                                },
                                                super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_current_element.primary_key_column.clone().into_read(), select: select_default_all_with_max_page_size_cloned } }).await.expect("error 35141faa-387c-4302-aa7a-c529966f974b"),
                    ...
                    let update_one_elapsed = start.elapsed();
                    {
                                        ...
                                        where_many: super::StdOptionOptionExampleWhereMany(Some(super::ExampleWhereMany {
                                            primary_key_column: Some(
                                                postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                    ...
                                                    for _ in 1..=length {
                                                        acc.push(
                                                            postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlWhereElement::Equal(
                                                                postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                    logical_operator: postgresql_crud::LogicalOperator::Or,
                                                                    value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlOrigin::new(
                                                                        uuid::Uuid::new_v4()
                                                                    )
                                                                }
                                                            )
                        ...
                        }
                        {
                            let generate_test_delete_many_by_primary_keys = async |length: std::primitive::usize| {
                                ...
                                println!("read_only_ids_from_try_create_many {read_only_ids_from_try_create_many:#?}");
                                        ...
                                        payload: super::ExampleDeleteManyPayload {
                                            where_many: super::StdOptionOptionExampleWhereMany(Some(super::ExampleWhereMany {
                                                primary_key_column: Some(
                                                    ...
                                                    .expect("error a95650c5-fadc-4d6e-86e8-2ba95f615c2c"),
                                                ),
                                                column_0: None,
                                                column_1: None,
                                            })),
                                ...
                                ).await.expect("error 5267d0fa-92cd-4421-8d7e-04e6b4f06c1e");
                                assert_eq!(
                                    read_only_ids_from_try_delete_many,
                                    {
                                        read_only_ids_from_try_create_many.iter().map(|element|
                                        ...
                                        ).collect::<std::vec::Vec<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead>>()
                                    },
                                    "error db146190-0496-42a7-93d6-8405eb641954"
                                );
                                match super::Example::try_read_many(
                                ...
                                .await {
                                    Ok(value) => if value.len() != 0 {
                                        panic!("error b32b172c-563f-455c-94f4-81905627cc1e")
                                    },
                                    Err(error) => panic!("error cc7f193f-7ac2-4022-9bef-440e7c679185")
                                }
                                //
                            };
                    ...
                    let delete_many_elapsed = start.elapsed();
                    {
                        ...
                        assert_eq!(
                            super::ExampleRead {
                                ...
                                column_0: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_0, ident_create_default.column_0),
                                column_1: <postgresql_crud::OptionStdPrimitiveI16AsNullableInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_1, ident_create_default.column_1)
                            },
                            super::Example::try_read_one(&url, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone().into_read(), select: select_default_all_with_max_page_size.clone() } }).await.expect("error c8c44c89-aeb0-43d3-ae72-02b7a5979f5a"),
                            "error 86ef08ae-4356-4417-9490-1d13eb2af71f"
                        );
                        let read_only_ids_from_try_delete_one = super::Example::try_delete_one(&url, super::ExampleDeleteOneParameters { payload: super::ExampleDeleteOnePayload { primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone().into_read() } }).await.expect("error acab86b7-b199-4732-b8ea-76c00a12abb2");
                        ...
                        if let Err(error) = super::Example::try_read_one(&url, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone().into_read(), select: select_default_all_with_max_page_size.clone() } }).await {
                            if let super::ExampleTryReadOneErrorNamed::ExampleReadOneErrorNamedWithSerializeDeserialize { read_one_error_named_with_serialize_deserialize, code_occurence: _ } = error {
                                if let super::ExampleReadOneErrorNamedWithSerializeDeserialize::Postgresql { postgresql, code_occurence: _ } = read_one_error_named_with_serialize_deserialize {
                                    if postgresql != no_rows_returned_by_a_query_that_expected_to_return_at_least_one_row {
                    ...
                    println!("create_many {:?}\ncreate_one {:?}\nupdate_many {:?}\nupdate_one {:?}\ndelete_many {:?}\ndelete_one {:?}", create_many_elapsed, create_one_elapsed, update_many_elapsed, update_one_elapsed, delete_many_elapsed, delete_one_elapsed);
