...
impl postgresql_crud::PostgresqlJsonType for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!(
            "jsonb_build_object('value',jsonb_build_object('id',{},'field_0',{}))",
...
impl postgresql_crud::tests::PostgresqlJsonTypeTestCases for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        vec![vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
            ...
            field_0: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(read_only_ids.0.value.field_0.clone()),
        }]]
    }
...
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate {
    ...
    update: AnimalWithIdAsNotNullJsonbObjectWithIdUpdateHandle,
    #[serde(skip_serializing_if = "Vec::is_empty")]
...
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate {
    pub fn try_new(create: std::vec::Vec<<AnimalWithIdAsNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Create>, update: AnimalWithIdAsNotNullJsonbObjectWithIdUpdateHandle, delete: std::vec::Vec<<postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Update>) -> Result<Self, VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed> {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                let __field1 = match serde::de::SeqAccess::next_element::<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateHandle>(&mut __seq)? {
                    serde::__private::Some(__value) => __value,
                    serde::__private::None => AnimalWithIdAsNotNullJsonbObjectWithIdUpdateHandle::default(),
                };
                ...
                __A: serde::de::MapAccess<'de>,
            {
                ...
                let mut __field1: serde::__private::Option<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateHandle> = serde::__private::None;
                ...
                while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                    match __key {
                        ...
                        __Field::__field1 => {
                            ...
                            __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateHandle>(&mut __map)?);
                        }
                        __Field::__field2 => {
...
impl postgresql_crud::PostgresqlJsonType for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn update_query_bind(value: Self::Update, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments> {
        for element in value.update.0.into_vec() {
            ...
            query = <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::update_query_bind(element.fields, query);
        }
                ...
                postgresql_crud::UniqueVec::try_new(
                    value
                        ...
                        .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                            ...
                            fields: <AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(AnimalAsNotNullJsonbObjectReadInner { field_0: element.field_0 }),
                        })
                        .collect(),
                )
                .unwrap(),
                ...
                .map(|element| {
                    ...
                    AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds(postgresql_crud::Value {
                        value: AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIdsHandle {
                            ...
                            field_0: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&field_0.expect("expect a3ec7cae-94a0-49c1-b5d1-88f7b2a3dd1d")),
                        },
                    })
                })
                .collect(),
...
impl postgresql_crud::PostgresqlJsonType for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn update_query_bind(value: Self::Update, query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments> {
        match value.0 {
            ...
            None => query.bind(sqlx::types::Json(<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Update::new(None))),
        }
    }
    fn select_only_updated_ids_query_part(value: &Self::Update, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match &value.0 {
...
impl postgresql_crud::PostgresqlType for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn update_query_part(value: &Self::Update, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match &value.0 {
            Some(value) => <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::update_query_part(value, jsonb_set_accumulator, jsonb_set_target, jsonb_set_path, increment),
            None => match increment.checked_add(1) {
                Some(value) => {
                    *increment = value;
                    Ok(format!("jsonb_set({jsonb_set_accumulator},'{{{jsonb_set_path}}}',${increment})"))
    ...
    fn update_query_bind<'a>(value: Self::Update, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments> {
        match value.0 {
            Some(value) => <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::update_query_bind(value, query),
            None => query.bind(sqlx::types::Json(<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Update::new(None))),
        }
    }
    fn select_only_updated_ids_query_part(value: &Self::Update, column: &std::primitive::str, increment: &mut std::primitive::u64, is_primary_key: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        //         Err(error) => Err(error),
        //     },
        //     None => Ok(format!("jsonb_build_object('value',(select jsonb_agg(jsonb_build_object('id', elem -> 'id')||jsonb_build_object('field_0', 'null'::jsonb)) from jsonb_array_elements({column}) as elem)::jsonb) as {column},")),
        // }

        match &value.0 {
            Some(value) => {
                //////////////here
                Ok(format!("jsonb_build_object('value',jsonb_build_object('value',(select jsonb_agg({}) from jsonb_array_elements({column}) as elem)::jsonb)) as {column},", {
                    match <AnimalWithIdAsNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.update, &"", &"elem", increment) {
                        Ok(value) => value,
                        Err(error) => {
                            return Err(error);
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn update_to_read_only_ids(value: &<Self::Element as postgresql_crud::PostgresqlType>::Update) -> <Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds {
        OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadOnlyIds(postgresql_crud::Value {
            value: match &value.0 {
                Some(value) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&value)),
                None => None,
            },
        })
    }
