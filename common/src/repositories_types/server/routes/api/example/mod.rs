...
impl postgresql_crud::PostgresqlJsonTypeTestCases for OptionAnimalAsNullableJsonbObject {
    ...
    fn read_from_previous_read_unwraped_merged_with_update(read: <Self::Element as postgresql_crud::PostgresqlJsonType>::Read, option_update: std::option::Option<<Self::Element as postgresql_crud::PostgresqlJsonType>::Update>) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Read {
        match option_update {
            Some(value) => match (read.0, value.0) {
                (Some(read), Some(update)) => OptionAnimalAsNullableJsonbObjectRead(Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(read, Some(update)))),
                (Some(read), None) => OptionAnimalAsNullableJsonbObjectRead(Some(read)),
                (None, Some(update)) => {
                    let mut field_0 = None;
                    let mut field_1 = None;
                    ...
                    OptionAnimalAsNullableJsonbObjectRead(Some(AnimalAsNotNullJsonbObjectRead {
                        field_0: Some(postgresql_crud::Value {
                ...
                (None, None) => OptionAnimalAsNullableJsonbObjectRead(None),
            },
            None => read,
        }
    }
