            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    let select_default_all_with_max_page_size = postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec![
                        ...
                        super::ExampleSelect::Column6(<<postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlType>::Select as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize>::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
                    ])
                    ...
                    //             for chunk in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_vec()
                    //                 .chunks(10)
                    ...
                    //                                     column_6: <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_6.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), create.column_6),
                    //                                 });
                    //                             }
                    //                             acc.sort_by(|a, b| {
                    ...
                    //                 }));
                    //             }
                    //             for chunk in <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::create_vec()
                    //                 .chunks(10)
                    //                 .map(|element| element.to_vec())
                    //                 .collect::<std::vec::Vec<std::vec::Vec<<postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlType>::Create>>>()
                    //             {
                    //                 let url_cloned = url.clone();
                    //                 let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                    //                 acc.push(futures::FutureExt::boxed(async move {
                    ...
                    //                             column_6: <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_6.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_6)
                    //                         },
                    //                         super::Example::try_read_one(
                    //                             &url_cloned,
                    //                             super::ExampleReadOneParameters {
                    ...
                    //                 }));
                    //             }
                    //             for element in <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                    //                 let url_cloned = url.clone();
                    //                 let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                    //                 acc.push(futures::FutureExt::boxed(async move {
                    //                     let ident_create = super::ExampleCreate {
                    ...
                    // let create_one_elapsed = start.elapsed();
                    {
                            ...
                            futures::stream::iter({
                                ...
                                for element in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                                    ...
                                    acc.push(futures::FutureExt::boxed(async move {
                                        ...
                                        let expected = vec![super::ExampleRead {
                                            ...
                                            column_6: <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_6.clone().expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_6.clone())
                                        }];
                                                        ...
                                                        super::ExampleWhereMany::try_new(
                                                            ...
                                                            Some(
                                                                postgresql_crud::PostgresqlTypeWhere::try_new(
                                                                    ...
                                                                    <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_0.clone())
                                                                )
                                        ...
                                        println!("ident_create {ident_create:#?}\nexpected {expected:#?}\ndb {db:#?}");
                                        assert_eq!(
                                            expected,
                                            db,
                                                        ...
                                                        where_many: super::StdOptionOptionExampleWhereMany(Some(
                                                            super::ExampleWhereMany::try_new(
                                                                ...
                                                                Some(
                                                                    postgresql_crud::PostgresqlTypeWhere::try_new(
                                                                        postgresql_crud::LogicalOperator::Or,
                                                                        <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids_returned_from_create_one.column_6.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_6.clone())
                                                                    )
                                                                    .expect("error c10cf3d9-f531-442a-99f0-f36c80fee4b1"),
                                                                )
                                                            )
                        ...
                        //                                             postgresql_crud::PostgresqlTypeWhere::try_new(
                        //                                                 postgresql_crud::LogicalOperator::Or,
                        //                                                 <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal_using_fields(read_only_ids_returned_from_create_one.column_0.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_0.clone())
                        //                                             )
                        //                                             .expect("error c10cf3d9-f531-442a-99f0-f36c80fee4b1"),
                        //                                         ),
                        //                                         None
                        ...
                        //                                             postgresql_crud::PostgresqlTypeWhere::try_new(
                        //                                                 postgresql_crud::LogicalOperator::Or,
                        //                                                 <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal_using_fields(read_only_ids_returned_from_create_one.column_6.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_6.clone())
                        //                                             )
                        //                                             .expect("error c10cf3d9-f531-442a-99f0-f36c80fee4b1"),
                        //                                         )
                        //                                     )
                    ...
                    //                         for element in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_of_read_inner(&value) {
                    //                             for _ in element {
                    //                                 acc.push(ident_create_default.clone());
                    //                             }
                    //                         }
                    ...
                    //                     println!("PostgresqlTypeTestCases read_only_ids_to_two_dimensional_vec_of_read_inner is empty for column_0");
                    //                 } else {
                    ...
                    //                                 for element_0 in <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_of_read_inner(&read_only_ids_current_element.column_0.clone().expect("error c4d98a71-f30f-410e-b410-a75f4672f2f7")) {
                    ...
                    //                         for element in <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_of_read_inner(&value) {
                    //                             for _ in element {
                    //                                 acc.push(ident_create_default.clone());
                    //                             }
                    //                         }
                    ...
                    //                 println!("update_many len {}", read_only_ids_to_two_dimensional_vec_of_read_inner_acc.len());
                    //                 if read_only_ids_to_two_dimensional_vec_of_read_inner_acc.is_empty() {
                    //                     println!("PostgresqlTypeTestCases read_only_ids_to_two_dimensional_vec_of_read_inner is empty for column_6");
                    //                 } else {
                    //                     let read_only_ids_current_elements = {
                    //                         use futures::StreamExt;
                    //                         futures::stream::iter(
                    ...
                    //                                 let mut local_increment = 0;
                    //                                 let mut option_test_case = None;
                    //                                 for element_0 in <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_of_read_inner(&read_only_ids_current_element.column_6.clone().expect("error c4d98a71-f30f-410e-b410-a75f4672f2f7")) {
                    //                                     let mut should_break = false;
                    //                                     for element_1 in element_0 {
                    //                                         if local_increment == increment {
                    //                                             option_test_case = Some(element_1);
                    ...
                    //                                         )
                    //                                     }),
                    //                                     column_6: previous_read.column_6
                    //                                 },
                    //                                 super::Example::try_read_one(
                    //                                     &url_cloned,
                    //                                     super::ExampleReadOneParameters {
                    ...
                    //             column_6: <postgresql_crud::StdPrimitiveI32AsNotNullInt4 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_6.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create_default.column_6)
                    //         },
                    //         super::Example::try_read_one(
                    //             &url,
                    //             super::ExampleReadOneParameters {
