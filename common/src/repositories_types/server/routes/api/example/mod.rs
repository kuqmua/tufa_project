...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn create_and_where_element_equal_vec() -> std::vec::Vec<(<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create, <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement)> {
        let mut acc = vec![];
