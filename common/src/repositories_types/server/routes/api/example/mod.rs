...
impl AnimalWithIdAsNotNullJsonbObjectWithId {
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, create: AnimalWithIdAsNotNullJsonbObjectWithIdCreate) -> AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement {
        AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement::Equal(postgresql_crud::PostgresqlJsonTypeWhereElementEqual {
            ...
            value: AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration::new(
                ...
                <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids.0.value.field_2, create.field_2),
            ),
        })
    }
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, create: AnimalWithIdAsNotNullJsonbObjectWithIdCreate) -> std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement> {
        vec![
            ...
            AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement::Field2(
                postgresql_crud::PostgresqlTypeWhere::try_new(
                    postgresql_crud::LogicalOperator::And,
                    <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids.0.value.field_2, create.field_2),
                )
                .expect("error f8c3796f-7574-468b-ac60-12a620c0917d"),
            ),
        ]
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids: AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, create: AnimalWithIdAsNotNullJsonbObjectWithIdCreate) -> std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement> {
        ...
        acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement::Field2(
            postgresql_crud::PostgresqlTypeWhere::try_new(
                postgresql_crud::LogicalOperator::Or,
                <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids.0.value.field_2, create.field_2),
            )
            .expect("error 187ece1f-7c99-437b-80a3-ed1a416731a3"),
        ));
        acc
...
impl AnimalAsNotNullJsonbObjectTableTypeDeclaration {
    pub fn new(field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration) -> Self {
        Self { field_2 }
    }
}
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectTableTypeDeclaration {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            field_2: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        }
    }
}
...
impl AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration {
    pub fn new(id: <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration, field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration) -> Self {
        Self { id, field_2 }
    }
}
...
impl AnimalAsNotNullJsonbObjectCreate {
    pub fn new(field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Create) -> Self {
        Self { field_2 }
    }
}
...
pub struct AnimalAsNotNullJsonbObjectCreateForQuery {
    field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::CreateForQuery,
}
impl std::convert::From<AnimalAsNotNullJsonbObjectCreate> for AnimalAsNotNullJsonbObjectCreateForQuery {
    fn from(value: AnimalAsNotNullJsonbObjectCreate) -> Self {
        Self {
            field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value.field_2),
        }
    }
}
    ...
    fn select_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, column_name_and_maybe_field_getter_for_error_message: &std::primitive::str) -> std::string::String {
        ...
        for element in self.0.to_vec() {
            acc.push_str(&format!(
                "{}||",
                match element {
                    AnimalAsNotNullJsonbObjectSelectElement::Field2(value) => <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_2", &column_name_and_maybe_field_getter, &column_name_and_maybe_field_getter_for_error_message, false,),
                }
            ));
        }
        let _ = acc.pop();
...
pub enum AnimalAsNotNullJsonbObjectSelectElement {
    ...
    Field2(<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Select),
}
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![AnimalAsNotNullJsonbObjectSelectElement::Field2(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element())]
    }
}
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for AnimalAsNotNullJsonbObjectSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_with_max_page_size() -> std::vec::Vec<Self> {
        vec![AnimalAsNotNullJsonbObjectSelectElement::Field2(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size())]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![
            ...
            AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field2(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
        ]
    }
}
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_with_max_page_size() -> std::vec::Vec<Self> {
        vec![
            ...
            AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field2(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
        ]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub enum AnimalAsNotNullJsonbObjectWhereElement {
    Field2(postgresql_crud::PostgresqlTypeWhere<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::WhereElement>),
...
impl<'a> postgresql_crud::PostgresqlTypeWhereFilter<'a> for AnimalAsNotNullJsonbObjectWhereElement {
    fn query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match &self {
            Self::Field2(value) => postgresql_crud::PostgresqlTypeWhereFilter::query_part(value, increment, &format!("{column}->'field_2'"), is_need_to_add_logical_operator),
    ...
    fn query_bind(self, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        match self {
            Self::Field2(value) => postgresql_crud::PostgresqlTypeWhereFilter::query_bind(value, query),
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectWhereElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![
            Self::Field2(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
...
pub struct AnimalAsNotNullJsonbObjectRead {
    ...
    field_2: std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>,
}
impl AnimalAsNotNullJsonbObjectRead {
    fn into_inner(self) -> AnimalAsNotNullJsonbObjectReadInner {
        AnimalAsNotNullJsonbObjectReadInner {
            field_2: match self.field_2 {
                Some(value) => Some(postgresql_crud::Value {
                    value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(value.value),
                }),
                None => None,
            },
        }
...
impl AnimalAsNotNullJsonbObjectRead {
    pub fn try_new(field_2: std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>) -> Result<Self, AnimalAsNotNullJsonbObjectReadTryFromErrorNamed> {
        if let None = &field_2 {
    ...
    impl<'de> _serde::Deserialize<'de> for AnimalAsNotNullJsonbObjectRead {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                ...
                {
                    match __value {
                        "field_2" => serde::__private::Ok(__Field::__field0),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                ...
                {
                    match __value {
                        b"field_2" => serde::__private::Ok(__Field::__field0),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                {
                    let __field0 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>>(&mut __seq)? {
                ...
                {
                    let mut __field0: serde::__private::Option<std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>> = serde::__private::None;
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                if serde::__private::Option::is_some(&__field0) {
                                    return serde::__private::Err(<__A::Error as serde::de::Error>::duplicate_field("field_2"));
                                }
                                __field0 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>>(&mut __map)?);
                            }
                            _ => {
                    ...
                    let __field0 = match __field0 {
                        ...
                        serde::__private::None => serde::__private::de::missing_field("field_2")?,
                    };
                    match AnimalAsNotNullJsonbObjectRead::try_new(__field0) {
                        Ok(value) => serde::__private::Ok(value),
                        Err(error) => {
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["field_2"];
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "field_2" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                fn visit_bytes<__E>(self, __value: &[u8]) -> _serde::__private::Result<Self::Value, __E>
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"field_2" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    let __field1 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct AnimalWithIdAsNotNullJsonbObjectWithIdRead with 2 elements"));
                        }
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field1: serde::__private::Option<std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>> = serde::__private::None;
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                if serde::__private::Option::is_some(&__field0) {
                            ...
                            __Field::__field1 => {
                                ...
                                __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>>(&mut __map)?);
                            }
                            _ => {
                                let _ = _serde::de::MapAccess::next_value::<_serde::de::IgnoredAny>(&mut __map)?;
                            }
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["id", "field_2"];
            _serde::Deserializer::deserialize_struct(
                __deserializer,
...
pub struct AnimalAsNotNullJsonbObjectReadOnlyIdsHandle {
    field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds,
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
...
pub struct AnimalAsNotNullJsonbObjectReadInner {
    field_2: std::option::Option<postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::ReadInner>>,
}
#[derive(Debug, Clone, PartialEq)]
...
pub enum AnimalAsNotNullJsonbObjectUpdateElement {
    #[serde(rename(serialize = "field_2", deserialize = "field_2"))]
    Field2(postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Update>),
}
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectUpdateElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![AnimalAsNotNullJsonbObjectUpdateElement::Field2(postgresql_crud::Value {
            value: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        })]
    }
}
...
impl AnimalAsNotNullJsonbObjectUpdateForQuery {
    fn select_only_updated_ids_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in self.0.to_vec() {
            match &element {
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field2(value) => match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_2", &column_name_and_maybe_field_getter, increment) {
                    Ok(mut value) => {
                        let _ = value.pop();
...
pub enum AnimalAsNotNullJsonbObjectUpdateForQueryElement {
    #[serde(rename(serialize = "field_2", deserialize = "field_2"))]
    Field2(postgresql_crud::Value<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::UpdateForQuery>),
}
impl std::convert::From<AnimalAsNotNullJsonbObjectUpdateElement> for AnimalAsNotNullJsonbObjectUpdateForQueryElement {
    fn from(value: AnimalAsNotNullJsonbObjectUpdateElement) -> Self {
        match value {
            AnimalAsNotNullJsonbObjectUpdateElement::Field2(value) => AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field2(postgresql_crud::Value {
                value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::UpdateForQuery::from(value.value),
            }),
        }
    }
}
...
impl postgresql_crud::PostgresqlJsonType for AnimalAsNotNullJsonbObject {
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        let mut acc = std::string::String::default();
        acc.push_str(&format!(
            "jsonb_build_object('field_2',{})||",
            <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_2'"))
        ));
        let _ = acc.pop();
        let _ = acc.pop();
    ...
    fn update_query_part(value: &Self::UpdateForQuery, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field2(value) => match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::update_query_part(&value.value, &std_option_option_object_acc, &generate_jsonb_set_target("field_2"), "field_2", increment) {
                    Ok(value) => {
    ...
    fn update_query_bind(value: Self::UpdateForQuery, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        for element in value.0.into_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field2(value) => match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::update_query_bind(value.value, query) {
                    Ok(value) => {
                        query = value;
                    }
                    Err(error) => {
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        for element in value.0.to_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field2(value) => match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(&value.value, query) {
                    Ok(value) => {
                        query = value;
                    }
                    Err(error) => {
    ...
    fn select_only_created_ids_query_part(value: &Self::CreateForQuery, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(format!("'{field_ident}',jsonb_build_object('value',{}),", {
            ...
            match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_part(&value.field_2, &"field_2", &format!("{column_name_and_maybe_field_getter}->'field_2'"), increment) {
                Ok(mut value) => {
                    let _ = value.pop();
                    acc.push_str(&format!("jsonb_build_object({})||", value));
                }
    ...
    fn select_only_created_ids_query_bind<'a>(value: &'a Self::CreateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(&value.field_2, query) {
            Ok(value) => {
                query = value;
            }
            Err(error) => {
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    type Select = AnimalAsNotNullJsonbObjectSelect;
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create>> {
        Some({
            let mut acc = vec![];
            if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create() {
    ...
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        ...
        for element0 in <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&read_only_ids.0.value.field_2) {
            for element1 in element0 {
                let field_2_current = Some(postgresql_crud::Value { value: element1 });
                field_2_last = field_2_current.clone();
                acc.push(vec![AnimalAsNotNullJsonbObjectReadInner { field_2: field_2_current.clone() }]);
            }
        }
        drop(field_2_last);
        acc
    ...
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Read::try_new(match value.field_2 {
            Some(value) => Some(postgresql_crud::Value {
                value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_read_with_new_or_try_new_unwraped(value.value),
            }),
            None => None,
        })
        .unwrap()
    ...
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Update::new(
            postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                let mut acc = vec![];
                if let Some(value) = value.field_2 {
                    acc.push(AnimalAsNotNullJsonbObjectUpdateElement::Field2(postgresql_crud::Value {
                        value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(value.value),
                    }));
                }
                acc
            })
    ...
    fn read_only_ids_into_option_value_read_inner(value: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadInner {
                field_2: match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_into_option_value_read_inner(value.0.value.field_2) {
                    Some(value) => Some(value),
                    None => Some(postgresql_crud::Value {
                        value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(
                            <<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
                        ),
                    }),
                },
            },
    ...
    fn update_to_read_only_ids(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds {
        ...
        for element in value.0.to_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field2(value) => {
                    field_2 = Some(<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&value.value));
                }
            }
        }
        AnimalAsNotNullJsonbObjectReadOnlyIds(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadOnlyIdsHandle { field_2: field_2.expect("expect 106f16f2-ae03-48b3-9239-f4b1b60746d5") },
        })
    }
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectRead::try_new(<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(
                &value.0.value.field_2,
            ))
    ...
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read, option_update: std::option::Option<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update>) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        match option_update {
            Some(value) => {
                ...
                AnimalAsNotNullJsonbObjectRead {
                    field_2: Some(postgresql_crud::Value {
                        value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(read.field_2.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").value, field_2),
                    }),
                }
            }
            None => read,
    ...
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        AnimalAsNotNullJsonbObjectRead::try_new(<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.0.value.field_2, create.field_2)).expect("error 52ad3994-8392-4fc5-8427-4ca42d87d726")
    }
    ...
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration {
        AnimalAsNotNullJsonbObjectTableTypeDeclaration::new(<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids.0.value.field_2, create.field_2))
    }
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement {
        AnimalAsNotNullJsonbObjectWhereElement::Equal(postgresql_crud::PostgresqlJsonTypeWhereElementEqual {
            logical_operator: postgresql_crud::LogicalOperator::Or,
            value: AnimalAsNotNullJsonbObjectTableTypeDeclaration::new(<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids.0.value.field_2, create.field_2)),
        })
    }
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        vec![AnimalAsNotNullJsonbObjectWhereElement::Field2(
            postgresql_crud::PostgresqlTypeWhere::try_new(
                postgresql_crud::LogicalOperator::And,
                <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids.0.value.field_2, create.field_2),
            )
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        let mut acc = vec![];
        for element in <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids.0.value.field_2, create.field_2) {
            acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, vec![element]).expect("error 0c6ccad1-6ffc-451f-9b16-0731010fee9f")));
        }
        acc
    }
    ...
    ) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        let mut acc = vec![];
        if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids.0.value.field_2, create.field_2) {
            for element in value.clone() {
                acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 479db858-6f36-48ba-9ab0-741b7df7956c")));
            }
            let whole = AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error beaeb784-58ea-4836-9c54-73924493bfb4"));
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(
        ...
        let mut acc = vec![];
        if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids.0.value.field_2, create.field_2) {
            for element in value.clone() {
                acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 479db858-6f36-48ba-9ab0-741b7df7956c")));
            }
            let whole = AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error beaeb784-58ea-4836-9c54-73924493bfb4"));
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(
        ...
        let mut acc = vec![];
        if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids.0.value.field_2, create.field_2) {
            for element in value.clone() {
                acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 479db858-6f36-48ba-9ab0-741b7df7956c")));
            }
            let whole = AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error beaeb784-58ea-4836-9c54-73924493bfb4"));
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(
        ...
        let mut acc = vec![];
        if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids.0.value.field_2, create.field_2) {
            for element in value.clone() {
                acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 479db858-6f36-48ba-9ab0-741b7df7956c")));
            }
            let whole = AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error beaeb784-58ea-4836-9c54-73924493bfb4"));
    ...
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        let mut acc = vec![];
        if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create.field_2) {
            for element in value.clone() {
                acc.push(AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 479db858-6f36-48ba-9ab0-741b7df7956c")));
            }
            let whole = AnimalAsNotNullJsonbObjectWhereElement::Field2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error beaeb784-58ea-4836-9c54-73924493bfb4"));
...
impl postgresql_crud::PostgresqlTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    type Select = AnimalAsNotNullJsonbObjectSelect;
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create>> {
        <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create()
    }
    ...
    fn read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_element_greater_than(
        greater_than_variant: postgresql_crud::GreaterThanVariant,
    ...
    ) -> std::option::Option<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement> {
        None
    }
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids, create)
    }
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct OptionAnimalAsNullableJsonbObjectTableTypeDeclaration(std::option::Option<AnimalAsNotNullJsonbObjectTableTypeDeclaration>);
impl OptionAnimalAsNullableJsonbObjectTableTypeDeclaration {
    pub fn new(value: std::option::Option<AnimalAsNotNullJsonbObjectTableTypeDeclaration>) -> Self {
        Self(value)
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectTableTypeDeclaration {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectTableTypeDeclaration {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<OptionAnimalAsNullableJsonbObjectTableTypeDeclaration> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<OptionAnimalAsNullableJsonbObjectTableTypeDeclaration> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct OptionAnimalAsNullableJsonbObjectCreate(std::option::Option<AnimalAsNotNullJsonbObjectCreate>);
impl OptionAnimalAsNullableJsonbObjectCreate {
    pub fn new(value: std::option::Option<AnimalAsNotNullJsonbObjectCreate>) -> Self {
        Self(value)
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectCreate {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectCreate {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<OptionAnimalAsNullableJsonbObjectCreate> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<OptionAnimalAsNullableJsonbObjectCreate> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize)]
pub struct OptionAnimalAsNullableJsonbObjectCreateForQuery(std::option::Option<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::CreateForQuery>);
impl std::convert::From<OptionAnimalAsNullableJsonbObjectCreate> for OptionAnimalAsNullableJsonbObjectCreateForQuery {
    fn from(value: OptionAnimalAsNullableJsonbObjectCreate) -> Self {
        Self(match value.0 {
            Some(value) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value)),
            None => None,
        })
    }
}
impl sqlx::Encode<'_, sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectCreateForQuery {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectCreateForQuery {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<OptionAnimalAsNullableJsonbObjectCreateForQuery> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<OptionAnimalAsNullableJsonbObjectCreateForQuery> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for OptionAnimalAsNullableJsonbObjectSelect {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size() -> Self {
...
impl sqlx::Encode<'_, sqlx::Postgres> for OptionAnimalAsNullableJsonbObjectRead {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize)]
pub struct OptionAnimalAsNullableJsonbObjectUpdateForQuery(std::option::Option<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::UpdateForQuery>);
impl OptionAnimalAsNullableJsonbObjectUpdateForQuery {
    fn select_only_updated_ids_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(match &self.0 {
            Some(value) => {
                let mut acc = std::string::String::default();
...
impl std::convert::From<<OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::Update> for <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::UpdateForQuery {
    fn from(value: <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::Update) -> Self {
        Self(match value.0 {
            Some(value) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::UpdateForQuery::from(value)),
            None => None,
        })
    }
}
impl postgresql_crud::PostgresqlJsonType for OptionAnimalAsNullableJsonbObject {
    ...
    type CreateForQuery = OptionAnimalAsNullableJsonbObjectCreateForQuery;
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!(
            "jsonb_build_object('value',case when jsonb_typeof({column_name_and_maybe_field_getter})='null' then 'null'::jsonb else {} end)",
            <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(column_name_and_maybe_field_getter),
        )
    }
    ...
    type UpdateForQuery = OptionAnimalAsNullableJsonbObjectUpdateForQuery;
    fn update_query_part(value: &Self::UpdateForQuery, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match &value.0 {
    ...
    fn select_only_created_ids_query_bind<'a>(value: &'a Self::CreateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        if let Some(value) = &value.0 {
            match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(&value, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
...
impl postgresql_crud::PostgresqlType for OptionAnimalAsNullableJsonbObject {
    ...
    fn create_query_bind(value: Self::Create, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        if let Err(error) = query.try_bind(<OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value)) {
            return Err(error.to_string());
        }
        Ok(query)
    }
    ...
    fn update_query_bind<'a>(value: Self::UpdateForQuery, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::update_query_bind(value, query)
    }
    fn select_only_updated_ids_query_part(value: &Self::UpdateForQuery, column: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match value.select_only_updated_ids_query_part(&column, increment) {
            Ok(value) => Ok(format!("jsonb_build_object('value',{}) as {column},", value)),
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(value, query)
    }
}
#[cfg(feature = "test-utils")]
impl postgresql_crud::PostgresqlJsonTypeTestCases for OptionAnimalAsNullableJsonbObject {
    ...
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create>> {
        Some({
            let mut acc = vec![];
            if let Some(value) = <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create() {
                for element in value {
                    let value = <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::Create::new(Some(element));
                    if !acc.contains(&value) {
                        acc.push(value);
                    }
                }
            ...
            {
                let value = <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonType>::Create::new(None);
                if !acc.contains(&value) {
                    acc.push(value);
                }
            }
    ...
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        ...
        if let Some(value) = &read_only_ids.0.value {
            for element0 in <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&value) {
                for element1 in element0 {
    ...
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: OptionAnimalAsNullableJsonbObjectReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Read::new(match value {
            Some(value) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_read_with_new_or_try_new_unwraped(value)),
            None => None,
        })
    }
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: OptionAnimalAsNullableJsonbObjectReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Update::new(match value {
            Some(value) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(value)),
            None => None,
        })
    }
    fn read_only_ids_into_option_value_read_inner(value: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        Some(postgresql_crud::Value {
            value: match value.0.value {
                Some(value) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_into_option_value_read_inner(value) {
    ...
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: OptionAnimalAsNullableJsonbObjectRead::new(match &value.0.value {
                Some(value) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value) {
                    Some(value) => Some(value.value),
                    None => None,
                },
                None => None,
    ...
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read, option_update: std::option::Option<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update>) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        match option_update {
            Some(value) => OptionAnimalAsNullableJsonbObjectRead(match value.0 {
                Some(value) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(
                    match read.0 {
                        Some(value) => value,
    ...
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        OptionAnimalAsNullableJsonbObjectRead::new(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids, create).expect("error 56ac4450-0feb-4ea7-aca7-6f51c8f4893c").value),
    ...
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create),
        })
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration {
        OptionAnimalAsNullableJsonbObjectTableTypeDeclaration::new(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids, create)),
    ...
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement {
        postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec![<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids, create)]).expect("error 9f550fbd-2d60-4a8a-a67b-ab49f728c9d0")),
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        vec![postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)).expect("error 9f550fbd-2d60-4a8a-a67b-ab49f728c9d0")),
            (Some(_), None) => panic!("error 49e4c289-b37d-4365-96e3-5d896d6860f7"),
            (None, Some(_)) => panic!("error ad71caa2-2503-4f9a-952c-e796abf5bbbe"),
            (None, None) => None,
        })]
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => {
                for element in <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids, create) {
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 111144d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 222244d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 33344d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 44444d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        match create.0 {
            Some(create) => match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 55544d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
...
impl postgresql_crud::PostgresqlTypeTestCases for OptionAnimalAsNullableJsonbObject {
    ...
    type Select = OptionAnimalAsNullableJsonbObjectSelect;
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create()
    }
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadInner>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&read_only_ids)
    }
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: OptionAnimalAsNullableJsonbObjectReadInner) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_read_with_new_or_try_new_unwraped(value)
    }
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: OptionAnimalAsNullableJsonbObjectReadInner) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(value)
    }
    fn update_to_read_only_ids(value: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(value)
    }
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value)
    }
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read, option_update: std::option::Option<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update>) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(read, option_update)
    }
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::TableTypeDeclaration {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_option_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        Some(<OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids, create))
    }
    fn create_into_postgresql_type_option_vec_where_element_dimension_one_equal(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        None
    }
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids, create)
    }
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionAnimalAsNullableJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
impl postgresql_crud::PostgresqlTypeNotPrimaryKey for OptionAnimalAsNullableJsonbObject {
    type PostgresqlType = OptionAnimalAsNullableJsonbObject;
    type Create = OptionAnimalAsNullableJsonbObjectCreate;
}
#[derive(Debug)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId;
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration(std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>);
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration {
    pub fn new(value: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>) -> Self {
        Self(value)
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate(std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>);
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate {
    pub fn new(value: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>) -> Self {
        Self(value)
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
...
impl std::convert::From<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn from(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate) -> Self {
        Self(value.0.into_iter().map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery::from(element)).collect())
    }
}
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdSelect {
    animal_with_id_as_not_null_jsonb_object_with_id_select: AnimalWithIdAsNotNullJsonbObjectWithIdSelect,
...
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdSelect {
    pub fn new(animal_with_id_as_not_null_jsonb_object_with_id_select: AnimalWithIdAsNotNullJsonbObjectWithIdSelect, dimension1_pagination: postgresql_crud::PaginationStartsWithZero) -> Self {
        Self {
            animal_with_id_as_not_null_jsonb_object_with_id_select,
            dimension1_pagination,
        }
    }
    fn select_query_part_postgresql_type(&self, column: &std::primitive::str) -> std::string::String {
        let animal_with_id_as_not_null_jsonb_object_with_id_select = {
            let mut acc = std::string::String::default();
            for element in self.animal_with_id_as_not_null_jsonb_object_with_id_select.0.to_vec() {
                acc.push_str(&format!(
                    "{}||",
                    match element {
                        AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Id(value) => <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "id", &"value", &column, false,),
                        AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field2(value) => <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_2", &"value", &column, false,),
                    }
                ));
            }
            let _ = acc.pop();
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdSelect {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            animal_with_id_as_not_null_jsonb_object_with_id_select: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdSelect {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size() -> Self {
        Self {
            animal_with_id_as_not_null_jsonb_object_with_id_select: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size(),
...
pub enum VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement {
    ...
    DimensionOneEqual(postgresql_crud::PostgresqlJsonTypeWhereElementDimensionOneEqual<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>),
    ...
    DimensionOneIn(postgresql_crud::PostgresqlJsonTypeWhereElementDimensionOneIn<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>),
    ContainsAllElementsOfArray(postgresql_crud::PostgresqlJsonTypeWhereElementContainsAllElementsOfArray<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>),
    OverlapsWithArray(postgresql_crud::PostgresqlJsonTypeWhereElementOverlapsWithArray<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>),
    ...
    ElementField2(postgresql_crud::PostgresqlTypeWhere<<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::WhereElement>),
}
impl<'a> postgresql_crud::PostgresqlTypeWhereFilter<'a> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement {
    fn query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        match &self {
            ...
            Self::ElementField2(value) => generate_element_query(value, &"field_2"),
        }
    }
    fn query_bind(self, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        match self {
            ...
            Self::ElementField2(value) => postgresql_crud::PostgresqlTypeWhereFilter::query_bind(value, query),
        }
    }
}
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![
            ...
            Self::ElementField2(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
        ]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead(std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdRead>);
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead {
    fn into_inner(self) -> VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner {
        self.0
            .into_iter()
            .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                id: match element.id {
                    Some(value) => Some(postgresql_crud::Value {
...
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead {
    pub fn new(value: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdRead>) -> Self {
        Self(value)
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
...
pub type VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner = std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdReadInner>;
#[derive(Debug, Clone, PartialEq, serde :: Serialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate {
    #[serde(skip_serializing_if = "Vec::is_empty")]
    create: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>,
    update: postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    ...
    pub fn try_new(create: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>, update: postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>, delete: std::vec::Vec<<postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Update>) -> Result<Self, VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed> {
        ...
        }
        {
            ...
            for element in update.to_vec() {
                if acc.contains(&&element.id) {
                    return Err(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::IdsAreNotUnique {
        ...
        }
        {
            ...
            let delete_acc = {
                ...
                for element in &delete {
                    if delete_acc.contains(&element) {
                        return Err(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonDeleteArray {
                            error: format!(
                                "custom serde error deserializing VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json delete array: {}",
                                <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeObjectVecElementId>::get_inner(&element.clone().into())
                            ),
                            code_occurence: error_occurence_lib::code_occurence!(),
                        });
                    } else {
            ...
            for element in update_acc {
                if delete_acc.contains(&&element) {
                    return Err(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonUpdateAndDeleteArrays {
                        error: format!(
                            "custom serde error deserializing VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json update and delete arrays: {}",
                            <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeObjectVecElementId>::get_inner(&element.clone().into())
                        ),
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
...
impl<'de> serde::Deserialize<'de> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            {
                let __field0 = match serde::de::SeqAccess::next_element::<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>>(&mut __seq)? {
                    serde::__private::Some(__value) => __value,
                    serde::__private::None => {
                        vec![]
                    }
                };
                let __field1 = match serde::de::SeqAccess::next_element::<postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>>(&mut __seq)? {
                    serde::__private::Some(__value) => __value,
                    serde::__private::None => postgresql_crud::UniqueVec::<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>::default(),
                };
            ...
            {
                let mut __field0: serde::__private::Option<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>> = serde::__private::None;
                let mut __field1: serde::__private::Option<postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>> = serde::__private::None;
                ...
                while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                    match __key {
                        __Field::__field0 => {
                            ...
                            __field0 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>>(&mut __map)?);
                        }
                        __Field::__field1 => {
                            if serde::__private::Option::is_some(&__field1) {
                                return serde::__private::Err(<__A::Error as serde::de::Error>::duplicate_field("update"));
                            }
                            __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>>(&mut __map)?);
                        }
                        __Field::__field2 => {
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize)]
pub struct VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateForQuery {
    #[serde(skip_serializing_if = "Vec::is_empty")]
    create: std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery>,
    update: postgresql_crud::UniqueVec<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateForQueryElement>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    delete: std::vec::Vec<<postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::UpdateForQuery>,
}
impl VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateForQuery {
    fn select_only_updated_ids_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(format!(
            "(select jsonb_agg({}) from jsonb_array_elements({}) as elem where elem->>'id' in ({}))",
            {
                ...
                for element in self.update.to_vec() {
                    ...
                    for element in element.fields.0.to_vec() {
                        match &element {
                            AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field2(value) => match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_2", &"elem", increment) {
                                Ok(mut value) => {
                                    let _ = value.pop();
                                    current_acc.push_str(&format!("jsonb_build_object({})||", value));
                                }
                ...
                for element in &self.create {
                    ...
                    match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_part(&element.field_2, &"field_2", &"elem", increment) {
                        Ok(mut value) => {
                            let _ = value.pop();
                            acc.push_str(&format!("jsonb_build_object({})||", value));
                        }
...
impl std::convert::From<<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Update> for <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::UpdateForQuery {
    fn from(value: <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Update) -> Self {
        Self {
            create: value.create.into_iter().map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery::from(element)).collect(),
...
impl postgresql_crud::PostgresqlJsonType for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    type CreateForQuery = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreateForQuery;
    type Select = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdSelect;
    fn select_query_part(value: &Self::Select, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, column_name_and_maybe_field_getter_for_error_message: &std::primitive::str, is_postgresql_type: std::primitive::bool) -> std::string::String {
        let animal_with_id_as_not_null_jsonb_object_with_id_select = {
            let mut acc = std::string::String::default();
            for element in value.animal_with_id_as_not_null_jsonb_object_with_id_select.0.to_vec() {
                acc.push_str(&format!(
                    "{}||",
                    match element {
                        AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Id(value) => <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "id", &"value", &"value", false,),
                        AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field2(value) => <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_2", &"value", &"value", false,),
                    }
                ));
            }
            let _ = acc.pop();
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!("jsonb_build_object('value',(select jsonb_agg({}) from jsonb_array_elements({column_name_and_maybe_field_getter}) as elem))", {
            ...
            acc.push_str(&format!("jsonb_build_object('field_2',{})||", <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&"elem->'field_2'")));
            let _ = acc.pop();
            let _ = acc.pop();
            format!("jsonb_build_object('value',{})", acc)
        })
    ...
    type UpdateForQuery = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateForQuery;
    fn update_query_part(value: &Self::UpdateForQuery, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
            ...
            if value.update.is_empty() {
                ...
                for element in value.update.to_vec() {
                    let ident_with_id_handle = {
                        ...
                        match <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::update_query_part(&element.fields, &"", &"elem", &"", increment) {
    ...
    fn update_query_bind(value: Self::UpdateForQuery, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        ...
        for element in value.create {
            if let Err(error) = query.try_bind(sqlx::types::Json(AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery::from(element))) {
                return Err(error.to_string());
            }
        }
        Ok(query)
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        ...
        for element in &value.create {
            ...
            match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(&element.field_2, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
...
impl postgresql_crud::PostgresqlType for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn create_query_bind(value: Self::Create, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        if let Err(error) = query.try_bind(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value)) {
            return Err(error.to_string());
        }
        Ok(query)
    }
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(value, query)
    }
}
#[cfg(feature = "test-utils")]
impl postgresql_crud::PostgresqlJsonTypeTestCases for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create>> {
        Some({
            let mut acc = vec![];
            if let Some(vec_create) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create() {
                ...
                let option_additional = {
                    ...
                    for element in &vec_create {
                        if option_additional.is_none() {
                            let value = AnimalWithIdAsNotNullJsonbObjectWithIdCreate::new(element.clone());
                            option_additional = Some((VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate::new(vec![value.clone()]), VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate::new(vec![value.clone(), value])));
                        } else {
                            break;
                        }
                    }
                ...
                for element in vec_create {
                    inner_acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdCreate::new(element));
                }
                {
                    let value = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate::new(inner_acc);
                    if !acc.contains(&value) {
                        acc.push(value);
                    }
                }
    ...
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        read_only_ids
            ...
            .map(|element0| {
                let mut acc = vec![];
                for element1 in <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&element0.0.value.field_2.clone()) {
                    for element2 in element1 {
                        acc.push(vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                            id: Some(postgresql_crud::Value { value: element0.0.value.id.0.value.clone() }),
                            field_2: Some(postgresql_crud::Value { value: element2 }),
                        }]);
                    }
                }
                acc
    ...
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
    ...
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update {
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::try_new(
            vec![],
            postgresql_crud::UniqueVec::<AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement>::try_new(
                value
                    .into_iter()
                    .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                        ...
                        fields: <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(AnimalAsNotNullJsonbObjectReadInner { field_2: element.field_2 }),
                    })
                    .collect(),
            )
    ...
    fn read_only_ids_into_option_value_read_inner(value: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        Some(postgresql_crud::Value {
            value: value.0.value.into_iter().fold(vec![], |mut acc, element| {
                acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                    ...
                    field_2: match <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_into_option_value_read_inner(element.0.value.field_2) {
                        Some(value) => Some(value),
                        None => Some(postgresql_crud::Value {
                            value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(
                                <<postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
            ...
            value: value
                ...
                .map(|element| {
                    ...
                    for element1 in element.fields.0.to_vec() {
                        match &element1 {
                            AnimalAsNotNullJsonbObjectUpdateElement::Field2(value) => {
                                field_2 = Some(value.value.clone());
                            }
                        }
                    }
                    AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds(postgresql_crud::Value {
                        value: AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIdsHandle {
                            ...
                            field_2: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&field_2.expect("expect a3ec7cae-94a0-49c1-b5d1-88f7b2a3dd1d")),
                        },
                    })
                })
                .collect(),
    ...
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead::new({
                let mut acc = value
                    .0
                    .value
                    .clone()
                    .into_iter()
                    .map(|element| {
                        AnimalWithIdAsNotNullJsonbObjectWithIdRead::try_new(
                            ...
                            <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&element.0.value.field_2),
                        )
                        .expect("error 8f6fb6b6-6e84-4819-b9c6-526d39e1ac88")
                    })
                    .collect::<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdRead>>();
                acc.sort_by(|a, b| {
            ...
            Some(value) => VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead({
                ...
                for update_element in value.update.into_vec() {
                    ...
                    acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                        ...
                        field_2: Some(postgresql_crud::Value {
                            value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(found_read_element.field_2.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").value, field_2),
                        }),
                    });
                }
                acc
    ...
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead::new({
            ...
            let mut acc = vec![];
            for (read_only_ids, create) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>() {
                acc.push(
                    AnimalWithIdAsNotNullJsonbObjectWithIdRead::try_new(
                        ...
                        <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.0.value.field_2, create.field_2),
                    )
    ...
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create),
        })
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration {
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration::new({
            assert_eq!(read_only_ids.0.value.len(), create.0.len(), "error 7776a146-06a8-4972-8e16-371d41ee164c");
            let mut acc = vec![];
            for (read_only_ids, create) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>() {
                acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration::new(
                    <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids.0.value.id, postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
                    <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids.0.value.field_2, create.field_2),
                ));
            }
    ...
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement {
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::Equal(postgresql_crud::PostgresqlJsonTypeWhereElementEqual {
            logical_operator: postgresql_crud::LogicalOperator::And,
            value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration::new({
                let mut acc = vec![];
                for (read_only_ids, create) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>() {
                    acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration::new(
                        <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids.0.value.id, postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        vec![VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::Equal(postgresql_crud::PostgresqlJsonTypeWhereElementEqual {
            logical_operator: postgresql_crud::LogicalOperator::And,
            value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration::new({
                let mut acc = vec![];
                for (read_only_ids, create) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>() {
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(
        read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds,
        create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create,
        ...
        //here
        let mut acc = vec![];
        for (index, (read_only_ids, create)) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>().into_iter().enumerate() {
            if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids.0.value.field_2.clone(), create.field_2.clone()) {
                println!("%%% {acc:#?}");
                for element in value.clone() {
                    // acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 1f7ae335-461f-4215-8fb5-ee7cf2f32881")));
                    //
                    let handle = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 1f7ae335-461f-4215-8fb5-ee7cf2f32881"));
                    //
                    if !acc.contains(&handle) {
                        acc.push(handle);
                    }
                }
                let whole = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error 79634838-847d-4eeb-b199-4927d57b2e2c"));
                if !acc.contains(&whole) {
                    acc.push(whole);
                }
            }
            acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::DimensionOneEqual(postgresql_crud::PostgresqlJsonTypeWhereElementDimensionOneEqual {
                logical_operator: postgresql_crud::LogicalOperator::And,
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(
        ...
        let mut acc = vec![];
        for (index, (read_only_ids, create)) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>().into_iter().enumerate() {
            if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids.0.value.field_2.clone(), create.field_2.clone()) {
                for element in value.clone() {
                    acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 1f7ae335-461f-4215-8fb5-ee7cf2f32881")));
                }
                let whole = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error 79634838-847d-4eeb-b199-4927d57b2e2c"));
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(
        ...
        let mut acc = vec![];
        for (index, (read_only_ids, create)) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>().into_iter().enumerate() {
            if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids.0.value.field_2.clone(), create.field_2.clone()) {
                for element in value.clone() {
                    acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 1f7ae335-461f-4215-8fb5-ee7cf2f32881")));
                }
                let whole = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error 79634838-847d-4eeb-b199-4927d57b2e2c"));
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(
        ...
        let mut acc = vec![];
        for (index, (read_only_ids, create)) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()).collect::<std::vec::Vec<(AnimalWithIdAsNotNullJsonbObjectWithIdReadOnlyIds, AnimalWithIdAsNotNullJsonbObjectWithIdCreate)>>().into_iter().enumerate() {
            if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids.0.value.field_2.clone(), create.field_2.clone()) {
                for element in value.clone() {
                    acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 1f7ae335-461f-4215-8fb5-ee7cf2f32881")));
                }
                let whole = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error 79634838-847d-4eeb-b199-4927d57b2e2c"));
    ...
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        let mut acc = vec![];
        for (index, create) in create.0.clone().into_iter().into_iter().enumerate() {
            if let Some(value) = <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create.field_2) {
                for element in value.clone() {
                    acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("error 955c6c27-863d-4b9b-9d88-e71f11161b3e")));
                }
                let whole = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::ElementField2(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, value).expect("error 6ee7a510-c8be-41f5-8fe5-505893eca3cc"));
                if !acc.contains(&whole) {
                    acc.push(whole);
                }
            }
        }
        acc.push(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhereElement::LengthEqual(postgresql_crud::PostgresqlJsonTypeWhereElementLengthEqual {
            logical_operator: postgresql_crud::LogicalOperator::And,
            value: postgresql_crud::UnsignedPartOfStdPrimitiveI32::try_from(std::primitive::i32::try_from(create.0.len()).expect("error 1fbbd897-2fae-4271-9fac-4b4007aecf32")).expect("error 0eb5d915-bbbe-44c0-9096-d3d858d3a937"),
        }));
        Some(acc)
    }
}
...
impl postgresql_crud::PostgresqlTypeTestCases for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    type Select = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdSelect;
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create()
    }
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadInner>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&read_only_ids)
    }
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_read_with_new_or_try_new_unwraped(value)
    }
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(value)
    }
    fn update_to_read_only_ids(value: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(value)
    }
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value)
    }
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read, option_update: std::option::Option<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update>) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(read, option_update)
    }
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::TableTypeDeclaration {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_option_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids, create))
    }
    fn create_into_postgresql_type_option_vec_where_element_dimension_one_equal(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        None
    }
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids, create)
    }
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
impl postgresql_crud::PostgresqlTypeNotPrimaryKey for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    type PostgresqlType = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId;
    type Create = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate;
}
#[derive(Debug)]
pub struct OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId;
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration(std::option::Option<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration>);
impl OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration {
    pub fn new(value: std::option::Option<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration>>) -> Self {
        Self(match value {
            Some(value) => Some(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration::new(value)),
            None => None,
        })
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
pub struct OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate(std::option::Option<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate>);
impl OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate {
    pub fn new(value: std::option::Option<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>>) -> Self {
        Self(match value {
            Some(value) => Some(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdCreate::new(value)),
            None => None,
        })
    }
}
...
impl sqlx::Encode<'_, sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize)]
pub struct OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery(std::option::Option<<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::CreateForQuery>);
impl std::convert::From<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn from(value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate) -> Self {
        Self(match value.0 {
            Some(value) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value)),
            None => None,
        })
    }
}
impl sqlx::Encode<'_, sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <sqlx::types::Json<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery> as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
        <sqlx::types::Json<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery> as sqlx::Type<sqlx::Postgres>>::compatible(ty)
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdSelect {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size() -> Self {
        Self(Some(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()))
    }
}
...
impl OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead {
    fn into_inner(self) -> OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner {
        match self.0 {
            Some(value) => Some(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead::into_inner(value)),
            None => None,
        }
    }
}
impl OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead {
    pub fn new(value: std::option::Option<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdRead>>) -> Self {
        Self(match value {
...
impl sqlx::Encode<'_, sqlx::Postgres> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&sqlx::types::Json(self), buf)
    }
}
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize)]
pub struct OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateForQuery(std::option::Option<<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::UpdateForQuery>);
impl OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateForQuery {
    fn select_only_updated_ids_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(match &self.0 {
            Some(value) => format!(
                "jsonb_build_object('value',{})",
                match VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdateForQuery::select_only_updated_ids_query_part(&value, &column_name_and_maybe_field_getter, increment) {
                    Ok(value) => value,
                    Err(error) => {
                        return Err(error);
                    }
...
impl std::convert::From<<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Update> for <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::UpdateForQuery {
    fn from(value: <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Update) -> Self {
        Self(match value.0 {
            Some(value) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::UpdateForQuery::from(value)),
            None => None,
        })
    }
}
impl postgresql_crud::PostgresqlJsonType for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    type CreateForQuery = OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreateForQuery;
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!(
            "jsonb_build_object('value',case when jsonb_typeof({column_name_and_maybe_field_getter})='null' then 'null'::jsonb else {} end)",
            <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(column_name_and_maybe_field_getter),
        )
    }
    ...
    type UpdateForQuery = OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateForQuery;
    fn update_query_part(value: &Self::UpdateForQuery, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match &value.0 {
    ...
    fn select_only_created_ids_query_bind<'a>(value: &'a Self::CreateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        if let Some(value) = &value.0 {
            match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(&value, query) {
                Ok(value) => {
                    query = value;
                }
                Err(error) => {
...
impl postgresql_crud::PostgresqlType for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn create_query_bind(value: Self::Create, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        if let Err(error) = query.try_bind(<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value)) {
            return Err(error.to_string());
        }
        Ok(query)
    }
    ...
    fn update_query_bind<'a>(value: Self::UpdateForQuery, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::update_query_bind(value, query)
    }
    fn select_only_updated_ids_query_part(value: &Self::UpdateForQuery, column: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match value.select_only_updated_ids_query_part(&column, increment) {
            Ok(value) => Ok(format!("jsonb_build_object('value',{}) as {column},", value)),
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(value, query)
    }
}
#[cfg(feature = "test-utils")]
impl postgresql_crud::PostgresqlJsonTypeTestCases for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create>> {
        Some({
            let mut acc = vec![];
            if let Some(value) = <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create() {
                for element in value {
                    let value = <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Create::new(Some(element.0));
                    if !acc.contains(&value) {
                        acc.push(value);
                    }
                }
            ...
            {
                let value = <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::Create::new(None);
                if !acc.contains(&value) {
                    acc.push(value);
                }
            }
    ...
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        let mut acc = vec![];
        if let Some(value) = &read_only_ids.0.value {
            for element0 in <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&value) {
                for element1 in element0 {
                    acc.push(vec![Some(element1)]);
                }
            }
    ...
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Read::new(match value {
            Some(value) => Some(
                value
                    .into_iter()
                    .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                        ...
                        field_2: match &element.field_2 {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_read_with_new_or_try_new_unwraped(value.value.clone()),
                            }),
                            None => None,
                        },
                    })
    ...
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Update::new(match value {
            Some(value) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(value)),
            None => None,
        })
    }
    fn read_only_ids_into_option_value_read_inner(value: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        Some(postgresql_crud::Value {
            value: match value.0.value {
                Some(value) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_into_option_value_read_inner(value) {
                    Some(value) => Some(value.value),
                    None => None,
                },
                None => None,
    ...
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead::new(match &value.0.value {
                Some(value) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value) {
    ...
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read, option_update: std::option::Option<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update>) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        match option_update {
            Some(value) => OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead(match value.0 {
                Some(value) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(
                    match read.0 {
                        Some(value) => value,
                        None => postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
                    },
    ...
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead::new(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(
                <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids, create)
                    .expect("error 56ac4450-0feb-4ea7-aca7-6f51c8f4893c")
                    .value
                    .0,
            ),
            (Some(_), None) => panic!("error 75be9ae0-ca9f-4251-bfff-2156a90b10c6"),
    ...
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create),
        })
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration {
        OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdTableTypeDeclaration::new(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids, create).0),
            (Some(_), None) => panic!("error 9349dcd5-3ed3-4157-b1ef-14c51d55262f"),
            (None, Some(_)) => panic!("error 45f8e70a-ffca-41b6-ac70-96f101ac3c80"),
            (None, None) => None,
        })
    ...
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement {
        postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec![<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids, create)]).expect("error 9f550fbd-2d60-4a8a-a67b-ab49f728c9d0")),
            (Some(_), None) => panic!("error 49e4c289-b37d-4365-96e3-5d896d6860f7"),
            (None, Some(_)) => panic!("error ad71caa2-2503-4f9a-952c-e796abf5bbbe"),
            (None, None) => None,
        })
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        vec![postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)).expect("error 9f550fbd-2d60-4a8a-a67b-ab49f728c9d0")),
            (Some(_), None) => panic!("error 49e4c289-b37d-4365-96e3-5d896d6860f7"),
            (None, Some(_)) => panic!("error ad71caa2-2503-4f9a-952c-e796abf5bbbe"),
            (None, None) => None,
        })]
    ...
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(
        read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds,
        create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create,
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 66644d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 77744d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 88844d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(
        ...
        match (read_only_ids.0.value, create.0) {
            (Some(read_only_ids), Some(create)) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids, create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 99944d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
    ...
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement>> {
        match create.0 {
            Some(create) => match <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create) {
                Some(value) => {
                    if value.is_empty() {
                        None
                    } else {
                        Some({
                            ...
                            let whole = postgresql_crud::NullableJsonObjectPostgresqlTypeWhereFilter(Some(postgresql_crud::NotEmptyUniqueEnumVec::try_new(value).expect("error 100044d4e9b2-12e2-44c4-8c67-88cb7b8465ce")));
                            if !acc.contains(&whole) {
                                acc.push(whole);
                            }
                            acc
...
impl postgresql_crud::PostgresqlTypeTestCases for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    type Select = OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdSelect;
    fn option_vec_create() -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::option_vec_create()
    }
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadInner>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&read_only_ids)
    }
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_read_with_new_or_try_new_unwraped(value)
    }
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped(value)
    }
    fn update_to_read_only_ids(value: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(value)
    }
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value)
    }
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read, option_update: std::option::Option<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Update>) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::previous_read_merged_with_option_update_into_read(read, option_update)
    }
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::Read>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::TableTypeDeclaration {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_where_element_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_option_vec_where_element_equal_to_json_field(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        Some(<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_element_equal_to_json_field(read_only_ids, create))
    }
    fn create_into_postgresql_type_option_vec_where_element_dimension_one_equal(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        None
    }
    ...
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal(read_only_ids, create)
    }
    fn read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal(read_only_ids, create)
    }
    fn create_into_postgresql_json_type_option_vec_where_element_length_more_than(create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::option::Option<std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement>> {
        <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::create_into_postgresql_json_type_option_vec_where_element_length_more_than(create)
    }
}
impl postgresql_crud::PostgresqlTypeNotPrimaryKey for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    type PostgresqlType = OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId;
    type Create = OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdCreate;
}
