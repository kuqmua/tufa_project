            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    let some_value_read_only_ids_returned_from_create_one = Some(postgresql_crud::Value {
                        value: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(common_read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    });
                    assert_eq!(
                        super::ExampleRead {
                        ...
                        super::Example::try_read_one(
                            ...
                            super::ExampleReadOneParameters {
                                payload: super::ExampleReadOnePayload {
                                    primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(common_read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    ...
                    assert_eq!(
                        ...
                        <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(common_read_only_ids_returned_from_create_one.primary_key_column.clone()),
                    ...
                    let start = std::time::Instant::now();
                    {
                        futures::StreamExt::for_each_concurrent(
                            futures::stream::iter({
                                ...
                                for chunk in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::create_vec()
                                    .chunks(10)
                                        ...
                                        assert_eq!(
                                            {
                                                ...
                                                for (read_only_ids, create) in read_only_ids_from_try_create_many.clone().into_iter().zip(ident_create_vec.into_iter()).collect::<std::vec::Vec<(super::ExampleReadOnlyIds, super::ExampleCreate)>>() {
                                                    acc.push(super::ExampleRead {
                                                        ...
                                                        column_154: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_154.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), create.column_154),
                                                    });
                                                }
                                                acc.sort_by(|a, b| {
                                                                        ...
                                                                        for element in &read_only_ids_from_try_create_many {
                                                                            acc.push(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                                ...
                                                                                value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead::new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::into_inner(
                                                                                    <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(element.primary_key_column.clone()),
                                                                                )),
                                                                            }));
                                                                        }
                                                                        acc
                                        ...
                                        assert_eq!(
                                            read_only_ids_from_try_delete_many,
                                            {
                                                let mut acc = read_only_ids_from_try_create_many
                                                    .into_iter()
                                                    .map(|element| <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(element.primary_key_column.clone()))
                                                            ...
                                                            Some(
                                                                postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                                    ...
                                                                    for element in &read_only_ids_from_try_delete_many {
                                                                        acc.push(postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlWhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                            logical_operator: postgresql_crud::LogicalOperator::Or,
                                                                            value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead::new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::into_inner(element.clone())),
                                                                        }));
                                                                    }
                                                                    acc
                                                                })
                            ...
                            futures::stream::iter({
                                ...
                                for element in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                                    ...
                                    acc.push(futures::FutureExt::boxed(async move {
                                        ...
                                        assert_eq!(
                                            super::ExampleRead {
                                                primary_key_column: Some(postgresql_crud::Value {
                                                    value: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_from_try_create_one.primary_key_column.clone())
                                                }),
                                                column_154: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_154.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_154)
                                            },
                                            super::Example::try_read_one(
                                                &url_cloned,
                                                super::ExampleReadOneParameters {
                                                    payload: super::ExampleReadOnePayload {
                                                        primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_from_try_create_one.primary_key_column.clone()),
                                                        select: select_default_all_with_max_page_size_cloned.clone()
                                                    }
                                                }
                                            )
                                        ...
                                        assert_eq!(
                                            read_only_ids_from_try_delete_one,
                                            <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_from_try_create_one.primary_key_column.clone()),
                    ...
                    let create_one_elapsed = start.elapsed();
                    {
                                            ...
                                            Some(
                                                postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                    ...
                                                    for _ in 1..=length {
                                                        acc.push(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                            logical_operator: postgresql_crud::LogicalOperator::Or,
                                                            value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead::new(uuid::Uuid::new_v4()),
                                                        }));
                                                    }
                                                    acc
                                                })
                        ...
                        //                                         Some(
                        //                                             postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                        //                                                 vec![<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                        //                                                     logical_operator: postgresql_crud::LogicalOperator::Or,
                        //                                                     value: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(
                                                            ...
                                                            payload: super::ExampleUpdateManyPayload::try_new({
                                                                ...
                                                                acc.push(
                                                                    super::ExampleUpdate::try_new(
                                                                        <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Update::from(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_update(read_only_ids_current_element.primary_key_column.clone())),
                                                ...
                                                assert_eq!(
                                                    {
                                                        vec![super::ExampleRead {
                                                            primary_key_column: Some(postgresql_crud::Value {
                                                                value: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_current_element.primary_key_column.clone()),
                                                            }),
                                                            column_154: Some(postgresql_crud::Value {
                                                                value: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(
                                                                    <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(
                                                                        &read_only_ids_current_element.column_154.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129"),
                                                                    )
                                                                        ...
                                                                        primary_key_column: Some(
                                                                            postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                                                ...
                                                                                acc.push(postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlWhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                                    logical_operator: postgresql_crud::LogicalOperator::Or,
                                                                                    value: postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresqlRead::new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::into_inner(
                                                                                        <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_current_element.primary_key_column.clone()),
                                                                                    )),
                                                                                }));
                                                                                acc
                                                                            })
                                            ...
                                            acc.push(futures::FutureExt::boxed(async move {
                                                ...
                                                assert_eq!(
                                                    ...
                                                    super::Example::try_read_one(
                                                        ...
                                                        super::ExampleReadOneParameters {
                                                            payload: super::ExampleReadOnePayload {
                                                                primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_current_element.primary_key_column.clone()),
                                                                select: select_default_all_with_max_page_size_cloned
                                                            }
                                                        }
                                                    )
                                                ...
                                                primary_key_column: Some(
                                                    postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                        ...
                                                        for element in &read_only_ids_from_try_create_many {
                                                            acc.push(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                logical_operator: postgresql_crud::LogicalOperator::Or,
                                                                value: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(element.primary_key_column.clone()).into(),
                                                            }));
                                                        }
                                                        acc
                                                    })
                    ...
                    let delete_many_elapsed = start.elapsed();
                    {
                        ...
                        assert_eq!(
                            super::ExampleRead {
                                primary_key_column: Some(postgresql_crud::Value {
                                    value: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_returned_from_create_one.primary_key_column.clone())
                                }),
                                column_154: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_154.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create_default.column_154)
                            },
                            super::Example::try_read_one(
                                &url,
                                super::ExampleReadOneParameters {
                                    payload: super::ExampleReadOnePayload {
                                        primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypePrimaryKey>::into_read(read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                        select: select_default_all_with_max_page_size.clone()
                                    }
                                }
                            )
...
pub struct AnimalAsNotNullJsonbObjectCreateForQuery {
    ...
    field_1: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::CreateForQuery,
}
impl std::convert::From<AnimalAsNotNullJsonbObjectCreate> for AnimalAsNotNullJsonbObjectCreateForQuery {
    fn from(value: AnimalAsNotNullJsonbObjectCreate) -> Self {
        Self {
            ...
            field_1: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value.field_1),
        }
    }
}
        ...
        for element in self.0.to_vec() {
            acc.push_str(&format!(
                ...
                match element {
                    ...
                    AnimalAsNotNullJsonbObjectSelectElement::Field1(value) => <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_1", &column_name_and_maybe_field_getter, &column_name_and_maybe_field_getter_for_error_message, false,),
                }
            ));
        }
        let _ = acc.pop();
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for AnimalAsNotNullJsonbObjectSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_with_max_page_size() -> std::vec::Vec<Self> {
        vec![
            AnimalAsNotNullJsonbObjectSelectElement::Field0(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
            AnimalAsNotNullJsonbObjectSelectElement::Field1(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
        ]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_with_max_page_size() -> std::vec::Vec<Self> {
        vec![
            ...
            AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field1(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
        ]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
    ...
    fn into_inner(self) -> AnimalAsNotNullJsonbObjectReadInner {
        AnimalAsNotNullJsonbObjectReadInner {
            ...
            field_1: match self.field_1 {
                Some(value) => Some(postgresql_crud::Value {
                    value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(value.value),
                }),
                None => None,
            },
        }
    ...
    fn select_only_updated_ids_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in self.0.to_vec() {
            match &element {
                ...
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field1(value) => match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_1", &column_name_and_maybe_field_getter, increment) {
                    Ok(mut value) => {
                        let _ = value.pop();
                        acc.push_str(&format!("jsonb_build_object({})||", value));
                    }
...
pub enum AnimalAsNotNullJsonbObjectUpdateForQueryElement {
    ...
    #[serde(rename(serialize = "field_1", deserialize = "field_1"))]
    Field1(postgresql_crud::Value<<postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::UpdateForQuery>),
}
impl std::convert::From<AnimalAsNotNullJsonbObjectUpdateElement> for AnimalAsNotNullJsonbObjectUpdateForQueryElement {
    fn from(value: AnimalAsNotNullJsonbObjectUpdateElement) -> Self {
        match value {
            ...
            AnimalAsNotNullJsonbObjectUpdateElement::Field1(value) => AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field1(postgresql_crud::Value {
                value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::UpdateForQuery::from(value.value),
            }),
        }
    }
}
...
impl postgresql_crud::PostgresqlJsonType for AnimalAsNotNullJsonbObject {
    ...
    fn update_query_part(value: &Self::UpdateForQuery, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            match element {
                ...
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field1(value) => match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::update_query_part(&value.value, &std_option_option_object_acc, &generate_jsonb_set_target("field_1"), "field_1", increment) {
                    Ok(value) => {
                        std_option_option_object_acc = value;
                    }
                    Err(error) => {
    ...
    fn update_query_bind(value: Self::UpdateForQuery, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        for element in value.0.into_vec() {
            match element {
                ...
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field1(value) => match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::update_query_bind(value.value, query) {
                    Ok(value) => {
                        query = value;
                    }
                    Err(error) => {
    ...
    fn select_only_updated_ids_query_bind<'a>(value: &'a Self::UpdateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        for element in value.0.to_vec() {
            match element {
                ...
                AnimalAsNotNullJsonbObjectUpdateForQueryElement::Field1(value) => match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(&value.value, query) {
                    Ok(value) => {
                        query = value;
                    }
                    Err(error) => {
    ...
    fn select_only_created_ids_query_part(value: &Self::CreateForQuery, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(format!("'{field_ident}',jsonb_build_object('value',{}),", {
            ...
            match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_part(&value.field_1, &"field_1", &format!("{column_name_and_maybe_field_getter}->'field_1'"), increment) {
                Ok(mut value) => {
                    let _ = value.pop();
                    acc.push_str(&format!("jsonb_build_object({})||", value));
                }
    ...
    fn select_only_created_ids_query_bind<'a>(value: &'a Self::CreateForQuery, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
        ...
        match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(&value.field_1, query) {
            Ok(value) => {
                query = value;
            }
            Err(error) => {
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn read_inner_vec_vec(read_only_ids: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        ...
        for element0 in <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_vec_vec(&read_only_ids.0.value.field_0) {
            for element1 in element0 {
                ...
                acc.push(vec![AnimalAsNotNullJsonbObjectReadInner { field_0: field_0_current.clone(), field_1: field_1_last.clone() }]);
            }
        }
        for element0 in <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_inner_vec_vec(&read_only_ids.0.value.field_1) {
            for element1 in element0 {
                let field_1_current = Some(postgresql_crud::Value { value: element1 });
                field_1_last = field_1_current.clone();
                acc.push(vec![AnimalAsNotNullJsonbObjectReadInner { field_0: field_0_last.clone(), field_1: field_1_current.clone() }]);
            }
        }
        drop(field_0_last);
        drop(field_1_last);
    ...
    fn read_new_or_try_new_unwraped_for_test(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        <Self::PostgresqlJsonType as postgresql_crud::PostgresqlType>::Read::try_new(
            match value.field_0 {
                Some(value) => Some(postgresql_crud::Value {
            ...
            match value.field_1 {
                Some(value) => Some(postgresql_crud::Value {
                    value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value),
                }),
                None => None,
            },
        )
            ...
            postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                ...
                if let Some(value) = value.field_1 {
                    acc.push(AnimalAsNotNullJsonbObjectUpdateElement::Field1(postgresql_crud::Value {
                        value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(value.value),
                    }));
                }
                acc
            })
        ...
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadInner {
                ...
                field_1: match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(value.0.value.field_1) {
                    Some(value) => Some(value),
                    None => Some(postgresql_crud::Value {
                        value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(
                            <<postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
                        ),
                    }),
                },
            },
    ...
    fn update_to_read_only_ids(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Update) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds {
        ...
        AnimalAsNotNullJsonbObjectReadOnlyIds(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadOnlyIdsHandle {
                field_0: field_0.expect("expect 106f16f2-ae03-48b3-9239-f4b1b60746d5"),
                field_1: field_1.expect("expect 106f16f2-ae03-48b3-9239-f4b1b60746d5"),
            },
        })
    }
    fn read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value: &<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read>> {
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectRead::try_new(
                <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&value.0.value.field_0),
                <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&value.0.value.field_1),
            )
        ...
        match option_update {
            Some(value) => {
                ...
                AnimalAsNotNullJsonbObjectRead {
                    ...
                    field_1: Some(postgresql_crud::Value {
                        value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(read.field_1.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").value, field_1),
                    }),
                }
            }
            None => read,
    ...
    fn create_vec() -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create> {
        ...
        for element in <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::create_vec() {
            acc.push(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Create::new(element, postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()));
        }
        for element in <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::create_vec() {
            acc.push(<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Create::new(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(), element));
        }
        acc
    }
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Read {
        AnimalAsNotNullJsonbObjectRead::try_new(
            ...
            <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.0.value.field_1, create.field_1),
        )
    ...
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds, create: <Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Create) -> std::vec::Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::WhereElement> {
        todo!()
    }
}
#[cfg(feature = "test-utils")]
impl postgresql_crud::PostgresqlTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud::PostgresqlType>::Create) -> std::vec::Vec<<Self::PostgresqlType as postgresql_crud::PostgresqlType>::WhereElement> {
