        ...
        std::thread::Builder::new()
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    //         for chunk in <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::create_vec().chunks(10).map(|element| element.to_vec()).collect::<std::vec::Vec<std::vec::Vec<<postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlType>::Create>>>() {
                    ...
                    //                         acc.push(super::ExampleCreate { column_47: element });
                    //                     }
                    //                     acc
                    //                 };
                    ...
                    //     futures::stream::iter({
                    //         let mut acc: std::vec::Vec<futures::future::BoxFuture<'static, ()>> = vec![];
                    //         for element in <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::create_vec() {
                    //             let url_cloned = url.clone();
                    //             let select_default_all_cloned = select_default_all.clone();
                    //             acc.push(futures::FutureExt::boxed(async move {
                    //                 let ident_create = super::ExampleCreate { column_47: element };
                    ...
                    //                 assert_eq!(super::ExampleRead { primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_from_try_create_one.primary_key_column.clone().into_read() }), column_47: <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_47, ident_create.column_47) }, super::Example::try_read_one(&url_cloned, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_from_try_create_one.primary_key_column.clone().into_read(), select: select_default_all_cloned.clone() } }).await.expect("error 35141faa-387c-4302-aa7a-c529966f974b"), "try_read_one result different after try_create_one");
                    ...
                    //                 let mut acc = vec![];
                    //                 if let Some(value) = &common_read_only_ids_returned_from_create_one.column_47 {
                    //                     for element in <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_inner_vec_vec(&value) {
                    //                         for _ in element {
                    ...
                    //                 println!("PostgresqlTypeTestCases read_inner_vec_vec is empty for column_47");
                    //             } else {
                    ...
                    //                                 column_47: match &element.column_47 {
                    //                                     Some(value) => <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&value),
                    ...
                    //                             for element_0 in <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_inner_vec_vec(&read_only_ids_current_element.column_47.clone().expect("error c4d98a71-f30f-410e-b410-a75f4672f2f7")) {
                    ...
                    //                             {
                    //                                 let mut acc = vec![];
                    //                                 acc.push(super::ExampleReadOnlyIds { primary_key_column: read_only_ids_current_element.primary_key_column.clone(), column_47: Some(<postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)) });
                    //                                 acc
                    //                             },
                    ...
                    //                         );
                    //                         assert_eq!(
                    //                             { vec![super::ExampleRead { primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_current_element.primary_key_column.clone().into_read() }), column_47: Some(postgresql_crud::Value { value: <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(<postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_47.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129")).expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5").value, Some(update.clone())) }) }] },
                    //                             {
                    //                                 let mut acc = super::Example::try_read_many(
                    //                                     &url_cloned,
                    //                                     super::ExampleReadManyParameters {
                                ...
                                if read_inner_vec_vec_acc.is_empty() {
                                    ...
                                    for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(super::ExampleReadOnlyIds { primary_key_column: read_only_ids_current_element.primary_key_column.clone(), column_47: Some(<postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)) }, super::Example::try_update_one(&url_cloned, super::ExampleUpdateOneParameters { payload: super::ExampleUpdate::try_new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Update::from(read_only_ids_current_element.primary_key_column.clone().into_read()), Some(postgresql_crud::Value { value: update.clone() })).expect("error 0e5d65a5-12c8-4c48-a24c-0f1fe376ada2") }).await.expect("error d2de0bd6-1b01-4ef2-b074-a60878241b52"), "try_update_one result different");
                                            

                                            let expected = super::ExampleRead { primary_key_column: Some(postgresql_crud::Value { value: read_only_ids_current_element.primary_key_column.clone().into_read() }), column_47: Some(postgresql_crud::Value { value: <postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(<postgresql_crud::VecOfStdStringStringAsNotNullArrayOfNotNullText as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_47.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129")).expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5").value, Some(update.clone())) }) };

                                            let db = super::Example::try_read_one(
                                                &url_cloned,
                                            ...
                                            assert_eq!(expected, db, "try_read_one result different after try_create_one");
                                        }));
                                    }
                                }
                            }
