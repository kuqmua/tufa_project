                                        ...
                                        let update = crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::try_new(
                                            {
                                                let f = vec![
                                                    crate::repositories_types::server::routes::api::example::AnimalWithIdAsNotNullJsonbObjectWithIdCreate::new(
                                                        //todo make it Create
                                                        postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumberOrigin::new(42)
                                                    )
                                                ];
...
//                 match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_part(
//                     &value.field_0,
//                     &"field_0",
...
//                 acc.push(AnimalAsNotNullJsonbObjectReadInner { field_0: field_0_current.clone() });
//             }
//         }
//         drop(field_0_last);
//         vec![acc]
...
//     }
//     fn select_only_updated_ids_query_part(&self, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
//         let create_for_query_vec = {
//             let mut acc = vec![];
//             for element in &self.create {
//                 acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery::from(element.clone()));
//             }
//             acc
//         };
//         Ok(format!(
...
//                         match &element {
//                             AnimalAsNotNullJsonbObjectUpdateElement::Field0(value) => match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_0", &"elem", increment) {
//                                 Ok(mut value) => {
//                                     let _ = value.pop();
//                                     current_acc.push_str(&format!("jsonb_build_object({})||", value));
//                                 }
...
//                 }
//                 //
//                 for element in &create_for_query_vec {
//                     //here2222
//                     // let s = format!(
//                     //     "jsonb_build_object('id', '{}', 'field_0', 'null'::jsonb)||",
...
//                     //     }
//                     // }
//                     // std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreate>
//                     match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_part(
//                         &element.id,
//                         &"id",
//                         &column_name_and_maybe_field_getter,
//                         increment
...
//                     }
//                 }
//                 for _ in &create_for_query_vec {
//                     //here2222
//                     // println!("@@@@@@@@ {element:#?}");
//                     // let element_create_for_query = AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery::from(element.clone());
//                     // println!("$$$$$$$$ {element_create_for_query:#?}");
//                     // // acc.push_str(&format!("jsonb_build_object({})||", value));
//                     // let s = format!(
//                     //     "jsonb_build_object('id', '{}', 'field_0', 'null'::jsonb)||",
//                     //     element_create_for_query.id.get_inner(),
//                     //     // <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumberRead::new(element_create_for_query.field_0.0))
//                     // );
//                     // println!("sssssssssss {s:#?}");
//                     //here
...
//         }
//         //here
//         // let create_for_query_vec = value.create.clone().into_iter().map(|element|{
//         //     AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery::from(element)
//         // }).collect::<std::vec::Vec<AnimalWithIdAsNotNullJsonbObjectWithIdCreateForQuery>>();
//         // for element in create_for_query_vec {
//         //     let id = element.id.clone();
//         //     match <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(
//         //         &id,
//         //         query
//         //     ) {
//         //         Ok(value) => {
...
//         //         }
//         //     }
//         //     // match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_bind(
//         //     //     &element.field_0,
//         //     //     query
//         //     // ) {
//         //     //     Ok(value) => {
...
//             Some(value) => format!(
//                 "jsonb_build_object('value',{})",
//                 match VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::select_only_updated_ids_query_part(&value, &column_name_and_maybe_field_getter, increment) {
//                     Ok(value) => value,
//                     Err(error) => {
//                         return Err(error);
//                     }
...
impl postgresql_crud::PostgresqlJsonType for AnimalAsNotNullJsonbObject {
    ...
    fn select_only_created_ids_query_part(value: &Self::CreateForQuery, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        Ok(format!("'{field_ident}',jsonb_build_object('value',{}),", {
            let mut acc = std::string::String::new();
            match <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_created_ids_query_part(&value.field_0, &"field_0", &column_name_and_maybe_field_getter, increment) {
                Ok(value) => {
                    acc.push_str(&format!("jsonb_build_object({})||", value));
                }
                Err(error) => {
...
impl postgresql_crud::PostgresqlType for AnimalAsNotNullJsonbObject {
    ...
    fn select_only_updated_ids_query_part(value: &Self::UpdateForQuery, column: &std::primitive::str, increment: &mut std::primitive::u64, _: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match value.select_only_updated_ids_query_part(&column, increment) {
            Ok(value) => Ok(format!("jsonb_build_object('value',{}) as {column},", value)),
            Err(error) => Err(error),
        }
