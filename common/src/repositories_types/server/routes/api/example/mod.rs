...
impl ExampleWhereMany {
    pub fn try_new(
        ...
        if let (None, None) = (&column_6e88acb0_c566_4fef_8a09_66a41338cf36, &animal_as_not_null_jsonb_object) {
            return Err(ExampleWhereManyTryNewErrorNamed::NoFiltersProvided { code_occurence: error_occurence_lib::code_occurence!() });
        }
        Ok(Self {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "animal_as_not_null_jsonb_object" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"animal_as_not_null_jsonb_object" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<postgresql_crud::postgresql_type::StdPrimitiveI64AsNotNullBigSerialInitializedByPostgresql as postgresql_crud::PostgresqlType>::WhereElement>>>(&mut __seq)? {
                        ...
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct ExampleWhereMany with 2 elements"));
                        }
                    };
                    let __field1 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::WhereElement>>>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct ExampleWhereMany with 2 elements"));
                        }
                    };
                    match ExampleWhereMany::try_new(__field0, __field1) {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field1: serde::__private::Option<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::WhereElement>>> = serde::__private::None;
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            ...
                            __Field::__field1 => {
                                ...
                                __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::PostgresqlTypeWhere<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::WhereElement>>>(
                                    &mut __map,
                                )?);
                            }
                            _ => {
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["column_6e88acb0_c566_4fef_8a09_66a41338cf36", "animal_as_not_null_jsonb_object"];
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ExampleCreateManyPayloadElement {
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ExampleCreateManyPayload(pub std::vec::Vec<ExampleCreateManyPayloadElement>);
#[derive(Debug)]
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleCreateManyPayloadElement {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ExampleCreateOnePayload {
    pub column_6e88acb0_c566_4fef_8a09_66a41338cf36: <postgresql_crud::postgresql_type::StdPrimitiveI64AsNotNullBigSerialInitializedByPostgresql as postgresql_crud::PostgresqlType>::Create,
    pub animal_as_not_null_jsonb_object: <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Create,
}
#[derive(Debug)]
pub struct ExampleCreateOneParameters {
    pub payload: ExampleCreateOnePayload,
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize)]
...
impl Example {
    pub async fn try_create_one_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let parameters = ExampleCreateOneParameters {
            payload: match serde_json::from_slice::<ExampleCreateOnePayload>(&body_bytes) {
                Ok(value) => {
                    let value = ExampleCreateOnePayload::from(value);
                    value
                }
                Err(error_0) => {
...
impl Example {
    pub async fn try_create_one(
        ...
        let payload = {
            let value = ExampleCreateOnePayload::from(parameters.payload);
            match serde_json::to_string(&value) {
                Ok(value) => value,
                Err(error_0) => {
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleCreateOnePayload {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            column_6e88acb0_c566_4fef_8a09_66a41338cf36: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
            animal_as_not_null_jsonb_object: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
...
impl Example {
    pub async fn create_one_payload_example_route_logic() -> axum::response::Response {
        let mut response = axum::response::IntoResponse::into_response(axum::Json(
            <ExampleCreateOnePayload as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        ));
        *response.status_mut() = axum::http::StatusCode::OK;
        return response;
    }
...
impl Example {
    pub async fn try_read_many_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let query_string = {
            format!("select {} from example {}", Example::generate_select_query_part(&parameters.payload.select), {
                let mut increment: std::primitive::u64 = 0;
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ExampleUpdateManyPayloadElement {
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ExampleUpdateManyPayload(pub std::vec::Vec<ExampleUpdateManyPayloadElement>);
#[derive(Debug)]
    ...
    pub async fn try_update_many_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let value = {
            ...
            let value = {
                ...
                {
                    Ok(value) => match value {
                        Some(value) => match sqlx::Row::try_get::<<postgresql_crud::postgresql_type::StdPrimitiveI64AsNotNullBigSerialInitializedByPostgresql as postgresql_crud::PostgresqlType>::Update, &std::primitive::str>(&value, "column_6e88acb0_c566_4fef_8a09_66a41338cf36") {
                            Ok(value) => Some(value),
                            Err(error_0) => {
                                drop(rows);
                                match executor.rollback().await {
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleUpdateManyPayloadElement {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            column_6e88acb0_c566_4fef_8a09_66a41338cf36: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct ExampleUpdateOnePayload {
    pub column_6e88acb0_c566_4fef_8a09_66a41338cf36: postgresql_crud::postgresql_type::StdPrimitiveI64AsNotNullBigSerialInitializedByPostgresqlUpdate,
    pub animal_as_not_null_jsonb_object: std::option::Option<postgresql_crud::Value<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Update>>,
}
#[derive(Debug)]
pub struct ExampleUpdateOneParameters {
    pub payload: ExampleUpdateOnePayload,
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize)]
...
impl Example {
    pub async fn try_update_one_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let parameters = ExampleUpdateOneParameters {
            payload: match serde_json::from_slice::<ExampleUpdateOnePayload>(&body_bytes) {
                Ok(value) => {
                    let value = ExampleUpdateOnePayload::from(value);
...
impl Example {
    pub async fn try_update_one(
        ...
        let payload = {
            let value = ExampleUpdateOnePayload::from(parameters.payload);
            match serde_json::to_string(&value) {
                Ok(value) => value,
                Err(error_0) => {
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for ExampleUpdateOnePayload {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            column_6e88acb0_c566_4fef_8a09_66a41338cf36: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
            animal_as_not_null_jsonb_object: Some(postgresql_crud::Value {
...
impl Example {
    pub async fn update_one_payload_example_route_logic() -> axum::response::Response {
        let mut response = axum::response::IntoResponse::into_response(axum::Json(
            <ExampleUpdateOnePayload as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        ));
        *response.status_mut() = axum::http::StatusCode::OK;
        return response;
    }
...
impl Example {
    pub async fn try_delete_many_route_logic(app_state: axum::extract::State<crate::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits>, request: axum::extract::Request) -> axum::response::Response {
        ...
        let query_string = format!("delete from example {} returning column_6e88acb0_c566_4fef_8a09_66a41338cf36", {
            let mut increment: std::primitive::u64 = 0;
