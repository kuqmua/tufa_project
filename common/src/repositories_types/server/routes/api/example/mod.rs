...
pub struct Example {
    ...
    // pub pg_range_time_offset_date_time_as_timestamp_tz_range_not_null: postgresql_crud::postgresql_type::postgresql_type::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTzRangeNotNull,
    // pub pg_range_time_offset_date_time_as_timestamp_tz_range_nullable: postgresql_crud::postgresql_type::postgresql_type::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTzRangeNullable,
