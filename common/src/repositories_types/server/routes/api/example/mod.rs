...
// }
// impl<'a> postgresql_crud::PostgresqlTypeWhereFilter<'a> for OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdWhereElement {
...
//     }
// }
// impl error_occurence_lib::ToStdStringString for OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdWhereElement {
//     fn to_std_string_string(&self) -> std::string::String {
//         format!("{self:?}")
//     }
// }
// impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdWhereElement {
...
// }
// #[derive(Debug, Clone, PartialEq, Default, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
// pub struct OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead(pub std::vec::Vec<DoggieWithIdAsNotNullJsonbObjectWithIdRead>);
...
// pub struct OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate {
...
// pub enum OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed {
...
//         update: std::vec::Vec<DoggieWithIdAsNotNullJsonbObjectWithIdUpdateElement>,
//         delete: std::vec::Vec<<postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Update>,
//     ) -> Result<Self, OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed> {
//         if create.is_empty() && update.is_empty() && delete.is_empty() {
//             return Err(OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::CreateUpdateDeleteCheckFieldsAreEmpty { code_occurence: error_occurence_lib::code_occurence!() });
//         }
//         {
//             let update_acc = {
...
//                         return Err(OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonUpdateArray {
//                             error: format!("custom serde error deserializing OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json update array: {}", id),
//                             code_occurence: error_occurence_lib::code_occurence!(),
//                         });
//                     } else {
//                         update_acc.push(id);
...
//                         return Err(OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonDeleteArray {
//                             error: format!("custom serde error deserializing OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json delete array: {}", element),
//                             code_occurence: error_occurence_lib::code_occurence!(),
//                         });
//                     } else {
...
//                 if delete_acc.contains(&&element) {
//                     return Err(OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdateTryNewErrorNamed::NotUniqueIdInJsonUpdateAndDeleteArrays {
//                         error: format!("custom serde error deserializing OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate: not unique id in json update and delete arrays: {}", element),
//                         code_occurence: error_occurence_lib::code_occurence!(),
//                     });
//                 }
//             }
...
//     }
// }
// impl<'de> serde::Deserialize<'de> for OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate {
...
//         #[doc(hidden)]
//         struct __Visitor<'de> {
//             marker: serde::__private::PhantomData<OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate>,
//             lifetime: serde::__private::PhantomData<&'de ()>,
//         }
//         impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
//             type Value = OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate;
//             fn expecting(&self, __formatter: &mut serde::__private::Formatter<'_>) -> serde::__private::fmt::Result {
//                 serde::__private::Formatter::write_str(__formatter, "tuple struct OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate")
//             }
//             #[inline]
...
//                     }
//                 };
//                 match OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate::try_new(__field0, __field1, __field2) {
...
//             __deserializer,
//             "OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate",
//             FIELDS,
//             __Visitor {
//                 marker: serde::__private::PhantomData::<OptionVecOfDoggieWithIdAsNullableArrayOfNotNullJsonbObjectWithIdUpdate>,
