...
//                         column_155: <<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
//                     };
...
//                         Some(value) => <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases<<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadInner>>::test_cases(&value),
//                         None => vec![],
//                     };
...
//                                 value: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases<<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadInner>>::update_new_or_try_new_unwraped_for_test(<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::into_inner(
//                                     <<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
//                                 )),
//                             }),
//                         };
...
//                             }),
//                             None => Some(postgresql_crud::Value {
//                                 value: <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::tests::PostgresqlTypeTestCases<<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::ReadInner>>::update_new_or_try_new_unwraped_for_test(
//                                     <crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::into_inner(
//                                         <<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
//                                     ),
//                                 ),
//                             }),
//                         };
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    for index in 0..column_154_test_cases.len().max(column_155_test_cases.len()) {
                        let select_primary_key_field_ident = postgresql_crud::NotEmptyUniqueEnumVec::try_new(
                            vec![
                                super::ExampleSelect::PrimaryKeyColumn(
                                    <<postgresql_crud::postgresql_type::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Select as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()
                                ),
                                // super::ExampleSelect::Column154(
                                //     <<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Select as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()
                                // ),
                                super::ExampleSelect::Column155(
                                    <<crate::repositories_types::server::routes::api::example::VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlType>::Select as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()
                                )
                            ]
                        ).expect("error 5fc78974-50e1-47c8-8cf0-156675513f3f");
                        println!("SELECT{select_primary_key_field_ident:#?}");
                        
                        
                        
                        let start = super::Example::try_read_one(
                            &url,
                            super::ExampleReadOneParameters {
                                payload: super::ExampleReadOnePayload {
                                    primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone(),
                        ...
                        ).await.expect("error 770fc785-f87a-42b0-a0c7-d08291f65293");
                        println!("START{start:#?}");
                        ...
                        let column_154_some_value_update = match column_154_test_cases.get(index) {
                            Some(value) => Some(postgresql_crud::Value { value: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases<<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadInner>>::update_new_or_try_new_unwraped_for_test(value.clone()) }),
                            None => Some(postgresql_crud::Value {
                                value: <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases<<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadInner>>::update_new_or_try_new_unwraped_for_test(<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::into_inner(<<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element())),
                            }),
                        };
                        println!("UPDATE{:#?}", column_154_some_value_update);
                        let column_155_some_value_update = match column_155_test_cases.get(index) {
                        ...
                        assert_eq!(
                            read_only_ids_returned_from_create_one.clone(),
                            {
                                let f = super::Example::try_update_one(
                                    ...
                                    super::ExampleUpdateOneParameters {
                                        payload: {
                                            let f = super::ExampleUpdate::try_new(<postgresql_crud::postgresql_type::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Update::from(read_only_ids_returned_from_create_one.primary_key_column.clone()), column_154_some_value_update, column_155_some_value_update).expect("error 0e5d65a5-12c8-4c48-a24c-0f1fe376ada2");
                                            println!("&&&&&&&{f:#?}");
                                            f
                                        },
                                    },
                        ...
                        // let end = super::Example::try_read_one(&url, super::ExampleReadOneParameters { payload: super::ExampleReadOnePayload { primary_key_column: read_only_ids_returned_from_create_one.primary_key_column.clone(), select: select_primary_key_field_ident.clone() } }).await.expect("error 770fc785-f87a-42b0-a0c7-d08291f65293");
                        // println!("END{end:#?}");
                    }
                });
            })
...
impl postgresql_crud::tests::PostgresqlTypeTestCases<OptionAnimalAsNullableJsonbObjectReadInner> for OptionAnimalAsNullableJsonbObject {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        match &read_only_ids.0 {
            Some(value) => <AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::ReadInner>>::test_cases(&value).into_iter().map(|element| Some(element)).collect::<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner>>(),
            None => vec![None],
        }
    }
    fn read_new_or_try_new_unwraped_for_test(value: OptionAnimalAsNullableJsonbObjectReadInner) -> <Self::Element as postgresql_crud::PostgresqlType>::Read {
            ...
            jsonb_build_object(
                ...
                jsonb_build_object(
                    ...
                    then '[]'::jsonb
                        ...
                        with ordinality
                        where ordinality between {dimension1_start} and {dimension1_end}
                    )
                    end
                )
            )
...
#[cfg(test)]
impl postgresql_crud::tests::PostgresqlTypeTestCases<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    type Element = Self;
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        read_only_ids
            .0
            ...
            .map(|element| {
                vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                    ...
                    field_0: Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(<<postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()) }),
                    field_1: Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(<<postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()) }),
                }]
            })
            .collect()
    }
        ...
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead::new({
            ...
            for element in value {
                acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                    id: match element.id {
                        Some(value) => Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Read::new(value.value) }),
                        None => None,
                    },
                    field_0: match element.field_0 {
                        Some(value) => Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read::new(value.value) }),
                        None => None,
                    },
                    field_1: match element.field_1 {
                        Some(value) => Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read::new(value.value) }),
                        None => None,
                    },
                });
            }
        ...
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::try_new(
            ...
            value
                ...
                .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                    id: postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbStringOrigin::new(element.id.unwrap().value),
...
#[cfg(test)]
impl postgresql_crud::tests::PostgresqlJsonTypeTestCases<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner> for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    type Element = Self;
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner> {
        read_only_ids
            .0
