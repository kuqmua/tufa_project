        ...
        std::thread::Builder::new()
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    futures::StreamExt::for_each_concurrent(
                        futures::stream::iter({
                            ...
                            if let Some(value) = &common_read_only_ids_returned_from_create_one.column_154 {
                                for element0 in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::test_cases(&value) {
                                    for element1 in element0 {
                                        let value_read_only_ids = value.clone();
                                        // let f: bool = element1;AnimalAsNotNullJsonbObjectReadInner
                                        // let f: bool = value;//AnimalAsNotNullJsonbObjectReadOnlyIds
                                        ...
                                        //             &url_cloned,
                                        //             super::ExampleUpdateOneParameters {
                                        //                 payload: super::ExampleUpdate::try_new(<postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlType>::Update::from(read_only_ids_returned_from_create_one.primary_key_column.clone()), Some(postgresql_crud::Value { value: update })).expect("error 0e5d65a5-12c8-4c48-a24c-0f1fe376ada2 column_154")
                                        //             }
                                        //         )
                                        //         .await
                    ...
                    //     // }
                    //     let ident_create_default_test_cases_counter = {
                    //         let mut counter: std::primitive::u64 = 0;
                    //         if let Some(value) = &common_read_only_ids_returned_from_create_one.column_154 {
                    //             for element0 in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::test_cases(&value) {
                    //                 for _ in element0 {
                    ...
                    //         }
                    //         //todo
                    //         //add here other columns
                    //         counter
                    //     };
                    //     // let column_read_inner_test_cases = {
                    //     //     let mut acc = vec![];
                    //     //     println!("common_read_only_ids_returned_from_create_one {:#?}", &common_read_only_ids_returned_from_create_one);
                    //     //     if let Some(value) = &common_read_only_ids_returned_from_create_one.column_154 {
                    //     //         for element0 in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::test_cases(&value) {
                    //     //             for element1 in element0 {
                    //     //                 acc.push(ColumnReadInnerTestCases::Column154(element1));
                    //     //             }
                    //     //         }
                    //     //     }
                    //     //     //todo
                    ...
                    //     futures::StreamExt::for_each_concurrent(
                    //         futures::stream::iter({
                    //             // struct TestCasesWith
                    //             let mut acc: std::vec::Vec<futures::future::BoxFuture<'static, ()>> = vec![];
                    //             for i in 1..=ident_create_default_test_cases_counter {
                    //                 let url_cloned = url.clone();
                    //                 let ident_create_default_cloned = ident_create_default.clone();
                    //                 let select_default_all_cloned = select_default_all.clone();
                    //                 let column_154_is_some = common_read_only_ids_returned_from_create_one.column_154.is_some();
                    //                 acc.push(futures::FutureExt::boxed(async move {
                    //                     let create_one_read_only_ids: super::ExampleReadOnlyIds = super::Example::try_create_one(&url_cloned, super::ExampleCreateOneParameters { payload: ident_create_default_cloned.clone() }).await.expect("error 32e30b87-b46a-4f39-aeb0-39694fc52d30");
                    //                     println!("create_one_read_only_ids {create_one_read_only_ids:#?}");
                    //                     // let current_test_cases
                    //                     if column_154_is_some {
                    //                         for element0 in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::test_cases(&value) {
                    //                             for element1 in element0 {
                    //                                 acc.push(ColumnReadInnerTestCases::Column154(element1));
                    //                             }
                    //                         }
                    //                     }
                    //                     // let some_value_read_only_ids_returned_from_create_one = Some(postgresql_crud::Value { value: create_one_read_only_ids.primary_key_column.clone() });
                    //                     // let read_only_ids_returned_from_create_one = read_only_ids_vec.get(future_counter).expect("error 870927ab-3ba2-445f-96b5-0f7b8618fc63 column_154").clone();
                    //                     let create_one_read_only_ids_primary_key = &create_one_read_only_ids.primary_key_column;
                    ...
                    //                     // assert_eq!(
                    //                     //     super::ExampleReadOnlyIds {
                    //                     //         primary_key_column: create_one_read_only_ids_primary_key.clone(),
                    //                     //         column_154: Some(<crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update)),
                    //                     //         // column_155: None,
                    //                     //         // column_156: None,
                    //                     //         // column_157: None
                    ...
                    //                     //                     postgresql_crud::PostgresqlType
                    //                     //                 >::Update::from(
                    //                     //                     create_one_read_only_ids_primary_key.clone()
                    //                     //                 ),
                    //                     //                 Some(postgresql_crud::Value { value: update.clone() }),
                    //                     //                 // None,
                    //                     //                 // None,
                    ...
                    //                     // );
                    //                     ///////////////////////////////
                    //                     // println!("create_one_read_only_ids.column_154 {:#?}\nupdate {:#?}", &create_one_read_only_ids.column_154, &update);
                    //                     // let left = super::ExampleRead {
                    //                     //     primary_key_column: Some(postgresql_crud::Value {
                    //                     //         value: create_one_read_only_ids_primary_key.clone(),
                    //                     //     }),
                    //                     //     column_154: Some(postgresql_crud::Value {
                    //                     //         value: <
                    //                     //             crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject
                    ...
                    //                     //                 postgresql_crud::PostgresqlTypeTestCases
                    //                     //             >::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(
                    //                     //                 &create_one_read_only_ids.column_154.clone().unwrap()
                    //                     //             ).unwrap().value,
                    //                     //             Some(update.clone())
                    //                     //         )
                    //                     //     }),
...
impl std::convert::From<DoggieWithIdAsNotNullJsonbObjectWithIdCreate> for DoggieWithIdAsNotNullJsonbObjectWithIdCreateForQuery {
    fn from(value: DoggieWithIdAsNotNullJsonbObjectWithIdCreate) -> Self {
        Self {
            id: <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(postgresql_crud::UuidUuidAsNotNullJsonbStringOrigin::new(uuid::Uuid::new_v4())),
            field_0: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::CreateForQuery::from(value.field_0),
        }
    }
}
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn update_new_or_try_new_unwraped_for_test(value: VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Update {
        VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::try_new(
            vec![],
            DoggieWithIdAsNotNullJsonbObjectWithIdUpdate::new(
                postgresql_crud::UniqueVec::try_new(
                    value
                        ...
                        .map(|element| DoggieWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                            ...
                            fields: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(DoggieAsNotNullJsonbObjectReadInner { field_0: element.field_0 }),
                        })
                        .collect(),
                )
                .unwrap(),
