...
pub struct AnimalAsNotNullJsonbObjectTableTypeDeclaration {
    field_111: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration,
}
impl AnimalAsNotNullJsonbObjectTableTypeDeclaration {
    pub fn new(field_111: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration) -> Self {
        Self { field_111 }
    }
}
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectTableTypeDeclaration {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            field_111: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration {
    pub fn new(id: <postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration, field_111: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration) -> Self {
        Self { id, field_111 }
    }
}
...
pub struct AnimalAsNotNullJsonbObjectCreate {
    field_111: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Create,
}
impl AnimalAsNotNullJsonbObjectCreate {
    pub fn new(field_111: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Create) -> Self {
        Self { field_111 }
    }
}
...
impl AnimalAsNotNullJsonbObjectCreate {
    fn create_query_part(&self, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        match <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::create_query_part(&self.field_111, increment) {
            Ok(value) => {
                increments.push_str(&postgresql_crud::wrap_into_jsonb_build_object("field_111", &value));
            }
            Err(error) => {
                return Err(error);
            }
    ...
    fn create_query_bind(self, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments> {
        query = <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::create_query_bind(self.field_111, query);
        query
    }
}
    ...
    fn select_query_part_postgresql_type(&self, column: &std::primitive::str) -> std::string::String {
        ...
        for element in self.0.to_vec() {
            acc.push_str(&format!(
                "{}||",
                match element {
                    AnimalAsNotNullJsonbObjectSelectElement::Field111(value) => <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_111", &column_name_and_maybe_field_getter_field_ident, &column_name_and_maybe_field_getter_for_error_message_field_ident, false,),
                }
            ));
        }
        let _ = acc.pop();
...
pub enum AnimalAsNotNullJsonbObjectSelectElement {
    #[serde(rename(serialize = "field_111", deserialize = "field_111"))]
    Field111(<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Select),
}
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![AnimalAsNotNullJsonbObjectSelectElement::Field111(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element())]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema, schemars :: JsonSchema)]
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![
            ...
            AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field111(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
        ]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
pub enum AnimalAsNotNullJsonbObjectWhereElement {
    Field111(postgresql_crud::PostgresqlTypeWhere<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::WhereElement>),
}
impl<'a> postgresql_crud::PostgresqlTypeWhereFilter<'a> for AnimalAsNotNullJsonbObjectWhereElement {
    fn query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match &self {
            Self::Field111(value) => postgresql_crud::PostgresqlTypeWhereFilter::query_part(value, increment, &format!("{column}->'field_111'"), is_need_to_add_logical_operator),
        }
    }
    fn query_bind(self, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments> {
        match self {
            Self::Field111(value) => postgresql_crud::PostgresqlTypeWhereFilter::query_bind(value, query),
        }
    }
}
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectWhereElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![Self::Field111(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element())]
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
...
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalWithIdAsNotNullJsonbObjectWithIdWhereElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![
            ...
            Self::Field111(postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element()),
        ]
    }
}
...
pub struct AnimalAsNotNullJsonbObjectRead {
    ...
    field_111: std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>,
}
impl AnimalAsNotNullJsonbObjectRead {
    fn into_inner(self) -> AnimalAsNotNullJsonbObjectReadInner {
        AnimalAsNotNullJsonbObjectReadInner {
            field_111: match self.field_111 {
                Some(value) => Some(postgresql_crud::Value {
                    value: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::into_inner(value.value),
                }),
                None => None,
            },
        }
...
impl AnimalAsNotNullJsonbObjectRead {
    pub fn try_new(field_111: std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>) -> Result<Self, AnimalAsNotNullJsonbObjectReadTryFromErrorNamed> {
        if let None = &field_111 {
    ...
    impl<'de> _serde::Deserialize<'de> for AnimalAsNotNullJsonbObjectRead {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                ...
                {
                    match __value {
                        "field_111" => serde::__private::Ok(__Field::__field0),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                ...
                {
                    match __value {
                        b"field_111" => serde::__private::Ok(__Field::__field0),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                {
                    let __field0 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>>(&mut __seq)? {
                ...
                {
                    let mut __field0: serde::__private::Option<std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>> = serde::__private::None;
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                if serde::__private::Option::is_some(&__field0) {
                                    return serde::__private::Err(<__A::Error as serde::de::Error>::duplicate_field("field_111"));
                                }
                                __field0 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>>(&mut __map)?);
                            }
                            _ => {
                    ...
                    let __field0 = match __field0 {
                        ...
                        serde::__private::None => serde::__private::de::missing_field("field_111")?,
                    };
                    match AnimalAsNotNullJsonbObjectRead::try_new(__field0) {
                        Ok(value) => serde::__private::Ok(value),
                        Err(error) => {
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["field_111"];
...
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectRead {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            field_111: Some(postgresql_crud::Value {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for AnimalWithIdAsNotNullJsonbObjectWithIdRead {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "field_111" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                fn visit_bytes<__E>(self, __value: &[u8]) -> _serde::__private::Result<Self::Value, __E>
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"field_111" => serde::__private::Ok(__Field::__field1),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["id", "field_111"];
            _serde::Deserializer::deserialize_struct(
                __deserializer,
...
pub struct AnimalAsNotNullJsonbObjectReadInner {
    field_111: std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::ReadInner>>,
}
#[derive(Debug, Clone, PartialEq)]
...
pub enum AnimalAsNotNullJsonbObjectUpdateElement {
    #[serde(rename(serialize = "field_111", deserialize = "field_111"))]
    Field111(postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Update>),
}
impl postgresql_crud::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalAsNotNullJsonbObjectUpdateElement {
    fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
        vec![AnimalAsNotNullJsonbObjectUpdateElement::Field111(postgresql_crud::Value {
            value: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        })]
    }
}
...
impl postgresql_crud::PostgresqlJsonType for AnimalAsNotNullJsonbObject {
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!("jsonb_build_object('value',jsonb_build_object('field_111',{}))", <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_111'")))
    }
    ...
    fn update_query_part(value: &Self::Update, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field111(value) => match <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::update_query_part(&value.value, &std_option_option_object_acc, &generate_jsonb_set_target("field_111"), "field_111", increment) {
                    Ok(value) => {
    ...
    fn update_query_bind(value: Self::Update, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments> {
        for element in value.0.into_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field111(value) => {
    ...
    fn select_only_updated_ids_query_part(value: &Self::Update, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            match &element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field111(value) => match <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_111", &format!("{column_name_and_maybe_field_getter}->'field_111'"), increment) {
                    Ok(value) => {
                        acc.push_str(&value);
                    }
                    Err(error) => {
...
impl postgresql_crud::PostgresqlType for AnimalAsNotNullJsonbObject {
    ...
    fn select_only_updated_ids_query_part(value: &Self::Update, column: &std::primitive::str, increment: &mut std::primitive::u64, is_primary_key: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            match &element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field111(value) => match <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_111", &column, increment) {
                    Ok(value) => {
                        acc.push_str(&value);
                    }
                    Err(error) => {
...
impl postgresql_crud::PostgresqlJsonType for AnimalWithIdAsNotNullJsonbObjectWithId {
        ...
        for element in value.0.to_vec() {
            acc.push_str(&format!(
                ...
                match element {
                    ...
                    AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field111(value) => <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_111", &column_name_and_maybe_field_getter_field_ident, &column_name_and_maybe_field_getter_for_error_message_field_ident, false,),
                }
            ));
        }
        let _ = acc.pop();
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!(
            "jsonb_build_object('value',jsonb_build_object('id',{},'field_111',{}))",
            ...
            <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_111'"))
        )
    }
        ...
        for element in value.0.to_vec() {
            acc.push_str(&format!("jsonb_build_object('id',jsonb_build_object('value','{}'),{})||", element.id.get_inner(), {
                ...
                for element in element.fields.0.to_vec() {
                    match &element {
                        AnimalAsNotNullJsonbObjectUpdateElement::Field111(value) => match <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_111", &column_name_and_maybe_field_getter, increment) {
                            Ok(value) => {
                                acc.push_str(&value);
                            }
                            Err(error) => {
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for AnimalAsNotNullJsonbObject {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner>> {
        let mut acc = vec![];
        for element in <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::test_cases(&read_only_ids.0.value.field_111) {
            for current_element in element {
                acc.push(AnimalAsNotNullJsonbObjectReadInner { field_111: Some(postgresql_crud::Value { value: current_element }) });
            }
        }
        vec![acc]
    }
    fn read_new_or_try_new_unwraped_for_test(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::Element as postgresql_crud::PostgresqlType>::Read {
        <Self::Element as postgresql_crud::PostgresqlType>::Read::try_new(match value.field_111 {
            Some(value) => Some(postgresql_crud::Value {
                value: <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value),
            }),
            None => None,
        })
        .unwrap()
    ...
    fn update_new_or_try_new_unwraped_for_test(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::Element as postgresql_crud::PostgresqlType>::Update {
        <Self::Element as postgresql_crud::PostgresqlType>::Update::new(
            postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                let mut acc = vec![];
                if let Some(value) = value.field_111 {
                    acc.push(AnimalAsNotNullJsonbObjectUpdateElement::Field111(postgresql_crud::Value {
                        value: <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(value.value),
                    }));
                }
                acc
            })
    ...
    fn update_to_read_only_ids(value: &<Self::Element as postgresql_crud::PostgresqlType>::Update) -> <Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds {
        let mut field_111 = None;
        for element in value.0.to_vec() {
            match element {
                AnimalAsNotNullJsonbObjectUpdateElement::Field111(value) => {
                    field_111 = Some(<DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&value.value));
                }
            }
        }
        AnimalAsNotNullJsonbObjectReadOnlyIds(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadOnlyIdsHandle { field_111: field_111.expect("expect 106f16f2-ae03-48b3-9239-f4b1b60746d5") },
        })
    }
}
#[cfg(test)]
    ...
    fn read_only_ids_to_option_value_read_inner(value: <Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::option::Option<postgresql_crud::Value<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadInner {
                field_111: match <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(value.0.value.field_111) {
                    Some(value) => Some(value),
                    None => Some(postgresql_crud::Value {
                        value: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::into_inner(<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()),
                    }),
                },
            },
        })
...
impl postgresql_crud::tests::PostgresqlJsonTypeTestCases for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner>> {
        vec![vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
            ...
            field_111: <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(read_only_ids.0.value.field_111.clone()),
        }]]
    }
    fn read_new_or_try_new_unwraped_for_test(value: AnimalWithIdAsNotNullJsonbObjectWithIdReadInner) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Read {
        AnimalWithIdAsNotNullJsonbObjectWithIdRead {
            ...
            field_111: match value.field_111 {
                Some(value) => Some(postgresql_crud::Value {
                    value: <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value),
                }),
                None => None,
...
impl postgresql_crud::PostgresqlJsonType for CatAsNotNullJsonbObject {
    ...
    fn select_only_updated_ids_query_part(value: &Self::Update, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in value.0.to_vec() {
            match &element {
                CatAsNotNullJsonbObjectUpdateElement::Field444(value) => match <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value.value, &"field_444", &format!("{column_name_and_maybe_field_getter}->'field_444'"), increment) {
                    Ok(value) => {
                        acc.push_str(&value);
                    }
                    Err(error) => {
...
impl postgresql_crud::PostgresqlJsonType for VecOfCatWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
    ...
    fn select_only_updated_ids_query_part(value: &Self::Update, field_ident: &std::primitive::str, column_name_and_maybe_field_getter: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        ...
        //                     'id', 
        //                     jsonb_build_object(
        //                       'value', '5a03848a-1d72-4df0-9e95-98c59a23fff5'
        //                     ), 
        //                     'field_444', 
        ...
        //                 column_154 -> 'field_807' -> 'field_807'
        //               ) as elem
        //           )
        //         )
        //       )
