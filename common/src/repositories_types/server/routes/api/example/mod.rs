...
impl postgresql_crud::tests::PostgresqlTypeTestCases<AnimalAsNotNullJsonbObjectReadInner> for AnimalAsNotNullJsonbObject {
    ...
    fn read_new_or_try_new_unwraped_for_test(value: AnimalAsNotNullJsonbObjectReadInner) -> <Self::Element as postgresql_crud::PostgresqlType>::Read {
        <Self::Element as postgresql_crud::PostgresqlType>::Read::try_new(
            match value.field_0 {
                Some(value) => Some(postgresql_crud::Value {
                    value: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases<<postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::ReadInner>>::read_new_or_try_new_unwraped_for_test(value.value),
                }),
                None => None,
            },
            match value.field_1 {
...
impl postgresql_crud::tests::PostgresqlTypeTestCases<OptionAnimalAsNullableJsonbObjectReadInner> for OptionAnimalAsNullableJsonbObject {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        match &read_only_ids.0 {
            Some(value) => <AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases<<AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::ReadInner>>::test_cases(&value)
                .into_iter()
                .map(|element| Some(element))
                .collect::<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner>>(),
            None => vec![None],
...
#[cfg(test)]
impl postgresql_crud::tests::PostgresqlTypeTestCases<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    type Element = Self;
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        //here
        match &read_only_ids.0 {
            Some(value) => <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::tests::PostgresqlJsonTypeTestCases<<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::ReadInner>>::test_cases(&value)
                .into_iter()
                .map(|element| Some(element))
                .collect::<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner>>(),
            None => vec![None],
            ...
            Some(value) => Some(
                value.into_iter().map(|element|{
                    AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                        id: match &element.id {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Read::new(value.value)
                            }),
                            None => None
                        },
                        field_0: match &element.field_0 {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read::new(value.value)
                            }),
                            None => None
                        },
                        field_1: match &element.field_1 {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read::new(value.value)
                            }),
                            None => None
                        },
                    }
    ...
    fn update_new_or_try_new_unwraped_for_test(value: OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::Element as postgresql_crud::PostgresqlType>::Update {
        //here
        <Self::Element as postgresql_crud::PostgresqlType>::Update::new(match value {
            Some(value) => Some(<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::tests::PostgresqlTypeTestCases<<VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::ReadInner>>::update_new_or_try_new_unwraped_for_test(value)),
            None => None,
        })
    }
}
#[cfg(test)]
impl postgresql_crud::tests::PostgresqlJsonTypeTestCases<OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdReadInner> for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    type Element = Self;
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlJsonType>::ReadInner> {
        //here
        match &read_only_ids.0 {
