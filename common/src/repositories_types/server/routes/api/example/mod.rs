...
impl AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration {
    pub fn new(id: <postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration, field_0: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration, field_1: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration, field_806: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::TableTypeDeclaration) -> Self {
        Self { id, field_0, field_1, field_806 }
    }
}
impl postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for AnimalWithIdAsNotNullJsonbObjectWithIdTableTypeDeclaration {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            ...
            field_806: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
        }
    }
}
impl AnimalAsNotNullJsonbObjectTableTypeDeclaration {
...
impl AnimalAsNotNullJsonbObjectCreate {
    pub fn new(field_0: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Create, field_1: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Create, field_806: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Create) -> Self {
        Self { field_0, field_1, field_806 }
    }
}
...
impl AnimalAsNotNullJsonbObjectRead {
    pub fn try_new(field_0: std::option::Option<postgresql_crud::Value<<postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>, field_1: std::option::Option<postgresql_crud::Value<<postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>, field_806: std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>) -> Result<Self, AnimalAsNotNullJsonbObjectReadTryFromErrorNamed> {
        ...
        Ok(Self { field_0, field_1, field_806 })
    }
}
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for AnimalAsNotNullJsonbObjectRead {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["field_0", "field_1", "field_806"];
...
impl AnimalWithIdAsNotNullJsonbObjectWithIdRead {
    pub fn try_new(id: std::option::Option<postgresql_crud::Value<<postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Read>>, field_0: std::option::Option<postgresql_crud::Value<<postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>, field_1: std::option::Option<postgresql_crud::Value<<postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read>>, field_806: std::option::Option<postgresql_crud::Value<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read>>) -> Result<Self, AnimalWithIdAsNotNullJsonbObjectWithIdReadTryFromErrorNamed> {
        if let (None, None, None, None) = (&id, &field_0, &field_1, &field_806) {
        ...
        Ok(Self { id, field_0, field_1, field_806 })
    }
}
const _: () = {
    #[allow(unused_extern_crates, clippy::useless_attribute)]
    ...
    impl<'de> _serde::Deserialize<'de> for AnimalWithIdAsNotNullJsonbObjectWithIdRead {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "field_806" => serde::__private::Ok(__Field::__field3),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                fn visit_bytes<__E>(self, __value: &[u8]) -> _serde::__private::Result<Self::Value, __E>
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"field_806" => serde::__private::Ok(__Field::__field3),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["id", "field_0", "field_1", "field_806"];
...
impl postgresql_crud::PostgresqlJsonType for AnimalWithIdAsNotNullJsonbObjectWithId {
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!("jsonb_build_object('id',{},'field_0',{},'field_1',{},'field_806',{})", <postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'id'")), <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_0'")), <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_1'")), <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&format!("{column_name_and_maybe_field_getter}->'field_806'")))
    }
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        ...
        for field_0 in <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::test_cases(&read_only_ids.field_0) {
            acc.push(AnimalAsNotNullJsonbObjectReadInner {
                ...
                field_806: Some(postgresql_crud::Value { value: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::into_inner(<<DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()) }),
            });
        }
        for field_1 in <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::test_cases(&read_only_ids.field_1) {
            acc.push(AnimalAsNotNullJsonbObjectReadInner {
        ...
        for field_806 in <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::test_cases(&read_only_ids.field_806) {
            acc.push(AnimalAsNotNullJsonbObjectReadInner {
                field_806: Some(postgresql_crud::Value { value: field_806 }),
                field_0: Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(<<postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()) }),
                field_1: Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(<<postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()) }),
            });
        }
        ...
        <Self::Element as postgresql_crud::PostgresqlType>::Update::new(
            postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                ...
                if let Some(value) = value.field_1 {
                    acc.push(AnimalAsNotNullJsonbObjectUpdateElement::Field1(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(value.value) }));
                }
            ...
            for element in value {
                acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                    ...
                    field_806: match element.field_806 {
                        Some(value) => Some(postgresql_crud::Value { value: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read::new(value.value) }),
                        None => None,
                    },
                });
            }
                ...
                .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                    ...
                    fields: AnimalAsNotNullJsonbObjectUpdate::new(
                        postgresql_crud::NotEmptyUniqueEnumVec::try_new({
                            ...
                            if let Some(value) = element.field_806 {
                                acc.push(AnimalAsNotNullJsonbObjectUpdateElement::Field806(postgresql_crud::Value { value: <DoggieAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(value.value) }));
                            }
                            acc
                        })
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for OptionAnimalAsNullableJsonbObject {
    ...
    fn read_new_or_try_new_unwraped_for_test(value: OptionAnimalAsNullableJsonbObjectReadInner) -> <Self::Element as postgresql_crud::PostgresqlType>::Read {
        <Self::Element as postgresql_crud::PostgresqlType>::Read::new(match value {
            Some(value) => Some(<AnimalAsNotNullJsonbObject as postgresql_crud::tests::PostgresqlTypeTestCases>::read_new_or_try_new_unwraped_for_test(value)),
            None => None,
        })
    }
...
impl postgresql_crud::PostgresqlType for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn select_only_updated_ids_query_part(value: &Self::Update, column: &std::primitive::str, increment: &mut std::primitive::u64, is_primary_key: std::primitive::bool) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
        match <OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_part(&value, &column, &column, increment) {
            Ok(value) => Ok(format!("{} as {column},", value)),
            Err(error) => Err(error),
        }
    }
...
impl postgresql_crud::tests::PostgresqlTypeTestCases for OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithId {
    ...
    fn test_cases(read_only_ids: &<Self::Element as postgresql_crud::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner> {
        match &read_only_ids.0 {
            Some(value) => <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::test_cases(&value).into_iter().map(|element| Some(element)).collect::<std::vec::Vec<<Self::Element as postgresql_crud::PostgresqlType>::ReadInner>>(),
            None => vec![None],
        }
    }
            ...
            Some(value) => Some(
                value
                    ...
                    .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                        id: match &element.id {
                            Some(value) => Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Read::new(value.value.clone()) }),
                            None => None,
                        },
                        field_0: match &element.field_0 {
                            Some(value) => Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read::new(value.value.clone()) }),
                            None => None,
                        },
                        field_1: match &element.field_1 {
                            Some(value) => Some(postgresql_crud::Value { value: <postgresql_crud::postgresql_json_type::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read::new(value.value.clone()) }),
                            None => None,
                        },
                        field_806: match &element.field_806 {
                            Some(value) => Some(postgresql_crud::Value { value: <DoggieAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonType>::Read::new(value.value.clone()) }),
                            None => None,
                        },
                    })
                    .collect(),
