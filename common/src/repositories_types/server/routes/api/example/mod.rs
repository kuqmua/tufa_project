...
pub struct Animal {
    ...
    pub vec_of_vec_of_std_primitive_i8_as_not_null_array_of_not_null_array_of_not_null_number: postgresql_crud::postgresql_json_type::VecOfVecOfStdPrimitiveI8AsNotNullArrayOfNotNullArrayOfNotNullJsonbNumber,
