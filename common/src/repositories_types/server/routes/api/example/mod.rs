...
pub struct ExampleReadManyPayload {
    pub where_many: ExampleWhereMany,
        ...
        let query_string = {
            format!(
                ...
                },
                {
                    ...
                    if let Some(value) = &parameters.payload.where_many.column_6e88acb0_c566_4fef_8a09_66a41338cf36 {
                    ...
                    if let Some(value) = &parameters.payload.where_many.animal_as_not_null_jsonb_object {
