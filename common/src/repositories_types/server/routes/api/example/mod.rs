                                ...
                                for element0 in <crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::test_cases(&value) {
                                    for element1 in element0 {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            >::read_new_or_try_new_unwraped_for_test(element1.clone());
                                            //here
                                            let left = super::ExampleRead {
                                                primary_key_column: Some(postgresql_crud::Value {
                                                    value: current_primary_key.clone(),
                                                }),
                                                //todo method update to read with default for non-updated fields //OR merge read before with current update
                                                column_154: Some(postgresql_crud::Value {
                                                    ...
                                                    //         value: postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumberRead::new()
                                                    //         // <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read
                                                    //     })
                                                    // )
                                                    // .expect("error a5630ea6-0cff-4f95-a7c9-3bc5d413dc72")
                                                }),
                                                // column_154: Some(postgresql_crud::Value {
                                                //     value: crate::repositories_types::server::routes::api::example::AnimalAsNotNullJsonbObjectRead::try_new(
                                                //         Some(postgresql_crud::Value {
                                                //             value: super::VecOfDoggieWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead::new(
                                                //                 // vec![
                                                //                 //     DoggieWithIdAsNotNullJsonbObjectWithIdRead::try_new(
                                                //                 //         id: Some(postgresql_crud::Value {
                                                //                 //             value: postgresql_crud::UuidUuidAsNotNullJsonbString::new()
                                                //                 //         }),
                                                //                 //         field_0: Some(postgresql_crud::Value {
                                                //                 //             value: postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumberRead::new()
                                                //                 //         }),
                                                //                 //     ).expect("error 6c6aaffd-d01a-4941-81bd-ee64336c89e8")
                                                //                 // ]
                                                //                 todo!()
                                                //             )
                                                //         }),
                                                //     ).expect("error e30bbd25-a284-4b77-928a-9d655b85ff1a")
                                                // }),
                                            ...
                                            println!("LEFT {left:#?}\n\nread_only_ids_returned_from_create_one@@ {read_only_ids_returned_from_create_one:#?}\n\nRIGHT {right:#?}");
                                            println!("element1 {element1:#?}\n\nread_new_or_try_new_unwraped_for_test@@ {one:#?}\n\nupdate {update:#?}");
                                            assert_eq!(
                                                {
                                                    left
                                                },
    ...
    fn select_query_part_postgresql_type(&self, column: &std::primitive::str) -> std::string::String {
        ...
        for element in self.0.to_vec() {
            acc.push_str(&format!(
                "{}||",
                match element {
                    AnimalAsNotNullJsonbObjectSelectElement::Field0(value) => <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_0", &column, &column, false,),
                    AnimalAsNotNullJsonbObjectSelectElement::Field1(value) => <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_1", &column, &column, false,),
                }
            ));
        }
        let _ = acc.pop();
        ...
        Some(postgresql_crud::Value {
            value: AnimalAsNotNullJsonbObjectReadInner {
                ...
                field_1: match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(value.0.value.field_1) {
                    Some(value) => Some(value),
                    None => Some(postgresql_crud::Value {
                        value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(<<postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()),
                    }),
                },
            },
        })
        ...
        match option_update {
            Some(value) => OptionAnimalAsNullableJsonbObjectRead(match (read.0, value.0) {
                ...
                (None, Some(update)) => Some({
                    ...
                    if field_1.is_none() {
                        panic!("error 1a6d1d7e-0a8b-46d2-8e6e-7b9163615f71 field_1 is None")
                    }
                    AnimalAsNotNullJsonbObjectRead {
                        field_0: Some(postgresql_crud::Value {
            ...
            for element in self.animal_with_id_as_not_null_jsonb_object_with_id_select.0.to_vec() {
                acc.push_str(&format!(
                    ...
                    match element {
                        ...
                        AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field1(value) => <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_1", &"value", &column, false,),
                    }
                ));
            }
            let _ = acc.pop();
...
impl postgresql_crud::PostgresqlJsonType for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
            ...
            for element in value.animal_with_id_as_not_null_jsonb_object_with_id_select.0.to_vec() {
                acc.push_str(&format!(
                    ...
                    match element {
                        ...
                        AnimalWithIdAsNotNullJsonbObjectWithIdSelectElement::Field1(value) => <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_query_part(&value, "field_1", &"value", &"value", false,),
                    }
                ));
            }
            let _ = acc.pop();
    ...
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String {
        format!("jsonb_build_object('value',(select jsonb_agg({}) from jsonb_array_elements({column_name_and_maybe_field_getter}) as elem))", {
            ...
            acc.push_str(&format!("jsonb_build_object('field_1',{})||", <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::select_only_ids_query_part(&"elem->'field_1'")));
            let _ = acc.pop();
            let _ = acc.pop();
            format!("jsonb_build_object('value',{})", acc)
        })
...
impl postgresql_crud::PostgresqlJsonTypeTestCases for VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId {
            ...
            .map(|element0| {
                ...
                for element1 in <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::test_cases(&element0.0.value.field_0.clone()) {
                    for element2 in element1 {
                        acc.push(vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                            ...
                            field_1: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(element0.0.value.field_1.clone()),
                        }]);
                    }
                }
                for element1 in <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::test_cases(&element0.0.value.field_1.clone()) {
                    for element2 in element1 {
                        acc.push(vec![AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                            id: Some(postgresql_crud::Value { value: element0.0.value.id.0.value.clone() }),
                            field_0: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(element0.0.value.field_0.clone()),
    ...
    fn update_new_or_try_new_unwraped_for_test(value: VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdReadInner) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Update {
        VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdUpdate::try_new(
            vec![],
            AnimalWithIdAsNotNullJsonbObjectWithIdUpdate::new(
                postgresql_crud::UniqueVec::try_new(
                    value
                        ...
                        .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdUpdateElement {
                            ...
                            fields: <AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlJsonTypeTestCases>::update_new_or_try_new_unwraped_for_test(AnimalAsNotNullJsonbObjectReadInner { field_0: element.field_0, field_1: element.field_1 }),
                        })
                        .collect(),
                )
                .unwrap(),
        ...
        Some(postgresql_crud::Value {
            value: value.0.value.into_iter().fold(vec![], |mut acc, element| {
                acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdReadInner {
                    ...
                    field_1: match <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_inner(element.0.value.field_1) {
                        Some(value) => Some(value),
                        None => Some(postgresql_crud::Value {
                            value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::into_inner(<<postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonType>::Read as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element()),
                        }),
                ...
                let mut acc = value
                    ...
                    .map(|element| {
                        AnimalWithIdAsNotNullJsonbObjectWithIdRead::try_new(
                            ...
                            <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&element.0.value.field_1),
                        )
                ...
                for update_element in value.update.0.into_vec() {
                    ...
                    acc.push({
                        AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                            ...
                            field_1: Some(postgresql_crud::Value {
                                value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(found_read_element.field_1.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").value, field_1),
                            }),
                        }
                    });
                }
            ...
            Some(value) => Some(
                value
                    ...
                    .map(|element| AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                        id: match &element.id {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value.clone()),
                            }),
                            None => None,
                        },
                        field_0: match &element.field_0 {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value.clone()),
                            }),
                            None => None,
                        },
                        field_1: match &element.field_1 {
                            Some(value) => Some(postgresql_crud::Value {
                                value: <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_new_or_try_new_unwraped_for_test(value.value.clone()),
                            }),
                            None => None,
                        },
                    })
    ...
    fn read_from_previous_read_unwraped_merged_with_update(read: <Self::Element as postgresql_crud::PostgresqlJsonType>::Read, option_update: std::option::Option<<Self::Element as postgresql_crud::PostgresqlJsonType>::Update>) -> <Self::Element as postgresql_crud::PostgresqlJsonType>::Read {
        ...
        match option_update {
            Some(value) => OptionVecOfAnimalWithIdAsNullableArrayOfNotNullJsonbObjectWithIdRead(match (read.0, value.0) {
                (Some(read), Some(update)) => Some(
                    <VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithId as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(
                        read,
                        Some(update)
                    )
                ),
                ...
                (None, Some(update_value)) => Some(VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdRead({
                    ...
                    for update_element in update_value.update.0.into_vec() {
                        ...
                        acc.push(AnimalWithIdAsNotNullJsonbObjectWithIdRead {
                            id: Some(postgresql_crud::Value {
                                value: postgresql_crud::UuidUuidAsNotNullJsonbStringRead::new(*update_element.id.get_inner())
                            }),
                            field_0: Some(postgresql_crud::Value {
