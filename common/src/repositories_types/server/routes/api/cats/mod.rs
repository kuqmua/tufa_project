            ...
            match value.std_primitive_bool_as_postgresql_bool {
                Some(value) => Some(
                    value
                        .into_iter()
                        .map(|element| {
                            postgresql_crud::WhereStdPrimitiveBoolWithSerializeDeserialize::from(
                                element,
                            )
                        })
                        .collect(),
...
pub enum TryDeleteManyErrorNamed {
    ...
    }, ExpectedType
    {
        ...
        TryDeleteManyWithSerializeDeserialize, code_occurence :
...
pub async fn delete_many<'a>(
    ...
    println!("{:#?}", parameters);
    {
        ...
        match (
            ...
            (None, Some(std_primitive_i64_as_postgresql_big_serial_not_null_primary_key)) => {
                        ...
                        match is_unique {
                            ...
                            false => {
                                let not_unique_std_primitive_bool_as_postgresql_bool_vec = {
                                    ...
                                    element |
                                    postgresql_crud::WhereStdPrimitiveBoolWithSerializeDeserialize
