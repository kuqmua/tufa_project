...
//     pub fn new(std_primitive_i8: postgresql_crud::json_types::StdPrimitiveI8ToCreate) -> Self {
//         Self(SomethingToCreateOrigin { std_primitive_i8 })
//     }
// }
...
//         vec![SomethingFieldToReadWithoutId::StdPrimitiveI8(
//             postgresql_crud::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement::default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
//         )]
//     }
// }
...
//     pub fn try_new(std_primitive_i8: std::option::Option<postgresql_crud::Value<postgresql_crud::json_types::StdPrimitiveI8OptionsToRead>>) -> Result<Self, SomethingOptionsToReadWithOrWithoutIdTryFromErrorNamed> {
...
//                     serde::__private::Some(__value) => __value,
//                     serde::__private::None => {
//                         return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct SomethingOptionsToRead with 1 elements"));
//                     }
//                 };
//                 match SomethingOptionsToReadWithoutId::try_new(__field0) {
...
//                     serde::__private::Some(__value) => __value,
//                     serde::__private::None => {
//                         return serde::__private::Err(serde::de::Error::invalid_length(0usize, &"struct SomethingOptionsToRead with 2 elements"));
//                     }
//                 };
...
//                     }
//                 };
//                 match SomethingOptionsToReadWithId::try_new(__field0, __field1) {
//                     Ok(value) => serde::__private::Ok(value),
//                     Err(error) => {
//                         return Err(serde::de::Error::custom(format!("{error:?}")));
//                     }
...
//     fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<Self> {
//         vec![SomethingOptionToUpdateOrigin::StdPrimitiveI8(postgresql_crud::Value {
//             value: postgresql_crud::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement::default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
//         })]
//     }
// }
...
//                 match element {
//                     //here1
//                     SomethingFieldToReadWithoutId::StdPrimitiveI8(value) => <postgresql_crud::json_types::StdPrimitiveI8 as postgresql_crud::PostgresqlJsonType>::generate_postgresql_query_part_field_to_read(value, "std_primitive_i8", column_name_and_maybe_field_getter, column_name_and_maybe_field_getter_for_error_message),
//                 }
//             ));
//         }
//         let _ = acc.pop();
...
//             match &element {
//                 //here1
//                 SomethingOptionToUpdateOrigin::StdPrimitiveI8(value) => match <postgresql_crud::json_types::StdPrimitiveI8 as postgresql_crud::PostgresqlJsonType>::try_generate_bind_increments(&value.value, &local_acc, &generate_jsonb_set_target("std_primitive_i8"), &generate_jsonb_set_path("std_primitive_i8"), increment) {
//                     Ok(value) => {
//                         local_acc = value;
//                     }
//                     Err(error) => {
...
//                     match element {
//                         //here1
//                         SomethingOptionToUpdateOrigin::StdPrimitiveI8(value) => match <postgresql_crud::json_types::StdPrimitiveI8 as postgresql_crud::PostgresqlJsonType>::try_generate_bind_increments(&value.value, &std_option_option_generic_acc, &generate_jsonb_set_target("std_primitive_i8"), "std_primitive_i8", increment) {
//                             Ok(value) => {
//                                 std_option_option_generic_acc = value;
//                             }
//                             Err(error) => {
...
//                 "{}||",
//                 match element {
//                     SomethingFieldToReadWithId::Id(value) => postgresql_crud::GeneratePostgresqlQueryPartFieldToRead::generate_postgresql_query_part_field_to_read(value, "id", "value", &column_name_and_maybe_field_getter_for_error_message_field_ident),
//                     //here1
//                     SomethingFieldToReadWithId::StdPrimitiveI8(value) => <postgresql_crud::json_types::StdPrimitiveI8 as postgresql_crud::PostgresqlJsonType>::generate_postgresql_query_part_field_to_read(value, "std_primitive_i8", "value", &column_name_and_maybe_field_getter_for_error_message_field_ident),
//                 }
//             ));
//         }
//         let _ = acc.pop();
...
//                         match element {
//                             SomethingOptionToUpdateOrigin::StdPrimitiveI8(value) => match <postgresql_crud::json_types::StdPrimitiveI8 as postgresql_crud::PostgresqlJsonType>::try_generate_bind_increments(&value.value, &element_acc, &generate_jsonb_set_target("std_primitive_i8"), "std_primitive_i8", increment) {
//                                 Ok(value) => {
//                                     element_acc = value;
//                                 }
//                                 Err(error) => {
