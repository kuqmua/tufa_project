    ...
    fn try_generate_bind_increments(
        ...
        match &self.0 {
            Some(value) => {
                for element in value {
                    match element {
                        StdOptionOptionGenericCatOptionToUpdateOrigin::StdPrimitiveI32(value) => match postgresql_crud::GeneratePostgresqlQueryPartToUpdate::try_generate_bind_increments(
                            &value.value,
