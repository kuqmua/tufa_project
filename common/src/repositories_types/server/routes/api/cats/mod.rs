...
pub struct Dog {
    ...
    // pub sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_timestamp: postgresql_crud::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestamp,
    // pub sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_timestamp_not_null: postgresql_crud::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestampNotNull,
    ...
    // pub sqlx_types_uuid_uuida_as_postgresql_uuid: postgresql_crud::SqlxTypesUuidUuidAsPostgresqlUuid,
    // pub sqlx_types_uuid_uuida_as_postgresql_uuid_not_null: postgresql_crud::SqlxTypesUuidUuidAsPostgresqlUuidNotNull,
    // pub sqlx_types_uuid_uuida_as_postgresql_uuid_not_null_primary_key: postgresql_crud::SqlxTypesUuidUuidAsPostgresqlUuidNotNullPrimaryKey,//todo Primary Key support only for Uuid - its simplification. maybe later support something else but now i think uuid v7 is enough
    ...
    // pub sqlx_types_json_t_as_postgresql_json: postgresql_crud::SqlxTypesJsonTAsPostgresqlJson<T>,
    // pub sqlx_types_json_t_as_postgresql_json_not_null: postgresql_crud::SqlxTypesJsonTAsPostgresqlJsonNotNull<T>,
    // pub sqlx_types_json_t_as_postgresql_json_b: postgresql_crud::SqlxTypesJsonTAsPostgresqlJsonB<T>,
    // pub sqlx_types_json_t_as_postgresql_json_b_not_null: postgresql_crud::SqlxTypesJsonTAsPostgresqlJsonBNotNull<T>,
...
DogOptions
{
    #[serde(skip_serializing_if = "Option::is_none")] pub id : std :: option
    :: Option <
    ...
    #[serde(skip_serializing_if = "Option::is_none")] pub
    sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
    : std :: option :: Option <
    postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32WithSerializeDeserialize
    >, #[serde(skip_serializing_if = "Option::is_none")] pub
    sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
    : std :: option :: Option <
...
impl std::convert::From<Dog> for DogOptions {
    fn from(value: Dog) -> Self {
        ...
        {
            id :
            Some(postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize::from(value.id.0)), 
            std_primitive_bool_as_postgresql_bool :
            Some(postgresql_crud::StdPrimitiveBoolWithSerializeDeserialize::from(value.std_primitive_bool_as_postgresql_bool.0)),
            sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null: Some(
                postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32WithSerializeDeserialize::from(
                    value.sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null.0
                )
            ),
            sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range:
            Some(
                // postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcWithSerializeDeserialize::from(
                //     value.sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range.0
                // )
                //
                 match postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcWithSerializeDeserialize::try_from(
                    value.sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range.0
                ) {
                    Ok(value) => value,
                    Err(_) => panic!("wtf")
...
#[derive(Debug)]
pub struct DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull {
    pub sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null:
        postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32WithSerializeDeserialize,
}
#[derive(Debug)]
pub struct
DogSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub
    sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
    :
...
#[derive(Debug)]
pub struct DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull {
    pub id: postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize,
    pub sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null:
        postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32WithSerializeDeserialize,
}
#[derive(Debug)]
pub struct
DogIdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub id :
    postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize, pub
    sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
    :
    postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct DogIdStdPrimitiveBoolAsPostgresqlBool {
    pub id: postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize,
    pub std_primitive_bool_as_postgresql_bool:
        postgresql_crud::StdPrimitiveBoolWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct
DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub std_primitive_bool_as_postgresql_bool :
    postgresql_crud::StdPrimitiveBoolWithSerializeDeserialize, pub
    sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
    :
    postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
{
    pub std_primitive_bool_as_postgresql_bool:
        postgresql_crud::StdPrimitiveBoolWithSerializeDeserialize,
    pub sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null:
...
#[derive(Debug)]
pub struct
DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub
    sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
    :
...
#[derive(Debug)]
pub struct
DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub id :
    postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize, pub
    sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
...
#[derive(Debug)]
pub struct DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
{
    pub id: postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize,
    pub std_primitive_bool_as_postgresql_bool:
        postgresql_crud::StdPrimitiveBoolWithSerializeDeserialize,
...
#[derive(Debug)]
pub struct
DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub id :
    postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize, pub
    std_primitive_bool_as_postgresql_bool :
...
#[derive(Debug)]
pub struct
DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub std_primitive_bool_as_postgresql_bool :
    postgresql_crud::StdPrimitiveBoolWithSerializeDeserialize, pub
    sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
...
#[derive(Debug)]
pub struct
DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    pub id :
    postgresql_crud::SqlxTypesUuidUuidTryParseWithSerializeDeserialize, pub
    std_primitive_bool_as_postgresql_bool :
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
{
    SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullIsNone {
        #[eo_display_with_serialize_deserialize]
        sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null_is_none:
            std::string::String,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
impl std::convert::TryFrom<DogOptions>
    for DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
{
    type Error =
    DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
    ;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null =
            match value
                .sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
            {
                Some(value) => value,
                ...
                SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullIsNone
                {
                    sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null_is_none
                    : std :: string :: String ::
                    from("sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null is None"),
                    code_occurence : error_occurence_lib :: code_occurence ::
                    CodeOccurence ::
                    new(crate :: global_variables :: compile_time ::
                    project_git_info :: PROJECT_GIT_INFO.commit.to_string(),
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeIsNone {
        #[eo_display_with_serialize_deserialize]
        sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range_is_none:
            std::string::String,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
impl std::convert::TryFrom<DogOptions>
    for DogSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    type Error =
    DogSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let
        sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
        = match
        value.sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
        {
            Some(value) => value, None =>
            {
                ...
                SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeIsNone
                {
                    sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range_is_none
                    : std :: string :: String ::
                    from("sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range is None"),
                    code_occurence : error_occurence_lib :: code_occurence ::
                    CodeOccurence ::
                    new(crate :: global_variables :: compile_time ::
                    project_git_info :: PROJECT_GIT_INFO.commit.to_string(),
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
impl std::convert::TryFrom<DogOptions>
    for DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
{
    type Error =
    DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
    ;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let id =
            match value.id {
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
impl std::convert::TryFrom<DogOptions>
    for DogIdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
{
    type Error =
    DogIdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let id =
            match value.id {
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdStdPrimitiveBoolAsPostgresqlBoolTryFromDogOptionsErrorNamed {
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
            crate::server::postgres::uuid_wrapper::UuidWrapperTryFromPossibleUuidWrapperErrorNamed,
...
impl std::convert::TryFrom<DogOptions> for DogIdStdPrimitiveBoolAsPostgresqlBool {
    type Error = DogIdStdPrimitiveBoolAsPostgresqlBoolTryFromDogOptionsErrorNamed;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let id =
            match value.id {
                Some(value) => value,
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    StdPrimitiveBoolAsPostgresqlBoolIsNone {
        #[eo_display_with_serialize_deserialize]
        std_primitive_bool_as_postgresql_bool_is_none: std::string::String,
...
{
    type Error =
    DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
{
    StdPrimitiveBoolAsPostgresqlBoolIsNone {
        #[eo_display_with_serialize_deserialize]
        std_primitive_bool_as_postgresql_bool_is_none: std::string::String,
...
impl std :: convert :: TryFrom < DogOptions > for
DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
{
    type Error =
    DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
        let std_primitive_bool_as_postgresql_bool = match
        value.std_primitive_bool_as_postgresql_bool
        ...
        sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
        = match
        value.sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
        {
            Some(value) => value, None =>
            {
                return
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullIsNone {
        #[eo_display_with_serialize_deserialize]
        sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null_is_none:
...
{
    type Error =
    DogSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
        let
        sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
{
    type Error =
    DogIdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
impl std :: convert :: TryFrom < DogOptions > for
DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
{
    type Error =
    DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
        let id = match value.id
        {
        ...
        Ok(Self
        {
            id, std_primitive_bool_as_postgresql_bool,
            sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
        })
    }
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
{
    type Error =
    DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
        let id = match value.id
        {
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    StdPrimitiveBoolAsPostgresqlBoolIsNone {
        #[eo_display_with_serialize_deserialize]
        std_primitive_bool_as_postgresql_bool_is_none: std::string::String,
...
{
    type Error =
    DogStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
        let std_primitive_bool_as_postgresql_bool = match
        value.std_primitive_bool_as_postgresql_bool
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
{
    type Error =
    DogIdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRangeTryFromDogOptionsErrorNamed
    ; fn try_from(value : DogOptions) -> Result < Self, Self :: Error >
    {
        let id = match value.id
        {
...
pub enum DogColumn {
    ...
    #[serde(rename(
        serialize = "sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null",
        deserialize = "sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null"
    ))]
    SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull,
    #[serde(rename(
        serialize = "sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range",
        deserialize = "sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"
    ))]
...
pub enum DogColumnSelect {
    ...
    SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull,
    SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    IdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull,
    IdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    IdStdPrimitiveBoolAsPostgresqlBool,
    StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull,
    SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    IdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull,
    IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
    IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange,
}
impl crate::server::postgres::generate_query::GenerateQuery for DogColumnSelect {
    fn generate_query(&self) -> std::string::String {
        match self
        {
            Self :: Id => std :: string :: String :: from("id"), Self ::
            StdPrimitiveBoolAsPostgresqlBool => std :: string :: String ::
            from("std_primitive_bool_as_postgresql_bool"), Self ::
            SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
            => std :: string :: String ::
            from("sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null"),
            Self ::
            SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self ::
            IdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
            => std :: string :: String ::
            from("id,sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null"),
            Self ::
            IdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("id,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self :: IdStdPrimitiveBoolAsPostgresqlBool => std :: string ::
            String :: from("id,std_primitive_bool_as_postgresql_bool"), Self
            ::
            StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("std_primitive_bool_as_postgresql_bool,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self ::
            StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
            => std :: string :: String ::
            from("std_primitive_bool_as_postgresql_bool,sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null"),
            Self ::
            SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self ::
            IdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("id,sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self ::
            IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
            => std :: string :: String ::
            from("id,std_primitive_bool_as_postgresql_bool,sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null"),
            Self ::
            IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("id,std_primitive_bool_as_postgresql_bool,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self ::
            StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("std_primitive_bool_as_postgresql_bool,sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range"),
            Self ::
            IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            => std :: string :: String ::
            from("id,std_primitive_bool_as_postgresql_bool,sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null,sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range")
        }
    }
}
...
impl std::str::FromStr for DogColumnSelect {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value
        {
            "Id" => Ok(Self :: Id), "StdPrimitiveBoolAsPostgresqlBool" =>
            ...
            IdSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange),
            "IdStdPrimitiveBoolAsPostgresqlBool" =>
            Ok(Self :: IdStdPrimitiveBoolAsPostgresqlBool),
            "StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange"
            =>
            Ok(Self ::
            StdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange),
            ...
            Err(Self :: Err :: NotCorrect
            {
                ...
                supported_values : std :: string :: String ::
                from("\"Id\",\"Std Primitive Bool As Postgresql Bool\",\"Sqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not Null\",\"Sqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"IdSqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not Null\",\"IdSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"IdStd Primitive Bool As Postgresql Bool\",\"Std Primitive Bool As Postgresql BoolSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"Std Primitive Bool As Postgresql BoolSqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not Null\",\"Sqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not NullSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"IdSqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not NullSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"IdStd Primitive Bool As Postgresql BoolSqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not Null\",\"IdStd Primitive Bool As Postgresql BoolSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"Std Primitive Bool As Postgresql BoolSqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not NullSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\",\"IdStd Primitive Bool As Postgresql BoolSqlx Postgres Types Pg Range Std Primitive I 32 As Postgresql Int 4 Range Not NullSqlx Postgres Types Pg Range Sqlx Types Chrono Date Time Sqlx Types Chrono Utc As Postgresql Ts Tz Range\""),
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
                new(crate :: global_variables :: compile_time ::
...
impl DogColumnSelect {
    ...
    where
        ...
        std::option::Option<sqlx::postgres::types::PgRange<std::primitive::i32>>:
        ...
        >: sqlx::types::Type<R::Database>,
    {
        ...
        match self
        {
            Self :: Id => {} Self :: StdPrimitiveBoolAsPostgresqlBool =>
            {
                std_primitive_bool_as_postgresql_bool =
                {
            ...
            =>
            {
                ...
                =
                {
                    ...
                    row.try_get("sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null")
                    ? ;
                    value.map(| value |
                    postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32WithSerializeDeserialize
                    ::
                    from(postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32(value)))
                } ;
            } Self ::
            SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            =>
            {
                ...
                =
                {
                    ...
                    sqlx::postgres::types::PgRange<sqlx::types::chrono::DateTime<sqlx::types::chrono::Utc>>
                    > =
                    row.try_get("sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range")
                    ? ;
                    // value.map(| value |
                    // postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcWithSerializeDeserialize
                    // ::
                    // from(postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtc(value)))
                    todo!()
                } ;
            } Self ::
            IdSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
            ...
            } Self :: IdStdPrimitiveBoolAsPostgresqlBool =>
            {
                std_primitive_bool_as_postgresql_bool =
                {
                    let value : std :: option :: Option < std::primitive::bool >
...
pub struct DogColumnReadPermission {
    ...
    sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null: bool,
    sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range:
        bool,
}
#[test]
fn dog_emulate_crud_api_usage_test() {
    async fn find_out_if_it_works() {
        ...
        let primary_keys =
        match
        try_create_many(& api_location, CreateManyParameters
        {
            payload :
            CreateManyPayload(vec!
            [CreateManyPayloadElement
            {
                std_primitive_bool_as_postgresql_bool : postgresql_crud ::
                StdPrimitiveBoolAsPostgresqlBool :: default(),
                sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
                : postgresql_crud ::
                SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNull
                :: default(),
        ...
        match
        try_update_many(& api_location, UpdateManyParameters
        {
            payload :
            UpdateManyPayload(primary_keys.clone().into_iter().map(| element |
            {
                UpdateManyPayloadElement
                {
                    id : element, std_primitive_bool_as_postgresql_bool :
        ...
        match
        try_delete_many(& api_location, DeleteManyParameters
        {
        ...
        try_create_one(& api_location, CreateOneParameters
        {
        ...
        try_read_one(& api_location, ReadOneParameters
        {
            ...
            {
                id : primary_key.clone(), select : DogColumnSelect ::
                IdStdPrimitiveBoolAsPostgresqlBoolSqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4RangeNotNullSqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange
            }
        },).await
        { Ok(value) => println! ("{value:#?}"), Err(e) => panic! ("{}", e) } ;
        ...
        let primary_key = match
        try_update_one(& api_location, UpdateOneParameters
        {
            payload : UpdateOnePayload
            {
                id : primary_key.clone(),
                std_primitive_bool_as_postgresql_bool :
                Some(postgresql_crud :: StdPrimitiveBoolAsPostgresqlBool ::
                default()),
                sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
                :
...
pub struct CreateManyPayloadElement {
    ...
    pub sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range:
    ...
    for CreateManyPayloadElement
{
    ...
    fn try_from(
        ...
        sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null
        = postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32 ::
        from(value.sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null)
        ;
        // let
        // sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range
        // =
        // postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtc
        // ::
        // from(value.sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range)
        // ;
        // Ok(Self {
        //     std_primitive_bool_as_postgresql_bool,
        //     sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null,
...
pub async fn create_many(
    ...
    {
        let query_string = {
            "insert into dogs (std_primitive_bool_as_postgresql_bool, sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null, sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range) select std_primitive_bool_as_postgresql_bool, sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null, sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range from unnest($1, $2, $3) as a(std_primitive_bool_as_postgresql_bool, sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null, sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range) returning id"
        };
        println!("{}", query_string);
        let binded_query = {
            let mut query = sqlx::query::<sqlx::Postgres>(&query_string);
            let current_vec_len = parameters.payload.0.len();
            let(std_primitive_bool_as_postgresql_bool_vec,
            sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null_vec,
            sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range_vec)
            =
            ...
            with_capacity(current_vec_len)), | mut acc, element |
            {
                ...
                acc.1.push(element.sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null)
                ;
                acc.2.push(element.sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range)
                ; acc
            }) ;
            ...
            query =
            query.bind(postgresql_crud::SqlxPostgresTypesPgRangeStdPrimitiveI32
            ::
            into_inner_type_vec(sqlx_postgres_types_pg_range_std_primitive_i32_as_postgresql_int4_range_not_null_vec))
            ;
            query =
            query.bind(postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtc
            ::
            into_inner_type_vec(sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_ts_tz_range_vec))
            ;
            query
        };
