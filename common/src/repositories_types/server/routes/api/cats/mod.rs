...
pub struct Dog {
    ...
    // pub sqlx_postgres_types_pg_range_sqlx_types_time_offset_date_time_as_postgresql_ts_tz_range: postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTsTzRange,//todo fails +
    // pub sqlx_postgres_types_pg_range_sqlx_types_time_offset_date_time_as_postgresql_ts_tz_range_not_null: postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTsTzRangeNotNull,//todo fails +
    ...
    // pub sqlx_postgres_types_pg_range_sqlx_types_time_primitive_date_time_as_postgresql_ts_range: postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTimeAsPostgresqlTsRange,//todo fails +
    // pub sqlx_postgres_types_pg_range_sqlx_types_time_primitive_date_time_as_postgresql_ts_range_not_null: postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTimeAsPostgresqlTsRangeNotNull,//todo fails +
    ...
    // pub sqlx_postgres_types_pg_range_sqlx_types_time_date_as_postgresql_date_range: postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesTimeDateAsPostgresqlDateRange,//todo fails +
    // pub sqlx_postgres_types_pg_range_sqlx_types_time_date_as_postgresql_date_range_not_null: postgresql_crud::SqlxPostgresTypesPgRangeSqlxTypesTimeDateAsPostgresqlDateRangeNotNull,//todo fails +
    ...
    pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz: postgresql_crud::SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz,//todo fails +
    // pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz_not_null: postgresql_crud::SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzNotNull,//todo fails +

    // pub sqlx_types_time_primitive_date_time_as_postgresql_timestamp: postgresql_crud::SqlxTypesTimePrimitiveDateTimeAsPostgresqlTimestamp,//todo fails +
    // pub sqlx_types_time_primitive_date_time_as_postgresql_timestamp_not_null: postgresql_crud::SqlxTypesTimePrimitiveDateTimeAsPostgresqlTimestampNotNull,//todo fails +

    // pub sqlx_types_time_offset_date_time_as_postgresql_timestamp_tz: postgresql_crud::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTz,//todo fails +
    // pub sqlx_types_time_offset_date_time_as_postgresql_timestamp_tz_not_null: postgresql_crud::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTzNotNull,//todo fails +

    // pub sqlx_types_time_date_as_postgresql_date: postgresql_crud::SqlxTypesTimeDateAsPostgresqlDate,//todo fails +
    // pub sqlx_types_time_date_as_postgresql_date_not_null: postgresql_crud::SqlxTypesTimeDateAsPostgresqlDateNotNull,//todo fails +

    // pub sqlx_types_time_time_as_postgresql_time: postgresql_crud::SqlxTypesTimeTimeAsPostgresqlTime,//todo fails +
    // pub sqlx_types_time_time_as_postgresql_time_not_null: postgresql_crud::SqlxTypesTimeTimeAsPostgresqlTimeNotNull,//todo fails +

    // pub sqlx_types_uuid_uuida_as_postgresql_uuid: postgresql_crud::SqlxTypesUuidUuidAsPostgresqlUuid,//todo fails +
    // pub sqlx_types_uuid_uuida_as_postgresql_uuid_not_null: postgresql_crud::SqlxTypesUuidUuidAsPostgresqlUuidNotNull,//todo fails +
    // // pub sqlx_types_uuid_uuida_as_postgresql_uuid_not_null_primary_key: postgresql_crud::SqlxTypesUuidUuidAsPostgresqlUuidNotNullPrimaryKey,// failes +//todo Primary Key support only for Uuid - its simplification. maybe later support something else but now i think uuid v7 is enough //todo fails too but primary key is a different logic. need refactor it as different task 
...
pub struct DogOptions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sqlx_types_chrono_naive_time_as_postgresql_time:
        std::option::Option<postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz:
        std::option::Option<postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize>,
}
impl std::convert::From<Dog> for DogOptions {
    fn from(value: Dog) -> Self {
        Self {
            ...
            sqlx_types_chrono_naive_time_as_postgresql_time: Some(
                postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize::from(
                    value.sqlx_types_chrono_naive_time_as_postgresql_time.0,
                ),
            ),
            sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz: Some(
                postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize::from(
                    value.sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz.0,
                ),
            ),
        }
    }
...
#[derive(Debug)]
pub struct DogSqlxTypesChronoNaiveTimeAsPostgresqlTime {
    pub sqlx_types_chrono_naive_time_as_postgresql_time:
        postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct DogSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz {
    pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz:
        postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTime {
    pub id: postgresql_crud::SqlxTypesUuidUuidWithSerializeDeserialize,
    pub sqlx_types_chrono_naive_time_as_postgresql_time:
        postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct DogIdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz {
    pub id: postgresql_crud::SqlxTypesUuidUuidWithSerializeDeserialize,
    pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz:
        postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize,
}
#[derive(Debug)]
pub struct DogSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz {
    pub sqlx_types_chrono_naive_time_as_postgresql_time:
        postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize,
    pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz:
        postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize,
...
#[derive(Debug)]
pub struct DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz
{
    pub id: postgresql_crud::SqlxTypesUuidUuidWithSerializeDeserialize,
    pub sqlx_types_chrono_naive_time_as_postgresql_time:
        postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize,
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogSqlxTypesChronoNaiveTimeAsPostgresqlTimeTryFromDogOptionsErrorNamed {
    SqlxTypesChronoNaiveTimeAsPostgresqlTimeIsNone {
        #[eo_display_with_serialize_deserialize]
        sqlx_types_chrono_naive_time_as_postgresql_time_is_none: std::string::String,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
impl std::convert::TryFrom<DogOptions> for DogSqlxTypesChronoNaiveTimeAsPostgresqlTime {
    type Error = DogSqlxTypesChronoNaiveTimeAsPostgresqlTimeTryFromDogOptionsErrorNamed;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let sqlx_types_chrono_naive_time_as_postgresql_time =
            match value.sqlx_types_chrono_naive_time_as_postgresql_time {
                Some(value) => value,
                None => {
                    return
                Err(Self :: Error ::
                SqlxTypesChronoNaiveTimeAsPostgresqlTimeIsNone
                {
                    sqlx_types_chrono_naive_time_as_postgresql_time_is_none :
                    std :: string :: String ::
                    from("sqlx_types_chrono_naive_time_as_postgresql_time is None"),
                    code_occurence : error_occurence_lib :: code_occurence ::
                    CodeOccurence ::
                    new(crate :: global_variables :: compile_time ::
                    project_git_info :: PROJECT_GIT_INFO.commit.to_string(),
        ...
        Ok(Self {
            sqlx_types_chrono_naive_time_as_postgresql_time,
        })
    }
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed {
    SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzIsNone {
        #[eo_display_with_serialize_deserialize]
        sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz_is_none: std::string::String,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
impl std::convert::TryFrom<DogOptions> for DogSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz {
    type Error = DogSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz =
            match value.sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz {
                Some(value) => value,
                None => {
                    return
                Err(Self :: Error ::
                SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzIsNone
                {
                    sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz_is_none
                    : std :: string :: String ::
                    from("sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz is None"),
                    code_occurence : error_occurence_lib :: code_occurence ::
                    CodeOccurence ::
                    new(crate :: global_variables :: compile_time ::
                    project_git_info :: PROJECT_GIT_INFO.commit.to_string(),
        ...
        Ok(Self {
            sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz,
        })
    }
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTimeTryFromDogOptionsErrorNamed {
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
            crate::server::postgres::uuid_wrapper::UuidWrapperTryFromPossibleUuidWrapperErrorNamed,
...
impl std::convert::TryFrom<DogOptions> for DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTime {
    type Error = DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTimeTryFromDogOptionsErrorNamed;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let id =
            match value.id {
                Some(value) => value,
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed {
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
            crate::server::postgres::uuid_wrapper::UuidWrapperTryFromPossibleUuidWrapperErrorNamed,
...
impl std::convert::TryFrom<DogOptions> for DogIdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz {
    type Error = DogIdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let id =
            match value.id {
                Some(value) => value,
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed
{
    SqlxTypesChronoNaiveTimeAsPostgresqlTimeIsNone {
        #[eo_display_with_serialize_deserialize]
        sqlx_types_chrono_naive_time_as_postgresql_time_is_none: std::string::String,
...
impl std::convert::TryFrom<DogOptions>
    for DogSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz
{
    type Error =
    DogSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed
    ;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let sqlx_types_chrono_naive_time_as_postgresql_time =
            match value.sqlx_types_chrono_naive_time_as_postgresql_time {
...
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed
{
    UuidWrapperTryFromPossibleUuidWrapper {
        #[eo_error_occurence]
        uuid_wrapper_try_from_possible_uuid_wrapper:
...
impl std::convert::TryFrom<DogOptions>
    for DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz
{
    type Error =
    DogIdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTzTryFromDogOptionsErrorNamed
    ;
    fn try_from(value: DogOptions) -> Result<Self, Self::Error> {
        let id =
            match value.id {
...
pub enum DogColumn {
    ...
    Id,
    #[serde(rename(
        serialize = "sqlx_types_chrono_naive_time_as_postgresql_time",
        deserialize = "sqlx_types_chrono_naive_time_as_postgresql_time"
    ))]
    SqlxTypesChronoNaiveTimeAsPostgresqlTime,
    #[serde(rename(
        serialize = "sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz",
        deserialize = "sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz"
    ))]
...
pub enum DogColumnSelect {
    ...
    SqlxTypesChronoNaiveTimeAsPostgresqlTime,
    SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz,
    IdSqlxTypesChronoNaiveTimeAsPostgresqlTime,
    IdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz,
    SqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz,
    IdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz,
}
impl crate::server::postgres::generate_query::GenerateQuery for DogColumnSelect {
    fn generate_query(&self) -> std::string::String {
        match self
        {
            ...
            SqlxTypesChronoNaiveTimeAsPostgresqlTime => std :: string ::
            String :: from("sqlx_types_chrono_naive_time_as_postgresql_time"),
            Self :: SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz => std ::
            string :: String ::
            from("sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz"), Self
            :: IdSqlxTypesChronoNaiveTimeAsPostgresqlTime => std :: string ::
            String ::
            from("id,sqlx_types_chrono_naive_time_as_postgresql_time"), Self
            :: IdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz => std :: string
            :: String ::
            from("id,sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz"),
            Self ::
            SqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz
            => std :: string :: String ::
            from("sqlx_types_chrono_naive_time_as_postgresql_time,sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz"),
            Self ::
            IdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz
            => std :: string :: String ::
            from("id,sqlx_types_chrono_naive_time_as_postgresql_time,sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz")
        }
    }
}
impl std::default::Default for DogColumnSelect {
    fn default() -> Self {
        Self::IdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz
    }
}
...
impl std::str::FromStr for DogColumnSelect {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value
        {
            "Id" => Ok(Self :: Id), "SqlxTypesChronoNaiveTimeAsPostgresqlTime"
            => Ok(Self :: SqlxTypesChronoNaiveTimeAsPostgresqlTime),
            "SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz" =>
            Ok(Self :: SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz),
            "IdSqlxTypesChronoNaiveTimeAsPostgresqlTime" =>
            Ok(Self :: IdSqlxTypesChronoNaiveTimeAsPostgresqlTime),
            "IdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz" =>
            Ok(Self :: IdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz),
            "SqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz"
            =>
            Ok(Self ::
            SqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz),
            ...
            Err(Self :: Err :: NotCorrect
            {
                ...
                supported_values : std :: string :: String ::
                from("\"Id\",\"SqlxTypesChronoNaiveTimeAsPostgresqlTime\",\"SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz\",\"IdSqlxTypesChronoNaiveTimeAsPostgresqlTime\",\"IdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz\",\"SqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz\",\"IdSqlxTypesChronoNaiveTimeAsPostgresqlTimeSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz\""),
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
                new(crate :: global_variables :: compile_time ::
...
impl DogColumnSelect {
    ...
    where
        ...
        std::option::Option<sqlx::types::chrono::NaiveTime>: sqlx::decode::Decode<'a, R::Database>,
        std::option::Option<sqlx::types::chrono::NaiveTime>: sqlx::types::Type<R::Database>,
        std::option::Option<sqlx::postgres::types::PgTimeTz>: sqlx::decode::Decode<'a, R::Database>,
        std::option::Option<sqlx::postgres::types::PgTimeTz>: sqlx::types::Type<R::Database>,
    {
        let mut id: std::option::Option<
            postgresql_crud::SqlxTypesUuidUuidWithSerializeDeserialize,
        > = None;
        let mut sqlx_types_chrono_naive_time_as_postgresql_time: std::option::Option<
            postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize,
        > = None;
        let mut sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz: std::option::Option<
            postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize,
        > = None;
        match self
        {
            Self :: Id => {} Self :: SqlxTypesChronoNaiveTimeAsPostgresqlTime
            =>
            {
                sqlx_types_chrono_naive_time_as_postgresql_time =
                {
                    ...
                    row.try_get("sqlx_types_chrono_naive_time_as_postgresql_time")
                    ? ;
                    value.map(| value |
                    postgresql_crud::SqlxTypesChronoNaiveTimeWithSerializeDeserialize
                    :: from(postgresql_crud::SqlxTypesChronoNaiveTime(value)))
                } ;
            } Self :: SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz =>
            {
                sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz =
                {
                    ...
                    row.try_get("sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz")
                    ? ;
                    value.map(| value |
                    postgresql_crud::SqlxPostgresTypesPgTimeTzWithSerializeDeserialize
                    :: from(postgresql_crud::SqlxPostgresTypesPgTimeTz(value)))
                } ;
            } Self :: IdSqlxTypesChronoNaiveTimeAsPostgresqlTime =>
            {
                sqlx_types_chrono_naive_time_as_postgresql_time =
                {
                    let value : std :: option :: Option <
            ...
            } Self :: IdSqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz =>
            {
                sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz =
                {
                    let value : std :: option :: Option <
...
pub struct DogColumnReadPermission {
    id: bool,
    sqlx_types_chrono_naive_time_as_postgresql_time: bool,
    sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz: bool,
}
#[test]
    ...
    async fn find_out_if_it_works() {
        ...
        let primary_keys = match try_create_many(
            ...
            CreateManyParameters {
                payload: CreateManyPayload(vec![CreateManyPayloadElement {
                    sqlx_types_chrono_naive_time_as_postgresql_time:
                        postgresql_crud::SqlxTypesChronoNaiveTimeAsPostgresqlTime::default(),
                    sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz:
                        postgresql_crud::SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz::default(),
                }]),
            },
        )
        .await
        ...
        try_read_many(& api_location, ReadManyParameters
        {
            payload : ReadManyPayload
            {
                ...
                sqlx_types_chrono_naive_time_as_postgresql_time : None,
                sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz : None,
        ...
        match try_update_many(
            ...
            UpdateManyParameters {
                            ...
                            UpdateManyPayloadElement
                {
                    id : element,
                    sqlx_types_chrono_naive_time_as_postgresql_time :
                    postgresql_crud :: SqlxTypesChronoNaiveTimeAsPostgresqlTime
                    :: default(),
                    sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz :
                    postgresql_crud ::
                    SqlxPostgresTypesPgTimeTzAsPostgresqlTimeTz :: default()
                }
                        })
                        .collect(),
                ),
...
pub struct CreateManyPayloadElement {
    pub sqlx_types_chrono_naive_time_as_postgresql_time: postgresql_crud::SqlxTypesChronoNaiveTime,
    pub sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz:
    ...
    for CreateManyPayloadElement
{
    ...
    fn try_from(
        ...
        let sqlx_types_chrono_naive_time_as_postgresql_time =
            postgresql_crud::SqlxTypesChronoNaiveTime::from(
                value.sqlx_types_chrono_naive_time_as_postgresql_time,
            );
        // let sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz =
        //     postgresql_crud::SqlxPostgresTypesPgTimeTz::try_from(
        //         value.sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz,
        //     ).unwrap();//HERE
        let sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz = match postgresql_crud::SqlxPostgresTypesPgTimeTz::try_from(
            value.sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz,
        ) {
            Ok(value) => value,
            Err(e) => {
...
pub async fn create_many(
    ...
    {
        let query_string = {
            "insert into dogs (sqlx_types_chrono_naive_time_as_postgresql_time, sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz) select sqlx_types_chrono_naive_time_as_postgresql_time, sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz from unnest($1, $2) as a(sqlx_types_chrono_naive_time_as_postgresql_time, sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz) returning id"
        };
        ...
        let binded_query = {
            ...
            let (
                sqlx_types_chrono_naive_time_as_postgresql_time_vec,
                sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz_vec,
                ...
                |mut acc, element| {
                    acc.0
                        .push(element.sqlx_types_chrono_naive_time_as_postgresql_time);
                    acc.1
                        .push(element.sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz);
                    acc
                },
            );
            query = query.bind(
                postgresql_crud::SqlxTypesChronoNaiveTime::into_inner_type_vec(
                    sqlx_types_chrono_naive_time_as_postgresql_time_vec,
                ),
            );
            query = query.bind(
                postgresql_crud::SqlxPostgresTypesPgTimeTz::into_inner_type_vec(
                    sqlx_postgres_types_pg_time_tz_as_postgresql_time_tz_vec,
                ),
            );
            query
