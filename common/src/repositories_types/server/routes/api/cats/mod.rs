...
pub async fn create_many(
    ...
    {
        let query_string = {
            "insert into dogs (std_primitive_bool_as_postgresql_bool) select std_primitive_bool_as_postgresql_bool from unnest($1) as a(std_primitive_bool_as_postgresql_bool) returning id"
        };
