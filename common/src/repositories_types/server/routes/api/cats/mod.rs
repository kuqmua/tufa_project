...
pub struct UpdateOnePayloadWithSerializeDeserialize {
    std_primitive_bool_as_postgresql_bool:
        std::option::Option<FieldWithSerializeDeserialize<postgresql_crud::StdOptionOptionStdPrimitiveBoolWithSerializeDeserialize>>,
    std_primitive_i16_as_postgresql_small_int:
        std::option::Option<FieldWithSerializeDeserialize<postgresql_crud::StdOptionOptionStdPrimitiveI16WithSerializeDeserialize>>,
    std_primitive_i32_as_postgresql_int:
        std::option::Option<FieldWithSerializeDeserialize<postgresql_crud::StdOptionOptionStdPrimitiveI32WithSerializeDeserialize>>,
    ...
    fn from(value: UpdateOnePayload) -> Self {
        let std_primitive_bool_as_postgresql_bool = match value.std_primitive_bool_as_postgresql_bool {
            Some(value) => Some(FieldWithSerializeDeserialize {
                value: postgresql_crud::StdOptionOptionStdPrimitiveBoolWithSerializeDeserialize::from(value.value)
            }),
            None => None
        };
        let std_primitive_i16_as_postgresql_small_int = match value.std_primitive_i16_as_postgresql_small_int {
            Some(value) => Some(FieldWithSerializeDeserialize {
                value: postgresql_crud::StdOptionOptionStdPrimitiveI16WithSerializeDeserialize::from(value.value)
            }),
            None => None
        };
        let std_primitive_i32_as_postgresql_int = match value.std_primitive_i32_as_postgresql_int {
            Some(value) => Some(FieldWithSerializeDeserialize {
                value: postgresql_crud::StdOptionOptionStdPrimitiveI32WithSerializeDeserialize::from(value.value)
            }),
            None => None
        };
        //
...
DynArcCombinationOfAppStateLogicTraits, >,
    ...
    let value = {
        match binded_query.fetch_one(pg_connection.as_mut()).await {
            Ok(value) => match sqlx::Row::try_get::<std::primitive::i64, &std::primitive::str>(
                &value,
                "std_primitive_i64_as_postgresql_big_serial_not_null_primary_key",
            ) {
                Ok(value) => postgresql_crud::StdPrimitiveI64WithSerializeDeserialize::from(
