...
pub enum SomethingFieldToRead {
    ...
    StdOptionOptionGeneric(std::vec::Vec<DoggieFieldToRead>),
}
...
pub struct SomethingOptionsToRead {
    ...
    std_option_option_generic:
        std::option::Option<postgresql_crud::Value<std::option::Option<DoggieOptionsToRead>>>,
}
        ...
        Self {
            std_option_option_generic: Some(postgresql_crud::Value {
                value: match value.std_option_option_generic.0 {
                    Some(value) => Some(DoggieOptionsToRead::from(value)),
                    None => None,
                },
            }),
        }
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                let __field0 = match serde::de::SeqAccess::next_element::<
                    std::option::Option<
                        std::result::Result<
                            std::option::Option<DoggieOptionsToRead>,
                            std::string::String,
                        >,
                    >,
                >(&mut __seq)?
                ...
                serde::__private::Ok(SomethingOptionsToRead {
                    std_option_option_generic: match __field0 {
                ...
                SomethingOptionToUpdate::StdOptionOptionGeneric(value) => match value.value {
                    ...
                    None => {
                        query = query.bind(sqlx::types::Json(
                            None::<std::option::Option<SomethingOptionsToUpdate>>,
                        ));
                    }
                },
            }
...
pub struct SomethingToCreate {
    pub std_option_option_generic: postgresql_crud::JsonStdOptionOptionGeneric<DoggieToCreate>,
}
impl postgresql_crud ::
StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
...
impl<'a> postgresql_crud::BindQuery<'a> for SomethingToCreate {
    ...
    fn try_generate_bind_increments(
        ...
        match self
            .std_option_option_generic
            .0
            .try_generate_bind_increments(increment)
        {
            Ok(value) => {
    ...
    fn bind_value_to_query(
        ...
        query = self.std_option_option_generic.0.bind_value_to_query(query);
        query
    }
}
...
impl<'de> serde::Deserialize<'de> for DoggieOptionsToRead {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl serde::de::Visitor<'_> for __FieldVisitor {
            ...
            {
                match __value {
                    "std_primitive_i16" => serde::__private::Ok(__Field::__field0),
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
            fn visit_bytes<__E>(self, __value: &[u8]) -> serde::__private::Result<Self::Value, __E>
            ...
            {
                match __value {
                    b"std_primitive_i16" => serde::__private::Ok(__Field::__field0),
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
        }
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                >(&mut __seq)?
                {
                    ...
                    serde::__private::None => {
                        return serde::__private::Err(serde::de::Error::invalid_length(
                            0usize,
                            &"struct DoggieOptionsToRead with 1 elements",
                        ));
                    }
                };
                serde::__private::Ok(DoggieOptionsToRead {
                    std_primitive_i16: match __field0 {
                        Some(value) => match value {
                            Ok(value) => Some(postgresql_crud::Value { value: value }),
                            Err(error) => {
                                return Err(serde::de::Error::custom(error));
        ...
        #[doc(hidden)]
        const FIELDS: &'static [&'static str] = &["std_primitive_i16"];
        serde::Deserializer::deserialize_struct(
            __deserializer,
            "DoggieOptionsToRead",
            FIELDS,
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct DoggieOptionsToUpdate(pub std::vec::Vec<DoggieOptionToUpdate>);
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
