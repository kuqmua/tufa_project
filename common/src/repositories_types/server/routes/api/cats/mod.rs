                        ...
                        Some(value) => {
                            ...
                            for (index, element) in &value.iter().enumerate().collect::<std::vec::Vec<(usize, &DoggieJsonArrayElementChange)>>() {
                                match postgresql_crud::JsonArrayElementBindQuery::try_generate_create_bind_increments(*element, increment) {
                                    ...
                                    Err(error) => {
                                        return Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed::
                                        StdOptionOptionStdVecVecGenericWithIdDoggieTryGenerateJsonArrayElementCreateBindIncrements
                                        {
                                            std_option_option_std_vec_vec_generic_with_id_doggie_try_generate_json_array_element_create_bind_increments
                                            : error, code_occurence : error_occurence_lib ::
            ...
            match element {
                ...
                SomethingOptionToUpdate::StdOptionOptionStdVecVecGenericWithId(value) => {
                    match &value.value {
                        ...
                        None => {
                            query = query.bind(sqlx::types::Json(None::<std::option::Option<std::vec::Vec<DoggieJsonArrayElementChange>>>));
                        }
                    }
                }
            }
        ...
        match self.std_option_option_std_vec_vec_generic_with_id.0 {
            ...
            None => {
                query = query.bind(sqlx::types::Json(
                    None::<std::option::Option<DoggieToCreate>>,
                ));
            }
        }
        query
