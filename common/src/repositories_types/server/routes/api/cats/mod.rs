...
impl<'de> serde::Deserialize<'de> for SomethingOptionsToRead {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl serde::de::Visitor<'_> for __FieldVisitor {
                ...
                __E: serde::de::Error,
            {
                match __value {
                    ...
                    "std_vec_vec_generic" => serde::__private::Ok(__Field::__field2),
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
                ...
                __E: serde::de::Error,
            {
                match __value {
                    ...
                    b"std_vec_vec_generic" => serde::__private::Ok(__Field::__field2),
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
        }
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                >(&mut __seq)?
                {
                    ...
                    serde::__private::None => {
                        return serde::__private::Err(serde::de::Error::invalid_length(
                            0usize,
                            &"struct SomethingOptionsToRead with 3 elements",
                        ));
                    }
                };
                ...
                serde::__private::Ok(SomethingOptionsToRead {
                    ...
                    std_primitive_i8: match __field1 {
                        Some(value) => match value {
                            Ok(value) => Some(postgresql_crud::Value { value: value }),
                            Err(error) => {
                                return Err(serde::de::Error::custom(error));
                    ...
                    std_vec_vec_generic: match __field2 {
                        Some(value) => match value {
        ...
        #[doc(hidden)]
        const FIELDS: &'static [&'static str] = &["id", "std_primitive_i8", "std_vec_vec_generic"];
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl serde::de::Visitor<'_> for __FieldVisitor {
                ...
                __E: serde::de::Error,
            {
                match __value {
                    "id" => serde::__private::Ok(__Field::__field0),
                    "std_primitive_i32" => serde::__private::Ok(__Field::__field1),
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
            fn visit_bytes<__E>(self, __value: &[u8]) -> serde::__private::Result<Self::Value, __E>
                ...
                __E: serde::de::Error,
            {
                match __value {
                    b"id" => serde::__private::Ok(__Field::__field0),
                    b"std_primitive_i32" => serde::__private::Ok(__Field::__field1),
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
        }
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                >(&mut __seq)?
                {
                    ...
                    serde::__private::None => {
                        return serde::__private::Err(serde::de::Error::invalid_length(
                            0usize,
                            &"struct CatOptionsToRead with 2 elements",
                        ));
                    }
                };
                let __field1 = match serde::de::SeqAccess::next_element::<
                ...
                serde::__private::Ok(CatOptionsToRead {
                    ...
                    std_primitive_i32: match __field1 {
                        Some(value) => match value {
                            Ok(value) => Some(postgresql_crud::Value { value: value }),
                            Err(error) => {
                                return Err(serde::de::Error::custom(error));
        ...
        #[doc(hidden)]
        const FIELDS: &'static [&'static str] = &["id", "std_primitive_i32"];
        serde::Deserializer::deserialize_struct(
            __deserializer,
            "CatOptionsToRead",
            FIELDS,
...
impl error_occurence_lib::ToStdStringString for CatKey {
    fn to_std_string_string(&self) -> std::string::String {
        match &self {
