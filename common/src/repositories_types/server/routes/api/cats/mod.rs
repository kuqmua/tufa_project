                ...
                DoggieOptionsToUpdate {
                    ...
                    fields: vec![
                        DoggieOptionToUpdate::StdPrimitiveI16(postgresql_crud::Value {
                            value: std::primitive::i16::default()
                        })
                    ],
                }
...
pub enum SomethingFieldToRead {
    ...
    StdPrimitiveI8,
    #[serde(rename(
        serialize = "std_option_option_std_primitive_i8",
        deserialize = "std_option_option_std_primitive_i8"
    ))]
    StdOptionOptionStdPrimitiveI8,
    #[serde(rename(
        serialize = "std_vec_vec_std_primitive_i8",
        deserialize = "std_vec_vec_std_primitive_i8"
    ))]
    ...
    #[serde(rename(
        serialize = "std_option_option_std_vec_vec_std_primitive_i8",
        deserialize = "std_option_option_std_vec_vec_std_primitive_i8"
    ))]
    ...
    #[serde(rename(
        serialize = "std_vec_vec_std_option_option_std_primitive_i8",
        deserialize = "std_vec_vec_std_option_option_std_primitive_i8"
    ))]
    ...
    #[serde(rename(
        serialize = "std_option_option_std_vec_vec_std_option_option_std_primitive_i8",
        deserialize = "std_option_option_std_vec_vec_std_option_option_std_primitive_i8"
    ))]
...
pub struct SomethingOptionsToRead {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    std_option_option_std_primitive_i8:
        std::option::Option<postgresql_crud::Value<std::option::Option<std::primitive::i8>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    std_vec_vec_std_primitive_i8:
        std::option::Option<postgresql_crud::Value<std::vec::Vec<std::primitive::i8>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    std_option_option_std_vec_vec_std_primitive_i8: std::option::Option<
        postgresql_crud::Value<std::option::Option<std::vec::Vec<std::primitive::i8>>>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    std_vec_vec_std_option_option_std_primitive_i8: std::option::Option<
        postgresql_crud::Value<std::vec::Vec<std::option::Option<std::primitive::i8>>>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    std_option_option_std_vec_vec_std_option_option_std_primitive_i8: std::option::Option<
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    std_option_option_generic:
        std::option::Option<postgresql_crud::Value<std::option::Option<MouseOptionsToRead>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    fn from(value: Something) -> Self {
        Self {
            ...
            std_option_option_std_primitive_i8: Some(postgresql_crud::Value {
                value: match value.std_option_option_std_primitive_i8.0 {
            ...
            std_option_option_std_vec_vec_std_option_option_std_primitive_i8: Some(
                postgresql_crud::Value {
                    value: match value
                        .std_option_option_std_vec_vec_std_option_option_std_primitive_i8
                        .0
        ...
        impl serde::de::Visitor<'_> for __FieldVisitor {
                ...
                __E: serde::de::Error,
            {
                match __value {
                    ...
                    "std_option_option_std_vec_vec_generic_with_id" => {
                        serde::__private::Ok(__Field::__field9)
                    }
                    _ => serde::__private::Ok(__Field::__ignore),
                }
            }
                ...
                __E: serde::de::Error,
            {
                match __value {
                    ...
                    b"std_option_option_std_primitive_i8" => {
                        serde::__private::Ok(__Field::__field1)
                    }
                    b"std_vec_vec_std_primitive_i8" => serde::__private::Ok(__Field::__field2),
                    b"std_option_option_std_vec_vec_std_primitive_i8" => {
                        serde::__private::Ok(__Field::__field3)
                    }
                    b"std_vec_vec_std_option_option_std_primitive_i8" => {
                        serde::__private::Ok(__Field::__field4)
                    }
                    b"std_option_option_std_vec_vec_std_option_option_std_primitive_i8" => {
                        serde::__private::Ok(__Field::__field5)
                    }
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                >(&mut __seq)?
                {
                    ...
                    serde::__private::None => {
                        return serde::__private::Err(serde::de::Error::invalid_length(
                            0usize,
                            &"struct SomethingOptionsToRead with 10 elements",
                        ));
                    }
                };
                let __field1 = match serde::de::SeqAccess::next_element::<
                    std::option::Option<
                        std::result::Result<
                            std::option::Option<std::primitive::i8>,
                            std::string::String,
                        >,
                    >,
                >(&mut __seq)?
                ...
                let __field8 = match serde::de::SeqAccess::next_element::<
                    std::option::Option<
                        std::result::Result<
                            std::vec::Vec<
                ...
                let __field9 = match serde::de::SeqAccess::next_element::<
                    std::option::Option<
                        std::result::Result<
                            std::option::Option<
                                std::vec::Vec<
                ...
                __A: serde::de::MapAccess<'de>,
            {
                ...
                let mut __field7: serde::__private::Option<
                    ...
                    >,
                > = serde::__private::None;
                let mut __field8: serde::__private::Option<
                    std::option::Option<
                        std::result::Result<
                            std::vec::Vec<
                                std::result::Result<DoggieOptionsToRead, std::string::String>,
                    ...
                    >,
                > = serde::__private::None;
                let mut __field9: serde::__private::Option<
                    std::option::Option<
                        std::result::Result<
                            std::option::Option<
                                std::vec::Vec<
                    ...
                    match __key {
                        ...
                        __Field::__field5 => {
                            if serde::__private::Option::is_some(&__field5) {
                                return serde :: __private ::
                                Err(< __A :: Error as serde :: de :: Error > ::
                                duplicate_field("std_option_option_std_vec_vec_std_option_option_std_primitive_i8",),);
                            }
                        ...
                        __Field::__field8 => {
                            ...
                            __field8 = serde::__private::Some(serde::de::MapAccess::next_value::<
                                std::option::Option<
                                    std::result::Result<
                                        std::vec::Vec<
                                            std::result::Result<
                ...
                let __field1 = match __field1 {
                    ...
                    serde::__private::None => {
                        serde::__private::de::missing_field("std_option_option_std_primitive_i8")?
                    }
                };
                let __field2 = match __field2 {
                    serde::__private::Some(__field2) => __field2,
                    serde::__private::None => {
                        serde::__private::de::missing_field("std_vec_vec_std_primitive_i8")?
                    }
                };
                ...
                let __field7 = match __field7 {
                    ...
                    serde::__private::None => {
                        serde::__private::de::missing_field("std_option_option_generic")?
                    }
                };
...
for Something
{
    ...
    -> Self
    {
        Self
        {
            ...
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
            std_option_option_std_primitive_i8 : postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
            std_vec_vec_std_primitive_i8 : postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
            std_option_option_std_vec_vec_std_primitive_i8 : postgresql_crud
            ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
            std_vec_vec_std_option_option_std_primitive_i8 : postgresql_crud
            ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
...
impl error_occurence_lib::ToStdStringString for SomethingFieldToUpdate {
    fn to_std_string_string(&self) -> std::string::String {
        match &self {
            ...
            Self::StdOptionOptionStdVecVecStdPrimitiveI8 => {
                "std_option_option_std_vec_vec_std_primitive_i8".to_owned()
            }
            Self::StdVecVecStdOptionOptionStdPrimitiveI8 => {
                "std_vec_vec_std_option_option_std_primitive_i8".to_owned()
            }
            Self::StdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8 => {
                "std_option_option_std_vec_vec_std_option_option_std_primitive_i8".to_owned()
            }
...
for SomethingOptionToUpdate
{
    fn
    all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()
    -> std :: vec :: Vec < SomethingOptionToUpdate >
    {
        vec!
        [SomethingOptionToUpdate ::
        StdPrimitiveI8(postgresql_crud :: Value
        {
            value : < postgresql_crud :: JsonStdPrimitiveI8 as postgresql_crud
            ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0
        }), SomethingOptionToUpdate ::
        StdOptionOptionStdPrimitiveI8(postgresql_crud :: Value
        {
            value : match < postgresql_crud ::
            JsonStdOptionOptionStdPrimitiveI8 as postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0
            { Some(value) => Some(value.0), None => None }
        }), SomethingOptionToUpdate ::
        StdVecVecStdPrimitiveI8(postgresql_crud :: Value
        {
            value : < postgresql_crud :: JsonStdVecVecStdPrimitiveI8 as
            postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0.into_iter().map(|
            element | element.0).collect()
        }), SomethingOptionToUpdate ::
        StdOptionOptionStdVecVecStdPrimitiveI8(postgresql_crud :: Value
        {
            value : match < postgresql_crud ::
            JsonStdOptionOptionStdVecVecStdPrimitiveI8 as postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0
            {
                Some(value) =>
                Some(value.into_iter().map(| element | element.0).collect()),
                None => None
            }
        }), SomethingOptionToUpdate ::
        StdVecVecStdOptionOptionStdPrimitiveI8(postgresql_crud :: Value
        {
            value : < postgresql_crud ::
            JsonStdVecVecStdOptionOptionStdPrimitiveI8 as postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0.into_iter().map(|
            element | match element
            { Some(value) => Some(value.0), None => None }).collect()
        }), SomethingOptionToUpdate ::
        StdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8(postgresql_crud
        :: Value
        {
            value : match < postgresql_crud ::
            JsonStdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8 as
            postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0
            {
                Some(value) =>
                Some(value.into_iter().map(| element | match element
                { Some(value) => Some(value.0), None => None }).collect()),
                None => None
            }
        }), SomethingOptionToUpdate ::
        Generic(postgresql_crud :: Value
        {
            value : postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
        ...
        StdOptionOptionGeneric(postgresql_crud :: Value
        {
            value :
        ...
        StdOptionOptionStdVecVecGenericWithId(postgresql_crud :: Value
        {
            value :
        ...
        }
        {
            ...
            for element in &self.0 {
                match element
                {
                    ...
                    {
                        let value = SomethingFieldToUpdate :: StdPrimitiveI8; if
                        acc.contains(& value)
                        {
                            return
                    ...
                    StdOptionOptionStdPrimitiveI8(_) =>
                    {
                        let value = SomethingFieldToUpdate ::
                        StdOptionOptionStdPrimitiveI8; if acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                            :: NotUniqueField
                    ...
                    {
                        let value = SomethingFieldToUpdate ::
                        StdVecVecStdPrimitiveI8; if acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                            :: NotUniqueField
                    ...
                    StdOptionOptionStdVecVecStdPrimitiveI8(_) =>
                    {
                        let value = SomethingFieldToUpdate ::
                        StdOptionOptionStdVecVecStdPrimitiveI8; if
                        acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                    ...
                    StdVecVecStdOptionOptionStdPrimitiveI8(_) =>
                    {
                        let value = SomethingFieldToUpdate ::
                        StdVecVecStdOptionOptionStdPrimitiveI8; if
                        acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                    ...
                    StdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8(_) =>
                    {
                        let value = SomethingFieldToUpdate ::
                        StdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8; if
                        acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                    ...
                    {
                        let value = SomethingFieldToUpdate :: Generic; if
                        acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                    ...
                    {
                        let value = SomethingFieldToUpdate ::
                        StdOptionOptionGeneric; if acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                            :: NotUniqueField
                    ...
                    {
                        let value = SomethingFieldToUpdate ::
                        StdVecVecGenericWithId; if acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                            :: NotUniqueField
                    ...
                    StdOptionOptionStdVecVecGenericWithId(_) =>
                    {
                        let value = SomethingFieldToUpdate ::
                        StdOptionOptionStdVecVecGenericWithId; if
                        acc.contains(& value)
                        {
                            return
                            Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
            ...
            match &element {
                SomethingOptionToUpdate::StdPrimitiveI8(_) => match increment.checked_add(1) {
                    Some(value) => {
                        *increment = value;
                        acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_primitive_i8}}',${increment})");
                    }
                    None => {
                        return
                        Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::StdOptionOptionStdPrimitiveI8(_) => {
                    match increment.checked_add(1) {
                        Some(value) => {
                            *increment = value;
                            acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_option_option_std_primitive_i8}}',${increment})");
                        }
                        None => {
                            return
                        Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::StdVecVecStdPrimitiveI8(_) => {
                    match increment.checked_add(1) {
                        Some(value) => {
                            *increment = value;
                            acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_vec_vec_std_primitive_i8}}',${increment})");
                        }
                        None => {
                            return
                        Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::StdOptionOptionStdVecVecStdPrimitiveI8(_) => {
                    match increment.checked_add(1) {
                        Some(value) => {
                            *increment = value;
                            acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_option_option_std_vec_vec_std_primitive_i8}}',${increment})");
                        }
                        None => {
                            return
                        Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::StdVecVecStdOptionOptionStdPrimitiveI8(_) => {
                    match increment.checked_add(1) {
                        Some(value) => {
                            *increment = value;
                            acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_vec_vec_std_option_option_std_primitive_i8}}',${increment})");
                        }
                        None => {
                            return
                        Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::StdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8(
                    _,
                ) => match increment.checked_add(1) {
                    Some(value) => {
                        *increment = value;
                        acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_option_option_std_vec_vec_std_option_option_std_primitive_i8}}',${increment})");
                    }
                    None => {
                        return
                        Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::Generic(value) => {
                    match value.value.try_generate_bind_increments(
                        ...
                        Err(error) => {
                            return Err(
                                SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed::Cat {
                                    cat: error,
                                    code_occurence: error_occurence_lib::code_occurence!(),
                                },
                            );
                ...
                SomethingOptionToUpdate::StdOptionOptionGeneric(value) => match &value.value {
                    Some(value) => match value.try_generate_bind_increments(
                        ...
                        Err(error) => {
                            return
                                ...
                                :: Mouse
                                {
                                    mouse : error, code_occurence : error_occurence_lib ::
                                    code_occurence! (),
                                });
                        }
                    },
                    None => match increment.checked_add(1) {
                        Some(value) => {
                            *increment = value;
                            acc = format!
                                    ("jsonb_set({acc},'{previous_jsonb_set_path}std_option_option_generic',${increment})");
                        }
                        None => {
                            return
                                    Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                    ...
                    match &value.value {
                        Some(value) => {
                            ...
                            let delete_query_part_acc = {
                                if value.delete.is_empty() {
                                    ...
                                    let mut delete_query_part_acc = std::string::String::default();
                                    for (index, element) in
                                        &value.delete.iter().enumerate().collect::<std::vec::Vec<(
                                            usize,
                                            &postgresql_crud::JsonUuid,
                                        )>>(
                                        )
                            ...
                            let maybe_jsonb_build_array_in_case_of_null =
                                if create_query_part_acc.is_empty() {
                        ...
                        None => match increment.checked_add(1) {
                            Some(value) => {
                                *increment = value;
                                acc = format!
                                ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_option_option_std_vec_vec_generic_with_id}}',${increment})");
                            }
                            None => {
                                return
                                Err(SomethingOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                ...
                SomethingOptionToUpdate::StdOptionOptionGeneric(value) => match value.value {
                    ...
                    None => {
                        query = query.bind(sqlx::types::Json(
                            None::<std::option::Option<MouseToCreate>>,
                        ));
                    }
                },
                SomethingOptionToUpdate::StdVecVecGenericWithId(value) => {
...
pub struct SomethingToCreate {
    ...
    pub std_option_option_std_primitive_i8: postgresql_crud::JsonStdOptionOptionStdPrimitiveI8,
    pub std_vec_vec_std_primitive_i8: postgresql_crud::JsonStdVecVecStdPrimitiveI8,
    pub std_option_option_std_vec_vec_std_primitive_i8:
        postgresql_crud::JsonStdOptionOptionStdVecVecStdPrimitiveI8,
    pub std_vec_vec_std_option_option_std_primitive_i8:
        postgresql_crud::JsonStdVecVecStdOptionOptionStdPrimitiveI8,
    pub std_option_option_std_vec_vec_std_option_option_std_primitive_i8:
        postgresql_crud::JsonStdOptionOptionStdVecVecStdOptionOptionStdPrimitiveI8,
...
impl<'a> postgresql_crud::BindQuery<'a> for SomethingToCreate {
    ...
    fn try_generate_bind_increments(
            ...
            Some(incr) => {
                *increment = incr;
                increments.push_str(&format!(
                    "'std_option_option_std_primitive_i8',${increment},"
                ));
            }
            None => {
                return Err(
        ...
        match increment.checked_add(1) {
            Some(incr) => {
                *increment = incr;
                increments.push_str(&format!(
                    "'std_option_option_std_vec_vec_std_primitive_i8',${increment},"
                ));
            }
            None => {
                return Err(
        ...
        match increment.checked_add(1) {
            Some(incr) => {
                *increment = incr;
                increments.push_str(&format!(
                    "'std_vec_vec_std_option_option_std_primitive_i8',${increment},"
                ));
            }
            None => {
                return Err(
        ...
        match increment.checked_add(1) {
            Some(incr) => {
                *increment = incr;
                increments.push_str(& format!
                ("'std_option_option_std_vec_vec_std_option_option_std_primitive_i8',${increment},"));
            }
            None => {
                return Err(
                    postgresql_crud::TryGenerateBindIncrementsErrorNamed::CheckedAdd {
        ...
        }
        {
            ...
            increments.push_str(& format!
            ("'std_option_option_std_vec_vec_generic_with_id',{maybe_jsonb_build_array_stringified},"));
        }
        let _ = increments.pop();
        Ok(format!("jsonb_build_object({increments})"))
    }
    fn bind_value_to_query(
        ...
        query = query.bind(sqlx::types::Json(
            self.std_option_option_std_vec_vec_std_primitive_i8.0,
        ));
        query = query.bind(sqlx::types::Json(
            self.std_vec_vec_std_option_option_std_primitive_i8.0,
        ));
        query = query.bind(sqlx::types::Json(
            self.std_option_option_std_vec_vec_std_option_option_std_primitive_i8
                .0,
        ));
        ...
        match self.std_option_option_std_vec_vec_generic_with_id.0 {
            ...
            None => {
                query = query.bind(sqlx::types::Json(
                    None::<std::option::Option<std::vec::Vec<DoggieToCreate>>>,
                ));
            }
        }
        query
...
impl postgresql_crud ::
AllEnumVariantsArrayStdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
for CatOptionToUpdate
{
    fn
    all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()
    -> std :: vec :: Vec < CatOptionToUpdate >
    {
        vec!
        [CatOptionToUpdate ::
        StdPrimitiveI32(postgresql_crud :: Value
        {
            value : < postgresql_crud :: JsonStdPrimitiveI32 as
            postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            > ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element().0
            ...
            match &element {
                CatOptionToUpdate::StdPrimitiveI32(_) => match increment.checked_add(1) {
                    Some(value) => {
                        *increment = value;
                        acc = format!
                        ("jsonb_set({acc},'{{{previous_jsonb_set_path}std_primitive_i32}}',${increment})");
                    }
                    None => {
                        return Err(
...
impl error_occurence_lib::ToStdStringString
    for MouseGeneratePostgresqlQueryPartToReadFromSelfVecErrorNamed
{
    fn to_std_string_string(&self) -> std::string::String {
        format!("{self:?}")
    }
...
impl
    postgresql_crud::GeneratePostgresqlQueryPartToRead<
        MouseGeneratePostgresqlQueryPartToReadFromSelfVecErrorNamed,
        (),
    > for MouseFieldToRead
{
    fn generate_postgresql_query_part_to_read_from_self_vec(
        value: &std::vec::Vec<Self>,
        column_name_and_maybe_field_getter: &std::primitive::str,
    ...
    ) -> Result<std::string::String, MouseGeneratePostgresqlQueryPartToReadFromSelfVecErrorNamed>
    {
        if value.is_empty() {
            return Err(
                MouseGeneratePostgresqlQueryPartToReadFromSelfVecErrorNamed::FieldsFilterIsEmpty {
                    code_occurence: error_occurence_lib::code_occurence!(),
                },
            );
        }
        ...
        for element in value {
            if unique.contains(&element) {
                return
                Err(MouseGeneratePostgresqlQueryPartToReadFromSelfVecErrorNamed
                :: NotUniqueFieldFilter
                {
                    field : element.clone(), code_occurence :
                    error_occurence_lib :: code_occurence! (),
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                >(&mut __seq)?
                {
                    ...
                    serde::__private::None => {
                        return serde::__private::Err(serde::de::Error::invalid_length(
                            0usize,
                            &"struct MouseOptionsToRead with 1 elements",
                        ));
                    }
                };
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            where
                __E: serde::Deserializer<'de>,
            {
                let __field0: Result<MouseOptionsToRead, std::string::String> = <Result<
                    MouseOptionsToRead,
                    std::string::String,
                > as serde::Deserialize>::deserialize(
                    __e
            ...
            {
                let __field0 = match serde::de::SeqAccess::next_element::<
                    Result<MouseOptionsToRead, std::string::String>,
                >(&mut __seq)?
                {
                    serde::__private::Some(__value) => __value,
                    serde::__private::None => {
                        return serde::__private::Err(serde::de::Error::invalid_length(
                            0usize,
                            &"tuple struct MouseReader with 1 element",
                        ));
                    }
                };
                serde::__private::Ok(MouseReader(match __field0 {
...
impl postgresql_crud ::
AllEnumVariantsArrayStdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
for MouseOptionToUpdate
{
    fn
    all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()
    -> std :: vec :: Vec < MouseOptionToUpdate >
    {
        vec!
        [MouseOptionToUpdate ::
        StdPrimitiveI32(postgresql_crud :: Value
...
impl
    postgresql_crud::GeneratePostgresqlQueryPartToUpdate<
        MouseOptionsToUpdateTryGenerateBindIncrementsErrorNamed,
    > for MouseOptionsToUpdate
{
    fn try_generate_bind_increments(
        &self,
        ...
        if self.0.is_empty() {
            return Err(
                MouseOptionsToUpdateTryGenerateBindIncrementsErrorNamed::FieldsIsEmpty {
                    code_occurence: error_occurence_lib::code_occurence!(),
                },
            );
        }
            ...
            for element in &self.0 {
                match element {
                    MouseOptionToUpdate::StdPrimitiveI32(_) => {
                        ...
                        if acc.contains(&value) {
                            return
                            Err(MouseOptionsToUpdateTryGenerateBindIncrementsErrorNamed
                            :: NotUniqueField
                            {
                                field : value, code_occurence : error_occurence_lib ::
                                code_occurence! (),
        ...
        for element in &self.0 {
            match &element {
                MouseOptionToUpdate::StdPrimitiveI32(_) => match increment.checked_add(1) {
                    ...
                    None => {
                        return Err(
                            MouseOptionsToUpdateTryGenerateBindIncrementsErrorNamed::CheckedAdd {
                                code_occurence: error_occurence_lib::code_occurence!(),
                            },
                        );
                    }
