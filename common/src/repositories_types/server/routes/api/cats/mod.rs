...
//todo this need for old version of update_many. later need to refactor update many and remove this
    ...
    impl<'de> serde::Deserialize<'de> for StdVecVecGenericWithIdDoggieOptionsToReadOrigin {
        fn deserialize<__D>(
            __deserializer: __D,
            ...
            __D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = StdVecVecGenericWithIdDoggieOptionsToReadOrigin;
                fn expecting(
                    &self,
                    __formatter: &mut serde::__private::Formatter<'_>,
                ) -> serde::__private::fmt::Result {
                    serde::__private::Formatter::write_str(
                        __formatter,
                        "struct StdVecVecGenericWithIdDoggieOptionsToReadOrigin",
                    )
                }
                #[inline]
                fn visit_seq<__A>(
                    ...
                    __A: serde::de::SeqAccess<'de>,
                {
                        ...
                        serde::__private::None => {
                            return serde::__private::Err(
                                serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct StdVecVecGenericWithIdDoggieOptionsToReadOrigin with 2 elements",
                                ),
                            );
                        }
                    };
                    ...
                    if let (None, None) = (&__field0, &__field1) {
                    ...
                    serde::__private::Ok(StdVecVecGenericWithIdDoggieOptionsToReadOrigin {
                        id: __field0,
