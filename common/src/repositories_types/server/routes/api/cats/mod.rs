...
//     pub sqlx_types_uuid_uuid_as_postgresql_uuid: postgresql_crud::StdOptionOptionSqlxTypesUuidUuid,
// }
// #[derive(Debug)]
...
//     sqlx_types_uuid_uuid_as_postgresql_uuid: postgresql_crud::StdOptionOptionSqlxTypesUuidUuid,
// }
// #[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
...
//             );
//         // let sqlx_types_uuid_uuid_as_postgresql_uuid =
//         //     match postgresql_crud::StdOptionOptionSqlxTypesUuidUuid::try_from(
//         //         value.sqlx_types_uuid_uuid_as_postgresql_uuid,
//         //     ) {
//         //         Ok(value) => value,
//         //         Err(error) => {
//         //             return Err(Self::Error::SqlxTypesUuidUuidAsPostgresqlUuid {
//         //                 std_primitive_i64_as_postgresql_big_serial_not_null_primary_key: error,
...
//         //         }
//         //     };
//         let sqlx_types_uuid_uuid_as_postgresql_uuid = postgresql_crud::StdOptionOptionSqlxTypesUuidUuid::from(value.sqlx_types_uuid_uuid_as_postgresql_uuid);
//         // Ok(
//         Self {
...
//     fn from(value: CreateManyPayloadWithSerializeDeserialize) -> 
//     // Result<
//     Self
//     // , 
//     // Self::Error> 
...
//             //     Err(error) => {
//             //         return Err(
//             //             Self::Error::StdPrimitiveI64AsPostgresqlBigSerialNotNullPrimaryKey {
//             //                 std_primitive_i64_as_postgresql_big_serial_not_null_primary_key: error,
//             //                 code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
//             //                     file!().to_owned(),
//             //                     line!(),
...
//             );
//         let sqlx_types_uuid_uuid_as_postgresql_uuid =
//             postgresql_crud::StdOptionOptionSqlxTypesUuidUuid::from(
//                 value.sqlx_types_uuid_uuid_as_postgresql_uuid,
//             );
//         Self {
//             std_primitive_bool_as_postgresql_bool,
...
//         ) {
//             Ok(value) => {
//                 // let value = match CreateManyPayload::try_from(value) {
//                 //     Ok(value) => value,
//                 //     Err(error_0) => {
...
//         let _ = values.pop();
//         format!
//         ("insert into dogs (std_primitive_bool_as_postgresql_bool, std_primitive_i16_as_postgresql_small_int, std_primitive_i32_as_postgresql_int, sqlx_types_uuid_uuid_as_postgresql_uuid) values {values}  returning std_primitive_i64_as_postgresql_big_serial_not_null_primary_key")
//     };
...
//                                 axum::Json(TryCreateManyRouteLogicResponseVariants::from(error)),
//                             );
//                             *response.status_mut() = axum::http::StatusCode::INTERNAL_SERVER_ERROR;
//                             return response;
//                         }
