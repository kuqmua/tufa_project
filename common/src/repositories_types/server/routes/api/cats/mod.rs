...
//todo this need for old version of update_many. later need to refactor update many and remove this
    ...
    impl<'de> serde::Deserialize<'de> for StdVecVecGenericWithIdDoggieOptionsToUpdate {
        fn deserialize<__D>(
            __deserializer: __D,
            ...
            __D: serde::Deserializer<'de>,
        {
            ...
            struct __Visitor<'de> {
                marker: serde::__private::PhantomData<
                    StdVecVecGenericWithIdDoggieOptionsToUpdate,
                >,
                lifetime: serde::__private::PhantomData<&'de ()>,
            }
            impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = StdVecVecGenericWithIdDoggieOptionsToUpdate;
                fn expecting(
                    &self,
                    __formatter: &mut serde::__private::Formatter<'_>,
                ) -> serde::__private::fmt::Result {
                    serde::__private::Formatter::write_str(
                        __formatter,
                        "struct StdVecVecGenericWithIdDoggieOptionsToUpdate",
                    )
                }
                #[inline]
                fn visit_seq<__A>(
                    ...
                    __A: serde::de::SeqAccess<'de>,
                {
                        ...
                        serde::__private::None => {
                            return serde::__private::Err(
                                serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct StdVecVecGenericWithIdDoggieOptionsToUpdate with 2 elements",
                                ),
                            );
                        }
                    };
                    let __field1 = match serde::de::SeqAccess::next_element::<
                        std::vec::Vec<StdVecVecGenericWithIdDoggieOptionToUpdateOrigin>,
                    >(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(
                    ...
                    //todo check vec is empty
                    //todo unique fields
                    serde::__private::Ok(StdVecVecGenericWithIdDoggieOptionsToUpdate {
                        id: __field0,
                        fields: __field1,
                    })
                }
                        ...
                        match __key {
                            ...
                            __Field::__field1 => {
                                ...
                                __field1 = serde::__private::Some(
                                    serde::de::MapAccess::next_value::<
                                        std::vec::Vec<
                                            StdVecVecGenericWithIdDoggieOptionToUpdateOrigin,
                                        >,
                                    >(&mut __map)?,
                                );
                            }
