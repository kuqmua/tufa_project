    ...
    match future.await
    {
        Ok(response) => {
                            ...
                            match serde_json::from_str::<TryDeleteOneResponseVariantsTvfrr500InternalServerError>(&response_text) {
                                Ok(value) => Ok(TryDeleteOneResponseVariants :: from(value))
                                    ...
                                    Result<
                                        ...
                                        crate::common::api_request_unexpected_error::ApiRequestUnexpectedError,
                                    >, 
                                Err(e) => Err(crate::common::api_request_unexpected_error::ApiRequestUnexpectedError::DeserializeBody{ serde: e, status_code, headers, response_text })
                                    as 
                                    Result<
                                        TryDeleteOneResponseVariants,
                                        crate::common::api_request_unexpected_error::ApiRequestUnexpectedError,
            ...
            match match_value {
                ...
                Err(e) => match e {
                    crate::common::api_request_unexpected_error::ApiRequestUnexpectedError::StatusCode{ status_code, headers, response_text_result, } => Err(
