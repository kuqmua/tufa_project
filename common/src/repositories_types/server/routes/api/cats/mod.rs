...
pub struct SomethingOptionsToReadWithId {
    #[serde(skip_serializing_if = "Option::is_none")]
    id: std::option::Option<postgresql_crud::Value<postgresql_crud::old_json_types::UuidOptionsToRead>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    std_primitive_i8: std::option::Option<postgresql_crud::Value<postgresql_crud::json_types::StdPrimitiveI8OptionsToRead>>,
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            where
                __A: serde::de::SeqAccess<'de>,
            {
                let __field0 = match serde::de::SeqAccess::next_element::<std::option::Option<postgresql_crud::Value<postgresql_crud::old_json_types::UuidOptionsToRead>>>(&mut __seq)? {
                    serde::__private::Some(__value) => __value,
                    serde::__private::None => {
            ...
            where
                __A: serde::de::MapAccess<'de>,
            {
                let mut __field0: serde::__private::Option<std::option::Option<postgresql_crud::Value<postgresql_crud::old_json_types::UuidOptionsToRead>>> = serde::__private::None;
                ...
                while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                    match __key {
                        __Field::__field0 => {
                            ...
                            __field0 = serde::__private::Some(serde::de::MapAccess::next_value::<std::option::Option<postgresql_crud::Value<postgresql_crud::old_json_types::UuidOptionsToRead>>>(&mut __map)?);
                        }
                        __Field::__field1 => {
                            if serde::__private::Option::is_some(&__field1) {
                                return serde::__private::Err(<__A::Error as serde::de::Error>::duplicate_field("std_primitive_i8"));
...
pub struct SomethingOptionsToUpdate {
    pub id: postgresql_crud::old_json_types::UuidOptionToUpdate,
...
pub struct StdVecVecGenericWithIdSomethingJsonArrayChange {
    ...
    #[serde(skip_serializing_if = "Vec::is_empty")]
    delete: std::vec::Vec<postgresql_crud::old_json_types::UuidOptionToUpdate>,
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
...
impl StdVecVecGenericWithIdSomethingJsonArrayChange {
    pub fn try_new(create: std::vec::Vec<SomethingToCreateWithGeneratedId>, update: std::vec::Vec<SomethingOptionsToUpdate>, delete: std::vec::Vec<postgresql_crud::old_json_types::UuidOptionToUpdate>) -> Result<Self, StdVecVecGenericWithIdSomethingJsonArrayChangeTryNewErrorNamed> {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                __A: serde::de::SeqAccess<'de>,
            {
                ...
                let __field2 = match serde::de::SeqAccess::next_element::<std::vec::Vec<postgresql_crud::old_json_types::UuidOptionToUpdate>>(&mut __seq)? {
                    serde::__private::Some(__value) => __value,
                    serde::__private::None => {
                        vec![]
                    }
                ...
                __A: serde::de::MapAccess<'de>,
            {
                ...
                let mut __field2: serde::__private::Option<std::vec::Vec<postgresql_crud::old_json_types::UuidOptionToUpdate>> = serde::__private::None;
                while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                    match __key {
                        __Field::__field0 => {
                            if serde::__private::Option::is_some(&__field0) {
                        ...
                        __Field::__field2 => {
                            ...
                            __field2 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<postgresql_crud::old_json_types::UuidOptionToUpdate>>(&mut __map)?);
                        }
                        _ => {
                            let _ = serde::de::MapAccess::next_value::<serde::de::IgnoredAny>(&mut __map)?;
                        }
...
impl StdOptionOptionStdVecVecGenericWithIdSomethingJsonArrayChange {
    pub fn try_new(create: std::vec::Vec<SomethingToCreateWithGeneratedId>, update: std::vec::Vec<SomethingOptionsToUpdate>, delete: std::vec::Vec<postgresql_crud::old_json_types::UuidOptionToUpdate>) -> Result<Self, StdOptionOptionStdVecVecGenericWithIdSomethingJsonArrayChangeTryNewErrorNamed> {
        {
            let update_acc = {
                let mut update_acc = vec![];
                for element in &update {
