...
pub struct UpdateManyPayloadElement {
    ...
    pub sqlx_types_uuid_uuid_as_postgresql_uuid:
        std::option::Option<Field<postgresql_crud::StdOptionOptionSqlxTypesUuidUuid>>,
}
#[derive(Debug)]
    ...
    for UpdateManyPayloadElement
{
    ...
    fn try_from(
        ...
        let sqlx_types_uuid_uuid_as_postgresql_uuid =
            match value.sqlx_types_uuid_uuid_as_postgresql_uuid {
                Some(value) => Some(Field {
                    value: match postgresql_crud::StdOptionOptionSqlxTypesUuidUuid::try_from(value)
                    {
                        Ok(value) => value,
                        Err(error) => {
                            return
...
pub enum UpdateManyPayloadTryFromUpdateManyPayloadWithSerializeDeserializeErrorNamed {
    SqlxTypesUuidUuidAsPostgresqlUuid {
        #[eo_error_occurence]
        std_primitive_i_64: postgresql_crud::SqlxTypesUuidUuidWithSerializeDeserializeErrorNamed,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
}
impl
    ...
    for UpdateManyPayloadElementWithSerializeDeserialize
{
    fn from(value: UpdateManyPayloadElement) -> Self {
        ...
        let sqlx_types_uuid_uuid_as_postgresql_uuid = match value
            .sqlx_types_uuid_uuid_as_postgresql_uuid
        {
            Some(value) => Some(FieldWithSerializeDeserialize {
                value:
                    postgresql_crud::StdOptionOptionSqlxTypesUuidUuidWithSerializeDeserialize::from(
                        value.value,
                    ),
            }),
            None => None,
...
pub enum TryUpdateManyRouteLogicErrorNamed {
    ...
    NoPayloadFields {
        #[eo_to_std_string_string]
        no_payload_fields: postgresql_crud::StdPrimitiveI64,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
    OperationDoneButPrimaryKeyInnerTypeTryFromPrimaryKeyInnerTypeWithSerializeDeserializeFailedInServer
    {
...
DynArcCombinationOfAppStateLogicTraits, >,
            ...
            Ok(axum::Json(value)) => {
                ...
                for element in &value.0 {
                    if let (None, None, None, None) = (
                        ...
                        let error = TryUpdateManyRouteLogicErrorNamed::NoPayloadFields {
                            no_payload_fields:
                                std_primitive_i64_as_postgresql_big_serial_not_null_primary_key,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence::new(
                                file!().to_owned(),
    ...
    let query_string = {
        ...
        {
            let mut is_sqlx_types_uuid_uuid_as_postgresql_uuid_update_exist = false;
            for element in &parameters.payload.0 {
                if element.sqlx_types_uuid_uuid_as_postgresql_uuid.is_some() {
                    is_sqlx_types_uuid_uuid_as_postgresql_uuid_update_exist = true;
                    break;
                }
            }
            if is_sqlx_types_uuid_uuid_as_postgresql_uuid_update_exist {
                let mut acc =
                    std::string::String::from("sqlx_types_uuid_uuid_as_postgresql_uuid = case ");
                for element in &parameters.payload.0 {
                    if let Some(value) = &element.sqlx_types_uuid_uuid_as_postgresql_uuid {
                        acc.push_str(& format!
                        ("when std_primitive_i64_as_postgresql_big_serial_not_null_primary_key = {} then {} ",
                        match postgresql_crud :: BindQuery ::
                        try_generate_bind_increments(&
                ...
                query.push_str(&format!(
                    "{}{}",
                    acc, "else sqlx_types_uuid_uuid_as_postgresql_uuid end,"
                ));
            }
        }
        let _ = query.pop();
