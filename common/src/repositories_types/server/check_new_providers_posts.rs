...
//             match crate::repositories_types::server::providers::provider_kind::functions::rss_part::rss_part(
//                 pk,
//                 {
// crate::repositories_types::server::traits::provider_kind_methods::ProviderKindMethods::generate_provider_links(
//     pk,
//     link_parts,
//     config
// )
