...
pub fn compile_time_project_git_info(
    ...
    assert!(output.status.success(), "f7185b72-c92e-4558-8615-1ae11bcaa131");
    let hash = String::from_utf8(output.stdout)
        .expect("9a3f659d-aca1-47d7-be32-cc3ba06e1b01")
        .trim()
        .to_owned();
    // Validate SHA-1 (40 hex chars)
    assert!(hash.len() == 40 && hash.chars().all(|element| element.is_ascii_hexdigit()), "093516ae-a89f-42df-8b01-9b2897111705");
