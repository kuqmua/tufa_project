...
pub fn to_upper_camel_case_stringified(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let syn_derive_input: syn::DeriveInput = syn::parse(input).unwrap_or_else(|error| panic!("{proc_macro_name_upper_camel_case_stringified} {}: {error}", proc_macro_common::constants::AST_PARSE_FAILED));
    ...
    let variants_matching_values_token_stream = data_enum
        ...
        .map(|variant| match &variant.fields {
            syn::Fields::Unit => {
                ...
                let variant_ident_upper_camel_case_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(&variant_ident_upper_camel_case_stringified, &proc_macro_name_upper_camel_case_ident_stringified);
    ...
    let function_name_snake_case_token_stream = proc_macro_common::generate_function_name_snake_case_token_stream(proc_macro_name_upper_camel_case_stringified, &proc_macro_name_upper_camel_case_ident_stringified);
    let trait_path_token_stream = proc_macro_common::trait_path_token_stream();
    let proc_macro_name_upper_camel_case_token_stream = proc_macro_common::generate_function_name_upper_camel_case_token_stream(proc_macro_name_upper_camel_case_stringified, &proc_macro_name_upper_camel_case_ident_stringified);
    ...
    let variants_matching_values_token_stream = data_enum
        ...
        .map(|variant| match &variant.fields {
            syn::Fields::Unit => {
                ...
                let variant_ident_snake_case_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(&variant_ident_snake_case_stringified, &proc_macro_name_upper_camel_case_ident_stringified);
