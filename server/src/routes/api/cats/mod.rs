...
fn crud(app_state: common::repositories_types::server::routes::app_state::DynArcCombinationOfAppStateLogicTraits) -> axum::Router {
    axum::Router::new()
        ...
        .route("/create_many", axum::routing::post(common::repositories_types::server::routes::api::cats::try_create_many_route_logic))
        ...
        .route("/read_one_payload_example", axum::routing::get(common::repositories_types::server::routes::api::cats::read_one_payload_example_route_logic))
        ...
        .route("/update_one_payload_example", axum::routing::get(common::repositories_types::server::routes::api::cats::update_one_payload_example_route_logic))
        // .route("/delete_many", axum::routing::delete(common::repositories_types::server::routes::api::cats::try_delete_many_route_logic))
        // .route("/delete_one", axum::routing::delete(common::repositories_types::server::routes::api::cats::try_delete_one_route_logic))
        //
