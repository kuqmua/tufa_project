...
//     let common::repositories_types::server::routes::admin::newsletter::post::FormData {
//         title,
//         text_content,
//         html_content,
//         idempotency_key,
//     } = form.0;
//     let idempotency_key: common::repositories_types::server::idempotency::IdempotencyKey =
//         idempotency_key
//             .try_into()
...
//     {
//         common::repositories_types::server::idempotency::NextAction::StartProcessing(t) => t,
//         common::repositories_types::server::idempotency::NextAction::ReturnSavedResponse(saved_response) => {
...
//         .await
//         .map_err(common::repositories_types::server::utils::status_codes::e500)?;
//     let response = common::repositories_types::server::utils::status_codes::see_other(
//         "/admin/newsletters",
//     );
//     let response =
