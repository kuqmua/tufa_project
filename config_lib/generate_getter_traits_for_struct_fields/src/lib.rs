...
pub fn generate_getter_trait(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let get_ident_upper_camel_case = naming_conventions::self_constants::GetSelfUpperCamelCase::from_dyn_quote_to_tokens(&ident);
    let get_ident_snake_case = naming_conventions::self_constants::GetSelfSnakeCase::from_dyn_quote_to_tokens(&ident);
    let generated = quote::quote! {
