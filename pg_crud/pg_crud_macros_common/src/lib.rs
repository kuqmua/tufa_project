...
pub fn gen_pg_type_where_ts(
    ...
    quote! {
        ...
        #impl_error_occurence_lib_to_std_string_string_for_pg_type_tokens_where_ts
...
pub fn gen_serde_deserialize_double_quotes_ts(
    ...
    (
        ...
        pg_type_ident_where_tokens_double_quotes_ts,
    )
}
pub fn gen_impl_pg_json_type_ts(
    ...
    quote! {
        ...
        impl #path_ts #PgJsonTypeUcc for #ident {
            ...
            ) -> Result<#query_pg_arguments_ts, #StdStringString> {
            ...
            ) -> Result<#query_lifetime_pg_arguments_ts, #StdStringString> {
