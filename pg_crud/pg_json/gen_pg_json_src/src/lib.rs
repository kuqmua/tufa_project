...
pub fn gen_pg_json(input_ts: &Ts2) -> Ts2 {
    ...
    .map(|(i, el)| {
        ...
        let ident_cr_ts = {
            ...
            let impl_dflt_opt_some_vec_one_el_for_ident_cr_ts =
                gen_impl_pg_crud_common_dflt_opt_some_vec_one_el_ts(&ident_cr_ucc, &quote! {Self(#PgCrudCommonDfltOptSomeVecOneElCall)});
            quote! {
                #ident_cr_ts
                #impl_ident_cr_ts
