    ...
    .map(|(i, el)| {
        ...
        let ident_origin_ts = {
            let ident_origin_ts = DTsBuilder::new()
                ...
                .d_partial_eq()
                .d_eq_if(match &is_not_null_stdrt_can_be_pk {
                    IsNotNullStdrtCanBePk::False => DEq::False,
                    IsNotNullStdrtCanBePk::True => DEq::True,
                })
                .d_partial_ord_if(match &is_stdrt_not_null {
                    IsStdrtNotNull::False => DPartialOrd::False,
                ...
                .d_ord_if(match &is_not_null_stdrt_can_be_pk {
                    IsNotNullStdrtCanBePk::False => DOrd::False,
                    IsNotNullStdrtCanBePk::True => DOrd::True,
                })
            ...
            let impl_sqlx_type_for_ident_origin_ts = gen_impl_sqlx_type_for_ident_ts(&ident_origin_ucc, &ft_h);
            ...
            let impl_sqlx_decode_sqlx_pg_for_ident_origin_ts = gen_impl_sqlx_decode_sqlx_pg_for_ident_ts(&ident_origin_ucc, &ft_h, &{
        ...
        let ident_table_type_ts = {
            ...
            let impl_pg_type_equal_oprtr_for_ident_table_type_ts = impl_pg_type_equal_oprtr_for_ident_ts(
                ...
                //todo
                &{
                    let equal_ts = EqualOprtrH::Equal.to_tokens_path(&import);
                    let is_null_ts = EqualOprtrH::IsNull.to_tokens_path(&import);
                    match &pg_type_pattern {
                        PgTypePattern::Stdrt => match &is_nullable {
                        ...
                        PgTypePattern::ArrDim1 { dim1_is_nullable } => match &is_nullable {
                            IsNullable::False => match &dim1_is_nullable {
                                IsNullable::False => equal_ts,
                                IsNullable::True => {
                                    //todo thats not actually usefull coz nullable arr comparison has different logic. need to refactor EqualOprtrH enum
                                    equal_ts
                                }
                            },
                            IsNullable::True => quote! {
            ...
            &{
                ...
                match &pg_type_pattern {
                    PgTypePattern::Stdrt => {
                        ...
                        let in_h = PgTypeFilter::In { ident: quote! {#ident_table_type_ucc} };
        ...
        let impl_pg_type_test_cases_for_ident_ts = {
            ...
            let read_ids_to_2_dims_vec_read_inner_ts = {
                ...
                match &pg_type_pattern {
                    PgTypePattern::Stdrt => match &is_nullable {
                        IsNullable::False => {
                            let ts = gen_stdrt_not_null_test_case_h_ts(&IsNeedToUseInto::True);
                            quote! {vec![{#ts}]}
                        }
                        IsNullable::True => quote! {
