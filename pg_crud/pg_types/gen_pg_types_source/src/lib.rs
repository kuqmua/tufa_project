...
use naming::{
    ...
    PgTypeUcc, PositiveLessTypicalSc, PositiveMoreTypicalSc, QuerySc, ReadIntoTableTypeSc,
    ReadOnlyIdsAndCreateIntoReadSc, ReadOnlyIdsIntoReadSc, ReadOnlyIdsIntoTableTypeSc,
    ReadOnlyIdsIntoUpdateSc, ReadOnlyIdsSc, ReadOnlyIdsToTwoDimsVecReadInnerSc, ReadOnlyIdsUcc,
    ReadSc, ReadUcc, SecSc, SecondSc, SelfSc, SelfUcc, StartSc, StartUcc, TableTypeSc,
    TableTypeUcc, TimeSc, TimeUcc, ToErrStringSc, TryNewForDeserializeSc, TryNewSc, UnboundedUcc,
...
pub fn gen_pg_types(input_ts: &Ts2) -> Ts2 {
    ...
    .map(|(i, el)| {
        ...
        let is_not_null_stdrt_can_be_pk = if matches!((&is_nullable, &pg_type_pattern, &can_be_pk), (IsNullable::False, PgTypePattern::Stdrt, CanBePk::True)) {
            IsNotNullStdrtCanBePk::True
        } else {
            IsNotNullStdrtCanBePk::False
        };
        ...
        let (ser_derive_or_impl, de_derive_or_impl) = if matches!(&is_stdrt_not_null, IsStdrtNotNull::True) {
            ...
            let gen_std_ops_bound_ts = |ts: &dyn ToTokens| {
            ...
            (
                {
                    ...
                    let gen_serde_state_init_ts = |param_nbr: &ParamNbr| {
                        let param_nbr_ts = {
                            let ts = param_nbr.get_vec_from_i_starting_with_zero().into_iter().map(|_| quote! {+ 1});
                            quote! {#(#ts)*}
                        };
                        quote! {
                ...
                },
                {
                    ...
                    let (sqlx_types_chrono_naive_time_origin_try_new_for_deserialize, match_origin_try_new_for_deserialize_one_ts, match_origin_try_new_for_deserialize_two_ts, match_origin_try_new_for_deserialize_four_ts) = {
                        ...
                        (
                            gen_ts(hour_min_sec_micro_display_plus_to_tokens_arr.len()),
                            gen_ts(1),
                            gen_ts(2),
                            gen_ts(4),
                        )
                    ...
                    let (
                        ...
                        let fields_serde_de_seq_access_next_el_init_string_ts = gen_fields_serde_de_seq_access_next_el_init_ts(&[&StringTs]);
                        let gen_new_two_ts = |ts: &dyn ToTokens|gen_ts(&quote! {
                            #ts
                        ...
                        (
                            ...
                            gen_new_two_ts(&gen_fields_serde_de_seq_access_next_el_init_ts(
                                &[&sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc,
                                &sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc]
                            )),
                            gen_new_two_ts(&gen_fields_serde_de_seq_access_next_el_init_ts(
                                &[&sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc,
                                &sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc]
                            ...
                            gen_new_two_ts(&gen_fields_serde_de_seq_access_next_el_init_ts(
                                &[&std_ops_bound_sqlx_types_chrono_naive_date_as_not_null_date_origin_ts,
                                &std_ops_bound_sqlx_types_chrono_naive_date_as_not_null_date_origin_ts]
                            )),
                            gen_new_two_ts(&gen_fields_serde_de_seq_access_next_el_init_ts(
                                &[&std_ops_bound_sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ts,
                                &std_ops_bound_sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ts]
                            )),
                            gen_new_two_ts(&gen_fields_serde_de_seq_access_next_el_init_ts(
                                &[&std_ops_bound_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_not_null_timestamptz_origin_ts,
                                &std_ops_bound_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_not_null_timestamptz_origin_ts]
                            )),
                            gen_ts(&{
                    ...
                    let (fn_visit_str_v_start_end_ts, fn_visit_str_v_hour_min_sec_micro_ts, fn_visit_str_v_hour_minute_second_microsecond_ts, fn_visit_str_v_date_time_ts, fn_visit_str_v_date_naive_time_ts, fn_visit_str_v_months_days_microseconds_ts) = {
                        ...
                        (
                            ...
                            gen_ts(&hour_min_sec_micro_display_plus_to_tokens_arr),
                    ...
                    let (
                        ...
                        let gen_visit_map_ts = |field_opt_none_init_ts: &dyn ToTokens, while_some_next_k_field_ts: &dyn ToTokens, match_field_init_ts: &dyn ToTokens, serde_private_ok_ts: &dyn ToTokens| {
                            quote! {
                                #[inline]
                                fn visit_map<__A>(self, mut __map: __A) -> Result<Self::Value, __A::Error>
                                where
                        ...
                        let (
                            ...
                            let gen_ts = |vec_ts: &[&dyn ToTokens]| {
                            ...
                            (
                                gen_ts(&[&U32, &U32, &U32, &U32]),
                                gen_ts(&[&U8, &U8, &U8, &U32]),
                                gen_ts(&[&sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc, &sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc]),
                                gen_ts(&[&sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc, &sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc]),
                                gen_ts(&[&std_ops_bound_sqlx_types_chrono_naive_date_as_not_null_date_origin_ts, &std_ops_bound_sqlx_types_chrono_naive_date_as_not_null_date_origin_ts]),
                                gen_ts(&[&std_ops_bound_sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ts, &std_ops_bound_sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ts]),
                                gen_ts(&[&std_ops_bound_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_not_null_timestamptz_origin_ts, &std_ops_bound_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_not_null_timestamptz_origin_ts]),
                                gen_ts(&[&std_ops_bound_i32_ts, &std_ops_bound_i32_ts]),
                                gen_ts(&[&std_ops_bound_i64_ts, &std_ops_bound_i64_ts]),
                                gen_ts(&[&I32, &I32, &I64]),
                            )
                        };
                        let (
                            ...
                            let gen_ts = |vec_ts: &[(&dyn Display, &dyn ToTokens)]| {
                            ...
                            (
                                gen_ts(&[(&HourSc, &U32), (&MinSc, &U32), (&SecSc, &U32), (&MicroSc, &U32)]),
                                gen_ts(&[(&HourSc, &U8), (&MinuteSc, &U8), (&SecondSc, &U8), (&MicrosecondSc, &U32)]),
                                gen_ts(&[(&DateSc, &sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc), (&TimeSc, &sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc)]),
                                gen_ts(&[(&DateNaiveSc, &sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc), (&TimeSc, &sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc)]),
                                gen_ts(&[(&StartSc, &std_ops_bound_sqlx_types_chrono_naive_date_as_not_null_date_origin_ts), (&EndSc, &std_ops_bound_sqlx_types_chrono_naive_date_as_not_null_date_origin_ts)]),
                                gen_ts(&[(&StartSc, &std_ops_bound_sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ts), (&EndSc, &std_ops_bound_sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ts)]),
                                gen_ts(&[
                                ...
                                gen_ts(&[(&StartSc, &std_ops_bound_i32_ts), (&EndSc, &std_ops_bound_i32_ts)]),
                                gen_ts(&[(&StartSc, &std_ops_bound_i64_ts), (&EndSc, &std_ops_bound_i64_ts)]),
                    ...
                    let (
                        ...
                        (
                            ...
                            gen_ts(&fn_expecting_struct_ident_dq_ts, &fn_visit_seq_sqlx_pg_types_pg_range_sqlx_types_chrono_naive_date_ts, &fn_visit_map_sqlx_pg_types_pg_range_sqlx_types_chrono_naive_date_ts),
                            gen_ts(&fn_expecting_struct_ident_dq_ts, &fn_visit_seq_sqlx_pg_types_pg_range_sqlx_types_chrono_naive_date_time_ts, &fn_visit_map_sqlx_pg_types_pg_range_sqlx_types_chrono_naive_date_time_ts),
                            gen_ts(
                                &fn_expecting_struct_ident_dq_ts,
                                &fn_visit_seq_sqlx_pg_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_ts,
                                &fn_visit_map_sqlx_pg_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_ts,
                            ),
                            gen_ts(&fn_expecting_struct_ident_dq_ts, &fn_visit_seq_sqlx_pg_types_pg_range_i32_ts, &fn_visit_map_sqlx_pg_types_pg_range_sqlx_pg_types_pg_range_i32_ts),
                            gen_ts(&fn_expecting_struct_ident_dq_ts, &fn_visit_seq_sqlx_pg_types_pg_range_i64_ts, &fn_visit_map_sqlx_pg_types_pg_range_sqlx_pg_types_pg_range_i64_ts),
                            gen_ts(&fn_expecting_struct_ident_dq_ts, &fn_visit_seq_sqlx_pg_types_pg_interval_ts, &fn_visit_map_sqlx_pg_types_pg_interval_ts),
                        )
                    };
        ...
        let gen_pub_const_new_or_pub_try_new_ts = |ts: &dyn ToTokens| {
            let pub_fn_new_or_try_new_ts = if pg_type_init_try_new_try_from_pg_type.is_ok() {
                ...
                &{
                    let self_ident_origin_new_v_ts = quote! {Self(#ident_origin_ucc::#NewSc(#VSc))};
        ...
        let ident_origin_ts = {
            let ident_origin_ts = StructOrEnumDeriveTsStreamBuilder::new()
                ...
                .derive_partial_eq()
                .derive_eq_if(match &is_not_null_stdrt_can_be_pk {
                    IsNotNullStdrtCanBePk::False => DeriveEq::False,
                    IsNotNullStdrtCanBePk::True => DeriveEq::True,
                })
                ...
                .derive_ord_if(match &is_not_null_stdrt_can_be_pk {
            ...
            let impl_ident_origin_ts = {
                    ...
                    let ts = {
                        let ts = {
                            ...
                            let gen_arr_dims_init_ts = |ts: &dyn ToTokens| match &is_nullable {
                                ...
                                IsNullable::True => gen_match_opt_ts(&ts),
                            };
                            match &pg_type_pattern {
                                PgTypePattern::Stdrt => match &is_nullable {
                                    IsNullable::False => {
                                ...
                                IsNullable::False => {
                                    ...
                                    match &pg_type_init_try_new {
                                        ...
                                        PgTypeInitTryNew::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsTimestampTz => {
                                            ...
                                            quote! {
                                                let #DateNaiveSc = match #sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc::#TryNewSc(#VSc.date_naive()) {
                                                ...
                                                let #TimeSc = match #sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc::#TryNewSc(#VSc.time()) {
                ...
                let mb_fn_new_or_try_new_for_deserialize_token = match &pg_type_pattern {
                    PgTypePattern::Stdrt => match &is_nullable {
                                ...
                                PgTypeImplNewForDeserializeOrTryNewForDeserialize::NewForDeserialize(pg_type_impl_new_for_deserialize) => {
                                    let params_ts = {
                                        let gen_start_end_std_std_ops_bound_ts = |ts: &dyn ToTokens| {
                                            quote! {
                                                #StartSc: std::ops::Bound<#ts>,
                                                #EndSc: std::ops::Bound<#ts>
                                            }
                                        };
                                        ...
                                        let self_sqlx_pg_types_pg_range_ts = {
                                            let (start_ts, end_ts) = {
                                                let gen_ts = |start_or_end: StartOrEnd|{
                                                    ...
                                                    quote!{
                                                        #name_ts: match #name_ts {
                                                            std::ops::Bound::Included(v) => std::ops::Bound::Included(v.0),
                                                            std::ops::Bound::Excluded(v) => std::ops::Bound::Excluded(v.0),
                                                            std::ops::Bound::Unbounded => std::ops::Bound::Unbounded,
                                                        },
                                                    }
                                                };
                ...
                let ts = match &pg_type_pattern {
                    PgTypePattern::Stdrt => match &is_nullable {
                        IsNullable::False => {
                            ...
                            let gen_as_dflt_opt_some_vec_one_el_call_ts = |ts: &dyn ToTokens| {
                                quote! {<#ts as #import::DfltOptSomeVecOneEl>::dflt_opt_some_vec_one_el()}
                            };
                            let gen_sqlx_pg_types_pg_range_dflt_opt_some_vec_one_el_ts = |ts: &dyn ToTokens| {
                                let ts0 = gen_as_dflt_opt_some_vec_one_el_call_ts(&ts);
                                quote! {sqlx::postgres::types::PgRange {
                                    #StartSc: std::ops::Bound::Included(#ts0.0),
                                    #EndSc: std::ops::Bound::Excluded(#ts0.0),
                                }}
                            };
                            let sqlx_types_chrono_naive_date_as_not_null_date_origin_as_dflt_opt_some_vec_one_el_call_ts = gen_as_dflt_opt_some_vec_one_el_call_ts(&sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc);
                            let sqlx_types_chrono_naive_time_as_not_null_time_origin_as_dflt_opt_some_vec_one_el_call_ts = gen_as_dflt_opt_some_vec_one_el_call_ts(&sqlx_types_chrono_naive_time_as_not_null_time_origin_ucc);
                            let init_ts: &dyn ToTokens = match &pg_type {
                                ...
                                PgType::SqlxTypesChronoNaiveDateTimeAsTimestamp => &gen_sqlx_types_chrono_naive_date_time_new_ts(&quote! {
                                    #sqlx_types_chrono_naive_date_as_not_null_date_origin_as_dflt_opt_some_vec_one_el_call_ts.0,
                                    #sqlx_types_chrono_naive_time_as_not_null_time_origin_as_dflt_opt_some_vec_one_el_call_ts.0,
                                }),
                                ...
                                PgType::SqlxPgTypesPgRangeSqlxTypesChronoNaiveDateAsDateRange => &gen_sqlx_pg_types_pg_range_dflt_opt_some_vec_one_el_ts(&sqlx_types_chrono_naive_date_as_not_null_date_origin_ucc),
                                PgType::SqlxPgTypesPgRangeSqlxTypesChronoNaiveDateTimeAsTimestampRange => &gen_sqlx_pg_types_pg_range_dflt_opt_some_vec_one_el_ts(&sqlx_types_chrono_naive_date_time_as_not_null_timestamp_origin_ucc),
                                PgType::SqlxPgTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsTimestampTzRange => &gen_sqlx_pg_types_pg_range_dflt_opt_some_vec_one_el_ts(&sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_not_null_timestamptz_origin_ucc),
                            };
                            quote! {#init_ts}
                        }
            ...
            let mb_impl_from_ident_read_for_ident_origin_ts = match &is_not_null_stdrt_can_be_pk {
            ...
            quote! {
                ...
                #mb_impl_from_ident_read_for_ident_origin_ts
            }
        };
        let gen_pub_struct_tokens_ts = |ident_ts_46b769df: &dyn ToTokens, ts: &dyn ToTokens, derive_dflt: DeriveDefault| {
            StructOrEnumDeriveTsStreamBuilder::new()
                .make_pub()
                .derive_debug()
                .derive_default_if(derive_dflt)
                .derive_clone()
                .derive_copy()
                .derive_partial_eq()
                .derive_serde_serialize()
        ...
        let ident_create_ts = {
            let ident_create_ts = match &can_be_pk {
                CanBePk::False => StructOrEnumDeriveTsStreamBuilder::new()
                    .make_pub()
                    .derive_debug()
                    .derive_clone()
                    .derive_copy_if(derive_copy)
                ...
                CanBePk::True => gen_pub_struct_tokens_ts(&ident_create_ucc, &quote! {(());}, DeriveDefault::False),
            };
                ...
                match &pg_type_pattern {
                    ...
                    PgTypePattern::ArrDim1 { dim1_is_nullable } => {
                        ...
                        let dim_one_in_handle = PgTypeFilter::DimOneIn {
                            ident: {
                                let ts = SelfTableTypeUcc::from_tokens(&match &pg_type.can_be_nullable() {
                                    CanBeNullable::False => quote! {#ident_stdrt_not_null_ucc},
                                    CanBeNullable::True => gen_ident_ts(pg_type, is_nullable, &PgTypePattern::Stdrt)
                                });
                                quote!{#ts}
                            },
                        };
                        ...
                        let common_arr_dim1_pg_type_filters = {
                            ...
                            vec.push(PgTypeFilter::DimOneEqual {
                                ident: {
                                    let ts = SelfTableTypeUcc::from_tokens(&match &dim1_is_nullable {
        ...
        let ident_read_ts = {
            let ident_read_ts = {
                let (
                    ...
                    derive_partial_ord,
                    derive_ord
                ) = match &is_not_null_stdrt_can_be_pk {
                    IsNotNullStdrtCanBePk::False => (
                        DeriveEq::False,
            ...
            let impl_crate_dflt_opt_some_vec_one_el_for_ident_read_ts =
            ...
            quote! {
                ...
                #impl_crate_dflt_opt_some_vec_one_el_for_ident_read_ts
                #impl_sqlx_encode_sqlx_pg_for_ident_origin_ts
                #impl_sqlx_decode_sqlx_pg_for_ident_read_ts
                #impl_sqlx_type_for_ident_read_ts
                #mb_impl_pg_type_where_filter_for_ident_read_if_can_be_pk_ts
            }
        };
        let ident_read_only_ids_ucc = SelfReadOnlyIdsUcc::from_tokens(&ident);
        let ident_read_only_ids_ts = if matches!(&is_not_null_stdrt_can_be_pk, IsNotNullStdrtCanBePk::True) {
        ...
        let impl_pg_type_for_ident_ts = {
            ...
            let (qp_create_ts, bind_v_to_query_create_ts): Handle<'_> = {
                ...
                let dflt_init_by_pg: Handle<'_> = (&ok_string_from_dflt_ts, &ok_query_ts);
                match &pg_type {
                    PgType::I16AsInt2
                    | PgType::I32AsInt4
                    | PgType::I64AsInt8
            ...
            gen_impl_pg_type_ts(
                ...
                &{
                    ...
                    let column_pg_query_type_not_null = format!("{{column}} {pg_query_type}{mb_arr_part} not null{mb_constraint_part}");
                    let space_extra_param = " {}";
                    match (&is_nullable, &can_be_pk) {
                        (IsNullable::False, CanBePk::False) => {
                            let format_ts = dq_ts(&column_pg_query_type_not_null);
                            quote! {
                                format!(#format_ts)
                            }
                        }
                        (IsNullable::False, CanBePk::True) => {
                            let format_ts = dq_ts(&format!("{column_pg_query_type_not_null}{space_extra_param}"));
                            quote! {
                                format!(#format_ts, #mb_pk_is_pk_ts)
                            }
                        }
                        (IsNullable::True, CanBePk::False) => {
                            let format_ts = dq_ts(&column_pg_query_type);
                            quote! {
                                format!(#format_ts)
                            }
                        }
                        (IsNullable::True, CanBePk::True) => {
        ...
        let impl_pg_type_test_cases_for_ident_ts = {
            ...
            let gen_stdrt_not_null_test_case_handle_ts = |is_need_to_use_into: &IsNeedToUseInto| {
                ...
                let (
                    ...
                    |gen_ident_stdrt_not_null_fn_ts(
                ...
                match &pg_type {
                    ...
                    PgType::SqlxTypesChronoNaiveTimeAsTime => {
                        let (
                            ...
                            let gen_ts = |ts: &dyn ToTokens|gen_ident_stdrt_not_null_fn_ts(
                                &SelfUcc,
                                &ts
                            );
                            (
            ...
            let opt_vec_create_ts = {
                ...
                | {
                    let (new_or_try_new_ts, mb_acc_push_none_ts) = match (&is_nullable_27c3e340, pg_type_init_try_new_try_from_pg_type.is_ok()) {
                ...
                match &pg_type_pattern {
                    PgTypePattern::Stdrt => match &is_nullable {
                        IsNullable::False => match &can_be_pk {
                            CanBePk::False => {
                            ...
                            IsNullable::False => {
                                ...
                                let (first_ts, second_ts, third_ts) = {
                                    ...
                                    let gen_ts = |v: usize| {
                                        ...
                                        //todo mb correlate with .derive_copy_if()
            ...
            let update_to_read_only_ids_ts = if matches!(&is_not_null_stdrt_can_be_pk, IsNotNullStdrtCanBePk::True) {
                quote! {
            ...
            let read_only_ids_to_opt_v_read_dflt_opt_some_vec_one_el_ts = {
                ...
                let ts = gen_v_init_ts0(&{
                    let ts: &dyn ToTokens = if matches!(&is_not_null_stdrt_can_be_pk, IsNotNullStdrtCanBePk::True) {
                        ...
                        &PgCrudCommonDfltOptSomeVecOneElCall
                    };
            ...
            let read_only_ids_and_create_into_opt_v_read_ts = {
                let ts = gen_v_init_ts0(&quote! {
                    <Self as #import::PgTypeTestCases>::#ReadOnlyIdsAndCreateIntoReadSc(
                        #ReadOnlyIdsSc,
                        #CreateSc
                    )
                });
            ...
            let read_only_ids_and_create_into_where_equal_ts = {
            ...
            let read_only_ids_and_create_into_vec_where_equal_using_fields_ts = quote! {
                #import::NotEmptyUniqueVec::try_new(vec![
                    #read_only_ids_and_create_into_where_equal_ts
                ]).expect("4c08b551")
            };
            let read_only_ids_and_create_into_opt_vec_where_equal_to_json_field_ts = none_ts.clone();
            ...
            let read_only_ids_and_table_type_into_pg_type_opt_where_greater_than_ts = match &pg_type_pattern {
                PgTypePattern::Stdrt => {
            ...
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_dim_one_equal_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_dim_two_equal_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_dim_three_equal_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_dim_four_equal_ts = none_ts.clone();
            ...
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_greater_than_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_between_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_in_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_regex_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_contains_el_greater_than_ts = none_ts.clone();
            let read_only_ids_and_create_into_pg_json_type_opt_vec_where_contains_el_regex_ts = none_ts;
            ...
            quote! {
                ...
                impl #import::#PgTypePkUcc for #ident_stdrt_not_null_ucc {
                    ...
                    fn #ReadOnlyIdsIntoTableTypeSc(#v_as_read_only_ids_ts) -> #self_as_pg_type_ts::#TableTypeUcc {
                        #ident_table_type_ucc(#VSc.0.0)
                    }
                    fn #ReadOnlyIdsIntoReadSc(#v_as_read_only_ids_ts) -> #self_as_pg_type_ts::#ReadUcc {
                        #VSc.0
                    }
                    fn #ReadOnlyIdsIntoUpdateSc(#v_as_read_only_ids_ts) -> #self_as_pg_type_ts::#UpdateUcc {
                        #ident_update_ucc(#VSc.0.0)
                    }
                    fn #ReadIntoTableTypeSc(
                        #VSc: #self_as_pg_type_ts::#ReadUcc
                    ) -> #self_as_pg_type_ts::#TableTypeUcc {
                        #ident_table_type_ucc(#VSc.0)
                    }
                }
            }
        } else {
