    ...
    .map(|(i, el)| {
        ...
        let ident_origin_ts = {
            ...
            let gen_int_range_type_er_vrts_ts = |int_range_type: &IntRangeType| {
                ...
                let (
                    ...
                    let gen_ts = |name_ts: &dyn ToTokens|gen_loc_var_ts(
                        &name_ts,
                        &quote!{
                                    ...
                                    let gen_ok_self_sqlx_pg_types_pg_range_ts = |ident_ts_430fc374: &dyn ToTokens| quote! {
                                        Ok(Self(sqlx::postgres::types::PgRange {
                                            #StartSc: match #VSc.#StartSc {
                                                std::ops::Bound::Included(v_fa01ee95) => match #ident_ts_430fc374::#TryNewSc(v_fa01ee95) {
                                                ...
                                                std::ops::Bound::Excluded(v_0cd476c2) => match #ident_ts_430fc374::#TryNewSc(v_0cd476c2) {
                                            ...
                                            #EndSc: match #VSc.#EndSc {
                                                std::ops::Bound::Included(v_892f5875) => match #ident_ts_430fc374::#TryNewSc(v_892f5875) {
                                                ...
                                                std::ops::Bound::Excluded(v_78cb4fa9) => match #ident_ts_430fc374::#TryNewSc(v_78cb4fa9) {
                                        ...
                                        let try_new_convert_pg_range_int_ts = gen_self_match_try_new_ts(
                                            ...
                                            &{
                                                ...
                                                let (
                                                    ...
                                                    let gen_ts = |name_ts: &dyn ToTokens|gen_match_ts(
                                                        &name_ts,
                                                        &quote!{
                                                            #StartSc,
                                                            #EndSc,
        ...
        let ident_create_ts = {
            ...
            let impl_default_opt_some_vec_one_el_for_ident_create_ts = gen_impl_pg_crud_common_default_opt_some_vec_one_el_ts(&ident_create_ucc, &{
                let ts: &dyn ToTokens = match &can_be_pk {
                    CanBePk::False => &PgCrudCommonDefaultOptSomeVecOneElCall,
                    CanBePk::True => &quote! {()},
                };
                quote! {Self(#ts)}
            });
        ...
        let ident_select_ts = {
            ...
            let (impl_default_opt_some_vec_one_el_for_ident_select_ts, impl_default_opt_some_vec_one_el_max_page_size_for_ident_select_ts) = {
                let gen_ts = |default_some_one_or_default_some_one_with_max_page_size: &DefaultSomeOneOrDefaultSomeOneWithMaxPageSize| match &pg_type_pattern {
                ...
                (
                    gen_impl_pg_crud_common_default_opt_some_vec_one_el_ts(&ident_select_ucc, &gen_ts(&DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne)),
                    gen_impl_pg_crud_common_default_opt_some_vec_one_el_max_page_size_ts(&ident_select_ucc, &gen_ts(&DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize)),
                )
            };
            quote! {
        ...
        let impl_pg_type_test_cases_for_ident_ts = {
            ...
            let gen_stdrt_not_null_test_case_handle_ts = |is_need_to_use_into: &IsNeedToUseInto| {
                ...
                let (
                    ...
                    let gen_ts = |naive: &dyn ToTokens| gen_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_from_naive_utc_and_offset_ts(naive);
                    (
                ...
                match &pg_type {
                    ...
                    PgType::SqlxTypesChronoNaiveTimeAsTime => {
                        let (
                            ...
                            let gen_ts = |ts_9d2b411e: &dyn ToTokens|gen_ident_stdrt_not_null_fn_ts(
                                &SelfUcc,
                                &ts_9d2b411e
                            );
                            (
                    ...
                    PgType::SqlxTypesChronoNaiveDateAsDate => {
                        let (
                            ...
                            let gen_ts = |ts_16bc2a50: &dyn ToTokens|gen_ident_stdrt_not_null_fn_ts(
                                &SelfUcc,
                                &ts_16bc2a50
                            );
                            (
