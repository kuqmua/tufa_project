...
pub fn gen_pg_json_object_type(input_ts: Ts2) -> Ts2 {
    ...
    let (fields_ts, pg_json_object_type_array) = pg_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let ident_ts = {
                let gen_struct_ident_ts = |ident_2c1c6b9c: &dyn ToTokens| StructOrEnumDeriveTokenStreamBuilder::new()
                    .make_pub()
                    .derive_debug()
                    .derive_clone()
                    .derive_copy()
            ...
            let gen_gen_impl_error_occurence_lib_to_err_string_wrapper_ts = |ident_ts_f6440ce9: &dyn ToTokens| gen_impl_to_err_string_ts(
                &Ts2::new(),
                &ident_ts_f6440ce9,
                &Ts2::new(),
                &quote! {format!("{self:?}")}
            ...
            let gen_ident_table_type_declaration_or_ident_create_common_ts = |pg_json_type_subtype_table_type_declaration_or_create: &PgJsonTypeSubtypeTableTypeDeclarationOrCreate| {
                ...
                let maybe_ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = if is_standart_not_null {
                    ...
                    let ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = gen_ident_table_type_declaration_or_create_ts(
                        ...
                        &gen_ident_table_type_declaration_or_create_or_ident_with_id_table_type_declaration_or_create_standart_not_null_content_ts(is_standart_with_id_240dfa72, pg_json_type_subtype_table_type_declaration_or_create, &new_type_or_struct_declaration_struct_declaration),
                    );
                    let impl_pub_const_new_for_ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = gen_impl_pub_const_new_for_ident_ts(
                        &ident_with_id_table_type_declaration_or_ident_with_id_standart_not_null_create_ucc,
                        &must_use_ts,
                        &gen_ident_table_type_declaration_or_create_or_ident_with_id_table_type_declaration_or_create_standart_not_null_content_ts(is_standart_with_id_240dfa72, pg_json_type_subtype_table_type_declaration_or_create, &new_type_or_struct_declaration_new_type),
                                ...
                                IsNullable::False => {
                                    ...
                                    quote! {
                                        Self {
                                            ...
                                            #dim1_pagination_ts: #dim1_pagination_content_ts,
                                        }
                                    }
                                },
                                IsNullable::True => match &default_some_one_or_default_some_one_with_max_page_size {
                    ...
                    gen_pub_try_new_ts(
                        ...
                        &{
                            ...
                            let check_if_all_fields_are_none_ts = {
                                ...
                                let content_ts = if vec_syn_field_19e98ce1_len == 1 {
                        ...
                        Pattern::Standart => match &is_nullable {
                            IsNullable::False => {
                                let content_ts = vec_syn_field.iter().map(|el_3a1eac56| {
                                    ...
                                    quote! {
                                        if let Some(value_2bbd2c96) = #field_type_as_pg_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dim_number_equal_sc(
                                            #ReadOnlyIdsSc.0.#ValueSc.#field_ident,
                            ...
                            IsNullable::False => {
                                let content_ts_f0710cd9 = {
                                    let content_ts_57d244f8 = vec_syn_field.iter().map(|el_18682ae5| {
                                        ...
                                        quote! {
                                            if let Some(value_bf84026e) = #field_type_as_pg_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dim_number_equal_sc(
                                ...
                                let content_ts_2cc4a40e = match &dim {
                                    Dim::One => {
                                        let dim_one_ts = {
                        ...
                        let option_vec_create_ts = {
                            let content_ts = match &is_nullable {
                                ...
                                IsNullable::True => {
                                    ...
                                    quote! {
                                        if let Some(value_399e6a50) = #ident_not_null_as_pg_json_type_test_cases_ts_e690553a::#OptionVecCreateSc() {
                                ...
                                IsNullable::True => {
                                    quote! {
                                        #ReadOnlyIdsSc.0.#ValueSc.as_ref().into_iter().flat_map(|value_5fa0668c| {
                                            #ident_standart_not_null_as_pg_json_type_test_cases_ts::
                                                #ReadOnlyIdsToTwoDimalVecReadInnerSc(value_5fa0668c)
                                                .into_iter()
                                                .flat_map(|element0| {
                                ...
                                IsNullable::True => {
                                    quote! {
                                        ...
                                        if let Some(value_6ee5750e) = &#ReadOnlyIdsSc.0.#ValueSc {
                                            for el_4a5a4b09 in #ident_array_not_null_as_pg_json_type_test_cases_ts::#ReadOnlyIdsToTwoDimalVecReadInnerSc(value_6ee5750e) {
