...
use naming::{
    ...
    param::{
        ...
        SelfTestsSc, SelfTryDeleteOneErUcc, SelfTryRoErUcc, SelfUpdateForQueryUcc,
        SelfUpdateManyParamsUcc, SelfUpdateManyPayloadUcc, SelfUpdateTryNewErUcc, SelfUpdateUcc,
