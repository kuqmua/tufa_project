...
use naming::{
    ...
    DefaultOptSomeVecOneElSc, DefaultOptSomeVecOneElUcc, DeleteOneExtraErVrtsSc,
    DeleteOneExtraLogicSc, DeserializeResUcc, DesirableUcc, DisplayPlusToTokens, DisplayToScStr,
    DmExtraErVrtsSc, DmExtraLogicSc, ElSc, EndpointLocationSc, ErSc, ExecutorAcquireSc, ExecutorSc,
    ExpectedResSc, ExtraParamsSc, FailedToGetResTextUcc, FalseSc, FromHandleSc, FutureSc,
    ...
    WhereUcc,
    param::{
        ErSelfSc, IsSelfUpdateExistSc, SelfCreateUcc, SelfDeleteOneErWithSerdeUcc,
        SelfDeleteOneParamsUcc, SelfDeleteOnePayloadUcc, SelfDmParamsUcc, SelfDmPayloadUcc,
        SelfErWithSerdeSc, SelfGenPgTableModSc, SelfHandleSc, SelfPayloadExampleSc,
        SelfPreparePgErUcc, SelfReadOnlyIdsToTwoDimsVecReadInnerAccSc, SelfReadOnlyIdsUcc,
        SelfReadUcc, SelfRoErWithSerdeUcc, SelfSelectUcc, SelfTableTypeUcc, SelfTestsSc,
        SelfTryDeleteOneErUcc, SelfTryRoErUcc, SelfUmParamsUcc, SelfUmPayloadUcc,
        SelfUpdateForQueryUcc, SelfUpdateTryNewErUcc, SelfUpdateUcc, SelfWhereManyTryNewErUcc,
        SelfWhereManyUcc, StdOptOptSelfWhereManyUcc,
...
pub fn gen_pg_table(input: Ts2) -> Ts2 {
    ...
    impl Operation {
        ...
        const fn desirable_status_code(self) -> StatusCode {
            match self {
                ...
                Self::Rm | Self::Ro | Self::Um | Self::Uo | Self::Dm | Self::DeleteOne => {
                    StatusCode::Ok200
                }
            }
        }
        ...
        const fn http_method(self) -> OperationHttpMethod {
            match self {
                ...
                Self::Dm | Self::DeleteOne => OperationHttpMethod::Delete,
            }
        }
    ...
    let ident_try_rm_er_ucc = gen_ident_try_operation_er_ucc(&Operation::Rm);
    ...
    for operation in &[
        ...
        impl_ident_vec_ts.push({
            let try_operation_ts = {
                let result_ok_type_ts: &dyn ToTokens = match &operation {
                    Operation::Rm => &vec_struct_opts_ident_ts,
                    Operation::Ro => &ident_read_ucc,
                    Operation::Dm => &vec_pk_ft_read_ts,
            ...
            let operation_handle_ts = {
                let req_parts_preparation_ts = {
                    let ts0 = &gen_operation_er_init_eprintln_res_creation_ts(
                        operation,
                ...
                let extra_validators_ts = {
                    let (common_extra_logic_ts, operation_extra_logic_ts) = {
                ...
                let query_string_ts = {
                    ...
                    let gen_select_only_updated_ids_query_part_ts =
                        |ts: &dyn ToTokens| quote! {#ts.#SelectOnlyUpdatedIdsQueryPartSc(&mut #IncrSc)};
                    match &operation {
                        Operation::Cm => {
                                ...
                                &gen_fields_named_without_pk_without_comma_ts(&|el: &SynFieldWrapper| {
                                    ...
                                    let ts_33401696 = gen_for_el_in_update_for_query_vec_ts_03fc0945(
                                        ...
                                        &{
                                            ...
                                            quote! {
                                                acc_8ad06c8c.push_str(&#import_ts #GenWhenColumnIdThenVUmQueryPartSc(
                                                    Self::#PkSc(),
                                                    &#ts0,
                                                    &#ts1
                                                ));
                                    ...
                                    quote! {
                                        {
                                            ...
                                            if #is_fi_update_exists_sc {
                                                acc_b86a253a.push_str(&
                                                    #import_ts gen_column_equals_case_acc_else_column_end_comma_um_query_part(
                                                        #fi_dq_ts,
                                                        &{
                                ...
                                &gen_for_el_in_update_for_query_vec_ts(&gen_if_write_is_err_ts_f22b2dd2(
                                    &{
                                        let match_update_query_part_pk_operation_ts =
                                            gen_match_update_query_part_pk_operation_ts(
                                                &quote! {el_a72f3eac},
                                            );
                                        quote! {
                                            acc_a95eb175,
                ...
                let binded_query_ts = {
                    ...
                    match &operation {
                        ...
                        Operation::Co => gen_match_query_bind_or_err_ts_519a3119(
                        ...
                        Operation::Ro => gen_match_query_bind_or_err_ts_519a3119(
                ...
                let pg_logic_ts = {
                    ...
                    let gen_create_update_dm_fetch_ts =
                        |create_or_update_or_dm: &CreateOrUpdateOrDm| {
                            let operation_d1960edc = Operation::from(create_or_update_or_dm);
                            gen_fetch_ts(
                                &ExecutorSc,
                    ...
                    match &operation {
                        Operation::Cm => wrap_into_pg_transaction_begin_commit_ts(
                            operation,
                            &gen_create_update_dm_fetch_ts(&CreateOrUpdateOrDm::Create),
                        ),
                        Operation::Co => wrap_into_pg_transaction_begin_commit_ts(
                            operation,
                        ...
                        Operation::Um => wrap_into_pg_transaction_begin_commit_ts(
                            operation,
                        ...
                        Operation::Dm => wrap_into_pg_transaction_begin_commit_ts(
                            operation,
        ...
        content_ts.push({
            let payload_ts = {
                ...
                match &operation {
                    Operation::Cm => gen_params_payload_and_default_ts(
                        &{
                    ...
                    Operation::Rm => gen_params_payload_and_default_ts(
                        &quote! {{
                    ...
                    Operation::Ro => gen_params_payload_and_default_ts(
                        &{
                    ...
                    Operation::Dm => gen_params_payload_and_default_ts(
    ...
    let ident_tests_ts = {
        ...
        let ident_cm_params_ucc = gen_ident_operation_params_ucc(&Operation::Cm);
        let ident_rm_params_ucc = gen_ident_operation_params_ucc(&Operation::Rm);
        let ident_cm_payload_ucc = gen_ident_operation_payload_ucc(&Operation::Cm);
        let ident_rm_payload_ucc = gen_ident_operation_payload_ucc(&Operation::Rm);
        ...
        let (
            ...
            fi_read_only_ids_merged_with_create_into_opt_v_read_read_only_ids_from_try_co_ident_create_ts,
        ...
        let common_read_only_ids_returned_from_co_ts = {
            ...
            quote! {
                let #CommonReadOnlyIdsReturnedFromCoSc = {
                    let read_only_ids_from_try_co = gen_read_only_ids_from_try_co_default(&#UrlSc, &table_init).await;
        ...
        let add_co_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_ts =
            |ts: &dyn ToTokens| {
                quote! {
                    let read_only_ids_from_try_co = gen_read_only_ids_from_try_co_default(
                        &url_cloned,
                        &table_7e35b1ce
                    ).await;
                    #ts
        ...
        let rm_tests_ts = {
            ...
            let test_rm_by_non_existent_pks_ts = gen_for_in_1_2_ts(
                ...
                &gen_acc_push_future_ts(
                    ...
                    &add_co_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_ts(&gen_assert_ts(
                        &quote!{
                            gen_try_rm_order_by_pk_with_big_pagination(
                                &url_cloned,
                                gen_ident_where_many_pripery_k_others_none(
            ...
            let test_rm_by_equal_to_created_pks_ts = gen_for_in_1_2_ts(&quote! {el_a636d084}, &{
                let ts = gen_acc_push_future_ts(
                        ...
                        &add_co_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_ts(&{
            ...
            quote! {
                acc_9189f86e.push({
                    ...
                    futures::FutureExt::boxed(async move {
                        ...
                        let read_only_ids_returned_from_co = gen_read_only_ids_from_try_co_default(&url, &table_delete_one_cloned).await;
        ...
        let gen_read_only_ids_from_try_co_default_fn_ts = quote! {
            async fn gen_read_only_ids_from_try_co_default(
                #UrlSc: &str,
                table: &str,
            ) -> #ident_read_only_ids_ucc {
        ...
        quote! {
            ...
            mod #ident_tests_sc {
                ...
                fn crud() {
                    ...
                    #gen_read_only_ids_from_try_co_default_fn_ts
