...
use naming::{
    ...
    HeadersSc, IdentCreateDefaultSc, IncrementSc, IntoSerializeDeserializeVersionSc,
    NoFieldsProvidedUcc, NotUniqueFieldSc, NotUniqueFieldUcc, NotUniquePrimaryKeySc,
    NotUniquePrimaryKeyUcc, OptionVecCreateSc, OrderBySc, OrderByUcc, OrderSc, PaginationSc,
    ParametersSc, PayloadSc, PayloadUcc, PgCrudSc, PgPoolForTokioSpawnSyncMoveSc, PgPoolSc, PgSc,
    ...
    PrimaryKeySc, QueryBindSc, QueryPartErrorNamedUcc, QueryPartSc, QueryPartUcc, QuerySc,
    ...
    parameter::{
        ...
        SelfErrorNamedWithSerializeDeserializeSc, SelfGenPgTableModSc, SelfHandleSc,
        SelfPayloadExampleSc, SelfPreparePgErrorNamedUcc,
...
pub fn gen_pg_table(input: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    ...
    struct GenPgTableConfig {
        create_many_content_write_into_gen_pg_table_create_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        create_one_content_write_into_gen_pg_table_create_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        read_many_content_write_into_gen_pg_table_read_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        read_one_content_write_into_gen_pg_table_read_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        update_many_content_write_into_gen_pg_table_update_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        update_one_content_write_into_gen_pg_table_update_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        delete_many_content_write_into_gen_pg_table_delete_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        delete_one_content_write_into_gen_pg_table_delete_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        tests_content_write_into_gen_pg_table_tests: macros_helpers::ShouldWriteTokenStreamIntoFile,
        common_content_write_into_gen_pg_table_common:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
    ...
    let return_err_query_part_error_named_write_into_buffer_ts =
        pg_crud_macros_common::gen_return_err_query_part_error_named_write_into_buffer_ts(
            import_path,
        );
    ...
    let std_vec_vec_ident_read_only_ids_ts =
        pg_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_read_only_ids_ucc);
    ...
    let impl_ident_ts = {
        ...
        let ident_prepare_pg_error_named_ts =
            macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
                ...
                .build_enum(
                    &ident_prepare_pg_error_named_ucc,
                    &quote! {{
        ...
        let pub_async_fn_prepare_extensions_ts = quote! {
            pub async fn #PrepareExtensionsSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>) -> Result<(), #ident_prepare_pg_error_named_ucc> {
                if let Err(#ErrorSc) = sqlx::query("create extension if not exists pg_jsonschema").execute(#PoolSc).await {
                    return Err(#ident_prepare_pg_error_named_ucc::#CreateExtensionIfNotExistsPgJsonschemaUcc {
                        #ErrorSc,
                        code_occurence: error_occurence_lib::code_occurence!()
                    });
                }
                if let Err(#ErrorSc) = sqlx::query("create extension if not exists \"uuid-ossp\"").execute(#PoolSc).await {
                    return Err(#ident_prepare_pg_error_named_ucc::#CreateExtensionIfNotExistsUuidOsspUcc {
                        #ErrorSc,
                        code_occurence: error_occurence_lib::code_occurence!()
                    });
                }
        ...
        let pub_async_fn_prepare_pg_table_ts = {
            let prepare_pg_double_quotes_ts = gen_quotes::double_quotes_ts(&format!(
            ...
            quote! {
                pub async fn #PreparePgTableSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>, table: &str) -> Result<(), #ident_prepare_pg_error_named_ucc> {
                    if let Err(error) = sqlx::query(&format!(
                        ...
                        return Err(#ident_prepare_pg_error_named_ucc::#PreparePgUcc {
                            error,
                            code_occurence: error_occurence_lib::code_occurence!()
                        });
                    }
        ...
        let pub_async_fn_prepare_pg_ts = quote! {
            pub async fn #PreparePgSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>) -> Result<(), #ident_prepare_pg_error_named_ucc> {
        ...
        quote! {
            #ident_prepare_pg_error_named_ts
        }
    };
    ...
    let gen_import_path_value_initialization_ts = |content_ts: &dyn ToTokens| {
        pg_crud_macros_common::gen_value_initialization_ts(&import_path, &content_ts)
    };
    ...
    let ident_create_ts = {
        ...
        let impl_ident_create_ts = {
            ...
            let fn_create_query_part_ts = {
                ...
                quote! {
                    fn #CreateQueryPartSc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, pg_crud::#QueryPartErrorNamedUcc> {
                ...
                &{
                    let fields_initialiation_without_primary_key_with_default_option_some_vec_one_el_ts =
                        gen_fields_named_without_primary_key_with_comma_ts(
                            &|element: &macros_helpers::SynFieldWrapper| {
                                let field_ident = &element.field_ident;
                                quote! {#field_ident: #pg_crud_default_option_some_vec_one_el_call_ts}
                            },
                        );
                    quote! {
                ...
                &{
                    let fields_ts = gen_fields_named_without_comma_ts(
                        &|el_0fd667f6: &macros_helpers::SynFieldWrapper| {
                            ...
                            quote! {
                                #field_ident: Some(
                                    #pg_crud_default_option_some_vec_one_el_call_ts
                                ),
                            }
                        },
                    );
    ...
    let std_option_option_ident_where_many_ts = {
        ...
        let impl_pg_type_where_filter_for_std_option_option_ident_where_many_ts =
            pg_crud_macros_common::impl_pg_type_where_filter_for_ident_ts(
                ...
                &pg_crud_macros_common::ColumnParameterUnderscore::True,
                        ...
                        &|element: &macros_helpers::SynFieldWrapper| {
                            ...
                            quote! {
                                if let Some(value_b12d6fe0) = value_27176ffb.#field_ident {
                                    match pg_crud::PgTypeWhereFilter::query_bind(value_b12d6fe0, #QuerySc) {
                                        Ok(value_edaee3b2) => {
            ...
            pg_crud_macros_common::gen_impl_pg_crud_all_variants_default_option_some_vec_one_el_ts(
                ...
                &{
                    let elements_ts = gen_fields_named_with_comma_ts(
                        &|el_5282570d: &macros_helpers::SynFieldWrapper| {
                            let field_ident_ucc_ts =
                                ToTokensToUccTs::case_or_panic(&el_5282570d.field_ident);
                            quote! {
                                Self::#field_ident_ucc_ts(#pg_crud_default_option_some_vec_one_el_call_ts)
                            }
                        },
                    );
    ...
    let select_pg_crud_default_option_some_vec_one_el_call_ts = quote! {
        #SelectSc: #pg_crud_default_option_some_vec_one_el_call_ts
    };
    let ident_read_ts = {
        let ident_read_ts = {
            ...
            .build_struct(
                ...
                &{
                    let field_option_primary_key_ts = {
                        let std_option_option_value_primary_key_field_type_as_pg_type_read_ts = pg_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_pg_type_read_ts(&primary_key_field_type)));
                        quote! {
                    ...
                    let fields_options_without_primary_key_ts = gen_fields_named_without_primary_key_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        ...
                        let field_ident = &element.field_ident;
                        let std_option_option_value_field_type_as_pg_type_read_ts = pg_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_pg_type_read_ts(&element.field_type)));
                        quote! {
                            #field_attribute_serde_skip_serializing_if_option_is_none_ts
                ...
                &{
                    ...
                    let gen_field_ts = |field_ident: &dyn ToTokens, field_type: &dyn ToTokens, wrap_into_option: &WrapIntoOption| {
                        let field_type_ts = match &wrap_into_option {
                            WrapIntoOption::False => gen_as_pg_type_read_only_ids_ts(&field_type),
                            WrapIntoOption::True => pg_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_as_pg_type_read_only_ids_ts(&field_type)),
                        };
                        quote! {
                ...
                &{
                    let (left_ts, right_ts) = {
                        let maybe_wrap_into_braces_handle_ts = |content_ts: &dyn ToTokens| {
                            pg_crud_macros_common::maybe_wrap_into_braces_ts(
                                content_ts,
            ...
            gen_impl_pg_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                ...
                &{
                    let primary_key_field_with_default_option_some_vec_one_el_ts = {
                        quote! {
                            #primary_key_field_ident: #pg_crud_default_option_some_vec_one_el_call_ts
                        }
                    };
                            ...
                            &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                quote! {
                                    #field_ident: Some(pg_crud::Value{
                                        #ValueSc: #pg_crud_default_option_some_vec_one_el_call_ts
                                    })
                                }
                            },
                        );
    ...
    let ident_update_for_query_ts = {
                ...
                &{
                    let fields_named_without_primary_key_ts = gen_fields_named_without_primary_key_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        ...
                        let option_value_field_type_as_pg_type_update_for_query_ts = {
                            ...
                            pg_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&quote! {#path_value_ts<#syn_type_as_pg_type_update_for_query_ts>})
                        };
        ...
        let impl_ident_update_for_query_ts = {
            let update_query_part_primary_key_ts = {
                quote! {
                    fn #update_query_part_primary_key_sc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, #PgCrudSc::#QueryPartErrorNamedUcc> {
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    quote! {
                        fn #update_query_part_field_ident_sc(
                            ...
                            #IncrementSc: &mut u64
                        ) -> Result<#string_ts, #PgCrudSc::#QueryPartErrorNamedUcc> {
            ...
            let select_only_updated_ids_query_part_ts = {
                ...
                quote! {
                    fn #SelectOnlyUpdatedIdsQueryPartSc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, pg_crud::QueryPartErrorNamed> {
                        ...
                        &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                            ...
                            let value_initialization_ts = gen_import_path_value_initialization_ts(
                                &{
                                    ...
                                    quote! {
                                         #field_type_as_pg_type_update_for_query_ts::from(value_0e64c53a.#ValueSc)
                                    }
                                },
                            );
                            quote! {
    ...
    let std_vec_vec_struct_options_ident_ts =
        pg_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_read_ucc);
    ...
    let gen_fetch_ts = |executor_name_ts: &dyn ToTokens,
        ...
        let content_ts = quote! {
            ...
            while let Some(value_d9cc2c36) = match #PgCrudSc::TryStreamExt::try_next(&mut #RowsSc).await {
    ...
    let gen_write_into_buffer_query_part_syn_variant_error_initialization_eprintln_response_creation_ts =
        |operation: &Operation| {
            let query_part_error_named_write_into_buffer_ts =
                pg_crud_macros_common::gen_query_part_error_named_write_into_buffer_ts(import_path);
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {{
                    ...
                    #PaginationSc: #pg_crud_default_option_some_vec_one_el_call_ts,
                }},
            ),
        );
        let operation_ts = {
    ...
    let update_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(&operation, {
            ...
            let std_vec_vec_ident_update_ts =
                pg_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_update_ucc);
            ...
            let impl_serde_deserialize_for_ident_update_many_payload_ts = {
                ...
                let match_ident_update_many_payload_try_new_field0_ts =
                    pg_crud_macros_common::gen_match_try_new_in_deserialize_ts(
                        &ident_operation_payload_ucc,
                        &quote! {__field0},
                    );
            ...
            let impl_pg_crud_default_option_some_vec_one_el_for_operation_payload_ts =
                gen_impl_pg_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                    &ident_operation_payload_ucc,
                    &quote! {
                        Self(vec![#pg_crud_default_option_some_vec_one_el_call_ts])
                    },
                );
            quote! {
    ...
    let delete_one_ts = {
        ...
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &primary_key_field_type_as_pg_type_read_ucc, &type_variants_from_request_response_syn_variants);
            {
                let parameters_logic_ts = gen_parameters_logic_ts(&operation);
    ...
    let ident_tests_ts = {
        ...
        let ident_create_default_fields_initialization_without_primary_key_ts =
            gen_fields_named_without_primary_key_with_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_type_as_pg_type_create_ts =
                        gen_as_pg_type_create_ts(&element.field_type);
                    quote! {
                 ...
                 should_add_dot_clone: &ShouldAddDotClone| {
                    gen_fields_named_without_primary_key_with_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| {
                            ...
                            quote! {
                                #current_field_ident: <#current_field_type as pg_crud::PgTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(
            ...
            gen_fields_named_without_primary_key_with_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    if field_ident == current_field_ident {
                        ...
                        quote! {
                            #current_field_ident: <
                                <#current_field_type as pg_crud::PgType>::Create as pg_crud::DefaultOptionSomeVecOneEl
                    ...
                    &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                        ...
                        quote! {
                            #current_field_ident: el_f108da5a.#current_field_ident.as_ref().map_or_else(
                                ...
                                <#current_field_type as pg_crud::PgTypeTestCases>::read_only_ids_to_option_value_read_default_option_some_vec_one_el
                            )
                        }
                    },
                );
        ...
        let read_many_tests_ts = {
            ...
            let (
                ...
                let gen_test_read_many_by_equal_one_column_value_ts = |test_name: &str, equal_or_equal_using_fields: &pg_crud_macros_common::EqualOrEqualUsingFields| {
                    gen_read_test_ts(
                        test_name,
                                ...
                                if current_field_ident == primary_key_field_ident {
                                    ...
                                    let method_content_ts = {
                                        let method_ts: &dyn ToTokens = match &equal_or_equal_using_fields {
                                            pg_crud_macros_common::EqualOrEqualUsingFields::Equal => &ReadOnlyIdsMergedWithCreateIntoWhereEqualSc,
                                            pg_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields => &ReadOnlyIdsMergedWithCreateIntoVecWhereEqualUsingFieldsSc
                                        };
                                        quote!{
                                            <#current_field_type as pg_crud::PgTypeTestCases>::#method_ts(
                                    ...
                                    match &equal_or_equal_using_fields {
                                        pg_crud_macros_common::EqualOrEqualUsingFields::Equal => gen_some_pg_type_where_try_new_and_ts(&quote!{
                                            vec![#method_content_ts]
                                        }),
                                        pg_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields => quote!{
                ...
                (
                    gen_test_read_many_by_equal_one_column_value_ts(table_read_only_ids_merged_with_create_into_where_equal_name, &pg_crud_macros_common::EqualOrEqualUsingFields::Equal),
                    gen_test_read_many_by_equal_one_column_value_ts(table_read_only_ids_merged_with_create_into_vec_where_equal_using_fields_name, &pg_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields),
                )
            };
            let read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_ts = gen_read_test_ts(table_read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_name, &gen_option_vec_create_call_unwrap_or_vec_ts, &gen_ident_create_content_el_ts, &|element: &macros_helpers::SynFieldWrapper| {
                ...
                quote! {
                    if let Some(value_d5cd3c70) = <#field_type as pg_crud::PgTypeTestCases>::#ReadOnlyIdsMergedWithCreateIntoOptionVecWhereEqualToJsonFieldSc(
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_a8bfc0c0: &macros_helpers::SynFieldWrapper| {
                        ...
                        if current_field_ident == primary_key_field_ident {
                            ...
                            gen_some_pg_type_where_try_new_and_ts(&quote! {vec![value_60baba1f]})
                        } else {
                            none_ts.clone()
                        }
                    }));
                    quote! {
                        if let Some(value_60baba1f) = <#field_type as pg_crud::PgTypeTestCases>::#ReadOnlyIdsMergedWithTableTypeDeclarationIntoPgTypeOptionWhereGreaterThanSc(
                            #ElementSc.variant,
            ...
            let (
                ...
                let gen_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_number_equal_ts =
                    |test_name: &str, dimension: &pg_crud_macros_common::Dimension| {
                ...
                (
                    gen_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_one_equal_name, &pg_crud_macros_common::Dimension::One),
                    gen_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_two_equal_name, &pg_crud_macros_common::Dimension::Two),
                    gen_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_three_equal_name, &pg_crud_macros_common::Dimension::Three),
                    gen_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_dimension_four_equal_name, &pg_crud_macros_common::Dimension::Four),
                )
            };
            let create_into_pg_json_type_option_vec_where_length_equal_ts = gen_read_test_ts(
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    quote! {
                        if let Some(value_f825e068) = <#field_type as pg_crud::PgTypeTestCases>::#CreateIntoPgJsonTypeOptionVecWhereLengthEqualSc(
                            ident_create.#field_ident.clone()
                        ) {
            ...
            let create_into_pg_json_type_option_vec_where_length_greater_than_ts = gen_read_test_ts(
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(
                        &gen_fields_named_with_comma_ts(
                            &|el_c927ab80: &macros_helpers::SynFieldWrapper| {
                                let current_field_ident = &el_c927ab80.field_ident;
                                if current_field_ident == primary_key_field_ident {
                                    some_primary_key_where_initialization_ts.clone()
                                } else if current_field_ident == field_ident {
                                    gen_some_pg_type_where_try_new_and_ts(
                                        &quote! {vec![el_527b546b]},
                                    )
                                } else {
                                    none_ts.clone()
                                }
                    ...
                    quote! {
                        if let Some(value_cd4aa374) = <#field_type as pg_crud::PgTypeTestCases>::#CreateIntoPgJsonTypeOptionVecWhereLengthGreaterThanSc(
                            ident_create.#field_ident.clone()
                        ) {
            ...
            let (
                ...
                let gen_read_only_ids_merged_with_create_into_pg_json_type_option_vec_where_filter_ts =
                    ...
                    &|element: &macros_helpers::SynFieldWrapper|{
                        ...
                        quote!{
                            if let Some(value_0b85c066) = <#field_type as pg_crud::PgTypeTestCases>::#method_ts(
                        ...
                        let ident_read_only_ids_upper_fields_initialization_without_primary_key_ts =
                            gen_fields_named_without_primary_key_with_comma_ts(
                                &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                                    ...
                                    let current_field_type = &syn_field_wrapper.field_type;
                                    if field_ident == current_field_ident {
                                        quote! {#current_field_ident: Some(<#current_field_type as pg_crud::PgTypeTestCases>::update_to_read_only_ids(&update))}
                                    } else {
                                    ...
                                    if field_ident == current_field_ident {
                                        let value_initialization_ts =
                                            gen_import_path_value_initialization_ts(&{
                                                ...
                                                quote! {
                                                    <#current_field_type as pg_crud::PgTypeTestCases>::previous_read_merged_with_option_update_into_read(
                                                        <#current_field_type as pg_crud::PgTypeTestCases>::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                    ...
                    futures::FutureExt::boxed(async move {
                        if let Err(#ErrorSc) = gen_try_delete_one_handle(
                            ...
                            if let #ident_try_delete_one_error_named_ucc::#ident_delete_one_error_named_with_serialize_deserialize_ucc {
                                ...
                                if let #ident_delete_one_error_named_with_serialize_deserialize_ucc::Pg {
                                    pg,
                                    ..
                                } = delete_one_error_named_with_serialize_deserialize {
            ...
            mod #ident_tests_sc {
                ...
                fn crud() {
                    ...
                    async fn gen_try_delete_one_handle(
                        ...
                        table: &str,
                    ) -> Result<#primary_key_field_type_as_pg_type_read_ts, #ident_try_delete_one_error_named_ucc> {
                    ...
                    tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                        ...
                        #ident::prepare_extensions(&#PgPoolSc).await.expect("0633ff48-ebc4-460f-a282-d750511f5d78");
