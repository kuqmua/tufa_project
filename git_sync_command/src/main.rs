...
fn main() {
    ...
    let string_path =
        env::var(gitmodules_path_env_name).expect("25f5388e-57cf-46df-ba63-98d259cfe4da");
    ...
    let canonicalize_pathbuf =
        fs::canonicalize(&parent_dir_pathbuf).expect("2bcd326b-6576-4f00-836f-5857cc617770");
