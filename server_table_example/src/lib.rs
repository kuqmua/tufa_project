...
impl TableExample {
    ...
    pub async fn prepare_postgresql_table(pool: &sqlx::Pool<sqlx::Postgres>, table: &str) -> Result<(), TableExamplePreparePostgresqlErrorNamed> {
        if let Err(error) = sqlx::query(&format!(
            ...
            <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::create_table_column_query_part(&"column_142", false)
        ))
        .execute(pool)
        .await
        {
    ...
    fn generate_select_query_part(select: &postgresql_crud::NotEmptyUniqueEnumVec<TableExampleSelect>) -> Result<String, postgresql_crud::QueryPartErrorNamed> {
        ...
        for element in select.to_vec() {
            value.push_str(&match element {
                ...
                TableExampleSelect::Column142(value) => match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::select_query_part(value, "column_142") {
                    Ok(value) => value,
                    Err(error) => {
                        return Err(error);
                    }
    ...
    async fn create_many_handle(app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request, table: &str) -> axum::response::Response {
        ...
        let query_string = postgresql_crud::generate_create_many_query_string(
            ...
            &{
                ...
                match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::select_only_ids_query_part("column_142") {
                    Ok(value) => {
                        acc.push_str(&value);
                    }
                    Err(error_0) => {
        ...
        let binded_query = {
            ...
            for element in &update_for_query_vec {
                if let Some(value) = &element.column_142 {
                    ...
                    match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::update_query_bind(value.value.clone(), query) {
                        Ok(value) => {
                            query = value;
                        }
                        Err(error_0) => {
            ...
            for element in &update_for_query_vec {
                if let Some(value) = &element.column_142 {
                    match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::select_only_updated_ids_query_bind(&value.value, query) {
                        Ok(value) => {
                            query = value;
                        }
                        Err(error_0) => {
...
pub struct TableExampleCreate {
    ...
    pub column_142: <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Create,
}
impl TableExampleCreate {
    fn create_query_part(&self, increment: &mut u64) -> Result<String, postgresql_crud::QueryPartErrorNamed> {
        ...
        match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::create_query_part(&self.column_142, increment) {
            Ok(value) => {
                use std::fmt::Write as _;
                if write!(acc, "{value},").is_err() {
                    return Err(postgresql_crud::QueryPartErrorNamed::WriteIntoBuffer { code_occurence: error_occurence_lib::code_occurence!() });
    ...
    fn create_query_bind(self, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>, String> {
        ...
        match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::create_query_bind(self.column_142, query) {
            Ok(value) => {
                query = value;
            }
            Err(error_0) => {
...
pub struct TableExampleWhereMany {
    ...
    column_142: Option<postgresql_crud::PostgresqlTypeWhere<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Where>>,
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    let Some(__field2) = serde::de::SeqAccess::next_element::<Option<postgresql_crud::PostgresqlTypeWhere<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Where>>>(&mut __seq)? else {
                        return Err(serde::de::Error::invalid_length(0usize, &"struct TableExampleWhereMany with 3 elements"));
                    };
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field2: Option<Option<postgresql_crud::PostgresqlTypeWhere<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Where>>> = None;
                    while let Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            ...
                            __Field::__field2 => {
                                ...
                                __field2 = Some(serde::de::MapAccess::next_value::<Option<postgresql_crud::PostgresqlTypeWhere<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Where>>>(&mut __map)?);
                            }
                            __Field::__ignore => {
...
pub enum TableExampleSelect {
    ...
    Column142(<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Select),
}
...
pub struct TableExampleRead {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub column_142: Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Read>>,
}
impl TableExampleRead {
    fn try_from_sqlx_postgres_pg_row_with_not_empty_unique_enum_vec_table_example_select(value: sqlx::postgres::PgRow, select: &postgresql_crud::NotEmptyUniqueEnumVec<TableExampleSelect>) -> Result<Self, sqlx::Error> {
        ...
        let mut column_142: Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Read>> = None;
        for element in select.to_vec() {
            match element {
                ...
                TableExampleSelect::Column142(_) => match sqlx::Row::try_get::<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Read, &str>(&value, "column_142") {
                    Ok(value) => {
...
pub struct TableExampleReadOnlyIds {
    ...
    pub column_142: Option<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::ReadOnlyIds>,
}
...
pub struct TableExampleUpdate {
    ...
    column_142: Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Update>>,
}
#[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    let Some(__field2) = serde::de::SeqAccess::next_element::<Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Update>>>(&mut __seq)? else {
                        return Err(serde::de::Error::invalid_length(0usize, &"struct TableExampleUpdate with 3 elements"));
                    };
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field2: Option<Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Update>>> = None;
                    while let Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                if Option::is_some(&__field0) {
                            ...
                            __Field::__field2 => {
                                ...
                                __field2 = Some(serde::de::MapAccess::next_value::<Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Update>>>(&mut __map)?);
                            }
                            __Field::__ignore => {
                                let _: serde::de::IgnoredAny = _serde::de::MapAccess::next_value::<_serde::de::IgnoredAny>(&mut __map)?;
                            }
...
pub struct TableExampleUpdateForQuery {
    ...
    column_142: Option<postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::UpdateForQuery>>,
}
impl TableExampleUpdateForQuery {
    ...
    fn update_query_part_column_142(value: &postgresql_crud::Value<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::UpdateForQuery>, increment: &mut u64) -> Result<String, postgresql_crud::QueryPartErrorNamed> {
        match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::update_query_part(&value.value, "column_142", "column_142", "", increment) {
            Ok(value) => Ok(value),
            Err(error_0) => Err(error_0),
        }
    }
    fn select_only_updated_ids_query_part(&self, increment: &mut u64) -> Result<String, postgresql_crud::QueryPartErrorNamed> {
        ...
        if let Some(value) = &self.column_142 {
            acc.push_str(&match <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::select_only_updated_ids_query_part(&value.value, "column_142", increment) {
                Ok(value) => value,
                Err(error) => {
                    return Err(error);
                }
            ...
            .spawn(|| {
                tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                    ...
                    let ident_create_default = TableExampleCreate {
                        ...
                        column_142: <<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Create as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>::default_but_option_is_always_some_and_vec_always_contains_one_element(),
                    };
                    let select_default_all_with_max_page_size = postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec![
                        ...
                        TableExampleSelect::Column142(<<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlType>::Select as postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize>::default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size()),
                    ])
                    ...
                    futures::StreamExt::for_each_concurrent(
                        futures::stream::iter({
                            let mut acc: Vec<futures::future::BoxFuture<'static, ()>> = vec![];
                            {
                                            ...
                                            assert_eq!(
                                                {
                                                    ...
                                                    for (read_only_ids, create) in read_only_ids_from_try_create_many.clone().into_iter().zip(ident_vec_create.into_iter()) {
                                                        acc.push(TableExampleRead {
                                                            ...
                                                            column_142: <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids.column_142.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), create.column_142),
                                                        });
                                                    }
                                ...
                                {
                                    for chunk in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create().unwrap_or(vec![]).chunks(10).map(Vec::from) {
                                        let current_table = current_table.clone();
                                        let url_cloned = url.clone();
                                        let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                                        acc.push(futures::FutureExt::boxed(async move {
                            ...
                            };
                            {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(
                                                TableExampleRead {
                                                    ...
                                                    column_142: <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_from_try_create_one.column_142.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_142)
                                                },
                                ...
                                {
                                    for element in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create().unwrap_or(vec![]) {
                                        let current_table = current_table.clone();
                                        let url_cloned = url.clone();
                                        let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                                        acc.push(futures::FutureExt::boxed(async move {
                            ...
                            };
                            {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            assert_eq!(
                                                vec![TableExampleRead {
                                                    ...
                                                    column_142: <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_142.clone().expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_142.clone())
                                                }],
                                                TableExample::try_read_many_handle(
                                                    &url_cloned,
                                                    TableExampleReadManyParameters {
                                                            ...
                                                            where_many: StdOptionOptionTableExampleWhereMany(Some(
                                                                TableExampleWhereMany::try_new(
                                                                    ...
                                                                    Some(
                                                                        postgresql_crud::PostgresqlTypeWhere::try_new(
                                                                            postgresql_crud::LogicalOperator::And,
                                                                            vec![<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_where_equal(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_142.clone())]
                                                                        )
                                                                        .expect("error c10cf3d9-f531-442a-99f0-f36c80fee4b1"),
                                                                    )
                                                                )
                                                            ...
                                                            where_many: StdOptionOptionTableExampleWhereMany(Some(
                                                                TableExampleWhereMany::try_new(
                                                                    ...
                                                                    Some(
                                                                        postgresql_crud::PostgresqlTypeWhere::try_new(
                                                                            postgresql_crud::LogicalOperator::And,
                                                                            <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_vec_where_equal_using_fields(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_142.clone())
                                                                        )
                                                                        .expect("error c10cf3d9-f531-442a-99f0-f36c80fee4b1"),
                                                                    )
                                                                )
                                ...
                                };
                                {
                                    ...
                                    for element in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create().unwrap_or(vec![]) {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create().unwrap_or(vec![]) {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::create_into_postgresql_type_option_vec_where_dimension_one_equal(ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::postgresql_type_option_vec_where_greater_than_test().unwrap_or(vec![]) {
                                        let current_table = current_table.clone();
                                        let url_cloned = url.clone();
                                        let select_default_all_with_max_page_size_cloned = select_default_all_with_max_page_size.clone();
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_greater_than(element.variant, read_only_ids_returned_from_create_one.column_142.clone().expect("error 2f7cdf57-72f7-4a1d-a1a1-8a7cbc5b90db"), element.greater_than) {
                                                assert_eq!(
                                                    vec![TableExampleRead {
                                                        primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                                        column_0: <postgresql_crud::StdPrimitiveI16AsNotNullInt2 as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_0.clone().expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create.column_0.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in {
                                        let mut acc = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::option_vec_create().unwrap_or(vec![]);
                                        if acc.is_empty() {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_one_equal(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_two_equal(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_three_equal(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_four_equal(read_only_ids_returned_from_create_one.column_142.clone().expect("error 2ed000a5-cf70-4df1-903a-c1f6d224e926"), ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                ...
                                };
                                {
                                    ...
                                    for element in {
                                        ...
                                        acc.push(futures::FutureExt::boxed(async move {
                                            ...
                                            let read_only_ids_returned_from_create_one = TableExample::try_create_one_handle(&url_cloned, TableExampleCreateOneParameters { payload: ident_create.clone() }, &current_table).await.expect("error d6f20011-a88d-44f6-af7f-b2b8eca4c649");
                                            if let Some(value) = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::create_into_postgresql_json_type_option_vec_where_length_equal(ident_create.column_142.clone()) {
                                                for element in value {
                                                    assert_eq!(
                                                        vec![TableExampleRead {
                                                            primary_key_column: <postgresql_crud::SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_returned_from_create_one.primary_key_column.clone()),
                                                ...
                                                for element in &read_only_ids_current_elements {
                                                    acc.push(TableExampleRead {
                                                        ...
                                                        column_142: match &element.column_142 {
                                                            Some(value) => <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value),
                                                            None => Some(postgresql_crud::Value {
                                                                value: postgresql_crud::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
                                                            }),
                                                        },
                                ...
                                };
                                {
                                    let read_only_ids_to_two_dimensional_vec_read_inner_acc = {
                                        ...
                                        if let Some(value) = &common_read_only_ids_returned_from_create_one.column_142 {
                                            for element in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(value) {
                                                for _ in element {
                                                    acc.push(ident_create_default.clone());
                                                }
                                            }
                                    ...
                                    if read_only_ids_to_two_dimensional_vec_read_inner_acc.is_empty() {
                                        ...
                                        for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                                            ...
                                            acc.push(futures::FutureExt::boxed(async move {
                                                ...
                                                let update = <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_inner_into_update_with_new_or_try_new_unwraped({
                                                    let mut local_increment: usize = 0;
                                                    let mut option_test_case = None;
                                                    for element_0 in <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&read_only_ids_current_element.column_142.clone().expect("error c4d98a71-f30f-410e-b410-a75f4672f2f7")) {
                                                        let mut should_break = false;
                                                        for element_1 in element_0 {
                                                            if local_increment == increment {
                                                                option_test_case = Some(element_1);
                                                ...
                                                assert_eq!(
                                                    vec![TableExampleReadOnlyIds {
                                                        primary_key_column: read_only_ids_current_element.primary_key_column.clone(),
                                                        column_0: None,
                                                        column_142: Some(<server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update))
                                                    }],
                                                    TableExample::try_update_many_handle(
                                                        &url_cloned,
                                                        TableExampleUpdateManyParameters {
                                                ...
                                                assert_eq!(
                                                    {
                                                        ...
                                                        for element in previous_read {
                                                            acc.push(TableExampleRead {
                                                                ...
                                                                column_142: Some(postgresql_crud::Value {
                                                                    value: <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::previous_read_merged_with_option_update_into_read(
                                                                        <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(&read_only_ids_current_element.column_142.clone().expect("error 4f19d0d2-a23f-4b77-a2bc-c7b04db7a129"))
                                                                            .expect("error c7685b19-9bca-47bc-a3a5-8fc543b174a5")
                                                                            .value,
                                                                        Some(update.clone()),
                                                                    ),
                                ...
                                acc.push(futures::FutureExt::boxed(async move {
                                    ...
                                    assert_eq!(
                                        TableExampleRead {
                                            ...
                                            column_142: <server_types::AnimalAsNotNullJsonbObject as postgresql_crud::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_option_value_read(read_only_ids_returned_from_create_one.column_142.expect("error 88038e29-adc7-4e1c-ae5b-609c18831a1b"), ident_create_default.column_142)
                                        },
                                        TableExample::try_read_one_handle(
                                            &url_cloned,
                                            TableExampleReadOneParameters {
