...
//         common::repositories_types::tufa_server::routes::admin::newsletter::post::FormData,
//     >,
...
//     let common::repositories_types::tufa_server::routes::admin::newsletter::post::FormData {
//         title,
//         text_content,
//         html_content,
//         idempotency_key,
//     } = form.0;
//     let idempotency_key: common::repositories_types::tufa_server::idempotency::IdempotencyKey =
//         idempotency_key
//             .try_into()
//             .map_err(common::repositories_types::tufa_server::utils::status_codes::e400)?;
...
//     {
//         common::repositories_types::tufa_server::idempotency::NextAction::StartProcessing(t) => t,
//         common::repositories_types::tufa_server::idempotency::NextAction::ReturnSavedResponse(saved_response) => {
...
//         .await
//         .map_err(common::repositories_types::tufa_server::utils::status_codes::e500)?;
//     let response = common::repositories_types::tufa_server::utils::status_codes::see_other(
//         "/admin/newsletters",
//     );
//     let response =
