...
pub fn generate_postgresql_types(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .map(|element|{
        ...
        let generate_ident_token_stream = |postgresql_type_pattern: &PostgresqlTypePattern, not_null_or_nullable: &postgresql_crud_macros_common::NotNullOrNullable|{
            ...
            let (rust_part, postgresql_part) = match &postgresql_type_pattern {
                ...
                PostgresqlTypePattern::ArrayDimension1 {
                    ...
                    (
                        format!("{vec_of_upper_camel_case}{d1_rust}{rust_type_name}"),
                        format!("{array_of_upper_camel_case}{d1}{postgresql_type_name}")
                    )
                },
                // PostgresqlTypePattern::ArrayDimension2 {
                //     dimension1_not_null_or_nullable,
        ...
        let ident = &generate_ident_token_stream(&postgresql_type_pattern, &not_null_or_nullable);
        ...
        let (
            ...
            let serde_serialize = {
                ...
                match &postgresql_type {
                    ...
                    PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsTimestampTzRange => postgresql_crud_macros_common::DeriveOrImpl::Impl(impl_serde_serialize_for_postgresql_type_not_null_tokens_serde_serialize_content_e5bb5640_d9fe_4ed3_9862_6943f8efee90_token_stream),
                    PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoLocalAsTimestampTzRange => postgresql_crud_macros_common::DeriveOrImpl::Impl(impl_serde_serialize_for_postgresql_type_not_null_tokens_serde_serialize_content_e5bb5640_d9fe_4ed3_9862_6943f8efee90_token_stream),
                }
            };
            let serde_deserialize = {
                ...
                match &postgresql_type {
                    ...
                    PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimeDateAsDateRange => postgresql_crud_macros_common::DeriveOrImpl::Impl(generate_impl_serde_deserialize_for_tokens_2a45b124_f34d_4526_b85d_52516d6a5486_token_stream(&impl_serde_de_visitor_for_visitor_sqlx_postgres_types_pg_range_sqlx_types_time_date_token_stream)),
