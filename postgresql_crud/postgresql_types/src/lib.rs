...
struct VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin(std::vec::Vec<StdPrimitiveI16AsNotNullInt2Origin>);
...
impl std::convert::Into<std::vec::Vec<std::primitive::i16>> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin {
    fn into(self) -> std::vec::Vec<std::primitive::i16> {
...
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
pub struct VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin);
impl VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration {
    pub fn new(value: std::vec::Vec<std::primitive::i16>) -> Self {
        Self(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin::new(value))
    }
}
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
...
impl sqlx::Type<sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
...
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&self.0, buf)
    }
}
impl sqlx::Decode<'_, sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration {
    fn decode(value: sqlx::postgres::PgValueRef<'_>) -> Result<Self, sqlx::error::BoxDynError> {
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
pub struct VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Create(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin);
impl VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Create {
    pub fn new(value: std::vec::Vec<std::primitive::i16>) -> Self {
        Self(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin::new(value))
    }
}
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Create {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self(postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element())
    }
}
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Create {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&self.0, buf)
    }
}
impl sqlx::Type<sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Create {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
...
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Select {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
...
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Select {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element_with_max_page_size() -> Self {
        Self {
...
pub enum VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2WhereElement {
    Equal(where_element_filters::PostgresqlTypeWhereElementEqual<VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration>),
    ...
    DimensionOneIn(where_element_filters::PostgresqlTypeWhereElementDimensionOneIn<StdPrimitiveI16AsNotNullInt2TableTypeDeclaration>),
}
impl<'a> postgresql_crud_common::PostgresqlTypeWhereFilter<'a> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2WhereElement {
    fn query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud_common::QueryPartErrorNamed> {
        match &self {
...
impl postgresql_crud_common::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2WhereElement {
...
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Read {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self(postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element())
    }
}
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
pub struct VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Update(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin);
impl VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Update {
    pub fn new(value: std::vec::Vec<std::primitive::i16>) -> Self {
        Self(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin::new(value))
    }
}
impl postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Update {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self(postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element())
    }
}
impl error_occurence_lib::ToStdStringString for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Update {
    fn to_std_string_string(&self) -> std::string::String {
        self.0.to_std_string_string()
    }
}
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize)]
pub struct VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2UpdateForQuery(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin);
impl sqlx::Type<sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2UpdateForQuery {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> std::primitive::bool {
...
impl sqlx::Encode<'_, sqlx::Postgres> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2UpdateForQuery {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> Result<sqlx::encode::IsNull, Box<dyn std::error::Error + Send + Sync>> {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&self.0, buf)
    }
}
impl std::convert::From<VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Update> for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2UpdateForQuery {
    fn from(value: VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Update) -> Self {
        Self(value.0)
    }
}
impl postgresql_crud_common::PostgresqlType for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 {
    ...
    fn normalize(value: Self::Read) -> Self::Read {
        VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Read(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Origin(value.0.0.into_iter().map(|element| <StdPrimitiveI16AsNotNullInt2 as postgresql_crud_common::PostgresqlType>::normalize(StdPrimitiveI16AsNotNullInt2Read(element)).0).collect()))
    }
    ...
    type UpdateForQuery = VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2UpdateForQuery;
...
impl postgresql_crud_common::PostgresqlTypeTestCases for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 {
    type PostgresqlType = Self;
    type Select = VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Select;
    fn vec_create() -> std::vec::Vec<<Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Create> {
        let mut acc = vec![];
        for element in <StdPrimitiveI16AsNotNullInt2 as postgresql_crud_common::PostgresqlTypeTestCases>::vec_create() {
            acc.push(<VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 as postgresql_crud_common::PostgresqlType>::Create::new(vec![element.0.into()]));
        }
        acc.push(<VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 as postgresql_crud_common::PostgresqlType>::Create::new(<StdPrimitiveI16AsNotNullInt2 as postgresql_crud_common::PostgresqlTypeTestCases>::vec_create().into_iter().map(|element| element.0.into()).collect()));
        if let Some(value) = <StdPrimitiveI16AsNotNullInt2 as postgresql_crud_common::PostgresqlTypeTestCases>::vec_create().get(0) {
            acc.push(<VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 as postgresql_crud_common::PostgresqlType>::Create::new(vec![value.clone().0.into(); 2]));
            acc.push(<VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 as postgresql_crud_common::PostgresqlType>::Create::new(vec![value.clone().0.into(); 1000]));
        }
        acc
    }
    fn read_only_ids_to_two_dimensional_vec_read_inner(read_only_ids: &<Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadOnlyIds) -> std::vec::Vec<std::vec::Vec<<Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadInner>> {
        let mut acc = vec![];
        let read_only_ids_to_two_dimensional_vec_read_inner = <StdPrimitiveI16AsNotNullInt2 as postgresql_crud_common::PostgresqlTypeTestCases>::read_only_ids_to_two_dimensional_vec_read_inner(&read_only_ids);
    ...
    fn read_inner_into_read_with_new_or_try_new_unwraped(value: std::vec::Vec<std::primitive::i16>) -> <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Read {
        <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Read::new(value)
    }
    fn read_inner_into_update_with_new_or_try_new_unwraped(value: std::vec::Vec<std::primitive::i16>) -> <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Update {
    ...
    fn previous_read_merged_with_option_update_into_read(read: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Read, option_update: std::option::Option<<Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Update>) -> <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Read {
        <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::normalize(match option_update {
            Some(value) => VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Read(value.0),
            None => read,
        })
    }
    fn read_only_ids_merged_with_create_into_read(read_only_ids: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Read {
        <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::normalize(VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Read(create.0))
    }
    fn read_only_ids_merged_with_create_into_option_value_read(read_only_ids: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Create) -> std::option::Option<postgresql_crud_common::Value<<Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Read>> {
        Some(postgresql_crud_common::Value {
            value: <VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 as postgresql_crud_common::PostgresqlTypeTestCases>::read_only_ids_merged_with_create_into_read(read_only_ids, create),
        })
    }
    fn read_only_ids_merged_with_create_into_table_type_declaration(read_only_ids: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::TableTypeDeclaration {
        VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration(create.0)
    }
    fn read_only_ids_merged_with_create_into_where_element_equal(read_only_ids: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Create) -> <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::WhereElement {
        VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2WhereElement::Equal(where_element_filters::PostgresqlTypeWhereElementEqual {
            logical_operator: postgresql_crud_common::LogicalOperator::Or,
            value: VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration(create.0),
        })
    }
    fn read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields(read_only_ids: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::ReadOnlyIds, create: <Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::Create) -> std::vec::Vec<<Self::PostgresqlType as postgresql_crud_common::PostgresqlType>::WhereElement> {
        vec![VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2WhereElement::Equal(where_element_filters::PostgresqlTypeWhereElementEqual {
            logical_operator: postgresql_crud_common::LogicalOperator::Or,
            value: VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration(create.0),
        })]
    }
...
impl postgresql_crud_common::PostgresqlTypeNotPrimaryKey for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2 {
    type PostgresqlType = VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2;
    type Create = VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2Create;
}
impl postgresql_crud_common::PostgresqlTypeEqualOperator for VecOfStdPrimitiveI16AsNotNullArrayOfNotNullInt2TableTypeDeclaration {
