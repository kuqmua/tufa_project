    ...
    .map(|(index, element)| {
        ...
        let generate_typical_query_bind_token_stream = |content_token_stream: &dyn quote::ToTokens| match &not_null_or_nullable {
            ...
            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                if let Err(#error_snake_case) = #query_snake_case.try_bind(#content_token_stream.0.0) {
                        ...
                        generate_serialize_field_token_stream(
                            ...
                            &quote::quote! {
                                &match self.0.#start_or_end_token_stream {
                                    std::ops::Bound::Included(#value_snake_case) => std::ops::Bound::Included(#current_ident_token_stream::#try_new_snake_case(#value_snake_case).map_err(_serde::ser::Error::custom)?),
                                    std::ops::Bound::Excluded(#value_snake_case) => std::ops::Bound::Excluded(#current_ident_token_stream::#try_new_snake_case(#value_snake_case).map_err(_serde::ser::Error::custom)?),
                                    std::ops::Bound::Unbounded => std::ops::Bound::Unbounded,
                                }
                            },
                        )
        ...
        let sqlx_types_chrono_naive_time_min_function_token_stream = quote::quote!{sqlx_types_chrono_naive_time_min};
        let sqlx_types_chrono_naive_time_ten_function_token_stream = quote::quote!{sqlx_types_chrono_naive_time_ten};
        let sqlx_types_chrono_naive_time_twenty_function_token_stream = quote::quote!{sqlx_types_chrono_naive_time_twenty};
        let sqlx_types_chrono_naive_time_max_function_token_stream = quote::quote!{sqlx_types_chrono_naive_time_max};
        let sqlx_types_chrono_naive_date_min_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_min};

        let sqlx_types_chrono_naive_date_negative_less_typical_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_negative_less_typical};
        let sqlx_types_chrono_naive_date_negative_more_typical_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_negative_more_typical};
        let sqlx_types_chrono_naive_date_near_zero_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_near_zero};
        let sqlx_types_chrono_naive_date_positive_less_typical_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_positive_less_typical};
        let sqlx_types_chrono_naive_date_positive_more_typical_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_positive_more_typical};
        let sqlx_types_chrono_naive_date_max_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_max};
        let sqlx_types_chrono_naive_date_max_pred_opt_expect_function_token_stream = quote::quote!{sqlx_types_chrono_naive_date_max_pred_opt_expect};
        ...
        let ident_token_stream = {
                ...
                matches!(&not_null_or_nullable, postgresql_crud_macros_common::NotNullOrNullable::NotNull)
            {
                ...
                let maybe_min_inner_type_token_stream = {
                    let generate_inner_type_token_stream_67fc7980 = |
                        is_const: IsConst,
                        content_token_stream_1ca2df79: &dyn quote::ToTokens
                    |generate_inner_type_token_stream(
                        is_const,
                        &quote::quote!{min_inner_type},
                        &content_token_stream_1ca2df79
                    );
                    match &postgresql_type {
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some(
                            generate_inner_type_token_stream_67fc7980(
                                IsConst::True,
                                &quote::quote!{
                ...
                let maybe_slightly_more_than_min_inner_type_token_stream = {
                    let generate_inner_type_token_stream_6d89728a = |
                        is_const: IsConst,
                        content_token_stream_dcc22544: &dyn quote::ToTokens
                    |generate_inner_type_token_stream(
                        is_const,
                        &quote::quote!{slightly_more_than_min_inner_type},
                        &content_token_stream_dcc22544
                    );
                    match &postgresql_type {
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some(
                            generate_inner_type_token_stream_6d89728a(
                                IsConst::True,
                                &quote::quote!{
                ...
                let maybe_middle_inner_type_token_stream = {
                    let generate_inner_type_token_stream_23368199 = |
                        is_const: IsConst,
                        content_token_stream_645cff79: &dyn quote::ToTokens
                    |generate_inner_type_token_stream(
                        is_const,
                        &quote::quote!{middle_inner_type},
                        &content_token_stream_645cff79
                    );
                    match &postgresql_type {
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some(
                            generate_inner_type_token_stream_23368199(
                                IsConst::True,
                                &quote::quote!{
                ...
                let maybe_slightly_more_than_middle_inner_type_token_stream = {
                    let generate_inner_type_token_stream_3a61c0b0 = |
                        is_const: IsConst,
                        content_token_stream_e09b85a8: &dyn quote::ToTokens
                    |generate_inner_type_token_stream(
                        is_const,
                        &quote::quote!{slightly_more_than_middle_inner_type},
                        &content_token_stream_e09b85a8
                    );
                    match &postgresql_type {
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some(
                            generate_inner_type_token_stream_3a61c0b0(
                                IsConst::True,
                                &quote::quote!{
                ...
                let maybe_max_inner_type_token_stream = {
                    let generate_inner_type_token_stream_32acb388 = |
                        is_const: IsConst,
                        content_token_stream_385694da: &dyn quote::ToTokens
                    |generate_inner_type_token_stream(
                        is_const,
                        &quote::quote!{max_inner_type},
                        &content_token_stream_385694da
                    );
                    match &postgresql_type {
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some(
                            generate_inner_type_token_stream_32acb388(
                                IsConst::True,
                                &quote::quote!{
                ...
                let maybe_slightly_less_than_max_inner_type_token_stream = {
                    let generate_inner_type_token_stream_ddf0f630 = |
                        is_const: IsConst,
                        content_token_stream_5ca08aea: &dyn quote::ToTokens
                    |generate_inner_type_token_stream(
                        is_const,
                        &quote::quote!{slightly_less_than_max_inner_type},
                        &content_token_stream_5ca08aea
                    );
                    match &postgresql_type {
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some(
                            generate_inner_type_token_stream_ddf0f630(
                                IsConst::True,
                                &quote::quote!{
                ...
                let maybe_read_inner_initializations_token_stream = {
                    let generate_function_token_stream = |
                        name_token_stream: &proc_macro2::TokenStream,
                        content_token_stream_5dfcb210: &proc_macro2::TokenStream
                    |quote::quote!{
                        const fn #name_token_stream() -> #ident_inner_type_token_stream {
                            #content_token_stream_5dfcb210
                        }
                    };
                    match &postgresql_type {
                        PostgresqlType::StdPrimitiveI16AsInt2 |
                        ...
                        PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => Some({
                            let content_token_stream_80e0683c = [
                                ...
                                (&sqlx_types_chrono_naive_time_ten_function_token_stream, &quote::quote!{10,10,10,10}),
                                (&sqlx_types_chrono_naive_time_twenty_function_token_stream, &quote::quote!{20,20,20,20}),
                                (&sqlx_types_chrono_naive_time_max_function_token_stream, &quote::quote!{23,59,59,999_999}),
                            ].iter().map(|(name_token_stream, parameters_token_stream)| quote::quote! {
                                const fn #name_token_stream() -> #ident_inner_type_token_stream {
                                    #ident_inner_type_token_stream::from_hms_micro_opt(#parameters_token_stream).expect("149e01cc-429b-4783-bfc1-2908db0b801f")
                                }
                        ...
                        PostgresqlType::SqlxTypesChronoNaiveDateAsDate => Some({
                            let content_token_stream_80e0683c = {
                                ...
                                |generate_function_token_stream(
                                    name_token_stream,
                                    &quote::quote!{#ident_inner_type_token_stream::#content_token_stream_a29ab1c6}
                                );
                                [
                                    generate_function_ident_inner_type_token_stream(
                                        &sqlx_types_chrono_naive_date_max_function_token_stream,
                                        &quote::quote! { MAX }
                                    ),
                                    generate_function_token_stream(
                                        &sqlx_types_chrono_naive_date_max_pred_opt_expect_function_token_stream,
                                        &quote::quote!{Self::#sqlx_types_chrono_naive_date_max_function_token_stream().pred_opt().expect("b7e16bf1-9e73-4a34-98b0-4e6e9e3d45fb")}
                                    )
                                ]
                                .into_iter()
                                .chain(
                                    [
                                        (&sqlx_types_chrono_naive_date_min_function_token_stream, &quote::quote! { -4713, 12, 31 }),
                                        (&sqlx_types_chrono_naive_date_negative_less_typical_function_token_stream, &quote::quote! { -2000, 1, 1 }),
                                        (&sqlx_types_chrono_naive_date_negative_more_typical_function_token_stream, &quote::quote! { -1000, 1, 1 }),
                                        (&sqlx_types_chrono_naive_date_near_zero_function_token_stream, &quote::quote! { 0, 1, 1 }),
                                        (&sqlx_types_chrono_naive_date_positive_less_typical_function_token_stream, &quote::quote! { 1000, 1, 1 }),
                                        (&sqlx_types_chrono_naive_date_positive_more_typical_function_token_stream, &quote::quote! { 2000, 1, 1 }),
                                    ]
                                    .into_iter()
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {
                                Ok(Self({
                                    ...
                                    for element_de177578 in #value_snake_case {
                                        match #type_token_stream::#try_new_snake_case(element_de177578) {
                                            Ok(value_a763a416) => {
                                    ...
                                    let parameters_token_stream = {
                                        ...
                                        match &postgresql_type_impl_try_new_for_deserialize {
                                            PostgresqlTypeImplTryNewForDeserialize::StdStringStringAsText | PostgresqlTypeImplTryNewForDeserialize::SqlxTypesChronoNaiveDateAsDate => {
                                                quote::quote! {value_356f2a0b: #ident_inner_type_token_stream}
                                            }
            ...
            let impl_std_convert_from_ident_origin_for_ident_inner_type_token_stream = {
                let content_token_stream = {
                    ...
                    match &postgresql_type_pattern {
                        ...
                        PostgresqlTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                            let element_dot_zero_token_stream = quote::quote! {element_6910aab7.0};
                            ...
                            let into_iter_dimension1_token_stream = quote::quote! {.into_iter().map(|element_6910aab7|#dimension1_token_stream).collect()};
                            match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {
                    ...
                    PostgresqlTypePattern::ArrayDimension1 { .. } => {
                        ...
                        for element_9f432ae3 in 1..=array_dimensions_number {
                            ...
                            arguments_token_stream.push(quote::quote! {
                                #dimension_number_pagination_token_stream: postgresql_types_common::PaginationStartsWithOne
                            });
                        }
        ...
        let impl_postgresql_type_for_ident_token_stream = {
            ...
            postgresql_crud_macros_common::generate_impl_postgresql_type_token_stream(
                ...
                &{
                    ...
                    let maybe_primary_key_is_primary_key_token_stream = quote::quote! {postgresql_types_common::maybe_primary_key(is_primary_key)};
                    ...
                    match &postgresql_type_pattern {
                        ...
                        PostgresqlTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                            (postgresql_crud_macros_common::NotNullOrNullable::NotNull, postgresql_crud_macros_common::NotNullOrNullable::NotNull) => {
                                let content_token_stream = if postgresql_type_range_try_from_postgresql_type_is_ok {
                                    generate_ident_standart_not_null_into_inner_ident_standart_not_null_read_token_stream(&quote::quote!{element_f5e94f0c})
                                } else {
                                    quote::quote! {element_f5e94f0c.0}
                                };
                                quote::quote! {
                                    #value_dot_zero_dot_zero_token_stream.into_iter().map(|element_f5e94f0c|#content_token_stream).collect()
                                }
                            }
                            (postgresql_crud_macros_common::NotNullOrNullable::NotNull, postgresql_crud_macros_common::NotNullOrNullable::Nullable) => {
                                ...
                                quote::quote! {
                                    #value_dot_zero_dot_zero_token_stream.into_iter().map(|element_236259fc|
                                        element_236259fc.0.map(|value_e9a6bd41| #content_token_stream)
                                    ).collect()
                                }
                            }
                            (postgresql_crud_macros_common::NotNullOrNullable::Nullable, postgresql_crud_macros_common::NotNullOrNullable::NotNull) => {
                                let content_token_stream = if postgresql_type_range_try_from_postgresql_type_is_ok {
                                    generate_ident_standart_not_null_into_inner_ident_standart_not_null_read_token_stream(&quote::quote!{element_b37be63e})
                                } else {
                                    quote::quote! {element_b37be63e.0}
                                };
                                quote::quote! {
                                    #value_dot_zero_dot_zero_token_stream.map(|value_47fb2e43|
                                        value_47fb2e43.0.into_iter().map(|element_b37be63e|#content_token_stream).collect()
                                    )
                                }
                            }
                            (postgresql_crud_macros_common::NotNullOrNullable::Nullable, postgresql_crud_macros_common::NotNullOrNullable::Nullable) => {
                                ...
                                quote::quote! {
                                    #value_dot_zero_dot_zero_token_stream.map(|value_b1a259c4| value_b1a259c4.0.into_iter().map(|element_19a7e6d0|
                                        element_19a7e6d0.0.map(|value_e5c5f65c| #content_token_stream)
                                    ).collect())
                                }
                            }
                        },
        ...
        let impl_postgresql_type_test_cases_for_ident_token_stream = {
            ...
            let generate_standart_not_null_test_case_handle_token_stream = |is_need_to_use_into: &IsNeedToUseInto| {
                ...
                let generate_ident_standart_not_null_function_token_stream = |
                    ident_8b874ea5: &dyn quote::ToTokens,
                    content_token_stream: &dyn quote::ToTokens
                |quote::quote!{#ident_8b874ea5::#content_token_stream()};
                let (
                    ident_sqlx_types_chrono_naive_time_min_token_stream,
                    ident_sqlx_types_chrono_naive_time_ten_token_stream,
                    ident_sqlx_types_chrono_naive_time_twenty_token_stream,
                    ident_sqlx_types_chrono_naive_time_max_token_stream
                ) = {
                    let generate_sqlx_types_chrono_naive_time_as_time_standart_not_null_function_token_stream = |
                        content_token_stream_fd88ca39: &dyn quote::ToTokens
                    |generate_ident_standart_not_null_function_token_stream(
                        &generate_ident_standart_not_null_token_stream(&PostgresqlType::SqlxTypesChronoNaiveTimeAsTime),
                        &content_token_stream_fd88ca39
                    );
                    (
                        generate_sqlx_types_chrono_naive_time_as_time_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_time_min_function_token_stream
                        ),
                        generate_sqlx_types_chrono_naive_time_as_time_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_time_ten_function_token_stream
                        ),
                        generate_sqlx_types_chrono_naive_time_as_time_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_time_twenty_function_token_stream
                        ),
                        generate_sqlx_types_chrono_naive_time_as_time_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_time_max_function_token_stream
                        )
                    )
                };
                let (
                    ident_sqlx_types_chrono_naive_date_min_token_stream,
                    ident_sqlx_types_chrono_naive_date_negative_less_typical_token_stream,
                    ident_sqlx_types_chrono_naive_date_negative_more_typical_token_stream,
                    ident_sqlx_types_chrono_naive_date_near_zero_token_stream,
                    ident_sqlx_types_chrono_naive_date_positive_less_typical_token_stream,
                    ident_sqlx_types_chrono_naive_date_positive_more_typical_token_stream,
                    ident_sqlx_types_chrono_naive_date_max_token_stream,
                    ident_sqlx_types_chrono_naive_date_max_pred_opt_expect_token_stream,
                ) = {
                    let sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream = |
                        content_token_stream_7c66f815: &dyn quote::ToTokens
                    |generate_ident_standart_not_null_function_token_stream(
                        &generate_ident_standart_not_null_token_stream(&PostgresqlType::SqlxTypesChronoNaiveDateAsDate),
                        &content_token_stream_7c66f815
                    );
                    (
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_min_function_token_stream,
                        ),
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_negative_less_typical_function_token_stream,
                        ),
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_negative_more_typical_function_token_stream,
                        ),
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_near_zero_function_token_stream,
                        ),
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_positive_less_typical_function_token_stream,
                        ),
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_positive_more_typical_function_token_stream,
                        ),
                        sqlx_types_chrono_naive_date_as_date_standart_not_null_function_token_stream(
                            &sqlx_types_chrono_naive_date_max_function_token_stream,
                        ),
                ...
                match &postgresql_type {
                    ...
                    PostgresqlType::SqlxTypesChronoNaiveTimeAsTime => {
                        let (
                            ...
                            let generate_self_sqlx_types_chrono_naive_time_standart_not_null_function_token_stream = |content_token_stream_9d2b411e: &dyn quote::ToTokens|generate_ident_standart_not_null_function_token_stream(
                                &self_upper_camel_case,
                                &content_token_stream_9d2b411e
                            );
                            (
                                generate_self_sqlx_types_chrono_naive_time_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_time_min_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_time_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_time_ten_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_time_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_time_twenty_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_time_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_time_max_function_token_stream),
                            )
                        };
                        quote::quote! {vec![
                            #self_sqlx_types_chrono_naive_time_min_token_stream,
                    ...
                    PostgresqlType::SqlxTypesChronoNaiveDateAsDate => {
                        let (
                            ...
                            let generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream = |content_token_stream_16bc2a50: &dyn quote::ToTokens|generate_ident_standart_not_null_function_token_stream(
                                &self_upper_camel_case,
                                &content_token_stream_16bc2a50
                            );
                            (
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_min_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_negative_less_typical_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_negative_more_typical_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_near_zero_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_positive_less_typical_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_positive_more_typical_function_token_stream),
                                generate_self_sqlx_types_chrono_naive_date_standart_not_null_function_token_stream(&sqlx_types_chrono_naive_date_max_function_token_stream)
                            )
                        };
                        quote::quote! {vec![
                            #sqlx_types_chrono_naive_date_min_token_stream,
                ...
                | {
                    let (new_or_try_new_content_token_stream, maybe_acc_push_none_token_stream) = match (&current_not_null_or_nullable, postgresql_type_initialization_try_new_try_from_postgresql_type.is_ok()) {
                        ...
                        (postgresql_crud_macros_common::NotNullOrNullable::Nullable, true) => (
                            ...
                            quote::quote! {acc_0b59a062.push(#self_as_postgresql_type_token_stream::Create::try_new(None).expect("31878971-17fc-4526-ab01-42c8332e641f"));},
                        ),
                        (postgresql_crud_macros_common::NotNullOrNullable::Nullable, false) => (quote::quote! {new(Some(element_0fd5865b.0.into()))}, quote::quote! {acc_0b59a062.push(#self_as_postgresql_type_token_stream::Create::new(None));}),
                    };
                    ...
                    quote::quote! {Some({
                        ...
                        for element_0fd5865b in #ident_as_postgresql_type_test_cases_token_stream::#option_vec_create_snake_case().unwrap_or(Vec::new()) {
                            acc_0b59a062.push(#self_as_postgresql_type_token_stream::Create::#new_or_try_new_content_token_stream);
                        }
            ...
            let read_only_ids_to_two_dimensional_vec_read_inner_token_stream = {
                ...
                match &postgresql_type_pattern {
                    ...
                    PostgresqlTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &dimension1_not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let element_d27d1981_token_stream = generate_star_or_dot_clone_token_stream(&quote::quote!{element_d27d1981});
                                quote::quote! {
                                            ...
                                            for element_d27d1981 in element_cb3f4b45 {
                                                if option_additional.is_none() {
                                                    option_additional = Some((vec![
                                                        vec![#element_d27d1981_token_stream]],
                                                        vec![vec![#element_d27d1981_token_stream, #element_d27d1981_token_stream]
                                                    ]));
                                                }
                                                else {
                                                    break;
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let element_6b831e7c_token_stream = generate_star_or_dot_clone_token_stream(&quote::quote!{element_6b831e7c});
                                quote::quote! {
                                            ...
                                            for element_6b831e7c in element_b04183c6 {
                                                if option_additional.is_none() {
                                                    option_additional = Some((
                                                        vec![vec![#element_6b831e7c_token_stream]],
                                                        vec![vec![#element_6b831e7c_token_stream, #element_6b831e7c_token_stream]]
                                                    ));
                                                }
                                                else {
                                                    break;
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            ...
                            let element_31abc64a_token_stream = generate_star_or_dot_clone_token_stream(&quote::quote!{element_31abc64a});
                            quote::quote! {
                                    ...
                                    for element_12a259ab in &read_only_ids_to_two_dimensional_vec_read_inner {
                                        ...
                                        for element_16a61773 in element_12a259ab {
                                            ...
                                            for element_31abc64a in element_16a61773 {
                                                if option_additional.is_none() {
                                                    option_additional = Some((
                                                        vec![Some(vec![#element_31abc64a_token_stream])],
                                                        vec![Some(vec![#element_31abc64a_token_stream, #element_31abc64a_token_stream])]
                                                    ));
                                                }
                                                else {
                                                    break;
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            match &postgresql_type {
                                ...
                                PostgresqlType::SqlxTypesChronoNaiveDateTimeAsTimestamp => wrap_into_not_empty_unique_vec_token_stream(&generate_greater_than_test_try_new_try_new_vec_token_stream(
                                    ...
                                    &quote::quote!{sqlx::types::chrono::NaiveDateTime::new(
                                        sqlx::types::chrono::NaiveDate::from_ymd_opt(-4713, 12, 31)?,
                                        #sqlx_types_chrono_naive_time_as_time_standart_not_null_token_stream::slightly_more_than_min_inner_type()
                                    )},
                                    &quote::quote!{sqlx::types::chrono::NaiveDateTime::new(
                                        #sqlx_types_chrono_naive_date_as_date_standart_not_null_token_stream::middle_inner_type(),
                                        #sqlx_types_chrono_naive_time_as_time_standart_not_null_token_stream::min_inner_type()
                                    )},
                                    &quote::quote!{sqlx::types::chrono::NaiveDateTime::new(
                                        #sqlx_types_chrono_naive_date_as_date_standart_not_null_token_stream::middle_inner_type(),
                                    ...
                                    &quote::quote!{sqlx::types::chrono::NaiveDateTime::new(
                                        sqlx::types::chrono::NaiveDate::MAX,
                                        #sqlx_types_chrono_naive_time_as_time_standart_not_null_token_stream::max_inner_type()
                                    )},
                                    &quote::quote!{sqlx::types::chrono::NaiveDateTime::new(
                                        sqlx::types::chrono::NaiveDate::MAX,
                                        #sqlx_types_chrono_naive_time_as_time_standart_not_null_token_stream::slightly_less_than_max_inner_type()
                                    )},
                                )),
            ...
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_regular_expression_token_stream = none_token_stream.clone();
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_element_greater_than_token_stream = none_token_stream.clone();
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_element_regular_expression_token_stream = none_token_stream;
