...
pub fn generate_postgresql_type_where_element_filters(_input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_filters_token_stream = |filter: &Filter|{
        ...
        let generate_impl_std_fmt_display_for_ident_try_new_error_named_token_stream = |content_token_stream: &dyn quote::ToTokens|{
            quote::quote!{
                impl<T: error_occurence_lib::ToStdStringString> std::fmt::Display for #ident_try_new_error_named<T> {
        ...
        let generate_ident_try_new_error_named_into_serialize_deserialize_version_token_stream = |content_token_stream: &dyn quote::ToTokens|{
            quote::quote!{
                impl<T> #ident_try_new_error_named<T> {
                    pub fn into_serialize_deserialize_version(self) -> #ident_try_new_error_named_with_serialize_deserialize<T> {
                        match self {
                            #content_token_stream
                        }
                    }
        ...
        let generate_error_occurence_lib_to_std_string_string_for_ident_try_new_error_named_with_serialize_deserialize_token_stream = |content_token_stream: &dyn quote::ToTokens|{
            quote::quote!{
                impl<T: error_occurence_lib::ToStdStringString> error_occurence_lib::ToStdStringString for #ident_try_new_error_named_with_serialize_deserialize<T> {
        ...
        let generate_try_new_for_ident_token_stream = |
        ...
        let (
            ...
            maybe_error_occurence_lib_to_std_string_string_for_ident_try_new_error_named_with_serialize_deserialize_token_stream,
            maybe_generate_try_new_for_ident_token_stream,
            // maybe_,
            // maybe_,
            ...
            Filter::Between => (
                ...
                &generate_ident_try_new_error_named_into_serialize_deserialize_version_token_stream(&quote::quote!{
                    Self::StartMoreOrEqualToEnd {
                        ...
                        code_occurence
                    } => #ident_try_new_error_named_with_serialize_deserialize::StartMoreOrEqualToEnd {
                        start,
                        end,
                        code_occurence
                    },
                ...
                &generate_error_occurence_lib_to_std_string_string_for_ident_try_new_error_named_with_serialize_deserialize_token_stream(&quote::quote!{
                    format!("{self}")
                }),
                &generate_try_new_for_ident_token_stream(
