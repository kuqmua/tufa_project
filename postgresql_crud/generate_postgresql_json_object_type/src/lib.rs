            ...
            let ident_read_only_ids_token_stream = {
                ...
                let ident_read_only_ids_token_stream = {
                    let content_token_stream = match &postgresql_json_object_type_pattern {
                        ...
                        PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {(postgresql_crud::Value<std::vec::Vec<#ident_with_id_read_only_ids_standart_not_null_upper_camel_case>>);},
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                        ...
                        match &postgresql_json_object_type_pattern {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    //     let _ = acc.pop();
                                    //     let _ = acc.pop();
                                    //     format!("jsonb_build_object('value',(select jsonb_agg(jsonb_build_object('id', elem -> 'id')||{acc}) from jsonb_array_elements({{{column_snake_case}}}) as elem)::jsonb) as {{{column_snake_case}}},")
                                    // });
                                    quote::quote!{
                                        // match &value.0 {
                    ...
                    PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            let fields_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                ...
                                let field_type = &element.ty;
                                quote::quote! {
                                    #field_ident: <#field_type as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&#field_ident.expect("expect a3ec7cae-94a0-49c1-b5d1-88f7b2a3dd1d"))
                                }
                            });
                            quote::quote! {
                                #ident_read_only_ids_upper_camel_case (
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            quote::quote! {
                                #ident_read_only_ids_upper_camel_case(postgresql_crud::Value {
                                    value: match &value.0 {
                                        Some(value) => Some(<#ident_array_not_null_upper_camel_case as postgresql_crud::tests::PostgresqlJsonTypeTestCases>::update_to_read_only_ids(&value)),
                                        None => None,
                                    },
                                })
                            }
