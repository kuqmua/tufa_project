use postgresql_crud_macros_common::NotNullOrNullable;//todo remove it?
...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .filter(|element|{
        ...
        let postgresql_json_type_pattern_filter = match &element.postgresql_json_type_pattern {
            ...
            postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                ...
                NotNullOrNullable::NotNull => match &element.not_null_or_nullable {
    ...
    .map(|(element, input_token_stream_stringified)|{
        ...
        let ident = &generate_ident_token_stream(&not_null_or_nullable, &postgresql_json_type_pattern, &IsStandartWithId::False);
        ...
        let ident_token_stream = {
            ...
            let maybe_ident_with_id_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_ident_token_stream(&ident_with_id_standart_not_null_upper_camel_case),
        ...
        let ident_table_type_declaration_token_stream = {
            let generate_ident_without_or_with_id_table_type_declaration_content_token_stream = |is_standart_with_id: &IsStandartWithId|{
                let maybe_id_token_stream = match &is_standart_with_id {
                    ...
                    IsStandartWithId::True => {
                        ...
                        quote::quote!{
                            pub #id_snake_case: #type_as_postgresql_json_type_subtype_table_type_declaration_token_stream,
                        }
                    }
                };
            ...
            let generate_ident_without_or_with_id_table_type_declaration_token_stream = |ident_token_stream: &dyn quote::ToTokens, content_token_stream: &dyn quote::ToTokens|{
                quote::quote! {
                    #[derive(Debug, Clone, PartialEq, Default, serde::Serialize, serde::Deserialize, utoipa::ToSchema, schemars::JsonSchema)]
                    pub struct #ident_token_stream #content_token_stream
                }
            };
            let generate_ident_create_or_ident_with_id_table_type_declaration_standart_not_null_upper_camel_case = |is_standart_with_id: &IsStandartWithId|{
            ...
            //todo maybe not need
            let generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_or_with_id_table_type_declaration_standart_not_null_content_token_stream = |is_standart_with_id: &IsStandartWithId|{
                let maybe_id_token_stream = match &is_standart_with_id {
                    IsStandartWithId::False => proc_macro2::TokenStream::new(),
            ...
            let generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_or_with_id_table_type_declaration_token_stream = |
                is_standart_with_id: &IsStandartWithId,
            ...
            |{
                postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                    generate_ident_create_or_ident_with_id_table_type_declaration_standart_not_null_upper_camel_case(&is_standart_with_id),
            ...
            let generate_impl_create_table_column_query_part_for_ident_table_type_declaration_token_stream = |is_standart_with_id: &IsStandartWithId|{
                postgresql_crud_macros_common::generate_create_table_column_query_part_token_stream(
                    ...
                    &{
                        ...
                        let schema_ident_token_stream: &dyn quote::ToTokens = match &is_standart_with_id {
                            IsStandartWithId::False => &ident_table_type_declaration_upper_camel_case,
                            IsStandartWithId::True => &ident_with_id_table_type_declaration_standart_not_null_upper_camel_case,
                        };
                        quote::quote! {
                            format!(#format_handle_token_stream, serde_json::to_string(&schemars::schema_for!(#schema_ident_token_stream)).unwrap())
                        }
                    }
                )
            };

            let ident_table_type_declaration_token_stream = generate_ident_without_or_with_id_table_type_declaration_token_stream(
                ...
                &{
                    ...
                    let generate_current_ident_prefix = |
                        current_not_null_or_nullable: &postgresql_crud_macros_common::NotNullOrNullable,
                        current_postgresql_json_type_pattern: &postgresql_crud_macros_common::PostgresqlJsonTypePattern,
                        is_standart_with_id: &IsStandartWithId,
                    |{
                    ...
                    match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_ident_without_or_with_id_table_type_declaration_content_token_stream(&IsStandartWithId::False),
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_table_type_declaration_token_stream = generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_or_with_id_table_type_declaration_token_stream(
                &IsStandartWithId::False,
                &{
                    ...
                    match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_or_with_id_table_type_declaration_standart_not_null_content_token_stream(
                                &IsStandartWithId::False
                            ),
            ...
            let maybe_ident_with_id_standart_not_null_table_type_declaration_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                        //todo maybe remove useless derive?
                        let ident_with_id_table_type_declaration_standart_not_null_token_stream = generate_ident_without_or_with_id_table_type_declaration_token_stream(
                            &ident_with_id_table_type_declaration_standart_not_null_upper_camel_case,
                            &generate_ident_without_or_with_id_table_type_declaration_content_token_stream(&IsStandartWithId::True)
                        );
                        let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_with_id_table_type_declaration_standart_not_null_token_stream = generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_or_with_id_table_type_declaration_token_stream(
                            &IsStandartWithId::True,
                            &generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_or_with_id_table_type_declaration_standart_not_null_content_token_stream(
                                &IsStandartWithId::True
                            )
                        );
            ...
            quote::quote! {
                ...
                #maybe_ident_with_id_standart_not_null_table_type_declaration_token_stream
            }
        };
        ...
        let ident_create_token_stream = {
            ...
            let generate_ident_without_or_with_id_create_content_token_stream = |is_standart_with_id: &IsStandartWithId|{
                ...
                let value = vec_syn_field.iter().map(|element| {
                    ...
                    quote::quote! {
                        pub #field_ident: #type_as_postgresql_json_type_subtype_create_token_stream
                    }
                });
                quote::quote!{{
                    #maybe_id_token_stream
            ...
            let generate_ident_without_or_with_id_create_token_stream = |ident_token_stream: &dyn quote::ToTokens, content_token_stream: &dyn quote::ToTokens|{
                quote::quote! {
                    #[derive(Debug, Clone, PartialEq, Default, serde::Serialize, serde::Deserialize, utoipa::ToSchema, schemars::JsonSchema)]
                    pub struct #ident_token_stream #content_token_stream
                }
            };
            let generate_ident_create_or_ident_with_id_create_standart_not_null_upper_camel_case = |is_standart_with_id: &IsStandartWithId|{
                match &is_standart_with_id {
                    IsStandartWithId::False => &ident_create_upper_camel_case,
                    IsStandartWithId::True => &ident_with_id_create_standart_not_null_upper_camel_case,
                }
            };
            let generate_impl_std_fmt_display_for_ident_without_or_with_id_create_standart_not_null_token_stream = |is_standart_with_id: &IsStandartWithId|{
            ...
            let generate_impl_create_table_column_query_part_for_ident_create_token_stream = |is_standart_with_id: &IsStandartWithId|{
                postgresql_crud_macros_common::generate_create_table_column_query_part_token_stream(
                    generate_ident_create_or_ident_with_id_create_standart_not_null_upper_camel_case(&is_standart_with_id),
                    &proc_macro2::TokenStream::new(),
                    &{
            ...
            let ident_create_token_stream = generate_ident_without_or_with_id_create_token_stream(
                ...
                &{
                    ...
                    match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_ident_without_or_with_id_create_content_token_stream(&IsStandartWithId::False),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => wrap_into_scopes_pub_token_stream(
                                &postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&prefix_wrapper(ident_standart_not_null_upper_camel_case))
                            ),
                        },
            ...
            let impl_std_fmt_display_for_ident_create_token_stream = generate_impl_std_fmt_display_for_ident_without_or_with_id_create_standart_not_null_token_stream(
                &IsStandartWithId::False
            );
            ...
            //impl_create_table_column_query_part_for_ident_table_type_declaration_token_stream
            let impl_create_table_column_query_part_for_ident_create_token_stream = generate_impl_create_table_column_query_part_for_ident_create_token_stream(
                &IsStandartWithId::False
            );
                ...
                quote::quote!{
                    impl #ident_token_stream {
                        ...
                        fn #create_query_bind_snake_case(
                            self,
                            mut #query_snake_case: #query_postgres_arguments_token_stream
            ...
            let impl_ident_create_token_stream = generate_create_query_part_and_create_query_bind_token_stream(
                ...
                &{
                    ...
                    //             //     #import_path::PostgresqlJsonTypeTryGeneratePostgresqlJsonObjectTypeToCreateErrorNamed
                    //             // };
            ...
            let maybe_ident_with_id_standart_not_null_create_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                        //todo maybe remove useless derive?
                        let ident_with_id_create_standart_not_null_token_stream = generate_ident_without_or_with_id_create_token_stream(
                        ...
                        let impl_std_fmt_display_for_ident_with_id_create_standart_not_null_token_stream = generate_impl_std_fmt_display_for_ident_without_or_with_id_create_standart_not_null_token_stream(
                            &IsStandartWithId::True
                        );
                        ...
                        let impl_create_table_column_query_part_for_ident_with_id_create_standart_not_null_token_stream = generate_impl_create_table_column_query_part_for_ident_create_token_stream(
                            &IsStandartWithId::True
                        );
                        let impl_ident_with_id_create_standart_not_null_token_stream = generate_create_query_part_and_create_query_bind_token_stream(
                            ...
                            &standart_not_null_create_query_bind_content_token_stream
                        );
                        quote::quote! {
                            ...
                            #impl_create_table_column_query_part_for_ident_with_id_create_standart_not_null_token_stream
            ...
            quote::quote! {
                ...
                #impl_create_table_column_query_part_for_ident_create_token_stream//todo remove from create impl - move it table type declaration
                #impl_ident_create_token_stream
                #maybe_ident_with_id_standart_not_null_create_token_stream
            }
        };
        ...
        let ident_select_token_stream = {
            ...
            let generate_ident_select_element_or_ident_with_id_select_element_upper_camel_case = |is_standart_with_id: &IsStandartWithId| {
                let token_stream: &dyn quote::ToTokens = match &is_standart_with_id {
                    ...
                    IsStandartWithId::True => &naming::parameter::SelfWithIdSelectElementUpperCamelCase::from_tokens(&ident)
                };
                quote::quote!{#token_stream}
            };
            let ident_select_element_or_ident_with_id_select_element_upper_camel_case: &dyn quote::ToTokens = &generate_ident_select_element_or_ident_with_id_select_element_upper_camel_case(&is_standart_with_id);
            let unique_vec_ident_select_element_or_ident_with_id_select_element_token_stream = quote::quote!{
                #import_path::UniqueVec<#ident_select_element_or_ident_with_id_select_element_upper_camel_case>
            };
            //todo add version with id
            let ident_select_token_stream = match postgresql_crud_macros_common::ArrayDimension::try_from(postgresql_json_type_pattern) {
                ...
                Err(_) => match &not_null_or_nullable {
                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {
                        ...
                        pub struct #ident_select_upper_camel_case(pub #unique_vec_ident_select_element_or_ident_with_id_select_element_token_stream);
                    },
                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                        #[derive(
                            Debug,
                        ...
                        pub enum #ident_select_upper_camel_case {
                            WithInnerExplicitSelect(#ident_select_standart_not_null_upper_camel_case),
            ...
            let sqlx_type_token_stream = postgresql_crud_macros_common::generate_sqlx_types_json_type_declaration_token_stream(
                &{
                    let content_token_stream: &dyn quote::ToTokens = match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => &unique_vec_ident_select_element_or_ident_with_id_select_element_token_stream,
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => &ident_select_upper_camel_case,
                        },
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                            dimension1_not_null_or_nullable,
                        } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
            ...
            let impl_sqlx_decode_sqlx_postgres_for_ident_select_token_stream = postgresql_crud_macros_common::generate_impl_sqlx_decode_sqlx_postgres_for_ident_token_stream(
                ...
                &match &postgresql_json_type_pattern {
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {Ok(Self(value.0))},
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote!{Ok(value.0)},
                    },
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        dimension1_not_null_or_nullable,
                    } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => quote::quote!{Ok(value.0)},
                        (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                        (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
                        (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => todo!(),
                    },
                    ...
                    let content_token_stream = match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                ...
                                | {
                                    let ident_select_element_without_id_or_with_id_upper_camel_case_token_stream: &dyn quote::ToTokens = match &postgresql_json_type_pattern {
                                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => &ident_select_element_or_ident_with_id_select_element_upper_camel_case,
                                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                                            dimension1_not_null_or_nullable,
                                        } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                                            (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => &ident_select_element_or_ident_with_id_select_element_upper_camel_case,
                                            (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                                            (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
                                            (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => todo!(),
                                        },
                                    ...
                                    let select_query_part_snake_case = naming::SelectQueryPartSnakeCase;
                                    quote::quote! {
                                        #ident_select_element_without_id_or_with_id_upper_camel_case_token_stream::#variant_name_token_stream(value) => #field_type_as_crud_postgresql_json_type_from_field_token_stream #select_query_part_snake_case(
                                            &value,
                                        ...
                                        generate_acc_push_str_variant_logic_token_stream(
                                            ...
                                            &match &postgresql_json_type_pattern {
                                                ...
                                                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                                                    ...
                                                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => quote::quote! {#value_snake_case_double_quotes_token_stream},
                                                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                                                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
                                                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => todo!(),
                                                },
                                ...
                                let self_field_vec_token_stream = match &postgresql_json_type_pattern {
                                    ...
                                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                                        ...
                                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => quote::quote! {.field_vec},
                                        (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                                        (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
                                        (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => todo!(),
                                    },
                                ...
                                let maybe_pagination_start_end_initialization_token_stream = match &postgresql_json_type_pattern {
                                    ...
                                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                                        ...
                                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => macros_helpers::pagination_start_end_initialization_token_stream::pagination_start_end_initialization_token_stream(&naming::SelectSnakeCase),
                                        (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                                        (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
                                        (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => todo!(),
                                    },
            ...
            let maybe_impl_default_default_for_ident_select_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
            ...
            let maybe_ident_select_element_and_ident_with_id_select_element_token_stream = if let postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart = &postgresql_json_type_pattern {
                if let postgresql_crud_macros_common::NotNullOrNullable::NotNull = &not_null_or_nullable {
                    let generate_ident_select_element_or_ident_with_id_select_element_token_stream = |is_standart_with_id: &IsStandartWithId|{
                            ...
                            &{
                                ...
                                let vec_content_token_stream = {
                                    let elements_token_stream = vec_syn_field.iter().map(|element| {
                                        ...
                                        quote::quote! {
                                            #current_ident_select_element_or_ident_with_id_select_element_upper_camel_case::#field_ident_upper_camel_case_token_stream(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)
                                        }
                                    });
                        ...
                        quote::quote! {
                            #ident_select_element_or_ident_with_id_select_element_token_stream
                            #impl_error_occurence_lib_to_std_string_string_for_ident_select_element_or_ident_with_id_select_element_token_stream
        ...
        let ident_where_element_token_stream = {
            let maybe_content_token_stream = {
                use postgresql_crud_macros_common::NotNullOrNullable;
                let ident_where_element_token_stream = match &postgresql_json_type_pattern {
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                        ...
                        NotNullOrNullable::Nullable => quote::quote!{"todo must not reach this code. maybe refactor later"},
                    },
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        dimension1_not_null_or_nullable,
                    } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
            ...
            match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                    NotNullOrNullable::NotNull => maybe_content_token_stream,
                    NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
                },
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                },
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension2 {
                    dimension1_not_null_or_nullable,
                    dimension2_not_null_or_nullable,
                ...
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension3 {
                    ...
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                },
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension4 {
                    dimension1_not_null_or_nullable,
                    dimension2_not_null_or_nullable,
                    ...
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => maybe_content_token_stream,
                    (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => maybe_content_token_stream,
                }
            }
        };
        ...
        let ident_read_token_stream = {
            ...
            let impl_serde_deserialize_for_ident_without_id_or_with_id_read_token_stream = {
                ...
                let generate_index = |index: std::primitive::usize| {
                    match &is_standart_with_id {
                        IsStandartWithId::False => index,
                        IsStandartWithId::True => index.checked_add(1).unwrap_or_else(|| panic!("vec_syn_field_len + 1 is None(int overflow)"))
                    }
                };
                let visit_str_value_enum_variants_token_stream = {
                    ...
                    let maybe_id_field_ident_double_quotes_serde_private_ok_field_token_stream = match &is_standart_with_id {
                        IsStandartWithId::False => proc_macro2::TokenStream::new(),
                        IsStandartWithId::True => {
                ...
                let visit_bytes_value_enum_variants_token_stream = {
                    ...
                    let maybe_b_field_ident_double_quotes_token_stream = match &is_standart_with_id {
                        IsStandartWithId::False => proc_macro2::TokenStream::new(),
                        IsStandartWithId::True => {
                ...
                let visit_map_missing_fields_check_token_stream = {
                    ...
                    let maybe_id_missing_field_token_stream = match &is_standart_with_id {
                        IsStandartWithId::False => proc_macro2::TokenStream::new(),
                        IsStandartWithId::True => generate_missing_field_token_stream(0, &id_snake_case_double_quotes_token_stream)
                    };
                    quote::quote! {
                ...
                let fields_array_elements_token_stream = {
                    ...
                    let maybe_id_double_quotes_comma_token_stream = match &is_standart_with_id {
                        IsStandartWithId::False => proc_macro2::TokenStream::new(),
                        IsStandartWithId::True => quote::quote! {#id_snake_case_double_quotes_token_stream,}
                    };
                    quote::quote! {
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_without_id_or_with_id_read_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                ...
                &{
                    ...
                    let content_token_stream = &match &is_standart_with_id {
                        IsStandartWithId::False => {
                            let fields_token_stream = vec_syn_field.iter().map(|element| {
        ...
        let ident_with_id_update_upper_camel_case = naming::parameter::SelfUpdateUpperCamelCase::from_tokens(&ident_with_id_standart_not_null_upper_camel_case);
        let ident_update_token_stream = {
            let generate_ident_update_element_or_ident_with_id_update_element_upper_camel_case = |is_standart_with_id: &IsStandartWithId| {
                let token_stream: &dyn quote::ToTokens = match &is_standart_with_id {
                    IsStandartWithId::False => &naming::parameter::SelfUpdateElementUpperCamelCase::from_tokens(&ident),
                    IsStandartWithId::True => &naming::parameter::SelfWithIdUpdateElementUpperCamelCase::from_tokens(&ident)
                };
                quote::quote!{#token_stream}
            };
            ...
            let std_vec_vec_object_with_id_or_std_option_option_std_vec_vec_object_with_id_ident_token_stream = {
                                    ...
                                    __D: serde::Deserializer<'de>,
                                {
                                    ...
                                    impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                                            ...
                                            __A: serde::de::SeqAccess<'de>,
                                        {
                                            ...
                                            let __field1 = match serde::de::SeqAccess::next_element::<std::vec::Vec<#ident_with_id_update_element_upper_camel_case>>(&mut __seq)? {
                                                serde::__private::Some(__value) => __value,
                                                serde::__private::None => {
                                                    vec![]
                                                }
                                            ...
                                            __A: serde::de::MapAccess<'de>,
                                        {
                                            ...
                                            let mut __field1: serde::__private::Option<std::vec::Vec<#ident_with_id_update_element_upper_camel_case>> = serde::__private::None;
                                            ...
                                            while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                                                match __key {
                                                    ...
                                                    __Field::__field1 => {
                                                        ...
                                                        __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<#ident_with_id_update_element_upper_camel_case>>(&mut __map)?);
                                                    }
                                                    __Field::__field2 => {
                    ...
                    let impl_ident_json_array_change_methods_token_stream = {
                        let update_query_part_token_stream = {
                            let query_part_variants_token_stream = vec_syn_field.iter().map(|element| {
                                ...
                                let field_type_as_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_crud_postgresql_json_type_from_field_token_stream(element);
                                quote::quote! {
                                    #ident_update_element_or_ident_with_id_update_element_upper_camel_case::#variant_ident_upper_camel_case_token_stream(value) => {
                        ...
                        quote::quote! {
                            impl #struct_ident_token_stream {
                                ...
                                ) -> Result<std::string::String, #import_path::QueryPartErrorNamed> {//todo reuse #import_path::QueryPartErrorNamed naming
                                    #update_query_part_token_stream
                                }
                                fn #update_query_bind_snake_case(self, mut #query_snake_case: #query_postgres_arguments_token_stream) -> #query_postgres_arguments_token_stream {
                ...
                match &postgresql_json_type_pattern {
                    ...
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        ...
                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => generate_ident_json_array_change_token_stream(
                        ...
                        (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                        (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => generate_ident_json_array_change_token_stream(
            ...
            let std_option_option_ident_update_standart_not_null_token_stream = {
            ...
            let ident_update_token_stream = {
                let self_type_content_token_stream = match &postgresql_json_type_pattern {
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {pub #import_path::UniqueVec<#ident_update_element_or_ident_with_id_update_element_upper_camel_case>},
                ...
                postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_update_upper_camel_case, &proc_macro2::TokenStream::new(), &{
                    let value = match &postgresql_json_type_pattern {
                        ...
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                            ...
                            (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => quote::quote! {(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)},
                            (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                            (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => quote::quote! {(Some(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream))},
                            (NotNullOrNullable::Nullable, NotNullOrNullable::Nullable) => todo!(),
                        },
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension2 {
                            dimension1_not_null_or_nullable: _,
                ...
                let update_query_bind_token_stream = {
                    let content_token_stream = match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            ...
                            //             },
                            //             None => {
                            //                 #query_snake_case = #query_snake_case.bind(sqlx::types::Json(None::<#std_option_option_ident_update_standart_not_null_token_stream>));
                            //             }
                            //         }
                            //         #query_snake_case
                            //     }
                        ...
                        // match &not_null_or_nullable {
                        //     postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {
                        //         #query_snake_case = self.0.#update_query_bind_snake_case(#query_snake_case);
                        //         #query_snake_case
                        //     },
                        //     postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                        //         match self.0 {
            ...
            let maybe_ident_update_element_and_ident_with_id_update_element_token_stream = if let postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart = &postgresql_json_type_pattern {
                if let postgresql_crud_macros_common::NotNullOrNullable::NotNull = &not_null_or_nullable {
                    let generate_ident_update_element_or_ident_with_id_update_element_token_stream = |is_standart_with_id: &IsStandartWithId|{
                        ...
                        quote::quote! {
                            #ident_update_element_or_ident_with_id_update_element_token_stream
        ...
        let maybe_impl_postgresql_crud_postgresql_json_type_for_ident_with_id_token_stream = match &postgresql_json_type_pattern {
            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => postgresql_crud_macros_common::generate_postgresql_json_type_token_stream(
                    ...
                    &ident_with_id_table_type_declaration_standart_not_null_upper_camel_case,//&ident_table_type_declaration_upper_camel_case,
                    &ident_with_id_create_standart_not_null_upper_camel_case,
                    &create_query_part_token_stream,
                    &postgresql_crud_macros_common::IsCreateQueryBindMutable::False,
                    &create_query_bind_token_stream,
        ...
        //     postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
        //         postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
        //             let ident_with_id_token_stream = {
        //                 quote::quote!{
        //                     #[derive(Debug)]
        //                     pub struct #ident_with_id_standart_not_null_upper_camel_case;
        //                 }
        //             };
        //             let ident_with_id_table_type_declaration_token_stream = {
        //                 let ident_with_id_table_type_declaration_standart_not_null_upper_camel_case = naming::parameter::SelfTableTypeDeclarationUpperCamelCase::from_tokens(&ident_with_id_standart_not_null_upper_camel_case);
        //                 let ident_with_id_table_type_declaration_token_stream = {
        //                     quote::quote!{
        ...
        //                 };
        //                 let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_wiht_id_table_type_declaration_token_stream = {
        //                     quote::quote!{

        //                     }
        //                 };
        //                 let impl_create_table_column_query_part_for_ident_with_id_table_type_declaration_token_stream = postgresql_crud_macros_common::generate_create_table_column_query_part_token_stream(
        //                     &ident_with_id_table_type_declaration_standart_not_null_upper_camel_case,
        //                     &proc_macro2::TokenStream::new(),
        //                     &{
        //                         let jsonb = "jsonb";
        ...
        //                         let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&format!("{{column}} {type_stringified} check (jsonb_matches_schema('{{}}', {{column}}))"));
        //                         quote::quote! {
        //                             format!(#format_handle_token_stream, serde_json::to_string(&schemars::schema_for!(#ident_with_id_table_type_declaration_standart_not_null_upper_camel_case)).unwrap())
        //                         }
        //                     }
        //                 );
        //                 quote::quote!{
        //                     #ident_with_id_table_type_declaration_token_stream
        //                     #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_wiht_id_table_type_declaration_token_stream//todo why need this? 
        //                     #impl_create_table_column_query_part_for_ident_with_id_table_type_declaration_token_stream
        //                 }
        //             };
        //             let ident_with_id_create_token_stream = {
        //                 let ident_with_id_create_standart_not_null_upper_camel_case = naming::parameter::SelfCreateUpperCamelCase::from_tokens(&ident_with_id_standart_not_null_upper_camel_case);
        //                 let ident_with_id_create_token_stream = {
        //                     let content_token_stream = {
        //                         let id_token_stream = {
        //                             let type_as_postgresql_json_type_subtype_create_token_stream = generate_type_as_postgresql_json_type_subtype_token_stream(
        //                                 &quote::quote!{postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString},
        //                                 &PostgresqlJsonTypeSubtype::Create
        //                             );
        //                             quote::quote!{
        //                                 pub #id_snake_case: #type_as_postgresql_json_type_subtype_create_token_stream,
        ...
        //                     quote::quote! {
        //                         #[derive(Debug, Clone, PartialEq, Default, serde::Serialize, serde::Deserialize, utoipa::ToSchema, schemars::JsonSchema)]
        //                         pub struct #ident_with_id_create_standart_not_null_upper_camel_case #content_token_stream
        //                     }
        //                 };
        //                 let impl_std_fmt_display_for_ident_with_id_create_token_stream = macros_helpers::generate_impl_std_fmt_display_token_stream(
        //                     &proc_macro2::TokenStream::new(),
        //                     &ident_with_id_create_standart_not_null_upper_camel_case,
        //                     &proc_macro2::TokenStream::new(),
        //                     &quote::quote! {write!(formatter, "{:?}", self)}
        //                 );
        //                 let impl_error_occurence_lib_to_std_string_string_for_ident_with_id_create_token_stream = macros_helpers::generate_impl_error_occurence_lib_to_std_string_string_token_stream(
        //                     &proc_macro2::TokenStream::new(),
        //                     &ident_with_id_create_standart_not_null_upper_camel_case,
        //                     &proc_macro2::TokenStream::new(),
        //                     &quote::quote! {format!("{self}")}
        //                 );
        //                 let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_with_id_create_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
        //                     &ident_with_id_create_standart_not_null_upper_camel_case,
        //                     &proc_macro2::TokenStream::new(),
        //                     &{
        //                         let content_token_stream = {
        ...
        //                     }
        //                 );
        //                 let impl_ident_with_id_create_token_stream = {
        //                     let create_query_part_content_token_stream = {
        //                         let ok_value_token_stream = quote::quote! {format!("jsonb_build_object('id', to_jsonb(gen_random_uuid()))||{increments}")};
        //                         let create_query_part_fields_token_stream = vec_syn_field.iter().map(|element| {
        //                             let element_field_ident = element.ident.as_ref().unwrap_or_else(|| {
        //                                 panic!("{}", naming::FIELD_IDENT_IS_NONE);
        //                             });
        ...
        //                         }
        //                     };
        //                     let create_query_bind_content_token_stream = {
        //                         let id_token_stream = {
        //                             let field_type_as_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_crud_postgresql_json_type_from_to_tokens_token_stream(
        //                                 &quote::quote!{postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString}
        //                             );
        //                             quote::quote! {
        //                                 #query_snake_case = #field_type_as_crud_postgresql_json_type_from_field_token_stream #create_query_bind_snake_case(self.#id_snake_case, #query_snake_case);
        //                             }
        //                         };
        //                         let fields_token_stream = vec_syn_field.iter().map(|element| {
        //                             let element_field_ident = element.ident.as_ref().unwrap_or_else(|| {
        ...
        //                     };
        //                     quote::quote!{
        //                         impl #ident_with_id_create_standart_not_null_upper_camel_case {
        //                             fn #create_query_part_snake_case(
        //                                 &self,
        //                                 #increment_snake_case: #reference_mut_std_primitive_u64_token_stream
        //                             ) -> Result<#std_string_string_token_stream, #import_path::QueryPartErrorNamed> {
        ...
        //                 };
        //                 quote::quote!{
        //                     #ident_with_id_create_token_stream
        //                     #impl_std_fmt_display_for_ident_with_id_create_token_stream
        //                     #impl_error_occurence_lib_to_std_string_string_for_ident_with_id_create_token_stream
        //                     #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_with_id_create_token_stream
        //                     #impl_ident_with_id_create_token_stream
        //                 }
        //             };
        //             let ident_with_id_select_token_stream = {
        //                 let ident_with_id_select_standart_not_null_upper_camel_case = naming::parameter::SelfSelectUpperCamelCase::from_tokens(&ident_with_id_standart_not_null_upper_camel_case);
        ...
        //                 let ident_with_id_select_token_stream = {
        //                     let unique_vec_ident_with_id_select_element_token_stream = quote::quote!{
        ...
        //                             schemars::JsonSchema,
        //                         )]
        //                         pub struct #ident_with_id_select_standart_not_null_upper_camel_case(pub #unique_vec_ident_with_id_select_element_token_stream);
        //                     }
        //                 };
        ...
        //                     }
        //                 );
        //                 let impl_ident_with_id_select_token_stream = {
        //                     let select_query_part_token_stream = {
        //                         let content_token_stream = {
        //                             let column_name_and_maybe_field_getter_for_error_message_field_ident_snake_case = naming::ColumnNameAndMaybeFieldGetterForErrorMessageFieldIdentSnakeCase;
        //                             let generate_acc_push_str_variant_logic_token_stream = |
        ...
        //                                 let select_query_part_snake_case = naming::SelectQueryPartSnakeCase;
        //                                 quote::quote! {
        //                                     #ident_with_id_select_element_standart_not_null_upper_camel_case::#variant_name_token_stream(value) => #field_type_as_crud_postgresql_json_type_from_field_token_stream #select_query_part_snake_case(
        //                                         &value,
        //                                         #field_ident_double_quotes_token_stream,
        //                                         #column_name_and_maybe_field_getter_token_stream,
        //                                         &#column_name_and_maybe_field_getter_for_error_message_field_ident_snake_case,
        ...
        //                     }
        //                 };
        //                 let ident_select_element_and_ident_with_id_select_element_token_stream = {
        //                     let ident_with_id_select_element_token_stream = {
        //                         let maybe_id_token_stream = quote::quote! {
        //                             #[serde(rename(serialize = #id_snake_case_double_quotes_token_stream, deserialize = #id_snake_case_double_quotes_token_stream))]
        //                              Id(#postgresql_crud_path_postgresql_json_type_uuid_uuid_select_token_stream),
        //                         };
        //                         let variants_token_stream = vec_syn_field.iter().map(|element| {
        ...
        //                                 IsStandartWithId::False => &proc_macro2::TokenStream::new(),
        //                                 IsStandartWithId::True => &quote::quote! {
        //                                     #ident_with_id_select_element_standart_not_null_upper_camel_case::Id(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream),
        //                                 }
        //                             };
        //                             let vec_content_token_stream = {
        //                                 let elements_token_stream = vec_syn_field.iter().map(|element| {
        ...
        //                                     let field_ident_upper_camel_case_token_stream = naming::ToTokensToUpperCamelCaseTokenStream::case_or_panic(&field_ident);
        //                                     quote::quote! {
        //                                         #ident_with_id_select_element_standart_not_null_upper_camel_case::#field_ident_upper_camel_case_token_stream(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)
        //                                     }
        //                                 });
        //                                 quote::quote! {#(#elements_token_stream),*}
        //                             };
        ...
        //                         #impl_error_occurence_lib_to_std_string_string_for_ident_with_id_select_element_token_stream
        //                         #impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_with_id_select_element_token_stream
        //                     }
        //                 };
        //                 quote::quote!{
        ...
        //                     #ident_select_element_and_ident_with_id_select_element_token_stream
        //                 }
        //             };
        ...
        //                     quote::quote! {
        //                         #[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
        //                         pub enum #ident_with_id_where_element_standart_not_null_upper_camel_case {
        //                              #(#variants_token_stream),*
        //                         }
        //                     }
        //                 };
        ...
        //                     #impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_with_id_where_element_token_stream
        //                     #impl_error_occurence_lib_to_std_string_string_for_ident_with_id_where_element_token_stream
        ...
        //                     False
        //                 }
        //                 let generate_ident_with_id_read_fields_declaration_token_stream = |
        //                     should_add_serde_option_is_none_annotation: &ShouldAddSerdeOptionIsNoneAnnotation
        //                 | {
        //                     let maybe_serde_skip_serializing_if_option_is_none_token_stream = match &should_add_serde_option_is_none_annotation {
        //                         ShouldAddSerdeOptionIsNoneAnnotation::True => quote::quote! {#[serde(skip_serializing_if = "Option::is_none")]},
        ...
        //                 };
        //                 let ident_with_id_read_token_stream = {
        //                     let content_token_stream = generate_ident_with_id_read_fields_declaration_token_stream(
        //                         &ShouldAddSerdeOptionIsNoneAnnotation::True
        //                     );
        //                     quote::quote! {
        //                         #[derive(Debug, Clone, PartialEq, Default, serde::Serialize, utoipa::ToSchema, schemars::JsonSchema)]
        ...
        //                     let ident_with_id_read_fields_declaration_token_stream = generate_ident_with_id_read_fields_declaration_token_stream(
        //                         &ShouldAddSerdeOptionIsNoneAnnotation::False
        //                     );
        ...
        //                                 WithReference::False => proc_macro2::TokenStream::new()
        //                             };
        //                             let id_token_stream = quote::quote! {#maybe_reference_symbol_token_stream #id_snake_case,};
        //                             let fields_token_stream = vec_syn_field.iter().map(|element| {
        //                                 let field_ident = element.ident.as_ref().unwrap_or_else(|| {
        //                                     panic!("{}", naming::FIELD_IDENT_IS_NONE);
        //                                 });
        ...
        //                     let visit_str_value_enum_variants_token_stream = {
        //                         let visit_str_value_enum_variants_token_stream = vec_syn_field.iter().enumerate().map(|(index, element)| {
        //                             let index = index.checked_add(1).unwrap_or_else(|| panic!("vec_syn_field_len + 1 is None(int overflow)"));
        //                             let field_name_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(&element.ident.as_ref().unwrap_or_else(|| {
        //                                 panic!("{}", naming::FIELD_IDENT_IS_NONE);
        //                             }));
        //                             generate_field_ident_double_quotes_serde_private_ok_field_token_stream(&field_name_double_quotes_token_stream, index)
        //                         });
        //                         let id_field_ident_double_quotes_serde_private_ok_field_token_stream = {
        //                             let value_token_stream = generate_field_ident_double_quotes_serde_private_ok_field_token_stream(&id_snake_case_double_quotes_token_stream, 0);
        //                             quote::quote! {#value_token_stream,}
        //                         };
        //                         quote::quote! {
        ...
        //                             generate_field_ident_double_quotes_serde_private_ok_field_token_stream(&b_field_name_double_quotes_token_stream, index)
        //                         });
        //                         let maybe_b_field_ident_double_quotes_token_stream = {
        //                             let value_token_stream = generate_field_ident_double_quotes_serde_private_ok_field_token_stream(
        //                                 &{
        //                                     let value = format!("b{id_snake_case_double_quotes_token_stream}");
        //                                     value.parse::<proc_macro2::TokenStream>().unwrap_or_else(|_| panic!("{value} {}", constants::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
        ...
        //                         }
        //                     };
        //                     let ident_with_id_read_standart_not_null_upper_camel_case_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(&ident_with_id_read_standart_not_null_upper_camel_case);
        //                     quote::quote! {
        //                         impl<'de> serde::Deserialize<'de> for #ident_with_id_read_standart_not_null_upper_camel_case {
        //                             fn deserialize<__D>(
        //                                 __deserializer: __D,
        //                             ) -> serde::__private::Result<Self, __D::Error>
        //                             where
        ...
        //                                 }
        //                                 impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
        //                                     type Value = #ident_with_id_read_standart_not_null_upper_camel_case;
        //                                     fn expecting(
        //                                         &self,
        //                                         __formatter: &mut serde::__private::Formatter<'_>,
        //                                     ) -> serde::__private::fmt::Result {
        ...
        //                                 serde::Deserializer::deserialize_struct(
        //                                     __deserializer,
        //                                     #ident_with_id_read_standart_not_null_upper_camel_case_double_quotes_token_stream,
        //                                     FIELDS,
        //                                     __Visitor {
        //                                         marker: serde::__private::PhantomData::<
        //                                             #ident_with_id_read_standart_not_null_upper_camel_case,
        ...
        //                     }
        //                 };
        //                 // let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_with_id_read_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
        //                 //     &ident_with_id_read_standart_not_null_upper_camel_case,
        //                 //     &proc_macro2::TokenStream::new(),
        //                 //     &{
        //                 //         let generate_field_ident_some_value_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream = |field_ident: &syn::Ident| {
        ...
        //                 //     // let std_option_option_sqlx_types_json_ident_with_id_read_token_stream = postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&sqlx_types_json_ident_with_id_read_token_stream);
        //                 //     let impl_sqlx_type_sqlx_postgres_for_ident_with_id_read_token_stream = postgresql_crud_macros_common::generate_impl_sqlx_type_sqlx_postgres_for_ident_token_stream(
        //                 //         &ident_with_id_read_standart_not_null_upper_camel_case,
        //                 //         //todo
        //                 //         &sqlx_types_json_ident_with_id_read_token_stream
        //                 //         // &match &postgresql_type {
        //                 //         //     PostgresqlType::JsonbNotNull => &sqlx_types_json_ident_with_id_read_token_stream,
        //                 //         //     PostgresqlType::JsonbNullable => &std_option_option_sqlx_types_json_ident_with_id_read_token_stream,
        //                 //         // },
        //                 //     );
        //                 //     let impl_sqlx_decode_sqlx_postgres_for_ident_with_id_read_token_stream = {
        //                 //         postgresql_crud_macros_common::generate_impl_sqlx_decode_sqlx_postgres_for_ident_token_stream(
        //                 //             &ident_with_id_read_standart_not_null_upper_camel_case,
        //                 //             //todo
        //                 //              &sqlx_types_json_ident_with_id_read_token_stream,
        ...
        //                 }
        //             };
        //             let impl_postgresql_crud_postgresql_json_type_for_ident_with_id_token_stream = {
        //                 quote::quote!{

        //                 }
        //             };
        //             quote::quote! {
        //                 #ident_with_id_token_stream
        //                 #ident_with_id_table_type_declaration_token_stream
        //                 #ident_with_id_create_token_stream
        //                 #ident_with_id_select_token_stream
        //                 #ident_with_id_where_element_token_stream
        ...
        //                 #impl_postgresql_crud_postgresql_json_type_for_ident_with_id_token_stream
        //             }
        //         },
        //         postgresql_crud_macros_common::NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
        //     },
