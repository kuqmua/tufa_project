...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .map(|(element, input_token_stream_stringified)|{
        ...
        let generate_type_as_crud_postgresql_json_type_token_stream = |
        ...
        let fields_declaration_3e60c916_a7e9_44af_a69d_0db54fa0c2f0_token_stream = {
            let value = vec_syn_field.iter().map(|element| {
                ...
                let field_type_as_json_type_create_token_stream = generate_type_as_crud_postgresql_json_type_token_stream(
                    &element.ty,
                    &PostgresqlJsonTypeSubtype::Create
                );
                quote::quote! {
                    pub #field_ident: #field_type_as_json_type_create_token_stream
                }
            });
            quote::quote!{{#(#value),*}}
        };
        ...
        let generate_current_ident_origin_non_wrapping = |current_not_null_or_nullable: &postgresql_crud_macros_common::NotNullOrNullable, current_postgresql_json_type_pattern: &postgresql_crud_macros_common::PostgresqlJsonTypePattern|{
        ...
        let field_type_handle: &dyn quote::ToTokens = {
            ...
            match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                    ...
                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => &postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&ident_standart_not_null_upper_camel_case),
                },
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => {
        ...
        let field_type_handle_struct_scopes = {
            let braces_pub_field_type_handle = quote::quote! {(pub #field_type_handle);};
            if let postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart = &postgresql_json_type_pattern {
                if let postgresql_crud_macros_common::NotNullOrNullable::NotNull = &not_null_or_nullable {
                    quote::quote! {{#field_type_handle}}
                }
                else {
                    braces_pub_field_type_handle
                }
            }
            else {
                braces_pub_field_type_handle
                ...
                let (ident_select_token_stream, ident_with_id_select_token_stream) = {
                    let generate_template_select_struct_token_stream = |tokens_select_token_stream: &dyn quote::ToTokens, additional_content_token_stream: &dyn quote::ToTokens| {
                        let variants_token_stream = vec_syn_field.iter().map(|element| {
                            ...
                            let field_type_as_json_type_select_token_stream = generate_type_as_crud_postgresql_json_type_token_stream(
                                &element.ty,
                                &PostgresqlJsonTypeSubtype::Select
                            );
                            quote::quote! {
            ...
            let update_token_stream = {
                let ident_update_element_token_stream = {
                    let variants_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        let field_type_as_json_type_update_token_stream = generate_type_as_crud_postgresql_json_type_token_stream(
                            &element.ty,
                            &PostgresqlJsonTypeSubtype::Update
                        );
                        quote::quote! {
        ...
        let tokens_select_upper_camel_case = naming::parameter::SelfSelectUpperCamelCase::from_tokens(&ident);
        let tokens_without_id_read_upper_camel_case = naming::parameter::SelfWithoutIdReadUpperCamelCase::from_tokens(&ident);
        let tokens_with_id_read_upper_camel_case = naming::parameter::SelfWithIdReadUpperCamelCase::from_tokens(&ident);
        let tokens_without_id_read_try_from_error_named_upper_camel_case = naming::parameter::SelfWithoutIdReadTryFromErrorNamedUpperCamelCase::from_tokens(&ident);
        // let tokens_with_id_read_try_from_error_named_upper_camel_case = naming::parameter::SelfWithIdReadTryFromErrorNamedUpperCamelCase::from_tokens(&ident);

        let tokens_where_element_upper_camel_case = naming::parameter::SelfWhereElementUpperCamelCase::from_tokens(&ident);
        ...
        let common_create_query_part_token_stream = match &postgresql_json_type_pattern {
            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
        ...
        let common_create_query_bind_token_stream = match &postgresql_json_type_pattern {
            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
        ...
        let generate_common_select_query_part_token_stream = |postgresql_type_or_json_type: &postgresql_crud_macros_common::PostgresqlTypeOrJsonType|{
        ...
        enum PostgresqlTypeOrJsonTypeHandle {
            PostgresqlType,
            PostgresqlJsonType,
        }
        let generate_common_read_token_stream = |
            postgresql_json_object_type: &PostgresqlJsonObjectType,
            postgresql_type_or_json_type_handle: &PostgresqlTypeOrJsonTypeHandle
        |{
            let tokens_without_id_or_with_id_read_upper_camel_case: &dyn naming::StdFmtDisplayPlusQuoteToTokens = match (&postgresql_json_object_type, &postgresql_type_or_json_type_handle) {
                (PostgresqlJsonObjectType::WithoutId, PostgresqlTypeOrJsonTypeHandle::PostgresqlType) => &naming::parameter::SelfWithoutIdReadUpperCamelCase::from_tokens(
                    &naming::parameter::SelfPostgresqlTypeUpperCamelCase::from_tokens(&ident)
                ),
                (PostgresqlJsonObjectType::WithoutId, PostgresqlTypeOrJsonTypeHandle::PostgresqlJsonType) => &tokens_without_id_read_upper_camel_case,
                (PostgresqlJsonObjectType::WithId, PostgresqlTypeOrJsonTypeHandle::PostgresqlType) => &naming::parameter::SelfWithIdReadUpperCamelCase::from_tokens(
                    &naming::parameter::SelfPostgresqlTypeUpperCamelCase::from_tokens(&ident)
                ),
                (PostgresqlJsonObjectType::WithId, PostgresqlTypeOrJsonTypeHandle::PostgresqlJsonType) => &tokens_with_id_read_upper_camel_case
            };
            let tokens_without_id_or_with_id_read_try_from_error_named_upper_camel_case: &dyn naming::StdFmtDisplayPlusQuoteToTokens = match &(&postgresql_json_object_type, &postgresql_type_or_json_type_handle) {
                (PostgresqlJsonObjectType::WithoutId, PostgresqlTypeOrJsonTypeHandle::PostgresqlType) => &naming::parameter::SelfWithoutIdReadTryFromErrorNamedUpperCamelCase::from_tokens(
                    &naming::parameter::SelfPostgresqlTypeUpperCamelCase::from_tokens(&ident)
                ),
                (PostgresqlJsonObjectType::WithoutId, PostgresqlTypeOrJsonTypeHandle::PostgresqlJsonType) => &tokens_without_id_read_try_from_error_named_upper_camel_case,
                (PostgresqlJsonObjectType::WithId, PostgresqlTypeOrJsonTypeHandle::PostgresqlType) => &naming::parameter::SelfWithIdReadTryFromErrorNamedUpperCamelCase::from_tokens(
                    &naming::parameter::SelfPostgresqlTypeUpperCamelCase::from_tokens(&ident)
                ),
                (PostgresqlJsonObjectType::WithId, PostgresqlTypeOrJsonTypeHandle::PostgresqlJsonType) => &tokens_without_id_read_try_from_error_named_upper_camel_case,
            };
            enum ShouldAddSerdeOptionIsNoneAnnotation {
                True,
                False
            }
            let generate_tokens_without_id_or_with_id_read_fields_declaration_token_stream = |
                postgresql_json_object_type: &PostgresqlJsonObjectType,
            ...
            | {
                ...
                let fields_token_stream = vec_syn_field.iter().map(|element| {
                    ...
                    let field_type_as_json_type_read_token_stream = generate_type_as_crud_postgresql_json_type_token_stream(
                        &element.ty,
                        &PostgresqlJsonTypeSubtype::Read
                    );
                    quote::quote! {
            ...
            let tokens_without_id_or_with_id_read_token_stream = {
                let content_token_stream = generate_tokens_without_id_or_with_id_read_fields_declaration_token_stream(
                ...
                quote::quote! {
                    ...
                    pub struct #tokens_without_id_or_with_id_read_upper_camel_case {
                        #content_token_stream
                    }
                }
            };
            let all_fields_are_none_upper_camel_case = naming::AllFieldsAreNoneUpperCamelCase;
            let tokens_without_id_or_with_id_read_try_from_error_named_token_stream = quote::quote! {
                #[derive(Debug, serde::Serialize, serde::Deserialize, thiserror::Error, error_occurence_lib::ErrorOccurence)]
                pub enum #tokens_without_id_or_with_id_read_try_from_error_named_upper_camel_case {
                    #all_fields_are_none_upper_camel_case {
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                    },
                }
            };
            let impl_try_new_for_tokens_without_id_or_with_id_read_try_from_error_named_token_stream = {
                let tokens_without_id_or_with_id_read_fields_declaration_token_stream = generate_tokens_without_id_or_with_id_read_fields_declaration_token_stream(
                    &postgresql_json_object_type,
                    &ShouldAddSerdeOptionIsNoneAnnotation::False
                );
                let (tokens_without_id_or_with_id_read_fields_reference_token_stream, tokens_without_id_or_with_id_read_fields_token_stream) = {
                    enum WithReference {
                        True,
                        False
                    }
                    let generate_tokens_without_id_or_with_id_read_fields_token_stream = |with_reference: &WithReference| {
                    ...
                    (
                        generate_tokens_without_id_or_with_id_read_fields_token_stream(&WithReference::True),
                        generate_tokens_without_id_or_with_id_read_fields_token_stream(&WithReference::False)
                    )
                };
                let tokens_without_id_or_with_id_read_check_if_all_fields_are_none_token_stream = {
                    ...
                    quote::quote! {
                        if let (#(#nones_token_stream),*) = (#tokens_without_id_or_with_id_read_fields_reference_token_stream) {
                            return Err(#tokens_without_id_or_with_id_read_try_from_error_named_upper_camel_case::#all_fields_are_none_upper_camel_case {
                ...
                quote::quote! {
                    impl #tokens_without_id_or_with_id_read_upper_camel_case {
                        pub fn try_new(#tokens_without_id_or_with_id_read_fields_declaration_token_stream) -> Result<Self, #tokens_without_id_or_with_id_read_try_from_error_named_upper_camel_case> {
                            #tokens_without_id_or_with_id_read_check_if_all_fields_are_none_token_stream
                            Ok(Self{#tokens_without_id_or_with_id_read_fields_token_stream})
                        }
                    }
                }
            };
            let impl_serde_deserialize_for_tokens_without_id_or_with_id_read_token_stream = {
                let range_end = {
                    let vec_syn_field_len = vec_syn_field.len();
                    match &postgresql_json_object_type {
                        PostgresqlJsonObjectType::WithoutId => vec_syn_field_len,
                ...
                let match_try_new_in_deserialize_token_stream = generate_match_try_new_in_deserialize_token_stream(
                    &tokens_without_id_or_with_id_read_upper_camel_case,
                    &{
                ...
                let tokens_without_id_or_with_id_read_upper_camel_case_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(&tokens_without_id_or_with_id_read_upper_camel_case);
                quote::quote! {
                    impl<'de> serde::Deserialize<'de> for #tokens_without_id_or_with_id_read_upper_camel_case {
                        fn deserialize<__D>(
                            __deserializer: __D,
                            ...
                            __D: serde::Deserializer<'de>,
                        {
                            ...
                            impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                                type Value = #tokens_without_id_or_with_id_read_upper_camel_case;
                                fn expecting(
                                    &self,
                                    __formatter: &mut serde::__private::Formatter<'_>,
                                ) -> serde::__private::fmt::Result {
                            ...
                            serde::Deserializer::deserialize_struct(
                                __deserializer,
                                #tokens_without_id_or_with_id_read_upper_camel_case_double_quotes_token_stream,
                                FIELDS,
                                __Visitor {
                                    marker: serde::__private::PhantomData::<
                                        #tokens_without_id_or_with_id_read_upper_camel_case,
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_without_id_or_with_id_read_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                &tokens_without_id_or_with_id_read_upper_camel_case,
                &proc_macro2::TokenStream::new(),
                &{
            ...
            let maybe_impl_sqlx_type_sqlx_postgres_and_impl_sqlx_decode_sqlx_postgres_token_stream = if let PostgresqlTypeOrJsonTypeHandle::PostgresqlType = &postgresql_type_or_json_type_handle {
                let sqlx_types_json_tokens_without_id_or_with_id_read_token_stream = postgresql_crud_macros_common::generate_sqlx_types_json_type_declaration_token_stream(&tokens_without_id_or_with_id_read_upper_camel_case);
                let std_option_option_sqlx_types_json_tokens_without_id_or_with_id_read_token_stream = postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&sqlx_types_json_tokens_without_id_or_with_id_read_token_stream);
                let impl_sqlx_type_sqlx_postgres_for_tokens_without_id_or_with_id_read_token_stream = postgresql_crud_macros_common::generate_impl_sqlx_type_sqlx_postgres_for_ident_token_stream(
                    &tokens_without_id_or_with_id_read_upper_camel_case,
                    //todo
                    &sqlx_types_json_tokens_without_id_or_with_id_read_token_stream
                    // &match &postgresql_type {
                    //     PostgresqlType::JsonbNotNull => &sqlx_types_json_tokens_without_id_or_with_id_read_token_stream,
                    //     PostgresqlType::JsonbNullable => &std_option_option_sqlx_types_json_tokens_without_id_or_with_id_read_token_stream,
                    // },
                );
                let impl_sqlx_decode_sqlx_postgres_for_tokens_without_id_or_with_id_read_token_stream = {
                ...
                quote::quote! {
                    #impl_sqlx_type_sqlx_postgres_for_tokens_without_id_or_with_id_read_token_stream
                    #impl_sqlx_decode_sqlx_postgres_for_tokens_without_id_or_with_id_read_token_stream
                }
            }
            else {
                proc_macro2::TokenStream::new()
            ...
            quote::quote! {
                #tokens_without_id_or_with_id_read_token_stream
                #tokens_without_id_or_with_id_read_try_from_error_named_token_stream
                #impl_try_new_for_tokens_without_id_or_with_id_read_try_from_error_named_token_stream
                #impl_serde_deserialize_for_tokens_without_id_or_with_id_read_token_stream
                #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_without_id_or_with_id_read_token_stream
                #maybe_impl_sqlx_type_sqlx_postgres_and_impl_sqlx_decode_sqlx_postgres_token_stream
            }
        };
        let common_update_query_part_token_stream = match &postgresql_json_type_pattern {
            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
        ...
        let common_update_query_bind_token_stream = match &postgresql_json_type_pattern {
            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
        ...
        let impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = {
                ...
                let tokens_to_create_token_stream = generate_supported_generics_template_struct_token_stream(
                    ...
                    &match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<#tokens_create_upper_camel_case>);},
                        },
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                            dimension1_not_null_or_nullable: _,
                        } => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {(pub std::vec::Vec<#tokens_create_upper_camel_case>);},
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<std::vec::Vec<#tokens_create_upper_camel_case>>);},
                        },
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension2 {
                            dimension1_not_null_or_nullable: _,
                            dimension2_not_null_or_nullable: _,
            ...
            let select_token_stream = {
                let tokens_select_token_stream = {
                    let content_token_stream = match &postgresql_json_type_pattern {
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {(pub postgresql_crud::UniqueVec<#ident_select_without_id_upper_camel_case>);},
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => todo!(),
                        },
                        postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                            dimension1_not_null_or_nullable: _,
                        } => todo!(),
                ...
                // let sqlx_types_json_tokens_select_token_stream = generate_sqlx_types_json_type_declaration_token_stream(
                //     &quote::quote!{postgresql_crud::UniqueVec<#ident_select_without_id_upper_camel_case>}
                // );
                // let std_option_option_sqlx_types_json_tokens_select_token_stream = generate_std_option_option_tokens_declaration_token_stream(&sqlx_types_json_tokens_select_token_stream);
                // let impl_sqlx_type_sqlx_postgres_for_ident_postgresql_type_select_token_stream = postgresql_crud_macros_common::generate_impl_sqlx_type_sqlx_postgres_for_ident_token_stream(
                //     &ident_postgresql_type_select_upper_camel_case,
                //     &match &postgresql_type {
                ...
                //     },
                // );
                // let impl_sqlx_decode_sqlx_postgres_for_ident_postgresql_type_select_token_stream = postgresql_crud_macros_common::generate_impl_sqlx_decode_sqlx_postgres_for_ident_token_stream(
                //     &ident_postgresql_type_select_upper_camel_case,
                //     &match &postgresql_type {
                //         PostgresqlType::JsonbNotNull => &sqlx_types_json_tokens_select_token_stream,
                //         PostgresqlType::JsonbNullable => &std_option_option_sqlx_types_json_tokens_select_token_stream,
                ...
                // );
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_select_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                    ...
                    &{
                        let content_token_stream = match &postgresql_json_type_pattern {
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(Some(
                                    #postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream
                                ))},
                            },
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                ...
                quote::quote! {
                    ...
                    // #impl_sqlx_type_sqlx_postgres_for_ident_postgresql_type_select_token_stream
                    // #impl_sqlx_decode_sqlx_postgres_for_ident_postgresql_type_select_token_stream
            ...
            let where_element_token_stream = {
                let tokens_where_element_token_stream = {
                    let variants_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        let field_type_as_json_type_where_element_token_stream = generate_type_as_crud_postgresql_json_type_token_stream(
                            &element.ty,
            ...
            let read_token_stream = generate_common_read_token_stream(&postgresql_json_object_type, &PostgresqlTypeOrJsonTypeHandle::PostgresqlJsonType);
            ...
            let update_token_stream = {
                let std_vec_vec_object_with_id_or_std_option_option_std_vec_vec_object_with_id_ident_token_stream = match &postgresql_json_type_pattern {
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => proc_macro2::TokenStream::new(),
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        dimension1_not_null_or_nullable: _,
                    } => match &not_null_or_nullable {
                ...
                let tokens_update_token_stream = {
                    ...
                    quote::quote! {
                        #[derive(Debug, Clone, PartialEq, Default, serde::Serialize, serde::Deserialize, utoipa::ToSchema, schemars::JsonSchema)]
                        pub struct #tokens_update_upper_camel_case(#self_type_content_token_stream);
                    }
                };
            ...
            let postgresql_json_type_for_ident_token_stream = postgresql_crud_macros_common::generate_postgresql_json_type_token_stream(
                ...
                //     },
                // },
                &common_create_query_part_token_stream,
                // &match &postgresql_json_type {
                //     PostgresqlJsonType::Object => {
                //         let create_query_bind_fields_token_stream = vec_syn_field.iter().map(|element| {
                //             let element_field_ident = element.ident.as_ref().unwrap_or_else(|| {
                ...
                &tokens_without_id_read_upper_camel_case,
                ...
                //     }
                // },
                &generate_common_select_query_part_token_stream(&postgresql_crud_macros_common::PostgresqlTypeOrJsonType::PostgresqlJsonType),
                &tokens_where_element_upper_camel_case,
        ...
        let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream = {
                ...
                let ident_postgresql_type_table_type_declaration_token_stream = generate_supported_generics_template_struct_token_stream(
                    ...
                    &{
                        match &postgresql_json_type_pattern {
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {#fields_declaration_3e60c916_a7e9_44af_a69d_0db54fa0c2f0_token_stream},
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<#ident_postgresql_type_table_type_declaration_upper_camel_case>);},
                            },
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                                dimension1_not_null_or_nullable: _,
                            } => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {(pub std::vec::Vec<#ident_postgresql_type_table_type_declaration_upper_camel_case>);},
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<std::vec::Vec<#ident_postgresql_type_table_type_declaration_upper_camel_case>>);},
                            },
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension2 {
                                dimension1_not_null_or_nullable: _,
                                dimension2_not_null_or_nullable: _,
            ...
            let ident_postgresql_type_create_upper_camel_case = naming::parameter::SelfCreateUpperCamelCase::from_tokens(&ident_postgresql_type_upper_camel_case);
            let ident_postgresql_type_create_token_stream = {
                let ident_postgresql_type_create_token_stream = generate_supported_generics_template_struct_token_stream(
                    true,
                    ...
                    &{
                        ...
                        match &postgresql_json_type_pattern {
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {#fields_declaration_3e60c916_a7e9_44af_a69d_0db54fa0c2f0_token_stream},
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<#ident_postgresql_type_create_upper_camel_case>);},
                            },
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                                dimension1_not_null_or_nullable: _,
                            } => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote! {(pub std::vec::Vec<#ident_postgresql_type_create_upper_camel_case>);},
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<std::vec::Vec<#ident_postgresql_type_create_upper_camel_case>>);},
                            },
                            postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension2 {
                                dimension1_not_null_or_nullable: _,
                                dimension2_not_null_or_nullable: _,
                ...
                let impl_std_fmt_display_for_ident_postgresql_type_create_token_stream = macros_helpers::generate_impl_std_fmt_display_token_stream(
                    &proc_macro2::TokenStream::new(),
                    &ident_postgresql_type_create_upper_camel_case,
                    &proc_macro2::TokenStream::new(),
                    &quote::quote! {write!(formatter, "{:?}", self)}
                );
                let impl_error_occurence_lib_to_std_string_string_for_ident_postgresql_type_create_token_stream = macros_helpers::generate_impl_error_occurence_lib_to_std_string_string_token_stream(
                    &proc_macro2::TokenStream::new(),
                    &ident_postgresql_type_create_upper_camel_case,
                    &proc_macro2::TokenStream::new(),
                    &quote::quote! {format!("{self}")}
                );
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_create_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                    &ident_postgresql_type_create_upper_camel_case,
                    &proc_macro2::TokenStream::new(),
                    &{
                        // let value = match &postgresql_type {
                ...
                quote::quote! {
                    #ident_postgresql_type_create_token_stream
                    #impl_std_fmt_display_for_ident_postgresql_type_create_token_stream
                    #impl_error_occurence_lib_to_std_string_string_for_ident_postgresql_type_create_token_stream
                    #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_create_token_stream
                }
            };
            //todo
            let ok_value_match_token_stream = quote::quote! {Ok(Self(value.0))};
            // match &postgresql_type {
            ...
            let ident_postgresql_type_select_token_stream = {
                ...
                let std_option_option_sqlx_types_json_tokens_select_token_stream = postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&sqlx_types_json_tokens_select_token_stream);
                let impl_sqlx_type_sqlx_postgres_for_ident_postgresql_type_select_token_stream = postgresql_crud_macros_common::generate_impl_sqlx_type_sqlx_postgres_for_ident_token_stream(
                    &ident_postgresql_type_select_upper_camel_case,
                    //todo
                ...
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_select_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_postgresql_type_select_upper_camel_case, &proc_macro2::TokenStream::new(), &{
                        //todo
                ...
                quote::quote! {
                    #ident_postgresql_type_select_token_stream
                    #impl_sqlx_type_sqlx_postgres_for_ident_postgresql_type_select_token_stream
                    #impl_sqlx_decode_sqlx_postgres_for_ident_postgresql_type_select_token_stream
                    #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_select_token_stream
                }
            };
            let ident_postgresql_type_where_element_upper_camel_case = naming::parameter::SelfWhereElementUpperCamelCase::from_tokens(&ident_postgresql_type_upper_camel_case);
            let ident_postgresql_type_where_element_token_stream = {
                let ident_postgresql_type_where_element_token_stream = {
                    let variants_token_stream = vec_syn_field.iter().map(|element| {
                        let field_ident_stringified = element
                            .ident
                    ...
                    quote::quote! {
                        #[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
                        pub enum #ident_postgresql_type_where_element_upper_camel_case {
                            #(#variants_token_stream),*
                        }
                    }
                };
                let impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_postgresql_type_where_element_token_stream = postgresql_crud_macros_common::impl_postgresql_type_where_filter_for_ident_token_stream(
                    &quote::quote! {<'a>},
                    &ident_postgresql_type_where_element_upper_camel_case,
                    &proc_macro2::TokenStream::new(),
                    &{
                        let variants_token_stream = vec_syn_field.iter().map(|element| {
                            let field_ident_stringified = element
                ...
                let impl_error_occurence_lib_to_std_string_string_for_ident_postgresql_type_where_element_token_stream =
                    macros_helpers::generate_impl_error_occurence_lib_to_std_string_string_token_stream(&proc_macro2::TokenStream::new(), &ident_postgresql_type_where_element_upper_camel_case, &proc_macro2::TokenStream::new(), &quote::quote! {format!("{self:#?}")});
                let impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_where_element_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_postgresql_type_where_element_upper_camel_case, &{
                        let variants_token_stream = vec_syn_field.iter().map(|element| {
                            let field_ident_stringified = element
                                .ident
                                .as_ref()
                ...
                quote::quote! {
                    #ident_postgresql_type_where_element_token_stream
                    #impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_postgresql_type_where_element_token_stream
                    #impl_error_occurence_lib_to_std_string_string_for_ident_postgresql_type_where_element_token_stream
                    #impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_where_element_token_stream
                }
            };
            let ident_postgresql_type_without_id_read_upper_camel_case = naming::parameter::SelfWithoutIdReadUpperCamelCase::from_tokens(&ident_postgresql_type_upper_camel_case);
            // let ident_postgresql_type_with_id_read_upper_camel_case = naming::parameter::SelfWithIdReadUpperCamelCase::from_tokens(&ident_postgresql_type_upper_camel_case);//todo
            let ident_postgresql_type_read_token_stream = generate_common_read_token_stream(&postgresql_json_object_type, &PostgresqlTypeOrJsonTypeHandle::PostgresqlType);
            let ident_postgresql_type_update_upper_camel_case = naming::parameter::SelfUpdateUpperCamelCase::from_tokens(&ident_postgresql_type_upper_camel_case);
            let ident_postgresql_type_update_token_stream = {
                let ident_postgresql_type_update_token_stream = {
                    //todo match on PostgresqlJsonType
                    let type_token_stream = {
                        let postgresql_crud_unique_vec_ident_update_element_token_stream = quote::quote!{postgresql_crud::UniqueVec<#ident_update_element_upper_camel_case>};
                        //todo
                        postgresql_crud_unique_vec_ident_update_element_token_stream
                        // match &postgresql_type {
                        //     PostgresqlType::JsonbNotNull => postgresql_crud_unique_vec_ident_update_element_token_stream,
                        //     PostgresqlType::JsonbNullable => postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&postgresql_crud_unique_vec_ident_update_element_token_stream),
                        // }
                    };
                    quote::quote! {
                        #[derive(
                        ...
                        pub struct #ident_postgresql_type_update_upper_camel_case (#type_token_stream);
                    }
                };
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_update_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_postgresql_type_update_upper_camel_case, &proc_macro2::TokenStream::new(), &{
                        //todo
                        let value = quote::quote! {(
                            #postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream
                        )};
                ...
                quote::quote! {
                    #ident_postgresql_type_update_token_stream
                    #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_postgresql_type_update_token_stream
                }
            };
            let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_ident_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_type_for_ident_token_stream(
                ...
                &ident_postgresql_type_without_id_read_upper_camel_case,
                &ident_postgresql_type_update_upper_camel_case,
                // &{
            ...
            quote::quote! {
                ...
                #ident_postgresql_type_select_token_stream
                #ident_postgresql_type_where_element_token_stream
                #ident_postgresql_type_read_token_stream
                #ident_postgresql_type_update_token_stream
