...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .map(|(index, element)|{
        ...
        let update_query_bind_postgresql_json_type_snake_case = naming::UpdateQueryBindPostgresqlTypeSnakeCase;
        ...
        let ident_create_token_stream = {
            ...
            let impl_ident_create_token_stream = generate_create_query_part_and_create_query_bind_token_stream(
                ...
                &match &not_null_or_nullable {
                    ...
                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                        let std_option_option_type_as_postgresql_json_type_create_token_stream = postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&generate_type_as_postgresql_json_type_create_token_stream(
                            &match &postgresql_json_object_type_pattern {
                                PostgresqlJsonObjectTypePattern::Standart => &ident_standart_not_null_upper_camel_case,
                                PostgresqlJsonObjectTypePattern::Array => &ident_with_id_array_not_null_upper_camel_case,
                            }
        ...
        let ident_with_id_array_not_null_as_postgresql_json_type_select_token_stream = generate_type_as_postgresql_json_type_select_token_stream(
        ...
        let ident_select_token_stream = {
            let ident_with_id_standart_not_null_as_postgresql_json_type_select_token_stream = generate_type_as_postgresql_json_type_select_token_stream(
                &ident_with_id_standart_not_null_upper_camel_case
            );
            ...
            let impl_select_query_part_for_ident_select_token_stream = {
                let select_query_part_content_token_stream = {
                    let generate_select_query_part_content_for_ident_select_or_ident_with_id_select_standart_not_null_token_stream = |
                        is_standart_with_id: &IsStandartWithId,
                        postgresql_type_or_postgresql_json_type: &postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType,
                    |{
                        ...
                        let (if_postgresql_type_is_true_format_handle_double_quotes_token_stream, if_postgresql_type_is_false_format_handle_double_quotes_token_stream) = {
                            ...
                            let acc_format_handle = {
                                ...
                                //     postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType::PostgresqlType => format!("{{{acc_snake_case}}} as {{{column_snake_case}}}"),
                                //     postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType::PostgresqlJsonType => format!("{{{acc_snake_case}}}"),
                                // }
                    ...
                    match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_select_query_part_content_for_ident_select_or_ident_with_id_select_standart_not_null_token_stream(
                                &is_standart_with_id_false,
            ...
            let maybe_ident_select_element_token_stream = if is_standart_not_null {
                generate_ident_select_element_or_ident_with_id_select_element_standart_not_null_token_stream(&is_standart_with_id_false)
            }
            else {
                proc_macro2::TokenStream::new()
            };
            ...
            quote::quote! {
                ...
                #impl_select_query_part_for_ident_select_token_stream
            ...
            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                    ...
                    match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => generate_impl_postgresql_type_where_filter_for_ident_token_stream(
                                &generate_where_filter_query_part_content_standart_not_null_token_stream(&is_standart_with_id_false),
                                postgresql_crud_macros_common::IsQueryBindMutable::False,
                                &generate_where_filter_query_bind_content_standart_not_null_token_stream(&is_standart_with_id_false),
                            ),
                            NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
                        },
                ...
                let maybe_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_where_element_token_stream = match &postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        NotNullOrNullable::NotNull => postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                            &ident_where_element_upper_camel_case,
                            &generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_content_standart_not_null_where_element(&is_standart_with_id_false)
                        ),
                        NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
                    },
                ...
                let maybe_ident_with_id_where_element_standart_not_null_token_stream = if is_standart_not_null {
                    let ident_with_id_where_element_standart_not_null_token_stream = generate_ident_where_element_token_stream(
                        ...
                        &generate_ident_where_element_content_token_stream(&is_standart_with_id_true)
                    );
        ...
        let generate_type_as_postgresql_json_type_read_inner_token_stream = |type_token_stream: &dyn quote::ToTokens|{
            generate_type_as_postgresql_json_type_subtype_token_stream(
                &type_token_stream,
                &postgresql_json_type_subtype_read_inner
            )
        };
        ...
        let generate_ident_or_ident_with_id_read_or_read_inner_fields_declaration_token_stream = |
            is_standart_with_id: &IsStandartWithId,
            read_or_read_inner: &ReadOrReadInner,
        | {
            let content_token_stream = get_vec_syn_field(is_standart_with_id).iter().map(|element| {
                ...
                let field_type_as_json_type_read_token_stream = match &read_or_read_inner {
                    ReadOrReadInner::ReadWithSerdeOptionIsNoneAnnotation |
                    ReadOrReadInner::ReadWithoutSerdeOptionIsNoneAnnotation => generate_type_as_postgresql_json_type_read_token_stream(&element.ty),
        ...
        let ident_read_token_stream = {
            ...
            let generate_fn_into_inner_token_stream = |
                ident_token_stream: &dyn quote::ToTokens,
            ...
            let generate_ident_read_or_ident_with_id_read_upper_camel_case = |is_standart_with_id: &IsStandartWithId|{
                match &is_standart_with_id {
            ...
            let generate_impl_try_new_for_ident_read_try_from_error_named_token_stream = |is_standart_with_id: &IsStandartWithId|{
                ...
                let fields_declaration_token_stream = generate_ident_or_ident_with_id_read_or_read_inner_fields_declaration_token_stream(
                    is_standart_with_id,
            ...
            let maybe_ident_with_id_read_token_stream = if is_standart_not_null {
                ...
                let impl_into_inner_for_ident_with_id_read_standart_not_null_token_stream = generate_fn_into_inner_token_stream(
                    &ident_with_id_read_standart_not_null_upper_camel_case,
        ...
        let ident_read_inner_token_stream = {
            ...
            let ident_read_inner_token_stream = {
                ...
                match &postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_ident_read_inner_or_ident_with_id_inner_standart_not_null_token_stream(
                            &IsStandartWithId::False
                        ),
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => generate_pub_type_ident_read_inner_alias_token_stream(
                            &postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(
                                &generate_type_as_postgresql_json_type_read_inner_token_stream(
                                    &ident_standart_not_null_upper_camel_case
                                )
                            )
                        )
            ...
            let maybe_ident_with_id_read_inner_token_stream = if is_standart_not_null {
                generate_ident_read_inner_or_ident_with_id_inner_standart_not_null_token_stream(
                    &IsStandartWithId::True
                )
            }
            else {
        ...
        let ident_update_token_stream = {
            ...
            let ident_standart_not_null_as_postgresql_json_type_update_token_stream = generate_type_as_postgresql_json_type_update_token_stream(
                &ident_standart_not_null_upper_camel_case
            );
            let ident_with_id_array_not_null_as_postgresql_json_type_update_token_stream = generate_type_as_postgresql_json_type_update_token_stream(
                &ident_with_id_array_not_null_upper_camel_case
            );
            ...
            let ident_update_token_stream = {
                ...
                let generate_std_option_option_ident_type_token_stream = |ident_token_stream: &dyn quote::ToTokens|{
                    wrap_content_into_scopes_dot_comma_token_stream(
                        &postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&ident_token_stream)
                    )
                };
                match &postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
            ...
            let maybe_impl_new_or_try_new_for_ident_update_token_stream = match &postgresql_json_object_type_pattern {
                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                    ...
                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => macros_helpers::generate_impl_new_for_ident_token_stream(
                        &ident_update_upper_camel_case,
                        &generate_value_type_token_stream(
                            &postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_token_stream(&ident_standart_not_null_as_postgresql_json_type_update_token_stream)
                        ),
                        &self_value_token_stream,
                    ),
                },
            ...
            let impl_ident_update_token_stream = {
                let update_query_part_postgresql_type_token_stream = {
                    let content_token_stream = match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_update_query_part_standart_not_null_content_token_stream(&is_standart_with_id_false),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                ...
                let update_query_bind_postgresql_type_token_stream = {
                    ...
                    let content_token_stream = match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_update_query_bind_standart_not_null_content_token_stream(&is_standart_with_id_false),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                    ...
                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                        let content_token_stream = vec_syn_field.iter().map(|element| {
                            ...
                            let default_token_stream = vec_syn_field.iter().map(|element| {
                                let default_element_field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                    panic!("{}", naming::FIELD_IDENT_IS_NONE);
                                });
                                let default_element_type = &element.ty;
                                if element_field_ident == default_element_field_ident {
                                    proc_macro2::TokenStream::new()
                                }
                                else {
                                    quote::quote! {#default_element_field_ident: Some(postgresql_crud::Value {
                                        #value_snake_case: <
