...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    .map(|(element, input_token_stream_stringified)|{
        ...
        let ident_table_type_declaration_token_stream = {
            ...
            let maybe_ident_with_id_standart_not_null_table_type_declaration_token_stream = if is_standart_not_null {
        ...
        let ident_select_token_stream = {
            ...
            let ident_select_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                    NotNullOrNullable::NotNull => generate_ident_select_standart_not_null_token_stream(&IsStandartWithId::False),
            ...
            let impl_ident_select_token_stream = {
                let select_query_part_token_stream = {
                    ...
                    //             let ident_select_with_id_upper_camel_case_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                    //                 PostgresqlJsonType::Object | PostgresqlJsonType::StdOptionOptionObject => &ident_select_upper_camel_case,
                    ...
                    //             let field_type_as_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_crud_postgresql_json_type_from_to_tokens_token_stream(&element_type);
                    //             quote::quote! {
                    //                 #ident_select_with_id_upper_camel_case_token_stream::#variant_name_token_stream(value) => #field_type_as_crud_postgresql_json_type_from_field_token_stream #select_query_part_snake_case(
                    //                     &value,
                    //                     #field_ident_double_quotes_token_stream,
                    //                     #column_name_and_maybe_field_getter_token_stream,
                    //                     &#column_name_and_maybe_field_getter_for_error_message_field_ident_snake_case,
        ...
        let ident_where_element_token_stream = {
            ...
            let maybe_ident_where_element_token_stream = {
                ...
                match &postgresql_json_type_pattern {
                    ...
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        ...
                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => generate_ident_where_element_wrapper_token_stream(&{
                            // let variants_token_stream = vec_syn_field.iter().map(|element| {
                            //     let field_ident_stringified = element
                            //         .ident
                            //         .as_ref()
                            ...
                            quote::quote! {
                                Equal(postgresql_crud::where_element_filters::PostgresqlJsonTypeWhereElementEqual<#ident_table_type_declaration_upper_camel_case>)
                            }
                        }),
                        (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                        (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
            ...
            let maybe_impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_where_element_token_stream = {
                ...
                match &postgresql_json_type_pattern {
                    ...
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        ...
                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => generate_impl_postgresql_type_where_filter_for_ident_token_stream(
                            &quote::quote!{
                                match &self {
            ...
            let maybe_impl_error_occurence_lib_to_std_string_string_for_ident_where_element_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                ...
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    ...
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => generate_generate_impl_error_occurence_lib_to_std_string_string_wrapper_token_stream(
                        &ident_where_element_upper_camel_case
                    ),
                    (NotNullOrNullable::NotNull, NotNullOrNullable::Nullable) => todo!(),
                    (NotNullOrNullable::Nullable, NotNullOrNullable::NotNull) => todo!(),
            ...
            let maybe_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_where_element_token_stream = match &postgresql_json_type_pattern {
                ...
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    ...
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        &ident_where_element_upper_camel_case,
                        &quote::quote!{
            ...
            match &postgresql_json_type_pattern {
                ...
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {..} => typical_token_stream,
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension2 {..} => todo!(),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension3 {..} => todo!(),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension4 {..} => todo!(),
            }
        ...
        let ident_read_token_stream = {
            ...
            |{
                ...
                quote::quote! {
                    #[derive(Debug, Clone, PartialEq, Default, serde::Serialize, #maybe_derive_serde_deserialize_token_stream utoipa::ToSchema, schemars::JsonSchema)]
                    pub struct #ident_token_stream #content_token_stream
                }
            };
            let ident_read_token_stream = {
                ...
                match &postgresql_json_type_pattern {
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => generate_ident_read_wrapper_token_stream(
                        &{
                    ...
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        ...
                        (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => generate_ident_read_wrapper_token_stream(
                            &quote::quote!{(pub std::vec::Vec<#ident_with_id_read_standart_not_null_upper_camel_case>);},
            ...
            let maybe_ident_read_try_from_error_named_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => generate_ident_read_try_from_error_named_token_stream(&ident_read_try_from_error_named_upper_camel_case),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => proc_macro2::TokenStream::new(),
            ...
            let maybe_impl_try_new_for_ident_read_try_from_error_named_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => generate_impl_try_new_for_ident_read_try_from_error_named_token_stream(&IsStandartWithId::False),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => proc_macro2::TokenStream::new(),
            ...
            let maybe_impl_serde_deserialize_for_ident_read_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => generate_impl_serde_deserialize_for_ident_read_token_stream(&IsStandartWithId::False),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => proc_macro2::TokenStream::new(),
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_read_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_read_token_stream(&IsStandartWithId::False),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                    (NotNullOrNullable::NotNull, NotNullOrNullable::NotNull) => postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        &ident_read_upper_camel_case,
                        &proc_macro2::TokenStream::new(),
                        &quote::quote! {
        ...
        let ident_update_token_stream = {
            ...
            let vec_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_update_token_stream = quote::quote!{std::vec::Vec<<postgresql_crud::postgresql_json_type::UuidUuidAsNotNullJsonbString as postgresql_crud::PostgresqlJsonType>::Update>};
            let generate_create_update_delete_fields_token_stream = |should_add_serde_skip_serializing_if_vec_is_empty_annotation: &ShouldAddSerdeSkipSerializingIfVecIsEmptyAnnotation|{
                ...
                quote::quote!{
                    ...
                    #maybe_serde_skip_serializing_if_vec_is_empty_token_stream
                    #delete_snake_case: #vec_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_update_token_stream,
                }
            };
            ...
            let ident_update_token_stream = {
                let content_token_stream = match &postgresql_json_type_pattern {
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {(pub std::option::Option<#ident_update_standart_not_null_upper_camel_case>);},
                    },
                    postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                        dimension1_not_null_or_nullable,
                    } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
            ...
            let maybe_impl_serde_deserialize_for_ident_update_token_stream = match &postgresql_json_type_pattern {
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::Standart => proc_macro2::TokenStream::new(),
                postgresql_crud_macros_common::PostgresqlJsonTypePattern::ArrayDimension1 {
                    dimension1_not_null_or_nullable,
                } => match (&not_null_or_nullable, &dimension1_not_null_or_nullable) {
                                    ...
                                    __D: serde::Deserializer<'de>,
                                {
                                    ...
                                    impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                                            ...
                                            __A: serde::de::SeqAccess<'de>,
                                        {
                                            ...
                                            let __field2 = match serde::de::SeqAccess::next_element::<#vec_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_update_token_stream>(&mut __seq)? {
                                                serde::__private::Some(__value) => __value,
                                                serde::__private::None => {
                                                    vec![]
                                                }
                                            ...
                                            __A: serde::de::MapAccess<'de>,
                                        {
                                            ...
                                            let mut __field2: serde::__private::Option<#vec_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_update_token_stream> = serde::__private::None;
                                            while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                                                match __key {
                                                    ...
                                                    __Field::__field2 => {
                                                        ...
                                                        __field2 = serde::__private::Some(serde::de::MapAccess::next_value::<#vec_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_update_token_stream>(&mut __map)?);
                                                    }
                                                    _ => {
        ...
        enum NoNeedToWrapOrTrue {
            NoNeedToWrap,
            True
        }
        let generate_update_query_part_token_stream = |no_need_to_wrap_or_true: &NoNeedToWrapOrTrue|{
            let no_need_to_wrap_parameter_token_stream = match &no_need_to_wrap_or_true {
                NoNeedToWrapOrTrue::NoNeedToWrap => quote::quote!{no_need_to_wrap},
                NoNeedToWrapOrTrue::True => quote::quote!{true}
            };
            quote::quote!{
                #value_snake_case.#update_query_part_snake_case(
                    ...
                    #jsonb_set_path_snake_case,
                    #increment_snake_case,
                    #no_need_to_wrap_parameter_token_stream,
                )
            }
        };
        ...
        let (
            ...
            let impl_postgresql_crud_postgresql_json_type_for_ident_token_stream = postgresql_crud_macros_common::generate_postgresql_json_type_token_stream(
                ...
                &generate_update_query_part_token_stream(&NoNeedToWrapOrTrue::NoNeedToWrap),
            ...
            let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_type_for_ident_token_stream(
                ...
                &ident_read_upper_camel_case,
                &ident_update_upper_camel_case,
                &generate_update_query_part_token_stream(&NoNeedToWrapOrTrue::True),
                &postgresql_crud_macros_common::IsUpdateQueryBindMutable::False,
                &update_query_bind_token_stream
            );
            match &trait_gen {
