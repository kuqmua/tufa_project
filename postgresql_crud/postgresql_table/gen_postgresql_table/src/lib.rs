...
pub fn gen_postgresql_table_config(
...
#[proc_macro_derive(GenPostgresqlTable, attributes(gen_postgresql_table_primary_key))]
pub fn gen_postgresql_table(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    gen_postgresql_table_source::gen_postgresql_table(input.into()).into()
}
