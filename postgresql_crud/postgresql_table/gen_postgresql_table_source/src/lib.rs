...
use naming::{
    ...
    GenColumnQuealsValueCommaUpdateOneQueryPartSc, GenPostgresqlTablePrimaryKeySc,
    ...
    PostgresPoolForTokioSpawnSyncMoveSc, PostgresPoolSc, PostgresqlCrudSc, PostgresqlSc,
    PostgresqlTypeOptionVecWhereGreaterThanTestSc, PostgresqlTypeUcc, PostgresqlUcc, PrefixSc,
    PrepareExtensionsSc, PreparePostgresqlSc, PreparePostgresqlTableSc, PreparePostgresqlUcc,
    ...
    parameter::{
        ...
        SelfErrorNamedWithSerializeDeserializeSc, SelfGenPostgresqlTableModSc, SelfHandleSc,
        SelfPayloadExampleSc, SelfPreparePostgresqlErrorNamedUcc,
...
#[must_use]
pub fn gen_postgresql_table(input: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    #[derive(Debug)]
    ...
    impl Operation {
        ...
        const fn gen_postgresql_table_attribute_additional_error_variants(
            self,
        ) -> GenPostgresqlTableAttribute {
            match self {
                Self::CreateMany => GenPostgresqlTableAttribute::CreateManyAdditionalErrorVariants,
                Self::CreateOne => GenPostgresqlTableAttribute::CreateOneAdditionalErrorVariants,
                Self::ReadMany => GenPostgresqlTableAttribute::ReadManyAdditionalErrorVariants,
                Self::ReadOne => GenPostgresqlTableAttribute::ReadOneAdditionalErrorVariants,
                Self::UpdateMany => GenPostgresqlTableAttribute::UpdateManyAdditionalErrorVariants,
                Self::UpdateOne => GenPostgresqlTableAttribute::UpdateOneAdditionalErrorVariants,
                Self::DeleteMany => GenPostgresqlTableAttribute::DeleteManyAdditionalErrorVariants,
                Self::DeleteOne => GenPostgresqlTableAttribute::DeleteOneAdditionalErrorVariants,
            }
        }
        const fn gen_postgresql_table_attribute_additional_logic(
            self,
        ) -> GenPostgresqlTableAttribute {
            match self {
                Self::CreateMany => GenPostgresqlTableAttribute::CreateManyAdditionalLogic,
                Self::CreateOne => GenPostgresqlTableAttribute::CreateOneAdditionalLogic,
                Self::ReadMany => GenPostgresqlTableAttribute::ReadManyAdditionalLogic,
                Self::ReadOne => GenPostgresqlTableAttribute::ReadOneAdditionalLogic,
                Self::UpdateMany => GenPostgresqlTableAttribute::UpdateManyAdditionalLogic,
                Self::UpdateOne => GenPostgresqlTableAttribute::UpdateOneAdditionalLogic,
                Self::DeleteMany => GenPostgresqlTableAttribute::DeleteManyAdditionalLogic,
                Self::DeleteOne => GenPostgresqlTableAttribute::DeleteOneAdditionalLogic,
            }
        }
    ...
    enum GenPostgresqlTableAttribute {
    ...
    impl GenPostgresqlTableAttribute {
    ...
    struct GenPostgresqlTableConfig {
        create_many_content_write_into_gen_postgresql_table_create_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        create_one_content_write_into_gen_postgresql_table_create_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        read_many_content_write_into_gen_postgresql_table_read_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        read_one_content_write_into_gen_postgresql_table_read_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        update_many_content_write_into_gen_postgresql_table_update_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        update_one_content_write_into_gen_postgresql_table_update_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        delete_many_content_write_into_gen_postgresql_table_delete_many:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        delete_one_content_write_into_gen_postgresql_table_delete_one:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        tests_content_write_into_gen_postgresql_table_tests:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        common_content_write_into_gen_postgresql_table_common:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        whole_content_write_into_gen_postgresql_table:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
    }
    ...
    let return_err_query_part_error_named_write_into_buffer_ts =
        postgresql_crud_macros_common::gen_return_err_query_part_error_named_write_into_buffer_ts(
            import_path,
        );
    ...
    let gen_postgresql_table_config = serde_json::from_str::<GenPostgresqlTableConfig>(
        &macros_helpers::get_macro_attribute_meta_list_ts(
            &syn_derive_input.attrs,
            &format!(
                "{}::gen_postgresql_table_config",
                        ...
                        for el_f4d3785c in &el_2e7b44a3.attrs {
                            if el_f4d3785c.path().segments.len() == 1 {
                                let first_segment_ident = &el_f4d3785c
                                    ...
                                    .ident;
                                let gen_postgresql_table_primary_key_sc_str =
                                    GenPostgresqlTablePrimaryKeySc.to_string();
                                if first_segment_ident == &gen_postgresql_table_primary_key_sc_str {
    ...
    let gen_as_postgresql_type_ts = |field_type: &dyn quote::ToTokens| {
        quote! {<#field_type as postgresql_crud::PostgresqlType>::}
    };
    let primary_key_field_type_as_postgresql_type_ts =
        gen_as_postgresql_type_ts(&primary_key_field_type);
    let gen_as_postgresql_type_tokens_ts =
        |field_type: &dyn quote::ToTokens, tokens: &dyn quote::ToTokens| {
            let as_postgresql_type_ts = gen_as_postgresql_type_ts(&field_type);
            quote! {#as_postgresql_type_ts #tokens}
        };
    // let gen_as_postgresql_type_table_type_declaration_ts = |field_type: &dyn quote::ToTokens| gen_as_postgresql_type_tokens_ts(&field_type, &TableTypeDeclarationUcc);
    // let primary_key_field_type_as_postgresql_type_table_type_declaration_ts = gen_as_postgresql_type_table_type_declaration_ts(&primary_key_field_type);
    let gen_as_postgresql_type_create_ts = |field_type: &dyn quote::ToTokens| {
        gen_as_postgresql_type_tokens_ts(&field_type, &CreateUcc)
    };
    let gen_as_postgresql_type_select_ts = |field_type: &dyn quote::ToTokens| {
        gen_as_postgresql_type_tokens_ts(&field_type, &SelectUcc)
    };
    let primary_key_field_type_as_postgresql_type_select_ts =
        gen_as_postgresql_type_select_ts(&primary_key_field_type);
    let gen_as_postgresql_type_where_ts =
        |field_type: &dyn quote::ToTokens| gen_as_postgresql_type_tokens_ts(&field_type, &WhereUcc);
    let primary_key_field_type_as_postgresql_type_where_ts =
        gen_as_postgresql_type_where_ts(&primary_key_field_type);
    let gen_as_postgresql_type_read_ts =
        |field_type: &dyn quote::ToTokens| gen_as_postgresql_type_tokens_ts(&field_type, &ReadUcc);
    let gen_as_postgresql_type_read_only_ids_ts = |field_type: &dyn quote::ToTokens| {
        gen_as_postgresql_type_tokens_ts(&field_type, &ReadOnlyIdsUcc)
    };
    let primary_key_field_type_as_postgresql_type_read_ts =
        gen_as_postgresql_type_read_ts(&primary_key_field_type);
    let gen_as_postgresql_type_update_ts = |field_type: &dyn quote::ToTokens| {
        gen_as_postgresql_type_tokens_ts(&field_type, &UpdateUcc)
    };
    let gen_as_postgresql_type_update_for_query_ts = |field_type: &dyn quote::ToTokens| {
        gen_as_postgresql_type_tokens_ts(&field_type, &UpdateForQueryUcc)
    };
    let primary_key_field_type_as_postgresql_type_read_ucc =
        quote! {<#primary_key_field_type as postgresql_crud::#PostgresqlTypeUcc>::#ReadUcc};
    ...
    let std_vec_vec_primary_key_field_type_read_ts =
        postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
            &primary_key_field_type_as_postgresql_type_read_ucc,
        );
    ...
    let gen_select_postgresql_crud_not_empty_unique_vec_ident_select_ts =
        |should_add_borrow: &ShouldAddBorrow| {
            quote! {#SelectSc: #should_add_borrow postgresql_crud::NotEmptyUniqueVec<#ident_select_ucc>}
        };
    let select_borrow_postgresql_crud_not_empty_unique_vec_ident_select_ts =
        gen_select_postgresql_crud_not_empty_unique_vec_ident_select_ts(&ShouldAddBorrow::True);
    let select_postgresql_crud_not_empty_unique_vec_ident_select_ts =
        gen_select_postgresql_crud_not_empty_unique_vec_ident_select_ts(&ShouldAddBorrow::False);
    let pub_select_postgresql_crud_not_empty_unique_vec_ident_select_ts = {
        quote! {pub #select_postgresql_crud_not_empty_unique_vec_ident_select_ts}
    };
    ...
    let impl_ident_ts = {
        let ident_prepare_postgresql_error_named_ucc =
            SelfPreparePostgresqlErrorNamedUcc::from_tokens(&ident);
        ...
        let ident_prepare_postgresql_error_named_ts =
            macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
                ...
                .build_enum(
                    &ident_prepare_postgresql_error_named_ucc,
                    &quote! {{
        ...
        let pub_async_fn_prepare_extensions_ts = quote! {
            pub async fn #PrepareExtensionsSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>) -> Result<(), #ident_prepare_postgresql_error_named_ucc> {
                if let Err(#ErrorSc) = sqlx::query("create extension if not exists pg_jsonschema").execute(#PoolSc).await {
                    return Err(#ident_prepare_postgresql_error_named_ucc::#CreateExtensionIfNotExistsPgJsonschemaUcc {
                        #ErrorSc,
                        code_occurence: error_occurence_lib::code_occurence!()
                    });
                }
                if let Err(#ErrorSc) = sqlx::query("create extension if not exists \"uuid-ossp\"").execute(#PoolSc).await {
                    return Err(#ident_prepare_postgresql_error_named_ucc::#CreateExtensionIfNotExistsUuidOsspUcc {
                        #ErrorSc,
                        code_occurence: error_occurence_lib::code_occurence!()
                    });
                }
        ...
        let pub_async_fn_prepare_postgresql_table_ts = {
            let prepare_postgresql_double_quotes_ts = gen_quotes::double_quotes_ts(&format!(
                "create table if not exists {{table}} ({})",
                fields.iter().map(|_| "{}").collect::<Vec<&str>>().join(",")
            ));
            let serde_json_to_string_schemars_schema_for_generic_unwrap_ts = {
                let gen_field_type_as_postgresql_crud_create_table_column_query_part_create_table_query_part_ts =
                    |field_type: &syn::Type, field_ident: &syn::Ident, is_primary_key: bool| {
                        ...
                        let field_type_postgresql_type_ts = gen_as_postgresql_type_ts(&field_type);
                        quote! {
                            #field_type_postgresql_type_ts #CreateTableColumnQueryPartSc(&#field_ident_double_quotes_ts, #is_primary_key_ts)
                        }
                    };
                once(
                    gen_field_type_as_postgresql_crud_create_table_column_query_part_create_table_query_part_ts(
            ...
            quote! {
                pub async fn #PreparePostgresqlTableSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>, table: &str) -> Result<(), #ident_prepare_postgresql_error_named_ucc> {
                    if let Err(error) = sqlx::query(&format!(
                        ...
                        return Err(#ident_prepare_postgresql_error_named_ucc::#PreparePostgresqlUcc {
                            error,
                            code_occurence: error_occurence_lib::code_occurence!()
                        });
                    }
        ...
        let pub_async_fn_prepare_postgresql_ts = quote! {
            pub async fn #PreparePostgresqlSc(#PoolSc: &sqlx::Pool<sqlx::Postgres>) -> Result<(), #ident_prepare_postgresql_error_named_ucc> {
                Self::#PrepareExtensionsSc(#PoolSc).await?;
                Self::#PreparePostgresqlTableSc(#PoolSc, #ident_sc_double_quotes_ts).await?;
                Ok(())
            }
        };
        ...
        let fn_gen_select_query_part_ts = {
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let initialization_ts = {
                        ...
                        let as_postgresql_crud_postgresql_type_postgresql_type_ts =
                            gen_as_postgresql_type_ts(&element.field_type);
                        quote! {
                            => match #as_postgresql_crud_postgresql_type_postgresql_type_ts #SelectQueryPartSc(
                                #ColumnSc,
            ...
            quote! {
                fn #GenSelectQueryPartSc(#select_borrow_postgresql_crud_not_empty_unique_vec_ident_select_ts) -> Result<#string_ts, #import_path ::#QueryPartErrorNamedUcc> {
    ...
    let gen_value_declaration_ts = |content_ts: &dyn quote::ToTokens| {
        quote! {#PostgresqlCrudSc::#ValueUcc<#content_ts>}
    };
    let gen_import_path_value_initialization_ts = |content_ts: &dyn quote::ToTokens| {
        postgresql_crud_macros_common::gen_value_initialization_ts(&import_path, &content_ts)
    };
    let gen_impl_postgresql_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts =
    ...
    let ident_create_ts = {
                ...
                let content_ts = gen_fields_named_without_primary_key_with_comma_ts(
                    &|element: &macros_helpers::SynFieldWrapper| {
                        ...
                        let el_syn_field_ty_as_postgresql_type_create_ts =
                            gen_as_postgresql_type_create_ts(&element.field_type);
                        quote! {
        ...
        let impl_ident_create_ts = {
            let primary_key_field_type_as_default_option_some_vec_one_el_call_ts = {
                let primary_key_field_type_as_postgresql_type_create_ts =
                    gen_as_postgresql_type_create_ts(&primary_key_field_type);
                quote! {
                    <
                        #primary_key_field_type_as_postgresql_type_create_ts as #PostgresqlCrudSc::#DefaultOptionSomeVecOneElUcc
                    >::#DefaultOptionSomeVecOneElSc()
                }
            };
            let fn_create_query_part_ts = {
                let gen_match_as_postgresql_crud_postgresql_type_postgresql_type_create_query_part_ts =
                    |field_type: &syn::Type, content_ts: &dyn quote::ToTokens| {
                        let as_postgresql_crud_postgresql_type_postgresql_type_ts =
                            gen_as_postgresql_type_ts(&field_type);
                        ...
                        quote! {
                            match #as_postgresql_crud_postgresql_type_postgresql_type_ts #CreateQueryPartSc(
                                &#content_ts,
                                #IncrementSc
                            ) {
                                Ok(value_c3f0b59a) => {
                ...
                let primary_key_content_ts = gen_match_as_postgresql_crud_postgresql_type_postgresql_type_create_query_part_ts(primary_key_field_type, &primary_key_field_type_as_default_option_some_vec_one_el_call_ts);
                let column_increments_ts = gen_fields_named_without_primary_key_without_comma_ts(
                    &|element: &macros_helpers::SynFieldWrapper| {
                        gen_match_as_postgresql_crud_postgresql_type_postgresql_type_create_query_part_ts(&element.field_type, &{
                ...
                quote! {
                    fn #CreateQueryPartSc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, postgresql_crud::#QueryPartErrorNamedUcc> {
            ...
            let fn_create_query_bind_ts = {
                let gen_query_as_postgresql_crud_postgresql_type_postgresql_type_create_query_bind_ts =
                    |field_type: &syn::Type, content_ts: &dyn quote::ToTokens| {
                        let as_postgresql_crud_postgresql_type_postgresql_type_ts =
                            gen_as_postgresql_type_ts(&field_type);
                        quote! {
                            match #as_postgresql_crud_postgresql_type_postgresql_type_ts #CreateQueryBindSc(
                                #content_ts,
                                #QuerySc
                            ) {
                                Ok(value_3c55d2e1) => {
                ...
                let primary_key_content_ts = gen_query_as_postgresql_crud_postgresql_type_postgresql_type_create_query_bind_ts(primary_key_field_type, &primary_key_field_type_as_default_option_some_vec_one_el_call_ts);
                let binded_query_modifications_ts =
                    gen_fields_named_without_primary_key_without_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| {
                            gen_query_as_postgresql_crud_postgresql_type_postgresql_type_create_query_bind_ts(&element.field_type, &{
                        let field_ident = &element.field_ident;
        ...
        let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_create_ts =
            gen_impl_postgresql_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                &ident_create_ucc,
                &{
        ...
        let fields_declaration_ts = gen_fields_named_with_comma_ts(
            &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                ...
                let el_syn_field_ty_as_postgresql_type_where_ts =
                    gen_as_postgresql_type_where_ts(&element.field_type);
                let std_option_option_postgresql_type_where_syn_field_ty_as_postgresql_type_where_ts =
                    postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                        &quote! {postgresql_crud::PostgresqlTypeWhere<#el_syn_field_ty_as_postgresql_type_where_ts>},
                    );
                quote! {
            ...
            postgresql_crud_macros_common::gen_impl_serde_deserialize_for_struct_ts(
                ...
                &|_: &syn::Ident, syn_type: &syn::Type| {
                    let syn_type_as_postgresql_type_where_ts =
                        gen_as_postgresql_type_where_ts(&syn_type);
                    postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                        &quote! {postgresql_crud::PostgresqlTypeWhere<#syn_type_as_postgresql_type_where_ts>},
                    )
                },
            );
    ...
    let std_option_option_ident_where_many_ts = {
                        ...
                        &|element: &macros_helpers::SynFieldWrapper| {
                            ...
                            quote! {
                                if let Some(value_b12d6fe0) = value_27176ffb.#field_ident {
                                    match postgresql_crud::PostgresqlTypeWhereFilter::query_bind(value_b12d6fe0, #QuerySc) {
                                        Ok(value_edaee3b2) => {
        ...
        let impl_postgresql_crud_default_option_some_vec_one_el_for_std_option_option_ident_where_many_ts =
            gen_impl_postgresql_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
                &std_option_option_ident_where_many_ucc,
                &quote! {Self(Some(#postgresql_crud_default_option_some_vec_one_el_call_ts))},
            );
        quote! {
    ...
    let where_many_postgresql_crud_default_option_some_vec_one_el_call_ts = quote! {
        #WhereManySc: #postgresql_crud_default_option_some_vec_one_el_call_ts
    };
    ...
    let gen_query_postgresql_type_where_filter_query_bind_parameters_payload_where_many_query_ts =
        |operation: &Operation| {
            ...
            quote! {
                match postgresql_crud::PostgresqlTypeWhereFilter::query_bind(#ParametersSc.#PayloadSc.#WhereManySc, #QuerySc) {
                    Ok(value_03a58371) => {
    ...
    let select_ts = {
            ...
            .build_enum(
                ...
                &{
                    let variants = gen_fields_named_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| {
                        ...
                        let field_ident_ucc_ts = ToTokensToUccTs::case_or_panic(&element.field_ident);
                        let el_syn_field_ty_as_postgresql_type_select_ts = gen_as_postgresql_type_select_ts(&element.field_type);
                        quote! {
                            #[serde(rename(serialize = #serialize_deserialize_ident_ts, deserialize = #serialize_deserialize_ident_ts))]
                            #field_ident_ucc_ts(#el_syn_field_ty_as_postgresql_type_select_ts)
                        }
                    });
                    quote!{{#variants}}
                }
        ...
        let impl_postgresql_crud_all_variants_default_option_some_vec_one_el_for_ident_select_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(&ident_select_ucc, &{
    ...
    let select_postgresql_crud_default_option_some_vec_one_el_call_ts = quote! {
        #SelectSc: #postgresql_crud_default_option_some_vec_one_el_call_ts
    };
    let ident_read_ts = {
        let ident_read_ts = {
            ...
            .build_struct(
                ...
                &{
                    let field_option_primary_key_ts = {
                        let std_option_option_value_primary_key_field_type_as_postgresql_type_read_ts = postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_postgresql_type_read_ts(&primary_key_field_type)));
                        quote! {
                    ...
                    let fields_options_without_primary_key_ts = gen_fields_named_without_primary_key_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        ...
                        let field_ident = &element.field_ident;
                        let std_option_option_value_field_type_as_postgresql_type_read_ts = postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_value_declaration_ts(&gen_as_postgresql_type_read_ts(&element.field_type)));
                        quote! {
                            #field_attribute_serde_skip_serializing_if_option_is_none_ts
            ...
            let fn_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts = {
                ...
                let assignment_variants_without_primary_key_ts = fields_without_primary_key
                    ...
                    .map(|el_3ce946f9| {
                        ...
                        let el_syn_field_ty_as_postgresql_type_read_ts = gen_as_postgresql_type_read_ts(&el_3ce946f9.field_type);
                        quote! {
    ...
    let ident_read_only_ids_ts = {
                ...
                &{
                    ...
                    let gen_field_ts = |field_ident: &dyn quote::ToTokens, field_type: &dyn quote::ToTokens, wrap_into_option: &WrapIntoOption| {
                        let field_type_ts = match &wrap_into_option {
                            WrapIntoOption::False => gen_as_postgresql_type_read_only_ids_ts(&field_type),
                            WrapIntoOption::True => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_as_postgresql_type_read_only_ids_ts(&field_type)),
                        };
                        quote! {
        ...
        let impl_sqlx_row_for_ident_read_only_ids_ts = {
            ...
            let where_field_types_ts = gen_fields_named_with_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let el_syn_field_ty_as_postgresql_type_read_only_ids_ts =
                        gen_as_postgresql_type_read_only_ids_ts(&field_type);
                    quote! {
            ...
            let primary_key_ts = {
                let el_syn_field_ty_as_postgresql_type_read_only_ids_ts =
                    gen_as_postgresql_type_read_only_ids_ts(&primary_key_field_type);
                let field_ident_double_quotes_ts =
                    gen_quotes::double_quotes_ts(&primary_key_field_ident);
                quote! {
    ...
    let postgresql_crud_order_by_ts = quote! {#PostgresqlCrudSc::#OrderByUcc};
    ...
    let ident_update_ts = {
        let gen_option_value_field_type_as_postgresql_type_update_ts = |syn_type: &syn::Type| {
            let path_value_ts = {
                let value = format!("{PostgresqlCrudSc}::{ValueUcc}");
                value
                    .parse::<proc_macro2::TokenStream>()
                    .expect("dbdbb7f2-7801-49e7-917e-f7daa9b4dd91")
            };
            let syn_type_as_postgresql_type_update_ts = gen_as_postgresql_type_update_ts(&syn_type);
            postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                &quote! {#path_value_ts<#syn_type_as_postgresql_type_update_ts>},
            )
        };
                ...
                gen_fields_named_without_primary_key_with_comma_ts(
                    &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        ...
                        let option_value_field_type_as_postgresql_type_update_ts =
                            gen_option_value_field_type_as_postgresql_type_update_ts(
                                &element.field_type,
                            );
                        quote! {
            ...
            postgresql_crud_macros_common::gen_impl_serde_deserialize_for_struct_ts(
                ...
                &|syn_ident: &syn::Ident, syn_type: &syn::Type| {
                    if syn_ident == primary_key_field_ident {
                        ...
                        gen_option_value_field_type_as_postgresql_type_update_ts(syn_type)
                    }
                },
            );
                            ...
                            &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                quote! {
                                    #field_ident: Some(postgresql_crud::Value{
                                        #ValueSc: #postgresql_crud_default_option_some_vec_one_el_call_ts
                                    })
                                }
                            },
                        );
    ...
    let ident_update_for_query_ts = {
                ...
                &{
                    let fields_named_without_primary_key_ts = gen_fields_named_without_primary_key_with_comma_ts(&|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                        ...
                        let option_value_field_type_as_postgresql_type_update_for_query_ts = {
                            ...
                            let syn_type_as_postgresql_type_update_for_query_ts = gen_as_postgresql_type_update_for_query_ts(&element.field_type);
                            postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&quote! {#path_value_ts<#syn_type_as_postgresql_type_update_for_query_ts>})
                        };
                        quote! {#field_ident: #option_value_field_type_as_postgresql_type_update_for_query_ts}
                    });
                    quote!{{
        ...
        let impl_ident_update_for_query_ts = {
            let update_query_part_primary_key_ts = {
                quote! {
                    fn #update_query_part_primary_key_sc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, #PostgresqlCrudSc::#QueryPartErrorNamedUcc> {
                        match #primary_key_field_type_as_postgresql_type_ts #UpdateQueryPartSc(
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    quote! {
                        fn #update_query_part_field_ident_sc(
                            #ValueSc: &postgresql_crud::Value<#field_type_as_postgresql_crud_postgresql_type_postgresql_type_ts #UpdateForQueryUcc>,
                            #IncrementSc: &mut u64
                        ) -> Result<#string_ts, #PostgresqlCrudSc::#QueryPartErrorNamedUcc> {
                            match #field_type_as_postgresql_crud_postgresql_type_postgresql_type_ts #UpdateQueryPartSc(
                                &#ValueSc.#ValueSc,
                                #field_ident_double_quotes_ts,
                                #field_ident_double_quotes_ts,
                                "",
            ...
            let select_only_updated_ids_query_part_ts = {
                let primary_key_content_ts = {
                    let primary_key_field_ident_double_quotes_ts =
                        gen_quotes::double_quotes_ts(&primary_key_field_ident);
                    quote! {
                        acc_88c91f52.push_str(&match <#primary_key_field_type as postgresql_crud::PostgresqlType>::#SelectOnlyUpdatedIdsQueryPartSc(
                            &self.#primary_key_field_ident,
                            #primary_key_field_ident_double_quotes_ts,
                            increment,
                        ){
                ...
                let content_ts = fields_without_primary_key.iter().map(|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_ident_double_quotes_ts = gen_quotes::double_quotes_ts(&field_ident);
                    let field_type_as_postgresql_crud_postgresql_type_postgresql_type_ts = gen_as_postgresql_type_ts(&element.field_type);
                    quote! {
                        if let Some(value_90f79b11) = &self.#field_ident {
                            acc_88c91f52.push_str(&match #field_type_as_postgresql_crud_postgresql_type_postgresql_type_ts #SelectOnlyUpdatedIdsQueryPartSc(
                ...
                quote! {
                    fn #SelectOnlyUpdatedIdsQueryPartSc(&self, #IncrementSc: &mut u64) -> Result<#string_ts, postgresql_crud::QueryPartErrorNamed> {
            ...
            let update_handle_ts = gen_from_handle_ts(&ident_update_ucc, &{
                let primary_key_field_type_as_postgresql_type_update_for_query_ts =
                    gen_as_postgresql_type_update_for_query_ts(&primary_key_field_type);
                let fields_named_without_primary_key_ts =
                    gen_fields_named_without_primary_key_with_comma_ts(
                        &|element: &macros_helpers::SynFieldWrapper| -> proc_macro2::TokenStream {
                            let field_ident = &element.field_ident;
                            let value_initialization_ts = gen_import_path_value_initialization_ts(
                                &{
                                    let field_type_as_postgresql_type_update_for_query_ts =
                                        gen_as_postgresql_type_update_for_query_ts(
                                            &element.field_type,
                                        );
                                    quote! {
                                         #field_type_as_postgresql_type_update_for_query_ts::from(value_0e64c53a.#ValueSc)
                                    }
                                },
                            );
                            quote! {
                ...
                quote! {
                    Self {
                        #primary_key_field_ident: #primary_key_field_type_as_postgresql_type_update_for_query_ts::from(#ValueSc.#primary_key_field_ident),
                        #fields_named_without_primary_key_ts
                    }
                }
            });
    ...
    let (
        ...
        let postgresql_crud_postgresql_type_where_filter_ts =
            quote! {#PostgresqlCrudSc::PostgresqlTypeWhereFilter::};
        (
            quote! {#postgresql_crud_postgresql_type_where_filter_ts #QueryPartSc},
            quote! {#postgresql_crud_postgresql_type_where_filter_ts #QueryBindSc},
        )
    };

    let std_vec_vec_struct_options_ident_ts =
        postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_read_ucc);
    ...
    let gen_additional_error_variants =
        |current_syn_derive_input: &syn::DeriveInput,
         gen_postgresql_table_attribute: GenPostgresqlTableAttribute|
         -> Vec<syn::Variant> {
            let gen_postgresql_table_attribute_str = gen_postgresql_table_attribute.to_string();
            let common_additional_error_variants_attribute_ts =
                macros_helpers::get_macro_attribute_meta_list_ts(
                    &current_syn_derive_input.attrs,
                    &gen_postgresql_table_attribute.gen_path_to_attribute(),
                );
            ...
            assert!(
                value_ident_str == gen_postgresql_table_attribute_str,
    ...
    let common_additional_error_variants = gen_additional_error_variants(
        &syn_derive_input,
        GenPostgresqlTableAttribute::CommonAdditionalErrorVariants,
    );
    ...
    let common_additional_logic_ts = macros_helpers::get_macro_attribute_meta_list_ts(
        &syn_derive_input.attrs,
        &GenPostgresqlTableAttribute::CommonAdditionalLogic.gen_path_to_attribute(),
    );
    ...
    let gen_fetch_ts = |executor_name_ts: &dyn quote::ToTokens,
        ...
        let content_ts = quote! {
            ...
            while let Some(value_d9cc2c36) = match #PostgresqlCrudSc::TryStreamExt::try_next(&mut #RowsSc).await {
    ...
    let gen_parameters_payload_and_default_ts =
        |operation: &Operation,
         ...
         default_init_content_ts: &dyn quote::ToTokens| {
            ...
            let impl_postgresql_crud_default_option_some_vec_one_el_for_operation_payload_ts =
                gen_impl_postgresql_crud_default_option_some_vec_one_el_for_tokens_no_lifetime_ts(
    ...
    let gen_type_variants_from_request_response_syn_variants =
        |syn_variants: &Vec<&syn::Variant>, operation: &Operation| -> Vec<syn::Variant> {
            ...
            for el_60533068 in gen_additional_error_variants(
                &syn_derive_input,
                operation.gen_postgresql_table_attribute_additional_error_variants(),
            ) {
    ...
    let std_sync_arc_combination_of_app_state_logic_traits_ts =
        quote! {std::sync::Arc<dyn #PostgresqlCrudSc::CombinationOfAppStateLogicTraits>};
     ...
     -> proc_macro2::TokenStream {
        ...
        let request_parts_preparation_ts = {
            ...
            quote! {
                ...
                //     }
                // }
                let body_bytes = match #PostgresqlCrudSc::check_body_size::check_body_size(#BodySc, *#AppStateSc.get_maximum_size_of_http_body_in_bytes()).await {
        ...
        let additional_validators_ts = {
            let operation_additional_logic_ts = macros_helpers::get_macro_attribute_meta_list_ts(
                &syn_derive_input.attrs,
                &operation
                    .gen_postgresql_table_attribute_additional_logic()
        ...
        |create_or_update_or_delete_one: &CreateOrUpdateOrDeleteOne| {
            ...
            wrap_into_value_ts(&gen_fetch_one_ts(
                ...
                &gen_sqlx_row_try_get_primary_key_ts(
                    &quote! {#primary_key_field_type_as_postgresql_type_read_ucc},
    ...
    let gen_operation_payload_example_ts = |operation: &Operation| {
        ...
        let wraped_into_axum_response_ts = wrap_into_axum_response_ts(
            &{
                let ident_operation_payload_ucc = gen_ident_operation_payload_ucc(operation);
                quote! {<#ident_operation_payload_ucc as postgresql_crud::#DefaultOptionSomeVecOneElUcc>::#DefaultOptionSomeVecOneElSc()}
            },
    ...
    let gen_select_only_ids_query_part_ts = |operation: &Operation| {
        let select_only_ids_query_part_initialization_ts = fields.iter().map(|element: &macros_helpers::SynFieldWrapper| {
            ...
            quote! {
                match #field_type_as_postgresql_crud_postgresql_type_postgresql_type_ts #SelectOnlyIdsQueryPartSc(#field_ident_double_quotes_ts) {
                    Ok(value_aa341baf) => {
    ...
    let gen_write_into_buffer_query_part_syn_variant_error_initialization_eprintln_response_creation_ts =
        |operation: &Operation| {
            let query_part_error_named_write_into_buffer_ts =
                postgresql_crud_macros_common::gen_query_part_error_named_write_into_buffer_ts(
                    import_path,
                );
    ...
    let create_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {(vec![#postgresql_crud_default_option_some_vec_one_el_call_ts])},
            ),
        );
        let operation_ts = {
                ...
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &std_vec_vec_ident_read_only_ids_ts, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    quote! {#PostgresqlCrudSc::gen_create_many_query_string(
                        #TableSc,
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.create_many_content_write_into_gen_postgresql_table_create_many,
        "gen_postgresql_table_create_many",
        &create_many_ts,
                ...
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &ident_read_only_ids_ucc, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    let select_only_ids_query_part_ts =
                        gen_select_only_ids_query_part_ts(&operation);
                    quote! {
                        #PostgresqlCrudSc::gen_create_one_query_string(
                            #TableSc,
                            #column_names_double_quotes_ts,
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.create_one_content_write_into_gen_postgresql_table_create_one,
        "gen_postgresql_table_create_one",
        &create_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let read_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {{
                    ...
                    pub #OrderBySc: #postgresql_crud_order_by_ts<#ident_select_ucc>,
                    pub #PaginationSc: postgresql_crud::PaginationStartsWithZero,
                }},
                &quote! {{
                    ...
                    #OrderBySc: postgresql_crud::OrderBy {
                    ...
                    #PaginationSc: #postgresql_crud_default_option_some_vec_one_el_call_ts,
                }},
            ),
        );
        let operation_ts = {
                ...
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &std_vec_vec_struct_options_ident_ts, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    quote! {#PostgresqlCrudSc::gen_read_many_query_string(
                        #TableSc,
                ...
                let binded_query_ts = {
                    let query_postgresql_type_where_filter_query_bind_parameters_payload_where_many_query_ts = gen_query_postgresql_type_where_filter_query_bind_parameters_payload_where_many_query_ts(&operation);
                    let postgresql_syn_variant_error_initialization_eprintln_response_creation_ts =
                        gen_operation_error_initialization_eprintln_response_creation_ts(
                            &operation,
                            &try_bind_syn_variant_wrapper,
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.read_many_content_write_into_gen_postgresql_table_read_many,
        "gen_postgresql_table_read_many",
        &read_many_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let read_one_ts = {
        ...
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts = gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &ident_read_ucc, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    quote! {#PostgresqlCrudSc::gen_read_one_query_string(
                        #TableSc,
                        &#select_query_part_parameters_payload_select_ts,
                        &match #postgresql_crud_postgresql_type_where_filter_query_part_ts(
                ...
                let binded_query_ts = {
                    let binded_query_modifications_ts = {
                        ...
                        quote! {
                            match #postgresql_crud_postgresql_type_where_filter_query_bind_ts(#ParametersSc.#PayloadSc.#primary_key_field_ident, #QuerySc) {
                                Ok(value_80ee6983) => {
                ...
                let postgresql_logic_ts = gen_fetch_one_ts(
                    &ExecutorAcquireSc,
                    &gen_match_ident_read_try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_ident_select_ts(&ReadManyOrReadOne::ReadOne),
                    &gen_operation_error_initialization_eprintln_response_creation_ts(&operation, &postgresql_syn_variant_wrapper, file!(), line!(), column!()),
                );
                impl_ident_vec_ts.push(gen_operation_ts(
                    &operation,
                    &common_additional_logic_ts,
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.read_one_content_write_into_gen_postgresql_table_read_one,
        "gen_postgresql_table_read_one",
        &read_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
        ...
        let parameters_ts = gen_parameters_pattern_ts(&operation, {
            ...
            let impl_serde_deserialize_for_ident_update_many_payload_ts = {
                ...
                let match_ident_update_many_payload_try_new_field0_ts =
                    postgresql_crud_macros_common::gen_match_try_new_in_deserialize_ts(
                        &ident_operation_payload_ucc,
                        &quote! {__field0},
                    );
                                ...
                                quote! {
                                    {
                                        ...
                                        if #is_field_ident_update_exists_sc {
                                            acc_b86a253a.push_str(&
                                                postgresql_crud::gen_column_equals_case_acc_else_column_end_comma_update_many_query_part(
                                                    #field_ident_double_quotes_ts,
                                                    &{
                                                        ...
                                                        for el_defbc401 in &#UpdateForQueryVecSc {
                                                            if let Some(value_3ea04126) = &el_defbc401.#field_ident {
                                                                acc_8ad06c8c.push_str(&#PostgresqlCrudSc::#gen_when_column_id_then_value_update_many_query_part_sc(
                                                                    Self::#PrimaryKeySc(),
                    ...
                    quote! {
                        {
                            ...
                            postgresql_crud::gen_update_many_query_string(
                                #TableSc,
                                &elements,
                                Self::#PrimaryKeySc(),
                                &primary_keys,
                ...
                let binded_query_ts = {
                                ...
                                quote! {
                                    for el_4b24f8f0 in &#UpdateForQueryVecSc {
                                        if let Some(value_2edaa480) = &el_4b24f8f0.#field_ident {
                                            ...
                                            match #as_postgresql_crud_postgresql_type_postgresql_type_ts #UpdateQueryBindSc(
                    ...
                    let primary_key_update_assignment_ts = quote! {
                        for el_323f7dfc in &#UpdateForQueryVecSc {
                            match #primary_key_field_type_as_postgresql_type_ts #UpdateQueryBindSc(
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.update_many_content_write_into_gen_postgresql_table_update_many,
        "gen_postgresql_table_update_many",
        &update_many_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let update_one_ts = {
                            ...
                            &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                quote! {
                                    if let Some(value_2d144436) = &#UpdateForQuerySc.#field_ident {
                                        acc_683e37b8.push_str(&#PostgresqlCrudSc::#gen_column_queals_value_comma_update_one_query_part_sc(
                                            #field_ident_double_quotes_ts,
                    ...
                    quote! {
                        {
                            ...
                            #PostgresqlCrudSc::gen_update_one_query_string(
                                #TableSc,
                                &#ColumnsSc,
                                Self::#PrimaryKeySc(),
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.update_one_content_write_into_gen_postgresql_table_update_one,
        "gen_postgresql_table_update_one",
        &update_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    ...
    let delete_many_ts = {
        ...
        let parameters_ts = gen_parameters_pattern_ts(
            ...
            gen_parameters_payload_and_default_ts(
                ...
                &quote! {{#where_many_postgresql_crud_default_option_some_vec_one_el_call_ts}},
            ),
        );
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &std_vec_vec_primary_key_field_type_read_ts, &type_variants_from_request_response_syn_variants);
            {
                ...
                let query_string_ts = {
                    ...
                    quote! {#PostgresqlCrudSc::gen_delete_many_query_string(
                        #TableSc,
                        &{
                            #increment_initialization_ts
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.delete_many_content_write_into_gen_postgresql_table_delete_many,
        "gen_postgresql_table_delete_many",
        &delete_many_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let delete_one_ts = {
        ...
        let operation_ts = {
            let try_operation_logic_response_variants_impl_std_convert_from_try_operation_logic_error_named_for_try_operation_logic_response_variants_try_operation_logic_error_named_ts =
                gen_ident_try_operation_logic_response_variants_ident_operation_error_named_convert_ts(&operation, &primary_key_field_type_as_postgresql_type_read_ucc, &type_variants_from_request_response_syn_variants);
            {
                let parameters_logic_ts = gen_parameters_logic_ts(&operation);
                let query_string_ts = quote! {#PostgresqlCrudSc::gen_delete_one_query_string(
                    #TableSc,
                    Self::#PrimaryKeySc(),
                )};
                let binded_query_ts = {
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.delete_one_content_write_into_gen_postgresql_table_delete_one,
        "gen_postgresql_table_delete_one",
        &delete_one_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    ...
    let ident_tests_ts = {
        ...
        let gen_some_postgresql_type_where_try_new_ts =
        ...
        let gen_some_postgresql_type_where_try_new_and_ts = |content_ts: &dyn quote::ToTokens| {
            gen_some_postgresql_type_where_try_new_ts(
                &quote! {#import_path::LogicalOperator::And},
                content_ts,
            )
        };
        let gen_postgresql_type_where_try_new_primary_key_content_ts = quote! {
            #import_path::PostgresqlTypeWhere::try_new(
                logical_operator,
                vec
        ...
        let gen_primary_key_field_type_as_postgresql_type_primary_key_method_call_ts =
        ...
        let primary_key_field_type_read_into_table_type_declaration_el_primary_key_field_ident_clone_ts =
            gen_primary_key_field_type_as_postgresql_type_primary_key_method_call_ts(
        ...
        let gen_read_only_ids_current_elements_ts = {
            ...
            quote! {
                async fn gen_read_only_ids_current_elements(
                    url: &str,
                    current_table: &str,
                    select_default_all_with_max_page_size: postgresql_crud::NotEmptyUniqueVec<#ident_select_ucc>,
                        ...
                        itertools::Itertools::sorted_by(
                            gen_try_read_many_order_by_primary_key_with_big_pagination(
                                ...
                                gen_ident_where_many_pripery_key_others_none(
                                    Some(
                                        gen_postgresql_type_where_try_new_primary_key(
        ...
        let create_many_tests_ts = {
            let create_many_tests_ts = gen_fields_named_without_primary_key_without_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    quote! {
                        for el_fce0969c in <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#OptionVecCreateSc().unwrap_or(Vec::new())
                            .chunks(10)
                            .map(Vec::from)
                        {
                                                    ...
                                                    postgresql_crud::LogicalOperator::Or,
                                                    {
                                                        ...
                                                        for el_bf356906 in &read_only_ids_from_try_create_many {
                                                            acc_1381c719.push(#primary_key_field_type_as_postgresql_type_where_ts::Equal(postgresql_crud::PostgresqlTypeWhereEqual {
                                                                ...
                                                                #ValueSc: #primary_key_field_type_table_type_declaration_ts::new(<#primary_key_field_type as postgresql_crud::PostgresqlType>::into_inner(
                                                                    #primary_key_field_type_read_only_ids_into_read_el_bf356906_primary_key_field_ident_ts
                                                                )),
                                                            }));
                                                        }
                                        ...
                                        #ident_delete_many_parameters_ucc {
                                            ...
                                            payload: #ident_delete_many_payload_ucc {
                                                where_many: #std_option_option_ident_where_many_ucc(Some(
                                                    #ident_where_many_ucc {
                                                        #primary_key_field_ident: Some(gen_postgresql_type_where_try_new_or_primary_keys(
        ...
        let create_one_tests_ts = {
            let create_one_tests_ts = gen_fields_named_without_primary_key_without_comma_ts(
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    quote! {
                        for el_7632d698 in <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#OptionVecCreateSc().unwrap_or(Vec::new()) {
        ...
        let add_create_one_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_ts =
            |content_ts: &dyn quote::ToTokens| {
                quote! {
                    ...
                    #content_ts
                    let _: #primary_key_field_type_as_postgresql_type_read_ts = gen_try_delete_one_handle(
                        &url_cloned,
                        #primary_key_field_type_read_only_ids_into_read_read_only_ids_from_try_create_one_primary_key_field_ident_ts,
                        &current_table
        ...
        let read_many_tests_ts = {
                            ...
                            #ident::try_delete_many_handle(
                                ...
                                #ident_delete_many_parameters_ucc {
                                    payload: #ident_delete_many_payload_ucc {
                                        where_many: #std_option_option_ident_where_many_ucc(Some(
                                            #ident_where_many_ucc {
                                                #primary_key_field_ident: Some(gen_postgresql_type_where_try_new_or_primary_keys(&read_only_ids_from_try_create_many)),
                                                #std_option_option_ident_where_many_content_ts
                                            }
                                        )),
                                    },
            ...
            let gen_option_vec_create_call_unwrap_or_vec_ts =
                |_: &syn::Ident, field_type: &syn::Type| {
                    quote! {
                        <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#OptionVecCreateSc().unwrap_or(Vec::new())
                    }
                };
            let gen_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_ts =
                |field_ident: &syn::Ident, field_type: &syn::Type| {
                    quote! {
                        <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#OptionVecCreateSc()
                        .filter(|el_bba28182| !el_bba28182.is_empty())
                        .unwrap_or_else(|| vec![ident_create_default.#field_ident.clone()])
                    }
                };
            let gen_postgresql_type_option_vec_where_greater_than_test_unwrap_or_else_vec_call_ts =
                |_: &syn::Ident, field_type: &syn::Type| {
                    quote! {
                        <#field_type as #import_path::PostgresqlTypeTestCases>::#PostgresqlTypeOptionVecWhereGreaterThanTestSc()
            ...
            let (
                ...
                let gen_test_read_many_by_equal_one_column_value_ts = |test_name: &str, equal_or_equal_using_fields: &postgresql_crud_macros_common::EqualOrEqualUsingFields| {
                    gen_read_test_ts(
                        test_name,
                                ...
                                if current_field_ident == primary_key_field_ident {
                                    ...
                                    let method_content_ts = {
                                        let method_ts: &dyn quote::ToTokens = match &equal_or_equal_using_fields {
                                            postgresql_crud_macros_common::EqualOrEqualUsingFields::Equal => &ReadOnlyIdsMergedWithCreateIntoWhereEqualSc,
                                            postgresql_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields => &ReadOnlyIdsMergedWithCreateIntoVecWhereEqualUsingFieldsSc
                                        };
                                        quote!{
                                    ...
                                    match &equal_or_equal_using_fields {
                                        postgresql_crud_macros_common::EqualOrEqualUsingFields::Equal => gen_some_postgresql_type_where_try_new_and_ts(&quote!{
                                            vec![#method_content_ts]
                                        }),
                                        postgresql_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields => quote!{
                ...
                (
                    gen_test_read_many_by_equal_one_column_value_ts(table_read_only_ids_merged_with_create_into_where_equal_name, &postgresql_crud_macros_common::EqualOrEqualUsingFields::Equal),
                    gen_test_read_many_by_equal_one_column_value_ts(table_read_only_ids_merged_with_create_into_vec_where_equal_using_fields_name, &postgresql_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields),
                )
            };
            let read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_ts = gen_read_test_ts(table_read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_name, &gen_option_vec_create_call_unwrap_or_vec_ts, &gen_ident_create_content_el_ts, &|element: &macros_helpers::SynFieldWrapper| {
                ...
                let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_97d8a089: &macros_helpers::SynFieldWrapper| {
                    ...
                    if current_field_ident == primary_key_field_ident {
                        ...
                        gen_some_postgresql_type_where_try_new_and_ts(&quote! {vec![el_48a3d976]})
                    } else {
                        none_ts.clone()
                    }
                }));
                quote! {
                    if let Some(value_d5cd3c70) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#ReadOnlyIdsMergedWithCreateIntoOptionVecWhereEqualToJsonFieldSc(
            ...
            let create_into_postgresql_type_option_vec_where_dimension_one_equal_ts =
                gen_read_test_ts(
                    ...
                    &|element: &macros_helpers::SynFieldWrapper| {
                                ...
                                &gen_fields_named_with_comma_ts(
                                    &|el_483e5312: &macros_helpers::SynFieldWrapper| {
                                        ...
                                        if primary_key_field_ident == current_field_ident {
                                            ...
                                            gen_some_postgresql_type_where_try_new_and_ts(
                        ...
                        quote! {
                            if let Some(value_b02d763d) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#CreateIntoPostgresqlTypeOptionVecWhereDimensionOneEqualSc(
                                ident_create.#field_ident.clone()
                            ) {
            ...
            let read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_greater_than_ts = gen_read_test_ts(
                table_read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_greater_than_name,
                &gen_postgresql_type_option_vec_where_greater_than_test_unwrap_or_else_vec_call_ts,
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    ...
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_a8bfc0c0: &macros_helpers::SynFieldWrapper| {
                        ...
                        if current_field_ident == primary_key_field_ident {
                            ...
                            gen_some_postgresql_type_where_try_new_and_ts(&quote! {vec![value_60baba1f]})
                        } else {
                            none_ts.clone()
                        }
                    }));
                    quote! {
                        if let Some(value_60baba1f) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#ReadOnlyIdsMergedWithTableTypeDeclarationIntoPostgresqlTypeOptionWhereGreaterThanSc(
                            #ElementSc.variant,
            ...
            let (
                ...
                let gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_ts =
                    |test_name: &str, dimension: &postgresql_crud_macros_common::Dimension| {
                        ...
                        let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_a9b23eca: &macros_helpers::SynFieldWrapper| {
                            ...
                            if current_field_ident == primary_key_field_ident {
                                ...
                                gen_some_postgresql_type_where_try_new_and_ts(&quote! {vec![el_3efa0bb4]})
                            } else {
                                none_ts.clone()
                            }
                        }));
                        quote! {
                            if let Some(value_bb67b871) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc(
                ...
                (
                    gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_one_equal_name, &postgresql_crud_macros_common::Dimension::One),
                    gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_two_equal_name, &postgresql_crud_macros_common::Dimension::Two),
                    gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_three_equal_name, &postgresql_crud_macros_common::Dimension::Three),
                    gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_ts(table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_four_equal_name, &postgresql_crud_macros_common::Dimension::Four),
                )
            };
            let create_into_postgresql_json_type_option_vec_where_length_equal_ts = gen_read_test_ts(
                table_create_into_postgresql_json_type_option_vec_where_length_equal_name,
                ...
                &|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
                    let field_type = &element.field_type;
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(&gen_fields_named_with_comma_ts(&|el_94f00070: &macros_helpers::SynFieldWrapper| {
                        let current_field_ident = &el_94f00070.field_ident;
                        if current_field_ident == primary_key_field_ident {
                            some_primary_key_where_initialization_ts.clone()
                        } else if current_field_ident == field_ident {
                            gen_some_postgresql_type_where_try_new_and_ts(&quote! {vec![el_c09ef321]})
                        } else {
                            none_ts.clone()
                        }
                    }));
                    quote! {
                        if let Some(value_f825e068) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#CreateIntoPostgresqlJsonTypeOptionVecWhereLengthEqualSc(
                            ident_create.#field_ident.clone()
                        ) {
            ...
            let create_into_postgresql_json_type_option_vec_where_length_greater_than_ts = gen_read_test_ts(
                table_create_into_postgresql_json_type_option_vec_where_length_greater_than_name,
                &gen_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_ts,
                &gen_ident_create_content_el_ts,
                &|element: &macros_helpers::SynFieldWrapper|{
                    ...
                    let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(
                        &gen_fields_named_with_comma_ts(&|el_c927ab80: &macros_helpers::SynFieldWrapper|{
                            ...
                            if current_field_ident == primary_key_field_ident {
                                ...
                                gen_some_postgresql_type_where_try_new_and_ts(&quote!{vec![el_527b546b]})
                            } else {
                                none_ts.clone()
                            }
                        })
                    ...
                    quote!{
                        if let Some(value_cd4aa374) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#CreateIntoPostgresqlJsonTypeOptionVecWhereLengthGreaterThanSc(
                            ident_create.#field_ident.clone()
                        ) {
            ...
            let (
                ...
                let gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts =
                        ...
                        let assert_eq_ts = gen_read_only_ids_merged_with_create_into_where_assert_eq_ts(
                            &gen_fields_named_with_comma_ts(&|el_16b8a9cc: &macros_helpers::SynFieldWrapper|{
                                ...
                                if current_field_ident == primary_key_field_ident {
                                    ...
                                    gen_some_postgresql_type_where_try_new_and_ts(&quote!{match el_feacc53b {
                        ...
                        let ident_read_only_ids_upper_fields_initialization_without_primary_key_ts =
                            gen_fields_named_without_primary_key_with_comma_ts(
                                &|syn_field_wrapper: &macros_helpers::SynFieldWrapper| {
                                    ...
                                    let current_field_type = &syn_field_wrapper.field_type;
                                    if field_ident == current_field_ident {
                                        quote! {#current_field_ident: Some(<#current_field_type as postgresql_crud::PostgresqlTypeTestCases>::update_to_read_only_ids(&update))}
                                    } else {
                    ...
                    futures::FutureExt::boxed(async move {
                        if let Err(#ErrorSc) = gen_try_delete_one_handle(
                            ...
                            if let #ident_try_delete_one_error_named_ucc::#ident_delete_one_error_named_with_serialize_deserialize_ucc {
                                ...
                                if let #ident_delete_one_error_named_with_serialize_deserialize_ucc::Postgresql {
                                    postgresql,
                                    ..
                                } = delete_one_error_named_with_serialize_deserialize {
        ...
        quote! {
            ...
            mod #ident_tests_sc {
                ...
                fn crud() {
                    ...
                    fn gen_postgresql_type_where_try_new_primary_key(
                        ...
                        #gen_postgresql_type_where_try_new_primary_key_content_ts
                    }
                    fn gen_postgresql_type_where_try_new_or_primary_keys(
                    ...
                    async fn gen_check_no_rows_returned_from_ident_try_read_one_handle_primary_key(
                        ...
                        if let Err(#ErrorSc) = gen_ident_try_read_one_handle_primary_key(
                            ...
                            if let #ident_try_read_one_error_named_ucc::#ident_read_one_error_named_with_serialize_deserialize_ucc {
                                ...
                                if let #ident_read_one_error_named_with_serialize_deserialize_ucc::Postgresql { postgresql, .. } = read_one_error_named_with_serialize_deserialize {
                    ...
                    async fn gen_try_delete_one_handle(
                        ...
                        table: &str,
                    ) -> Result<#primary_key_field_type_as_postgresql_type_read_ts, #ident_try_delete_one_error_named_ucc> {
                    ...
                    tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                        ...
                        let #SelectPrimaryKeySc = postgresql_crud::NotEmptyUniqueVec::try_new(vec![
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.tests_content_write_into_gen_postgresql_table_tests,
        "gen_postgresql_table_Tests",
        &ident_tests_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let common_ts = quote! {
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.common_content_write_into_gen_postgresql_table_common,
        "gen_postgresql_table_common",
        &common_ts,
        &macros_helpers::FormatWithCargofmt::True,
    );
    let gend = {
        let ident_gen_postgresql_table_mod_sc = SelfGenPostgresqlTableModSc::from_tokens(&ident);
        ...
        quote! {
            #[allow(unused_qualifications)]
            #[allow(clippy::absolute_paths)]
            mod #ident_gen_postgresql_table_mod_sc {
                use super::#ident;
                #content_ts_1c0e3fcd
            }
            pub use #ident_gen_postgresql_table_mod_sc::*;
        }
    };
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_table_config.whole_content_write_into_gen_postgresql_table,
        "gen_postgresql_table",
        &gend,
        &macros_helpers::FormatWithCargofmt::True,
    );
    gend
