...
pub fn generate_postgresql_table(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let ident_tests_token_stream = {
        ...
        let read_many_token_stream = {
            ...
            let read_only_ids_returned_from_create_one_content_token_stream = quote::quote!{
            ...
            let delete_many_after_where_element_test_token_stream = quote::quote!{
                let read_only_ids_from_try_delete_many = {
                    let mut #acc_snake_case = super::#ident::try_delete_many(
                        &url_cloned,
                        super::#ident_delete_many_parameters_upper_camel_case {
                        ...
                        quote::quote!{
                            for #element_snake_case in <#field_type as postgresql_crud::PostgresqlTypeTestCases>::vec_create() {
                                ...
                                #acc_snake_case.push(futures::FutureExt::boxed(async move {
                                    ...
                                    #read_only_ids_returned_from_create_one_content_token_stream
                                    assert_eq!(
                                        vec![
                                            super::#ident_read_upper_camel_case {
                                                #primary_key_field_ident: <
                                    ...
                                    #delete_many_after_where_element_test_token_stream
                                }));
                            }
                        }
                    }))
