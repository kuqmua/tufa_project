...
pub fn generate_postgresql_table(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
                    ...
                    quote::quote! {
                        #field_ident: match #value_snake_case.#field_ident {
                            Some(#value_snake_case) => Some(postgresql_crud::Value {
                                #value_snake_case: #field_type_as_postgresql_type_update_for_query_token_stream::from(#value_snake_case.#value_snake_case)
                            }),
                            None => None
                        }
                    }
    ...
    let ident_tests_token_stream = {
        ...
        let (
            select_default_all_not_empty_unique_enum_vec_token_stream,
            ...
            let generate_select_default_token_stream = |default_some_one_or_default_some_one_with_max_page_size: &postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize|{
                let (
                    ...
                    postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne => (
                        &quote::quote!{select_default_all},//todo name use naming?
                        &"70f3e400-eef6-4e3e-8098-85dcd148e282"
                    ),
                    postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize => (
                        &quote::quote!{select_default_all_with_max_page_size},//todo name use naming?
                        &"8f42ee4f-00d9-4b67-8ead-adddf5bcdf94"
                    ),
                };
                let content_token_stream = generate_fields_named_with_comma_token_stream(&|element: &SynFieldWrapper|{
                    ...
                    let (
                        ...
                        postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize => (
                            &naming::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSizeUpperCamelCase,
                ...
                let warning_message_double_quote_token_stream = generate_quotes::double_quotes_token_stream(&format!("error {id}"));
                quote::quote! {
                    let #name_token_stream = postgresql_crud::NotEmptyUniqueEnumVec::try_new(vec![
                        #content_token_stream
                    ]).expect(#warning_message_double_quote_token_stream);
                }
            };
            (
                generate_select_default_token_stream(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne),
                generate_select_default_token_stream(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize)
            )
        };
        let create_many_tests_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
            ...
            let ident_create_content_token_stream = generate_fields_named_without_primary_key_with_comma_token_stream(&|element: &SynFieldWrapper| {
                ...
                if field_ident == current_field_ident {
                    quote::quote! {
                        #current_field_ident: #element_snake_case
                    }
                } else {
                    quote::quote! {
                        #current_field_ident: <
                    ...
                    .collect::<std::vec::Vec<std::vec::Vec<#field_type_as_postgresql_type_create_token_stream>>>()
                {
                    ...
                    #acc_snake_case.push(futures::FutureExt::boxed(async move {
                        ...
                        let read_only_ids_from_try_create_many = super::#ident::try_create_many(&url_cloned, super::#ident_create_many_parameters_upper_camel_case {
                            #payload_snake_case: super::#ident_create_many_payload_upper_camel_case(ident_create_vec.clone())
                        ...
                        assert_eq!(
                            {
                                ...
                                for (read_only_ids, create) in read_only_ids_from_try_create_many.clone().into_iter().zip(ident_create_vec.into_iter()).collect::<std::vec::Vec<(super::#ident_read_only_ids_upper_camel_case, super::#ident_create_upper_camel_case)>>() {
                                                    ...
                                                    postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                        ...
                                                        for #element_snake_case in &read_only_ids_from_try_create_many {
                                                            #acc_snake_case.push(#primary_key_field_type_as_postgresql_type_where_element_token_stream::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                ...
                                                                #value_snake_case: #primary_key_field_type_origin_token_stream::new(<#primary_key_field_type as postgresql_crud::PostgresqlType>::into_inner(#element_snake_case.#primary_key_field_ident.clone().into_read())),
                                                            }));
                                                        }
                                                        #acc_snake_case
                                                    })
                        ...
                        let read_only_ids_from_try_delete_many = {
                            let mut #acc_snake_case = super::#ident::try_delete_many(
                                &url_cloned,
                        ...
                        assert_eq!(
                            read_only_ids_from_try_delete_many,
                            {
                                let mut #acc_snake_case = read_only_ids_from_try_create_many.into_iter().map(|element|
                                    #element_snake_case.#primary_key_field_ident.clone().into_read()
                                            ...
                                            Some(
                                                postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::Or, {
                                                    ...
                                                    for #element_snake_case in &read_only_ids_from_try_delete_many {
                                                        #acc_snake_case.push(#primary_key_field_type_where_element_token_stream::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                            logical_operator: postgresql_crud::LogicalOperator::Or,
                                                            #value_snake_case: #primary_key_field_type_origin_token_stream::new(<#primary_key_field_type as postgresql_crud::PostgresqlType>::into_inner(#element_snake_case.clone())),
                                                        }));
                                                    }
                                                    #acc_snake_case
                                                })
                    ...
                    #acc_snake_case.push(futures::FutureExt::boxed(async move {
                        ...
                        assert_eq!(
                            super::#ident_read_upper_camel_case {
                                #primary_key_field_ident: Some(postgresql_crud::Value {
                                    #value_snake_case: read_only_ids_from_try_create_one.#primary_key_field_ident.clone().into_read()
                                }),
                                #ident_read_content_token_stream
                            },
                            super::#ident::try_read_one(
                                ...
                                super::#ident_read_one_parameters_upper_camel_case {
                                    #payload_snake_case: super::#ident_read_one_payload_upper_camel_case {
                                        ...
                                        #select_snake_case: select_default_all_cloned.clone()
                                    }
                                }
                            )
                            .await
                        ...
                        if let Err(#error_snake_case) = super::#ident::try_read_one(
                            ...
                            super::#ident_read_one_parameters_upper_camel_case {
                                #payload_snake_case: super::#ident_read_one_payload_upper_camel_case {
                                    #primary_key_field_ident: read_only_ids_from_try_create_one.#primary_key_field_ident.clone().into_read(),
                                    #select_snake_case: select_default_all_cloned
                                }
                            }
                        )
                        .await {
                ...
                if field_ident == current_field_ident {
                    quote::quote! {
                        #current_field_ident: Some(postgresql_crud::Value {
                            #value_snake_case: <#current_field_type as postgresql_crud::PostgresqlTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(
            ...
            quote::quote! {
                {
                    let read_inner_vec_vec_acc = {
                        let mut #acc_snake_case = vec![];
                        #ident_create_defaults_for_column_read_inner_vec_vec_token_stream
                        #acc_snake_case
                    };
                                                                    ...
                                                                    #acc_snake_case.push(#primary_key_field_type_where_element_token_stream::Equal(
                                                                        postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                            ...
                                                                            #value_snake_case: #primary_key_field_type_origin_token_stream::new(
                                                                                <#primary_key_field_type as postgresql_crud::PostgresqlType>::into_inner(#element_snake_case.#primary_key_field_ident.clone().into_read())
                                                                            ),
                                                                        }
                                                                    ));
                                                                }
                                                    ...
                                                    where_many: super::#std_option_option_ident_where_many_upper_camel_case(Some(super::#ident_where_many_upper_camel_case {
                                                        #primary_key_field_ident: Some(postgresql_crud::PostgresqlTypeWhere::try_new(
                                                            postgresql_crud::LogicalOperator::Or,
                                                            {
                                                                ...
                                                                #acc_snake_case.push(#primary_key_field_type_where_element_token_stream::Equal(postgresql_crud::PostgresqlTypeWhereElementEqual {
                                                                    logical_operator: postgresql_crud::LogicalOperator::Or,
                                                                    #value_snake_case: #primary_key_field_type_origin_token_stream::new(<#primary_key_field_type as postgresql_crud::PostgresqlType>::into_inner(read_only_ids_current_element.#primary_key_field_ident.clone().into_read())),
                                                                }));
                                                                #acc_snake_case
                                                            }
                                                        ).expect("error 5f1e5f9d-d189-4368-807e-a84348967610")),
        ...
        let delete_one_token_stream = {
            ...
            quote::quote!{
                ...
                let read_only_ids_returned_from_create_one = super::#ident::try_create_one(
                    &url,
                ...
                assert_eq!(
                    super::#ident_read_upper_camel_case {
                        #primary_key_field_ident: Some(postgresql_crud::Value {
                            #value_snake_case: read_only_ids_returned_from_create_one.#primary_key_field_ident.clone().into_read()
                        }),
                        #ident_read_content_token_stream
                    },
                    super::#ident::try_read_one(
                ...
                if let Err(#error_snake_case) = super::#ident::try_read_one(
                    ...
                    super::#ident_read_one_parameters_upper_camel_case {
                        payload: super::#ident_read_one_payload_upper_camel_case {
                            #primary_key_field_ident: read_only_ids_returned_from_create_one.#primary_key_field_ident.clone().into_read(),
                            select: select_default_all.clone()
                        }
                    }
                ).await {
                    ...
                    std::thread::Builder::new()
                        ...
                        .spawn(|| {
                            tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                                ...
                                //     ),
                                //     "error 5904b29a-b9f5-44ae-86b1-ebb9ae1fb4d4"
                                // );

                                //update part start
                                // #columns_read_inner_vec_vec_declaration_token_stream
                                // #columns_read_inner_vec_vec_updates_token_stream

                                // for #index_snake_case in #read_inner_vec_vec_max_len_token_stream {
                                ...
                                //     //         #value_snake_case
                                //     //     },
                                //     //     "error 92ab0eca-b51f-4ae3-a746-e714885c9b33"
                                //     // );
                                ...
                                //     //     ),
                                //     //     "error 3fcb8bab-3bf0-4365-90c4-f70fea5932f1"
                                //     // );
                                //     assert_eq!(
                                //         super::#ident_read_only_ids_upper_camel_case {
                                //             #primary_key_field_ident: #read_only_ids_returned_from_create_one_snake_case.#primary_key_field_ident.clone(),
                                ...
                                //         "error b85441d0-f1f0-4e12-b8f0-6513730e5988"
                                //     );
                                //     // assert_eq!(
                                //     //     super::#ident_read_upper_camel_case {
                                ...
                                //     //     .await
                                //     //     .expect("error 770fc785-f87a-42b0-a0c7-d08291f65293"),
                                //     //     "error fc6c0ac4-a288-44e2-9d3f-69562fa8d350"
                                //     // );
                                ...
                                //         #value_snake_case
                                //     },
                                //     "error 5b13cdae-704d-43ca-8284-b03990778baa"
                                // );
                                // assert_eq!(
                                ...
                                //     "error 6a962bc3-d188-450f-903a-8cdd07dd08e2"
                                // );
                                ...
                                // assert_eq!(#read_only_ids_returned_from_create_one_snake_case.clone(), primary_key_returned_from_delete_one, "error 43365e95-67ed-4102-a535-91655ffa7f53");
                                // if let Err(#error_snake_case) = super::#ident::try_read_one(
                                //     &#url_snake_case,
                                //     super::#ident_read_one_parameters_upper_camel_case {
                                //         #payload_snake_case: super::#ident_read_one_payload_upper_camel_case {
