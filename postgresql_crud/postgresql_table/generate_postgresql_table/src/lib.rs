...
pub fn generate_postgresql_table(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let ident_tests_token_stream = {
        ...
        let generate_ident_create_content_token_stream = |field_ident: &syn::Ident|generate_fields_named_without_primary_key_with_comma_token_stream(&|element: &SynFieldWrapper| {
            let current_field_ident = &element.field_ident;
            let current_field_type = &element.syn_field.ty;
        ...
        let read_many_token_stream = {
                    ...
                    let generate_test_read_many_by_equal_to_created_primary_keys = async |length: std::primitive::usize| {
                        ...
                        let read_only_ids_from_try_create_many = super::#ident::try_create_many(
                            ...
                            super::#ident_create_many_parameters_upper_camel_case {
                                payload: super::#ident_create_many_payload_upper_camel_case(ident_create_vec.clone())
                            }
                        ...
                        assert_eq!(
                            {
                                ...
                                for (read_only_ids, create) in read_only_ids_from_try_create_many.clone()
                                    .into_iter()
                                    .zip(ident_create_vec.into_iter())
            ...
            let (
                test_read_many_by_equal_one_column_value_token_stream,
                test_read_many_by_equal_using_fields_one_column_value_token_stream
            ) = {
                let generate_test_read_many_by_equal_one_column_value_token_stream = |equal_or_equal_using_fields: &postgresql_crud_macros_common::EqualOrEqualUsingFields|{
                    let method_name_token_stream: &dyn quote::ToTokens = match &equal_or_equal_using_fields {
                        postgresql_crud_macros_common::EqualOrEqualUsingFields::Equal => &read_only_ids_merged_with_create_into_where_element_equal_snake_case,
                        postgresql_crud_macros_common::EqualOrEqualUsingFields::EqualUsingFields => &read_only_ids_merged_with_create_into_where_element_equal_using_fields_snake_case,
                    };
                    let update_many_only_one_column_tests_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
                        ...
                        let field_type = &element.syn_field.ty;
                        let ident_create_content_token_stream = generate_ident_create_content_token_stream(&field_ident);
                        let ident_where_many_try_new_parameters_content_token_stream = generate_fields_named_with_comma_token_stream(&|element: &SynFieldWrapper|{
                            let current_field_ident = &element.field_ident;
                            let current_field_type = &element.syn_field.ty;
                            if field_ident == current_field_ident {
                                quote::quote! {
                                    Some(
                                        postgresql_crud::PostgresqlTypeWhere::try_new(
                                            postgresql_crud::LogicalOperator::Or,
                                            <#current_field_type as postgresql_crud::PostgresqlTypeTestCases>::#method_name_token_stream(
