    ...
    let ident_tests_token_stream = {
        ...
        let mut fill_table_field_idents_vec_token_stream = |test_names: Vec<&str>| {
            for test_name in test_names {
                ...
                table_field_idents_initialization_vec_token_stream.push(generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &macros_helpers::SynFieldWrapper| {
                    let field_ident = &element.field_ident;
        ...
        let table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_name = "35a01678_f7e2_482d_9803_c3b5a23d36ad";
                                ...
                                .map(Vec::from)
                            {
                                ...
                                #acc_snake_case.push(futures::FutureExt::boxed(async move {
                                    ...
                                    match generate_try_read_many_order_by_primary_key_with_big_pagination(
                                        ...
                                        Ok(ok_value) => assert!(ok_value == Vec::new(), "4e88679a-0d23-418f-8767-4e9b7531429c"),
        ...
        let read_many_tests_token_stream = {
                ...
                let content_token_stream = add_create_one_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_token_stream(&{
                    quote::quote! {
                        match generate_try_read_many_order_by_primary_key_with_big_pagination(
                            ...
                            Ok(ok_value) => assert!(ok_value.is_empty(), "06df4025-e2d1-4128-b819-c06613c6ae3f"),
                            Err(#error_snake_case) => {
                ...
                let content_token_stream = add_create_one_default_and_delete_after_just_to_add_some_data_to_be_sure_it_will_not_return_from_the_test_query_token_stream(&{
                    quote::quote! {
                        ...
                        match generate_try_read_many_order_by_primary_key_with_big_pagination(
                            ...
                            Ok(ok_value) => assert!(ok_value == Vec::new(), "d79c0af3-5e2e-4891-a7ff-d1007b573e77"),
                            Err(#error_snake_case) => {
                                ...
                                for #element_snake_case in #method_call_token_stream {
                                    ...
                                    #acc_snake_case.push(futures::FutureExt::boxed(async move {
                                        ...
                                        match generate_try_read_many_order_by_primary_key_with_big_pagination(
                                            ...
                                            Ok(ok_value) => assert!(ok_value == Vec::new(), "38187925-c136-41de-940d-eba75efc3a39"),
                                            Err(#error_snake_case) => {
            ...
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_token_stream = generate_read_test_token_stream(
                table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_name,
                &generate_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_token_stream,
                &generate_ident_create_content_element_token_stream,
                &|element: &macros_helpers::SynFieldWrapper|{
                    ...
                    let assert_eq_token_stream = generate_read_only_ids_merged_with_create_into_where_assert_eq_token_stream(
                        &generate_fields_named_with_comma_token_stream(&|current_element: &macros_helpers::SynFieldWrapper|{
                            ...
                            if current_field_ident == primary_key_field_ident {
                                ...
                                generate_some_postgresql_type_where_try_new_and_token_stream(&quote::quote!{{
                                    let mut acc0 = vec![];
                                    match element {
                                        ...
                                        #import_path::SingleOrMultiple::Multiple(multiple) => {
                                            for element0 in multiple.into_vec() {
                                                acc0.push(element0);
                                            }
                                        }
                                    }
                    ...
                    quote::quote!{
                        if let Some(some_value) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_snake_case(
                                        ...
                                        assert_eq!(
                                            ...
                                            },
                                            {
                                                let mut #acc_snake_case = generate_try_read_many_order_by_primary_key_with_big_pagination(
                                                    ...
                                                    select_default_all_with_max_page_size_cloned,
                                                    &current_table
                                                ).await.expect("25c561e2-6b39-4982-8fe7-4473d12b3271");
                                                #acc_snake_case.sort_by(|first, second| {
                                                    if let (Some(value_first), Some(value_second)) = (&first.#primary_key_field_ident, &second.#primary_key_field_ident) {
                                                        value_first.#value_snake_case.cmp(&value_second.#value_snake_case)
                                                    } else {
                                ...
                                assert_eq!(
                                    ...
                                    },
                                    {
                                        let mut #acc_snake_case = generate_try_read_many_order_by_primary_key_with_big_pagination(
                                            ...
                                            #select_default_all_with_max_page_size_clone_token_stream,
                                            &current_table
                                        ).await.expect("f5eeb8b7-85f1-406b-85e2-b8c409bd77d1");
                                        #acc_snake_case.sort_by(|first, second| {
                                            if let (Some(value_first), Some(value_second)) = (&first.#primary_key_field_ident, &second.#primary_key_field_ident) {
                                                value_first.#value_snake_case.cmp(&value_second.#value_snake_case)
                                            }
