...
pub fn generate_postgresql_table(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_operation_error_initialization_eprintln_response_creation_token_stream = |operation: &Operation, syn_variant_wrapper: &SynVariantWrapper, file: &'static str, line: u32, column: u32| {
        ...
        let wraped_into_axum_response_token_stream = wrap_into_axum_response_token_stream(&quote::quote! {#ident_operation_response_variants_upper_camel_case::#from_snake_case(#error_snake_case)}, &status_code_token_stream, &ShouldAddReturn::True);
        quote::quote! {
    ...
    let ident_read_only_ids_token_stream = {
        ...
        let impl_try_from_pg_row_for_ident_read_only_ids_token_stream = macros_helpers::generate_impl_std_convert_try_from_token_stream::generate_impl_std_convert_try_from_token_stream(&quote::quote! {sqlx::postgres::PgRow}, &ident_read_only_ids_upper_camel_case, &quote::quote! {sqlx::Error}, &{
    ...
    let ident_update_for_query_token_stream = {
        ...
        let impl_std_convert_from_for_ident_update_for_query_token_stream = macros_helpers::generate_impl_std_convert_from_token_stream::generate_impl_std_convert_from_token_stream(&ident_update_upper_camel_case, &ident_update_for_query_upper_camel_case, &{
    ...
    let ident_tests_token_stream = {
                ...
                table_field_idents_routes_handle_vec_token_stream.push(generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
                    ...
                    quote::quote! {
                        .merge(#ident::#routes_handle_snake_case(
                            std::sync::Arc::<crate::server_app_state::ServerAppState<'_>>::clone(&#app_state_snake_case),
        ...
        let read_many_token_stream = {
            ...
            let generate_postgresql_type_where_try_new_and_token_stream = |content_token_stream: &dyn quote::ToTokens| {
                quote::quote! {
                    Some(
                    ...
                    .spawn(|| {
                        tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                            ...
                            let #underscore_unused_token_stream = tokio::spawn(async move {
                                ...
                                let #app_state_snake_case = std::sync::Arc::new(crate::server_app_state::ServerAppState {
