...
pub fn generate_postgresql_table(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let ident_update_for_query_token_stream = {
        ...
        let impl_std_convert_from_for_ident_update_for_query_token_stream = macros_helpers::generate_impl_std_convert_from_token_stream::generate_impl_std_convert_from_token_stream(
            &ident_update_upper_camel_case,
        ...
        quote::quote!{
            ...
            #impl_std_convert_from_for_ident_update_for_query_token_stream
        }
    };
            ...
            let operation_token_stream = {
                let parameters_logic_token_stream = {
                    ...
                    quote::quote!{
                        ...
                        .map(|#element_snake_case|#ident_update_for_query_upper_camel_case::from(#element_snake_case))
                        .collect::<std::vec::Vec<#ident_update_for_query_upper_camel_case>>();
                    }
                };
                let query_string_token_stream = {
                    let query_part_syn_variant_error_initialization_eprintln_response_creation_token_stream = generate_operation_error_initialization_eprintln_response_creation_token_stream(&operation, &query_part_syn_variant_wrapper, file!(), line!(), column!());
        ...
        let operation_token_stream = {
            ...
            let operation_token_stream = {
                let parameters_logic_token_stream = {
                    ...
                    quote::quote!{
                        #parameters_logic_token_stream
                        let #update_for_query_snake_case = #ident_update_for_query_upper_camel_case::from(#parameters_snake_case.#payload_snake_case);
                    }
                };
                let query_string_token_stream = {
                ...
                let binded_query_token_stream = {
                    ...
                    let binded_query_modifications_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
                        ...
                        let as_postgresql_crud_postgresql_type_postgresql_type_token_stream = generate_as_postgresql_type_token_stream(&element.syn_field.ty);
                        quote::quote! {
                            if let Some(ref #value_snake_case) = #update_for_query_snake_case.#field_ident {
                                match #as_postgresql_crud_postgresql_type_postgresql_type_token_stream #update_query_bind_snake_case(
                        ...
                        .route(#slash_create_many_double_quotes_token_stream, axum::routing::post(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    ...
                                    async move {
                                        #ident::#create_many_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_create_one_double_quotes_token_stream, axum::routing::post(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#create_one_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_read_many_double_quotes_token_stream, axum::routing::post(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#read_many_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_read_one_double_quotes_token_stream, axum::routing::post(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#read_one_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_update_many_double_quotes_token_stream, axum::routing::patch(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#update_many_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_update_one_double_quotes_token_stream, axum::routing::patch(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#update_one_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_delete_many_double_quotes_token_stream, axum::routing::delete(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#delete_many_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
                        ...
                        .route(#slash_delete_one_double_quotes_token_stream, axum::routing::delete(
                            {
                                ...
                                move |app_state: axum::extract::State<std::sync::Arc<dyn postgresql_crud::CombinationOfAppStateLogicTraits>>, request: axum::extract::Request| {
                                    let table = table.clone();
                                    async move {
                                        #ident::#delete_one_snake_case_token_stream(app_state, request, &table).await
                                    }
                                }
                            }
                        ))
    ...
    let ident_tests_token_stream = {
        ...
        let select_default_all_with_max_page_size_not_empty_unique_enum_vec_token_stream = {
            ...
            let warning_message_double_quote_token_stream = generate_quotes::double_quotes_token_stream(&format!("error 8f42ee4f-00d9-4b67-8ead-adddf5bcdf94"));
            quote::quote! {
        ...
        let primary_key_field_type_read_into_table_type_declaration_element_primary_key_field_ident_clone_token_stream = generate_primary_key_field_type_as_postgresql_type_primary_key_method_call_token_stream(
            &read_into_table_type_declaration_snake_case,
            &element_snake_case
        );
        let primary_key_field_type_read_only_ids_into_table_type_declaration_element_primary_key_field_ident_clone_token_stream = generate_primary_key_field_type_as_postgresql_type_primary_key_method_call_token_stream(
        ...
        let (
            ...
            let generate_read_only_ids_into_read_token_stream = |content_token_stream: &dyn quote::ToTokens|generate_primary_key_field_type_as_postgresql_type_primary_key_method_call_token_stream(
        ...
        let primary_key_field_type_as_postgresql_type_update_as_postgresql_type_primary_key_read_only_ids_into_update_token_stream = {
            let method_call_token_stream = generate_primary_key_field_type_as_postgresql_type_primary_key_method_call_token_stream(
        ...
        let generate_ident_create_content_element_token_stream = |field_ident: &syn::Ident|generate_ident_create_content_token_stream(
            field_ident,
            &element_snake_case,
        );
        let generate_ident_create_content_element_create_token_stream = |field_ident: &syn::Ident|generate_ident_create_content_token_stream(
            &field_ident,
        ...
        let table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal_name = "1f388ef8_dc28_489d_bed9_ca4e7f640dd5";
        let table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal_name = "581c947f_9b0f_452f_8e52_524088bbb2e7";
        let table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal_name = "de556c26_9297_4adb_9483_22d474cf1e7d";
        let table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal_name = "35b26a97_abdd_4cf9_b4e5_aa9b47aa1a0d";
        let table_create_into_postgresql_json_type_option_vec_where_element_length_equal_name = "1ce53b67_1e94_413e_83cf_c6d7094289a8";
        let table_create_into_postgresql_json_type_option_vec_where_element_length_greater_than_name = "6b6bdfe0_c7b8_43fd_ac2e_854a47c0b64c";
        ...
        fill_table_field_idents_vec_token_stream(vec![
            ...
            &table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal_name,
            &table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal_name,
            &table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal_name,
            &table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal_name,
            &table_create_into_postgresql_json_type_option_vec_where_element_length_equal_name,
            &table_create_into_postgresql_json_type_option_vec_where_element_length_greater_than_name,
        ]);
        let create_many_token_stream = {
                        ...
                        #acc_snake_case.push(futures::FutureExt::boxed(async move {
                            let ident_vec_create = {
                                ...
                                for #element_snake_case in chunk {
                                    #acc_snake_case.push(super::#ident_create_upper_camel_case {
                            ...
                            assert_eq!(
                                ...
                                super::#ident::try_read_many_handle(
                                    &url_cloned,
                            ...
                            let read_only_ids_from_try_delete_many = {
                                let mut #acc_snake_case = super::#ident::try_delete_many_handle(
                                    &url_cloned,
                    ...
                    for #element_snake_case in <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#option_vec_create_snake_case().unwrap_or(vec![]) {
                        ...
                        #acc_snake_case.push(futures::FutureExt::boxed(async move {
                            ...
                            assert_eq!(
                                ...
                                super::#ident::try_read_one_handle(
                                    &url_cloned,
                                    super::#ident_read_one_parameters_upper_camel_case {
                                        #payload_snake_case: super::#ident_read_one_payload_upper_camel_case {
        ...
        let read_many_token_stream = {
                    ...
                    quote::quote!{{
                        ...
                        for #element_snake_case in #method_call_token_stream {
                            ...
                            #acc_snake_case.push(futures::FutureExt::boxed(async move {
                                ...
                                let read_only_ids_returned_from_create_one = super::#ident::try_create_one_handle(
                                    &url_cloned,
                                    super::#ident_create_one_parameters_upper_camel_case {
                                        payload: ident_create.clone()
                                    },
            ...
            let read_only_ids_merged_with_create_into_option_vec_where_element_equal_to_json_field_token_stream = generate_read_test_token_stream(
                ...
                &|element: &SynFieldWrapper|{
                    ...
                    quote::quote!{
                        if let Some(#value_snake_case) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#read_only_ids_merged_with_create_into_option_vec_where_element_equal_to_json_field_snake_case(
            ...
            let create_into_postgresql_type_option_vec_where_element_dimension_one_equal_token_stream = generate_read_test_token_stream(
                ...
                &|element: &SynFieldWrapper|{
                    ...
                    quote::quote!{
                        if let Some(#value_snake_case) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#create_into_postgresql_type_option_vec_where_element_dimension_one_equal_snake_case(
                            ident_create.#field_ident.clone()
                        ) {
                            for #element_snake_case in #value_snake_case {
                                #assert_eq_token_stream
            ...
            let read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_element_greater_than_token_stream = generate_read_test_token_stream(
                ...
                &|element: &SynFieldWrapper|{
                    ...
                    quote::quote!{
                        if let Some(#value_snake_case) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#read_only_ids_merged_with_table_type_declaration_into_postgresql_type_option_where_element_greater_than_snake_case(
            ...
            let (
                ...
                let generate_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_number_equal_token_stream = |
                    test_name: &std::primitive::str,
                ...
                (
                    ...
                    generate_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_number_equal_token_stream(
                        &table_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal_name,
                        &postgresql_crud_macros_common::Dimension::Four
                    )
                )
            };
            let create_into_postgresql_json_type_option_vec_where_element_length_equal_token_stream = generate_read_test_token_stream(
                &table_create_into_postgresql_json_type_option_vec_where_element_length_equal_name,
                &generate_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_token_stream,
                &generate_ident_create_content_element_token_stream,
                &|element: &SynFieldWrapper|{
                    ...
                    quote::quote!{
                        if let Some(#value_snake_case) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#create_into_postgresql_json_type_option_vec_where_element_length_equal_snake_case(
                            ident_create.#field_ident.clone()
                        ) {
                            for #element_snake_case in #value_snake_case {
                                #assert_eq_token_stream
            ...
            let create_into_postgresql_json_type_option_vec_where_element_length_greater_than_token_stream = generate_read_test_token_stream(
                &table_create_into_postgresql_json_type_option_vec_where_element_length_greater_than_name,
                &generate_option_vec_create_call_unwrap_or_vec_ident_create_default_field_ident_clone_token_stream,
                &generate_ident_create_content_element_token_stream,
                &|element: &SynFieldWrapper|{
                    ...
                    quote::quote!{
                        if let Some(#value_snake_case) = <#field_type as postgresql_crud::PostgresqlTypeTestCases>::#create_into_postgresql_json_type_option_vec_where_element_length_greater_than_snake_case(
                            ident_create.#field_ident.clone()
                        ) {
                            for #element_snake_case in #value_snake_case {
                                #assert_eq_token_stream
        ...
        let update_many_token_stream = {
            ...
            let update_many_only_one_column_tests_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
                ...
                let maybe_previous_read_token_stream = if is_fields_without_primary_key_len_greater_than_one {
                    quote::quote! {
                        let previous_read = {
                            let mut #acc_snake_case = super::#ident::try_read_many_handle(
                                &url_cloned,
                                super::#ident_read_many_parameters_upper_camel_case {
                                    payload: super::#ident_read_many_payload_upper_camel_case {
                                        where_many: super::#std_option_option_ident_where_many_upper_camel_case(Some(
                                        ...
                                        select: select_default_all_with_max_page_size_cloned.clone(),
                                        order_by: postgresql_crud::OrderBy {
                                            column: super::#ident_select_upper_camel_case::#primary_key_field_ident_upper_camel_case_token_stream(#primary_key_field_type_as_postgresql_type_token_stream Select::default()),
                                            order: Some(postgresql_crud::Order::Asc)
                                        },
                                        ...
                                        let mut #acc_snake_case = super::#ident::try_read_many_handle(
                                            ...
                                            super::#ident_read_many_parameters_upper_camel_case {
                                                payload: super::#ident_read_many_payload_upper_camel_case {
                                                    ...
                                                    order_by: postgresql_crud::OrderBy {
                                                        column: super::#ident_select_upper_camel_case::#primary_key_field_ident_upper_camel_case_token_stream(
                                                            #primary_key_field_type_as_postgresql_type_token_stream Select::default()
                                                        ),
                                                        order: Some(postgresql_crud::Order::Asc)
                                                    },
                                                    pagination: postgresql_crud::PaginationStartsWithZero::try_new(10000, 0).expect("error 8070b103-ef91-4188-b788-b14439b6235a"),
        ...
        let update_one_token_stream = {
            let update_one_only_one_column_tests_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
                ...
                let maybe_previous_read_token_stream = if fields_without_primary_key.len() > 1 {
                    quote::quote! {
                        let previous_read = super::#ident::try_read_one_handle(
                            &url_cloned,
                            super::#ident_read_one_parameters_upper_camel_case {
                                payload: super::#ident_read_one_payload_upper_camel_case {
                        ...
                        for (increment, read_only_ids_current_element) in read_only_ids_current_elements.into_iter().enumerate() {
                            ...
                            #acc_snake_case.push(futures::FutureExt::boxed(async move {
                                ...
                                assert_eq!(
                                    ...
                                    super::#ident::try_update_one_handle(
                                        &url_cloned,
                ...
                #acc_snake_case.push(futures::FutureExt::boxed(async move {
                    if let Err(#error_snake_case) = super::#ident::try_delete_one_handle(
                        ...
                        if let super::#ident_try_delete_one_error_named_upper_camel_case::#ident_delete_one_error_named_with_serialize_deserialize_upper_camel_case {
                            ...
                            if let super::#ident_delete_one_error_named_with_serialize_deserialize_upper_camel_case::Postgresql {
                                postgresql,
                                code_occurence: _
                            } = delete_one_error_named_with_serialize_deserialize {
                                if postgresql != no_rows_returned_by_a_query_that_expected_to_return_at_least_one_row {
