...
impl TableExample {
                    ...
                    match element_1651705d.create_query_part(&mut increment) {
                        Ok(value_f4fdd10d) => {
                            ...
                            .is_err()
                            {
                                ...
                                let error = TableExampleCreateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3298 , column : 21 , })) } ;
                                let mut response =
            ...
            let value = {
                ...
                .await
                {
                                ...
                                Err(error_0) => {
                                    drop(rows);
                                    {
                                        if let Err(error_1) = executor.rollback().await {
                                            let error = TableExampleCreateManyErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3183 , column : 204 , })) } ;
                                        ...
                                        let error = TableExampleCreateManyErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3183 , column : 175 , })) } ;
                                        let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleCreateManyResponseVariants :: from_handle (error))) ;
                                        *response.status_mut() =
                                            http::StatusCode::INTERNAL_SERVER_ERROR;
                                        return response;
                    ...
                    Err(error_0) => {
                        ...
                        {
                            if let Err(error_1) = executor.rollback().await {
                                let error = TableExampleCreateManyErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3194 , column : 166 , })) } ;
                                let mut response =
                                    axum::response::IntoResponse::into_response(axum::Json(
                                        TableExampleCreateManyResponseVariants::from_handle(error),
                                    ));
    ...
    async fn try_create_many_handle(
        ...
        Err (TableExampleTryCreateManyErrorNamed :: TableExampleCreateManyErrorNamedWithSerializeDeserialize { create_many_error_named_with_serialize_deserialize , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3128 , column : 175 , })) , })
    }
                ...
                match binded_query.fetch_one(executor.as_mut()).await {
                    Ok(value_b27d7d79) => {
                        ...
                        >>::from_row(&value_b27d7d79)
                        {
                            ...
                            Err(error_0) => {
                                if let Err(error_1) = executor.rollback().await {
                                    let error = TableExampleCreateOneErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3516 , column : 191 , })) } ;
                                    let mut response =
                                        axum::response::IntoResponse::into_response(axum::Json(
                                ...
                                let error = TableExampleCreateOneErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3516 , column : 162 , })) } ;
                                let mut response =
                                    axum::response::IntoResponse::into_response(axum::Json(
                                        TableExampleCreateOneResponseVariants::from_handle(error),
                                    ));
    ...
    async fn read_many_handle(
        ...
        let query_string = postgresql_crud::generate_read_many_query_string(
            ...
            &{
                ...
                if { use std :: fmt :: Write as _ ; write ! (additional_parameters , "{prefix}{}" , match postgresql_crud :: PostgresqlTypeWhereFilter :: query_part (& parameters . payload . pagination , & mut increment , & "" , bool :: default ()) { Ok (value_742be6cf) => value_742be6cf , Err (error_0) => { let error = TableExampleReadManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3628 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleReadManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } , }) } . is_err () { let error_0 = postgresql_crud :: QueryPartErrorNamed :: WriteIntoBuffer { code_occurence : error_occurence_lib :: code_occurence ! () } ; let error = TableExampleReadManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3298 , column : 21 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleReadManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; }
                additional_parameters
            },
        );
        let binded_query = {
        ...
        let value = {
            {
                ...
                let mut acc_d16ac269 = Vec::new();
                while let Some (value_d9cc2c36) = match postgresql_crud :: TryStreamExt :: try_next (& mut rows) . await { Ok (value_19f3d6e1) => match value_19f3d6e1 { Some (value_b27d7d79) => Some (match TableExampleRead :: try_from_sqlx_postgres_pg_row_with_not_empty_unique_vec_table_example_select (& value_b27d7d79 , & parameters . payload . select) { Ok (value_90535a1d) => value_90535a1d , Err (error_0) => { let error = TableExampleReadManyErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 1591 , column : 21 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleReadManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } }) , None => None , } , Err (error_0) => { let error = TableExampleReadManyErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3718 , column : 169 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleReadManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } } { acc_d16ac269 . push (value_d9cc2c36) ; }
                acc_d16ac269
            }
        };
        let mut response = axum::response::IntoResponse::into_response(axum::Json(
        ...
        let query_string = {
            ...
            let elements = {
                let mut acc_b86a253a = String::default();
                {
                    ...
                    if is_column_0_update_exist {
                        acc_b86a253a . push_str (& postgresql_crud :: generate_column_equals_case_acc_else_column_end_comma_update_many_query_part ("column_0" , & { let mut acc_8ad06c8c = String :: default () ; for element_defbc401 in & update_for_query_vec { if let Some (value_3ea04126) = & element_defbc401 . column_0 { acc_8ad06c8c . push_str (& postgresql_crud :: generate_when_column_id_then_value_update_many_query_part (Self :: primary_key () , & match element_defbc401 . update_query_part_primary_key (& mut increment) { Ok (value_00890100) => value_00890100 , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4108 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } } , & match TableExampleUpdateForQuery :: update_query_part_column_0 (value_3ea04126 , & mut increment) { Ok (value_8797585c) => value_8797585c , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4108 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } } ,)) ; } } acc_8ad06c8c })) ;
                    }
                }
                {
                    ...
                    if is_column_1_update_exist {
                        acc_b86a253a . push_str (& postgresql_crud :: generate_column_equals_case_acc_else_column_end_comma_update_many_query_part ("column_1" , & { let mut acc_8ad06c8c = String :: default () ; for element_defbc401 in & update_for_query_vec { if let Some (value_3ea04126) = & element_defbc401 . column_1 { acc_8ad06c8c . push_str (& postgresql_crud :: generate_when_column_id_then_value_update_many_query_part (Self :: primary_key () , & match element_defbc401 . update_query_part_primary_key (& mut increment) { Ok (value_00890100) => value_00890100 , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4108 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } } , & match TableExampleUpdateForQuery :: update_query_part_column_1 (value_3ea04126 , & mut increment) { Ok (value_8797585c) => value_8797585c , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4108 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } } ,)) ; } } acc_8ad06c8c })) ;
                    }
                }
                {
                    ...
                    if is_column_2_update_exist {
                        acc_b86a253a . push_str (& postgresql_crud :: generate_column_equals_case_acc_else_column_end_comma_update_many_query_part ("column_2" , & { let mut acc_8ad06c8c = String :: default () ; for element_defbc401 in & update_for_query_vec { if let Some (value_3ea04126) = & element_defbc401 . column_2 { acc_8ad06c8c . push_str (& postgresql_crud :: generate_when_column_id_then_value_update_many_query_part (Self :: primary_key () , & match element_defbc401 . update_query_part_primary_key (& mut increment) { Ok (value_00890100) => value_00890100 , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4108 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } } , & match TableExampleUpdateForQuery :: update_query_part_column_2 (value_3ea04126 , & mut increment) { Ok (value_8797585c) => value_8797585c , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4108 , column : 200 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } } ,)) ; } } acc_8ad06c8c })) ;
                    }
                }
            ...
            let primary_keys = {
                ...
                for element_9b2b56f8 in &update_for_query_vec {
                    if { use std :: fmt :: Write as _ ; write ! (acc_a95eb175 , "{}," , match element_9b2b56f8 . update_query_part_primary_key (& mut increment) { Ok (value_f269a3b2) => value_f269a3b2 , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 2253 , column : 21 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } }) } . is_err () { let error_0 = postgresql_crud :: QueryPartErrorNamed :: WriteIntoBuffer { code_occurence : error_occurence_lib :: code_occurence ! () } ; let error = TableExampleUpdateManyErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3298 , column : 21 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; }
                }
        ...
        let binded_query = {
            ...
            for element_4b24f8f0 in &update_for_query_vec {
                if let Some(value_2edaa480) = &element_4b24f8f0.column_0 {
                    ...
                    match < postgresql_crud :: StdPrimitiveI16AsNotNullInt2 as postgresql_crud :: PostgresqlType > :: update_query_bind (value_2edaa480 . value . clone () , query ,) { Ok (value_600e67dc) => { query = value_600e67dc ; } , Err (error_0) => { let error = TableExampleUpdateManyErrorNamed :: TryBind { try_bind : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4231 , column : 252 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } }
                }
            }
            for element_4b24f8f0 in &update_for_query_vec {
    ...
    async fn update_one_handle(
        ...
        let query_string = {
            ...
            let columns = {
                ...
                if let Some(value_2d144436) = &update_for_query.column_0 {
                    acc_683e37b8 . push_str (& postgresql_crud :: generate_column_queals_value_comma_update_one_query_part ("column_0" , & match TableExampleUpdateForQuery :: update_query_part_column_0 (value_2d144436 , & mut increment) { Ok (value_1ec12051) => value_1ec12051 , Err (error_0) => { let error = TableExampleUpdateOneErrorNamed :: QueryPart { error : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4401 , column : 212 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateOneResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: BAD_REQUEST ; return response ; } })) ;
                }
        ...
        let binded_query = {
            ...
            if let Some(value_ed87c152) = &update_for_query.column_0 {
                match < postgresql_crud :: StdPrimitiveI16AsNotNullInt2 as postgresql_crud :: PostgresqlType > :: update_query_bind (value_ed87c152 . value . clone () , query) { Ok (value_c3c1b857) => { query = value_c3c1b857 ; } Err (error_0) => { let error = TableExampleUpdateOneErrorNamed :: TryBind { try_bind : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4456 , column : 198 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleUpdateOneResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } }
            }
                ...
                match binded_query.fetch_one(executor.as_mut()).await {
                    Ok(value_b27d7d79) => {
                        ...
                        >>::from_row(&value_b27d7d79)
                        {
                            ...
                            Err(error_0) => {
                                if let Err(error_1) = executor.rollback().await {
                                    let error = TableExampleUpdateOneErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4534 , column : 165 , })) } ;
                                    let mut response =
                                        axum::response::IntoResponse::into_response(axum::Json(
                                ...
                                let error = TableExampleUpdateOneErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 4534 , column : 136 , })) } ;
                                let mut response =
                                    axum::response::IntoResponse::into_response(axum::Json(
                                        TableExampleUpdateOneResponseVariants::from_handle(error),
                                    ));
    ...
    async fn delete_many_handle(
        ...
        let value = {
            ...
            let value = {
                let mut rows = binded_query.fetch(executor.as_mut());
                let mut acc_d16ac269 = Vec::new();
                while let Some (value_d9cc2c36) = match postgresql_crud :: TryStreamExt :: try_next (& mut rows) . await { Ok (value_19f3d6e1) => match value_19f3d6e1 { Some (value_b27d7d79) => match sqlx :: Row :: try_get :: < < postgresql_crud :: SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud :: PostgresqlType > :: Read , & str > (& value_b27d7d79 , Self :: primary_key ()) { Ok (value_69ecb6a9) => Some (value_69ecb6a9) , Err (error_0) => { drop (rows) ; { if let Err (error_1) = executor . rollback () . await { let error = TableExampleDeleteManyErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3191 , column : 174 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } let error = TableExampleDeleteManyErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3191 , column : 145 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } } } , None => None , } , Err (error_0) => { drop (rows) ; { if let Err (error_1) = executor . rollback () . await { let error = TableExampleDeleteManyErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3194 , column : 166 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } let error = TableExampleDeleteManyErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3194 , column : 137 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteManyResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } } } { acc_d16ac269 . push (value_d9cc2c36) ; }
                acc_d16ac269
            };
            if let Err(error_0) = executor.commit().await {
                let error = TableExampleDeleteManyErrorNamed::Postgresql {
    ...
    async fn delete_one_handle(
        ...
        let value = {
            ...
            let value = {
                match binded_query . fetch_one (executor . as_mut ()) . await { Ok (value_b27d7d79) => { match sqlx :: Row :: try_get :: < < postgresql_crud :: SqlxTypesUuidUuidAsNotNullUuidV4InitializedByPostgresql as postgresql_crud :: PostgresqlType > :: Read , & str > (& value_b27d7d79 , Self :: primary_key ()) { Ok (value_69ecb6a9) => value_69ecb6a9 , Err (error_0) => { { if let Err (error_1) = executor . rollback () . await { let error = TableExampleDeleteOneErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3212 , column : 25 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteOneResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } let error = TableExampleDeleteOneErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3209 , column : 25 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteOneResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } } } } , Err (error_0) => { { if let Err (error_1) = executor . rollback () . await { let error = TableExampleDeleteOneErrorNamed :: RowAndRollback { row : error_0 , rollback : error_1 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3222 , column : 21 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteOneResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } let error = TableExampleDeleteOneErrorNamed :: Postgresql { postgresql : error_0 , code_occurence : error_occurence_lib :: code_occurence :: CodeOccurence :: new (file ! () . to_owned () , line ! () , column ! () , Some (error_occurence_lib :: code_occurence :: MacroOccurence { file : String :: from ("postgresql_crud/postgresql_table/generate_postgresql_table_source/src/lib.rs") , line : 3219 , column : 21 , })) } ; let mut response = axum :: response :: IntoResponse :: into_response (axum :: Json (TableExampleDeleteOneResponseVariants :: from_handle (error))) ; * response . status_mut () = http :: StatusCode :: INTERNAL_SERVER_ERROR ; return response ; } } }
            };
            if let Err(error_0) = executor.commit().await {
                let error = TableExampleDeleteOneErrorNamed::Postgresql {
                    postgresql: error_0,
