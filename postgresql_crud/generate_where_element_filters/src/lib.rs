#[proc_macro]
pub fn generate_where_element_filters(
    ...
    let core_default_default_default_token_stream =
        generate_core_default_default_default_token_stream();
    fn generate_path_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream()
    ...
    let unsigned_part_of_std_primitive_i32_token_stream =
        generate_unsigned_part_of_std_primitive_i32_token_stream();
    fn generate_not_zero_unsigned_part_of_std_primitive_i32_token_stream()
    -> proc_macro2::TokenStream {
        quote::quote! {crate::NotZeroUnsignedPartOfStdPrimitiveI32}
    }
    let not_zero_unsigned_part_of_std_primitive_i32_token_stream =
        generate_not_zero_unsigned_part_of_std_primitive_i32_token_stream();
    let value_not_zero_unsigned_part_of_std_primitive_i32_declaration_token_stream =
        quote::quote! {value: #not_zero_unsigned_part_of_std_primitive_i32_token_stream};
    ...
    fn generate_value_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream()
    -> proc_macro2::TokenStream {
        let path_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream = generate_path_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream();
        quote::quote! {
    ...
    fn generate_match_increment_checked_add_one_initialization_token_stream(
    ...
    let should_add_declaration_of_struct_ident_generic_true_debug_partial_eq_clone =
        ShouldAddDeclarationOfStructIdentGeneric::True {
            maybe_additional_traits_token_stream: Some(
                quote::quote! {std::fmt::Debug + std::cmp::PartialEq + std::clone::Clone},
            ),
        };
    ...
    let query_self_value_query_bind_token_stream =
        ...
        fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
            match &self {
                KindOfUnsignedPartOfStdPrimitiveI32::CanBeZero => {
                    quote::quote! {UnsignedPartOfStdPrimitiveI32}.to_tokens(tokens)
                }
    ...
    let value_match_increment_checked_add_one_initialization_token_stream =
        generate_match_increment_checked_add_one_initialization_token_stream(
            &quote::quote! {value},
        );
    ...
    let query_self_dimensions_query_bind_query_token_stream =
        quote::quote! {query = self.#dimensions_snake_case.query_bind(query);};
    ...
    let postgresql_type_token_stream = {
        let generate_filters_token_stream =
            |filter: &postgresql_crud_macros_common::PostgresqlTypeFilter| {
                let ident =
                    naming::parameter::PostgresqlTypeWhereElementSelfUpperCamelCase::from_display(
                        &filter,
                    );
                let (
                    ...
                    let should_add_declaration_of_struct_ident_generic_true_type_encode =
                        ShouldAddDeclarationOfStructIdentGeneric::True {
                            maybe_additional_traits_token_stream: Some(
                                quote::quote! {sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres>},
                            ),
                        };
                    let should_add_declaration_of_struct_ident_generic_true_debug_partial_eq_clone_type_encode =
                        ShouldAddDeclarationOfStructIdentGeneric::True {
                            maybe_additional_traits_token_stream: Some(
                                quote::quote! {std::fmt::Debug + std::cmp::PartialEq + Clone + sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres>},
                            ),
                        };
                    ...
                    let generate_postgresql_type_dimensions_helpers =
    ...
    let postgresql_json_type_token_stream = {
        let generate_filters_token_stream =
            |filter: &postgresql_crud_macros_common::PostgresqlJsonTypeFilter| {
                ...
                let pub_value_postgresql_json_type_not_empty_unique_vec_t_token_stream =
                    quote::quote! {pub value: crate::PostgresqlJsonTypeNotEmptyUniqueVec<T>};
                ...
                let generate_length_more_than_token_stream =
                    |postgresql_type_pattern_handle: &PostgresqlTypePatternHandle| {
                        generate_ae2fa44d_9035_49fd_ba20_eed1bd4680d4_token_stream(
                            &postgresql_type_pattern_handle,
                            &">",
