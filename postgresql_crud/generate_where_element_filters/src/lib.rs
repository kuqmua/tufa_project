...
pub fn generate_where_element_filters(_input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_impl_postgresql_type_self_where_filter_token_stream =
        |filter_type: &FilterType, should_add_declaration_of_struct_ident_generic: &ShouldAddDeclarationOfStructIdentGeneric, ident: &dyn quote::ToTokens, where_query_part_content_token_stream: &dyn quote::ToTokens, where_query_bind_content_token_stream: &dyn quote::ToTokens| {
    ...
    let postgresql_type_token_stream = {
        ...
        let generate_filters_token_stream = |filter: &postgresql_crud_macros_common::PostgresqlTypeFilter| {
            ...
            let (should_add_declaration_of_struct_ident_generic, struct_additional_fields_token_stream, impl_default_but_option_is_always_some_and_vec_always_contains_one_element_additional_fields_token_stream, where_query_part_content_token_stream, where_query_bind_content_token_stream) =
                match &filter {
            ...
            let struct_token_stream = generate_struct_token_stream(filter_initialized_with_try_new_result.is_ok(), &should_add_declaration_of_struct_ident_generic, &ident, &struct_additional_fields_token_stream);
            ...
            let impl_postgresql_type_self_where_filter_token_stream = generate_impl_postgresql_type_self_where_filter_token_stream(&FilterType::PostgresqlType, &should_add_declaration_of_struct_ident_generic, &ident, &where_query_part_content_token_stream, &where_query_bind_content_token_stream);
            quote::quote! {
                #struct_token_stream
    ...
    let postgresql_json_type_token_stream = {
        ...
        let generate_filters_token_stream = |filter: &postgresql_crud_macros_common::PostgresqlJsonTypeFilter| {
            ...
            let impl_postgresql_type_self_where_filter_token_stream =
                generate_impl_postgresql_type_self_where_filter_token_stream(&FilterType::PostgresqlJsonType, &should_add_declaration_of_struct_ident_generic, &ident, &where_query_part_content_token_stream, &where_query_bind_content_token_stream);
            quote::quote! {
                #struct_token_stream
                #maybe_try_new_logic_token_stream
                #impl_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream
