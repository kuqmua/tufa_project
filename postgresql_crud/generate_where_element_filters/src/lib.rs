    ...
    let postgresql_type_token_stream = {
        let generate_filters_token_stream = |filter: &postgresql_crud_macros_common::PostgresqlTypeFilter| {
            ...
            let (
                ...
                let generate_value_t_token_stream = |format_handle_token_stream: &dyn quote::ToTokens|{
                    (
                        ...
                        {
                            let ok_format_token_stream = generate_ok_format_value_token_stream(&format_handle_token_stream);
                            quote::quote! {
                ...
                match &filter {
                    ...
                    postgresql_crud_macros_common::PostgresqlTypeFilter::DimensionOneCurrentTime => generate_without_value_token_stream(
                        &generate_current_time_format_handle_token_stream(&PostgresqlTypeKind::ArrayDimension)
                    ),
                    ...
                    postgresql_crud_macros_common::PostgresqlTypeFilter::DimensionOneFindRangesWithinGivenRange { ident: _ } => generate_value_t_token_stream(
                        &quote::quote!{"{}({}{} <@ ${})"}
                    ),
                    ...
                    postgresql_crud_macros_common::PostgresqlTypeFilter::DimensionOneFindRangesThatFullyContainTheGivenRange { ident: _ } => generate_value_t_token_stream(
                        &quote::quote!{"{}({}{} @> ${})"}
                    ),
                    ...
                    postgresql_crud_macros_common::PostgresqlTypeFilter::DimensionOneStrictlyToRightOfRange { ident: _ } => generate_value_t_token_stream(
                        &quote::quote!{"{}({}{} &> ${})"}
                    ),
                    ...
                    postgresql_crud_macros_common::PostgresqlTypeFilter::DimensionOneIncludedLowerBound { ident: _ } => generate_value_t_token_stream(
                        &quote::quote!{"{}(lower({}{}) = ${})"}
                    ),
                    ...
                    postgresql_crud_macros_common::PostgresqlTypeFilter::DimensionOneGreaterThanIncludedLowerBound { ident: _ } => generate_value_t_token_stream(
                        &quote::quote!{"{}(lower({}{}) > ${})"}
                    ),
                    postgresql_crud_macros_common::PostgresqlTypeFilter::GreaterThanExcludedUpperBound { ident: _ } => (
                        should_add_declaration_of_struct_ident_generic_true_type_encode.clone(),
                        pub_value_t_token_stream.clone(),
                        value_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream.clone(),
                        generate_query_part_one_value_token_stream(&quote::quote!{"{}(upper({}) > ${})"}),
