...
pub fn generate_where_element_filters(_input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let regular_expression_case_and_value_declaration_token_stream = quote::quote! {
        ...
        pub value: postgresql_crud_common::RegexRegex
    };
    ...
    let generate_pub_dimensions_bounded_vec_token_stream = |vec_length_token_stream: &dyn quote::ToTokens, kind_of_unsigned_part_of_std_primitive_i32: &KindOfUnsignedPartOfStdPrimitiveI32| {
        quote::quote! {pub #dimensions_snake_case: postgresql_crud_common::BoundedStdVecVec<postgresql_crud_common::#kind_of_unsigned_part_of_std_primitive_i32, #vec_length_token_stream>}
    };
            ...
            let (should_add_declaration_of_struct_ident_generic, struct_additional_fields_token_stream, impl_default_but_option_is_always_some_and_vec_always_contains_one_element_additional_fields_token_stream, increment_parameter_underscore, query_part_content_token_stream, is_query_bind_mutable, query_bind_content_token_stream) = {
                ...
                let generate_1fa0bbf4_908e_421b_ae0a_fc9e7ff95034_token_stream = |postgresql_type_pattern_handle: &PostgresqlTypePatternHandle, postgresql_syntax: &dyn std::fmt::Display| {
                    ...
                    (
                        ...
                        match &postgresql_type_pattern_handle {
                            ...
                            PostgresqlTypePatternHandle::ArrayDimension1 | PostgresqlTypePatternHandle::ArrayDimension2 | PostgresqlTypePatternHandle::ArrayDimension3 | PostgresqlTypePatternHandle::ArrayDimension4 => is_query_bind_mutable_true.clone(),
                        },
                        quote::quote! {
                            #maybe_dimensions_query_bind_content_token_stream
                            #query_snake_case
                ...
                let generate_equal_to_encoded_string_representation_token_stream = |postgresql_type_pattern_handle: &PostgresqlTypePatternHandle| {
                    ...
                    (
                        ...
                        quote::quote! {
                            #maybe_dimensions_declaration_token_stream
                            pub encode_format: postgresql_crud_common::EncodeFormat,
                ...
                let generate_range_length_token_stream = |postgresql_type_pattern_handle: &PostgresqlTypePatternHandle| {
                    let (maybe_dimensions_declaration_token_stream, maybe_dimensions_default_initialization_token_stream, maybe_dimensions_indexes_initialization_token_stream, postgresql_type_kind, maybe_additional_parameters_token_stream, maybe_dimensions_query_bind_content_token_stream) = if let Ok(dimension_number) = DimensionNumber::try_from(postgresql_type_pattern_handle) {
                        ...
                        (proc_macro2::TokenStream::new(), proc_macro2::TokenStream::new(), proc_macro2::TokenStream::new(), PostgresqlTypeKind::Standart, quote::quote! {column,}, proc_macro2::TokenStream::new())
                    };
                    (
    ...
    let postgresql_json_type_token_stream = {
        let generate_filters_token_stream = |filter: &postgresql_crud_macros_common::PostgresqlJsonTypeFilter| {
            ...
            let (should_add_declaration_of_struct_ident_generic, struct_additional_fields_token_stream, impl_default_but_option_is_always_some_and_vec_always_contains_one_element_additional_fields_token_stream, query_part_content_token_stream, is_query_bind_mutable, query_bind_content_token_stream) = match &filter {
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::Equal { ident: _ } => generate_equal_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneEqual { ident: _ } => generate_equal_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoEqual { ident: _ } => generate_equal_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeEqual { ident: _ } => generate_equal_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourEqual { ident: _ } => generate_equal_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::AllElementsEqual { ident: _ } => generate_all_elements_equal_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneAllElementsEqual { ident: _ } => generate_all_elements_equal_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoAllElementsEqual { ident: _ } => generate_all_elements_equal_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeAllElementsEqual { ident: _ } => generate_all_elements_equal_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourAllElementsEqual { ident: _ } => generate_all_elements_equal_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                ...
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeGreaterThan { ident: _ } => generate_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourGreaterThan { ident: _ } => generate_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::ContainsElementGreaterThan { ident: _ } => generate_contains_element_greater_than_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneContainsElementGreaterThan { ident: _ } => generate_contains_element_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoContainsElementGreaterThan { ident: _ } => generate_contains_element_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeContainsElementGreaterThan { ident: _ } => generate_contains_element_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourContainsElementGreaterThan { ident: _ } => generate_contains_element_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::AllElementsGreaterThan { ident: _ } => generate_all_elements_greater_than_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneAllElementsGreaterThan { ident: _ } => generate_all_elements_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoAllElementsGreaterThan { ident: _ } => generate_all_elements_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeAllElementsGreaterThan { ident: _ } => generate_all_elements_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourAllElementsGreaterThan { ident: _ } => generate_all_elements_greater_than_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::Between { ident: _ } => generate_between_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneBetween { ident: _ } => generate_between_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoBetween { ident: _ } => generate_between_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeBetween { ident: _ } => generate_between_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourBetween { ident: _ } => generate_between_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::In { ident: _ } => generate_in_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneIn { ident: _ } => generate_in_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoIn { ident: _ } => generate_in_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeIn { ident: _ } => generate_in_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourIn { ident: _ } => generate_in_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                ...
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::ContainsAllElementsOfArray { ident: _ } => generate_contains_all_elements_of_array_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneContainsAllElementsOfArray { ident: _ } => generate_contains_all_elements_of_array_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoContainsAllElementsOfArray { ident: _ } => generate_contains_all_elements_of_array_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeContainsAllElementsOfArray { ident: _ } => generate_contains_all_elements_of_array_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourContainsAllElementsOfArray { ident: _ } => generate_contains_all_elements_of_array_token_stream(&postgresql_type_pattern_handle_array_dimension4),
                // postgresql_crud_macros_common::PostgresqlJsonTypeFilter::ContainedInArray => todo!(),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::OverlapsWithArray { ident: _ } => generate_overlaps_with_array_token_stream(&postgresql_type_pattern_handle_standart),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionOneOverlapsWithArray { ident: _ } => generate_overlaps_with_array_token_stream(&postgresql_type_pattern_handle_array_dimension1),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionTwoOverlapsWithArray { ident: _ } => generate_overlaps_with_array_token_stream(&postgresql_type_pattern_handle_array_dimension2),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionThreeOverlapsWithArray { ident: _ } => generate_overlaps_with_array_token_stream(&postgresql_type_pattern_handle_array_dimension3),
                postgresql_crud_macros_common::PostgresqlJsonTypeFilter::DimensionFourOverlapsWithArray { ident: _ } => generate_overlaps_with_array_token_stream(&postgresql_type_pattern_handle_array_dimension4),
            };
            let struct_token_stream = generate_struct_token_stream(false, &should_add_declaration_of_struct_ident_generic, &ident, &struct_additional_fields_token_stream);
            let impl_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream = generate_impl_default_but_option_is_always_some_and_vec_always_contains_one_element_token_stream(&should_add_declaration_of_struct_ident_generic, &ident, &impl_default_but_option_is_always_some_and_vec_always_contains_one_element_additional_fields_token_stream);
            let impl_postgresql_type_where_filter_token_stream = generate_impl_postgresql_type_where_filter_token_stream(
