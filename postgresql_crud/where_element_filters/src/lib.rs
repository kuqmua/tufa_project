...
pub struct PostgresqlTypeWhereElementEqual<T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + postgresql_crud_common::PostgresqlTypeEqualOperator> {
    pub logical_operator: postgresql_crud_common::LogicalOperator,
    pub value: T,
}
impl<T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + postgresql_crud_common::PostgresqlTypeEqualOperator + postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement> postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for PostgresqlTypeWhereElementEqual<T> {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
...
impl<'a, T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + postgresql_crud_common::PostgresqlTypeEqualOperator + std::marker::Send + 'a> postgresql_crud_common::PostgresqlTypeWhereFilter<'a> for PostgresqlTypeWhereElementEqual<T> {
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize, serde :: Deserialize, schemars :: JsonSchema)]
pub struct PostgresqlTypeWhereElementDimensionOneEqual<T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + postgresql_crud_common::PostgresqlTypeEqualOperator> {
    pub logical_operator: postgresql_crud_common::LogicalOperator,
    pub dimensions: crate::BoundedStdVecVec<crate::NotZeroUnsignedPartOfStdPrimitiveI32, 1>,
    pub value: T,
}
impl<T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + postgresql_crud_common::PostgresqlTypeEqualOperator + postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement> postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for PostgresqlTypeWhereElementDimensionOneEqual<T> {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
            logical_operator: postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement::default_but_option_is_always_some_and_vec_always_contains_one_element(),
...
impl<'a, T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + postgresql_crud_common::PostgresqlTypeEqualOperator + std::marker::Send + 'a> postgresql_crud_common::PostgresqlTypeWhereFilter<'a> for PostgresqlTypeWhereElementDimensionOneEqual<T> {
    fn query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud_common::QueryPartErrorNamed> {
        ...
        Ok(format!("{}({}{dimensions_indexes} {content})", &self.logical_operator.to_query_part(is_need_to_add_logical_operator), column))
    }
    fn query_bind(self, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>, std::string::String> {
