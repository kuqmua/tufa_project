...
pub struct PostgresqlTypeWhereElementEqual<
    T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres>
    //here
    +
...
impl<
    ...
    +
    postgresql_crud_common::PostgresqlTypeEqualOperator
> postgresql_crud_common::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for PostgresqlTypeWhereElementEqual<T> {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
...
impl<
    ...
    //
    + 'a
> postgresql_crud_common::PostgresqlTypeWhereFilter<'a> for PostgresqlTypeWhereElementEqual<T> {
