...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let structs_variants_token_stream = column_variants.iter().map(|variant_columns| {
        ...
        let genereted_fields = variant_columns.iter().map(|variant_column|{
            ...
            quote::quote! {
                pub #variant_column_ident: #inner_type_with_serialize_deserialize_token_stream,
            }
        });
        quote::quote! {
                                            ...
                                            None => {
                                                return Err(Self::Error::
                                                    #primary_key_field_ident_is_none_upper_camel_case_token_stream {
                                                        #primary_key_field_ident_is_none_snake_case_token_stream: #std_string_string_token_stream::#from_snake_case_token_stream(#primary_key_is_none_quotes_token_stream),
                            ...
                            let #field_ident = match value.#field_ident {
                                ...
                                None => {
                                    return Err(Self::Error::#field_ident_is_none_upper_camel_case_token_stream {
                                        #field_ident_is_none_snake_case_token_stream: #std_string_string_token_stream::#from_snake_case_token_stream(#field_ident_is_none_message_snake_case_token_stream),
                    ...
                    fn from_str(value: #str_ref_token_stream) -> Result<Self, Self::Err> {
                        match value {
                            ...
                            _ => Err(Self::Err::#not_correct_upper_camel_case_token_stream {
                                #not_correct_value_token_stream: #std_string_string_token_stream::#from_snake_case_token_stream(value),
                                #supported_values_token_stream: #std_string_string_token_stream::#from_snake_case_token_stream(#supported_values_handle_token_stream),
                        ...
                        let column = match string_deserialized.find(column_equal_str) {
                            Some(index) => match index.checked_add(column_equal_str.len()) {
                                Some(offset) => match string_deserialized.get(offset..) {
                                            ...
                                            match offset_slice.get(0..offset_slice_next_comma_index) {
                                                ...
                                                None => {
                                                    return Err(Self::Err::ColumnNoOffsetValue {
                                                        column_no_offset_value: #std_string_string_token_stream::#from_snake_case_token_stream("no offset value"),
                                        ...
                                        None => match offset_slice.get(0..) {
                                            ...
                                            None => {
                                                return Err(Self::Err::ColumnOffsetSliceGet {
                                                    column_offset_slice_get: #std_string_string_token_stream::#from_snake_case_token_stream("offset_slice_get"),
                                    ...
                                    None => {
                                        return Err(Self::Err::ColumnStringDeserializedGet {
                                            column_string_deserialized_get: #std_string_string_token_stream::#from_snake_case_token_stream("string_deserialized_get"),
                                ...
                                None => {
                                    return Err(Self::Err::ColumnIndexCheckedAdd {
                                        column_index_checked_add: #std_string_string_token_stream::#from_snake_case_token_stream("index_checked_add"),
                            ...
                            None => {
                                return Err(Self::Err::ColumnStringDeserializedFind {
                                    column_string_deserialized_find: #std_string_string_token_stream::#from_snake_case_token_stream("string_deserialized_find"),
                            ...
                            Some(index) => match index.checked_add(order_equal_str.len()) {
                                Some(offset) => match string_deserialized.get(offset..) {
                                            ...
                                            match offset_slice.get(0..offset_slice_next_comma_index) {
                                                ...
                                                None => {
                                                    return Err(Self::Err::OrderOffsetSliceGetNone {
                                                        order_offset_slice_get_none: #std_string_string_token_stream::#from_snake_case_token_stream("order_offset_slice_get_none"),
                                    ...
                                    None => {
                                        return Err(Self::Err::OrderStringDeserializedGetNone {
                                            order_string_deserialized_get_none: #std_string_string_token_stream::#from_snake_case_token_stream("string_deserialized_get_none"),
                                ...
                                None => {
                                    return Err(Self::Err::OrderIndexCheckedAdd {
                                        order_index_checked_add: #std_string_string_token_stream::#from_snake_case_token_stream("order_index_checked_add"),
    ...
    let operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_snake_case_stringified = format!(
        ...
        proc_macro_helpers::naming_conventions::server_snake_case_stringified()
    );
    let operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_snake_case_token_stream = {
        ...
        .unwrap_or_else(|_| panic!("{proc_macro_name_upper_camel_case_ident_stringified} {operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_snake_case_stringified} {}", proc_macro_common::global_variables::hardcode::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
    };
                        ...
                        quote::quote! {
                            impl std::convert::TryFrom<#operation_payload_with_serialize_deserialize_upper_camel_case_token_stream> for #operation_payload_upper_camel_case_token_stream {
                                ...
                                fn try_from(value: #operation_payload_with_serialize_deserialize_upper_camel_case_token_stream) -> Result<Self, Self::Error> {
                                    ...
                                    let #select_snake_case_token_stream = value.#select_snake_case_token_stream;
                                    let #order_by_snake_case_token_stream = value.#order_by_snake_case_token_stream;
                                    let #limit_snake_case_token_stream = #limit_and_offset_type_token_stream::#from_snake_case_token_stream(value.#limit_snake_case_token_stream);//todo reuse
                                    let #offset_snake_case_token_stream = #limit_and_offset_type_token_stream::#from_snake_case_token_stream(value.#offset_snake_case_token_stream);//todo reuse
                                    Ok(Self {
                                        #(#fields_named_idents_comma_token_stream)*
                                        #select_snake_case_token_stream,
                                        #order_by_snake_case_token_stream,
                            ...
                            impl std::convert::From<#operation_payload_with_serialize_deserialize_upper_camel_case_token_stream> for #operation_payload_upper_camel_case_token_stream {
                                fn from(value: #operation_payload_with_serialize_deserialize_upper_camel_case_token_stream) -> Self {
                                    Self (
                                        ...
                                        .collect::<std::vec::Vec<#operation_payload_element_upper_camel_case_token_stream>>()
                                    )
                                }
                            }
                        }
    ...
    let (delete_many_token_stream, delete_many_http_request_test_token_stream) = {
        ...
        let parameters_token_stream = {
            ...
            let impl_std_convert_from_or_try_from_operation_payload_with_serialize_deserialize_for_operation_payload_token_stream = match fields_named_from_or_try_from {
                postgresql_crud_common::FromOrTryFrom::From => {
                    let fields_assignments_token_stream = fields_named_excluding_primary_key.iter()
                        .map(|element| generate_option_vec_where_inner_type_from_option_vec_where_inner_type_with_serialize_deserialize_token_stream(&element));
                    let self_init_fields_token_stream = generate_self_fields_token_stream(
                        &fields_named.iter().map(|element|&element.field).collect::<std::vec::Vec<&syn::Field>>()
                            as &[&syn::Field],
                        &proc_macro_name_upper_camel_case_ident_stringified,
...
impl std::convert::From<syn::Field> for SynFieldWithAdditionalInfo {
    fn from(value: syn::Field) -> Self {
        ...
        let where_inner_type_with_serialize_deserialize_token_stream = {
            let value_stringified = &rust_sqlx_map_to_postgres_type_variant.get_where_inner_type_with_serialize_deserialize_stringified("");//todo json generics
            value_stringified.parse::<proc_macro2::TokenStream>()
            .unwrap_or_else(|_| panic!("{name} {value_stringified} {}", proc_macro_common::global_variables::hardcode::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
        };
        Self {
...
fn generate_let_option_field_ident_value_option_inner_type_from_token_stream(element: &SynFieldWithAdditionalInfo) -> proc_macro2::TokenStream {
    let field_ident = &element.field_ident;
    let inner_type_token_stream = &element.inner_type_token_stream;
    let from_snake_case_token_stream = proc_macro_helpers::naming_conventions::from_snake_case_token_stream();
    quote::quote! {
...
fn generate_option_vec_where_inner_type_from_option_vec_where_inner_type_with_serialize_deserialize_token_stream(value: &SynFieldWithAdditionalInfo) -> proc_macro2::TokenStream {
    let field_ident = &value.field_ident;
    let where_inner_type_token_stream = &value.where_inner_type_token_stream;
    let from_snake_case_token_stream = proc_macro_helpers::naming_conventions::from_snake_case_token_stream();
    quote::quote! {
    ...
    match value.rust_sqlx_map_to_postgres_type_variant.inner_type_from_or_try_from_inner_type_with_serialize_deserialize() {
        ...
        postgresql_crud_common::FromOrTryFrom::TryFrom => {
            let where_with_serialize_deserialize_error_named_token_stream = {
                let value_stringified = value.rust_sqlx_map_to_postgres_type_variant.get_where_with_serialize_deserialize_error_named_stringified("");
                value_stringified.parse::<proc_macro2::TokenStream>()
                .unwrap_or_else(|_| panic!("{value_stringified} {}", proc_macro_common::global_variables::hardcode::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
            };
            let field_ident_upper_camel_case_token_stream = {
