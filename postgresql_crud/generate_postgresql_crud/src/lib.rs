...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let (
        ...
        not_unique_primary_key_with_serialize_deserialize_syn_variant_token_stream
     ) = {
        ...
        let not_unique_primary_key_with_serialize_deserialize_syn_variant_status_code = proc_macro_helpers::status_code::StatusCode::InternalServerError500;
        let not_unique_primary_key_with_serialize_deserialize_syn_variant = proc_macro_helpers::construct_syn_variant::construct_syn_variant_with_status_code(
            not_unique_primary_key_with_serialize_deserialize_syn_variant_status_code.clone(),
        ...
        let not_unique_primary_key_with_serialize_deserialize_syn_variant_token_stream = generate_error_occurence_variant_token_stream(
            &not_unique_primary_key_with_serialize_deserialize_syn_variant,
            &proc_macro_name_upper_camel_case_ident_stringified,
        );
        (
    ...
    let operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_client_many_declaration_handle_token_stream = match primary_key_from_or_try_from {
    ...
    let (
        ...
        let not_unique_column_syn_variant = proc_macro_helpers::construct_syn_variant::construct_syn_variant_with_status_code(
    ...
    let select_assignment_token_stream = quote::quote! {
    ...
    let generate_read_common_http_request_syn_variants = |
        operation: &Operation,
    |{
        let mut value = common_http_request_syn_variants.clone();
        value.push(proc_macro_helpers::construct_syn_variant::construct_syn_variant(
            &naming_conventions::SelfPayloadWithSerializeDeserializeTryFromSelfPayloadUpperCamelCaseTokenStream::self_payload_with_serialize_deserialize_try_from_self_payload_upper_camel_case_token_stream(operation),
            vec![(
                proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoErrorOccurence,
                &naming_conventions::SelfPayloadWithSerializeDeserializeTryFromSelfPayloadSnakeCaseTokenStream::self_payload_with_serialize_deserialize_try_from_self_payload_snake_case_token_stream(operation),
                proc_macro_helpers::generate_simple_syn_punctuated_punctuated::generate_simple_syn_punctuated_punctuated(
    ...
    | {
        ...
        let operation_payload_with_serialize_deserialize_try_from_operation_payload_syn_variant_initialization_token_stream = {
    ...
    let (read_many_token_stream, read_many_test_token_stream) = {
        ...
        let not_unique_fields_syn_variants_status_code = proc_macro_helpers::status_code::StatusCode::BadRequest400;
        let not_unique_fields_syn_variants_handle = fields_named_excluding_primary_key.iter().map(|element|{
            ...
            proc_macro_helpers::construct_syn_variant::construct_syn_variant_with_status_code(
                not_unique_fields_syn_variants_status_code.clone(),
        ...
        let not_unique_fields_syn_variants = not_unique_fields_syn_variants_handle.iter().collect::<std::vec::Vec<&syn::Variant>>();
        let type_variants_from_request_response_syn_variants = generate_type_variants_from_request_response_syn_variants(
            &{
        ...
        let parameters_token_stream = {
            ...
            let impl_std_convert_try_from_operation_payload_for_operation_payload_with_serialize_deserialize_token_stream = {
                ...
                let impl_std_convert_try_from_operation_payload_for_operation_payload_with_serialize_deserialize_token_stream = proc_macro_helpers::generate_impl_std_convert_try_from_token_stream::generate_impl_std_convert_try_from_token_stream(
                   ...
                   &{
                        let filter_not_unique_primary_key_token_stream = {
                            let error_initialization_eprintln_response_creation_token_stream = generate_error_initialization_eprintln_response_creation_token_stream(
                                ...
                                &not_unique_primary_key_with_serialize_deserialize_syn_variant_initialization_token_stream,
                                &quote::quote! {#from_snake_case(#error_snake_case)},
                                &not_unique_primary_key_with_serialize_deserialize_syn_variant_status_code.to_axum_http_status_code_token_stream(),
                                &eprintln_error_token_stream,
                            );
                            quote::quote! {
        ...
        let (try_operation_token_stream, try_operation_test_token_stream) = {
            let try_operation_error_named_token_stream = generate_try_operation_error_named_token_stream(
                &operation,
                &generate_read_common_http_request_syn_variants(&operation),
                &proc_macro_name_upper_camel_case_ident_stringified,
            );
            // println!("{try_operation_error_named_token_stream}");
            let try_operation_token_stream = generate_try_operation_token_stream(
...
fn generate_impl_std_convert_from_operation_payload_upper_camel_case_token_stream_for_operation_payload_with_serialize_deserialize_upper_camel_case_token_stream(
    operation: &Operation,
    content_token_stream: &proc_macro2::TokenStream,
) -> proc_macro2::TokenStream {
    proc_macro_helpers::generate_impl_std_convert_from_token_stream::generate_impl_std_convert_from_token_stream(
