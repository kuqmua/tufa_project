...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let from_str_upper_camel_case_token_stream =
        proc_macro_helpers::naming_conventions::FromStrUpperCamelCase;
    let from_str_snake_case_token_stream = proc_macro_helpers::naming_conventions::FromStrSnakeCase;
    ...
    let try_from_snake_case_token_stream = proc_macro_helpers::naming_conventions::TryFromSnakeCase;
    ...
    let code_occurence_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::CodeOccurenceUpperCamelCase;
    ...
    let column_select_upper_camel_case_stringified = proc_macro_helpers::naming_conventions::ColumnSelectUpperCamelCase;
    ...
    let options_try_from_sqlx_row_snake_case_token_stream = proc_macro_helpers::naming_conventions::OptionsTryFromSqlxRowSnakeCase;
    ...
    let wrapper_vec_column_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::WrapperVecColumnUpperCamelCase;
    let wrapper_vec_column_snake_case_token_stream = proc_macro_helpers::naming_conventions::WrapperVecColumnSnakeCase;
    ...
    //todo reuse path
    let primary_key_try_from_sqlx_row_snake_case_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeyTryFromSqlxRowSnakeCase;
    let primary_key_try_get_sqlx_row_token_stream = {
        ...
        let primary_key_name_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeySnakeCase;
        quote::quote! {
            fn #primary_key_try_from_sqlx_row_snake_case_token_stream<'a, R: #sqlx_row_token_stream>(#row_snake_case: &'a R) -> sqlx::Result<#primary_key_inner_type_token_stream>
            where
                #std_primitive_str_sqlx_column_index_token_stream
            ...
            {
                let #primary_key_name_token_stream: #primary_key_original_type_token_stream = #row_snake_case.try_get(#primary_key_str_token_stream)?;
                Ok(#primary_key_inner_type_token_stream(#primary_key_name_token_stream))
            }
        }
    };
    // println!("{primary_key_try_get_sqlx_row_token_stream}");
    let order_by_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::OrderByUpperCamelCase;
    ...
    let limit_snake_case_token_stream = naming_constants::LimitSnakeCase;
    let offset_snake_case_token_stream = naming_constants::OffsetSnakeCase;
    let order_snake_case_token_stream = naming_constants::OrderSnakeCase;
    let column_snake_case_token_stream = naming_constants::ColumnSnakeCase;
    ...
    let additional_http_status_codes_error_variants_snake_case_stringified = proc_macro_helpers::naming_conventions::AdditionalHttpStatusCodesErrorVariantsSnakeCase;
    ...
    let extraction_result_snake_case_stringified = proc_macro_helpers::naming_conventions::ExtractionResultSnakeCase;
    let parameters_snake_case_token_stream =
        naming_constants::ParametersSnakeCase;
    let payload_upper_camel_case_stringified =
        naming_constants::PayloadUpperCamelCase;
    let payload_snake_case_stringified = naming_constants::PayloadSnakeCase;
    let payload_snake_case_token_stream = naming_constants::PayloadSnakeCase;
    let payload_extraction_result_snake_case_token_stream = proc_macro_helpers::naming_conventions::ExtractionResultSnakeCase;
    ...
    let returning_stringified = naming_constants::ReturningSnakeCase;
    ...
    let postgresql_crud_token_stream = proc_macro_helpers::naming_conventions::ExtractionResultSnakeCase;
    let app_state_path = quote::quote! {#postgresql_crud_token_stream::app_state::DynArcGetConfigGetPostgresPoolSendSync}; //todo path
    let serde_json_to_string_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::SerdeJsonToStringUpperCamelCase;
    let serde_json_to_string_snake_case_token_stream = proc_macro_helpers::naming_conventions::SerdeJsonToStringSnakeCase;
    let serde_json_to_string_variant_initialization_token_stream = {
        ...
        quote::quote! {
            #serde_json_to_string_upper_camel_case_token_stream {
                #serde_json_to_string_snake_case_token_stream: #error_snake_case,
    ...
    let (bind_query_syn_variant, bind_query_variant_initialization_token_stream) = {
        (
            ...
            {
                let bind_query_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::BindQueryUpperCamelCase;
                let bind_query_snake_case_token_stream = proc_macro_helpers::naming_conventions::BindQuerySnakeCase;
                ...
                quote::quote! {
                    #bind_query_upper_camel_case_token_stream {
                        #bind_query_snake_case_token_stream: #error_snake_case.#into_serialize_deserialize_version_snake_case_token_stream(),
    ...
    let (checked_add_syn_variant, checked_add_variant_initialization_token_stream) = {
        (
            ...
            ),
            {
                ...
                let checked_add_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::CheckedAddUpperCamelCase;
                let checked_add_snake_case_token_stream = proc_macro_helpers::naming_conventions::CheckedAddSnakeCase;
                ...
                quote::quote! {
                    #checked_add_upper_camel_case_token_stream { //todo remove it? refactor it?
                        #checked_add_snake_case_token_stream: #std_string_string_token_stream::#from_snake_case(#checked_is_none_quotes_token_stream),
    ...
    let query_upper_camel_case_stringified = naming_constants::QueryUpperCamelCase;
    let query_snake_case_stringified = naming_constants::QuerySnakeCase;
    let rollback_upper_camel_case_stringified = naming_constants::RollbackUpperCamelCase;
    let rollback_snake_case_stringified = naming_constants::RollbackSnakeCase;
    let rollback_snake_case_token_stream = naming_constants::RollbackSnakeCase;
    let (
        ...
        (
            crate::type_variants_from_request_response_generator::construct_syn_variant_with_status_code(
                ...
                vec![
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
                        &query_snake_case_stringified.to_string(),
                        sqlx_error_syn_punctuated_punctuated.clone(),
                    ),
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
                        &rollback_snake_case_stringified.to_string(),
                        sqlx_error_syn_punctuated_punctuated.clone(),
                    ),
                ],
            ),
            {
                let query_and_rollback_failed_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::QueryAndRollbackFailedUpperCamelCase;
                let query_and_rollback_failed_snake_case_token_stream = proc_macro_helpers::naming_conventions::QueryAndRollbackFailedSnakeCase;
                ...
                quote::quote! {
                    #query_and_rollback_failed_upper_camel_case_token_stream {
                        #query_and_rollback_failed_snake_case_token_stream: #error_snake_case,
    ...
    let (
        ...
        (
            ...
            {
                let primary_key_from_row_and_failed_rollback_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeyFromRowAndFailedRollbackUpperCamelCase;
                let primary_key_from_row_and_failed_rollback_snake_case_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeyFromRowAndFailedRollbackSnakeCase;
                ...
                quote::quote! {
                    #primary_key_from_row_and_failed_rollback_upper_camel_case_token_stream {
                        #primary_key_from_row_and_failed_rollback_snake_case_token_stream: #error_snake_case,
                        #rollback_snake_case_token_stream,
    ...
    let (non_existing_primary_keys_syn_variant, non_existing_primary_keys_syn_variant_initialization_token_stream) = {
        (
            ...
            {
                let non_existing_primary_keys_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::NonExistingPrimaryKeysUpperCamelCase;
                let non_existing_primary_keys_snake_case_token_stream = proc_macro_helpers::naming_conventions::NonExistingPrimaryKeysSnakeCase;
    ...
    let (
        ...
        (
            ...
            {
                let non_existing_primary_keys_and_failed_rollback_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::NonExistingPrimaryKeysAndFailedRollbackUpperCamelCase;
                let non_existing_primary_keys_snake_case_token_stream = proc_macro_helpers::naming_conventions::NonExistingPrimaryKeysSnakeCase;
                ...
                quote::quote! {
                    #non_existing_primary_keys_and_failed_rollback_upper_camel_case_token_stream {
                        #non_existing_primary_keys_snake_case_token_stream,
                        #rollback_snake_case_token_stream: #error_snake_case,
    ...
    let (
        ...
        (
            ...
            {
                let commit_failed_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::CommitFailedUpperCamelCase;
                let commit_failed_snake_case_token_stream = proc_macro_helpers::naming_conventions::CommitFailedSnakeCase;
                ...
                quote::quote! {
                    #commit_failed_upper_camel_case_token_stream {
                        #commit_failed_snake_case_token_stream: #error_snake_case,
    ...
    let not_unique_primary_keys_name_token_stream = proc_macro_helpers::naming_conventions::NotUniquePrimaryKeysSnakeCase;
    let (
        ...
        (
            ...
            {
                let not_unique_primary_keys_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::NotUniquePrimaryKeysUpperCamelCase;
                let not_unique_primary_keys_snake_case_token_stream = proc_macro_helpers::naming_conventions::NotUniquePrimaryKeysSnakeCase;
    ...
    let (
        ...
        (
            ...
            {
                let operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::OperationDoneButPrimaryKeyInnerTypeTryFromPrimaryKeyInnerTypeWithSerializeDeserializeFailedInServerUpperCamelCase;
                let operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_snake_case_token_stream = proc_macro_helpers::naming_conventions::OperationDoneButPrimaryKeyInnerTypeTryFromPrimaryKeyInnerTypeWithSerializeDeserializeFailedInServerSnakeCase;
                ...
                quote::quote! {
                    #operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_upper_camel_case_token_stream {
                        #operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_snake_case_token_stream: #error_snake_case,
        ...
        (
            crate::type_variants_from_request_response_generator::construct_syn_variant_with_status_code(
                ...
                vec![
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
                        &naming_constants::PostgresqlSnakeCase.to_string(),
                        sqlx_error_syn_punctuated_punctuated,
                    )
                ]
            ),
            {
                let postgresql_upper_camel_case_token_stream = naming_constants::PostgresqlUpperCamelCase;
                let postgresql_snake_case_token_stream = naming_constants::PostgresqlSnakeCase;
        ...
        (
            crate::type_variants_from_request_response_generator::construct_syn_variant_with_status_code(
                ...
                vec![
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
                        &naming_constants::JsonSnakeCase.to_string(),
                        proc_macro_helpers::generate_simple_syn_punctuated_punctuated::generate_simple_syn_punctuated_punctuated(
            ...
            {
                let json_upper_camel_case_token_stream = naming_constants::JsonUpperCamelCase;
                let json_snake_case_token_stream = naming_constants::JsonSnakeCase;
                ...
                quote::quote! {
                    #json_upper_camel_case_token_stream {
                        #json_snake_case_token_stream: #error_snake_case,
    ...
    let (
        ...
        let primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_in_client_snake_case_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeyInnerTypeTryFromPrimaryKeyInnerTypeWithSerializeDeserializeInClientSnakeCase;
        (
            quote::quote! {
            ...
            },
            {
                ...
                quote::quote! {
                    #operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_client_upper_camel_case_token_stream {
                        #primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_in_client_snake_case_token_stream: #error_snake_case,
    ...
    let (
        ...
        (
            ...
            {
                let no_payload_fields_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::NoPayloadFieldsUpperCamelCase;
                let no_payload_fields_snake_case_token_stream = proc_macro_helpers::naming_conventions::NoPayloadFieldsSnakeCase;
                ...
                quote::quote! {
                    #no_payload_fields_upper_camel_case_token_stream {
                        #no_payload_fields_snake_case_token_stream: #std_string_string_token_stream::#from_snake_case(#no_payload_fields_quotes_token_stream),
    ...
    let try_extract_value_snake_case_token_stream = proc_macro_helpers::naming_conventions::TryExtractValueSnakeCase;
    let dot_space = ", ";
    // let pg_temp_stringified = "pg_temp";
    let pg_connection_snake_case_token_stream = proc_macro_helpers::naming_conventions::PgConnectionSnakeCase;
    let query_string_snake_case_token_stream = proc_macro_helpers::naming_conventions::QueryStringSnakeCase;
    let binded_query_snake_case_token_stream = proc_macro_helpers::naming_conventions::BindedQuerySnakeCase;
    let current_vec_len_snake_case_token_stream = proc_macro_helpers::naming_conventions::CurrentVecLenSnakeCase;
    let desirable_upper_camel_case_token_stream =
        naming_constants::DesirableUpperCamelCase;
    let select_snake_case_token_stream =
        naming_constants::SelectSnakeCase;
    let limit_snake_case_token_stream =
        naming_constants::LimitSnakeCase;
    let offset_snake_case_token_stream =
        naming_constants::OffsetSnakeCase;
    let rollback_snake_case_token_stream =
        naming_constants::RollbackSnakeCase;
    let element_snake_case_token_stream =
        naming_constants::ElementSnakeCase;
    let acc_snake_case_token_stream =
        naming_constants::AccSnakeCase;
    let query_snake_case_token_stream =
        naming_constants::QuerySnakeCase;
    let update_snake_case_stringified =
        naming_constants::UpdateSnakeCase;
    let as_snake_case_stringified = naming_constants::AsSnakeCase;
    let set_snake_case_stringified = naming_constants::SetSnakeCase;
    let from_snake_case = naming_constants::FromSnakeCase;
    let insert_snake_case_stringified =
        naming_constants::InsertSnakeCase;
    let into_snake_case_stringified =
        naming_constants::IntoSnakeCase;
    let values_snake_case_stringified =
        naming_constants::ValuesSnakeCase;
    let delete_snake_case_stringified =
        naming_constants::DeleteSnakeCase;
    let where_snake_case_stringified =
        naming_constants::WhereSnakeCase;
    let where_snake_case_qoutes_token_stream =
        proc_macro_common::generate_quotes::token_stream(
            &where_snake_case_stringified.to_string(),
            &proc_macro_name_upper_camel_case_ident_stringified,
        );
    let and_snake_case_stringified = naming_constants::AndSnakeCase;
    let select_snake_case_stringified =
        naming_constants::SelectSnakeCase;
    let order_by_name_stringified = format!(
        "{} {}",
        naming_constants::OrderSnakeCase,
        naming_constants::BySnakeCase
    );
    let limit_snake_case_stringified =
        naming_constants::LimitSnakeCase;
    let offset_snake_case_stringified =
        naming_constants::OffsetSnakeCase;
    let in_snake_case_stringified = naming_constants::InSnakeCase;
    let unnest_snake_case_stringified =
        naming_constants::UnnestSnakeCase;
    let api_request_unexpected_error_module_path_token_stream =
        quote::quote! { crate::common::api_request_unexpected_error };
    let expected_type_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::ExpectedTypeUpperCamelCase;
    let expected_type_snake_case_token_stream =
        proc_macro_helpers::naming_conventions::ExpectedTypeSnakeCase;
    ...
    let (
        ...
        (
            ...
            quote::quote! {
                #expected_type_upper_camel_case_token_stream {
                    #expected_type_snake_case_token_stream: #error_snake_case,
                    #field_code_occurence_new_a2da8618_eb3a_425c_a2d8_c02d39845168_token_stream
                }
            },
        )
    };
    let unexpected_status_code_upper_camel_case = proc_macro_helpers::naming_conventions::UnexpectedStatusCodeUpperCamelCase;
    ...
    let (
        ...
        (
            ...
            ,
            {
                let failed_to_get_response_text_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::FailedToGetResponseTextUpperCamelCase;
                let reqwest_snake_case_token_stream = naming_constants::ReqwestSnakeCase;
                ...
                quote::quote! {
                    #failed_to_get_response_text_upper_camel_case_token_stream {
                        #reqwest_snake_case_token_stream: #error_snake_case,
                        #status_code_snake_case,
                        #headers_snake_case,
    ...
    let (
        ...
        let deserialize_response_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::DeserializeResponseUpperCamelCase;
        let serde_snake_case_token_stream = naming_constants::SerdeSnakeCase;
        ...
        (
            quote::quote! {
                #deserialize_response_upper_camel_case_token_stream {
                    ...
                    #headers_snake_case: #reqwest_header_header_map_token_stream,
                    #eo_to_std_string_string_serialize_deserialize_token_stream
                    #response_text_snake_case: #std_string_string_token_stream,
                    #code_occurence_snake_case_double_dot_space_error_occurence_lib_code_occurence_code_occurence_token_stream,
                }
            },
            quote::quote! {
                #deserialize_response_upper_camel_case_token_stream {
                    #serde_snake_case_token_stream: #error_snake_case,
                    #status_code_snake_case,
                    #headers_snake_case,
    ...
    let (reqwest_declaration_token_stream, reqwest_initialization_token_stream) = {
        let reqwest_upper_camel_case_token_stream = naming_constants::ReqwestUpperCamelCase;
        let reqwest_snake_case_token_stream = naming_constants::ReqwestSnakeCase;
    ...
    let primary_keys_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeysSnakeCase;
    let primary_key_token_stream = proc_macro_helpers::naming_conventions::PrimaryKeySnakeCase;
    let into_inner_type_vec_snake_case_token_stream = proc_macro_helpers::naming_conventions::IntoInnerTypeVecSnakeCase;
    let (
    ...
    //todo reuse naming
    let not_unique_column_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::NotUniqueColumnUpperCamelCase;
    let not_unique_column_snake_case_token_stream = proc_macro_helpers::naming_conventions::NotUniqueColumnSnakeCase;
    ...
    let get_axum_http_status_code_snake_case_token_stream = proc_macro_helpers::naming_conventions::GetAxumHttpStatusCodeSnakeCase;
    ...
    let body_bytes_snake_case_token_stream = proc_macro_helpers::naming_conventions::BodyBytesSnakeCase;
    ...
    let into_response_snake_case_token_stream = proc_macro_helpers::naming_conventions::IntoResponseSnakeCase;
    let serde_json_to_string_syn_variant = proc_macro_helpers::construct_syn_variant::construct_syn_variant(
        &proc_macro_helpers::naming_conventions::SerdeJsonToStringUpperCamelCase.to_string(),
        &code_occurence_field,
        vec![
            (
                proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
    ...
    let (
        ...
        (
            proc_macro_helpers::construct_syn_variant::construct_syn_variant(
                &proc_macro_helpers::naming_conventions::DeserializeResponseUpperCamelCase.to_string(),
                &code_occurence_field,
                vec![
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
                    ...
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringStringSerializeDeserialize,
                        &proc_macro_helpers::naming_conventions::ResponseTextSnakeCase.to_string(),
                        std_string_string_syn_punctuated_punctuated.clone(),
                    ),
                    (
                        proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
                        &naming_constants::SerdeSnakeCase.to_string(),
                        proc_macro_helpers::generate_simple_syn_punctuated_punctuated::generate_simple_syn_punctuated_punctuated(
                            &["serde_json","Error"],
                            &proc_macro_name_upper_camel_case_ident_stringified
                        ),
    ...
    let reqwest_syn_variant = proc_macro_helpers::construct_syn_variant::construct_syn_variant(
        &naming_constants::ReqwestUpperCamelCase.to_string(),
        &code_occurence_field,
        vec![
            (
                proc_macro_helpers::error_occurence::ErrorOccurenceFieldAttribute::EoToStdStringString,
    ...
    let (check_body_size_syn_variant, check_body_size_syn_variant_initialization_token_stream) = {
        let check_body_size_upper_camel_case_token_stream = proc_macro_helpers::naming_conventions::CheckBodySizeUpperCamelCase;
        let check_body_size_snake_case_token_stream = proc_macro_helpers::naming_conventions::CheckBodySizeSnakeCase;
        ...
        (
            ...
            quote::quote! {
                #check_body_size_upper_camel_case_token_stream {
                    #check_body_size_snake_case_token_stream: #error_snake_case,
            ...
            let try_operation_route_logic_response_token_stream = {
                quote::quote! {
                    pub struct #try_operation_route_logic_response_upper_camel_case_token_stream {
                        #status_code_snake_case: #axum_http_status_code_token_stream,
                        #body_snake_case: #try_operation_route_logic_response_variants_upper_camel_case_token_stream,
                    }
                }
            };
                ...
                quote::quote! {
                    impl #axum_response_into_response_token_stream for #try_operation_route_logic_response_upper_camel_case_token_stream {
                        fn #into_response_snake_case_token_stream(self) -> #axum_response_response_token_stream {
                            let mut res = axum::Json(self.#body_snake_case).#into_response_snake_case_token_stream(); 
            ...
            let try_operation_route_logic_token_stream = {
                ...
                let parameters_logic_token_stream = {
                    let try_or_try_from_operation_payload_upper_camel_case_token_stream = match fields_named_excluding_primary_key_from_or_try_from {
                        postgresql_crud_common::FromOrTryFrom::From => quote::quote! {#operation_payload_upper_camel_case_token_stream::#from_snake_case(value)},
                        postgresql_crud_common::FromOrTryFrom::TryFrom => {
                            ...
                            quote::quote! {
                                match #operation_payload_upper_camel_case_token_stream::try_from(value) {
                                    ...
                                    Err(#error_snake_case) => {
                                        ...
                                        #eprintln_error_token_stream
                                        return #try_operation_route_logic_response_upper_camel_case_token_stream {
                                            #status_code_snake_case: axum::http::StatusCode::CREATED,
                                            #body_snake_case: #try_operation_route_logic_response_variants_upper_camel_case_token_stream::#from_snake_case(#error_snake_case),
                                        };
                                    }
                                }
                            }
                ...
                let query_string_token_stream = {
                    ...
                    let query_stringified = format!(
                        "\"{insert_snake_case_stringified} {into_snake_case_stringified} {table_name_stringified} ({column_names}) {select_snake_case_stringified} {column_names} {from_snake_case} {unnest_snake_case_stringified}({column_increments}) {as_snake_case_stringified} a({column_names}){returning_primary_key_stringified}\""
                    );
                            ...
                            .await
                            {
                                ...
                                Err(error) => {
                                    ...
                                    return #try_operation_route_logic_response_upper_camel_case_token_stream {
                                        ...
                                        body: #try_operation_route_logic_response_variants_upper_camel_case_token_stream::#from_snake_case(error),
                                    };
                                }
                            }
                        } {
    ...
    //                         ),
    //                         Err(#error_snake_case) => {
    //                             let #error_snake_case = #try_operation_upper_camel_case_token_stream::#operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_server_initialization_token_stream;
    //                             #eprintln_error_token_stream
    ...
    //                         Ok(value) => value,
    //                         Err(#error_snake_case) => {
    //                             let #error_snake_case = #try_operation_upper_camel_case_token_stream::#operation_payload_try_from_operation_payload_with_serialize_deserialize_upper_camel_case_token_stream {
    //                                 #operation_payload_try_from_operation_payload_with_serialize_deserialize_snake_case_token_stream: #error_snake_case,
    ...
    //                         Err(#error_snake_case) => {
    //                             return #error_snake_case;//todo convert into return enum mannually
    //                         }
    //                     },
    //                 };
    //                 println!("{:#?}", #parameters_snake_case_token_stream);
    ...
    //             &quote::quote! {
    //                 let #payload_snake_case_token_stream = match #serde_json_to_string_token_stream(&#operation_payload_with_serialize_deserialize_upper_camel_case_token_stream::#from_snake_case(#parameters_snake_case_token_stream.#payload_snake_case_token_stream)) {
    //                     Ok(value) => value,
    //                     Err(#error_snake_case) => {
    ...
    //                 postgresql_crud_common::FromOrTryFrom::From => quote::quote!{Ok(#primary_key_inner_type_token_stream::#from_snake_case(value))},
    //                 postgresql_crud_common::FromOrTryFrom::TryFrom => quote::quote!{
    ...
    //                 let #limit_snake_case_token_stream = #limit_and_offset_type_token_stream::#from_snake_case(value.#limit_snake_case_token_stream);
    //                 let #offset_snake_case_token_stream = #limit_and_offset_type_token_stream::#from_snake_case(value.#offset_snake_case_token_stream);
    //             };
    ...
    //                         let #select_snake_case_token_stream = value.#select_snake_case_token_stream;
    //                         let #order_by_snake_case_token_stream = value.#order_by_snake_case_token_stream;
    //                         let #limit_snake_case_token_stream = #limit_and_offset_type_with_serialize_deserialize_token_stream::#from_snake_case(value.#limit_snake_case_token_stream);//todo reuse
    //                         let #offset_snake_case_token_stream = #limit_and_offset_type_with_serialize_deserialize_token_stream::#from_snake_case(value.#offset_snake_case_token_stream);//todo reuse
    //                         Self{
    //                             #(#fields_named_idents_comma_token_stream)*
    //                             #select_snake_case_token_stream,
    //                             #order_by_snake_case_token_stream,
    ...
    //                             let #error_snake_case = #try_operation_upper_camel_case_token_stream::#not_unique_primary_key_variant_initialization_token_stream;
    //                             #eprintln_error_token_stream
    //                             return #try_operation_response_variants_token_stream::#from_snake_case(#error_snake_case);
    //                         }
    //                     }
    ...
    //                                                 #where_inner_type_with_serialize_deserialize_token_stream::#from_snake_case(element)
    //                                             ).collect()
    //                                         };
    ...
    //                     &#operation_payload_with_serialize_deserialize_upper_camel_case_token_stream::#from_snake_case(#parameters_snake_case_token_stream.#payload_snake_case_token_stream)
    //                 ) {
    //                     Ok(value) => value,
    //                     Err(#error_snake_case) => {
    //                         return Err(#try_operation_error_named_upper_camel_case_token_stream::#serde_json_to_string_variant_initialization_token_stream);
    ...
    //                         quote::quote! {
    //                             let #field_ident = match value.#field_ident {
    //                                 Some(value) => Some(#inner_type_token_stream::#from_snake_case(value)),
    //                                 None => None,
    //                             };
    //                         }
    //                     });
    ...
    //                         quote::quote! {
    //                             let #field_ident = match value.#field_ident {
    //                                 Some(value) => Some(#inner_type_with_serialize_deserialize_token_stream::#from_snake_case(value)),
    //                                 None => None,
    ...
    //             primary_key_inner_type_token_stream,
    //             &quote::quote! {
    //                 let #payload_snake_case_token_stream = match #serde_json_to_string_token_stream(&#operation_payload_with_serialize_deserialize_upper_camel_case_token_stream::#from_snake_case(
    //                     #parameters_snake_case_token_stream.#payload_snake_case_token_stream
    //                 )) {
    //                     Ok(value) => value,
    //                     Err(#error_snake_case) => {
    ...
    //                     match #primary_key_inner_type_token_stream::try_from(value) {
    //                         Ok(value) => Ok(value),
    //                         Err(#error_snake_case) => Err(#try_operation_error_named_upper_camel_case_token_stream::#operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_client_one_initialization_token_stream )
    //                     }
    //                 }
    //             },
    //             &table_name_stringified,
    ...
    //                             Ok(value) => value,
    //                             Err(#error_snake_case) => {
    //                                 let #error_snake_case = #try_operation_upper_camel_case_token_stream::#from_snake_case(#error_snake_case);
    //                                 #eprintln_error_token_stream
    //                                 return #try_operation_response_variants_token_stream::#from_snake_case(#error_snake_case);
    //                             }
    //                         }
...
fn generate_http_request_many_token_stream(
    ...
    operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_client_error_unnamed_upper_camel_case_token_stream: &proc_macro_helpers::naming_conventions::OperationDoneButPrimaryKeyInnerTypeTryFromPrimaryKeyInnerTypeWithSerializeDeserializeFailedInClientErrorUnnamedUpperCamelCase,
    operation_done_but_primary_key_inner_type_try_from_primary_key_inner_type_with_serialize_deserialize_failed_in_client_upper_camel_case_token_stream: &proc_macro_helpers::naming_conventions::OperationDoneButPrimaryKeyInnerTypeTryFromPrimaryKeyInnerTypeWithSerializeDeserializeFailedInClientUpperCamelCase,
    ...
    let server_location_snake_case = proc_macro_helpers::naming_conventions::ServerLocationSnakeCase;
...
fn generate_let_field_ident_value_field_ident_try_from_token_stream(//todo rename
    ...
    primary_key_supported_sqlx_postgres_type_snake_case_token_stream: &proc_macro2::TokenStream,
    from_snake_case: &naming_constants::FromSnakeCase,
) -> proc_macro2::TokenStream {
    let field_ident = &element.field_ident;
    let inner_token_stream = quote::quote! {value.#field_ident};
    let initialization_token_stream = {
...
fn generate_let_field_ident_value_inner_type_with_serialize_deserialize_from_token_stream(
    ...
    let inner_type_with_serialize_deserialize_token_stream = &element.inner_type_with_serialize_deserialize_token_stream;
    quote::quote! {
        let #field_ident = #inner_type_with_serialize_deserialize_token_stream::#from_snake_case(value.#field_ident);//todo from or try_from
    }
}
...
fn generate_let_field_ident_value_option_vec_with_serialize_deserialize_token_stream(
    ...
    quote::quote! {
        let #field_ident = match value.#field_ident {
            Some(value) => Some(value.into_iter().map(|element|#where_inner_type_with_serialize_deserialize_token_stream::#from_snake_case(element)).collect()),
            None => None
        };
    }
}
...
fn generate_error_occurence_variant_token_stream(
    ...
    let fields_mapped_into_token_stream = fields_named.named.iter().map(|field|{
        ...
        let error_occurence_attribute = if *field_ident == *proc_macro_helpers::naming_conventions::CodeOccurenceSnakeCase.to_string() {
            proc_macro2::TokenStream::new()
        }
        else {
