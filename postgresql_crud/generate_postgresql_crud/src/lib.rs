...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let from_snake_case_token_stream = naming_constants::FromSnakeCase;
    ...
    let primary_key_try_get_sqlx_row_token_stream = {
        ...
        let row_name_token_stream = naming_constants::RowSnakeCase;
    ...
    let from_snake_case_stringified =
        naming_constants::FromSnakeCase;
                    ...
                    let impl_std_convert_from_operation_payload_element_with_serialize_deserialize_for_operation_payload_element_token_stream = {
                        let fields_assignment_excluding_primary_key_token_stream = fields_named_excluding_primary_key.iter()
                            .map(|element| generate_let_field_ident_value_inner_type_from_token_stream(
                                element,
                                &quote::quote! {#from_snake_case_token_stream},
                            ));
                        quote::quote! {
                                ...
                                match #operation_payload_upper_camel_case_token_stream::try_from(value) {
                                    ...
                                    Err(#error_snake_case) => {
                                        ...
                                        return #try_operation_route_logic_response_upper_camel_case_token_stream {
                                            ...
                                            #body_snake_case: #try_operation_route_logic_response_variants_upper_camel_case_token_stream::#from_snake_case_token_stream(#error_snake_case),
                                        };
                                    }
                                }
                            }
    ...
    //                             #eprintln_error_token_stream
    //                             return #try_operation_response_variants_token_stream::#from_snake_case_token_stream(#error_snake_case);
    //                         }
    //                     },
    //                     Err(#error_snake_case) => {
    //                         #from_log_and_return_error_token_stream
    ...
    //                                     Err(#error_snake_case) => Err(Self::Error::#from_snake_case_token_stream(#error_snake_case)),
    //                                 }
    //                             }
    //                         }
    //                     };
    ...
    //                             Ok(value) => value,
    //                             Err(#error_snake_case) => {
    //                                 let #error_snake_case = #try_operation_upper_camel_case_token_stream::#from_snake_case_token_stream(#error_snake_case);
    //                                 #eprintln_error_token_stream
    //                                 return #try_operation_response_variants_token_stream::#from_snake_case_token_stream(#error_snake_case);
    //                             }
    //                         }
