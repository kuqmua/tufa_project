...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_query_vec_column_token_stream = {
        ...
        quote::quote! {
            fn #generate_query_vec_column_snake_case_token_stream(#value_snake_case: &[#ident_column_upper_camel_case_token_stream]) -> #std_string_string {
                let mut #value_snake_case = #value_snake_case.iter().fold(#std_string_string::#from_snake_case(""), |mut acc, #element_snake_case| {
                    acc += match #element_snake_case {
            ...
            quote::quote! {
                #ident_column_upper_camel_case_token_stream::#primary_key_field_ident_upper_camel_case_token_stream => {
                    #primary_key_field_ident = {
                        let #value_snake_case: std::option::Option<#primary_key_original_type_token_stream> = #row_snake_case.try_get(#primary_key_field_ident_string_quotes_token_stream)?;
                        #value_snake_case.map(|#value_snake_case|postgresql_crud::Value{ #value_snake_case: #primary_key_inner_type_with_serialize_deserialize_token_stream::from(#primary_key_inner_type_token_stream(#value_snake_case))})
                    };
                }
            }
        };
        let assignment_variants_excluding_primary_key_token_stream = fields_named_excluding_primary_key.iter().map(|element|{
            ...
            quote::quote! {
                #ident_column_upper_camel_case_token_stream::#field_ident_upper_camel_case_token_stream => {
                    #field_ident = {
                        let #value_snake_case: std::option::Option<#original_type_token_stream> = #row_snake_case.try_get(#field_ident_string_quotes_token_stream)?;
                        #value_snake_case.map(|#value_snake_case|postgresql_crud::Value{ #value_snake_case: #inner_type_with_serialize_deserialize_token_stream::#from_snake_case(#inner_type_token_stream(#value_snake_case))})
                    };
                }
            }
        }).collect::<std::vec::Vec<proc_macro2::TokenStream>>();
    ...
    let (
        ...
        (
            proc_macro_helpers::construct_syn_variant::construct_syn_variant_with_status_code(
                row_and_rollback_syn_variant_status_code.clone(),
            ...
            ),
            {
                ...
                quote::quote! {
                    #row_and_rollback_upper_camel_case {
                        #row_snake_case: #error_snake_case,
                        #rollback_snake_case,
    ...
    let (
        ...
        (
            ...
            |element_value_token_stream: &proc_macro2::TokenStream|{
                ...
                quote::quote! {
                    #not_unique_primary_key_upper_camel_case {
                        #not_unique_primary_key_snake_case: #element_value_token_stream,
                        ...
                        match element.rust_sqlx_map_to_postgres_type_variant.inner_type_from_or_try_from_inner_type_with_serialize_deserialize() {
                            ...
                            postgresql_crud_common::FromOrTryFrom::TryFrom => {
                                ...
                                let field_ident_snake_case_token_stream = {
                                    //todo its a temporal naming desicion. maybe it can be better
                                    let value = syn_ident_to_snake_case_stringified(element.field_ident);
                                    value.parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name_upper_camel_case_ident_stringified} {value} {}", proc_macro_common::constants::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
                                };
                                quote::quote!{
    ...
    let generate_filter_no_payload_fields_token_stream = |operation: &Operation, source_token_stream: &proc_macro2::TokenStream|{
        ...
        quote::quote! {
            if let (#(#none_fields_named_excluding_primary_key_token_stream),*) = (#(#match_fields_named_excluding_primary_key_token_stream),*) {
                let #primary_key_field_ident = #source_token_stream.#primary_key_field_ident;
                #error_initialization_eprintln_response_creation_token_stream
            }
        }
    };
    let postgres_transaction_snake_case = naming_conventions::PostgresTransactionSnakeCase;
    let generate_postgres_transaction_token_stream = |operation: &Operation|{
    ...
    let generate_commit_token_stream = |operation: &Operation|{
        ...
        quote::quote!{
            if let Err(#error_snake_case) = #postgres_transaction_snake_case.#commit_snake_case().await {
                #postgresql_syn_variant_error_initialization_eprintln_response_creation_token_stream
            }
        }
    };
    let expected_primary_keys_snake_case = naming_conventions::ExpectedPrimaryKeysSnakeCase;
    let results_vec_snake_case = naming_conventions::ResultsVecSnakeCase;
    ...
    |{
        ...
        quote::quote!{
            let #value_snake_case = #expected_primary_keys_token_stream.into_iter().fold(std::vec::Vec::new(),|mut acc, #element_snake_case| {
    ...
    let (read_many_token_stream, read_many_test_token_stream) = {
                ...
                let parameters_logic_token_stream = generate_parameters_logic_token_stream(
                   ...
                   &{
                        let filter_not_unique_fields_token_stream = {
                            ...
                            let filter_not_unique_fields_named_excluding_primary_key_token_stream = fields_named_excluding_primary_key.iter().map(|element| {
        ...
        let (try_operation_token_stream, try_operation_test_token_stream) = {
            let try_operation_error_named_token_stream = generate_try_operation_error_named_token_stream(
                ...
                &{
                    let mut value = common_http_request_syn_variants.clone();
                    value.push(not_unique_primary_key_syn_variant.clone());
                    not_unique_fields_syn_variants.iter().for_each(|element|{
            ...
            let try_operation_token_stream = generate_try_operation_token_stream(
                ...
                &match fields_named_from_or_try_from {
                    ...
                    postgresql_crud_common::FromOrTryFrom::TryFrom => quote::quote!{
                        #value_snake_case
                        .into_iter()
                        .fold(std::vec::Vec::new(), |mut acc, #element_snake_case| {
                            acc.push(#element_snake_case);
                            acc
                        })
                    }
    ...
    let (update_many_token_stream, update_many_test_token_stream) = {
        ...
        let not_unique_primary_key_syn_variant_initialization_token_stream = generate_not_unique_primary_key_syn_variant_initialization_token_stream(&quote::quote!{#element_snake_case.#primary_key_field_ident.clone()});
        let type_variants_from_request_response_syn_variants = generate_type_variants_from_request_response_syn_variants(
            &{
        ...
        let try_operation_route_logic_token_stream = {
            ...
            let try_operation_route_logic_token_stream = {
                ...
                let postgresql_logic_token_stream = {
                    let postgres_transaction_token_stream = generate_postgres_transaction_token_stream(&operation);
                    let postgresql_syn_variant_error_initialization_eprintln_response_creation_token_stream = generate_error_initialization_eprintln_response_creation_token_stream(
                        &operation,
                        &postgresql_syn_variant_initialization_token_stream,
                        &quote::quote! {#from_snake_case(#error_snake_case)},
    ...
    let (delete_many_token_stream, delete_many_test_token_stream) = {
        ...
        let (
            ...
            let no_primary_keys_upper_camel_case = naming_conventions::NoPrimaryKeysUpperCamelCase;
            let no_primary_keys_syn_variant_status_code = proc_macro_helpers::status_code::StatusCode::BadRequest400;
            (
                proc_macro_helpers::construct_syn_variant::construct_syn_variant_with_status_code_only_code_occurence(
                    no_primary_keys_syn_variant_status_code.clone(),
                    &no_primary_keys_upper_camel_case,
                    &proc_macro_name_upper_camel_case_ident_stringified,
                ),
                {
                    let field_code_occurence_new_93399f92_7f5c_47b6_af6f_a527753050f8_token_stream = proc_macro_helpers::generate_field_code_occurence_new_token_stream::generate_field_code_occurence_new_token_stream(
                        file!(),
                        line!(),
                        column!(),
                        &proc_macro_name_upper_camel_case_ident_stringified,
                    ...
                    quote::quote! {
                        #no_primary_keys_upper_camel_case {
                            #field_code_occurence_new_93399f92_7f5c_47b6_af6f_a527753050f8_token_stream
                        }
                    }
                },
                no_primary_keys_syn_variant_status_code
        ...
        let try_operation_route_logic_token_stream = {
            ...
            let try_operation_route_logic_token_stream = {
                let parameters_logic_token_stream = generate_parameters_logic_token_stream(
                    ...
                    &{
                        let filter_no_payload_fields_token_stream = {
                            ...
                            let value_fields_named_token_stream = fields_named.iter().map(|element|{
                                let field_ident = &element.field_ident;
                        ...
                        let filter_no_primary_keys_token_stream = {
                            let no_primary_keys_syn_variant_error_initialization_eprintln_response_creation_token_stream = generate_error_initialization_eprintln_response_creation_token_stream(
                                ...
                                &no_primary_keys_syn_variant_initialization_token_stream,
                                &quote::quote! {#from_snake_case(#error_snake_case)},
                                &no_primary_keys_syn_variant_status_code.to_axum_http_status_code_token_stream(),
                                &eprintln_error_token_stream,
                            );
                            quote::quote!{
                ...
                let postgresql_logic_token_stream = {
                    ...
                    //                 let #error_snake_case = #try_operation_upper_camel_case_token_stream::#not_unique_primary_keys_syn_variant_initialization_token_stream;
                    //                 #eprintln_error_token_stream
    ...
    let (delete_one_token_stream, delete_one_test_token_stream) = {
        ...
        let parameters_token_stream = {
            let (
                ...
                let payload_token_stream = generate_operation_payload_token_stream(
                    &operation,
                    &token_patterns::DeriveDebugCloneCopy,
                    &generate_fields_token_stream(true)
                );
                // println!("{payload_token_stream}");
                let payload_with_serialize_deserialize_token_stream = generate_payload_with_serialize_deserialize_token_stream(
...
fn syn_ident_to_snake_case_stringified(value: &syn::Ident) -> std::string::String {
    proc_macro_common::naming_conventions::ToSnakeCaseStringified::to_snake_case_stringified(&value.to_string())
}
...
fn generate_let_field_ident_value_field_ident_try_from_token_stream(//todo rename
    ...
    proc_macro_name_upper_camel_case_ident_stringified: &str,
    field_code_occurence_new_token_stream: &proc_macro2::TokenStream,
    field_ident_token_stream: &proc_macro2::TokenStream,
) -> proc_macro2::TokenStream {
    let field_ident = &element.field_ident;
    ...
    let initialization_token_stream = {
        ...
        match element.rust_sqlx_map_to_postgres_type_variant.inner_type_from_or_try_from_inner_type_with_serialize_deserialize() {
            ...
            postgresql_crud_common::FromOrTryFrom::TryFrom => {
                ...
                let field_ident_upper_camel_case_token_stream = {
                    //todo its a temporal naming desicion. maybe it can be better
                    let value = syn_ident_to_upper_camel_case_stringified(field_ident);
                    value.parse::<proc_macro2::TokenStream>()
                    .unwrap_or_else(|_| panic!("{proc_macro_name_upper_camel_case_ident_stringified} {value} {}", proc_macro_common::constants::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
                };
                quote::quote!{
                    match #inner_type_token_stream::#try_from_snake_case(#inner_token_stream) {
                        ...
                        Err(#error_snake_case) => {
                            return Err(Self::Error::#field_ident_upper_camel_case_token_stream {
                                #field_ident_token_stream: #error_snake_case,
                                #field_code_occurence_new_token_stream
                            });
                        }
                    }
...
fn generate_inner_type_from_or_try_from_inner_type_with_serialize_deserialize_error_variant_vec_token_stream(value: &[SynFieldWithAdditionalInfo<'_>]) -> std::vec::Vec<proc_macro2::TokenStream> {
...
fn generate_operation_payload_token_stream(
    operation: &Operation,
    derive_token_stream: &impl quote::ToTokens,
...
fn generate_impl_std_convert_from_self_payload_element_with_serialize_deserialize_for_self_payload_element_token_stream(
    operation: &Operation,
    content_token_stream: &proc_macro2::TokenStream,
) -> proc_macro2::TokenStream {
    proc_macro_helpers::generate_impl_std_convert_from_token_stream::generate_impl_std_convert_from_token_stream(
...
fn generate_impl_std_convert_try_from_self_payload_with_serialize_deserialize_for_self_payload_token_stream(
    operation: &Operation,
    content_token_stream: &proc_macro2::TokenStream,
) -> proc_macro2::TokenStream {
...
fn generate_impl_std_convert_from_operation_payload_element_for_operation_payload_element_with_serialize_deserialize_and_from_operation_payload_upper_camel_case_token_stream_for_operation_payload_with_serialize_deserialize_token_stream(
    operation: &Operation,
