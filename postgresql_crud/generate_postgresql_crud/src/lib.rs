...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let fields_named_wrappers_excluding_primary_key = fields_named
        .clone()
        .into_iter()
        .filter(|element| element.field != primary_key_syn_field_with_additional_info.field)
        .map(|element| SynFieldWithAdditionalInfo::from(element))
        .collect::<std::vec::Vec<SynFieldWithAdditionalInfo>>();
    ...
    let column_token_stream = {
        let column_variants = fields_named
            .iter()
            .map(|element| {
                let field_ident_stringified = element.field.ident
                    .as_ref()
                    .unwrap_or_else(|| {
    ...
    let not_unique_vec_syn_variants: std::vec::Vec<syn::Variant> = fields_named.iter().fold(std::vec::Vec::with_capacity(fields_named_len - 1), |mut acc, element| {
        let field_ident = element.field.ident.as_ref().unwrap_or_else(|| {
            panic!(
                "{proc_macro_name_upper_camel_case_ident_stringified} {}",
    ...
    let (create_one_token_stream, create_one_http_request_test_token_stream) = {
        ...
        let try_operation_error_with_middleware_error_variants_token_stream = crate::type_variants_from_request_response_generator::type_variants_from_request_response_generator(
            &desirable_status_code,
            &primary_key_inner_type_with_serialize_deserialize_token_stream,//crate_server_postgres_uuid_wrapper_possible_uuid_wrapper_token_stream
            &derive_debug_thiserror_error_occurence_token_stream,
            &derive_debug_serialize_deserialize_token_stream,
            &derive_debug_serialize_deserialize_to_schema_token_stream,
            &type_variants_from_request_response_syn_variants,
        ...
        let parameters_token_stream = {
            ...
            let impl_std_convert_try_from_operation_payload_with_serialize_deserialize_for_operation_payload_token_stream = {
                ...
                let operation_payload_try_from_operation_payload_with_serialize_deserialize_error_named_token_stream = {
                    ...
                    let fields_named_wrappers_excluding_primary_key_operation_payload_element_try_from_operation_payload_element_with_serialize_deserialize_error_named_upper_camel_case_token_stream = fields_named_wrappers_excluding_primary_key.iter().map(|element|
                        ...
                        > for #operation_payload_try_from_operation_payload_with_serialize_deserialize_error_named_upper_camel_case_token_stream {
                            fn from(value: #operation_payload_element_try_from_operation_payload_element_with_serialize_deserialize_error_named_upper_camel_case_token_stream) -> Self {
                                match value {
                                    ...
                                    #(#fields_named_wrappers_excluding_primary_key_operation_payload_element_try_from_operation_payload_element_with_serialize_deserialize_error_named_upper_camel_case_token_stream)*
                                }
                            }
                        }
                    }
    ...
    let (delete_many_token_stream, delete_many_http_request_test_token_stream) = {
        ...
        let parameters_token_stream = {
            ...
            let impl_std_convert_try_from_operation_payload_with_serialize_deserialize_for_operation_payload_token_stream = {
                ...
                let impl_std_convert_try_from_operation_payload_with_serialize_deserialize_for_operation_payload_token_stream = {
                    ...
                    let primary_key_inner_type_token_stream = &primary_key_syn_field_with_additional_info.inner_type_token_stream;
                    let inner_type_with_serialize_deserialize_error_named_token_stream = &&primary_key_syn_field_with_additional_info.inner_type_with_serialize_deserialize_error_named_token_stream;
                    //todo maybe use where with conjuctive operator
                    let primary_key_let_field_ident_value_field_ident_try_from_token_stream = {
                        let field_ident = &primary_key_syn_field_with_additional_info.field_ident;
                        let inner_token_stream = quote::quote! {value.#field_ident};
                        let inner_type_token_stream = &primary_key_syn_field_with_additional_info.inner_type_token_stream;
                        let initialization_token_stream = match primary_key_syn_field_with_additional_info.rust_sqlx_map_to_postgres_type_variant.inner_type_from_or_try_from_inner_type_with_serialize_deserialize() {
                            postgresql_crud_common::FromOrTryFrom::From => quote::quote!{
                                match #inner_token_stream {
                                    Some(value) => Some(value.into_iter().map(|element|#inner_type_token_stream::from(element)).collect()),
                                    None => None,
                                }
                            },
                            postgresql_crud_common::FromOrTryFrom::TryFrom => {
                                ...
                                let field_ident_upper_camel_case_token_stream = {
                                    ...
                                    let value_stringified = syn_ident_to_upper_camel_case_stringified(&primary_key_syn_field_with_additional_info.field_ident);
                                    value_stringified.parse::<proc_macro2::TokenStream>()
                                ...
                                let postgresql_crud_common_supported_sqlx_postgres_type_snake_case_token_stream = {
                                    let value_stringified = proc_macro_common::naming_conventions::ToSnakeCaseStringified::to_snake_case_stringified(
                                        &postgresql_crud_common::SupportedSqlxPostgresType::from(&primary_key_syn_field_with_additional_info.rust_sqlx_map_to_postgres_type_variant)
                                    );
                                    value_stringified.parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{value_stringified} {}", proc_macro_common::global_variables::hardcode::PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE))
                                };
        ...
        let (http_request_token_stream, http_request_test_token_stream) = {
            ...
            let http_request_token_stream = generate_http_request_many_token_stream(
                ...
                &commit_header_addition_token_stream,
                &content_type_application_json_header_addition_token_stream,
                &primary_key_syn_field_with_additional_info.inner_type_token_stream,
                &operation_done_but_cannot_convert_uuid_wrapper_from_possible_uuid_wrapper_in_client_error_unnamed_upper_camel_case_token_stream,
                &operation_done_but_cannot_convert_uuid_wrapper_from_possible_uuid_wrapper_in_client_upper_camel_case_token_stream,
                &operation_done_but_cannot_convert_uuid_wrapper_from_possible_uuid_wrapper_in_client_many_initialization_token_stream,
                &table_name_stringified,
...
// fn generate_let_field_where_ident_value_field_where_ident_with_serialize_deserialize_try_from_token_stream(
//     element: &SynFieldWithAdditionalInfo,
//     proc_macro_name_upper_camel_case_ident_stringified: &str,
//     field_code_occurence_new_token_stream: &proc_macro2::TokenStream,
// ) -> proc_macro2::TokenStream {
...
//             postgresql_crud_common::FromOrTryFrom::From => {
//                 let from_snake_case_token_stream = proc_macro_helpers::naming_conventions::from_snake_case_token_stream();
//                 quote::quote!{#where_inner_type_token_stream::#from_snake_case_token_stream(#inner_token_stream)}
//             },
//             postgresql_crud_common::FromOrTryFrom::TryFrom => {
//                 let try_from_snake_case_token_stream = proc_macro_helpers::naming_conventions::try_from_snake_case_token_stream();
//                 let postgresql_crud_common_supported_sqlx_postgres_type_snake_case_token_stream = {
...
//                 };
//                 quote::quote!{
//                     match #where_inner_type_token_stream::#try_from_snake_case_token_stream(#inner_token_stream) {
//                         Ok(value) => value,
//                         Err(e) => {
//                             return Err(Self::Error::#field_ident_upper_camel_case_token_stream {
//                                 #postgresql_crud_common_supported_sqlx_postgres_type_snake_case_token_stream: e,
...
fn generate_inner_type_from_or_try_from_inner_type_with_serialize_deserialize_error_variant_token_stream(
    ...
    match value.rust_sqlx_map_to_postgres_type_variant.inner_type_from_or_try_from_inner_type_with_serialize_deserialize() {
        ...
        postgresql_crud_common::FromOrTryFrom::TryFrom => {
            let postgresql_crud_common_supported_sqlx_postgres_type = postgresql_crud_common::SupportedSqlxPostgresType::from(&value.rust_sqlx_map_to_postgres_type_variant);
            let postgresql_crud_common_supported_sqlx_postgres_type_snake_case_token_stream = {
                let value_stringified = proc_macro_common::naming_conventions::ToSnakeCaseStringified::to_snake_case_stringified(
        ...
        postgresql_crud_common::FromOrTryFrom::TryFrom => {
            ...
            quote::quote!{
                #operation_payload_element_try_from_operation_payload_element_with_serialize_deserialize_error_named_upper_camel_case_token_stream::#field_ident_upper_camel_case_token_stream {
                    #postgresql_crud_common_supported_sqlx_postgres_type_snake_case_token_stream,
                    #code_occurence_snake_case_token_stream,
        ...
        postgresql_crud_common::FromOrTryFrom::TryFrom => {
            ...
            quote::quote!{
                #field_ident_upper_camel_case_token_stream {
                    ...
                    #postgresql_crud_common_supported_sqlx_postgres_type_snake_case_token_stream: #where_with_serialize_deserialize_error_named_token_stream,
                    #code_occurence_snake_case_double_dot_space_error_occurence_lib_code_occurence_code_occurence_token_stream,
                },//must use comma here
            }
        }
