    ...
    let update_many_token_stream = {
        ...
        let try_operation_route_logic_token_stream = {
            ...
            let try_operation_route_logic_token_stream = {
                                    ...
                                    for #element_snake_case in &#parameters_snake_case.#payload_snake_case.0 {
                                        if let Some(#value_snake_case) = &#element_snake_case.#field_ident {
                                            #acc_snake_case.push_str(&format!(
                                                ...
                                                match <#primary_key_field_type as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::#self_to_update_query_part_snake_case(
                                               ...
                                               match <#field_type as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::#self_to_update_query_part_snake_case(
                ...
                // println!("{query_string_token_stream}");
                let binded_query_token_stream = {
                    let self_to_update_bind_query_part_snake_case = naming::SelfToUpdateBindQueryPartSnakeCase;
                    let fields_named_excluding_primary_key_update_assignment_token_stream = fields_without_primary_key.iter().map(|element| {
                        let field_ident = &element.field_ident;
                        let field_type = &element.syn_field.ty;
                        let is_field_ident_update_exists_snake_case = naming::parameter::IsSelfUpdateExistSnakeCase::from_tokens(&field_ident);
                                ...
                                if #is_field_ident_update_exists_snake_case {
                                    for #element_snake_case in &#parameters_snake_case.#payload_snake_case.0 {
                                        if let Some(#value_snake_case) = &#element_snake_case.#field_ident {
                                            ...
                                            <#field_type as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::#self_to_update_bind_query_part_snake_case(
                    ...
                    let primary_key_update_assignment_token_stream = quote::quote! {
                        {
                            for #element_snake_case in &#parameters_snake_case.#payload_snake_case.0 {
                                ...
                                <#primary_key_field_type as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::#self_to_update_bind_query_part_snake_case(
                ...
                let binded_query_token_stream = {
                    ...
                    let binded_query_modifications_token_stream = fields_without_primary_key.iter().map(|element| {
                        ...
                        quote::quote! {
                            if let Some(#value_snake_case) = #parameters_snake_case.#payload_snake_case.#field_ident {
                                ...
                                //     #query_snake_case,
                                // );
                                #query_snake_case = <#field_type as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::#self_to_update_bind_query_part_snake_case(
                                    #value_snake_case.#value_snake_case,
                                    #query_snake_case,
                                );
                            }
                    ...
                    let binded_query_primary_key_modification_token_stream = {
                        ...
                        quote::quote! {
                            ...
                            //     #query_snake_case,
                            // );
                            #query_snake_case = <#primary_key_field_type as postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlType>::#self_to_update_bind_query_part_snake_case(
                                #parameters_snake_case.#payload_snake_case.#primary_key_field_ident,
                                #query_snake_case,
                            );
                        }
