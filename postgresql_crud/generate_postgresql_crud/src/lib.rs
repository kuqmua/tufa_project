...
pub fn generate_postgresql_crud(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let some_value_primary_key_read_returned_from_create_one_snake_case = naming::SomeValuePrimaryKeyReadReturnedFromCreateOneSnakeCase;
    ...
    let primary_key_read_returned_from_create_one_snake_case = naming::PrimaryKeyReadReturnedFromCreateOneSnakeCase;
    ...
    | -> proc_macro2::TokenStream {
        ...
        let request_parts_preparation_token_stream = {
            let header_content_type_application_json_not_found_syn_variant_wrapper_error_initialization_eprintln_response_creation_token_stream =
                &generate_operation_error_initialization_eprintln_response_creation_token_stream(operation, &header_content_type_application_json_not_found_syn_variant_wrapper, file!(), line!(), column!());
    ...
    let create_one_token_stream = {
        ...
        let operation_token_stream = {
            ...
            let operation_token_stream = {
                ...
                let postgresql_logic_token_stream = wrap_content_into_postgresql_transaction_begin_commit_value_token_stream(&operation, &generate_create_update_delete_one_fetch_token_stream(&CreateOneOrUpdateOneOrDeleteOne::CreateOne));
                generate_operation_token_stream(
                    &operation,
                    &common_additional_logic_token_stream,
                    &parameters_logic_token_stream,
    ...
    let update_one_token_stream = {
        ...
        let operation_token_stream = {
            ...
            let operation_token_stream = {
                ...
                let postgresql_logic_token_stream = wrap_content_into_postgresql_transaction_begin_commit_value_token_stream(&operation, &generate_create_update_delete_one_fetch_token_stream(&CreateOneOrUpdateOneOrDeleteOne::UpdateOne));
                generate_operation_token_stream(
                    &operation,
                    &common_additional_logic_token_stream,
                    &parameters_logic_token_stream,
    ...
    let ident_tests_token_stream = {
        ...
        let update_try_new_parameters_declaration_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
            let field_ident_test_cases_snake_case = naming::parameter::SelfTestCasesSnakeCase::from_tokens(&element.field_ident);
            let field_ident_some_value_update_snake_case = naming::parameter::SelfSomeValueUpdateSnakeCase::from_tokens(&element.field_ident);
            let field_type = &element.syn_field.ty;
            quote::quote! {
        ...
        let update_try_new_parameters_cloned_token_stream = generate_fields_named_without_primary_key_with_comma_token_stream(&|element: &SynFieldWrapper| {
            let field_ident_some_value_update_snake_case = naming::parameter::SelfSomeValueUpdateSnakeCase::from_tokens(&element.field_ident);
        ...
        let ident_select_columns_token_stream = generate_fields_named_with_comma_token_stream(&|element: &SynFieldWrapper| {
            let field_ident_upper_camel_case = naming::ToTokensToUpperCamelCaseTokenStream::case_or_panic(&element.field_ident);
            let field_type = &element.syn_field.ty;
            quote::quote! {
        ...
        let ident_read_fields_declaration_token_stream = generate_fields_named_without_primary_key_without_comma_token_stream(&|element: &SynFieldWrapper| {
            let field_ident = &element.field_ident;
            let field_ident_test_cases_snake_case = naming::parameter::SelfTestCasesSnakeCase::from_tokens(&field_ident);
            let field_ident_some_value_read_snake_case = naming::parameter::SelfSomeValueReadSnakeCase::from_tokens(&field_ident);
            let field_type = &element.syn_field.ty;
            quote::quote! {
        ...
        let ident_read_fields_cloned_token_stream = generate_fields_named_without_primary_key_with_comma_token_stream(&|element: &SynFieldWrapper| {
            let field_ident = &element.field_ident;
            let field_ident_some_value_read_snake_case = naming::parameter::SelfSomeValueReadSnakeCase::from_tokens(&field_ident);
            quote::quote! {#field_ident: #field_ident_some_value_read_snake_case.clone()}
        });
        let ident_read_fields_token_stream = generate_fields_named_without_primary_key_with_comma_token_stream(&|element: &SynFieldWrapper| {
            let field_ident = &element.field_ident;
            let field_ident_some_value_read_snake_case = naming::parameter::SelfSomeValueReadSnakeCase::from_tokens(&field_ident);
                    ...
                    std::thread::Builder::new()
                        ...
                        .spawn(|| {
                            tokio::runtime::Builder::new_multi_thread().worker_threads(num_cpus::get()).enable_all().build().expect("error 38823c21-1879-449c-9b60-ce7293709959").block_on(async {
                                ...
                                let #primary_key_read_returned_from_create_one_snake_case = super::#ident::try_create_one(
                                    &#url_snake_case,
                                ...
                                assert_eq!(
                                    super::#ident_read_upper_camel_case {
                                        #primary_key_field_ident: #some_value_primary_key_read_returned_from_create_one_snake_case.clone(),
                                        #fields_none_initialization_token_stream
                                    },
                                    super::#ident::try_read_one(
                                        ...
                                        super::#ident_read_one_parameters_upper_camel_case {
                                            #payload_snake_case: super::#ident_read_one_payload_upper_camel_case {
                                                #primary_key_field_ident: #primary_key_read_returned_from_create_one_snake_case.clone(),
                                                #select_snake_case: #select_primary_key_snake_case.clone(),
                                            },
                                        },
                                    )
                                ...
                                for #index_snake_case in #test_cases_max_len_token_stream {
                                    ...
                                    // assert_eq!(
                                    //     {
                                    //         let left = #sort_vec_of_ident_read_with_primary_key_by_primary_key_snake_case({
                                    //             let #generate_element_snake_case = |#value_snake_case: #primary_key_field_type_as_postgresql_type_read_token_stream|{
                                    //                 super::#ident_read_upper_camel_case {
                                    ...
                                    //     },
                                    //     {
                                    //         let right = #sort_vec_of_ident_read_with_primary_key_by_primary_key_snake_case(super::#ident::try_read_many(
                                    //                 &#url_snake_case,
                                    //                 super::#ident_read_many_parameters_upper_camel_case {
                                    //                     #payload_snake_case: {
                                    ...
                                    // );
                                    assert_eq!(
                                        #primary_key_read_returned_from_create_one_snake_case.clone(),
                                    ...
                                    assert_eq!(
                                        super::#ident_read_upper_camel_case {
                                            #primary_key_field_ident: match #some_value_primary_key_read_returned_from_create_one_snake_case.clone() {
                                                Some(#value_snake_case) => Some(postgresql_crud::Value {
                                ...
                                //         #payload_snake_case: super::#ident_delete_one_payload_upper_camel_case { #primary_key_field_ident: #primary_key_read_returned_from_create_one_snake_case.clone() },
                                //     },
                                // )
                                // .await
                                ...
                                //     super::#ident_read_one_parameters_upper_camel_case {
                                //         #payload_snake_case: super::#ident_read_one_payload_upper_camel_case {
                                //             #primary_key_field_ident: #primary_key_read_returned_from_create_one_snake_case,
                                //             #select_snake_case: #select_primary_key_snake_case.clone(),
                                //         },
                                //     },
                                // ).await &&
