...
pub fn generate_postgresql_query_part(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
                    ...
                    __D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                            ...
                            __A: serde::de::SeqAccess<'de>,
                        {
                            ...
                            let __field2 = match serde::de::SeqAccess::next_element::<std::vec::Vec<postgresql_crud::JsonUuid>>(&mut __seq)? {
                                serde::__private::Some(__value) => __value,
                                serde::__private::None => {
                                    vec![]
                                }
                            ...
                            __A: serde::de::MapAccess<'de>,
                        {
                            ...
                            let mut __field2: serde::__private::Option<std::vec::Vec<postgresql_crud::JsonUuid>> = serde::__private::None;
                            while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                                match __key {
                                    ...
                                    __Field::__field2 => {
                                        ...
                                        __field2 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<postgresql_crud::JsonUuid>>(&mut __map)?);
                                    }
                                    _ => {
    ...
    let std_vec_vec_generic_with_id_ident_token_stream = {
        ...
        // println!("{std_vec_vec_generic_with_id_ident_option_to_update_try_generate_bind_increments_error_named_token_stream}");
        let impl_postgresql_crud_generate_postgresql_query_part_to_update_std_vec_vec_generic_with_id_ident_option_to_update_try_generate_bind_increments_error_named_for_std_vec_vec_generic_with_id_ident_option_to_update_token_stream = {
            let try_generate_bind_increments_variants_token_stream = vec_syn_field.iter().map(|element| {
                ...
                let variant_ident_upper_camel_case_token_stream = proc_macro_common::naming_conventions::ToUpperCamelCaseTokenStream::to_upper_camel_case_token_stream(&field_ident_stringified);
                quote::quote!{
                    #std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream::#variant_ident_upper_camel_case_token_stream(value) => match postgresql_crud::GeneratePostgresqlQueryPartToUpdate::try_generate_bind_increments(
                        //todo fix parameters
                        &value.value,
                        jsonb_set_accumulator,
                        jsonb_set_target,
