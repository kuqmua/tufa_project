...
pub fn generate_postgresql_query_part(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let postgresql_crud_uuid_option_to_update_token_stream = quote::quote!{#postgresql_crud_path_token_stream json_types::PostgresqlJsonTypeUuidOptionToUpdate};//todo reuse
    ...
    let generate_postgresql_json_type_tokens_field_reader_token_stream = |postgresql_json_type_field_reader: &PostgresqlJsonTypeFieldReader|{
        ...
        let postgresql_json_type_tokens_field_reader_try_new_error_named_upper_camel_case_token_stream: &dyn quote::ToTokens = match &postgresql_json_type_field_reader {
            ...
            PostgresqlJsonTypeFieldReader::ObjectIdent => &naming::parameter::PostgresqlJsonTypeObjectSelfPostgresqlJsonTypeFieldReaderTryNewErrorNamedUpperCamelCase::from_tokens(&ident),
                    ...
                    let ident_field_to_read_with_id_token_stream = generate_template_field_to_read_struct_token_stream(
                        ...
                        &quote::quote!{
                            #[serde(rename(serialize = #id_snake_case_double_quotes_token_stream, deserialize = #id_snake_case_double_quotes_token_stream))]
                             Id(#postgresql_crud_path_token_stream json_types::PostgresqlJsonTypeUuidFieldReader),//todo reuse
                        },
                    );
                    (
                ...
                |{
                    ...
                    let maybe_id_token_stream = if contains_id {
                        quote::quote!{
                            ...
                            #id_snake_case: std::option::Option<#postgresql_crud_path_token_stream Value<#postgresql_crud_path_token_stream json_types::PostgresqlJsonTypeUuidOptionsToRead>>,
                        }
                    }
                    else {
                        proc_macro2::TokenStream::new()
                    ...
                    |{
                        ...
                        let visit_seq_fields_initialization_token_stream = {
                            ...
                            let maybe_id_serde_de_seq_access_next_element_token_stream = if contains_id {
                                generate_serde_de_seq_access_next_element_token_stream(
                                    0,
                                    &quote::quote!{#postgresql_crud_path_token_stream json_types::PostgresqlJsonTypeUuidOptionsToRead},//todo reuse
                                )
                            }
                            else {
                                proc_macro2::TokenStream::new()
                        ...
                        let visit_map_fields_initialization_token_stream = {
                            ...
                            let maybe_id_mut_field_index_serde_private_option_token_stream = if contains_id {
                                generate_mut_field_index_serde_private_option_token_stream(
                                    0,
                                    &quote::quote!{#postgresql_crud_path_token_stream json_types::PostgresqlJsonTypeUuidOptionsToRead},//todo
                                )
                            }
                            else {
                                quote::quote!{}
                ...
                let ident_json_array_change_try_generate_postgresql_query_part_error_named_token_stream = generate_tokens_try_generate_postgresql_query_part_error_named_token_stream(
                    ...
                    &{
                        let variants_token_stream = vec_syn_field.iter().map(|element| {
                            ...
                            let postgresql_json_type_element_type_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case = naming::parameter::PostgresqlJsonTypeSelfOptionToUpdateTryGeneratePostgresqlQueryPartErrorNamedUpperCamelCase::from_type_last_segment(&element.ty);
                            quote::quote!{
                                #variant_ident_upper_camel_case_token_stream {
                                    #[eo_error_occurence]
                                    error: #postgresql_json_type_element_type_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                                    code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                                }
                            }
                        });
    ...
    let postgresql_json_type_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case = naming::parameter::PostgresqlJsonTypeSelfOptionToUpdateTryGeneratePostgresqlQueryPartErrorNamedUpperCamelCase::from_tokens(&ident);
    ...
    let ident_token_stream = {
        ...
        let update_token_stream = {
            ...
            let postgresql_json_type_ident_option_to_update_try_generate_postgresql_query_part_error_named_token_stream = generate_tokens_try_generate_postgresql_query_part_error_named_token_stream(
                &postgresql_json_type_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                &{
                    let variants_token_stream = vec_syn_field.iter().map(|element| {
                        let field_ident_stringified = element
                            .ident
            ...
            let impl_postgresql_json_type_ident_option_to_update_methods_token_stream = generate_tokens_to_update_methods_token_stream(
                ...
                &{
                    ...
                    let try_generate_bind_increments_variants_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        let field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream(&element);
                        quote::quote!{
                            #postgresql_json_type_ident_option_to_update_origin_upper_camel_case::#variant_ident_upper_camel_case_token_stream(value) => match #field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream #try_generate_postgresql_query_part_to_update_snake_case(
                                &value.value,
                                &local_acc,
                                ...
                                Err(error) => {
                                    return Err(#postgresql_json_type_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::#variant_ident_upper_camel_case_token_stream {
                                        error,
                                        code_occurence: error_occurence_lib::code_occurence!()
                                    });
                                }
            ...
            quote::quote!{
                ...
                #postgresql_json_type_ident_option_to_update_try_generate_postgresql_query_part_error_named_token_stream
    ...
    let json_value_variants_token_stream = {
        ...
        let generate_impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = |
            postgresql_json_type: SupportedJsonValue,

            pub_struct_postgresql_json_type_tokens_declaration_token_stream: &dyn quote::ToTokens,
        ...
        |{
            let postgresql_json_type_tokens_token_stream = {
                let postgresql_json_type_tokens_upper_camel_case: &quote::ToTokens = match &postgresql_json_type {
                    SupportedJsonValue::Object => naming::PostgresqlJsonTypeObjectSelfUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdOptionOptionObject => naming::PostgresqlJsonTypeStdOptionOptionObjectSelfUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdVecVecObjectWithId => naming::PostgresqlJsonTypeStdVecVecObjectWithIdSelfUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => naming::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectSelfUpperCamelCase::from_tokens(&ident),
                };
                let postgresql_json_type_tokens_token_stream = generate_supported_generics_template_struct_token_stream(
                    true,
                    &postgresql_json_type_tokens_upper_camel_case,
                    &pub_struct_postgresql_json_type_tokens_declaration_token_stream
                );
                let postgresql_json_type_tokens_to_create_upper_camel_case: &quote::ToTokens = match &postgresql_json_type {
                    SupportedJsonValue::Object => naming::PostgresqlJsonTypeObjectSelfToCreateUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdOptionOptionObject => naming::PostgresqlJsonTypeStdOptionOptionObjectSelfoCreateUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdVecVecObjectWithId => naming::PostgresqlJsonTypeStdVecVecObjectWithIdSelfoCreateUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => naming::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectSelfoCreateUpperCamelCase::from_tokens(&ident),
                };
                let create_token_stream = {
                ...
                let postgresql_json_type_tokens_options_to_read_upper_camel_case: &quote::ToTokens = match &postgresql_json_type {
                    SupportedJsonValue::Object => naming::PostgresqlJsonTypeObjectSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdOptionOptionObject => naming::PostgresqlJsonTypeStdOptionOptionObjectSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdVecVecObjectWithId => naming::PostgresqlJsonTypeStdVecVecObjectWithIdSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                    SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => naming::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                };
                let read_token_stream = {
                    ...
                    let maybe_impl_try_new_for_postgresql_json_type_tokens_options_to_read_token_stream = {
                        let postgresql_json_type_tokens_options_to_read_try_new_error_named_upper_camel_case = match &postgresql_json_type {
                            SupportedJsonValue::Object |
                            SupportedJsonValue::StdOptionOptionObject => todo!(),
                            SupportedJsonValue::StdVecVecObjectWithId => naming::PostgresqlJsonTypeStdVecVecObjectWithIdSelfOptionsToReadTryNewErrorNamedUpperCamelCase::from_tokens(&ident),
                            SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => naming::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectSelfOptionsToReadTryNewErrorNamedUpperCamelCase::from_tokens(&ident),
                        };
                        ...
                        |{
                            ...
                            let impl_postgresql_json_type_tokens_options_to_read_try_new_error_named_pub_fn_try_new_token_stream = {
                                quote::quote!{
                                    impl #postgresql_json_type_tokens_options_to_read_try_new_error_named_upper_camel_case {
                        ...
                        match &postgresql_json_type {
                            SupportedJsonValue::Object |,
                            SupportedJsonValue::StdOptionOptionObject => proc_macro2::TokenStream::new(),
                            SupportedJsonValue::StdVecVecObjectWithId => generate_impl_try_new_for_postgresql_json_type_tokens_options_to_read_token_stream(
                            ...
                            SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => generate_impl_try_new_for_postgresql_json_type_tokens_options_to_read_token_stream(
                    ...
                    let postgresql_json_type_tokens_field_reader_token_stream = generate_postgresql_json_type_tokens_field_reader_token_stream(&match &postgresql_json_type {
                        SupportedJsonValue::Object => PostgresqlJsonTypeFieldReader::ObjectIdent,
                        SupportedJsonValue::StdOptionOptionObject => PostgresqlJsonTypeFieldReader::StdOptionOptionObjectIdent,
                        SupportedJsonValue::StdVecVecObjectWithId => PostgresqlJsonTypeFieldReader::StdVecVecObjectWithIdIdent,
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => PostgresqlJsonTypeFieldReader::StdOptionOptionStdVecVecObjectWithIdIdent,
                    });
                    let postgresql_json_type_tokens_field_reader_upper_camel_case: &quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::Object => naming::PostgresqlJsonTypeObjectSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObject => naming::PostgresqlJsonTypeStdOptionOptionObjectSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithId => naming::PostgresqlJsonTypeStdVecVecObjectWithIdSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => naming::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                    };
                    ...
                    let postgresql_json_type_tokens_reader_upper_camel_case: &quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::Object => naming::PostgresqlJsonTypeObjectSelfReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObject => naming::PostgresqlJsonTypeStdOptionOptionObjectSelfReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithId => naming::PostgresqlJsonTypeStdVecVecObjectWithIdSelfReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithId => naming::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectSelfReaderUpperCamelCase::from_tokens(&ident),
                    };
                ...
                //     &{
                //         let tokens_ident_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                ...
                //     },
                //     &{
                //         let postgresql_json_type_tokens_ident_to_create_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                //             SupportedJsonValue::ObjectIdent => &postgresql_json_type_object_ident_to_create_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionObjectIdent => &postgresql_json_type_std_option_option_object_ident_to_create_upper_camel_case,
                //             SupportedJsonValue::StdVecVecObjectWithIdIdent => &postgresql_json_type_std_vec_vec_object_with_id_ident_to_create_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_to_create_upper_camel_case,
                //         };
                //         postgresql_json_type_tokens_ident_to_create_token_stream
                //     },
                //     &try_generate_postgresql_query_part_to_create_content_token_stream,
                //     &bind_value_to_postgresql_query_part_to_create_content_token_stream,
                //     &{
                //         let postgresql_json_type_tokens_ident_field_reader_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                //             SupportedJsonValue::ObjectIdent => &postgresql_json_type_object_ident_field_reader_upper_camel_case_token_stream,
                //             SupportedJsonValue::StdOptionOptionObjectIdent => &postgresql_json_type_std_option_option_object_ident_field_reader_upper_camel_case,
                //             SupportedJsonValue::StdVecVecObjectWithIdIdent => &postgresql_json_type_std_vec_vec_object_with_id_ident_field_reader_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_field_reader_upper_camel_case,
                //         };
                //         postgresql_json_type_tokens_ident_field_reader_token_stream
                //     },
                //     &{
                //         let postgresql_json_type_tokens_ident_options_to_read_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                //             SupportedJsonValue::ObjectIdent => &postgresql_json_type_object_ident_options_to_read_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionObjectIdent => &postgresql_json_type_std_option_option_object_ident_options_to_read_upper_camel_case,
                //             SupportedJsonValue::StdVecVecObjectWithIdIdent => &postgresql_json_type_std_vec_vec_object_with_id_ident_options_to_read_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_options_to_read_upper_camel_case,
                //         };
                //         postgresql_json_type_tokens_ident_options_to_read_token_stream
                //     },
                ...
                //             SupportedJsonValue::ObjectIdent => &postgresql_json_type_object_ident_option_to_update_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionObjectIdent => &postgresql_json_type_std_option_option_object_ident_option_to_update_upper_camel_case,
                //             SupportedJsonValue::StdVecVecObjectWithIdIdent => &postgresql_json_type_std_vec_vec_object_with_id_ident_option_to_update_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_option_to_update_upper_camel_case,
                //         };
                ...
                //             SupportedJsonValue::ObjectIdent => &postgresql_json_type_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionObjectIdent => &postgresql_json_type_std_option_option_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                //             SupportedJsonValue::StdVecVecObjectWithIdIdent => &postgresql_json_type_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                //             SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                //         };
        ...
        let generate_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = |
            ...
            pub_struct_postgresql_type_tokens_to_create_declaration_token_stream: &dyn quote::ToTokens,
        ...
        |{
            enum PostgresqlJsonVariant {
                PostgresqlJson,
                PostgresqlJsonNotNull,
                PostgresqlJsonb,
            ...
            |{
                ...
                let postgresql_type_tokens_column_upper_camel_case = {
                    let value: &dyn quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlTypeObjectSelfColumnUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlTypeStdOptionOptionObjectSelfColumnUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdVecVecObjectWithIdSelfColumnUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdOptionOptionStdVecVecObjectWithIdSelfColumnUpperCamelCase::from_tokens(&ident),
                    };
                    postgresql_json_variant.add_postfix(value)
                };
                ...
                let postgresql_type_tokens_to_create_upper_camel_case = {
                    let value: &dyn quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlTypeObjectSelfToCreateUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlTypeStdOptionOptionObjectSelfToCreateUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdVecVecObjectWithIdSelfToCreateUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdOptionOptionStdVecVecObjectWithIdSelfToCreateUpperCamelCase::from_tokens(&ident),
                    };
                    postgresql_json_variant.add_postfix(value)
                };
                ...
                let postgresql_type_tokens_to_read_upper_camel_case = {
                    let value: &dyn quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlTypeObjectSelfToReadUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlTypeStdOptionOptionObjectSelfToReadUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdVecVecObjectWithIdSelfToReadUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdOptionOptionStdVecVecObjectWithIdSelfToReadUpperCamelCase::from_tokens(&ident),
                    };
                    postgresql_json_variant.add_postfix(value)
                };
                let postgresql_type_tokens_to_read_token_stream = {
                    let postgresql_json_type_tokens_field_reader_upper_camel_case: &dyn quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlJsonTypeObjectSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlJsonTypeStdOptionOptionObjectSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlJsonTypeStdVecVecObjectWithIdSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectWithIdSelfFieldReaderUpperCamelCase::from_tokens(&ident),
                    };
                    let postgresql_type_tokens_to_read_token_stream = {
                        quote::quote!{
                            #[derive(
                ...
                let postgresql_type_tokens_to_update_upper_camel_case = {
                    let value: &dyn quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlTypeObjectSelfToUpdateUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlTypeStdOptionOptionObjectSelfToUpdateUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdVecVecObjectWithIdSelfToUpdateUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdOptionOptionStdVecVecObjectWithIdSelfToUpdateUpperCamelCase::from_tokens(&ident),
                    };
                    postgresql_json_variant.add_postfix(value)
                };
                ...
                let postgresql_type_tokens_where_upper_camel_case = {
                    let value: &dyn quote::ToTokens = match &postgresql_json_type {
                        SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlTypeObjectSelfWhereUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlTypeStdOptionOptionObjectSelfWhereUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdVecVecObjectWithIdSelfWhereUpperCamelCase::from_tokens(&ident),
                        SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlTypeStdOptionOptionStdVecVecObjectWithIdSelfWhereUpperCamelCase::from_tokens(&ident),
                    };
                    postgresql_json_variant.add_postfix(value)
                };
                ...
                let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = {
                    ...
                    //maybe its wrong and should write wrapper around it like tokens_column, tokens_to_read and tokens_where
                    // let postgresql_json_type_tokens_to_create_upper_camel_case: &dyn quote::ToTokens = match &postgresql_json_type {
                    //     SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlJsonTypeObjectSelfToCreateUpperCamelCase::from_tokens(&ident),
                    //     SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlJsonTypeStdOptionOptionObjectSelfToCreateUpperCamelCase::from_tokens(&ident),
                    //     SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlJsonTypeStdVecVecObjectWithIdSelfToCreateUpperCamelCase::from_tokens(&ident),
                    //     SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectWithIdSelfToCreateUpperCamelCase::from_tokens(&ident),
                    // };
                    // let postgresql_json_type_tokens_option_to_update_upper_camel_case: &dyn quote::ToTokens = match &postgresql_json_type {
                    //     SupportedJsonValue::ObjectIdent => &naming::parameter::PostgresqlJsonTypeObjectSelfOptionToUpdateUpperCamelCase::from_tokens(&ident),
                    //     SupportedJsonValue::StdOptionOptionObjectIdent => &naming::parameter::PostgresqlJsonTypeStdOptionOptionObjectSelfOptionToUpdateUpperCamelCase::from_tokens(&ident),
                    //     SupportedJsonValue::StdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlJsonTypeStdVecVecObjectWithIdSelfOptionToUpdateUpperCamelCase::from_tokens(&ident),
                    //     SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectWithIdSelfOptionToUpdateUpperCamelCase::from_tokens(&ident),
                    // };
                    quote::quote!{
                        impl postgresql_crud::postgresql_types::postgresql_type::#postgresql_type_upper_camel_case<'_> for #tokens_upper_camel_case {
                            //todo add prefix PostgresqlType
            ...
            let postgresql_json_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream(
                ...
                &pub_struct_postgresql_type_tokens_to_create_declaration_token_stream,
                &try_generate_bind_increments_content_for_postgresql_type_tokens_to_create_token_stream,
                &bind_value_to_query_content_for_postgresql_type_tokens_to_create_token_stream,
                &std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_content_for_postgresql_type_tokens_to_create_token_stream,
        ...
        let (
            ...
            let object_ident_token_stream = {
                ...
                let update_token_stream = {
                    ...
                    let postgresql_json_type_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_alias_token_stream = macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                        &postgresql_json_type_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                        &postgresql_json_type_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case
                    );
                    let postgresql_json_type_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_with_serialize_deserialize_alias_token_stream = macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                        &naming::parameter::PostgresqlJsonTypeObjectSelfOptionToUpdateTryGeneratePostgresqlQueryPartErrorNamedWithSerializeDeserializeUpperCamelCase::from_tokens(&ident),
                        &naming::parameter::PostgresqlJsonTypeSelfOptionToUpdateTryGeneratePostgresqlQueryPartErrorNamedWithSerializeDeserializeUpperCamelCase::from_tokens(&ident)
                    );
                    quote::quote!{
                        #postgresql_json_type_object_ident_option_to_update_alias_token_stream
                        #postgresql_json_type_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_alias_token_stream
            ...
            let std_option_option_object_ident_token_stream = {
                                ...
                                quote::quote!{
                                    #postgresql_json_type_ident_option_to_update_origin_upper_camel_case::#variant_ident_upper_camel_case_token_stream(value) => {
                                        match #field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream #try_generate_postgresql_query_part_to_update_snake_case(
                                            ...
                                            Err(error) => {
                                                return Err(#postgresql_json_type_std_option_option_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::#variant_ident_upper_camel_case_token_stream {
                                                    error,
                                                    code_occurence: error_occurence_lib::code_occurence!(),
                                                });
                                            }
                            ...
                            quote::quote!{
                                Ok(match &#postgresql_json_type_self_option_to_update_snake_case.0 {
                                    ...
                                    None => match #increment_snake_case.checked_add(1) {
                                        ...
                                        None => {
                                            return Err(#postgresql_json_type_std_option_option_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::#checked_add_variant_initialization_token_stream);
                                        }
                                    }
                                })
                            }
                ...
                let update_token_stream = {
                    ...
                    let postgresql_json_type_std_option_option_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_token_stream = generate_tokens_try_generate_postgresql_query_part_error_named_token_stream(
                        &postgresql_json_type_std_option_option_object_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                        &{
                            let variants_token_stream = vec_syn_field.iter().map(|element| {
                                let field_ident_stringified = element
                                    .ident
        ...
        let (
            ...
            let std_vec_vec_object_with_id_ident_token_stream = {
                    ...
                    let impl_postgresql_crud_postgresql_json_type_for_std_vec_vec_object_with_id_ident_token_stream = generate_impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream(
                        ...
                        quote::quote!{
                            match #postgresql_json_type_self_option_to_update_snake_case.0.#try_generate_postgresql_query_part_to_update_snake_case(
                                ...
                                Ok(value) => Ok(value),
                                Err(error) => {
                                    return Err(#postgresql_json_type_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::#ident_json_array_change_try_generate_postgresql_query_part_error_named_upper_camel_case {
                                        error,
                                        code_occurence: error_occurence_lib::code_occurence!()
                                    });
                                }
                ...
                let update_token_stream = {
                    ...
                    let postgresql_json_type_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_token_stream = generate_tokens_try_generate_postgresql_query_part_error_named_token_stream(
                        &postgresql_json_type_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                        &{
                            quote::quote!{
                                #ident_json_array_change_try_generate_postgresql_query_part_error_named_upper_camel_case {
                                    #[eo_error_occurence]
            ...
            let std_option_option_std_vec_vec_object_with_id_ident_token_stream = {
                                ...
                                match &#postgresql_json_type_self_option_to_update_snake_case.0 {
                                    Some(value) => {
                                        match value.#try_generate_postgresql_query_part_to_update_snake_case(
                                            ...
                                            Ok(value) => Ok(value),
                                            Err(error) => {
                                                return Err(#postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::JsonArrayChange {
                                                    error,
                                                    code_occurence: error_occurence_lib::code_occurence!()
                                                });
                                            }
                                    ...
                                    None => match #increment_snake_case.checked_add(1) {
                                        ...
                                        None => {
                                            return Err(#postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::#checked_add_variant_initialization_token_stream);
                                        }
                                    },
                                }
                            }
                ...
                let update_token_stream = {
                    ...
                    let postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_token_stream = generate_tokens_try_generate_postgresql_query_part_error_named_token_stream(
                        &postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case,
                        &{
                            quote::quote!{
                                #checked_add_variant_declaration_token_stream,
                                JsonArrayChange {
