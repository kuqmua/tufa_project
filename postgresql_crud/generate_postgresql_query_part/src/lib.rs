    ...
    |{
        quote::quote!{
            impl #struct_token_stream {
                ...
                fn #bind_value_to_postgresql_query_part_to_update_snake_case<'a>(self, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments> {
            ...
            let impl_ident_option_to_update_methods_token_stream = generate_tokens_to_update_methods_token_stream(
                ...
                &{
                    ...
                    let local_acc_format_handle_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                        &format!("jsonb_set({{{jsonb_set_accumulator_snake_case}}},'{{{{{{jsonb_set_path}}}}}}',case when jsonb_typeof({{{jsonb_set_target_snake_case}}}) = 'object' then ({{{jsonb_set_target_snake_case}}})::jsonb else '{{{{}}}}'::jsonb end)"),
                        &proc_macro_name_upper_camel_case_ident_stringified
                    );
                    quote::quote!{
                        #generate_jsonb_set_target_token_stream
                    ...
                    let bind_value_to_postgresql_query_part_to_update_variants_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        quote::quote!{
                            #ident_option_to_update_origin_upper_camel_case::#variant_ident_upper_camel_case_token_stream(value) => {
                                query = <#element_type as postgresql_crud::PostgresqlJsonType>::#bind_value_to_postgresql_query_part_to_update_snake_case(value.value, query);
                            }
                        }
                    });
                    quote::quote!{
            ...
            let std_option_option_object_ident_token_stream = {
                ...
                let impl_postgresql_crud_postgresql_json_type_for_std_option_option_object_ident_token_stream = impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream(
                    ...
                    &{
                        ...
                        let some_format_handle_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                ...
                let impl_postgresql_crud_postgresql_json_type_for_std_vec_vec_object_with_id_ident_token_stream = impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream(
                    ...
                    quote::quote!{
                        match #option_to_update_snake_case.0.#try_generate_postgresql_query_part_to_update_snake_case(
                            ...
                            Ok(value) => Ok(value),
                            Err(error) => {
                                return Err(#std_vec_vec_object_with_id_ident_option_to_update_try_generate_postgresql_query_part_error_named_upper_camel_case::#ident_json_array_change_try_generate_bind_increments_error_named_upper_camel_case {
                                    error,
                                    code_occurence: error_occurence_lib::code_occurence!()
                                });
                            }
                    ...
                    &quote::quote!{
                        query = #option_to_update_snake_case.0.#bind_value_to_postgresql_query_part_to_update_snake_case(query);
                        query
                    }
                );
                quote::quote!{
            ...
            let std_option_option_std_vec_vec_object_with_id_ident_token_stream = {
                ...
                let impl_postgresql_crud_postgresql_json_type_for_std_option_option_std_vec_vec_object_with_id_ident_token_stream = impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream(
                    ...
                    &quote::quote!{
                        match #option_to_update_snake_case.0 {
                            Some(value) => {
                                query = value.#bind_value_to_postgresql_query_part_to_update_snake_case(query);
                            }
                            None => {
