    ...
    let json_value_variants_token_stream = {
        ...
        |{        
            let tokens_column_token_stream = {
                ...
                let std_option_option_object_ident_column_upper_camel_case = naming_conventions::StdOptionOptionObjectSelfColumnUpperCamelCase::from_dyn_quote_to_tokens(&ident);
                let std_vec_vec_object_with_id_ident_column_upper_camel_case = naming_conventions::StdVecVecObjectWithIdSelfColumnUpperCamelCase::from_dyn_quote_to_tokens(&ident);
                let std_option_option_std_vec_vec_object_with_id_ident_column_upper_camel_case = naming_conventions::StdOptionOptionStdVecVecObjectWithIdSelfColumnUpperCamelCase::from_dyn_quote_to_tokens(&ident);
                let tokens_column_upper_camel_case: &dyn quote::ToTokens = match &supported_json_value {
                    SupportedJsonValue::ObjectIdent => &object_ident_column_upper_camel_case,
                    SupportedJsonValue::StdOptionOptionObjectIdent => &std_option_option_object_ident_column_upper_camel_case,
                    SupportedJsonValue::StdVecVecObjectWithIdIdent => &std_vec_vec_object_with_id_ident_column_upper_camel_case,
                    SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &std_option_option_std_vec_vec_object_with_id_ident_column_upper_camel_case,
                };
                let tokens_column_token_stream = {
                    quote::quote!{
                        #[derive(
            ...
            let tokens_where_token_stream = {
                ...
                let std_option_option_object_ident_where_upper_camel_case = naming_conventions::StdOptionOptionObjectSelfWhereUpperCamelCase::from_dyn_quote_to_tokens(&ident);
                let std_vec_vec_object_with_id_ident_where_upper_camel_case = naming_conventions::StdVecVecObjectWithIdSelfWhereUpperCamelCase::from_dyn_quote_to_tokens(&ident);
                let std_option_option_std_vec_vec_object_with_id_ident_where_upper_camel_case = naming_conventions::StdOptionOptionStdVecVecObjectWithIdSelfWhereUpperCamelCase::from_dyn_quote_to_tokens(&ident);
                let tokens_where_upper_camel_case: &dyn quote::ToTokens = match &supported_json_value {
                    SupportedJsonValue::ObjectIdent => &object_ident_where_upper_camel_case,
                    SupportedJsonValue::StdOptionOptionObjectIdent => &std_option_option_object_ident_where_upper_camel_case,
                    SupportedJsonValue::StdVecVecObjectWithIdIdent => &std_vec_vec_object_with_id_ident_where_upper_camel_case,
                    SupportedJsonValue::StdOptionOptionStdVecVecObjectWithIdIdent => &std_option_option_std_vec_vec_object_with_id_ident_where_upper_camel_case,
                };
                let tokens_where_token_stream = {
                    quote::quote!{
                        #[derive(
