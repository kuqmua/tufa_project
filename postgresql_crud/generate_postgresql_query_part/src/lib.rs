...
pub fn generate_postgresql_query_part(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_tokens_option_to_update_origin_token_stream = |struct_ident_token_stream: &proc_macro2::TokenStream|{
        let variants_token_stream = vec_syn_field.iter().map(|element| {
            let field_ident = element
                .ident
                .as_ref()
    ...
    let generate_tokens_options_to_update_token_stream = |
        struct_ident_token_stream: &proc_macro2::TokenStream,
    ...
    let generate_impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_option_to_update_token_stream = |struct_ident_token_stream: &proc_macro2::TokenStream|{
        let elements_token_stream = vec_syn_field.iter().map(|element| {
            ...
            let variant_ident_upper_camel_case_token_stream = proc_macro_common::naming_conventions::ToUpperCamelCaseTokenStream::to_upper_camel_case_token_stream(&field_ident.to_string());
            quote::quote!{
                #struct_ident_token_stream::#variant_ident_upper_camel_case_token_stream(postgresql_crud::Value {
                    value: #postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream
                })
            }
        });
        quote::quote!{
            impl postgresql_crud::AllEnumVariantsArrayStdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement for #struct_ident_token_stream {
                fn all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> std::vec::Vec<#struct_ident_token_stream> {
                    vec![#(#elements_token_stream),*]
                }
            }
        }
    ...
    let genarate_impl_serde_deserialize_for_tokens_json_array_change_token_stream = |
        tokens_option_to_update_upper_camel_case_stringified: &std::primitive::str,
        tokens_json_array_change_upper_camel_case_token_stream: &proc_macro2::TokenStream,
        tokens_to_create_origin_upper_camel_case_token_stream: &proc_macro2::TokenStream,
    ...
    |{
        ...
        let std_vec_vec_generic_with_id_ident_option_to_update_upper_camel_case_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
        ...
        quote::quote!{
            impl<'de> serde::Deserialize<'de> for #tokens_json_array_change_upper_camel_case_token_stream {
                    ...
                    __D: serde::Deserializer<'de>,
                {
                    ...
                    #[doc(hidden)]
                    struct __Visitor<'de> {
                        marker: serde::__private::PhantomData<#tokens_json_array_change_upper_camel_case_token_stream>,
                        lifetime: serde::__private::PhantomData<&'de ()>,
                    }
                    impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                        type Value = #tokens_json_array_change_upper_camel_case_token_stream;
                        fn expecting(&self, __formatter: &mut serde::__private::Formatter<'_>) -> serde::__private::fmt::Result {
                            serde::__private::Formatter::write_str(__formatter, #tuple_struct_std_vec_vec_generic_with_id_ident_option_to_update_double_quotes_token_stream)
                        }
                        #[inline]
                        ...
                        where
                            __A: serde::de::SeqAccess<'de>,
                        {
                            let __field0 = match serde::de::SeqAccess::next_element::<std::vec::Vec<#tokens_to_create_origin_upper_camel_case_token_stream>>(&mut __seq)? {
                                serde::__private::Some(__value) => __value,
                                serde::__private::None => {
                                    vec![]
                                }
                            };
                            let __field1 = match serde::de::SeqAccess::next_element::<std::vec::Vec<#tokens_options_to_update_upper_camel_case_token_stream>>(&mut __seq)? {
                                serde::__private::Some(__value) => __value,
                                serde::__private::None => {
                                    vec![]
                                }
                            ...
                            serde::__private::Ok(#tokens_json_array_change_upper_camel_case_token_stream { create: __field0, update: __field1, delete: __field2 })
                        }
                        #[inline]
                        ...
                        where
                            __A: serde::de::MapAccess<'de>,
                        {
                            let mut __field0: serde::__private::Option<std::vec::Vec<#tokens_to_create_origin_upper_camel_case_token_stream>> = serde::__private::None;
                            let mut __field1: serde::__private::Option<std::vec::Vec<#tokens_options_to_update_upper_camel_case_token_stream>> = serde::__private::None;
                            ...
                            while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                                match __key {
                                    __Field::__field0 => {
                                        ...
                                        __field0 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<#tokens_to_create_origin_upper_camel_case_token_stream>>(&mut __map)?);
                                    }
                                    __Field::__field1 => {
                                        if serde::__private::Option::is_some(&__field1) {
                                            return serde::__private::Err(<__A::Error as serde::de::Error>::duplicate_field("update"));
                                        }
                                        __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<#tokens_options_to_update_upper_camel_case_token_stream>>(&mut __map)?);
                                    }
                                    __Field::__field2 => {
                    ...
                    serde::Deserializer::deserialize_struct(
                        __deserializer,
                        #std_vec_vec_generic_with_id_ident_option_to_update_upper_camel_case_double_quotes_token_stream,
                        FIELDS,
                        __Visitor {
                            marker: serde::__private::PhantomData::<#tokens_json_array_change_upper_camel_case_token_stream>,
                            lifetime: serde::__private::PhantomData,
    ...
    let ident_token_stream = {
        ...
        // let ident_option_to_update_token_stream = generate_tokens_option_to_update_origin_token_stream(&ident_option_to_update_upper_camel_case_token_stream);
        ...
        let ident_option_to_update_origin_token_stream = generate_tokens_option_to_update_origin_token_stream(&ident_option_to_update_origin_upper_camel_case_token_stream);
        // println!("{ident_option_to_update_origin_token_stream}");
        ...
        let impl_postgresql_crud_generate_postgresql_query_part_to_update_ident_option_to_update_try_generate_bind_increments_error_named_for_ident_option_to_update_token_stream = {
            ...
            quote::quote!{
                impl postgresql_crud::GeneratePostgresqlQueryPartToUpdate<#ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream> for #ident_option_to_update_upper_camel_case_token_stream {
                    fn try_generate_bind_increments(
                        &self,
                        jsonb_set_accumulator: &std::primitive::str,
                        jsonb_set_target: &std::primitive::str,
    ...
    let generic_ident_token_stream = {
        ...
        let generic_ident_option_to_update_origin_upper_camel_case_token_stream = naming_conventions::ImplQuoteToTokensGenericSelfOptionToUpdateOriginUpperCamelCaseTokenStream::impl_quote_to_tokens_generic_self_option_to_update_origin_upper_camel_case_token_stream(&ident);
        let generic_ident_option_to_update_origin_token_stream = generate_tokens_option_to_update_origin_token_stream(&generic_ident_option_to_update_origin_upper_camel_case_token_stream);
        let impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_generic_ident_option_to_update_origin_token_stream = generate_impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_option_to_update_token_stream(&generic_ident_option_to_update_origin_upper_camel_case_token_stream);
        ...
        let generic_ident_option_to_update_token_stream = generate_tokens_option_to_update_token_stream(
            ...
            &quote::quote!{std::vec::Vec<#generic_ident_option_to_update_origin_upper_camel_case_token_stream>},
            false,
        );
                ...
                impl<'de> serde::Deserialize<'de> for #generic_ident_option_to_update_upper_camel_case_token_stream {
                        ...
                        __D: serde::Deserializer<'de>,
                    {
                        ...
                        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                            ...
                            {
                                let __field0 = match serde::de::SeqAccess::next_element::<
                                    std::vec::Vec<#generic_ident_option_to_update_origin_upper_camel_case_token_stream>,
                                >(&mut __seq)? {
                                    serde::__private::Some(__value) => __value,
                                    serde::__private::None => {
                                        return serde::__private::Err(
        ...
        let generic_ident_option_to_update_try_generate_bind_increments_error_named_token_stream = {
            let variants_token_stream = vec_syn_field.iter().map(|element| {
                let field_ident_stringified = element
                    .ident
                    .as_ref()
            ...
            quote::quote!{
                #[derive(Debug, thiserror::Error, error_occurence_lib::ErrorOccurence)]
                pub enum #generic_ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream {
                    CheckedAdd {
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                    },
                    #(#variants_token_stream),*
        ...
        let impl_postgresql_crud_generate_postgresql_query_part_to_update_generic_ident_option_to_update_try_generate_bind_increments_error_named_for_generic_ident_option_to_update_token_stream = {
            ...
            let bind_value_to_query_variants_token_stream = vec_syn_field.iter().map(|element| {
                ...
                let variant_ident_upper_camel_case_token_stream = proc_macro_common::naming_conventions::ToUpperCamelCaseTokenStream::to_upper_camel_case_token_stream(&field_ident_stringified);
                quote::quote!{
                    #generic_ident_option_to_update_origin_upper_camel_case_token_stream::#variant_ident_upper_camel_case_token_stream(value) => {
                        query = postgresql_crud::GeneratePostgresqlQueryPartToUpdate::bind_value_to_query(value.value, query);
                    }
                }
            });
            quote::quote!{
                impl postgresql_crud::GeneratePostgresqlQueryPartToUpdate<#generic_ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream> for #generic_ident_option_to_update_upper_camel_case_token_stream {
                    fn try_generate_bind_increments(
                        &self,
                        jsonb_set_accumulator: &std::primitive::str,
                        jsonb_set_target: &std::primitive::str,
        ...
        quote::quote!{
            ...
            #generic_ident_option_to_update_origin_token_stream
            #impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_generic_ident_option_to_update_origin_token_stream
    ...
    let std_option_option_generic_ident_token_stream = {
        ...
        let std_option_option_generic_ident_option_to_update_origin_token_stream = generate_tokens_option_to_update_origin_token_stream(&std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream);
        let impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_std_option_option_generic_ident_option_to_update_token_stream = generate_impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_option_to_update_token_stream(&std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream);
        ...
        let std_option_option_generic_ident_option_to_update_token_stream = generate_tokens_option_to_update_token_stream(
            ...
            &quote::quote!{std::option::Option<std::vec::Vec<#std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream>>},
            false,
        );
                        ...
                        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                                ...
                                __E: serde::Deserializer<'de>,
                            {
                                let __field0: std::option::Option<
                                    std::vec::Vec<#std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream>,
                                > = <std::option::Option<
                                    std::vec::Vec<#std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream>,
                                > as serde::Deserialize>::deserialize(__e)?;
                                #custom_checks_token_stream
        ...
        let std_option_option_generic_ident_option_to_update_try_generate_bind_increments_error_named_token_stream = {
            let variants_token_stream = vec_syn_field.iter().map(|element| {
                let field_ident_stringified = element
                    .ident
                    .as_ref()
            ...
            quote::quote!{
                #[derive(Debug, thiserror::Error, error_occurence_lib::ErrorOccurence)]
                pub enum #std_option_option_generic_ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream {
                    CheckedAdd {
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                    },
                    #(#variants_token_stream),*
        ...
        let impl_postgresql_crud_generate_postgresql_query_part_to_update_std_option_option_generic_ident_option_to_update_try_generate_bind_increments_error_named_for_std_option_option_generic_ident_option_to_update_token_stream = {
            ...
            let try_generate_bind_increments_variants_token_stream = vec_syn_field.iter().map(|element| {
                ...
                quote::quote!{
                    #std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream::#variant_ident_upper_camel_case_token_stream(value) => {
            ...
            quote::quote!{
                impl postgresql_crud::GeneratePostgresqlQueryPartToUpdate<#std_option_option_generic_ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream> for #std_option_option_generic_ident_option_to_update_upper_camel_case_token_stream {
                    fn try_generate_bind_increments(
                        &self,
                        jsonb_set_accumulator: &std::primitive::str,
                        jsonb_set_target: &std::primitive::str,
                    ...
                    fn bind_value_to_query<'a>(self, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments> {
                        match self.0 {
                            ...
                            None => {
                                query = query.bind(sqlx::types::Json(None::<std::option::Option<std::vec::Vec<#std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream>>>));
                            }
                        }
                        query
                    }
        ...
        quote::quote!{
            ...
            #impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_std_option_option_generic_ident_option_to_update_token_stream
    ...
    let std_vec_vec_generic_with_id_ident_token_stream = {
        ...
        let std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream = naming_conventions::ImplQuoteToTokensStdVecVecGenericWithIdSelfOptionToUpdateOriginUpperCamelCaseTokenStream::impl_quote_to_tokens_std_vec_vec_generic_with_id_self_option_to_update_origin_upper_camel_case_token_stream(&ident);
        ...
        let impl_serde_deserialize_for_std_vec_vec_generic_with_id_ident_options_to_update_token_stream = {
            let struct_std_vec_vec_generic_with_id_ident_options_to_update_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                &format!("{struct_space_stringified}{std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_stringified}"),
                &proc_macro_name_upper_camel_case_ident_stringified
            );
            let struct_std_vec_vec_generic_with_id_ident_options_to_update_with_2_elements_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                &format!("{struct_space_stringified}{std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_stringified} with 2 elements"),
                &proc_macro_name_upper_camel_case_ident_stringified
            );
            let std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                &std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_stringified,
                &proc_macro_name_upper_camel_case_ident_stringified
            );
            let custom_checks_token_stream = {
                let custom_serde_error_deserializing_std_vec_vec_generic_with_id_ident_options_to_update_stringified = format!("custom serde error deserializing {std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_stringified}:");
                let check_fields_are_empty_token_stream = {
                    let fields_are_empty_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                        &format!("{custom_serde_error_deserializing_std_vec_vec_generic_with_id_ident_options_to_update_stringified} create, update, delete fields are empty"),
                        &proc_macro_name_upper_camel_case_ident_stringified
                    );
                    quote::quote!{
                ...
                let check_unique_fields_token_stream = {
                    let variants_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        let variant_ident_upper_camel_case_token_stream = proc_macro_common::naming_conventions::ToUpperCamelCaseTokenStream::to_upper_camel_case_token_stream(&field_ident_stringified);
                        let format_handle_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
                            &format!("{custom_serde_error_deserializing_std_vec_vec_generic_with_id_ident_options_to_update_stringified} not unique {field_ident_stringified} field"),
                            &proc_macro_name_upper_camel_case_ident_stringified
                        );
                        quote::quote!{
                            #std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream::#variant_ident_upper_camel_case_token_stream(_) => {
                                let value = #ident_field_to_update_upper_camel_case_token_stream::#variant_ident_upper_camel_case_token_stream;
                                if acc.contains(&value) {
                                    return Err(serde::de::Error::custom(#format_handle_double_quotes_token_stream));
                                }
            ...
            quote::quote!{
                impl<'de> serde::Deserialize<'de> for #std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_token_stream {
                    fn deserialize<__D>(
                        __deserializer: __D,
                    ) -> serde::__private::Result<Self, __D::Error>
                    where
                        __D: serde::Deserializer<'de>,
                    {
                        ...
                        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                            type Value = #std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_token_stream;
                            fn expecting(
                                &self,
                                __formatter: &mut serde::__private::Formatter<'_>,
                            ) -> serde::__private::fmt::Result {
                                ...
                                __A: serde::de::SeqAccess<'de>,
                            {
                                ...
                                let __field1 = match serde::de::SeqAccess::next_element::<
                                    std::vec::Vec<#std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream>,
                                >(&mut __seq)? {
                                    serde::__private::Some(__value) => __value,
                                    serde::__private::None => {
                                        return serde::__private::Err(
                                ...
                                #custom_checks_token_stream
                                serde::__private::Ok(#std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_token_stream {
                                    id: __field0,
                                    fields: __field1,
                                })
                            }
        ...
        //
        let impl_serde_deserialize_for_std_vec_vec_generic_with_id_ident_option_to_update_token_stream = {
            // let tuple_struct_std_option_option_generic_ident_option_to_update_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
            //     &format!("{tuple_struct_space_stringified}{std_option_option_generic_ident_option_to_update_upper_camel_case_stringified}"),
            //     &proc_macro_name_upper_camel_case_ident_stringified
            // );
            ...
            //             let variant_ident_upper_camel_case_token_stream = proc_macro_common::naming_conventions::ToUpperCamelCaseTokenStream::to_upper_camel_case_token_stream(&field_ident_stringified);
            //             let format_handle_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(
            //                 &format!("custom serde error deserializing {std_option_option_generic_ident_option_to_update_upper_camel_case_token_stream}: field {{value:?}} are not unique"),
            //                 &proc_macro_name_upper_camel_case_ident_stringified
            //             );
            //             quote::quote!{
            //                 #std_option_option_generic_ident_option_to_update_origin_upper_camel_case_token_stream::#variant_ident_upper_camel_case_token_stream(_) => {
        ...
        let std_vec_vec_generic_with_id_ident_json_array_change_token_stream = {
            quote::quote!{
                ...
                pub struct #std_vec_vec_generic_with_id_ident_json_array_change_upper_camel_case_token_stream {
                    ...
                    pub create: std::vec::Vec<#std_vec_vec_generic_with_id_ident_to_create_origin_upper_camel_case_token_stream>,
                    #[serde(skip_serializing_if = "Vec::is_empty")]
        ...
        let impl_serde_deserialize_for_std_vec_vec_generic_with_id_ident_json_array_change_token_stream = genarate_impl_serde_deserialize_for_tokens_json_array_change_token_stream(
            &std_vec_vec_generic_with_id_ident_option_to_update_upper_camel_case_stringified,
            &std_vec_vec_generic_with_id_ident_json_array_change_upper_camel_case_token_stream,
            &std_vec_vec_generic_with_id_ident_to_create_origin_upper_camel_case_token_stream,
            &std_vec_vec_generic_with_id_ident_options_to_update_upper_camel_case_token_stream,
            &std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream,
        ...
        quote::quote!{
            ...
            #std_vec_vec_generic_with_id_ident_option_to_update_origin_token_stream
            #impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_std_vec_vec_generic_ident_option_to_update_token_stream
    ...
    let std_option_option_std_vec_vec_generic_with_id_ident_token_stream = {
        ...
        let std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream = naming_conventions::ImplQuoteToTokensStdOptionOptionStdVecVecGenericWithIdSelfOptionToUpdateOriginUpperCamelCaseTokenStream::impl_quote_to_tokens_std_option_option_std_vec_vec_generic_with_id_self_option_to_update_origin_upper_camel_case_token_stream(&ident);
        ...
        let std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_origin_token_stream = generate_tokens_option_to_update_origin_token_stream(&std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream);
        let impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_std_option_option_std_vec_vec_generic_ident_option_to_update_token_stream = generate_impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_option_to_update_token_stream(&std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_origin_upper_camel_case_token_stream);
        let std_option_option_std_vec_vec_generic_with_id_ident_options_to_update_token_stream = generate_tokens_options_to_update_token_stream(
        ...
        let std_option_option_std_vec_vec_generic_with_id_ident_json_array_change_token_stream = {
            quote::quote!{
                ...
                pub struct #std_option_option_std_vec_vec_generic_with_id_ident_json_array_change_upper_camel_case_token_stream {
                    #[serde(skip_serializing_if = "Vec::is_empty")]
                    pub create: std::vec::Vec<#std_option_option_std_vec_vec_generic_with_id_ident_to_create_origin_upper_camel_case_token_stream>,
                    #[serde(skip_serializing_if = "Vec::is_empty")]
        ...
        let impl_serde_deserialize_for_std_option_option_std_vec_vec_generic_with_id_ident_json_array_change_token_stream = genarate_impl_serde_deserialize_for_tokens_json_array_change_token_stream(
            &std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_upper_camel_case_stringified,
        ...
        let std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_try_generate_bind_increments_error_named_token_stream = {
            ...
            quote::quote!{
                #[derive(Debug, thiserror::Error, error_occurence_lib::ErrorOccurence)]
                pub enum #std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream {
                    CheckedAdd {
                        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                    },
                    Create {
        ...
        let impl_postgresql_crud_generate_postgresql_query_part_to_update_std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_try_generate_bind_increments_error_named_for_std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_token_stream = {
            ...
            quote::quote!{
                impl postgresql_crud::GeneratePostgresqlQueryPartToUpdate<#std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_try_generate_bind_increments_error_named_upper_camel_case_token_stream> for #std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_upper_camel_case_token_stream {
                    fn try_generate_bind_increments(
                        &self,
                        jsonb_set_accumulator: &std::primitive::str,
                        jsonb_set_target: &std::primitive::str,
                        ...
                        match &self.0 {
                            Some(value) => {
                                ...
                                // let maybe_jsonb_build_array = if create_query_part_acc.is_empty() { std::string::String::default() } else { format!(" || jsonb_build_array({create_query_part_acc})") }; 
                                Ok(format!("jsonb_set({jsonb_set_accumulator},'{{{jsonb_set_path}}}', case when jsonb_typeof({jsonb_set_target}) = 'array' then case when jsonb_array_length({jsonb_set_target}) = 0 then '[]' :: jsonb else (select jsonb_agg({update_query_part_acc}) from jsonb_array_elements({jsonb_set_target}) as elem {maybe_where}) end else '[]'::jsonb end {maybe_jsonb_build_array})"))
                            }
                            None => match increment.checked_add(1) {
                                Some(value) => {
                                    *increment = value;
        ...
        quote::quote!{
            ...
            #std_option_option_std_vec_vec_generic_with_id_ident_option_to_update_origin_token_stream
            #impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_std_option_option_std_vec_vec_generic_ident_option_to_update_token_stream
