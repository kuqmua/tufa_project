...
pub fn generate_postgresql_query_part(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_impl_std_fmt_display_for_ident_token_stream = |value_token_stream: &proc_macro2::TokenStream|{
        quote::quote!{
    ...
    |{
        ...
        let content_token_stream = match &field_reader_content {
            ...
            FieldReaderContent::GenericAndStdOptionOptionGeneric => quote::quote!{(#std_vec_vec_ident_field_to_read_upper_camel_case_token_stream_token_stream);},
    ...
    let generic_ident_token_stream = {
        ...
        let impl_serde_deserialize_for_ident_options_to_read_token_stream = {
            ...
            //     }
            // });
            // let struct_generic_ident_options_to_read_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(&format!("struct {generic_ident_options_to_read_upper_camel_case_stringified}"), &proc_macro_name_upper_camel_case_ident_stringified);
            // let struct_generic_ident_options_to_read_with_double_quotes_token_stream = proc_macro_common::generate_quotes::double_quotes_token_stream(&format!("struct {generic_ident_options_to_read_upper_camel_case_stringified} with {} elements", vec_syn_field.len()), &proc_macro_name_upper_camel_case_ident_stringified);
            // // // let generate_type_token_stream = |value: &syn::Field| {
            // // //     // let supported_predefined_type = SupportedPredefinedType::try_from(value).unwrap_or_else(|error| panic!("{proc_macro_name_upper_camel_case_ident_stringified} failed to convert into SupportedPredefinedType: {error:#?}"));
            // // //     // match supported_predefined_type {
            // // //     //     SupportedPredefinedType::JsonStdPrimitiveI8
            ...
            //     let element_type = &element.ty;
            //     quote::quote! {
            //         let #field_index_token_stream = match serde::de::SeqAccess::next_element::<std::option::Option<std::result::Result<#element_type, std::string::String>>>(&mut __seq)? {
            //             serde::__private::Some(__value) => match __value {
            //                 Some(value) => match value {
            //                     Ok(value) => Some(value),
            //                     Err(error) => {
            //                         return Err(serde::de::Error::custom(error));
            ...
            //                     serde::de::Error::invalid_length(
            //                         #index_usize_token_stream,
            //                         &#struct_generic_ident_options_to_read_with_double_quotes_token_stream,
            //                     ),
            //                 );
            //             }
            //         };
            ...
            //         let mut #field_index_token_stream: serde::__private::Option<
            //             std::option::Option<
            //                 std::result::Result<#element_type, std::string::String>,
            //             >,
            //         > = serde::__private::None;
            //     }
            // });
            ...
            //     let field_ident_double_quotes_token_stream = generate_field_ident_double_quotes_token_stream(&element);
            //     // let type_token_stream = generate_type_token_stream(element);
            //     //todo match inner type &element.type is not correct
            //     let element_type = &element.ty;
            //     quote::quote! {
            //         __Field::#field_index_token_stream => {
            //             if serde::__private::Option::is_some(&#field_index_token_stream) {
            ...
            // let fields_array_elements_token_stream = vec_syn_field.iter().map(|element| generate_field_ident_double_quotes_token_stream(&element));
            quote::quote! {
            //     impl<'de> serde::Deserialize<'de> for #generic_ident_options_to_read_upper_camel_case_token_stream {
            //         fn deserialize<__D>(
            //             __deserializer: __D,
            //         ) -> serde::__private::Result<Self, __D::Error>
            //         where
    ...
    let std_option_option_generic_ident_token_stream = {
        ...
        let std_option_option_generic_ident_to_create_token_stream = generate_tokens_to_create_token_stream(&std_option_option_generic_ident_to_create_upper_camel_case_token_stream);
        ...
        let impl_postgresql_crud_json_create_bind_query_for_std_option_option_generic_ident_to_create_token_stream = generate_impl_postgresql_crud_json_create_bind_query_for_tokens_to_create_token_stream(&std_option_option_generic_ident_to_create_upper_camel_case_token_stream, false);
        quote::quote!{
    ...
    let std_vec_vec_generic_with_id_ident_token_stream = {
        ...
        let std_vec_vec_generic_with_id_ident_to_create_token_stream = generate_tokens_to_create_token_stream(&std_vec_vec_generic_with_id_ident_to_create_upper_camel_case_token_stream);
        ...
        let impl_postgresql_crud_json_create_bind_query_for_std_vec_vec_generic_with_id_ident_to_create_token_stream = generate_impl_postgresql_crud_json_create_bind_query_for_tokens_to_create_token_stream(&std_vec_vec_generic_with_id_ident_to_create_upper_camel_case_token_stream, false);
        quote::quote!{
    ...
    let std_option_option_std_vec_vec_generic_with_id_ident_token_stream = {
        ...
        let std_option_option_std_vec_vec_generic_with_id_ident_to_create_token_stream = generate_tokens_to_create_token_stream(&std_option_option_std_vec_vec_generic_with_id_ident_to_create_upper_camel_case_token_stream);
