...
pub fn generate_postgresql_query_part(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generic_ident_token_stream = {
        ...
        //             })
        //             .to_string();
        //         let variant_ident_upper_camel_case_stringified = proc_macro_common::naming_conventions::ToUpperCamelCaseStringified::to_upper_camel_case_stringified(&field_ident_stringified);
        //         quote::quote!{
        //             #generic_ident_option_to_update_upper_camel_case_token_stream::#variant_ident_upper_camel_case_stringified(value) => {
        //                 acc = postgresql_crud::GeneratePostgresqlQueryPartToUpdate::try_generate_bind_increments(
        //                     //todo fix parameters
        //                     &value,
        //                     jsonb_set_accumulator,
        //                     jsonb_set_target,
