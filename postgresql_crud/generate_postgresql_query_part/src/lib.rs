...
pub fn generate_postgresql_query_part(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
                    ...
                    __D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                        ...
                        where
                            __A: serde::de::SeqAccess<'de>,
                        {
                            let __field0 = match serde::de::SeqAccess::next_element::<std::vec::Vec<#tokens_to_create_upper_camel_case_token_stream>>(&mut __seq)? {
                                serde::__private::Some(__value) => __value,
                                serde::__private::None => {
                                    vec![]
                                }
                        ...
                        where
                            __A: serde::de::MapAccess<'de>,
                        {
                            let mut __field0: serde::__private::Option<std::vec::Vec<#tokens_to_create_upper_camel_case_token_stream>> = serde::__private::None;
                            ...
                            while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                                match __key {
                                    __Field::__field0 => {
                                        ...
                                        __field0 = serde::__private::Some(serde::de::MapAccess::next_value::<std::vec::Vec<#tokens_to_create_upper_camel_case_token_stream>>(&mut __map)?);
                                    }
                                    __Field::__field1 => {
    ...
    let genarate_impl_serde_deserialize_for_tokens_json_array_change_token_stream_second = |
        tokens_option_to_update_upper_camel_case_stringified: &std::primitive::str,
        tokens_json_array_change_upper_camel_case_token_stream: &proc_macro2::TokenStream,
    ...
    let std_vec_vec_generic_with_id_ident_token_stream = {
        ...
        let impl_serde_deserialize_for_std_vec_vec_generic_with_id_ident_json_array_change_token_stream = genarate_impl_serde_deserialize_for_tokens_json_array_change_token_stream_second(
