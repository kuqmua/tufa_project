...
pub enum VecOfStdPrimitiveI8AsNotNullArrayOfNotNullJsonbNumberWhereElement {
    ...
    DimensionOneEqual(where_element_filters::PostgresqlJsonTypeWhereElementDimensionOneEqual<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    ...
    DimensionOneContainsAllElementsOfArray(where_element_filters::PostgresqlJsonTypeWhereElementDimensionOneContainsAllElementsOfArray<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    DimensionOneOverlapsWithArray(where_element_filters::PostgresqlJsonTypeWhereElementDimensionOneOverlapsWithArray<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    AllElementsEqual(where_element_filters::PostgresqlJsonTypeWhereElementAllElementsEqual<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    DimensionOneIn(where_element_filters::PostgresqlJsonTypeWhereElementDimensionOneIn<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    DimensionOneGreaterThan(where_element_filters::PostgresqlJsonTypeWhereElementDimensionOneGreaterThan<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    DimensionOneBetween(where_element_filters::PostgresqlJsonTypeWhereElementDimensionOneBetween<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    ContainsElementGreaterThan(where_element_filters::PostgresqlJsonTypeWhereElementContainsElementGreaterThan<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
    AllElementsGreaterThan(where_element_filters::PostgresqlJsonTypeWhereElementAllElementsGreaterThan<StdPrimitiveI8AsNotNullJsonbNumberOrigin>),
}
