    ...
    let (_fields_token_stream, postgresql_json_type_array) = postgresql_json_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let generate_into_inner_content_token_stream = |content_token_stream: &dyn quote::ToTokens| {
                ...
                let into_inner_content_token_stream = match &element.postgresql_json_type_pattern {
            ...
            let ident_origin_token_stream = {
                ...
                let impl_std_convert_into_ident_origin_impl_new_value_type_for_ident_origin_token_stream = {
                    ...
                    quote::quote! {
                        impl std::convert::Into<#ident_origin_impl_new_value_type_token_stream> for #ident_origin_upper_camel_case {
                            fn into(self) -> #ident_origin_impl_new_value_type_token_stream {
                        ...
                        let content_token_stream = match &postgresql_json_type_pattern {
                            ...
                            PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => generate_acc_content_token_stream(
                                ...
                                &{
                                    ...
                                    // }
                                    if let NotNullOrNullable::NotNull = &not_null_or_nullable
                                        && let NotNullOrNullable::NotNull = &dimension1_not_null_or_nullable
                                    {
                                        quote::quote! {
                            ...
                            PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => generate_acc_content_token_stream(
                                not_null_or_nullable,
                                &generate_ident_token_stream(dimension1_not_null_or_nullable, &PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable: *dimension2_not_null_or_nullable }),
                                &{
