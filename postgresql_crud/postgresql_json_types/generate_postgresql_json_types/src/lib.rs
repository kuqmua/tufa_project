...
pub fn generate_postgresql_json_types(
    ...
    let postgresql_json_type_record_vec = {
        ...
        postgresql_json_type_record_vec.into_iter().fold(Vec::new(), |mut acc, postgresql_json_type_record_element| {
    ...
    //     &serde_json::to_string(&postgresql_json_type_record_vec).expect("5480b910-d98e-414a-a273-1a9bf44cc515"),
    // );
