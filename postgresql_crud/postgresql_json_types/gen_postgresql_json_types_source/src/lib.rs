use naming::{
    ...
    EqualUcc, ErrorSc, GenPostgresqlJsonTypesModSc, IncrementSc, JsonbSetAccumulatorSc, NewSc,
...
#[must_use]
pub fn gen_postgresql_json_types(input_ts: &proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    ...
    enum GenPostgresqlJsonTypesConfigVariant {
        All,
        WithoutDimensions,
        WithDimensionOne,
        WithDimensionTwo,
    ...
    struct GenPostgresqlJsonTypesConfig {
        ...
        whole_content_write_into_gen_postgresql_json_types:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
        variant: GenPostgresqlJsonTypesConfigVariant,
    }
    ...
    let (fields_ts, postgresql_json_type_array) = {
        {
            let gen_standart = |acc_29796d99: &mut Vec<PostgresqlJsonTypeRecord>, postgresql_json_type: PostgresqlJsonType|{
            ...
            let gen_array_dimension1 = |acc_5b22a398: &mut Vec<PostgresqlJsonTypeRecord>, postgresql_json_type: PostgresqlJsonType|{
            ...
            let gen_array_dimension2 = |acc_e59f7158: &mut Vec<PostgresqlJsonTypeRecord>, postgresql_json_type: PostgresqlJsonType|{
            ...
            let gen_array_dimension3 = |acc_77498dc3: &mut Vec<PostgresqlJsonTypeRecord>, postgresql_json_type: PostgresqlJsonType|{
            ...
            let gen_array_dimension4 = |acc_7c8a3329: &mut Vec<PostgresqlJsonTypeRecord>, postgresql_json_type: PostgresqlJsonType|{
            ...
            let acc_d97120ed = match gen_postgresql_json_types_config.variant {
                GenPostgresqlJsonTypesConfigVariant::All => PostgresqlJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_e2f65a79, postgresql_json_type| {
                    for el_644643cd in PostgresqlJsonTypePattern::into_array() {
                        match &el_644643cd {
                            PostgresqlJsonTypePattern::Standart => gen_standart(&mut acc_e2f65a79, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_e2f65a79, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_e2f65a79, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension3 { .. } => gen_array_dimension3(&mut acc_e2f65a79, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension4 { .. } => gen_array_dimension4(&mut acc_e2f65a79, postgresql_json_type.clone()),
                        }
                    }
                    acc_e2f65a79
                }),
                GenPostgresqlJsonTypesConfigVariant::WithoutDimensions => PostgresqlJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_3d95645c, postgresql_json_type| {
                    for el_fccf1979 in PostgresqlJsonTypePattern::into_array() {
                        match &el_fccf1979 {
                            PostgresqlJsonTypePattern::Standart => gen_standart(&mut acc_3d95645c, postgresql_json_type.clone()),
                ...
                GenPostgresqlJsonTypesConfigVariant::WithDimensionOne => PostgresqlJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_66a17cae, postgresql_json_type| {
                    for el_e69bd1fc in PostgresqlJsonTypePattern::into_array() {
                        match &el_e69bd1fc {
                            PostgresqlJsonTypePattern::Standart => gen_standart(&mut acc_66a17cae, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_66a17cae, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension2 { .. } |
                            PostgresqlJsonTypePattern::ArrayDimension3 { .. } |
                            PostgresqlJsonTypePattern::ArrayDimension4 { .. } => (),
                        }
                ...
                GenPostgresqlJsonTypesConfigVariant::WithDimensionTwo => PostgresqlJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_c5ffb796, postgresql_json_type| {
                    for el_345fd6bd in PostgresqlJsonTypePattern::into_array() {
                        match &el_345fd6bd {
                            PostgresqlJsonTypePattern::Standart => gen_standart(&mut acc_c5ffb796, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_c5ffb796, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_c5ffb796, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension3 { .. } |
                            PostgresqlJsonTypePattern::ArrayDimension4 { .. } => (),
                        }
                    }
                ...
                GenPostgresqlJsonTypesConfigVariant::WithDimensionThree => PostgresqlJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_78b27c00, postgresql_json_type| {
                    for el_88e3b8fe in PostgresqlJsonTypePattern::into_array() {
                        match &el_88e3b8fe {
                            PostgresqlJsonTypePattern::Standart => gen_standart(&mut acc_78b27c00, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_78b27c00, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_78b27c00, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension3 { .. } => gen_array_dimension3(&mut acc_78b27c00, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension4 { .. } => (),
                        }
                    }
                    acc_78b27c00
                }),
                GenPostgresqlJsonTypesConfigVariant::WithDimensionFour => PostgresqlJsonType::into_array().into_iter().fold(Vec::new(), |mut acc_172c62ad, postgresql_json_type| {
                    for el_80434642 in PostgresqlJsonTypePattern::into_array() {
                        match &el_80434642 {
                            PostgresqlJsonTypePattern::Standart => gen_standart(&mut acc_172c62ad, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension1 { .. } => gen_array_dimension1(&mut acc_172c62ad, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension2 { .. } => gen_array_dimension2(&mut acc_172c62ad, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension3 { .. } => gen_array_dimension3(&mut acc_172c62ad, postgresql_json_type.clone()),
                            PostgresqlJsonTypePattern::ArrayDimension4 { .. } => gen_array_dimension4(&mut acc_172c62ad, postgresql_json_type.clone()),
                        }
                    }
                    acc_172c62ad
                }),
                GenPostgresqlJsonTypesConfigVariant::Concrete(value) => value,
            };
            ...
            for el_7ae8d2ae in {
                ...
                fn gen_postgresql_json_type_record_handle_vec(postgresql_json_type_record_handle: PostgresqlJsonTypeRecordHandle) -> Vec<PostgresqlJsonTypeRecordHandle> {
                    let gen_vec = |current_postgresql_json_type_record_handle: PostgresqlJsonTypeRecordHandle| gen_postgresql_json_type_record_handle_vec(
                    ...
                    match (&postgresql_json_type_record_handle.not_null_or_nullable, &postgresql_json_type_record_handle.postgresql_json_type_pattern) {
                        ...
                        (NotNullOrNullable::Nullable, PostgresqlJsonTypePattern::Standart) => gen_vec(PostgresqlJsonTypeRecordHandle {
                            not_null_or_nullable: NotNullOrNullable::NotNull,
                            postgresql_json_type_pattern: PostgresqlJsonTypePattern::Standart,
                        }),
                        (NotNullOrNullable::NotNull, PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable }) => gen_vec(PostgresqlJsonTypeRecordHandle {
                        ...
                        (NotNullOrNullable::NotNull, PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. }) => gen_vec(PostgresqlJsonTypeRecordHandle {
                            not_null_or_nullable: *dimension1_not_null_or_nullable,
                        ...
                        ) => gen_vec(PostgresqlJsonTypeRecordHandle {
                            not_null_or_nullable: *dimension1_not_null_or_nullable,
                            postgresql_json_type_pattern: PostgresqlJsonTypePattern::ArrayDimension2 {
                                dimension1_not_null_or_nullable: *dimension2_not_null_or_nullable,
                                dimension2_not_null_or_nullable: *dimension3_not_null_or_nullable,
                        ...
                        (NotNullOrNullable::Nullable, PostgresqlJsonTypePattern::ArrayDimension1 { .. } | PostgresqlJsonTypePattern::ArrayDimension2 { .. } | PostgresqlJsonTypePattern::ArrayDimension3 { .. } | PostgresqlJsonTypePattern::ArrayDimension4 { .. }) => gen_vec(PostgresqlJsonTypeRecordHandle {
                            not_null_or_nullable: NotNullOrNullable::NotNull,
                            postgresql_json_type_pattern: postgresql_json_type_record_handle.postgresql_json_type_pattern.clone(),
                        }),
                    }
                }
                gen_postgresql_json_type_record_handle_vec(PostgresqlJsonTypeRecordHandle {
    ...
    .map(|(index, el_1d376874)| {
        ...
        let gen_ident_ts = |current_not_null_or_nullable: &NotNullOrNullable, current_postgresql_json_type_pattern: &PostgresqlJsonTypePattern| {
        ...
        let ident = &gen_ident_ts(not_null_or_nullable, postgresql_json_type_pattern);
        let ident_standart_not_null_ucc = &gen_ident_ts(&NotNullOrNullable::NotNull, &PostgresqlJsonTypePattern::Standart);
        ...
        let ident_not_null_ts = gen_ident_ts(&NotNullOrNullable::NotNull, postgresql_json_type_pattern);
        let ident_ts = {
        ...
        let ident_origin_ts = {
            ...
            | SelfOriginUcc::from_tokens(&gen_ident_ts(current_not_null_or_nullable, current_postgresql_json_type_pattern));
                ...
                .build_struct(
                    ...
                    &{
                        let content_ts: &dyn quote::ToTokens = {
                            let gen_current_ident_origin = |current_not_null_or_nullable: &NotNullOrNullable, current_postgresql_json_type_pattern: &PostgresqlJsonTypePattern| {
                                let value = gen_current_ident_origin_non_wrapping(current_not_null_or_nullable, current_postgresql_json_type_pattern);
                            ...
                            match &postgresql_json_type_pattern {
                                ...
                                PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => &{
                                    ...
                                    gen_current_ident_origin(current_not_null_or_nullable, current_postgresql_json_type_pattern)
                                },
            ...
            let ident_origin_impl_new_self_content_ts = {
                ...
                match &postgresql_json_type_pattern {
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_array_dimensions_initialization_ts(&{
                        ...
                        gen_current_ident_origin_non_wrapping(current_not_null_or_nullable, current_postgresql_json_type_pattern)
                    }),
                    PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgresql_json_type_pattern, current_not_null_or_nullable): (&PostgresqlJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgresql_json_type_pattern, current_not_null_or_nullable): (&PostgresqlJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_array_dimensions_initialization_ts(&{
                        let (current_postgresql_json_type_pattern, current_not_null_or_nullable): (&PostgresqlJsonTypePattern, &NotNullOrNullable) = match &not_null_or_nullable {
            ...
            //         let schema_id_format_handle_ts = gen_quotes::double_quotes_ts(&format!("postgresql_crud::postgersql_json_type::{ident_origin_ucc}"));
            ...
            let maybe_impl_is_string_empty_for_ident_origin_ts = if matches!(&is_standart_not_null, IsStandartNotNull::True) {
                match &postgresql_json_type {
                    ...
                    PostgresqlJsonType::StdStringStringAsJsonbString => postgresql_crud_macros_common::gen_impl_crate_is_string_empty_for_ident_content_ts(
                        &ident_origin_ucc,
                        &quote!{self.0.clone().is_empty()}
                    ),
                    PostgresqlJsonType::UuidUuidAsJsonbString => postgresql_crud_macros_common::gen_impl_crate_is_string_empty_for_ident_content_ts(
                        &ident_origin_ucc,
            ...
            let impl_sqlx_type_sqlx_postgres_for_ident_origin_ts = postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_origin_ucc, &postgresql_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&ident_read_inner_ucc));
            let impl_sqlx_encode_sqlx_postgres_for_ident_origin_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_origin_ucc, &quote! {sqlx::types::Json(&#self_sc.0)});
            quote! {
                #ident_origin_ts
        ...
        let ident_table_type_declaration_ts = {
            ...
            let impl_sqlx_encode_sqlx_postgres_for_ident_table_type_declaration_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_table_type_declaration_ucc, &quote! {&#self_sc.0});
            //todo maybe add to trait?
            let impl_sqlx_type_sqlx_postgres_for_ident_table_type_declaration_ts = postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_table_type_declaration_ucc, &postgresql_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&ident_read_inner_ucc));
            quote! {
        ...
        let ident_create_ts = {
            ...
            let impl_default_option_some_vec_one_el_for_ident_create_ts =
                postgresql_crud_macros_common::gen_impl_postgresql_crud_common_default_option_some_vec_one_el_ts(&ident_create_ucc, &quote! {Self(#postgresql_crud_common_default_option_some_vec_one_el_call_ts)});
            quote! {
                #ident_create_ts
        ...
        let ident_create_for_query_ts = {
            ...
            let impl_sqlx_encode_sqlx_postgres_for_ident_create_for_query_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_create_for_query_ucc, &quote! {sqlx::types::Json(&#self_sc.0)});
            let impl_sqlx_type_sqlx_postgres_for_ident_create_for_query_ts = postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_create_for_query_ucc, &ident_origin_ucc);
        ...
        let ident_select_ts = {
            ...
            let impl_default_option_some_vec_one_el_for_postgresql_json_type_ident_select_ts =
                postgresql_crud_macros_common::gen_impl_postgresql_crud_common_default_option_some_vec_one_el_ts(&ident_select_ucc, &gen_default_some_one_content_ts(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne));
            let impl_default_option_some_vec_one_el_max_page_size_for_postgresql_json_type_ident_select_ts =
                postgresql_crud_macros_common::gen_impl_postgresql_crud_common_default_option_some_vec_one_el_max_page_size_ts(&ident_select_ucc, &gen_default_some_one_content_ts(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize));
            quote! {
                #ident_select_ts
        ...
        let ident_where_ts = match &not_null_or_nullable {
            NotNullOrNullable::NotNull => postgresql_crud_macros_common::gen_postgresql_type_where_ts(
                &allow_clippy_arbitrary_source_item_ordering_ts,
                &{
                    #[derive(Debug, Clone)]
                    ...
                    match &postgresql_json_type_pattern {
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("21eaebaf-cd7a-4625-9232-0e23788a5432")));
                                quote! {#value}
                            };
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => {
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("0c4491c4-8364-4c27-9478-227aefadb086")));
                                quote! {#value}
                            };
                            let array_dimension2_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension2_not_null_or_nullable, &postgresql_json_type_pattern.down_by_2().expect("2d4ee5d4-490e-4503-91a7-ed29f73e6219")));
                                quote! {#value}
                            };
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension3 {
                            ...
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("3450bef4-e5f3-4bcd-b2de-4e4c67143336")));
                                quote! {#value}
                            };
                            let array_dimension2_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension2_not_null_or_nullable, &postgresql_json_type_pattern.down_by_2().expect("3c0d10f4-6d7d-45d0-b929-5e307c7d79b1")));
                                quote! {#value}
                            };
                            let array_dimension3_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension3_not_null_or_nullable, &postgresql_json_type_pattern.down_by_3().expect("9aaf9e82-0a92-4848-bfd4-de49013972a5")));
                                quote! {#value}
                            };
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension4 {
                            ...
                            let array_dimension1_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("550d313b-e925-496d-8a57-87931c573155")));
                                quote! {#value}
                            };
                            let array_dimension2_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension2_not_null_or_nullable, &postgresql_json_type_pattern.down_by_2().expect("7bda1424-64c0-402e-9bf8-44d5fb3b9903")));
                                quote! {#value}
                            };
                            let array_dimension3_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension3_not_null_or_nullable, &postgresql_json_type_pattern.down_by_3().expect("b43aa5bd-9bba-4f3e-b93b-a41f108262ff")));
                                quote! {#value}
                            };
                            let array_dimension4_inner_el_ident_table_type_declaration_ucc = {
                                let value = SelfTableTypeDeclarationUcc::from_tokens(&gen_ident_ts(dimension4_not_null_or_nullable, &postgresql_json_type_pattern.down_by_4().expect("a246885a-ca72-4e37-a396-b7220e237c7e")));
                                quote! {#value}
                            };
        ...
        let ident_read_ts = {
            ...
            let impl_sqlx_encode_sqlx_postgres_for_ident_read_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_read_ucc, &quote! {&#self_sc.0});
            let impl_sqlx_type_sqlx_postgres_for_ident_read_ts = postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(&ident_read_ucc, &postgresql_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&ident_read_inner_ucc));
            quote! {
                #ident_read_ts
                #impl_ident_read_ts
        ...
        let ident_read_only_ids_ts = macros_helpers::StructOrEnumDeriveTokenStreamBuilder::new()
            ...
            .build_struct(
                ...
                &{
                    let std_option_option_unit_ts = postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&quote! {()});
                    let vec_ts = |value: &dyn quote::ToTokens| postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&value);
                        ...
                        match &postgresql_json_type_pattern {
                            PostgresqlJsonTypePattern::Standart => {
                                let ts1 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_read_inner_standart_not_null_alias_ts),
                                };
                                quote! {#ts1}
                            }
                            PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => {
                                ...
                                let ts2 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts1),
                                };
                                quote! {#ts2}
                            }
                            PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => {
                                ...
                                let ts3 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts2),
                                };
                                quote! {#ts3}
                            }
                            PostgresqlJsonTypePattern::ArrayDimension3 {
                                ...
                                let ts4 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts3),
                                };
                                quote! {#ts4}
                            }
                            PostgresqlJsonTypePattern::ArrayDimension4 {
                                ...
                                let ts5 = match &not_null_or_nullable {
                                    ...
                                    NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ts4),
                                };
                                quote! {#ts5}
                            }
                        }
        ...
        let ident_read_inner_ts = {
            let type_ts = match &postgresql_json_type_pattern {
                ...
                PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => &{
                    ...
                    let dimension1_type = dimension1_not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension2_type));
                    not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension1_type))
                },
                PostgresqlJsonTypePattern::ArrayDimension3 {
                    dimension1_not_null_or_nullable,
                    ...
                    let dimension2_type = dimension2_not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension3_type));
                    let dimension1_type = dimension1_not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension2_type));
                    not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension1_type))
                },
                PostgresqlJsonTypePattern::ArrayDimension4 {
                    ...
                    let dimension3_type = dimension3_not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension4_type));
                    let dimension2_type = dimension2_not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension3_type));
                    let dimension1_type = dimension1_not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension2_type));
                    not_null_or_nullable.maybe_option_wrap(postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&dimension1_type))
                },
        ...
        let ident_update_for_query_ts = {
            ...
            let impl_sqlx_encode_sqlx_postgres_for_ident_update_for_query_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(&ident_update_for_query_ucc, &quote! {sqlx::types::Json(&#self_sc.0)});
        ...
        let impl_postgresql_json_type_for_ident_ts = {
            ...
            let select_only_created_or_updated_ids_query_part_ts = if matches!(&postgresql_json_type, PostgresqlJsonType::UuidUuidAsJsonbString) {
                ...
                quote! {Ok(gen_postgresql_json_types_common::field_ident_jsonb_build_object_value(field_ident))}
            };
            ...
            postgresql_crud_macros_common::gen_impl_postgresql_json_type_ts(
                ...
                &{
                    ...
                    let into_inner_content_ts = match &postgresql_json_type_pattern {
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_into_iter_map_el_collect_not_null_or_nullable_ts(
                            &quote!{el_0fdb74a5},
                            dimension1_not_null_or_nullable,
                        ),
                        PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => {
        ...
        let maybe_impl_postgresql_json_type_object_vec_el_id_for_ident_origin_ts = if matches!(&is_standart_not_null_uuid, IsStandartNotNullUuid::True) {
            let (query_bind_string_as_postgresql_text_create_for_query_ts, query_bind_string_as_postgresql_text_update_for_query_ts) = {
                ...
                let gen_query_bind_string_as_postgresql_text_ts = |create_for_query_or_update_for_query: &CreateForQueryOrUpdateForQuery| {
                    let name_ts = format!(
                ...
                (gen_query_bind_string_as_postgresql_text_ts(&CreateForQueryOrUpdateForQuery::CreateForQuery), gen_query_bind_string_as_postgresql_text_ts(&CreateForQueryOrUpdateForQuery::UpdateForQuery))
            };
            quote! {
                #allow_clippy_arbitrary_source_item_ordering_ts
        ...
        let impl_postgresql_json_type_test_cases_for_ident_ts = {
            ...
            let gen_array_dimension_equal_ts = |dimension: &postgresql_crud_macros_common::Dimension| {
                    ...
                    let content_ts_c85923bd = {
                        ...
                        let mut content_ts_4c106eea = {
                            let content_ts_f1ffd3b2 = {
                                ...
                                let current_where_ident_where_ucc = SelfWhereUcc::from_tokens(&gen_ident_ts(&NotNullOrNullable::NotNull, postgresql_json_type_pattern));
                ...
                match &postgresql_json_type_pattern {
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => match dimension_index_number_max {
                        postgresql_crud_macros_common::DimensionIndexNumber::Zero => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                        ]),
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, dimension2_not_null_or_nullable } => match dimension_index_number_max {
                        ...
                        postgresql_crud_macros_common::DimensionIndexNumber::One => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                            dimension2_not_null_or_nullable
                        ]),
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension3 {
                        ...
                        postgresql_crud_macros_common::DimensionIndexNumber::Two => gen_dimension_index_number_ts(&[
                            dimension1_not_null_or_nullable,
                            dimension2_not_null_or_nullable,
                            dimension3_not_null_or_nullable
                        ]),
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension4 {
                        ...
                        match dimension_index_number_max {
                            ...
                            postgresql_crud_macros_common::DimensionIndexNumber::Three => gen_dimension_index_number_ts(&[
                                dimension1_not_null_or_nullable,
                                dimension2_not_null_or_nullable,
                                dimension3_not_null_or_nullable,
                                dimension4_not_null_or_nullable
            ...
            let option_vec_create_ts = {
                ...
                let content_ts = match &postgresql_json_type_pattern {
                    PostgresqlJsonTypePattern::Standart => match &not_null_or_nullable {
                        ...
                        NotNullOrNullable::Nullable => gen_some_acc_content_ts(not_null_or_nullable, &gen_ident_ts(&NotNullOrNullable::NotNull, &PostgresqlJsonTypePattern::Standart)),
                    },
                    PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("dec468c0-09fd-4db3-98e7-7fa9cd565909")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgresql_json_type_pattern),
                        },
                    ),
                    PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("4010ebf7-d6e2-4d6e-a562-a299201c92ec")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgresql_json_type_pattern),
                        },
                    ),
                    PostgresqlJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("acdbb564-b169-40db-9815-2653c0150a4c")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgresql_json_type_pattern),
                        },
                    ),
                    PostgresqlJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_some_acc_content_ts(
                        not_null_or_nullable,
                        &match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("5abf9504-cde0-4c6c-adb9-145b385918a5")),
                            NotNullOrNullable::Nullable => gen_ident_ts(&NotNullOrNullable::NotNull, postgresql_json_type_pattern),
                        },
                    ),
                };
            ...
            let read_only_ids_to_two_dimensional_vec_read_inner_ts = {
                ...
                let content_ts = match &postgresql_json_type_pattern {
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_acc_content_handle_ts(
                        &gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("d6f89137-9a47-4f74-afce-0e1959d3dc59")),
                    ...
                    PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_acc_content_handle_ts(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("38774398-d485-4c14-84e8-92e06c36c23b")), &has_len_greater_than_one_ts),
                    PostgresqlJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_acc_content_handle_ts(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("053f4bab-0a8e-457f-9176-50e519b312bb")), &has_len_greater_than_one_ts),
                    PostgresqlJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_acc_content_handle_ts(&gen_ident_ts(dimension1_not_null_or_nullable, &postgresql_json_type_pattern.down_by_1().expect("860f8f15-72ac-4557-a2c6-87b1aa958eb4")), &has_len_greater_than_one_ts),
                };
                match &postgresql_json_type {
                    PostgresqlJsonType::StdPrimitiveI8AsJsonbNumber
                    | PostgresqlJsonType::StdPrimitiveI16AsJsonbNumber
            ...
            let update_to_read_only_ids_ts = {
                let value_initialization_ts = gen_import_path_value_initialization_ts(&if matches!(&postgresql_json_type, PostgresqlJsonType::UuidUuidAsJsonbString) {
                    ...
                    match &postgresql_json_type_pattern {
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension1 { dimension1_not_null_or_nullable } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension2 { dimension1_not_null_or_nullable, .. } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => *dimension1_not_null_or_nullable,
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension3 { dimension1_not_null_or_nullable, .. } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => *dimension1_not_null_or_nullable,
                        ...
                        PostgresqlJsonTypePattern::ArrayDimension4 { dimension1_not_null_or_nullable, .. } => gen_iter_or_match_ts(
                            not_null_or_nullable,
                            &gen_ident_ts(
                                &match &not_null_or_nullable {
                                    NotNullOrNullable::NotNull => *dimension1_not_null_or_nullable,
            ...
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_one_equal_ts = gen_array_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::One);
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_two_equal_ts = gen_array_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::Two);
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_three_equal_ts = gen_array_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::Three);
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_four_equal_ts = gen_array_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::Four);
            ...
            let create_into_postgresql_json_type_option_vec_where_length_equal_ts = {
                ...
                match &postgresql_json_type_pattern {
                    PostgresqlJsonTypePattern::Standart => none_ts.clone(),
                    PostgresqlJsonTypePattern::ArrayDimension1 { .. } | PostgresqlJsonTypePattern::ArrayDimension2 { .. } | PostgresqlJsonTypePattern::ArrayDimension3 { .. } | PostgresqlJsonTypePattern::ArrayDimension4 { .. } => gen_ts(),
                }
            };
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_json_types_config.postgresql_table_columns_content_write_into_postgresql_table_columns_using_postgresql_json_types,
    ...
    let gend = {
        let gen_postgresql_json_types_mod_sc = GenPostgresqlJsonTypesModSc;
        ...
        quote! {
            #[allow(unused_qualifications)]
            #[allow(clippy::absolute_paths)]
            mod #gen_postgresql_json_types_mod_sc {
                #(#content_ts)*
            }
            pub use #gen_postgresql_json_types_mod_sc::*;
        }
    };
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_json_types_config.whole_content_write_into_gen_postgresql_json_types,
        "gen_postgresql_json_types",
        &gend,
        &macros_helpers::FormatWithCargofmt::True,
    );
    gend
