...
// trait_alias!( = );
// trait_alias!( = );
trait_alias!(TableTypeDeclarationAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement);
trait_alias!(CreateAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement);
trait_alias!(CreateForQueryAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> sqlx::Encode<'__, sqlx::Postgres> + sqlx::Type<sqlx::Postgres>);
trait_alias!(SelectAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement);
trait_alias!(WhereElementAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + for<'__> crate::PostgresqlTypeWhereFilter<'__>);
trait_alias!(ReadAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__>);
trait_alias!(ReadOnlyIdsAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__>);
trait_alias!(ReadInnerAlias = std::fmt::Debug + Clone + PartialEq);
trait_alias!(UpdateAlias = std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement);
trait_alias!(UpdateForQuery = std::fmt::Debug + Clone + PartialEq + serde::Serialize);
...
pub trait PostgresqlType {
    ...
    type Read: ReadAlias + sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Decode<'__, sqlx::Postgres>;
...
pub trait PostgresqlJsonType {
    ...
    type Read: ReadAlias + for<'__> utoipa::ToSchema<'__> + schemars::JsonSchema + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement;
    type ReadOnlyIds: ReadOnlyIdsAlias;
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String;
    type ReadInner: ReadInnerAlias;
    fn into_inner(value: Self::Read) -> Self::ReadInner;
    type Update: UpdateAlias + for<'__> utoipa::ToSchema<'__> + schemars::JsonSchema;
...
pub trait PostgresqlTypeNotPrimaryKey {
    type PostgresqlType: crate::PostgresqlType;
    type Create: CreateAlias + for<'__> sqlx::Encode<'__, sqlx::Postgres>  + sqlx::Type<sqlx::Postgres>;
}
...
pub trait PostgresqlJsonTypeElementId {
    ...
    type Update: UpdateAlias + for<'__> utoipa::ToSchema<'__> + schemars::JsonSchema + error_occurence_lib::ToStdStringString;
...
pub trait PostgresqlJsonTypeTestCases {
    type PostgresqlJsonType: crate::PostgresqlJsonType;
    type Select: SelectAlias + for<'__> utoipa::ToSchema<'__> + schemars::JsonSchema + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize;
