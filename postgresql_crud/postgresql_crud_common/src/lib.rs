...
trait_alias!(DebugClonePartialEq = std::fmt::Debug + Clone + PartialEq);
trait_alias!(DebugClonePartialEqSerialize = DebugClonePartialEq + serde::Serialize);
trait_alias!(DebugClonePartialEqSerializeDeserialize = DebugClonePartialEqSerialize + for<'__> serde::Deserialize<'__>);
trait_alias!(DebugClonePartialEqSerializeDeserializeDefaultSomeOne = DebugClonePartialEqSerializeDeserialize + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement);
trait_alias!(SqlxEncodePostgresSqlxTypePostgres = for<'__> sqlx::Encode<'__, sqlx::Postgres> + sqlx::Type<sqlx::Postgres>);
trait_alias!(UtoipaToSchemaAndSchemarsJsonSchema = for<'__> utoipa::ToSchema<'__> + schemars::JsonSchema);

trait_alias!(TableTypeDeclarationAlias = DebugClonePartialEqSerializeDeserializeDefaultSomeOne);
trait_alias!(CreateAlias = DebugClonePartialEqSerializeDeserializeDefaultSomeOne);
trait_alias!(CreateForQueryAlias = DebugClonePartialEqSerialize + SqlxEncodePostgresSqlxTypePostgres);
trait_alias!(SelectAlias = DebugClonePartialEqSerializeDeserializeDefaultSomeOne);
trait_alias!(WhereElementAlias = DebugClonePartialEqSerializeDeserialize + for<'__> crate::PostgresqlTypeWhereFilter<'__>);
trait_alias!(ReadAlias = DebugClonePartialEqSerializeDeserialize);
trait_alias!(ReadOnlyIdsAlias = DebugClonePartialEqSerializeDeserialize);
trait_alias!(ReadInnerAlias = DebugClonePartialEq);
trait_alias!(UpdateAlias = DebugClonePartialEqSerializeDeserializeDefaultSomeOne);
trait_alias!(UpdateForQuery = DebugClonePartialEqSerialize);
...
pub trait PostgresqlType {
    ...
    type UpdateForQuery: UpdateForQuery;
...
pub trait PostgresqlJsonType {
    type TableTypeDeclaration: TableTypeDeclarationAlias + UtoipaToSchemaAndSchemarsJsonSchema;
    type Create: CreateAlias + UtoipaToSchemaAndSchemarsJsonSchema;
    type CreateForQuery: CreateForQueryAlias + std::convert::From<Self::Create>;
    type Select: SelectAlias + UtoipaToSchemaAndSchemarsJsonSchema;
    //todo change trait fn select_query_part( to Result String CheckedAdd
    ...
    type Read: ReadAlias + UtoipaToSchemaAndSchemarsJsonSchema + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement;
    type ReadOnlyIds: ReadOnlyIdsAlias;
    fn select_only_ids_query_part(column_name_and_maybe_field_getter: &std::primitive::str) -> std::string::String;
    type ReadInner: ReadInnerAlias;
    fn into_inner(value: Self::Read) -> Self::ReadInner;
    type Update: UpdateAlias + UtoipaToSchemaAndSchemarsJsonSchema;
    type UpdateForQuery: UpdateForQuery + std::convert::From<Self::Update>;
    fn update_query_part(value: &Self::UpdateForQuery, jsonb_set_accumulator: &std::primitive::str, jsonb_set_target: &std::primitive::str, jsonb_set_path: &std::primitive::str, increment: &mut std::primitive::u64) -> Result<std::string::String, crate::QueryPartErrorNamed>;
    fn update_query_bind(value: Self::UpdateForQuery, query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> Result<
        sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>,
        std::string::String
...
pub trait PostgresqlTypeNotPrimaryKey {
    type PostgresqlType: crate::PostgresqlType;
    type Create: CreateAlias + SqlxEncodePostgresSqlxTypePostgres;
}
...
pub trait PostgresqlJsonTypeElementId {
    ...
    type Update: UpdateAlias + UtoipaToSchemaAndSchemarsJsonSchema + error_occurence_lib::ToStdStringString;
...
pub trait PostgresqlJsonTypeTestCases {
    type PostgresqlJsonType: crate::PostgresqlJsonType;
    type Select: SelectAlias + UtoipaToSchemaAndSchemarsJsonSchema + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElementWithMaxPageSize;
