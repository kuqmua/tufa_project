pub trait TypeDeclarationAlias: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement {}
...
pub trait PostgresqlType {
    ...
    type TableTypeDeclaration: TypeDeclarationAlias;
...
pub trait PostgresqlJsonType {
    type TableTypeDeclaration: TypeDeclarationAlias + for<'__> utoipa::ToSchema<'__> + schemars::JsonSchema;
...
pub trait PostgresqlTypePrimaryKey {
    ...
    type TableTypeDeclaration: TypeDeclarationAlias + PartialOrd;
    fn into_read(
