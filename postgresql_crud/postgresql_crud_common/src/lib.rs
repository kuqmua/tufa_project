...
impl RustSqlxMapToPostgresTypeVariant {
    ...
    fn get_from_or_try_from(&self) -> std::string::String {
        match self {
            ...
            Self::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestamp => std::string::String::from(""),
            Self::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestampNotNull => std::string::String::from(""),
