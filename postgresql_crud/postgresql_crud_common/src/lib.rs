...
impl<T: WhereElementAlias + AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement> WhereElementAlias for NullableJsonObjectPostgresqlTypeWhereFilter<T> {}
