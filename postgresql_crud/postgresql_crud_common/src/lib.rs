...
impl<T: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement> TableTypeDeclarationAlias for T {}
...
impl<T: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement> CreateAlias for T {}
...
impl<T: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> sqlx::Encode<'__, sqlx::Postgres> + sqlx::Type<sqlx::Postgres>> CreateForQueryAlias for T {}
...
impl<T: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement> SelectAlias for T {}
pub trait WhereElementAlias: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + for<'__> crate::PostgresqlTypeWhereFilter<'__> {}
impl<T: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> + for<'__> crate::PostgresqlTypeWhereFilter<'__>> WhereElementAlias for T {}
pub trait ReadAlias: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__> {}
impl<T: std::fmt::Debug + Clone + PartialEq + serde::Serialize + for<'__> serde::Deserialize<'__>> ReadAlias for T {}
