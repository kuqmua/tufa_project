...
impl SupportedSqlxPostgresType {
    pub fn get_with_serialize_deserialize_error_named_stringified(&self) -> std::string::String {
        match self {
            ...
            Self::SqlxTypesTimeOffsetDateTime => std::string::String::from("time::error::ComponentRange"),
            Self::SqlxTypesTimeDate => std::string::String::from("time::error::ComponentRange"),
            Self::SqlxTypesTimeTime => std::string::String::from("time::error::ComponentRange"),
            Self::SqlxTypesUuidUuid => std::string::String::from("sqlx::types::uuid::Error"),
...
pub trait BindQuery {
    fn try_increment(&self, increment: &mut u64) -> Result<(), std::string::String>;//TryGenerateBindIncrementsErrorNamed
    fn try_generate_bind_increments(
        &self,
        increment: &mut u64,
    ) -> Result<std::string::String, std::string::String>;//TryGenerateBindIncrementsErrorNamed
