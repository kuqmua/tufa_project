...
#[derive(
    ...
    serde::Deserialize,
    // postgresql_crud_types_macro_logic_reuse::PostgresqlTypeTokens,
    postgresql_crud_types_macro_logic_reuse::AutoGeneratedPostgresqlTypeTokens,
...
/////////////////////////////
// impl sqlx::Decode<'_, sqlx::Postgres> for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToCreate {
...
//     }
// }
impl sqlx::Type<sqlx::Postgres> for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToCreate {
...
impl crate::BindQuerySecond<'_> for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToRead {
...
impl crate::generate_postgresql_json_type::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToRead {
...
impl std::fmt::Display for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToUpdate {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(formatter, "{:?}", self.0)
    }
}
impl error_occurence_lib::ToStdStringString for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToUpdate {
    fn to_std_string_string(&self) -> std::string::String {
        format!("{self}")
    }
}
impl sqlx::Encode<'_, sqlx::Postgres> for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToUpdate {
    fn encode_by_ref(&self, buf: &mut sqlx::postgres::PgArgumentBuffer) -> sqlx::encode::IsNull {
        sqlx::Encode::<sqlx::Postgres>::encode_by_ref(&self.0, buf)
    }
}
impl sqlx::Decode<'_, sqlx::Postgres> for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToUpdate {
    fn decode(value: sqlx::postgres::PgValueRef<'_>) -> Result<Self, sqlx::error::BoxDynError> {
        match <crate::postgresql_type::postgresql_base_type::StdPrimitiveI16 as sqlx::Decode<sqlx::Postgres>>::decode(value) {
            Ok(value) => Ok(Self(value)),
            Err(error) => Err(error),
...
impl sqlx::Type<sqlx::Postgres> for PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToUpdate {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <crate::postgresql_type::postgresql_base_type::StdPrimitiveI16 as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> bool {
...
pub struct StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete(crate::postgresql_type::postgresql_base_type::StdPrimitiveI16);
impl crate::BindQuerySecond<'_> for StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete {
    fn try_generate_bind_increments(&self, increment: &mut std::primitive::u64) -> Result<std::string::String, crate::TryGenerateBindIncrementsErrorNamed> {
        crate::BindQuerySecond::try_generate_bind_increments(&self.0, increment)
    }
    fn bind_value_to_query(self, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments> {
...
impl std::fmt::Display for StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(formatter, "{:?}", self.0)
    }
}
impl error_occurence_lib::ToStdStringString for StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete {
    fn to_std_string_string(&self) -> std::string::String {
        format!("{self}")
    }
}
impl sqlx::Decode<'_, sqlx::Postgres> for StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete {
    fn decode(value: sqlx::postgres::PgValueRef<'_>) -> Result<Self, sqlx::error::BoxDynError> {
        match <crate::postgresql_type::postgresql_base_type::StdPrimitiveI16 as sqlx::Decode<sqlx::Postgres>>::decode(value) {
            Ok(value) => Ok(Self(value)),
            Err(error) => Err(error),
...
impl sqlx::Type<sqlx::Postgres> for StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete {
    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
        <crate::postgresql_type::postgresql_base_type::StdPrimitiveI16 as sqlx::Type<sqlx::Postgres>>::type_info()
    }
    fn compatible(ty: &<sqlx::Postgres as sqlx::Database>::TypeInfo) -> bool {
...
impl crate::generate_postgresql_json_type::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement for StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete {
    fn std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> Self {
        Self(crate::generate_postgresql_json_type::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement::std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element())
    }
}
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypePrimaryKey<'_> for StdPrimitiveI16AsPostgresqlSmallSerialNotNull {
    type PostgresqlTypeSelfToCreate = PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToCreate;
    type PostgresqlTypeSelfToRead = PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToRead;
    type PostgresqlTypeSelfToUpdate = PostgresqlTypeStdPrimitiveI16AsPostgresqlSmallSerialNotNullToUpdate;
    type PostgresqlTypeSelfToDelete = StdPrimitiveI16AsPostgresqlSmallSerialNotNullToDelete;
}
