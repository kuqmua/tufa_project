...
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdPrimitiveI16AsPostgresqlInt2NotNullWhereElementEqual {
    fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
        match increment.checked_add(1) {
            Some(value) => {
                *increment = value;
...
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdPrimitiveI16AsPostgresqlInt2NotNullWhereElementGreaterThan {
    fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
        match increment.checked_add(1) {
            Some(value) => {
                *increment = value;
...
//     }
// }
// impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdPrimitiveI16AsPostgresqlInt2NotNullWhereElementBetween {
//     fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
//         match increment.checked_add(1) {
//             Some(first_value) => {
...
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdPrimitiveI16AsPostgresqlInt2NotNullWhereElementIn {
    fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
        let mut acc = std::string::String::default();
        for element in &self.value {
            match increment.checked_add(1) {
...
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdPrimitiveI16AsPostgresqlInt2NotNullWhereElement {
    fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
        match &self {
            Self::Equal(value) => crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::where_query_part(value, increment, column, is_need_to_add_logical_operator),
...
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdOptionOptionStdPrimitiveI16AsPostgresqlInt2NotNullWhereElementEqual {
    fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
...
impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter<'_> for StdPrimitiveI16AsPostgresqlInt2NullableWhereElement {
    fn where_query_part(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, crate::QueryPartErrorNamed> {
        match &self {
            Self::Equal(value) => crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::where_query_part(value, increment, column, is_need_to_add_logical_operator),
            Self::GreaterThan(value) => crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::where_query_part(value, increment, column, is_need_to_add_logical_operator),
