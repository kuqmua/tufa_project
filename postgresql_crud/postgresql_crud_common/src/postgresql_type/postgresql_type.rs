...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementBetween {
        fn deserialize<__D>(
            __deserializer: __D,
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __Visitor<'de> {
                marker: _serde::__private::PhantomData<
                    PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementBetween,
                >,
                lifetime: _serde::__private::PhantomData<&'de ()>,
            }
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementBetween;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private::Formatter<'_>,
                ) -> _serde::__private::fmt::Result {
                    _serde::__private::Formatter::write_str(
                        __formatter,
                        "struct PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementBetween",
                    )
                }
                #[inline]
                fn visit_seq<__A>(
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                        ...
                        _serde::__private::None => {
                            return _serde::__private::Err(
                                _serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementBetween with 3 elements",
                                ),
                            );
                        }
                    };
                    ...
                    match PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementBetween::try_new(__field0, __field1, __field2) {
...
#[derive(Debug, Clone, PartialEq, serde :: Serialize)]
pub struct PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementIn{
    logical_operator: crate::LogicalOperator,
    value: std::vec::Vec<crate::postgresql_type::postgresql_base_type::StdPrimitiveI32>
}
#[derive(Debug, Clone, serde :: Serialize, serde :: Deserialize, thiserror::Error, error_occurence_lib::ErrorOccurence)]
...
impl PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementIn {
    fn try_new(
        logical_operator: crate::LogicalOperator,
        value: std::vec::Vec<crate::postgresql_type::postgresql_base_type::StdPrimitiveI32>
    ) -> Result<Self, PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementInTryNewErrorNamed> {
        if value.is_empty() {
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'de> _serde::Deserialize<'de> for PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementIn {
        fn deserialize<__D>(
            __deserializer: __D,
        ) -> _serde::__private::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                fn expecting(
                    ...
                    _serde::__private::Formatter::write_str(
                        __formatter,
                        "struct PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementIn",
                    )
                }
                #[inline]
                fn visit_seq<__A>(
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    >(&mut __seq)? {
                        ...
                        _serde::__private::None => {
                            return _serde::__private::Err(
                                _serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementIn with 2 elements",
                                ),
                            );
                        }
                    };
                    ...
                    match PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElementIn::try_new(__field0, __field1) {
                        Ok(value) => _serde::__private::Ok(value),
                        Err(error) => Err(_serde::de::Error::custom(format!("{error:?}")))
                    }
                }
...
//     pub logical_operator: crate::LogicalOperator,
//     pub value: PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElement,
// }
// impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereElementTraits<'_> for PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElement {}
// impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter for PostgresqlTypeStdPrimitiveI32AsPostgresqlSerialNotNullWhereElement {
//     fn postgresql_type_self_where_try_generate_bind_increments(
...
//                     format!("{}{} ", &self.logical_operator, &self.equal)
//                 }
//                 else {
//                     std::string::String::default()
//                 };
//                 Ok(format!("{maybe_logical_operator}({value})"))
//             },
...
//                     serde::__private::None => {
//                         serde::__private::de::missing_field("logical_operator")?
//                     }
//                 };
//                 let __field2 = match __field2 {
