...
pub trait PostgresqlType<'a> {
    ...
    fn update_bind_query_part(self_to_update: Self::Update, query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>;
