...
pub struct StdPrimitiveBoolAsPostgresqlBoolNotNullToDelete(StdPrimitiveBool);
...
pub struct StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete(StdPrimitiveI64);
