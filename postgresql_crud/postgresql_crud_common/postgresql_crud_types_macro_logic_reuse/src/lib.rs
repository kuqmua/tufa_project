...
//////////////////////////////////////////
            ...
            let postgresql_type_not_null_or_nullable_to_create_token_stream = {
                ...
                match &postgresql_type_initialized_by_tokens {
                    PostgresqlTypeInitializedByTokens::InitializedUsingDefaultKeywordByPostgresql => generate_initialized_by_postgresql_token_stream(&quote::quote!{"DEFAULT"}),
                    PostgresqlTypeInitializedByTokens::InitializedUsingUuidGenerateV4FunctionByPostgresql => generate_initialized_by_postgresql_token_stream(&quote::quote!{"uuid_generate_v4()"}),
                    PostgresqlTypeInitializedByTokens::InitializedByClient => macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                        &postgresql_type_not_null_or_nullable_to_create_upper_camel_case,
                        &postgresql_type_not_null_or_nullable_upper_camel_case
                    ),
                }
            ...
            let postgresql_type_not_null_or_nullable_where_element_token_stream = {
                ...
                let generate_where_element_sqlx_postgres_types_pg_range_filter_token_stream = |range_type: RangeType|{
                    let range_type_token_stream: &dyn quote::ToTokens = match &range_type {
                        ...
                        RangeType::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTz => &sqlx_types_time_offset_date_time_as_postgresql_timestamp_tz_not_null_upper_camel_case_token_stream,
                    ...
                    let range_type_should_impl_range_length = {
                        ...
                        match &range_type {
                            ...
                            RangeType::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTz => should_impl_range_length_false,
                    ...
                    let range_type_postgresql_type_self_where_bind_value_to_query_parameter_token_stream: &dyn quote::ToTokens = match &range_type {
                        ...
                        RangeType::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTz => &dot_zero_token_stream,
                ...
                let where_element_sqlx_postgres_types_pg_range_sqlx_types_time_offset_date_time_token_stream = generate_where_element_sqlx_postgres_types_pg_range_filter_token_stream(RangeType::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTz);
