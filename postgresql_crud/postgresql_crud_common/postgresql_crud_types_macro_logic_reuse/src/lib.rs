...
pub fn generate_postgresql_types(_input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_postgresql_type_token_stream = |postgresql_type: PostgresqlType| {
        ...
        let generate_postgresql_type_not_null_or_nullable = |postgresql_type_not_null_or_nullable: &PostgresqlTypeNotNullOrNullable| -> proc_macro2::TokenStream {
            ...
            // }
            let sqlx_types_ipnetwork_ip_network_v4_token_stream = quote::quote! {
                ...
                PostgresqlTypeNotNullOrNullable::NotNull => {
                    postgresql_crud_macros_common::generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(&postgresql_type_not_null_or_nullable_upper_camel_case, &{
                        ...
                        let initialization_token_stream: &dyn quote::ToTokens = match &postgresql_type {
                            ...
                            PostgresqlType::SqlxTypesIpnetworkIpNetworkAsPostgresqlInet | PostgresqlType::SqlxTypesIpnetworkIpNetworkAsPostgresqlCidr => &sqlx_types_ipnetwork_ip_network_v4_token_stream,
                            ...
                            PostgresqlType::SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4Range | PostgresqlType::SqlxPostgresTypesPgRangeStdPrimitiveI64AsPostgresqlInt8Range | PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateTimeAsPostgresqlTimestampRange => {
                            ...
                            PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestampTzRange | PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTimestampTzRange => {
                                &sqlx_postgres_types_pg_range_core_default_default_default_token_stream
                            }
                            ...
                            PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesDecimalAsPostgresqlNumRange | PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesBigDecimalAsPostgresqlNumRange => &sqlx_postgres_types_pg_range_core_default_default_default_token_stream,
                        };
            ...
            let impl_crate_bind_query_for_postgresql_type_not_null_or_nullable_token_stream = {
                ...
                match &postgresql_type_not_null_or_nullable {
                    PostgresqlTypeNotNullOrNullable::NotNull => generate_impl_crate_bind_query_for_tokens_token_stream(
                        ...
                        &try_generate_bind_increments_token_stream,
                        &quote::quote! {
                            #query_snake_case = #query_snake_case.bind(#self_dot_zero_token_stream);
                            #query_snake_case
                        },
                    ),
            ...
            let postgresql_type_not_null_or_nullable_where_element_token_stream = {
                let where_operator_type_field_type_default = WhereOperatorType::FieldType {
                    ...
                    default_initialization_token_stream: &core_default_default_default_token_stream,
                };
                ...
                let postgresql_type_self_to_update_query_part_token_stream = {
                    ...
                    quote::quote! {
                        fn #postgresql_type_self_to_update_query_part_snake_case(
                            ...
                            #crate_bind_query_token_stream #try_generate_bind_increments_snake_case(#postgresql_type_self_to_update_snake_case, #increment_snake_case)
                        }
                    }
                };
                let postgresql_type_self_to_update_bind_query_part_token_stream = {
                    ...
                    quote::quote! {
                        fn #postgresql_type_self_to_update_bind_query_part<'a>(
                            ...
                            #crate_bind_query_token_stream #bind_value_to_query_snake_case(#postgresql_type_self_to_update_snake_case, #query_snake_case)
                        }
                    }
                };
    ...
    let h24 = generate_postgresql_type_token_stream(PostgresqlType::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestampTz);
    let h25 = generate_postgresql_type_token_stream(PostgresqlType::SqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTimestampTz);

    let h26 = generate_postgresql_type_token_stream(PostgresqlType::SqlxTypesUuidUuidAsPostgresqlUuidV4InitializedByPostgresql);
    let h27 = generate_postgresql_type_token_stream(PostgresqlType::SqlxTypesUuidUuidAsPostgresqlUuidInitializedByClient);
    let h28 = generate_postgresql_type_token_stream(PostgresqlType::SqlxTypesIpnetworkIpNetworkAsPostgresqlInet);
    let h29 = generate_postgresql_type_token_stream(PostgresqlType::SqlxTypesIpnetworkIpNetworkAsPostgresqlCidr);
    ...
    let h35 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesDecimalAsPostgresqlNumRange);
    let h36 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesBigDecimalAsPostgresqlNumRange);
    let h37 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimeDateAsPostgresqlDateRange);
    let h38 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateAsPostgresqlDateRange);
    let h39 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateTimeAsPostgresqlTimestampRange);
    let h40 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTimeAsPostgresqlTimestampRange);
    let h41 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestampTzRange);
    let h42 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTimestampTzRange);
