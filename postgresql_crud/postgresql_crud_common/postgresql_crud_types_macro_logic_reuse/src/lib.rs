        ...
        generate_postgresql_type_tokens_where_element_variant_token_stream(
            ...
            ShouldWhereElementFieldsBePublic::False {
                ...
                try_new_content_token_stream: &{
                    ...
                    quote::quote!{
                        if #start_snake_case #where_operator_type_additional_bind_token_stream #try_new_error_named_compare_symbol_token_stream #end_snake_case #where_operator_type_additional_bind_token_stream {
                            Ok(Self {
                                logical_operator,
                                #start_snake_case,
                                #end_snake_case
                            ...
                            Err(#postgresql_type_ident_where_element_between_try_new_error_named_upper_camel_case::#try_new_error_named_upper_camel_case_token_stream {
                                #start_snake_case: #start_snake_case #where_operator_type_additional_bind_token_stream ,
                                #end_snake_case: #end_snake_case #where_operator_type_additional_bind_token_stream,
                                code_occurence: error_occurence_lib::code_occurence!(),
                            })
                        }
                    }
...
pub fn postgresql_base_type_tokens_where_element_sqlx_postgres_types_pg_interval(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_postgresql_type_tokens_where_element_token_stream = |is_nullable: IsNullable|{
        ...
        // Between::generate_postgresql_type_tokens_where_element_variant_handle_token_stream(
        //     &ident,
        //     &is_nullable,
        //     &WhereOperatorType::Ident(&ident),
        // );
