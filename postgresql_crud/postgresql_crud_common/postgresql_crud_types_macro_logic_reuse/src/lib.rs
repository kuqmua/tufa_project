...
impl Equal {
    fn generate_postgresql_type_tokens_where_element_variant_handle_token_stream(
        ...
        let try_generate_bind_increments_error_named_upper_camel_case = naming::TryGenerateBindIncrementsErrorNamedUpperCamelCase;
        let checked_add_upper_camel_case = naming::CheckedAddUpperCamelCase;
        let maybe_pub_token_stream = is_value_type_pub.maybe_pub_token_stream();
        generate_postgresql_type_tokens_where_element_variant_token_stream(
            &ident,
            Self::upper_camel_case(),
            &is_nullable,
            ShouldWhereElementFieldsBePublic::True,
            &quote::quote!{#maybe_pub_token_stream #value_snake_case: #value_type_token_stream},
            ...
            &quote::quote!{
                #query_snake_case = #query_snake_case.bind(self.#value_snake_case #bind_additional_token_stream);
                #query_snake_case
            }
        )
    }
    ...
    let generate_postgresql_type_tokens_where_element_token_stream = |is_nullable: IsNullable|{
        ...
        let postgresql_type_tokens_where_element_between_token_stream = {
            ...
            generate_postgresql_type_tokens_where_element_variant_token_stream(
                ...
                &quote::quote!{
                    #start_snake_case: sqlx::types::time::PrimitiveDateTime::new(
                        sqlx::types::time::Date::from_ordinal_date(
                            ::core::default::Default::default(),
                            1,
                        ).unwrap(),//todo
                    ...
                    #end_snake_case: sqlx::types::time::PrimitiveDateTime::new(
                        sqlx::types::time::Date::from_ordinal_date(
                            ::core::default::Default::default(),
                            1,
                        ).unwrap(),//todo
            ...
            generate_postgresql_type_tokens_where_element_variant_token_stream(
                ...
                ShouldWhereElementFieldsBePublic::False {
                    ...
                    try_new_content_token_stream: &{
                        let postgresql_type_ident_where_element_between_try_new_error_named_upper_camel_case = naming::parameter::PostgresqlTypeSelfWhereElementBetweenTryNewErrorNamedUpperCamelCase::from_tokens(&ident);
                        quote::quote!{
                            if #start_snake_case.0.0 < #end_snake_case.0.0 {
                                Ok(Self {
                                    logical_operator,
                                    #start_snake_case,
                                    #end_snake_case
            ...
            generate_postgresql_type_tokens_where_element_variant_token_stream(
                ...
                ShouldWhereElementFieldsBePublic::False {
                    ...
                    try_new_error_named_variants_token_stream: &quote::quote!{
                        ...
                        #not_unique_upper_camel_case {
                            #[eo_to_std_string_string_serialize_deserialize]
                            #value_snake_case: #ident,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                        },
                    },
                    try_new_additional_input_parameters_token_stream: &quote::quote!{
                        #value_snake_case: std::vec::Vec<#ident>
                    },
                    try_new_content_token_stream: &{
                        let postgresql_type_ident_where_element_in_try_new_error_named_upper_camel_case = naming::parameter::PostgresqlTypeSelfWhereElementInTryNewErrorNamedUpperCamelCase::from_tokens(&ident);
                        quote::quote!{
                ...
                &quote::quote!{
                    value: std::vec::Vec<#ident>
                },
                &quote::quote!{
                    value: vec![#crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream]
                },
                &quote::quote!{
                    let mut #acc_snake_case = std::string::String::default();
                    for #element_snake_case in &self.#value_snake_case {
                ...
                &quote::quote!{
                    for #element_snake_case in self.#value_snake_case {
                        #query_snake_case = #query_snake_case.bind(#element_snake_case.0);
                    }
                    #query_snake_case
                }
            )
...
pub fn postgresql_base_type_tokens_where_element_std_net_ip_addr(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_postgresql_type_tokens_where_element_token_stream = |is_nullable: IsNullable|{
        ...
        let postgresql_type_tokens_where_element_equal_token_stream = generate_postgresql_type_tokens_where_element_variant_token_stream(
            ...
            ShouldWhereElementFieldsBePublic::True,
            &quote::quote!{pub value: #field_type},
            &quote::quote!{#value_snake_case: std::net::IpAddr::V4(std::net::Ipv4Addr::UNSPECIFIED)},
            &quote::quote!{
                match #increment_snake_case.checked_add(1) {
                    Some(#value_snake_case) => {
                        *#increment_snake_case = #value_snake_case;
...
//             ShouldWhereElementFieldsBePublic::True,
//             &quote::quote!{pub value: #field_type},
//             &quote::quote!{#value_snake_case: sqlx::types::ipnetwork::IpNetwork::V4(sqlx::types::ipnetwork::Ipv4Network::new(core::net::Ipv4Addr::UNSPECIFIED, ::core::default::Default::default()).unwrap())},
//             &quote::quote!{
//                 match #increment_snake_case.checked_add(1) {
//                     Some(#value_snake_case) => {
//                         *#increment_snake_case = #value_snake_case;
