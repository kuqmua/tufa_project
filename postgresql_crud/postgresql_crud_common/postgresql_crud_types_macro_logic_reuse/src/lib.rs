    ...
    let generate_postgresql_type_token_stream = |postgresql_type: PostgresqlType|{
        ...
        let ident_token_stream = {
            ...
            quote::quote!{
                ...
                pub struct #postgresql_type(#field_type);
            }
        };
        ...
        let postgresql_base_type_tokens = {
            ...
            let pub_struct_std_option_option_ident_token_stream = generate_pub_struct_tokens_token_stream(
                Visibility::Pub,
                &std_option_option_ident_upper_camel_case,
            ...
            let impl_postgresql_crud_type_self_type_for_ident_token_stream = {
                let postgresql_type_self_traits_upper_camel_case = naming::PostgresqlTypeSelfTraitsUpperCamelCase;
                quote::quote!{
                    impl crate::postgresql_type::postgresql_type_trait:: #postgresql_type_self_traits_upper_camel_case<'_> for #postgresql_type{}
                }
            };
            let impl_postgresql_crud_type_self_type_for_std_option_option_ident_token_stream = {
                let postgresql_type_self_traits_upper_camel_case = naming::PostgresqlTypeSelfTraitsUpperCamelCase;
                quote::quote!{
                    impl crate::postgresql_type::postgresql_type_trait:: #postgresql_type_self_traits_upper_camel_case<'_> for #std_option_option_ident_upper_camel_case {}
                }
            };
            ...
            // };
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_to_read_traits_for_postgresql_type_token_stream = quote::quote! {
                impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfToReadTraits<'_> for #postgresql_type {}
            };
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_to_read_traits_for_std_option_option_ident_token_stream = quote::quote! {
                impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfToReadTraits<'_> for #std_option_option_ident_upper_camel_case {}
            };
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_to_update_traits_for_postgresql_type_token_stream = quote::quote! {
                impl crate::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfToUpdateTraits<'_> for #postgresql_type {}
            };
        ...
        let maybe_primary_key_tokens_token_stream = {
            let primary_key_token_stream = {
                ...
                let impl_crate_postgresql_type_postgresql_base_type_trait_postgresql_base_type_primary_key_for_ident_token_stream = {
                    ...
                    let postgresql_base_type_self_upper_camel_case = naming::PostgresqlBaseTypeSelfUpperCamelCase;
                    quote::quote!{
                        impl crate::postgresql_type::postgresql_type_trait:: #postgresql_base_type_primary_key_upper_camel_case<'_> for #postgresql_type{
                            type #postgresql_base_type_self_upper_camel_case = Self;
                        }
                    }
                };
        ...
        let postgresql_type_initialized_by_tokens_token_stream = {
            ...
            let generate_postgresql_type_nullable_or_not_null = |postgresql_type_nullable_or_not_null: &PostgresqlTypeNullableOrNotNull| -> proc_macro2::TokenStream {
                ...
                //     };
                //     macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(&postgresql_type_ident_to_create_upper_camel_case, &alias)
                // };
                let postgresql_type_ident_to_create_token_stream = {
                ...
                let postgresql_type_ident_to_update_token_stream = macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
        ...
        let generate_postgresql_type_nullable_or_not_null = |postgresql_type_nullable_or_not_null: &PostgresqlTypeNullableOrNotNull| -> proc_macro2::TokenStream {
            ...
            let postgresql_type_nullable_or_not_null_upper_camel_case: &dyn naming::StdFmtDisplayPlusQuoteToTokens = match &postgresql_type_nullable_or_not_null {
            ...
            let postgresql_type_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(&postgresql_type);
            let maybe_impl_serde_serialize_for_postgresql_type_not_null_token_stream = match &postgresql_type_nullable_or_not_null {
                PostgresqlTypeNullableOrNotNull::Nullable => proc_macro2::TokenStream::new(),
                PostgresqlTypeNullableOrNotNull::NotNull => {
                    ...
                    let generate_serde_serialize_content_b5af560e_5f3f_4f23_9286_c72dd986a1b4 = |value_token_stream: &dyn quote::ToTokens|{
                        quote::quote!{_serde::Serializer::serialize_newtype_struct(__serializer, #postgresql_type_double_quotes_token_stream, &self.0 #value_token_stream)}
                    };
                    let generate_serde_state_initialization_token_stream = |parameter_number: ParameterNumber|{
                        let parameter_number_token_stream = match parameter_number {
                            ParameterNumber::One => quote::quote!{+ 1 + 1},
                        ...
                        quote::quote!{
                            let mut __serde_state = _serde::Serializer::serialize_struct(__serializer, #postgresql_type_double_quotes_token_stream, false as usize #parameter_number_token_stream)?;
                        }
                    };
                    let serde_state_initialization_two_fields_token_stream = generate_serde_state_initialization_token_stream(ParameterNumber::Two);
                    let serde_state_initialization_three_fields_token_stream = generate_serde_state_initialization_token_stream(ParameterNumber::Three);
                    ...
                    let impl_serde_serialize_for_sqlx_types_bit_vec_token_stream = generate_impl_serde_serialize_for_postgresql_type_not_null_tokens(&quote::quote!{
                        _serde::Serializer::serialize_newtype_struct(
                            __serializer,
                            #postgresql_type_double_quotes_token_stream,
                            &self.0.iter().collect::<std::vec::Vec<std::primitive::bool>>(),
                        )
                    });
                    match &postgresql_type {
            ...
            let maybe_impl_serde_deserialize_for_postgresql_type_not_null_token_stream = match &postgresql_type_nullable_or_not_null {
                PostgresqlTypeNullableOrNotNull::Nullable => proc_macro2::TokenStream::new(),
                PostgresqlTypeNullableOrNotNull::NotNull => {
                    let struct_ident_double_quotes_token_stream = generate_struct_postgresql_type_where_element_tokens_double_quotes_token_stream(&postgresql_type);
                    //// let struct_ident_with_one_element_double_quotes_token_stream = generate_struct_postgresql_type_ident_where_element_tokens_with_number_elements_double_quotes_token_stream(
            ...
            let impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_nullable_or_not_null_token_stream = match &postgresql_type_nullable_or_not_null {
                PostgresqlTypeNullableOrNotNull::Nullable => generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                    &postgresql_type_nullable_or_not_null_upper_camel_case,
                    &{
                        //todo reuse
                        let crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_token_stream = {
                ...
                PostgresqlTypeNullableOrNotNull::NotNull => generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                    &postgresql_type_nullable_or_not_null_upper_camel_case,
                    &{
                        let sqlx_postgres_types_pg_range_core_default_default_default_token_stream = generate_sqlx_postgres_types_pg_range_token_steram(//todo fix naming
                            &core_default_default_default_token_stream,
            ...
            let is_primary_key = match &postgresql_type {
                ...
                PostgresqlType::StdPrimitiveI32AsPostgresqlInt4 => IsPrimaryKey::False,
                PostgresqlType::StdPrimitiveI64AsPostgresqlInt8 => IsPrimaryKey::False,
                PostgresqlType::StdPrimitiveF32AsPostgresqlFloat4 => IsPrimaryKey::False,
                PostgresqlType::StdPrimitiveF64AsPostgresqlFloat8 => IsPrimaryKey::False,
                PostgresqlType::StdPrimitiveI16AsPostgresqlSmallSerialInitializedByPostgresql => IsPrimaryKey::True,
                PostgresqlType::StdPrimitiveI32AsPostgresqlSerialInitializedByPostgresql => IsPrimaryKey::True,
                PostgresqlType::StdPrimitiveI64AsPostgresqlBigSerialInitializedByPostgresql => IsPrimaryKey::True,
                PostgresqlType::SqlxPostgresTypesPgMoneyAsPostgresqlMoney => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesDecimalAsPostgresqlNumeric => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesBigDecimalAsPostgresqlNumeric => IsPrimaryKey::False,
                PostgresqlType::StdPrimitiveBoolAsPostgresqlBool => IsPrimaryKey::False,
                PostgresqlType::StdStringStringAsPostgresqlCharN => IsPrimaryKey::False,
                PostgresqlType::StdStringStringAsPostgresqlVarchar => IsPrimaryKey::False,
                PostgresqlType::StdStringStringAsPostgresqlText => IsPrimaryKey::False,
                PostgresqlType::StdVecVecStdPrimitiveU8AsPostgresqlBytea => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesTimeDateAsPostgresqlDate => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesChronoNaiveDateAsPostgresqlDate => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesChronoNaiveTimeAsPostgresqlTime => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesTimeTimeAsPostgresqlTime => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgIntervalAsPostgresqlInterval => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeStdPrimitiveI32AsPostgresqlInt4Range => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeStdPrimitiveI64AsPostgresqlInt8Range => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateTimeAsPostgresqlTsRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTimeAsPostgresqlTsRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTsTzRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTsTzRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateAsPostgresqlDateRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimeDateAsPostgresqlDateRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesDecimalAsPostgresqlNumRange => IsPrimaryKey::False,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesBigDecimalAsPostgresqlNumRange => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesChronoNaiveDateTimeAsPostgresqlTimestamp => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesTimePrimitiveDateTimeAsPostgresqlTimestamp => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTz => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTimestampTz => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTimestampTz => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesUuidUuidAsPostgresqlUuidV4InitializedByPostgresql => IsPrimaryKey::True,
                PostgresqlType::SqlxTypesUuidUuidAsPostgresqlUuidInitializedByClient => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesIpnetworkIpNetworkAsPostgresqlInet => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesIpnetworkIpNetworkAsPostgresqlCidr => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesMacAddressMacAddressAsPostgresqlMacAddr => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesBitVecAsPostgresqlBit => IsPrimaryKey::False,
                PostgresqlType::SqlxTypesBitVecAsPostgresqlVarbit => IsPrimaryKey::False,
            };
            let impl_crate_create_table_column_query_part_for_postgresql_type_nullable_or_not_null_token_stream = {
                let postgresql_query_type = match &postgresql_type {
                    PostgresqlType::StdPrimitiveI16AsPostgresqlInt2 => "int2",
                    PostgresqlType::StdPrimitiveI32AsPostgresqlInt4 => "int4",
                    PostgresqlType::StdPrimitiveI64AsPostgresqlInt8 => "int8",
                ...
                let content_token_stream = match (&postgresql_type_nullable_or_not_null, &is_primary_key) {
                    (PostgresqlTypeNullableOrNotNull::Nullable, IsPrimaryKey::True) => {
                    ...
                    (PostgresqlTypeNullableOrNotNull::Nullable, IsPrimaryKey::False) => {
                        let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&column_postgresql_query_type);
                        quote::quote!{
                            format!(#format_handle_token_stream)
                        }
                    },
                    (PostgresqlTypeNullableOrNotNull::NotNull, IsPrimaryKey::True) => {
                    ...
                    (PostgresqlTypeNullableOrNotNull::NotNull, IsPrimaryKey::False) => {
                ...
                quote::quote!{
                    impl crate::CreateTableColumnQueryPart for #postgresql_type_nullable_or_not_null_upper_camel_case {
                        fn create_table_column_query_part(column: &dyn std::fmt::Display, is_primary_key: std::primitive::bool) -> impl std::fmt::Display {
                            #content_token_stream
                        }
                    }
            ...
            let maybe_primary_key_tokens_token_stream = if let (PostgresqlTypeNullableOrNotNull::NotNull, IsPrimaryKey::True) = (&postgresql_type_nullable_or_not_null, &is_primary_key) {
            ...
            let self_dot_zero_token_stream = quote::quote!{#self_snake_case.0};
            let postgresql_type_nullable_or_not_null_struct_content_token_stream = quote::quote!{(#postgresql_type_nullable_or_not_null_upper_camel_case);};
            let empty_struct_content_token_stream = quote::quote!{(());};
            ...
            let postgresql_type_nullable_or_not_null_to_create_token_stream = {
                let postgresql_type_nullable_or_not_null_to_create_token_stream = generate_pub_struct_tokens_token_stream(
                    ...
                    match &postgresql_type_initialized_by_tokens {
                        PostgresqlTypeInitializedByTokens::InitializedUsingDefaultKeywordByPostgresql => &empty_struct_content_token_stream,
                        PostgresqlTypeInitializedByTokens::InitializedUsingUuidGenerateV4FunctionByPostgresql => &empty_struct_content_token_stream,
                        PostgresqlTypeInitializedByTokens::InitializedByClient => &postgresql_type_nullable_or_not_null_struct_content_token_stream,
                    },
                    false,
                    true,
                );
            ...
            //         &postgresql_type_nullable_or_not_null_struct_content_token_stream,
            //         false,
            //         true,
            //     );
            ...
            let where_element_token_stream = {
                ...
                let where_operator_type_ident = WhereOperatorType::Ident(&postgresql_type);
                let generate_postgresql_type_nullable_or_not_null_where_element_token_stream = |variants: &std::vec::Vec<&dyn crate::filters::WhereOperatorName>| {
                    generate_postgresql_type_tokens_where_element_and_postgresql_type_std_option_option_tokens_where_element_handle_token_stream(
                        &variants,
                        &postgresql_type_nullable_or_not_null_where_element_upper_camel_case,
                        &naming::parameter::PostgresqlTypeSelfWhereElementUpperCamelCase::from_display(&postgresql_type),
                        &ShouldDeriveSchemarsJsonSchema::False,
                    )
                };
