...
fn generate_postgresql_type_tokens_where_element_logic_token_stream(
    postgresql_type_ident_where_element_upper_camel_case: &dyn quote::ToTokens,
    postgresql_type_tokens_where_element_declaration_content_token_steram: &dyn quote::ToTokens,
    _content_token_stream: &dyn quote::ToTokens,
) -> proc_macro2::TokenStream {
    ...
    //     &postgresql_type_tokens_where_element_declaration_content_token_steram
    // );
        ...
        &{
            let variants_token_stream = variants.iter().map(|element|{
                ...
                let postgresql_type_tokens_where_element_equal_upper_camel_case = {
                    let value = format!("{postgresql_type_ident_where_element_upper_camel_case}{}", quote::quote!{#element});
...
pub fn postgresql_base_type_tokens_where_element_number(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_postgresql_type_tokens_where_element_token_stream = |is_option: std::primitive::bool|{
        ...
        let postgresql_type_tokens_where_element_equal_token_stream = {
            ...
            let impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_where_element_equal_token_stream = generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                ...
                &{
                    ...
                    quote::quote!{Self {
                        ...
                        #value_snake_case: #value_initialization_token_stream
                    }}
                },
            );
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_tokens_where_element_equal_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                &postgresql_type_tokens_where_element_equal_upper_camel_case,
                &{
                    if is_option {
                        quote::quote! {
            ...
            quote::quote!{
                ...
                #impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_where_element_equal_token_stream
        ...
        let postgresql_type_tokens_where_element_greater_than_upper_camel_case: &dyn quote::ToTokens = if is_option {
            &postgresql_type_std_option_option_ident_where_element_greater_than_upper_camel_case
        }
        else {
            &postgresql_type_ident_where_element_greater_than_upper_camel_case
        };
        let postgresql_type_tokens_where_element_greater_than_token_stream = if is_option {
            ...
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_ident_where_element_greater_than_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                &postgresql_type_ident_where_element_greater_than_upper_camel_case,
                &quote::quote! {
                    match #increment_snake_case.checked_add(1) {
                        Some(#value_snake_case) => {
        ...
        let postgresql_type_std_option_option_ident_where_element_between_upper_camel_case = naming::parameter::PostgresqlTypeStdOptionOptionSelfWhereElementBetweenUpperCamelCase::from_tokens(&ident);
        let postgresql_type_tokens_where_element_between_upper_camel_case: &dyn quote::ToTokens = if is_option {
        ...
        let postgresql_type_tokens_where_element_between_token_stream = if is_option {
            macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                &postgresql_type_std_option_option_ident_where_element_between_upper_camel_case, 
                &postgresql_type_ident_where_element_between_upper_camel_case
            )
            ...
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_ident_where_element_between_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                &postgresql_type_ident_where_element_between_upper_camel_case,
                &quote::quote! {
                    match #increment_snake_case.checked_add(1) {
                        Some(first_value) => {
        ...
        let postgresql_type_tokens_where_element_in_upper_camel_case: &dyn quote::ToTokens = if is_option {
        ...
        let postgresql_type_tokens_where_element_in_token_stream = if is_option {
            macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                &postgresql_type_std_option_option_ident_where_element_in_upper_camel_case, 
                &postgresql_type_ident_where_element_in_upper_camel_case
            )
    ...
    let postgresql_type_ident_where_element_token_stream = generate_postgresql_type_tokens_where_element_token_stream(false);
    let postgresql_type_std_option_option_ident_where_element_token_stream = generate_postgresql_type_tokens_where_element_token_stream(true);
    let generated = quote::quote! {
        #postgresql_type_ident_where_element_token_stream
...
pub fn postgresql_base_type_tokens_where_element_std_string_string(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_postgresql_type_tokens_where_element_token_stream = |is_option: std::primitive::bool|{
        ...
        let checked_add_upper_camel_case = naming::CheckedAddUpperCamelCase;
        let try_generate_bind_increments_error_named_upper_camel_case = naming::TryGenerateBindIncrementsErrorNamedUpperCamelCase;
        let postgresql_type_tokens_where_element_case_sensitive_regular_expression_upper_camel_case: &dyn quote::ToTokens = if is_option {
            &naming::parameter::PostgresqlTypeStdOptionOptionSelfWhereElementCaseSensitiveRegularExpressionUpperCamelCase::from_tokens(&ident)
        }
        else {
        ...
        let postgresql_type_tokens_where_element_case_insensitive_regular_expression_upper_camel_case: &dyn quote::ToTokens = if is_option {
            &naming::parameter::PostgresqlTypeStdOptionOptionSelfWhereElementCaseInsensitiveRegularExpressionUpperCamelCase::from_tokens(&ident)
        }
        else {
        ...
        let postgresql_type_tokens_where_element_case_insensitive_regular_expression_token_stream = {
            ...
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_tokens_where_element_case_insensitive_regular_expression_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                &postgresql_type_tokens_where_element_case_insensitive_regular_expression_upper_camel_case,
                &{
                    if is_option {
                        quote::quote! {
            ...
            quote::quote!{
                ...
                #impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_where_element_case_insensitive_regular_expression_token_stream
...
pub fn postgresql_base_type_tokens_where_element_std_vec_vec_std_primitive_u8(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_postgresql_type_tokens_where_element_token_stream = |is_option: std::primitive::bool|{
        ...
        let checked_add_upper_camel_case = naming::CheckedAddUpperCamelCase;
        let try_generate_bind_increments_error_named_upper_camel_case = naming::TryGenerateBindIncrementsErrorNamedUpperCamelCase;
        let postgresql_type_tokens_where_element_hexadecimal_notation_equal_upper_camel_case: &dyn quote::ToTokens = if is_option {
            &naming::parameter::PostgresqlTypeStdOptionOptionSelfWhereElementHexadecimalNotationEqualUpperCamelCase::from_tokens(&ident)
        }
        else {
            &naming::parameter::PostgresqlTypeSelfWhereElementHexadecimalNotationEqualUpperCamelCase::from_tokens(&ident)
        };
        let postgresql_type_tokens_where_element_hexadecimal_notation_equal_token_stream = {
            ...
            let impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_where_element_hexadecimal_notation_equal_token_stream = generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                &postgresql_type_tokens_where_element_hexadecimal_notation_equal_upper_camel_case,
                &{
                    let value_initialization_token_stream: &dyn quote::ToTokens = if is_option {
                        &quote::quote!{Some(vec![::core::default::Default::default()])}
                    }
                    else {
            ...
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_tokens_where_element_hexadecimal_notation_equal_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                &postgresql_type_tokens_where_element_hexadecimal_notation_equal_upper_camel_case,
                &{
                    if is_option {
                        quote::quote! {
            ...
            quote::quote!{
                ...
                #impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_where_element_hexadecimal_notation_equal_token_stream
                #impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_tokens_where_element_hexadecimal_notation_equal_token_stream
            }
        };

        let postgresql_type_ident_where_element_length_upper_camel_case = naming::parameter::PostgresqlTypeSelfWhereElementLengthUpperCamelCase::from_tokens(&ident);
        let postgresql_type_std_option_option_ident_where_element_length_upper_camel_case = naming::parameter::PostgresqlTypeStdOptionOptionSelfWhereElementLengthUpperCamelCase::from_tokens(&ident);
        let postgresql_type_tokens_where_element_length_upper_camel_case: &dyn quote::ToTokens = if is_option {
            &postgresql_type_std_option_option_ident_where_element_length_upper_camel_case
        }
        else {
            &postgresql_type_ident_where_element_length_upper_camel_case
        };
        let postgresql_type_tokens_where_element_length_token_stream = if is_option {
            macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                &postgresql_type_std_option_option_ident_where_element_length_upper_camel_case, 
                &postgresql_type_ident_where_element_length_upper_camel_case
            )
            ...
            let postgresql_type_ident_where_element_length_token_stream = generate_postgresql_type_tokens_where_element_tokens_token_stream(
                &postgresql_type_ident_where_element_length_upper_camel_case,
                false,
                false,
                &quote::quote!{length: #std_primitive_i32_token_stream,}
            );
            let postgresql_type_ident_where_element_length_try_new_error_named_upper_camel_case = naming::parameter::PostgresqlTypeSelfWhereElementLengthTryNewErrorNamedUpperCamelCase::from_tokens(&ident);
            let postgresql_type_ident_where_element_length_try_new_error_named_token_stream = {
                quote::quote! {
                    #[derive(Debug, Clone, serde::Serialize, serde::Deserialize, thiserror::Error, error_occurence_lib::ErrorOccurence)]
                    pub enum #postgresql_type_ident_where_element_length_try_new_error_named_upper_camel_case {
                        LengthIsNegative {
                            #[eo_to_std_string_string_serialize_deserialize]
                            length: #std_primitive_i32_token_stream,
                            code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                        },
                    }
                }
            };
            let impl_postgresql_type_ident_where_element_length_try_new_token_stream = {
                quote::quote! {
                    impl #postgresql_type_ident_where_element_length_upper_camel_case {
                        fn try_new(
                            logical_operator: crate::LogicalOperator,
                            length: #std_primitive_i32_token_stream,
                        ) -> Result<Self, #postgresql_type_ident_where_element_length_try_new_error_named_upper_camel_case> {
                            if length >= 0 {
                                Ok(Self{
                                    logical_operator,
                                    length
                                ...
                                Err(#postgresql_type_ident_where_element_length_try_new_error_named_upper_camel_case::LengthIsNegative {
                                    length,
                                    code_occurence: error_occurence_lib::code_occurence!(),
                                })
                            }
            ...
            let impl_serde_deserialize_for_postgresql_type_ident_where_element_length_token_stream = {
                let struct_postgresql_type_ident_where_element_length_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(
                    &format!(
                        "struct {postgresql_type_ident_where_element_length_upper_camel_case}"
                    )
                );
                let struct_postgresql_type_ident_where_element_length_with_2_elements_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(
                    &format!(
                        "struct {postgresql_type_ident_where_element_length_upper_camel_case} with 2 elements"
                    )
                );
                let postgresql_type_ident_where_element_length_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(
                    &postgresql_type_ident_where_element_length_upper_camel_case
                );
                quote::quote! {
                    const _: () = {
                        ...
                        extern crate serde as _serde;
                        #[automatically_derived]
                        impl<'de> _serde::Deserialize<'de> for #postgresql_type_ident_where_element_length_upper_camel_case {
                            fn deserialize<__D>(
                                __deserializer: __D,
                            ) -> _serde::__private::Result<Self, __D::Error>
                            where
                                __D: _serde::Deserializer<'de>,
                            {
                                ...
                                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                                    type Value = #postgresql_type_ident_where_element_length_upper_camel_case;
                                    fn expecting(
                                        &self,
                                        __formatter: &mut _serde::__private::Formatter<'_>,
                                    ) -> _serde::__private::fmt::Result {
                                        _serde::__private::Formatter::write_str(
                                            __formatter,
                                            #struct_postgresql_type_ident_where_element_length_double_quotes_token_stream,
                                        )
                                    }
                                    #[inline]
                                    fn visit_seq<__A>(
                                        ...
                                        __A: _serde::de::SeqAccess<'de>,
                                    {
                                        ...
                                        >(&mut __seq)? {
                                            ...
                                            _serde::__private::None => {
                                                return _serde::__private::Err(
                                                    _serde::de::Error::invalid_length(
                                                        0usize,
                                                        &#struct_postgresql_type_ident_where_element_length_with_2_elements_double_quotes_token_stream,
                                                    ),
                                                );
                                            }
                                        };
                                        ...
                                        match #postgresql_type_ident_where_element_length_upper_camel_case::try_new(__field0, __field1) {
                                            Ok(value) => _serde::__private::Ok(value),
                                            Err(error) => Err(_serde::de::Error::custom(format!("{error:?}")))
                                        }
                                    }
                                        ...
                                        __A: _serde::de::MapAccess<'de>,
                                    {
                                        let mut __field0: _serde::__private::Option<
                                            crate::LogicalOperator,
                                        > = _serde::__private::None;
                                        let mut __field1: _serde::__private::Option<#std_primitive_i32_token_stream> = _serde::__private::None;
                                        while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<
                                            __Field,
                                        >(&mut __map)? {
                                            match __key {
                                ...
                                _serde::Deserializer::deserialize_struct(
                                    __deserializer,
                                    #postgresql_type_ident_where_element_length_double_quotes_token_stream,
                                    FIELDS,
                                    __Visitor {
                                        marker: _serde::__private::PhantomData::<
                                            #postgresql_type_ident_where_element_length_upper_camel_case,
            ...
            let impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_ident_where_element_length_token_stream = generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                &postgresql_type_ident_where_element_length_upper_camel_case,
                &quote::quote! {Self {
                    logical_operator: #crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream,
            ...
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_ident_where_element_length_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                ...
                &quote::quote!{
                    #query_snake_case = #query_snake_case.bind(self.length);
                    #query_snake_case
                }
            );
            quote::quote! {
                #postgresql_type_ident_where_element_length_token_stream
                #postgresql_type_ident_where_element_length_try_new_error_named_token_stream
                #impl_postgresql_type_ident_where_element_length_try_new_token_stream
                #impl_serde_deserialize_for_postgresql_type_ident_where_element_length_token_stream
                #impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_ident_where_element_length_token_stream
                #impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_ident_where_element_length_token_stream
            }
        };

        let postgresql_type_ident_where_element_encode_upper_camel_case = naming::parameter::PostgresqlTypeSelfWhereElementEncodeUpperCamelCase::from_tokens(&ident);
        let postgresql_type_std_option_option_ident_where_element_encode_upper_camel_case = naming::parameter::PostgresqlTypeStdOptionOptionSelfWhereElementEncodeUpperCamelCase::from_tokens(&ident);
        let postgresql_type_tokens_where_element_encode_upper_camel_case: &dyn quote::ToTokens = if is_option {
            &postgresql_type_std_option_option_ident_where_element_encode_upper_camel_case
        }
        else {
            &postgresql_type_ident_where_element_encode_upper_camel_case
        };
        let postgresql_type_tokens_where_element_encode_token_stream = if is_option {
            macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(
                &postgresql_type_std_option_option_ident_where_element_encode_upper_camel_case, 
                &postgresql_type_ident_where_element_encode_upper_camel_case
            )
            ...
            let postgresql_type_ident_where_element_encode_token_stream = generate_postgresql_type_tokens_where_element_tokens_token_stream(
                &postgresql_type_ident_where_element_encode_upper_camel_case,
                true,
                true,
                &quote::quote!{
            ...
            let impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_ident_where_element_encode_token_stream = generate_impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                &postgresql_type_ident_where_element_encode_upper_camel_case,
                &quote::quote! {Self {
                    logical_operator: #crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream,
            ...
            let impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_type_ident_where_element_encode_token_stream = generate_impl_crate_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_token_stream(
                &postgresql_type_ident_where_element_encode_upper_camel_case,
                &quote::quote! {
                    match #increment_snake_case.checked_add(1) {
                        Some(#value_snake_case) => {
            ...
            quote::quote! {
                #postgresql_type_ident_where_element_encode_token_stream
                #impl_crate_generate_postgresql_json_type_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_ident_where_element_encode_token_stream
        ...
        let postgresql_type_tokens_where_element_token_stream = generate_postgresql_type_tokens_where_element_and_postgresql_type_std_option_option_tokens_where_element_token_stream(
            ...
            &[
                ...
                &naming::LengthUpperCamelCase,
                &naming::EncodeUpperCamelCase,
                &naming::BinaryPatternUpperCamelCase,
            ]
        );
        quote::quote! {
            #postgresql_type_tokens_where_element_hexadecimal_notation_equal_token_stream
