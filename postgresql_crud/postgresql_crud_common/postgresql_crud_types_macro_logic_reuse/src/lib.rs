...
pub fn generate_postgresql_types(_input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    impl PostgresqlType {
        ...
        fn field_type_stringified(&self) -> std::string::String {
            ...
            match &self {
                ...
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateTimeAsPostgresqlTsRange => sqlx_postgres_types_pg_range_sqlx_types_chrono_naive_date_time_stringified,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTimeAsPostgresqlTsRange => sqlx_postgres_types_pg_range_sqlx_types_time_primitive_date_time_stringified,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange => sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_stringified,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTsTzRange => sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_local_stringified,
                PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTsTzRange => sqlx_postgres_types_pg_range_sqlx_types_time_offset_date_time_stringified,
    ...
    let generate_postgresql_type_token_stream = |postgresql_type: PostgresqlType|{
        ...
        let generate_postgresql_type_not_null_or_nullable = |postgresql_type_not_null_or_nullable: &PostgresqlTypeNotNullOrNullable| -> proc_macro2::TokenStream {
            ...
            let maybe_impl_serde_deserialize_for_postgresql_type_not_null_token_stream = match &postgresql_type_not_null_or_nullable {
                ...
                PostgresqlTypeNotNullOrNullable::NotNull => {
                    ...
                    let fn_visit_seq_sqlx_postgres_types_pg_range_sqlx_types_time_primitive_date_time_token_stream = generate_fn_visit_seq_token_stream(&{
                        let fields_initialization_token_stream = {
                            //todo reusage
                            let std_collections_bound_sqlx_types_time_primitive_date_time_as_postgresql_timestamp_token_stream = quote::quote!{std::collections::Bound<SqlxTypesTimePrimitiveDateTimeAsPostgresqlTimestampNotNull>};
                            generate_fields_serde_de_seq_access_next_element_initialization_token_stream(&[
                    ...
                    let fn_visit_seq_sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_token_stream = generate_fn_visit_seq_token_stream(&{
                        let fields_initialization_token_stream = {
                            let std_collections_bound_sqlx_types_chrono_date_time_sqlx_types_chrono_utc_token_stream = quote::quote!{std::collections::Bound<#sqlx_types_chrono_date_time_sqlx_types_chrono_utc_as_postgresql_timestamp_tz_field_type_token_stream>};
                            generate_fields_serde_de_seq_access_next_element_initialization_token_stream(&[
                    ...
                    let fn_visit_seq_sqlx_postgres_types_pg_range_sqlx_types_chrono_date_time_sqlx_types_chrono_local_token_stream = generate_fn_visit_seq_token_stream(&{
                        let fields_initialization_token_stream = {
                            //todo reuse std_collections_bound wrapper
                            let std_collections_bound_sqlx_types_chrono_date_time_sqlx_types_chrono_local_token_stream = quote::quote!{std::collections::Bound<#sqlx_types_chrono_date_time_sqlx_types_chrono_local_as_postgresql_timestamp_tz_field_type_token_stream>};
                            generate_fields_serde_de_seq_access_next_element_initialization_token_stream(&[
                    ...
                    let fn_visit_seq_sqlx_postgres_types_pg_range_sqlx_types_chrono_naive_date_token_stream = generate_fn_visit_seq_token_stream(&{
                        let fields_initialization_token_stream = {
                            let std_collections_bound_sqlx_types_chrono_naive_date_token_stream = quote::quote!{std::collections::Bound<#sqlx_types_chrono_naive_date_as_postgresql_date_field_type_token_stream>};
                            generate_fields_serde_de_seq_access_next_element_initialization_token_stream(&[
                    ...
                    let fn_visit_seq_sqlx_postgres_types_pg_range_sqlx_types_decimal_token_stream = generate_fn_visit_seq_token_stream(&{
                        let fields_initialization_token_stream = {
                            let token_stream = quote::quote!{std::collections::Bound<#sqlx_types_decimal_as_postgresql_numeric_field_type_token_stream>};
                            generate_fields_serde_de_seq_access_next_element_initialization_token_stream(&[
                                &token_stream,
                                &token_stream,
                            ])
                    ...
                    let (
                        ...
                        (
                            ...
                            generate_std_collections_bound_token_stream(&quote::quote!{SqlxTypesTimeOffsetDateTimeAsPostgresqlTimestampTzNotNull}),
                            generate_std_collections_bound_token_stream(&sqlx_types_chrono_naive_date_as_postgresql_date_field_type_token_stream),
                            generate_std_collections_bound_token_stream(&quote::quote!{SqlxTypesTimeDateAsPostgresqlDateNotNull}),
                            generate_std_collections_bound_token_stream(&sqlx_types_decimal_as_postgresql_numeric_field_type_token_stream),
                            generate_std_collections_bound_token_stream(&quote::quote!{SqlxTypesBigDecimalAsPostgresqlNumericNotNull})
                        )
                    };
            ...
            let impl_crate_create_table_column_query_part_for_postgresql_type_not_null_or_nullable_token_stream = {
                ...
                let content_token_stream = match (&postgresql_type_not_null_or_nullable, &is_primary_key) {
                    (PostgresqlTypeNotNullOrNullable::NotNull, IsPrimaryKey::False) => {
                        let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&format!("{column_postgresql_query_type_not_null}"));
                        quote::quote!{
                            format!(#format_handle_token_stream)
                        }
                    },
                    (PostgresqlTypeNotNullOrNullable::NotNull, IsPrimaryKey::True) => {
                    ...
                    (PostgresqlTypeNotNullOrNullable::Nullable, IsPrimaryKey::False) => {
                        let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&column_postgresql_query_type);
                        quote::quote!{
                            format!(#format_handle_token_stream)
                        }
                    },
                    (PostgresqlTypeNotNullOrNullable::Nullable, IsPrimaryKey::True) => {
            ...
            let maybe_primary_key_tokens_token_stream = if let (PostgresqlTypeNotNullOrNullable::NotNull, IsPrimaryKey::True) = (&postgresql_type_not_null_or_nullable, &is_primary_key) {
            ...
            let postgresql_type_not_null_or_nullable_where_element_token_stream = {
                ...
                let generate_where_element_sqlx_postgres_types_pg_range_filter_token_stream = |range_type: RangeType|{
                    let range_type_token_stream: &dyn quote::ToTokens = match &range_type {
                        ...
                        RangeType::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTime => &quote::quote!{SqlxTypesTimePrimitiveDateTimeAsPostgresqlTimestampNotNull},
    ...
    let h36 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoNaiveDateTimeAsPostgresqlTsRange);
    let h37 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimePrimitiveDateTimeAsPostgresqlTsRange);
    let h38 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoUtcAsPostgresqlTsTzRange);
    let h39 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesChronoDateTimeSqlxTypesChronoLocalAsPostgresqlTsTzRange);
    let h40 = generate_postgresql_type_token_stream(PostgresqlType::SqlxPostgresTypesPgRangeSqlxTypesTimeOffsetDateTimeAsPostgresqlTsTzRange);
