...
fn generate_impl_deserialize_with_try_new_token_stream<'a>(
    ...
    let visit_str_match_variants_token_stream = fields.iter().enumerate().map(|(index, element)|format!("{} => _serde::__private::Ok(__Field::__field{index})", generate_quotes::double_quotes_stringified(&element.field_name)).parse::<proc_macro2::TokenStream>().unwrap());
    let visit_bytes_match_variants_token_stream = fields.iter().enumerate().map(|(index, element)|format!("{} => _serde::__private::Ok(__Field::__field{index})", generate_quotes::binary_double_quotes_stringified(&element.field_name)).parse::<proc_macro2::TokenStream>().unwrap());
...
fn generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream_94ce15d6_0735_4407_af5b_4a82e434f91a(
    ...
    generate_postgresql_type_or_json_type_tokens_where_element_variant_token_stream(
        ...
        &generate_additional_default_initialization_token_stream_49cf6c53_08ea_4758_91cd_a175677b5ad6(&token_patterns::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElementCall),
        &generate_try_generate_bind_increments_token_stream_1ccce498_2851_4b84_8d29_a2d205a8e111(&is_nullable_postgresql_type, &dimension),
        &generate_bind_value_to_query_token_stream_ab123b8a_9bca_4b86_ac58_214a877e8d3e(&is_nullable_postgresql_type),
    )
}
...
impl Equal {
    ...
    pub fn generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream(
        ...
        generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream_94ce15d6_0735_4407_af5b_4a82e434f91a(
            WhereOperatorName::upper_camel_case(self),
    ...
    pub fn generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream(
        ...
        generate_postgresql_type_or_json_type_tokens_where_element_variant_token_stream(
            ...
            &generate_postgresql_json_type_ident_where_element_filter_upper_camel_case(
                &postgresql_json_type_variant.postgresql_json_type_ident_wrapper(), 
                WhereOperatorName::upper_camel_case(self),
            ),
            ShouldWhereElementFieldsBePublic::True,
            &crate::ShouldDeriveSchemarsJsonSchema::True,
    ...
    generate_maybe_nullable_postgresql_type_tokens_where_element_variant_token_stream(
        ...
        ShouldWhereElementFieldsBePublic::False {
            ...
            try_new_content_token_stream: &generate_try_new_content_token_stream_87985e52_7a0a_4c62_8328_cc23a015d7fd(
                &ident,
                &postgresql_type_or_json_type,
                &regular_expression_name_upper_camel_case,
            ),
...
impl Before {
    pub fn generate_postgresql_type_tokens_where_element_variant_handle_token_stream(
        ...
        generate_maybe_nullable_postgresql_type_tokens_where_element_variant_token_stream(
            ...
            &quote::quote!{
                #value_snake_case: #std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream
            },
            &generate_try_generate_bind_increments_token_stream_cc8c69fa_8d39_425e_8875_201168042b0a(&quote::quote!{"{}({} < ${})"}),
            &quote::quote!{
    ...
    pub fn generate_postgresql_type_tokens_where_element_variant_handle_token_stream(
        ...
        generate_maybe_nullable_postgresql_type_tokens_where_element_variant_token_stream(
            ...
            &{
                let core_default_default_default = token_patterns::CoreDefaultDefaultDefault;
                quote::quote!{
                    encode_format: #std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream,
...
impl BitVecPositionEqual {
    ...
    fn generate_impl_deserialize_token_stream(
        ...
        let postgresql_type_or_json_type_ident_where_element_bit_vec_position_equals_upper_camel_case = generate_postgresql_type_or_json_type_self_where_element_filter_upper_camel_case_token_stream(
            &postgresql_type_or_json_type,
            &ident,
            &WhereOperatorName::upper_camel_case(self),
        );
...
impl PositionEqual {
    ...
    pub fn generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream(
        ...
        let self_upper_camel_case = WhereOperatorName::upper_camel_case(self);
        let postgresql_type_or_json_type = crate::PostgresqlTypeOrJsonType::PostgresqlJsonType;
        let additional_type_declaration_token_stream = generate_additional_type_declaration_token_stream_34095bbb_d306_4a44_92e9_4df1a7354bc1(
            &postgresql_json_type_ident_wrapper_array_element
        );
        generate_postgresql_type_or_json_type_tokens_where_element_variant_token_stream(
            &postgresql_type_or_json_type,
            &generate_postgresql_json_type_ident_where_element_filter_upper_camel_case(&postgresql_json_type_ident_wrapper, self_upper_camel_case),
            ...
            &crate::ShouldDeriveSchemarsJsonSchema::True,
            &additional_type_declaration_token_stream,
            &generate_additional_default_initialization_token_stream_cd86231b_5ff2_4e91_9906_29b822838309(&token_patterns::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElementCall),
            &Self::generate_try_generate_bind_increments_token_stream(),
    ...
    generate_postgresql_type_or_json_type_tokens_where_element_variant_token_stream(
        ...
        ShouldWhereElementFieldsBePublic::False {
            ...
            impl_deserialize_token_stream: &generate_impl_deserialize_token_stream_45e71974_8062_4f69_9296_248692666dde(
                &postgresql_json_type_ident_wrapper,
                &postgresql_type_or_json_type,
                &postgresql_json_type_array_element_ident_wrapper,
                &self_upper_camel_case,
            ),
        },
        &crate::ShouldDeriveSchemarsJsonSchema::True,
        &additional_type_declaration_token_stream,
        &generate_additional_default_initialization_token_stream_e46171d1_2c28_450b_85a8_80293ebe69f8(&token_patterns::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElementCall),
...
impl ContainsElementCaseSensitiveRegularExpression {
    ...
    pub fn generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream(
        ...
        generate_postgresql_json_type_tokens_where_element_variant_handle_token_stream_5d8e8b34_33ec_476c_a50b_19e0b8d5da69(
            WhereOperatorName::upper_camel_case(self),
            postgresql_json_type_variant,
            &Self::generate_try_generate_bind_increments_token_stream(),
        )
