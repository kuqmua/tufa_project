    ...
    let json_value_variants_token_stream = {
        ...
        let generate_impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = |postgresql_json_type: &PostgresqlJsonType|{
            let postgresql_json_type_tokens_token_stream = {
                ...
                let update_token_stream = match &postgresql_json_type {
                    PostgresqlJsonType::Object => {
            ...
            let generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = |postgresql_type: PostgresqlType|{
                ...
                // &mut increment,
                            ...
                            match &postgresql_type {
                                ...
                                PostgresqlType::JsonNotNull |
                                PostgresqlType::JsonbNotNull => generate_ok_try_generate_postgresql_json_type_to_update_token_stream(&quote::quote!{self.0}),
                            }
                        };
                        let bind_value_to_query_content_for_postgresql_type_tokens_to_update_token_stream = {
                            ...
                            match &postgresql_type {
                                ...
                                PostgresqlType::JsonNotNull |
                                PostgresqlType::JsonbNotNull => generate_bind_value_to_postgresql_query_part_to_update_token_stream(&quote::quote!{self.0}),
                            }
                        };
                        quote::quote!{
