...
pub fn generate_postgresql_json_type(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let postgresql_type_traits_token_stream = {
        ...
        let generate_postgresql_type_traits_token_stream = |postgresql_json_type: &PostgresqlJsonType, need_to_generate_postgresql_crud_logic: bool|{
            let postgresql_json_type_tokens_to_create_upper_camel_case = {
            ...
            let impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = {
                ...
                let postgresql_json_type_tokens_where_upper_camel_case: &dyn quote::ToTokens = match &postgresql_json_type {
                    ...
                    PostgresqlJsonType::StdOptionOptionObject => &naming::parameter::PostgresqlJsonTypeStdOptionOptionObjectSelfWhereUpperCamelCase::from_tokens(&ident),
                    PostgresqlJsonType::StdVecVecObjectWithId => &naming::parameter::PostgresqlJsonTypeStdVecVecObjectWithIdSelfWhereUpperCamelCase::from_tokens(&ident),
                    PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => &naming::parameter::PostgresqlJsonTypeStdOptionOptionStdVecVecObjectWithIdSelfWhereUpperCamelCase::from_tokens(&ident),
                };
                let read_token_stream = {
                    ...
                    let postgresql_json_type_tokens_options_to_read_upper_camel_case_token_stream = {
                        let value: &dyn quote::ToTokens = match &postgresql_json_type {
                            PostgresqlJsonType::Object => &naming::parameter::PostgresqlJsonTypeObjectSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                            PostgresqlJsonType::StdOptionOptionObject => &naming::parameter::PostgresqlJsonTypeStdOptionOptionObjectSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                            PostgresqlJsonType::StdVecVecObjectWithId => &naming::parameter::PostgresqlJsonTypeStdVecVecObjectWithIdSelfOptionsToReadUpperCamelCase::from_tokens(&ident),
                    ...
                    let postgresql_json_type_tokens_where_element_token_stream = {
                        let postgresql_json_type_tokens_where_element_token_stream = {
                            let variants_token_stream = vec_syn_field.iter().map(|element| {
                                let field_ident_stringified = element
                                    .ident
                                ...
                                let postgresql_json_type_field_type_where_upper_camel_case_token_stream = naming::parameter::PostgresqlJsonTypeSelfWhereUpperCamelCase::from_type_last_segment(&element.ty);
                                quote::quote!{
                                    #field_ident_upper_camel_case_token_stream(#postgresql_json_type_field_type_where_upper_camel_case_token_stream)
                                }
                            });
                            quote::quote!{
                        ...
                        let impl_postgresql_crud_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_json_type_tokens_where_element_token_stream = {
                            let postgresql_type_self_where_try_generate_bind_increments_variants_token_stream = vec_syn_field.iter().map(|element| {
                                let field_ident_stringified = element
                                    .ident
                                    .as_ref()
                                    .unwrap_or_else(|| {
                                ...
                                quote::quote!{
                                    Self::#field_ident_upper_camel_case_token_stream(value) => postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::postgresql_type_self_where_try_generate_bind_increments(
                                        value,
                                        increment,
                                        &format!(#format_handle_token_stream),
                            ...
                            quote::quote!{
                                impl postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter for #postgresql_json_type_tokens_where_element_upper_camel_case {
                                    fn postgresql_type_self_where_try_generate_bind_increments(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud::TryGenerateBindIncrementsErrorNamed> {
                                        match &self {
                                            #(#postgresql_type_self_where_try_generate_bind_increments_variants_token_stream),*
                                        }
                                    }
                        ...
                        let impl_postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_json_type_tokens_where_element_token_stream = {
                            let variants_token_stream = vec_syn_field.iter().map(|element| {
                                ...
                                let field_ident_upper_camel_case_token_stream = naming::AsRefStrToUpperCamelCaseTokenStream::new_or_panic(&field_ident_stringified);
                                quote::quote!{
                                    Self::#field_ident_upper_camel_case_token_stream(#postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream)
                                }
                            });
                            quote::quote!{
                        ...
                        let impl_postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_json_type_tokens_where_token_stream = {
                            quote::quote!{
                                impl postgresql_crud::StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement for #postgresql_json_type_tokens_where_upper_camel_case {
                                    ...
                                    fn std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element() -> Self {
                                        Self {
                                            logical_operator: #postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream,
                ...
                let postgresql_json_type_tokens_option_to_update_try_generate_postgresql_json_type_error_named_upper_camel_case_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                    ...
                    let postgresql_type_tokens_to_create_token_stream = {
                        let postgresql_type_tokens_to_create_token_stream = {
                            ...
                            quote::quote!{
                                ...
                                pub struct #postgresql_type_tokens_to_create_upper_camel_case (#postgresql_type_tokens_to_create_declaration_token_stream);
                            }
                        };
                                    ...
                                    => {
                                        ...
                                        quote::quote!{
                                            #query_snake_case = match self.0 {
                                                ...
                                                None => #query_snake_case.bind(std::option::Option::<sqlx::types::Json<#postgresql_json_type_tokens_to_create_upper_camel_case>>::None)
                                            };
                                            #query_snake_case
                                        }
                                    },
                    ...
                    let postgresql_type_tokens_to_update_token_stream = {
                        ...
                        let impl_postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_to_update_token_stream = {
                            let std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_content_for_postgresql_type_tokens_to_update_token_stream = match &postgresql_type {
                                PostgresqlType::JsonbNullable => quote::quote!{Self(Some(
                                    #postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream
                                ))},
                        ...
                        let postgresql_type_tokens_where_element_token_stream = {
                            let variants_token_stream = vec_syn_field.iter().map(|element| {
                                let field_ident_stringified = element
                                    ...
                                    .to_string();
                                let field_ident_upper_camel_case_token_stream = naming::AsRefStrToUpperCamelCaseTokenStream::new_or_panic(&field_ident_stringified);
                                let postgresql_json_type_field_ident_where_upper_camel_case = naming::parameter::PostgresqlJsonTypeSelfWhereUpperCamelCase::from_type_last_segment(&element.ty);
                                quote::quote!{
                                    #field_ident_upper_camel_case_token_stream(#postgresql_json_type_field_ident_where_upper_camel_case)
                                }
                            });
                            quote::quote!{
                                #[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
                    ...
                    let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = {
                        ...
                        let postgresql_type_self_column_query_part_token_stream = {
                            ...
                            let format_value_token_stream = match &postgresql_type {
                                PostgresqlType::JsonbNullable
                                => quote::quote!{
                                    match &#postgresql_type_self_column_snake_case.0 {
                                ...
                                PostgresqlType::JsonbNotNull
                                => quote::quote!{
                                    <#tokens_upper_camel_case as postgresql_crud::PostgresqlJsonType>::generate_postgresql_json_type_to_read(&#postgresql_type_self_column_snake_case.0, &column, &column, &column, true)
                                },
                            };
                            quote::quote!{
