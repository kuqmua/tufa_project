...
pub fn generate_postgresql_json_type(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_tokens_select_token_stream = |postgresql_json_type_select: &PostgresqlJsonTypeSelect| {
        ...
        let content_token_stream = match &postgresql_json_type_select {
            ...
            PostgresqlJsonTypeSelect::Ident | PostgresqlJsonTypeSelect::ObjectIdent | PostgresqlJsonTypeSelect::StdOptionOptionObjectIdent => quote::quote! {(#std_vec_vec_ident_field_to_read_without_id_upper_camel_case_token_stream);},
            PostgresqlJsonTypeSelect::StdVecVecObjectWithIdIdent | PostgresqlJsonTypeSelect::StdOptionOptionStdVecVecObjectWithIdIdent => quote::quote! {
                {
    ...
    let common_token_stream = {
        let create_token_stream = {
            ...
            let ident_to_create_origin_token_stream = generate_supported_generics_template_struct_token_stream(false, &ident_to_create_origin_upper_camel_case, &quote::quote! {{ #fields_declaration_token_stream }});
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_origin_token_stream =
            ...
            let (impl_new_for_ident_to_create_with_generated_id_token_stream, impl_new_for_ident_to_create_without_generated_id_token_stream) = {
                ...
                (impl_new_for_ident_to_create_with_generated_id_token_stream, impl_new_for_ident_to_create_without_generated_id_token_stream)
            };
            let (
                ...
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_with_generated_id_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_to_create_with_generated_id_upper_camel_case, &proc_macro2::TokenStream::new(), &initialization_token_stream);
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_without_generated_id_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_to_create_without_generated_id_upper_camel_case, &proc_macro2::TokenStream::new(), &initialization_token_stream);
                (
                    impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_with_generated_id_token_stream,
                    impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_without_generated_id_token_stream,
                )
            };
            let (impl_postgresql_crud_json_create_postgresql_query_part_for_ident_to_create_with_generated_id_token_stream, impl_postgresql_crud_json_create_postgresql_query_part_for_ident_to_create_without_generated_id_token_stream) = {
                ...
                let impl_postgresql_crud_json_create_postgresql_query_part_for_ident_to_create_with_generated_id_token_stream = generate_impl_json_create_tokens_to_create_token_stream(&ident_to_create_with_generated_id_upper_camel_case, true);
                let impl_postgresql_crud_json_create_postgresql_query_part_for_ident_to_create_without_generated_id_token_stream = generate_impl_json_create_tokens_to_create_token_stream(&ident_to_create_without_generated_id_upper_camel_case, false);
                (
        ...
        let (read_token_stream, update_token_stream) = {
            let read_token_stream = {
                let (ident_field_to_read_token_stream, ident_with_id_field_to_read_token_stream) = {
                    let generate_template_field_to_read_struct_token_stream = |tokens_field_to_read_token_stream: &dyn quote::ToTokens, additional_content_token_stream: &dyn quote::ToTokens| {
                    ...
                    let ident_field_to_read_without_id_token_stream = generate_template_field_to_read_struct_token_stream(&ident_field_to_read_without_id_upper_camel_case, &proc_macro2::TokenStream::new());
                    ...
                    (ident_field_to_read_without_id_token_stream, ident_field_to_read_with_id_token_stream)
                };
                let (impl_error_occurence_lib_to_std_string_string_for_ident_field_to_read_token_stream, impl_error_occurence_lib_to_std_string_string_for_ident_with_id_field_to_read_token_stream) = {
                    let content_token_stream = quote::quote! {format!("{self:?}")};
                    (
                        macros_helpers::generate_impl_error_occurence_lib_to_std_string_string_token_stream(&proc_macro2::TokenStream::new(), &ident_field_to_read_without_id_upper_camel_case, &proc_macro2::TokenStream::new(), &content_token_stream),
                        macros_helpers::generate_impl_error_occurence_lib_to_std_string_string_token_stream(&proc_macro2::TokenStream::new(), &ident_field_to_read_with_id_upper_camel_case, &proc_macro2::TokenStream::new(), &content_token_stream),
                    )
                };
                let (
                    ...
                    let impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_field_to_read_without_id_token_stream =
                        postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_field_to_read_without_id_upper_camel_case, &{
                    ...
                    let impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_field_to_read_with_id_token_stream =
                        postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_field_to_read_with_id_upper_camel_case, &{
            ...
            let update_token_stream = {
                ...
                let impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_ident_option_to_update_origin_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&ident_update_origin_upper_camel_case, &{
                        let elements_token_stream = vec_syn_field.iter().map(|element| {
                            let field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                panic!("{}", naming::FIELD_IDENT_IS_NONE);
                            });
                ...
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_options_to_update_token_stream =
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
            ...
            (read_token_stream, update_token_stream)
        };
        quote::quote! {
            #create_token_stream
            #read_token_stream
    ...
    let generate_tokens_to_update_methods_token_stream = |struct_token_stream: &dyn quote::ToTokens,
                                                          //todo rename
    ...
    let generate_tokens_reader_alias_token_stream = |struct_ident_token_stream: &dyn quote::ToTokens, struct_read_token_stream: &dyn quote::ToTokens| macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(struct_ident_token_stream, struct_read_token_stream);
    ...
    let ident_token_stream = {
        ...
        let read_token_stream = {
            ...
            let impl_serde_deserialize_for_postgresql_json_type_ident_select_token_stream = {
                ...
                let match_try_new_in_deserialize_token_stream = generate_match_try_new_in_deserialize_token_stream(&ident_select_upper_camel_case, &field0_token_stream);
                quote::quote! {
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_ident_select_token_stream =
                postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
        ...
        let update_token_stream = {
            ...
            let impl_serde_deserialize_for_postgresql_json_type_ident_option_to_update_token_stream = {
                ...
                let match_try_new_in_deserialize_token_stream = generate_match_try_new_in_deserialize_token_stream(&ident_update_upper_camel_case, &field0_token_stream);
                quote::quote! {
            ...
            let postgresql_json_type_ident_option_to_update_try_generate_postgresql_json_type_error_named_token_stream = generate_tokens_try_generate_postgresql_json_type_error_named_token_stream(&ident_update_error_named_upper_camel_case, &{
                let variants_token_stream = vec_syn_field.iter().map(|element| {
                    let field_ident_stringified = element
                        .ident
                        .as_ref()
            ...
            let impl_postgresql_json_type_ident_option_to_update_methods_token_stream = generate_tokens_to_update_methods_token_stream(
                ...
                &{
                    ...
                    let local_acc_format_handle_token_stream = generate_quotes::double_quotes_token_stream(&format!(
                        "jsonb_set({{{jsonb_set_accumulator_snake_case}}},'{{{{{{{jsonb_set_path_snake_case}}}}}}}',case when jsonb_typeof({{{jsonb_set_target_snake_case}}}) = 'object' then ({{{jsonb_set_target_snake_case}}})::jsonb else '{{{{}}}}'::jsonb end)"
                    ));
            ...
            let impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = {
                    ...
                    let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_tokens_select_token_stream =
                        postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(&tokens_select_upper_camel_case, &proc_macro2::TokenStream::new(), &{
                            let value = match &postgresql_json_type {
                                ...
                                PostgresqlJsonType::Object | PostgresqlJsonType::StdOptionOptionObject => quote::quote! {(#postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)},
                        ...
                        let impl_postgresql_crud_postgresql_type_postgresql_type_trait_postgresql_type_where_filter_for_tokens_where_element_token_stream = postgresql_crud_macros_common::impl_postgresql_type_where_filter_for_ident_token_stream(
                            ...
                            &{
                                let where_query_part_variants_token_stream = vec_syn_field.iter().map(|element| {
                                    ...
                                    quote::quote! {
                                        Self::#field_ident_upper_camel_case_token_stream(value) => postgresql_crud::postgresql_type_trait::PostgresqlTypeWhereFilter::where_query_part(
                                            value,
                                            increment,
                                            &format!(#format_handle_token_stream),
                            ...
                            &{
                                let where_query_bind_variants_token_stream = vec_syn_field.iter().map(|element| {
                                    ...
                                    let field_ident_upper_camel_case_token_stream = naming::AsRefStrToUpperCamelCaseTokenStream::case_or_panic(&field_ident_stringified);
                                    quote::quote! {
                                        Self::#field_ident_upper_camel_case_token_stream(value) => postgresql_crud::postgresql_type_trait::PostgresqlTypeWhereFilter::where_query_bind(value, query)
                                    }
                                });
                                quote::quote! {
                                    match self {
                ...
                let update_token_stream = {
                    ...
                    let postgresql_json_type_tokens_option_to_update_try_generate_postgresql_json_type_error_named_token_stream = {
                        let generate_postgresql_json_type_tokens_option_to_update_try_generate_postgresql_json_type_error_named_token_stream =
                            |content_token_stream: &dyn quote::ToTokens| generate_tokens_try_generate_postgresql_json_type_error_named_token_stream(&tokens_update_error_named_upper_camel_case_token_stream, &content_token_stream);
                        ...
                        match &postgresql_json_type {
                            ...
                            PostgresqlJsonType::StdVecVecObjectWithId => generate_postgresql_json_type_tokens_option_to_update_try_generate_postgresql_json_type_error_named_token_stream(&ident_json_array_change_try_generate_postgresql_json_type_error_named_token_stream),
                        ...
                        let generate_acc_push_str_variant_logic_token_stream =
                            |variant_name_token_stream: &dyn quote::ToTokens, field_ident_double_quotes_token_stream: &dyn quote::ToTokens, column_name_and_maybe_field_getter_token_stream: &dyn quote::ToTokens, element_type: &dyn quote::ToTokens| {
                                let tokens_field_to_read_with_or_without_id_upper_camel_case_token_stream: &dyn quote::ToTokens = match &postgresql_json_type {
                                    PostgresqlJsonType::Object | PostgresqlJsonType::StdOptionOptionObject => &ident_field_to_read_without_id_upper_camel_case,
                                    PostgresqlJsonType::StdVecVecObjectWithId | PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => &ident_field_to_read_with_id_upper_camel_case,
                                };
                    ...
                    let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_as_type_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_type_for_ident_token_stream(
                        ...
                        &{
                            ...
                            let generate_ok_try_generate_postgresql_json_type_to_update_token_stream = |is_postgresql_type_self_to_update_zero: std::primitive::bool| {
                                let first_argument_token_stream: &dyn quote::ToTokens = if is_postgresql_type_self_to_update_zero { &quote::quote! {&#value_snake_case.0} } else { &value_snake_case };
