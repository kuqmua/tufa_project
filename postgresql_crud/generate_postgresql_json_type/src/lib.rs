...
pub fn generate_postgresql_json_type(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let json_value_variants_token_stream = {
        ...
        let generate_impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = |postgresql_json_type: &PostgresqlJsonType|{
            ...
            let read_token_stream = {
                ...
                generate_impl_postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                    &postgresql_json_type_tokens_field_reader_upper_camel_case,
                    &match &postgresql_json_type {
                        PostgresqlJsonType::Object => quote::quote!{(#postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream)},
                        //todo optioon(null) must also be a read value
                        PostgresqlJsonType::StdOptionOptionObject => quote::quote!{(#postgresql_crud_all_enum_variants_array_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream)},
                ...
                let impl_serde_deserialize_for_postgresql_json_type_tokens_field_reader_token_stream = match &postgresql_json_type {
                    PostgresqlJsonType::Object => {
            ...
            let update_token_stream = {
                ...
                let postgresql_json_type_tokens_option_to_update_token_stream = generate_tokens_option_to_update_token_stream(
                    ...
                    &match &postgresql_json_type {
                        PostgresqlJsonType::Object => quote::quote!{pub #postgresql_json_type_ident_option_to_update_upper_camel_case},
                        PostgresqlJsonType::StdOptionOptionObject => quote::quote!{pub std::option::Option<#postgresql_json_type_ident_option_to_update_upper_camel_case>},
                ...
                let impl_postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_json_type_tokens_option_to_update_token_stream = generate_impl_postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_tokens_token_stream(
                    ...
                    &match &postgresql_json_type {
                        ...
                        PostgresqlJsonType::StdOptionOptionObject |
                        PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => quote::quote!{(Some(#postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream))},
                    }
                );
                quote::quote!{
            ...
            let postgresql_json_type_token_stream = postgresql_crud_macros_common::generate_postgresql_json_type_token_stream(
                ...
                &postgresql_json_type_tokens_to_create_upper_camel_case,
                &match &postgresql_json_type {
                    PostgresqlJsonType::Object => quote::quote!{#postgresql_json_type_self_to_create_snake_case.0.#try_generate_postgresql_json_type_to_create_snake_case(#increment_snake_case)},
                ...
                &match &postgresql_json_type {
                    PostgresqlJsonType::Object => quote::quote!{#postgresql_json_type_self_to_create_snake_case.0.#bind_value_to_postgresql_query_part_to_create_snake_case(#query_snake_case)},
                    PostgresqlJsonType::StdOptionOptionObject => quote::quote!{
                ...
                &match &postgresql_json_type {
                        ...
                        quote::quote!{
                            match &#postgresql_json_type_self_option_to_update_snake_case.0 {
                                ...
                                None => match #increment_snake_case.checked_add(1) {
                                    ...
                                    None => Err(#postgresql_json_type_tokens_option_to_update_try_generate_postgresql_json_type_error_named_upper_camel_case_token_stream::#checked_add_variant_initialization_token_stream)
                                }
                            }
                        }
                    },
                    PostgresqlJsonType::StdVecVecObjectWithId => quote::quote!{
                        match #postgresql_json_type_self_option_to_update_snake_case.0.#try_generate_postgresql_json_type_to_update_snake_case(
                            ...
                            Ok(value) => Ok(value),
                            Err(error) => Err(#postgresql_json_type_tokens_option_to_update_try_generate_postgresql_json_type_error_named_upper_camel_case_token_stream::#ident_json_array_change_try_generate_postgresql_json_type_error_named_upper_camel_case {
                                error,
                                code_occurence: error_occurence_lib::code_occurence!()
                            })
                        }
        ...
        let generate_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = |postgresql_json_type: PostgresqlJsonType|{
            ...
            let generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = |postgresql_type: PostgresqlType|{
                ...
                let postgresql_type_tokens_to_update_token_stream = {
                    ...
                    let impl_postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_for_postgresql_type_tokens_to_update_token_stream = {
                        let std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_content_for_postgresql_type_tokens_to_update_token_stream = match &postgresql_type {
                            PostgresqlType::Json |
                            PostgresqlType::Jsonb => quote::quote!{Self(Some(
                                #postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream
                            ))},
                            PostgresqlType::JsonNotNull |
                            PostgresqlType::JsonbNotNull => quote::quote!{Self(
                                #postgresql_crud_std_default_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element_call_token_stream
                            )},
                        };
                        quote::quote!{
            ...
            // let postgresql_json_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_as_postgresql_json_token_stream = generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream(PostgresqlType::Json);
            // let postgresql_json_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_as_postgresql_json_not_null_token_stream = generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream(PostgresqlType::JsonNotNull);
