...
pub fn generate_postgresql_json_type(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let generate_tokens_select_token_stream = |postgresql_json_type_select: &PostgresqlJsonTypeSelect|{
        let tokens_upper_camel_case_token_stream: &dyn quote::ToTokens = match &postgresql_json_type_select {
            PostgresqlJsonTypeSelect::Ident => &{
                let value = naming::ToTokensToUpperCamelCaseTokenStream::case_or_panic(&ident);
                value
            },
            PostgresqlJsonTypeSelect::ObjectIdent => &naming::parameter::ObjectSelfUpperCamelCase::from_tokens(&ident),
            PostgresqlJsonTypeSelect::StdOptionOptionObjectIdent => &naming::parameter::StdOptionOptionObjectSelfUpperCamelCase::from_tokens(&ident),
            PostgresqlJsonTypeSelect::StdVecVecObjectWithIdIdent => &naming::parameter::StdVecVecObjectWithIdSelfUpperCamelCase::from_tokens(&ident),
            PostgresqlJsonTypeSelect::StdOptionOptionStdVecVecObjectWithIdIdent => &naming::parameter::StdOptionOptionStdVecVecObjectWithIdSelfUpperCamelCase::from_tokens(&ident),
        };
        let tokens_select_upper_camel_case_token_stream = naming::parameter::SelfSelectUpperCamelCase::from_tokens(&tokens_upper_camel_case_token_stream);
        ...
        let content_token_stream = match &postgresql_json_type_select {
            ...
            PostgresqlJsonTypeSelect::Ident |
            PostgresqlJsonTypeSelect::ObjectIdent |
            PostgresqlJsonTypeSelect::StdOptionOptionObjectIdent => quote::quote!{(#std_vec_vec_ident_field_to_read_without_id_upper_camel_case_token_stream);},
            PostgresqlJsonTypeSelect::StdVecVecObjectWithIdIdent |
            PostgresqlJsonTypeSelect::StdOptionOptionStdVecVecObjectWithIdIdent => quote::quote!{
                {
        ...
        let impl_pub_fn_try_new_token_stream = {
            ...
            match &postgresql_json_type_select {
                PostgresqlJsonTypeSelect::Ident |
                PostgresqlJsonTypeSelect::ObjectIdent |
                PostgresqlJsonTypeSelect::StdOptionOptionObjectIdent => generate_impl_pub_fn_try_new_token_stream(
                    false,
                ...
                PostgresqlJsonTypeSelect::StdVecVecObjectWithIdIdent |
                PostgresqlJsonTypeSelect::StdOptionOptionStdVecVecObjectWithIdIdent => generate_impl_pub_fn_try_new_token_stream(
                    true,
                    &field_vec_std_vec_vec_ident_field_to_read_with_id_upper_camel_case_token_stream_pagination_postgersql_crud_pagination_token_stream_token_stream,
                    true,
                )
        ...
        quote::quote!{
            ...
            pub struct #tokens_select_upper_camel_case_token_stream #content_token_stream
    ...
    let generate_postgresql_json_type_tokens_read_alias_token_stream = |postgresql_json_type_tokens_read_token_stream: &dyn quote::ToTokens, contains_id: std::primitive::bool|{
        let postgresql_json_type_tokens_read_with_or_without_id_token_stream = if contains_id {
            quote::quote!{#ident_read_with_id_upper_camel_case}
        }
        else {
            quote::quote!{#ident_read_without_id_upper_camel_case}
        };
    ...
    let generate_postgresql_json_type_tokens_read_token_stream = |
        postgresql_json_type_token_read_token_stream: &dyn quote::ToTokens,
    ...
    let common_token_stream = {
        let create_token_stream = {
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_origin_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                &ident_to_create_origin_upper_camel_case,
                &proc_macro2::TokenStream::new(),
                &quote::quote!{Self #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_fields_token_stream}
            );
            ...
            let (
                ...
                let initialization_token_stream = quote::quote!{Self(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)};
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_with_generated_id_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                    &ident_to_create_with_generated_id_upper_camel_case,
                    &proc_macro2::TokenStream::new(),
                    &initialization_token_stream
                );
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_without_generated_id_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                    &ident_to_create_without_generated_id_upper_camel_case,
                    &proc_macro2::TokenStream::new(),
                    &initialization_token_stream
                );
            ...
            quote::quote!{
                ...
                #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_to_create_origin_token_stream
        ...
        let (
            ...
            let read_token_stream = {
                    ...
                    let ident_field_to_read_with_id_token_stream = generate_template_field_to_read_struct_token_stream(
                        ...
                        &quote::quote!{
                            #[serde(rename(serialize = #id_snake_case_double_quotes_token_stream, deserialize = #id_snake_case_double_quotes_token_stream))]
                             Id(#postgresql_crud_path_token_stream postgresql_json_type::UuidUuidSelect),//todo reuse
                        },
                    );
                    (
                ...
                let (
                    impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_field_to_read_token_stream,
                    impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_with_id_field_to_read_token_stream
                ) = {
                    ...
                    // );
                    let impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_field_to_read_with_id_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        &ident_field_to_read_with_id_upper_camel_case,
                        &{
                            let other_variants_token_stream = generate_vec_content_token_stream(&ident_field_to_read_with_id_upper_camel_case);
                            quote::quote!{
                                vec![
                                    #ident_field_to_read_with_id_upper_camel_case::Id(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream),
                    ...
                    (
                        impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_field_to_read_without_id_token_stream,
                        impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_field_to_read_with_id_token_stream
                    )
                };
                let generate_postgresql_json_type_ident_read_with_or_without_id_fields_declaration_token_stream = |
                    contains_id: std::primitive::bool,
                ...
                |{
                    ...
                    let maybe_id_token_stream = if contains_id {
                        quote::quote!{
                            ...
                            #id_snake_case: std::option::Option<#postgresql_crud_path_token_stream Value<#postgresql_crud_path_token_stream postgresql_json_type::UuidUuidRead>>,//todo reuse
                        }
                    }
                    else {
                        proc_macro2::TokenStream::new()
                ...
                let (
                    ...
                    let generate_struct_postgresql_json_type_tokens_read_token_stream = |struct_ident_token_stream: &dyn quote::ToTokens, contains_id: std::primitive::bool|{
                        generate_postgresql_json_type_tokens_read_token_stream(
                            &struct_ident_token_stream,
                            false,
                            &{
                ...
                let (
                    ...
                    let (
                        ...
                        let generate_impl_try_new_for_postgresql_json_type_ident_read_with_or_without_id_token_stream = |contains_id: std::primitive::bool|{
                            let postgresql_json_type_ident_read_with_or_without_id_token_stream: &dyn quote::ToTokens = if contains_id {
                            ...
                            let (
                                postgresql_json_type_ident_read_with_or_without_id_fields_reference_token_stream,
                                postgresql_json_type_ident_read_with_or_without_id_fields_token_stream
                            ) = {
                ...
                let (
                    ...
                    let generate_impl_serde_deserialize_for_postgresql_json_type_read_token_stream = |
                    ...
                    |{
                        ...
                        let visit_seq_fields_initialization_token_stream = {
                            let generate_serde_de_seq_access_next_element_token_stream = |
                                index: std::primitive::usize,
                                type_read_token_stream: &dyn quote::ToTokens,
                            |{
                                let field_index_token_stream = generate_field_index_token_stream(index);
                                quote::quote! {
                            ...
                            let visit_seq_fields_initialization_token_stream = vec_syn_field.iter().enumerate().map(|(index, element)| {
                                ...
                                generate_serde_de_seq_access_next_element_token_stream(
                                    index,
                                    &type_read_token_stream,
                                )
                            });
                            let maybe_id_serde_de_seq_access_next_element_token_stream = if contains_id {
                                generate_serde_de_seq_access_next_element_token_stream(
                                    0,
                                    &quote::quote!{#postgresql_crud_path_token_stream postgresql_json_type::UuidUuidRead},//todo reuse
                                )
                            }
                            else {
                                proc_macro2::TokenStream::new()
                        ...
                        let visit_map_fields_initialization_token_stream = {
                            ...
                            let maybe_id_mut_field_index_serde_private_option_token_stream = if contains_id {
                                generate_mut_field_index_serde_private_option_token_stream(
                                    0,
                                    &quote::quote!{#postgresql_crud_path_token_stream postgresql_json_type::UuidUuidRead},//todo
                                )
                            }
                            else {
                                quote::quote!{}
                    ...
                    let impl_serde_deserialize_for_postgresql_json_type_ident_read_without_id_token_stream = generate_impl_serde_deserialize_for_postgresql_json_type_read_token_stream(
                        &ident_read_without_id_upper_camel_case,
                        false,
                    );
                    let impl_serde_deserialize_for_postgresql_json_type_ident_read_with_id_token_stream = generate_impl_serde_deserialize_for_postgresql_json_type_read_token_stream(
                        &ident_read_with_id_upper_camel_case,
                        true,
                    );
                    (
                ...
                let (
                    ...
                    let (
                        ...
                        let generate_field_ident_some_value_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream = |
                        ...
                        let fields_some_value_self_read_initialization_content_token_stream = {
                            let fields_token_stream = vec_syn_field.iter().map(|element| generate_field_ident_some_value_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream(
                                element
                                .ident
                                .as_ref()
                                .unwrap_or_else(|| {
                        ...
                        let fields_with_id_some_value_self_read_initialization_content_token_stream = {
                            let fields_token_stream = {
                                ...
                                let id_field_ident_some_value_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream = generate_field_ident_some_value_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream(
            ...
            let update_token_stream = {
                ...
                let impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_ident_option_to_update_origin_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                ...
                let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_options_to_update_token_stream =        postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                ...
                quote::quote!{
                    ...
                    #impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_ident_options_to_update_token_stream
                }
            };
            (
                read_token_stream,
    ...
    let generate_tokens_reader_alias_token_stream = |struct_ident_token_stream: &dyn quote::ToTokens, struct_read_token_stream: &dyn quote::ToTokens|{
        macros_helpers::generate_pub_type_alias_token_stream::generate_pub_type_alias_token_stream(struct_ident_token_stream, struct_read_token_stream)
    };
    ...
    let ident_token_stream = {
        ...
        let read_token_stream = {
            ...
            let impl_serde_deserialize_for_postgresql_json_type_ident_select_token_stream = {
                let tuple_struct_ident_select_double_quotes_token_stream = generate_tuple_struct_tokens_double_quotes_token_stream(&ident_select_upper_camel_case);
                let tuple_struct_ident_select_with_1_element_double_quotes_token_stream = generate_tuple_struct_tokens_with_1_element_double_quotes_token_stream(&ident_select_upper_camel_case);
                let ident_select_upper_camel_case_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(&ident_select_upper_camel_case);
                let match_try_new_in_deserialize_token_stream = generate_match_try_new_in_deserialize_token_stream(
                    &ident_select_upper_camel_case,
                    &field0_token_stream,
                );
                quote::quote!{
                    impl<'de> serde::Deserialize<'de> for #ident_select_upper_camel_case {
                        fn deserialize<__D>(
                            __deserializer: __D,
                        ) -> serde::__private::Result<Self, __D::Error>
                        where
                            __D: serde::Deserializer<'de>,
                        {
                            #[doc(hidden)]
                            struct __Visitor<'de> {
                                marker: serde::__private::PhantomData<#ident_select_upper_camel_case>,
                                lifetime: serde::__private::PhantomData<&'de ()>,
                            }
                            impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                                type Value = #ident_select_upper_camel_case;
                                fn expecting(
                                    &self,
                                    __formatter: &mut serde::__private::Formatter<'_>,
                                ) -> serde::__private::fmt::Result {
                                    serde::__private::Formatter::write_str(
                                        __formatter,
                                        #tuple_struct_ident_select_double_quotes_token_stream,
                                    )
                                }
                                #[inline]
                                    ...
                                    >(&mut __seq)? {
                                        ...
                                        serde::__private::None => {
                                            return serde::__private::Err(
                                                serde::de::Error::invalid_length(
                                                    0usize,
                                                    &#tuple_struct_ident_select_with_1_element_double_quotes_token_stream,
                                                ),
                                            );
                                        }
                                    };
                            ...
                            serde::Deserializer::deserialize_newtype_struct(
                                __deserializer,
                                #ident_select_upper_camel_case_double_quotes_token_stream,
                                __Visitor {
                                    marker: serde::__private::PhantomData::<#ident_select_upper_camel_case>,
                                    lifetime: serde::__private::PhantomData,
                                },
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_ident_select_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                &ident_select_upper_camel_case,
                &proc_macro2::TokenStream::new(),
                &quote::quote!{Self(#postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)}
            );
            ...
            let impl_postgresql_crud_generate_postgresql_json_type_to_read_ident_generate_postgresql_json_type_to_read_from_self_vec_error_named_for_ident_field_to_read_token_stream = {
                let impl_postgresql_crud_generate_postgresql_json_type_to_read_ident_generate_postgresql_json_type_to_read_from_self_vec_error_named_for_ident_field_to_read_token_stream = {
                    let variants_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        let field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream(element);
                        quote::quote!{
                            #ident_field_to_read_without_id_upper_camel_case::#variant_ident_upper_camel_case_token_stream(value) => #field_type_as_postgresql_crud_postgresql_json_type_from_field_token_stream #select_query_part_snake_case(
                                value,
                                #field_ident_double_quotes_token_stream,
        ...
        let update_token_stream = {
            ...
            let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_ident_option_to_update_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                &ident_update_upper_camel_case,
                &proc_macro2::TokenStream::new(),
                &quote::quote!{Self(#postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)}
            );
        ...
        let generate_postgresql_type_traits_token_stream = |postgresql_json_type: &PostgresqlJsonType, need_to_generate_postgresql_crud_logic: bool|{
            ...
            let impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = {
                let tokens_token_stream = {
                    ...
                    let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream =  postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        &tokens_upper_camel_case,
                        &proc_macro2::TokenStream::new(),
                        &{
                ...
                let create_token_stream = {
                    ...
                    let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_to_create_token_stream =  postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        &tokens_create_upper_camel_case,
                        &proc_macro2::TokenStream::new(),
                        &{
                            let value = match &postgresql_json_type {
                ...
                let read_token_stream = {
                    ...
                    let maybe_impl_try_new_for_postgresql_json_type_tokens_read_token_stream = {
                        ...
                        let generate_impl_try_new_for_postgresql_json_type_tokens_read_token_stream = |
                        ...
                        match &postgresql_json_type {
                            ...
                            PostgresqlJsonType::StdVecVecObjectWithId => generate_impl_try_new_for_postgresql_json_type_tokens_read_token_stream(
                            ...
                            PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => generate_impl_try_new_for_postgresql_json_type_tokens_read_token_stream(
                                &quote::quote!{std::option::Option<std::vec::Vec<#ident_read_with_id_upper_camel_case>>},
                                &{
                                    let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&format!("not unique {id_snake_case} {{}}"));
                                    //todo its duplicate -remove it
                                    let postgresql_json_type_tokens_read_try_new_error_named_upper_camel_case: &dyn quote::ToTokens = match &postgresql_json_type {
                    ...
                    let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_tokens_read_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        &tokens_read_upper_camel_case,
                        &proc_macro2::TokenStream::new(),
                        &{
                            let value = match &postgresql_json_type {
                    ...
                    let tokens_select_token_stream = generate_tokens_select_token_stream(&match &postgresql_json_type {
                        //todo why its two different types?
                        PostgresqlJsonType::Object => PostgresqlJsonTypeSelect::ObjectIdent,
                        PostgresqlJsonType::StdOptionOptionObject => PostgresqlJsonTypeSelect::StdOptionOptionObjectIdent,
                        PostgresqlJsonType::StdVecVecObjectWithId => PostgresqlJsonTypeSelect::StdVecVecObjectWithIdIdent,
                        PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => PostgresqlJsonTypeSelect::StdOptionOptionStdVecVecObjectWithIdIdent,
                    });
                    let impl_serde_deserialize_for_postgresql_json_type_tokens_read_token_stream = match &postgresql_json_type {
                        ...
                        PostgresqlJsonType::StdVecVecObjectWithId => {
                            ...
                            let postgresql_json_type_std_vec_vec_object_with_id_ident_read_upper_camel_case_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(
                                &tokens_read_upper_camel_case
                            );
                            let match_try_new_in_deserialize_token_stream = generate_match_try_new_in_deserialize_token_stream(
                                &tokens_read_upper_camel_case,
                        ...
                        PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => {
                            ...
                            let postgresql_json_type_std_option_option_std_vec_vec_object_with_id_ident_read_upper_camel_case_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(
                                &tokens_read_upper_camel_case
                            );
                            let match_try_new_in_deserialize_token_stream = generate_match_try_new_in_deserialize_token_stream(
                                &tokens_read_upper_camel_case,
                    ...
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        ...
                        &{
                            let value = match &postgresql_json_type {
                                ...
                                PostgresqlJsonType::Object |
                                PostgresqlJsonType::StdOptionOptionObject => quote::quote!{(#postgresql_crud_all_enum_variants_array_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)},
                                PostgresqlJsonType::StdVecVecObjectWithId |
                    ...
                    let impl_serde_deserialize_for_postgresql_json_type_tokens_select_token_stream = {
                        ...
                        match &postgresql_json_type {
                            ...
                            PostgresqlJsonType::StdOptionOptionObject => {
                                ...
                                let tuple_struct_postgresql_json_type_std_option_option_object_ident_select_with_1_element_double_quotes_token_stream = generate_tuple_struct_tokens_with_1_element_double_quotes_token_stream(&postgresql_json_type_std_option_option_object_ident_select_upper_camel_case);
                                let postgresql_json_type_std_option_option_object_ident_select_upper_camel_case_double_quotes_token_stream = generate_quotes::double_quotes_token_stream(
                ...
                let update_token_stream = {
                    ...
                    let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_postgresql_json_type_tokens_option_to_update_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                        ...
                        &{
                            let value = match &postgresql_json_type {
                                PostgresqlJsonType::Object |
                                PostgresqlJsonType::StdVecVecObjectWithId => quote::quote!{(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream)},
                                PostgresqlJsonType::StdOptionOptionObject |
                                PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => quote::quote!{(Some(#postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_call_token_stream))},
                            };
                            quote::quote!{Self #value}
                        }
                    );
                ...
                let postgresql_json_type_token_stream = postgresql_crud_macros_common::generate_postgresql_json_type_token_stream(
                    ...
                    &{
                        ...
                        let maybe_pagination_start_end_initialization_token_stream = match &postgresql_json_type {
                            ...
                            PostgresqlJsonType::StdOptionOptionObject => proc_macro2::TokenStream::new(),
                            PostgresqlJsonType::StdVecVecObjectWithId |
                            PostgresqlJsonType::StdOptionOptionStdVecVecObjectWithId => macros_helpers::pagination_start_end_initialization_token_stream::pagination_start_end_initialization_token_stream(&naming::SelectSnakeCase)
                        };
            ...
            let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = {
                ...
                let generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = |postgresql_type: PostgresqlType|{
                    ...
                    let tokens_as_type_create_token_stream = {
                        ...
                        let impl_postgresql_crud_bind_query_for_tokens_as_type_create_token_stream = {
                            let try_generate_bind_increments_content_for_tokens_as_type_create_token_stream = {
                            ...
                            let bind_value_to_query_content_for_tokens_as_type_create_token_stream = {
                                let query_snake_case = naming::QuerySnakeCase;
                            ...
                            quote::quote!{
                                impl postgresql_crud::BindQuery for #tokens_as_type_create_upper_camel_case {
                                    fn try_generate_bind_increments(&self, increment: &mut std::primitive::u64) -> Result<std::string::String, postgresql_crud::QueryPartErrorNamed> {
                                        #try_generate_bind_increments_content_for_tokens_as_type_create_token_stream
                                    }
                                    fn bind_value_to_query(self, mut query: sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'_, sqlx::Postgres, sqlx::postgres::PgArguments> {
                                        #bind_value_to_query_content_for_tokens_as_type_create_token_stream
                                    }
                                }
                            }
                        };
                        ...
                        quote::quote!{
                            ...
                            #impl_postgresql_crud_bind_query_for_tokens_as_type_create_token_stream
                    ...
                    let tokens_as_type_select_token_stream = {
                        ...
                        let impl_sqlx_type_sqlx_postgres_for_tokens_as_type_select_token_stream = {
                            let content_token_stream = match &postgresql_type {
                                PostgresqlType::JsonbNotNull => quote::quote!{<sqlx::types::Json<#tokens_select_upper_camel_case> as sqlx::Type<sqlx::Postgres>>::type_info()},
                                PostgresqlType::JsonbNullable => quote::quote!{<std::option::Option<sqlx::types::Json<#tokens_select_upper_camel_case>> as sqlx::Type<sqlx::Postgres>>::type_info()},
                            };
                            quote::quote!{
                    ...
                    let tokens_as_type_where_element_token_stream = {
                        ...
                        quote::quote!{
                            ...
                            #impl_postgresql_crud_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_tokens_as_type_where_element_token_stream
                    ...
                    let tokens_as_type_read_token_stream = {
                        ...
                        let impl_sqlx_type_sqlx_postgres_for_tokens_as_type_read_token_stream = {
                            let content_token_stream = match &postgresql_type {
                                PostgresqlType::JsonbNullable
                                => quote::quote!{<std::option::Option<sqlx::types::Json<#tokens_read_upper_camel_case>> as sqlx::Type<sqlx::Postgres>>::type_info()},

                                PostgresqlType::JsonbNotNull
                                => quote::quote!{<sqlx::types::Json<#tokens_read_upper_camel_case> as sqlx::Type<sqlx::Postgres>>::type_info()},
                            };
                            quote::quote!{
                                impl sqlx::Type<sqlx::Postgres> for #tokens_as_type_read_upper_camel_case {
                                    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
                                        #content_token_stream
                                    }
                                }
                    ...
                    let tokens_as_type_update_token_stream = {
                        ...
                        let impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_as_type_update_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_but_option_is_always_some_and_vec_always_contains_one_element_for_tokens_token_stream(
                    ...
                    let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_as_type_token_stream = {
                        ...
                        quote::quote!{
                            impl postgresql_crud::postgresql_type_trait::#postgresql_type_upper_camel_case for #tokens_as_type_upper_camel_case {
                                ...
                                type #update_query_part_error_named_upper_camel_case = #tokens_as_type_update_query_part_error_named_upper_camel_case;
                                #update_query_part_token_stream
                                #update_query_bind_token_stream
                            }
                        }
