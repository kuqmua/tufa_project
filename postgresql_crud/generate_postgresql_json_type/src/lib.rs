            ...
            let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = {
                ...
                let generate_postgresql_json_types_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = |postgresql_type: PostgresqlType|{
                    ...
                    let tokens_read_token_stream = {
                        ...
                        let impl_sqlx_type_sqlx_postgres_for_tokens_read_token_stream = {
                            let type_info_content_for_tokens_to_read_token_stream = match &postgresql_type {
                                PostgresqlType::JsonbNullable
                            ...
                            quote::quote!{
                                impl sqlx::Type<sqlx::Postgres> for #tokens_as_type_read_upper_camel_case {
                                    fn type_info() -> <sqlx::Postgres as sqlx::Database>::TypeInfo {
                                        #type_info_content_for_tokens_to_read_token_stream
                                    }
                                }
                            }
                        };
                        let impl_sqlx_decode_sqlx_postgres_for_tokens_read_token_stream = {
                            let decode_content_for_tokens_read_token_stream = match &postgresql_type {
                                PostgresqlType::JsonbNullable
                                => quote::quote!{
                            ...
                            quote::quote!{
                                impl sqlx::Decode<'_, sqlx::Postgres> for #tokens_as_type_read_upper_camel_case {
                                    fn decode(value: sqlx::postgres::PgValueRef<'_>) -> Result<Self, sqlx::error::BoxDynError> {
                                        #decode_content_for_tokens_read_token_stream
                                    }
                                }
                            }
                        };
                        quote::quote!{
                            ...
                            #impl_sqlx_type_sqlx_postgres_for_tokens_read_token_stream
                    ...
                    let tokens_update_upper_camel_case_token_stream = generate_tokens_update_upper_camel_case_token_stream(postgresql_json_type);
                    let tokens_update_token_stream = {
                        let tokens_update_token_stream = {
                            let pub_struct_tokens_update_declaration_token_stream = {
                                match &postgresql_type {
                                    PostgresqlType::JsonbNotNull => quote::quote!{(#tokens_update_upper_camel_case_token_stream);},
                                    PostgresqlType::JsonbNullable => quote::quote!{(std::option::Option<#tokens_update_upper_camel_case_token_stream>);},
                                }
                            };
                            quote::quote!{
                                #[derive(
                                ...
                                match &postgresql_type {
                                    ...
                                    PostgresqlType::JsonbNullable => quote::quote!{
                                        query = match #value_snake_case.0 {
                                            ...
                                            None => {
                                                #query_snake_case.bind(sqlx::types::Json(None::<std::option::Option<#tokens_update_upper_camel_case_token_stream>>))
                                            }
                                        };
                                        query
                                    },
