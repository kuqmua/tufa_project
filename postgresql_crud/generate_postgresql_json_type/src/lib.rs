...
pub fn generate_postgresql_json_type(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let postgresql_crud_try_generate_to_create_error_named_token_stream = {
        let try_generate_to_create_error_named_upper_camel_case = naming::TryGenerateToCreateErrorNamedUpperCamelCase;
        quote::quote!{#postgresql_crud_path_token_stream #try_generate_to_create_error_named_upper_camel_case}
    };
    ...
    |{
        quote::quote!{
            impl #struct_ident_token_stream {
                fn #try_generate_postgresql_json_type_to_create_snake_case(&self, #increment_snake_case: &mut std::primitive::u64) -> Result<std::string::String, #postgresql_crud_try_generate_to_create_error_named_token_stream> {
                ...
                let ident_json_array_change_try_generate_postgresql_json_type_error_named_token_stream = generate_tokens_try_generate_postgresql_json_type_error_named_token_stream(
                    ...
                    &{
                        ...
                        quote::quote!{
                            ...
                            Create {
                                #[eo_error_occurence]
                                error: #postgresql_crud_try_generate_to_create_error_named_token_stream,
                                code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
                            },
                            #(#variants_token_stream),*
                        }
        ...
        let generate_postgresql_type_traits_token_stream = |postgresql_json_type: &PostgresqlJsonType, need_to_generate_postgresql_crud_logic: bool|{
            ...
            let impl_postgresql_crud_postgresql_json_type_for_tokens_ident_token_stream = {
                    ...
                    let postgresql_json_type_tokens_where_element_token_stream = {
                        ...
                        let impl_postgresql_crud_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_json_type_tokens_where_element_token_stream = {
                            let postgresql_type_self_where_try_generate_bind_increments_variants_token_stream = vec_syn_field.iter().map(|element| {
                                ...
                                quote::quote!{
                                    Self::#field_ident_upper_camel_case_token_stream(value) => postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::self_where_try_generate_bind_increments(
                                        value,
                                        increment,
                                        &format!(#format_handle_token_stream),
                            ...
                            let postgresql_type_self_where_bind_value_to_query_variants_token_stream = vec_syn_field.iter().map(|element| {
                                ...
                                let field_ident_upper_camel_case_token_stream = naming::AsRefStrToUpperCamelCaseTokenStream::case_or_panic(&field_ident_stringified);
                                quote::quote!{
                                    Self::#field_ident_upper_camel_case_token_stream(value) => postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::self_where_bind_value_to_query(value, query)
                                }
                            });
                            quote::quote!{
                                impl postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter for #postgresql_json_type_tokens_where_element_upper_camel_case {
                                    fn self_where_try_generate_bind_increments(&self, increment: &mut std::primitive::u64, column: &dyn std::fmt::Display, is_need_to_add_logical_operator: std::primitive::bool) -> Result<std::string::String, postgresql_crud::TryGenerateBindIncrementsErrorNamed> {
                                        match &self {
                        ...
                        let impl_postgresql_crud_postgresql_type_postgresql_type_trait_postgresql_type_self_where_filter_for_postgresql_json_type_tokens_where_token_stream = {
                            quote::quote!{
                                impl postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter for #postgresql_json_type_tokens_where_upper_camel_case {
                                    ...
                                    fn self_where_bind_value_to_query<'a>(self, mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments> {
                                        for element in self.value {
                                            query = postgresql_crud::postgresql_type::postgresql_type_trait::PostgresqlTypeSelfWhereFilter::self_where_bind_value_to_query(element, query);
                                        }
                                        query
                                    }
                                }
                ...
                let postgresql_json_type_token_stream = postgresql_crud_macros_common::generate_postgresql_json_type_token_stream(
                    ...
                    &postgresql_json_type_tokens_to_create_upper_camel_case,
                    &match &postgresql_json_type {
                        PostgresqlJsonType::Object => quote::quote!{#self_to_create_snake_case.0.#try_generate_postgresql_json_type_to_create_snake_case(#increment_snake_case)},
                        PostgresqlJsonType::StdOptionOptionObject => quote::quote!{
                            match &#self_to_create_snake_case.0 {
                        ...
                        PostgresqlJsonType::StdVecVecObjectWithId => quote::quote!{
                            let mut acc = std::string::String::default();
                            for element in &#self_to_create_snake_case.0 {
                                match element.#try_generate_postgresql_json_type_to_create_snake_case(#increment_snake_case) {
                                    Ok(value) => {
                                        acc.push_str(&format!("{value},"));
                                    },
                    ...
                    &match &postgresql_json_type {
                        PostgresqlJsonType::Object => quote::quote!{#self_to_create_snake_case.0.#bind_value_to_postgresql_query_part_to_create_snake_case(#query_snake_case)},
                        PostgresqlJsonType::StdOptionOptionObject => quote::quote!{
                            if let Some(value) = #self_to_create_snake_case.0 {
                    ...
                    let postgresql_type_self_to_update_query_part_token_stream = {
                        ...
                        let postgresql_type_self_to_update_query_part_content_token_stream = {
                            ...
                            match &postgresql_type {
                                PostgresqlType::JsonbNullable => {
                                    ...
                                    quote::quote!{
                                        match &#self_to_update_snake_case.0 {
                        ...
                        quote::quote!{
                            fn #self_to_update_query_part_snake_case(
                                ...
                                #jsonb_set_path_snake_case: &std::primitive::str,
                                #increment_snake_case: &mut std::primitive::u64
                            ) -> Result<std::string::String, Self::#self_to_update_query_part_error_named_upper_camel_case> {
                        ...
                        let self_to_update_bind_query_part_content_token_stream = {
                            ...
                            match &postgresql_type {
                                PostgresqlType::JsonbNullable => {
                                    ...
                                    quote::quote!{
                                        query = match #self_to_update_snake_case.0 {
                    ...
                    let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_for_tokens_token_stream = {
                        ...
                        quote::quote!{
                            impl postgresql_crud::postgresql_type::postgresql_type_trait::#postgresql_type_upper_camel_case<'_> for #tokens_as_postgresql_postfix_type_upper_camel_case {
                                ...
                                type #self_column_upper_camel_case = #postgresql_type_tokens_column_upper_camel_case;
