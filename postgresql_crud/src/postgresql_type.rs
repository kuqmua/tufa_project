...
impl SqlxPostgresTypesPgRangeStdPrimitiveI32 {
    pub fn try_new(value: sqlx::postgres::types::PgRange<std::primitive::i32>) -> Result<Self, SqlxPostgresTypesPgRangeStdPrimitiveI32TryNewErrorNamed> {
        match (&value.start, &value.end) {
            ...
            (std::ops::Bound::Included(_), std::ops::Bound::Unbounded) => (),
            ...
            (std::ops::Bound::Unbounded, std::ops::Bound::Excluded(_)) => (),
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, thiserror::Error, error_occurence_lib::ErrorOccurence, schemars::JsonSchema)]
pub enum SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed {
    IncludedStartMoreThanIncludedEnd {
        #[eo_to_std_string_string_serialize_deserialize]
    ...
    IncludedEndCannotBeStdPrimitiveI64Max {
        #[eo_to_std_string_string_serialize_deserialize]
        end: std::primitive::i64,
        code_occurence: error_occurence_lib::code_occurence::CodeOccurence,
    },
...
impl SqlxPostgresTypesPgRangeStdPrimitiveI64 {
    pub fn try_new(value: sqlx::postgres::types::PgRange<std::primitive::i64>) -> Result<Self, SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed> {
        match (&value.start, &value.end) {
            (std::ops::Bound::Included(start), std::ops::Bound::Included(end)) => {
                if start > end {
                    return Err(SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed::IncludedStartMoreThanIncludedEnd {
                        start: *start,
                        end: *end,
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
                }
                if *end == std::primitive::i64::MAX {
                    return Err(SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed::IncludedEndCannotBeStdPrimitiveI64Max {
                        end: *end,
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
                }
            ...
            (std::ops::Bound::Included(start), std::ops::Bound::Excluded(end)) => {
                if start > end {
                    return Err(SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed::IncludedStartMoreThanExcludedEnd {
                        start: *start,
                        end: *end,
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
            ...
            (std::ops::Bound::Excluded(start), std::ops::Bound::Included(end)) => {
                if start > end {
                    return Err(SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed::ExcludedStartMoreThanIncludedEnd {
                        start: *start,
                        end: *end,
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
            ...
            (std::ops::Bound::Excluded(start), std::ops::Bound::Excluded(end)) => {
                if start > end {
                    return Err(SqlxPostgresTypesPgRangeStdPrimitiveI64TryNewErrorNamed::ExcludedStartMoreThanExcludedEnd {
                        start: *start,
                        end: *end,
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
    ...
    pub fn get(&self) -> &sqlx::postgres::types::PgRange<std::primitive::i64> {
        &self.0
    }
}
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl _serde::Serialize for SqlxPostgresTypesPgRangeStdPrimitiveI64 {
        fn serialize<__S>(
            &self,
            __serializer: __S,
        ) -> _serde::__private::Result<__S::Ok, __S::Error>
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'de> _serde::Deserialize<'de> for SqlxPostgresTypesPgRangeStdPrimitiveI64 {
        fn deserialize<__D>(
            __deserializer: __D,
        ) -> _serde::__private::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                fn expecting(
                    ...
                    _serde::__private::Formatter::write_str(
                        __formatter,
                        "struct SqlxPostgresTypesPgRangeStdPrimitiveI64",
                    )
                }
                #[inline]
                fn visit_seq<__A>(
                ...
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<
                        std::ops::Bound<std::primitive::i64>,
                    >(&mut __seq)? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
                            return _serde::__private::Err(
                                _serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct SqlxPostgresTypesPgRangeStdPrimitiveI64 with 2 elements",
                                ),
                            );
                        }
                    };
                    ...
                    match SqlxPostgresTypesPgRangeStdPrimitiveI64::try_new(sqlx::postgres::types::PgRange {
                        start: __field0,
                        end: __field1
                    }) {
                        Ok(value) => _serde::__private::Ok(value),
...
impl std::convert::Into<sqlx::postgres::types::PgRange<std::primitive::i64>> for SqlxPostgresTypesPgRangeStdPrimitiveI64 {
    fn into(self) -> sqlx::postgres::types::PgRange<std::primitive::i64> {
        self.0
    }
}
impl error_occurence_lib::ToStdStringString for SqlxPostgresTypesPgRangeStdPrimitiveI64 {
    fn to_std_string_string(&self) -> std::string::String {
        self.0.to_string()
    }
}
impl crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for SqlxPostgresTypesPgRangeStdPrimitiveI64 {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self(sqlx::postgres::types::PgRange {
            start: std::ops::Bound::Included(0),
            end: std::ops::Bound::Excluded(10),
...
impl sqlx::postgres::PgHasArrayType for SqlxPostgresTypesPgRangeStdPrimitiveI64 {
    fn array_type_info() -> sqlx::postgres::PgTypeInfo {
