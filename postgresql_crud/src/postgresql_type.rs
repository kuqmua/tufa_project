...
pub enum SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOriginTryNewErrorNamed {
    DateNaive {
        #[eo_error_occurence]
...
impl SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOrigin {
    //here
    pub fn try_new(value: sqlx::types::chrono::DateTime<sqlx::types::chrono::Utc>) -> Result<Self, SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOriginTryNewErrorNamed> {
        let date_naive = match SqlxTypesChronoNaiveDateAsNotNullDateOrigin::try_new(value.date_naive()) {
            Ok(value) => value,
            Err(error) => {
                return Err(SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOriginTryNewErrorNamed::DateNaive {
                    error,
                    code_occurence: error_occurence_lib::code_occurence!(),
                });
            }
        ...
        let time = match SqlxTypesChronoNaiveTimeAsNotNullTimeOrigin::try_new(value.time()) {
            Ok(value) => value,
            Err(error) => {
                return Err(SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOriginTryNewErrorNamed::Time {
                    error,
                    code_occurence: error_occurence_lib::code_occurence!(),
                });
            }
    ...
    fn new_for_deserialize(date_naive: SqlxTypesChronoNaiveDateAsNotNullDateOrigin, time: SqlxTypesChronoNaiveTimeAsNotNullTimeOrigin) -> Self {
        Self(sqlx::types::chrono::DateTime::<sqlx::types::chrono::Utc>::from_naive_utc_and_offset(sqlx::types::chrono::NaiveDateTime::new(date_naive.0, time.0), sqlx::types::chrono::Utc))
    }
...
impl SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzRead {
    pub fn try_new(value: sqlx::types::chrono::DateTime<sqlx::types::chrono::Utc>) -> Result<Self, SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOriginTryNewErrorNamed> {
        match SqlxTypesChronoDateTimeSqlxTypesChronoUtcAsNotNullTimestampTzOrigin::try_new(value) {
            Ok(value) => Ok(Self(value)),
            Err(error) => Err(error)
        }
    }
    ...
    fn test_cases() -> std::vec::Vec<<Self::Element as crate::PostgresqlType>::ReadInner> {
        vec![
            sqlx::types::chrono::DateTime::<sqlx::types::chrono::Utc>::from_naive_utc_and_offset(
                sqlx::types::chrono::NaiveDateTime::new(sqlx::types::chrono::NaiveDate::from_ymd_opt(-4712, 12, 31).unwrap(), sqlx::types::chrono::NaiveTime::from_hms_micro_opt(0, 0, 0, 0).unwrap()),
                sqlx::types::chrono::Utc,
            ),
            sqlx::types::chrono::DateTime::<sqlx::types::chrono::Utc>::from_naive_utc_and_offset(
            ...
            // sqlx::types::chrono::DateTime::<sqlx::types::chrono::Utc>::from_naive_utc_and_offset(
            //     sqlx::types::chrono::NaiveDateTime::new(sqlx::types::chrono::NaiveDate::MAX, sqlx::types::chrono::NaiveTime::from_hms_nano_opt(23, 59, 59, 999_999_999).unwrap()),
            //     sqlx::types::chrono::Utc,
            // ),
        ]
    }
