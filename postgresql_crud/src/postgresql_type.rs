...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, thiserror::Error, error_occurence_lib::ErrorOccurence, schemars::JsonSchema)]
pub enum SqlxTypesTimeTimeAsNotNullTimeOriginTryNewFromDeserializeErrorNamed {
...
impl SqlxTypesTimeTimeAsNotNullTimeOrigin {
    ...
    fn try_new_from_deserialize(
        hour: std::primitive::u8,
        minute: std::primitive::u8,
        second: std::primitive::u8,
        microsecond: std::primitive::u32
    ) -> Result<Self, SqlxTypesTimeTimeAsNotNullTimeOriginTryNewFromDeserializeErrorNamed> {
        match sqlx::types::time::Time::from_hms_micro(
            ...
            Err(error) => Err(SqlxTypesTimeTimeAsNotNullTimeOriginTryNewFromDeserializeErrorNamed::InvalidHourOrMinuteOrSecondOrMicrosecond {
                hour,
                minute,
                second,
                microsecond,
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    match SqlxTypesTimeTimeAsNotNullTimeOrigin::try_new_from_deserialize(__field0, __field1, __field2, __field3) {
                        Ok(value) => _serde::__private::Ok(value),
                        Err(error) => Err(_serde::de::Error::custom(format!("{error:?}"))),
                    }
                }
...
impl crate::tests::PostgresqlTypeTestCases for SqlxTypesTimeTimeAsNotNullTime {
    ...
    fn test_cases() -> std::vec::Vec<<Self::Element as crate::PostgresqlType>::ReadInner> {
        vec![
            sqlx::types::time::Time::from_hms_micro(
                0,
                0,
                0,
                0,
