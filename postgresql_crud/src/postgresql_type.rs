...
pub enum SqlxTypesTimeTimeAsNotNullTimeOriginTryNewErrorNamed {
...
#[derive(Debug, serde :: Serialize, serde :: Deserialize, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum SqlxTypesTimeTimeAsNotNullTimeOriginTryNewForDeserializeErrorNamed {
...
impl SqlxTypesTimeTimeAsNotNullTimeOrigin {
    pub fn try_new(value: sqlx::types::time::Time) -> Result<Self, SqlxTypesTimeTimeAsNotNullTimeOriginTryNewErrorNamed> {
        if value.nanosecond() % 1000 != 0 {
            return Err(SqlxTypesTimeTimeAsNotNullTimeOriginTryNewErrorNamed::NanosecondPrecisionIsNotSupported {
    ...
    fn try_new_for_deserialize(hour: std::primitive::u8, minute: std::primitive::u8, second: std::primitive::u8, microsecond: std::primitive::u32) -> Result<Self, SqlxTypesTimeTimeAsNotNullTimeOriginTryNewForDeserializeErrorNamed> {
        match sqlx::types::time::Time::from_hms_micro(hour, minute, second, microsecond) {
            Ok(value) => {
                //todo
                if value.nanosecond() % 1000 != 0 {
                    return Err(SqlxTypesTimeTimeAsNotNullTimeOriginTryNewForDeserializeErrorNamed::NanosecondPrecisionIsNotSupported {
                        value: value.to_string(),
                        code_occurence: error_occurence_lib::code_occurence!(),
                    });
                }
            ...
            Err(error) => Err(SqlxTypesTimeTimeAsNotNullTimeOriginTryNewForDeserializeErrorNamed::InvalidHourOrMinuteOrSecondOrMicrosecond {
                hour,
                minute,
                second,
                microsecond,
...
const _: () = {
    ...
    impl _serde::Serialize for SqlxTypesTimeTimeAsNotNullTimeOrigin {
        ...
        where
            __S: _serde::Serializer,
        {
            let mut __serde_state = _serde::Serializer::serialize_struct(__serializer, "SqlxTypesTimeTimeAsNotNullTimeOrigin", false as usize + 1 + 1 + 1 + 1)?;
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "hour", &self.0.hour())?;
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "minute", &self.0.minute())?;
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "second", &self.0.second())?;
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "microsecond", &self.0.microsecond())?;
            _serde::ser::SerializeStruct::end(__serde_state)
        }
    }
};
    ...
    impl<'de> _serde::Deserialize<'de> for SqlxTypesTimeTimeAsNotNullTimeOrigin {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                fn expecting(&self, __formatter: &mut _serde::__private::Formatter<'_>) -> _serde::__private::fmt::Result {
                    _serde::__private::Formatter::write_str(__formatter, "struct SqlxTypesTimeTimeAsNotNullTimeOrigin")
                }
                #[inline]
                ...
                where
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<std::primitive::u8>(&mut __seq)? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
                            return _serde::__private::Err(_serde::de::Error::invalid_length(0usize, &"struct SqlxTypesTimeTimeAsNotNullTimeOrigin with 4 elements"));
                        }
                    };
                    let __field1 = match _serde::de::SeqAccess::next_element::<std::primitive::u8>(&mut __seq)? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
                            return _serde::__private::Err(_serde::de::Error::invalid_length(1usize, &"struct SqlxTypesTimeTimeAsNotNullTimeOrigin with 4 elements"));
                        }
                    };
                    let __field2 = match _serde::de::SeqAccess::next_element::<std::primitive::u8>(&mut __seq)? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
                            return _serde::__private::Err(_serde::de::Error::invalid_length(2usize, &"struct SqlxTypesTimeTimeAsNotNullTimeOrigin with 4 elements"));
                        }
                    };
                    let __field3 = match _serde::de::SeqAccess::next_element::<std::primitive::u32>(&mut __seq)? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
                            return _serde::__private::Err(_serde::de::Error::invalid_length(3usize, &"struct SqlxTypesTimeTimeAsNotNullTimeOrigin with 4 elements"));
                        }
                    };
                    ...
                    while let _serde::__private::Some(__key) = _serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                        match __key {
                            __Field::__field0 => {
                                ...
                                __field0 = _serde::__private::Some(_serde::de::MapAccess::next_value::<std::primitive::u8>(&mut __map)?);
                            }
                            __Field::__field1 => {
                                if _serde::__private::Option::is_some(&__field1) {
                                    return _serde::__private::Err(<__A::Error as _serde::de::Error>::duplicate_field("minute"));
                                }
                                __field1 = _serde::__private::Some(_serde::de::MapAccess::next_value::<std::primitive::u8>(&mut __map)?);
                            }
                            __Field::__field2 => {
                                if _serde::__private::Option::is_some(&__field2) {
                                    return _serde::__private::Err(<__A::Error as _serde::de::Error>::duplicate_field("second"));
                                }
                                __field2 = _serde::__private::Some(_serde::de::MapAccess::next_value::<std::primitive::u8>(&mut __map)?);
                            }
                            __Field::__field3 => {
...
impl crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for SqlxTypesTimeTimeAsNotNullTimeOrigin {
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self(sqlx::types::time::Time::from_hms_micro(0, 0, 0, 0).unwrap())
    }
}
...
impl SqlxTypesTimeTimeAsNotNullTimeRead {
    //here
    pub fn try_new(value: sqlx::types::time::Time) -> Result<Self, SqlxTypesTimeTimeAsNotNullTimeOriginTryNewErrorNamed> {
        match SqlxTypesTimeTimeAsNotNullTimeOrigin::try_new(value) {
            Ok(value) => Ok(Self(value)),
            Err(error) => Err(error)
        }
    }
...
impl crate::tests::PostgresqlTypeTestCases for SqlxTypesTimeTimeAsNotNullTime {
    type Element = Self;
    fn test_cases() -> std::vec::Vec<<Self::Element as crate::PostgresqlType>::ReadInner> {
        vec![
            sqlx::types::time::Time::from_hms_micro(0, 0, 0, 0).unwrap(),
            sqlx::types::time::Time::from_hms_micro(23, 59, 59, 999_999).unwrap(),
