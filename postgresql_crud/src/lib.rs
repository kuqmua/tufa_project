...
pub trait PostgresqlType {
    ...
    fn select_query_part(value: &Self::Select, column: &std::primitive::str)
    -> std::string::String;
    type WhereElement: std::fmt::Debug
        ...
        + serde::Serialize
        + for<'__> serde::Deserialize<'__>
        + for<'a> crate::PostgresqlTypeWhereFilter<'a>;
    ...
    type ReadOnlyIds: std::fmt::Debug
        + Clone
        + PartialEq
        + serde::Serialize
        + for<'__> serde::Deserialize<'__>;
...
impl<T> crate::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
...
pub struct ObjectWithIdAsNotNullJsonbObjectWithIdUpdateElement<T: PostgresqlJsonType> {
    pub id:
        <crate::postgresql_json_type::UuidUuidAsNotNullJsonbString as PostgresqlJsonType>::Update,
    pub fields: <T as PostgresqlJsonType>::Update,
}
impl<T: PostgresqlJsonType> DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
    for ObjectWithIdAsNotNullJsonbObjectWithIdUpdateElement<T>
{
...
pub trait GeneratePostgresqlJsonObjectTypeToRead {
    fn generate_postgresql_json_object_type_to_read_from_vec(
        value: &[Self],
        column_name_and_maybe_field_getter: &std::primitive::str,
        column_name_and_maybe_field_getter_for_error_message: &std::primitive::str,
    ) -> std::string::String
...
pub fn wrap_into_jsonb_build_object(
...
#[derive(
    Debug, Clone, Copy, serde::Serialize, serde::Deserialize, Eq, PartialEq, schemars::JsonSchema,
)]
...
#[derive(
    Debug, Clone, Copy, serde::Serialize, serde::Deserialize, PartialEq, Eq, from_str::FromStr,
)]
pub enum Order {
...
impl<'de> serde::Deserialize<'de> for PaginationStartsWithZero {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            {
                let __field0 =
                    match serde::de::SeqAccess::next_element::<std::primitive::i64>(&mut __seq)? {
            ...
            {
                let mut __field0: serde::__private::Option<std::primitive::i64> =
                    serde::__private::None;
                let mut __field1: serde::__private::Option<std::primitive::i64> =
                    serde::__private::None;
...
impl crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
...
impl<PostgresqlTypeWhereElement: std::cmp::PartialEq + Clone>
    PostgresqlTypeWhere<PostgresqlTypeWhereElement>
{
    pub fn try_new(
        logical_operator: crate::LogicalOperator,
        value: std::vec::Vec<PostgresqlTypeWhereElement>,
    ) -> Result<Self, PostgresqlTypeWhereTryNewErrorNamed<PostgresqlTypeWhereElement>> {
        if value.is_empty() {
...
const _: () = {
    ...
    impl<
        'de,
        PostgresqlTypeWhereElement: std::fmt::Debug + std::cmp::PartialEq + std::clone::Clone + _serde::Deserialize<'de>,
    > _serde::Deserialize<'de> for PostgresqlTypeWhere<PostgresqlTypeWhereElement>
    {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<
                'de,
                PostgresqlTypeWhereElement: std::fmt::Debug
                    + std::cmp::PartialEq
                    + std::clone::Clone
                    + _serde::Deserialize<'de>,
            > _serde::de::Visitor<'de> for __Visitor<'de, PostgresqlTypeWhereElement>
            {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    let __field1 = match _serde::de::SeqAccess::next_element::<
                        std::vec::Vec<PostgresqlTypeWhereElement>,
                    >(&mut __seq)?
                    {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
                ...
                {
                    let mut __field0: _serde::__private::Option<crate::LogicalOperator> =
                        _serde::__private::None;
...
impl<'a, PostgresqlTypeWhereElement: crate::PostgresqlTypeWhereFilter<'a>>
    crate::PostgresqlTypeWhereFilter<'a> for PostgresqlTypeWhere<PostgresqlTypeWhereElement>
{
    fn query_part(
        &self,
        increment: &mut std::primitive::u64,
        ...
        for element in &self.value {
            match crate::PostgresqlTypeWhereFilter::query_part(
                element,
                increment,
                column,
...
impl<
    PostgresqlTypeWhereElement: crate::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement,
> crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
...
const _: () = {
    ...
    impl<
        'de,
        T: std::fmt::Debug + std::cmp::PartialEq + std::clone::Clone + _serde::Deserialize<'de>,
    > _serde::Deserialize<'de> for NotEmptyUniqueEnumVec<T>
    {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            > _serde::de::Visitor<'de> for __Visitor<'de, T>
            {
                ...
                {
                    let __field0: std::vec::Vec<T> =
                        <std::vec::Vec<T> as _serde::Deserialize>::deserialize(__e)?;
                ...
                where
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<std::vec::Vec<T>>(
                        &mut __seq,
                    )? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
...
impl<T: crate::AllEnumVariantsArrayDefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>
    crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for NotEmptyUniqueEnumVec<T>
{
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
...
impl<T: std::cmp::PartialEq + Clone + serde::Serialize> PostgresqlJsonTypeNotEmptyUniqueVec<T> {
    ...
    pub fn query_bind_one_by_one<'a>(
        self,
        mut query: sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>,
    ) -> sqlx::query::Query<'a, sqlx::Postgres, sqlx::postgres::PgArguments>
    where
...
impl<T: crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement>
    crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                where
                    __E: _serde::Deserializer<'de>,
                {
                    let __field0: std::string::String =
                        <std::string::String as _serde::Deserialize>::deserialize(__e)?;
                ...
                where
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<std::string::String>(
                        &mut __seq,
                    )? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                where
                    __E: _serde::Deserializer<'de>,
                {
                    let __field0: std::primitive::i32 =
                        <std::primitive::i32 as _serde::Deserialize>::deserialize(__e)?;
                ...
                where
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<std::primitive::i32>(
                        &mut __seq,
                    )? {
                        _serde::__private::Some(__value) => __value,
                        _serde::__private::None => {
...
impl crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
    for UnsignedPartOfStdPrimitiveI32
{
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self(0)
    }
...
impl std::convert::TryFrom<std::primitive::i32> for NotZeroUnsignedPartOfStdPrimitiveI32 {
    ...
    fn try_from(value: std::primitive::i32) -> Result<Self, Self::Error> {
        if value >= 1 {
            ...
            Err(
                Self::Error::NotZeroUnsignedPartOfStdPrimitiveI32IsLessThanOne {
                    value: value,
                    code_occurence: error_occurence_lib::code_occurence!(),
                },
            )
...
impl<
    T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + std::cmp::PartialOrd,
> Between<T>
{
...
impl<
    T: crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
        + sqlx::Type<sqlx::Postgres>
        + for<'__> sqlx::Encode<'__, sqlx::Postgres>,
> crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement for Between<T>
{
    fn default_but_option_is_always_some_and_vec_always_contains_one_element() -> Self {
        Self {
...
impl<
    ...
    T: std::marker::Send
        ...
        + for<'__> sqlx::Encode<'__, sqlx::Postgres>
        + 'a,
> crate::PostgresqlTypeWhereFilter<'a> for Between<T>
{
    fn query_part(
        &self,
        increment: &mut std::primitive::u64,
...
impl<
    'a,
    T: sqlx::Type<sqlx::Postgres> + for<'__> sqlx::Encode<'__, sqlx::Postgres> + 'a,
    const LENGTH: std::primitive::usize,
> BoundedStdVecVec<T, LENGTH>
{
    ...
    pub fn postgresql_type_query_part(
        ...
        self.query_part(
            increment,
            column,
            _is_need_to_add_logical_operator,
...
impl<T, const LENGTH: std::primitive::usize> std::convert::TryFrom<std::vec::Vec<T>>
...
impl<
    T: Clone + crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement,
    const LENGTH: std::primitive::usize,
> crate::DefaultButOptionIsAlwaysSomeAndVecAlwaysContainsOneElement
    for BoundedStdVecVec<T, LENGTH>
{
...
pub fn generate_read_many_query_string(
    table: &std::primitive::str,
    select_string: std::string::String,
    where_string: std::string::String,
) -> std::string::String {
...
pub fn generate_update_many_query_string(
    ...
    format!(
        "update {table} set {elements} where {primary_key_field_name} in ({primary_keys}) returning {primary_key_field_name}"
    )
}
//todo additional parameter for columns_to_return instead of primary_key_field_name in "returning {primary_key_field_name}""
...
pub fn generate_delete_one_query_string(
    table: &std::primitive::str,
    primary_key_field_name: &std::primitive::str,
) -> std::string::String {
    format!(
...
impl<'de> serde::Deserialize<'de> for SqlxTypesTimeUtcOffset {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            {
                let __field0 =
                    match serde::de::SeqAccess::next_element::<std::primitive::i8>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(
                                0usize,
            ...
            where
                __A: serde::de::MapAccess<'de>,
            {
                let mut __field0: serde::__private::Option<std::primitive::i8> =
                    serde::__private::None;
                let mut __field1: serde::__private::Option<std::primitive::i8> =
                    serde::__private::None;
                let mut __field2: serde::__private::Option<std::primitive::i8> =
                    serde::__private::None;
                while let serde::__private::Some(__key) =
                    serde::de::MapAccess::next_key::<__Field>(&mut __map)?
                {
                    match __key {
                        ...
                        __Field::__field1 => {
                            if serde::__private::Option::is_some(&__field1) {
                                return serde::__private::Err(
                                    <__A::Error as serde::de::Error>::duplicate_field("minutes"),
                                );
                            }
                            __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<
                                std::primitive::i8,
                        ...
                        __Field::__field2 => {
                            if serde::__private::Option::is_some(&__field2) {
                                return serde::__private::Err(
                                    <__A::Error as serde::de::Error>::duplicate_field("seconds"),
                                );
                            }
...
impl<'de> serde::Deserialize<'de> for NumBigintBigInt {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            {
                let __field0 =
                    match serde::de::SeqAccess::next_element::<NumBigintSign>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(
                                0usize,
                ...
                __A: serde::de::MapAccess<'de>,
            {
                ...
                let mut __field1: serde::__private::Option<std::vec::Vec<std::primitive::u32>> =
                    serde::__private::None;
                while let serde::__private::Some(__key) =
                    serde::de::MapAccess::next_key::<__Field>(&mut __map)?
                {
...
impl<'de> serde::Deserialize<'de> for NumBigintSign {
        ...
        __D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
            ...
            {
                let __field0: std::string::String =
                    <std::string::String as serde::Deserialize>::deserialize(__e)?;
                serde::__private::Ok(NumBigintSign(match __field0.as_str() {
                    ...
                    _ => {
                        return Err(serde::de::Error::custom(
                            "unsupported value, supported: Minus, NoSign, Plus",
                        ));
                    }
                }))
            }
            ...
            {
                let __field0 =
                    match serde::de::SeqAccess::next_element::<std::string::String>(&mut __seq)? {
                        serde::__private::Some(__value) => __value,
                        serde::__private::None => {
                            return serde::__private::Err(serde::de::Error::invalid_length(
                                0usize,
