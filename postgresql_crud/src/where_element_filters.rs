...
//                         }
//                     };
//                     let __field1 = match _serde::de::SeqAccess::next_element::<regex::Regex>(&mut __seq)? {
//                         _serde::__private::Some(__value) => __value,
//                         _serde::__private::None => {
...
//                     let mut __field1: _serde::__private::Option<regex::Regex> = _serde::__private::None;
...
//                                 }
//                                 __field1 = _serde::__private::Some(_serde::de::MapAccess::next_value::<regex::Regex>(&mut __map)?);
//                             }
//                             _ => {
