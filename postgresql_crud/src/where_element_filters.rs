...
///////////////////////
impl<T: error_occurence_lib::ToStdStringString> std::fmt::Display for PostgresqlTypeWhereElementBetweenTryNewErrorNamed<T> {//here
...
impl<T> PostgresqlTypeWhereElementBetweenTryNewErrorNamed<T> {
    pub fn into_serialize_deserialize_version(self) -> PostgresqlTypeWhereElementBetweenTryNewErrorNamedWithSerializeDeserialize<T> {
        ...
        match self {
            Self::StartMoreOrEqualToEnd { start, end, code_occurence } => PostgresqlTypeWhereElementBetweenTryNewErrorNamedWithSerializeDeserialize::StartMoreOrEqualToEnd { start, end, code_occurence },
        }
    }
}
