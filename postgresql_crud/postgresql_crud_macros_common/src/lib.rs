...
pub fn generate_postgresql_type_where_element_token_stream_second(
    variants: &std::vec::Vec<
        PostgresqlJsonTypeFilter
        // &dyn crate::PostgresqlFilter
    >,
    ...
    let postgresql_type_tokens_where_element_token_stream = {
        let variants_token_stream = variants.iter().map(|element| {
            ...
            let option_type_token_stream: std::option::Option<proc_macro2::TokenStream> = match &element {
                ...
                crate::PostgresqlJsonTypeFilter::DimensionOneEqual {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionTwoEqual {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionThreeEqual {
                    ident,
                } => Some(ident.clone()),
                ...
                crate::PostgresqlJsonTypeFilter::DimensionOneGreaterThan {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionTwoGreaterThan {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionThreeGreaterThan {
                    ident,
                } => Some(ident.clone()),
                ...
                crate::PostgresqlJsonTypeFilter::DimensionOneIn {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionTwoIn {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionThreeIn {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionFourIn {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::RegularExpression => None,
                crate::PostgresqlJsonTypeFilter::DimensionOneRegularExpression => None,
                crate::PostgresqlJsonTypeFilter::DimensionTwoRegularExpression => None,
                crate::PostgresqlJsonTypeFilter::DimensionThreeRegularExpression => None,
                crate::PostgresqlJsonTypeFilter::DimensionFourRegularExpression => None,
                ...
                crate::PostgresqlJsonTypeFilter::DimensionOneAllElementsRegularExpression => None,
                ...
                crate::PostgresqlJsonTypeFilter::DimensionOneContainsAllElementsOfArray {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionTwoContainsAllElementsOfArray {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionThreeContainsAllElementsOfArray {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionFourContainsAllElementsOfArray {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionOneOverlapsWithArray {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionTwoOverlapsWithArray {
                    ident,
                } => Some(ident.clone()),
                crate::PostgresqlJsonTypeFilter::DimensionThreeOverlapsWithArray {
                    ident,
                } => Some(ident.clone()),
