...
pub fn generate_impl_postgresql_type_test_cases_for_ident_token_stream(
    ...
    read_only_ids_merged_with_create_into_postgresql_type_where_element_dimension_one_equal_token_stream: &dyn quote::ToTokens,
) -> proc_macro2::TokenStream {
    let postgresql_type_upper_camel_case = naming::PostgresqlTypeUpperCamelCase;
    ...
    let read_only_ids_merged_with_create_into_postgresql_type_where_element_dimension_one_equal_snake_case = naming::ReadOnlyIdsMergedWithCreateIntoPostgresqlTypeWhereElementDimensionOneEqualSnakeCase;
    quote::quote! {
        #cfg_token_stream
        impl #import_path::#postgresql_type_test_cases_upper_camel_case for #ident {
            ...
            fn #read_only_ids_merged_with_create_into_postgresql_type_where_element_dimension_one_equal_snake_case(
                #read_only_ids_snake_case: #self_postgresql_type_as_postgresql_type_token_stream::#read_only_ids_upper_camel_case,
                #create_snake_case: #self_postgresql_type_as_postgresql_type_token_stream::#create_upper_camel_case
