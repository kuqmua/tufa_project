    ...
    pub fn all_variants() -> std::vec::Vec<Self> {
        Self::into_array().into_iter().fold(vec![], |mut acc, postgresql_json_type_pattern| {
            match &postgresql_json_type_pattern {
                Self::Standart => {
                    acc.push(postgresql_json_type_pattern);
                },
                Self::ArrayDimension1 {..} => {
                    NotNullOrNullable::into_array().into_iter().for_each(|dimension1_not_null_or_nullable| {
                ...
                Self::ArrayDimension2 {..} => {
                    NotNullOrNullable::into_array().into_iter().for_each(|dimension1_not_null_or_nullable| {
                        NotNullOrNullable::into_array().into_iter().for_each(|dimension2_not_null_or_nullable| {
                ...
                Self::ArrayDimension3 {..} => {
                    NotNullOrNullable::into_array().into_iter().for_each(|dimension1_not_null_or_nullable| {
                        NotNullOrNullable::into_array().into_iter().for_each(|dimension2_not_null_or_nullable| {
                            NotNullOrNullable::into_array().into_iter().for_each(|dimension3_not_null_or_nullable| {
                ...
                Self::ArrayDimension4 {..} => {
                    NotNullOrNullable::into_array().into_iter().for_each(|dimension1_not_null_or_nullable| {
                        NotNullOrNullable::into_array().into_iter().for_each(|dimension2_not_null_or_nullable| {
                            NotNullOrNullable::into_array().into_iter().for_each(|dimension3_not_null_or_nullable| {
                                NotNullOrNullable::into_array().into_iter().for_each(|dimension4_not_null_or_nullable| {
...
impl ArrayDimensionSelectPattern{
    ...
    pub fn select_array<'a> (&'a self) -> std::vec::Vec<&'a NotNullOrNullable> {
        match &self {
            Self::ArrayDimension2{
                dimension1_not_null_or_nullable,
