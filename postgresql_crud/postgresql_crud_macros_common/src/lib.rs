...
pub fn generate_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal_token_stream(
    read_only_ids_token_stream: &dyn quote::ToTokens,
    create_token_stream: &dyn quote::ToTokens,
    where_element_token_stream: &dyn quote::ToTokens,
    content_token_stream: &dyn quote::ToTokens,
    ...
    quote::quote!{
        fn #read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal_snake_case(
            #read_only_ids_snake_case: #read_only_ids_token_stream,
            #create_snake_case: #create_token_stream
        ) -> std::option::Option<std::vec::Vec<#where_element_token_stream>> {
            #content_token_stream
        }
    }
}
pub fn generate_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal_token_stream(
    read_only_ids_token_stream: &dyn quote::ToTokens,
    create_token_stream: &dyn quote::ToTokens,
    where_element_token_stream: &dyn quote::ToTokens,
    content_token_stream: &dyn quote::ToTokens,
...
pub fn generate_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal_token_stream(
    read_only_ids_token_stream: &dyn quote::ToTokens,
    create_token_stream: &dyn quote::ToTokens,
    where_element_token_stream: &dyn quote::ToTokens,
    content_token_stream: &dyn quote::ToTokens,
...
pub fn generate_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal_token_stream(
    read_only_ids_token_stream: &dyn quote::ToTokens,
    create_token_stream: &dyn quote::ToTokens,
    where_element_token_stream: &dyn quote::ToTokens,
    content_token_stream: &dyn quote::ToTokens,
...
pub fn generate_impl_postgresql_type_test_cases_for_ident_token_stream(
    ...
    read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_one_equal_token_stream: &dyn quote::ToTokens,
    read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_two_equal_token_stream: &dyn quote::ToTokens,
    read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_three_equal_token_stream: &dyn quote::ToTokens,
    read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_element_dimension_four_equal_token_stream: &dyn quote::ToTokens,
) -> proc_macro2::TokenStream {
    let postgresql_type_upper_camel_case = naming::PostgresqlTypeUpperCamelCase;
    ...
    // let (
    //     read_only_ids_merged_with_create_into_where_element_equal_method_token_stream,
    //     read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields_method_token_stream,
    // ) = {
    //     let generate_read_only_ids_merged_with_create_into_where_element_method_postgresql_type_token_stream = |
    //         method_name_token_stream: &dyn quote::ToTokens,
    //         content_token_stream: &dyn quote::ToTokens
    //     |generate_read_only_ids_merged_with_create_into_where_element_method_token_stream(
    //         &import_path,
    //         &method_name_token_stream,
    //         &content_token_stream,
    //         &PostgresqlTypeOrPostgresqlJsonType::PostgresqlType,
    //     );
    //     (
    //         generate_read_only_ids_merged_with_create_into_where_element_method_postgresql_type_token_stream(
    //             &naming::ReadOnlyIdsMergedWithCreateIntoWhereElementEqualSnakeCase,
    //             &read_only_ids_merged_with_create_into_where_element_equal_token_stream
    //         ),
    //         generate_read_only_ids_merged_with_create_into_where_element_method_postgresql_type_token_stream(
    //             &naming::ReadOnlyIdsMergedWithCreateIntoVecWhereElementEqualUsingFieldsSnakeCase,
    ...
    let read_only_ids_merged_with_create_into_where_element_equal_content_token_stream = generate_read_only_ids_merged_with_create_into_where_element_equal_token_stream(
        ...
        &quote::quote!{#self_postgresql_type_as_postgresql_type_token_stream::#where_element_upper_camel_case},
        &read_only_ids_merged_with_create_into_where_element_equal_token_stream,
    );
    ...
    quote::quote! {
        ...
        impl #import_path::#postgresql_type_test_cases_upper_camel_case for #ident {
            ...
            type #select_upper_camel_case = #ident_select_upper_camel_case;
            fn #option_vec_create_snake_case() -> std::option::Option<std::vec::Vec<#self_postgresql_type_as_postgresql_type_token_stream::#create_upper_camel_case>> {
            ...
            fn #read_inner_into_update_with_new_or_try_new_unwraped_snake_case(#value_snake_case: #type_token_stream) -> #self_postgresql_type_as_postgresql_type_token_stream::#update_upper_camel_case {
                #read_inner_into_update_with_new_or_try_new_unwraped_token_stream
            }
            fn #update_to_read_only_ids_snake_case(
                #value_snake_case: &#self_postgresql_type_as_postgresql_type_token_stream::#update_upper_camel_case
            ) -> #self_postgresql_type_as_postgresql_type_token_stream::#read_only_ids_upper_camel_case {
            ...
            ) -> #self_postgresql_type_as_postgresql_type_token_stream::#read_upper_camel_case {
...
pub fn generate_impl_postgresql_json_type_test_cases_for_ident_token_stream(
    ...
    //     read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields_method_token_stream,
    // ) = {
    //     let generate_read_only_ids_merged_with_create_into_where_element_method_postgresql_json_type_token_stream = |
    //         method_name_token_stream: &dyn quote::ToTokens,
    //         content_token_stream: &dyn quote::ToTokens
    //     |generate_read_only_ids_merged_with_create_into_where_element_method_token_stream(
    //         &import_path,
    ...
    //     );
    //     (
    //         generate_read_only_ids_merged_with_create_into_where_element_method_postgresql_json_type_token_stream(
    //             &naming::ReadOnlyIdsMergedWithCreateIntoWhereElementEqualSnakeCase,
    //             &read_only_ids_merged_with_create_into_where_element_equal_token_stream
    //         ),
    //         generate_read_only_ids_merged_with_create_into_where_element_method_postgresql_json_type_token_stream(
    ...
    let read_only_ids_merged_with_create_into_where_element_equal_content_token_stream = generate_read_only_ids_merged_with_create_into_where_element_equal_token_stream(
        ...
        &quote::quote!{#self_postgresql_json_type_as_postgresql_json_type_token_stream::#where_element_upper_camel_case},
        &read_only_ids_merged_with_create_into_where_element_equal_token_stream,
    );
    let read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields_content_token_stream = generate_read_only_ids_merged_with_create_into_vec_where_element_equal_using_fields_token_stream(
        &quote::quote!{#self_postgresql_json_type_as_postgresql_json_type_token_stream::#read_only_ids_upper_camel_case},
    ...
    quote::quote! {
        ...
        impl #import_path::#postgresql_json_type_test_cases_upper_camel_case for #ident {
            ...
            type #select_upper_camel_case = #ident_select_upper_camel_case;
            fn #option_vec_create_snake_case() -> std::option::Option<std::vec::Vec<#self_postgresql_json_type_as_postgresql_json_type_token_stream::#create_upper_camel_case>> {
                #option_vec_create_token_stream
            }
            fn #read_only_ids_to_two_dimensional_vec_read_inner_snake_case(
            ...
            fn #read_inner_into_update_with_new_or_try_new_unwraped_snake_case(
                #value_snake_case: #type_token_stream
            ) -> #self_postgresql_json_type_as_postgresql_json_type_token_stream::#update_upper_camel_case {
                #read_inner_into_update_with_new_or_try_new_unwraped_token_stream
            }
            ...
            fn #update_to_read_only_ids_snake_case(
                #value_snake_case: &#self_postgresql_json_type_as_postgresql_json_type_token_stream::#update_upper_camel_case
            ) -> #self_postgresql_json_type_as_postgresql_json_type_token_stream::#read_only_ids_upper_camel_case {
                #update_to_read_only_ids_token_stream
            }
            fn #read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element_snake_case(
                #value_snake_case: &#self_postgresql_json_type_as_postgresql_json_type_token_stream::#read_only_ids_upper_camel_case
