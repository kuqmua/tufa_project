use naming::{
    ...
    parameter::{
        ...
        SelfGeneratePostgresqlJsonObjectTypeModSc, SelfLastSc, SelfReadInnerUcc,
...
pub fn generate_postgresql_json_object_type(
    ...
    let (fields_ts, postgresql_json_object_type_array) = postgresql_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let generate_ident_ucc = |ident_pattern: &IdentPattern| {
            ...
            let ident = &generate_ident_ucc(&match (&not_null_or_nullable, &pattern) {
            ...
            let ident_standart_not_null_ucc = &generate_ident_ucc(&IdentPattern::StandartNotNullWithoutId);
            let ident_array_not_null_ucc = &generate_ident_ucc(&IdentPattern::ArrayNotNullWithId);
            let ident_with_id_standart_not_null_ucc = &generate_ident_ucc(&IdentPattern::StandartNotNullWithId);
            let ident_with_id_array_not_null_ucc = &generate_ident_ucc(&IdentPattern::ArrayNotNullWithId);
            ...
            let generate_type_as_postgresql_json_type_ts = |type_ts: &dyn quote::ToTokens| {
                generate_type_as_import_path_ts(&type_ts, &postgresql_json_type_ucc)
            };
            let ident_as_import_path_postgresql_json_type_ts = generate_type_as_postgresql_json_type_ts(&ident);
            let ident_standart_not_null_as_import_path_postgresql_json_type_ts = generate_type_as_postgresql_json_type_ts(&ident_standart_not_null_ucc);
            let ident_array_not_null_as_import_path_postgresql_json_type_ts = generate_type_as_postgresql_json_type_ts(&ident_array_not_null_ucc);
            ...
            let generate_type_as_postgresql_type_ts = |type_ts: &dyn quote::ToTokens| {
                generate_type_as_import_path_ts(&type_ts, &PostgresqlTypeUcc)
            };
            let generate_type_as_postgresql_json_type_test_cases_ts = |type_ts: &dyn quote::ToTokens| {
                generate_type_as_import_path_ts(&type_ts, &PostgresqlJsonTypeTestCasesUcc)
            };
            let generate_type_as_postgresql_type_test_cases_ts = |type_ts: &dyn quote::ToTokens| {
                generate_type_as_import_path_ts(&type_ts, &PostgresqlTypeTestCasesUcc)
            };
            let self_as_postgresql_json_type_test_cases_ts = generate_type_as_postgresql_json_type_test_cases_ts(&self_ucc);
            ...
            let ident_standart_not_null_as_postgresql_json_type_test_cases_ts = generate_type_as_postgresql_json_type_test_cases_ts(&ident_standart_not_null_ucc);
            ...
            let ident_ts = {
                ...
                let maybe_ident_with_id_standart_not_null_ts = if is_standart_not_null {
                    let ident_with_id_standart_not_null_ts = generate_struct_ident_ts(&ident_with_id_standart_not_null_ucc);
            ...
            let ident_array_not_null_as_postgresql_json_type_ts = generate_type_as_postgresql_json_type_ts(&ident_array_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_ts = generate_type_as_postgresql_json_type_ts(&ident_with_id_array_not_null_ucc);
                ...
                let ident_table_type_declaration_or_ident_create_ts = generate_ident_table_type_declaration_or_create_ts(
                    ...
                    &match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => wrap_into_scopes_ts(&postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_ts(&generate_tokens_table_type_declaration_or_create_ts(ident_standart_not_null_ucc))),
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => wrap_into_scopes_ts(&postgresql_crud_macros_common::generate_std_vec_vec_tokens_declaration_ts(
                                &generate_tokens_table_type_declaration_or_create_ts(&ident_with_id_standart_not_null_ucc)
                            )),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => wrap_into_scopes_ts(&postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_ts(&generate_tokens_table_type_declaration_or_create_ts(&ident_with_id_array_not_null_ucc))),
                        },
                    }
                );
                    ...
                    let parameters_ts = {
                        ...
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => generate_wrap_into_value_parameter_ts(&postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_ts(&generate_tokens_table_type_declaration_or_create_ts(ident_standart_not_null_ucc))),
                            },
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_wrap_into_value_parameter_ts(&postgresql_crud_macros_common::generate_std_vec_vec_tokens_declaration_ts(&generate_tokens_table_type_declaration_or_create_ts(&ident_with_id_standart_not_null_ucc))),
                    ...
                    let content_ts = match &pattern {
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let ident_array_not_null_with_id_postfix_ucc = generate_tokens_table_type_declaration_or_create_ts(&generate_ident_ucc(&IdentPattern::ArrayNotNullWithId));
            ...
            let ident_create_ts = {
                ...
                let impl_std_fmt_display_for_ident_create_ts = generate_impl_std_fmt_display_for_ident_create_ts(&ident_create_ucc);
                let impl_error_occurence_lib_to_std_string_string_for_ident_create_ts = generate_generate_impl_error_occurence_lib_to_std_string_string_wrapper_ts(&ident_create_ucc);
                let maybe_ident_with_id_create_standart_not_null_ts = if is_standart_not_null {
                    let impl_std_fmt_display_for_ident_with_id_create_standart_not_null_ts = generate_impl_std_fmt_display_for_ident_create_ts(&ident_with_id_standart_not_null_create_ucc);
                    let impl_error_occurence_lib_to_std_string_string_for_ident_with_id_create_standart_not_null_ts = generate_generate_impl_error_occurence_lib_to_std_string_string_wrapper_ts(&ident_with_id_standart_not_null_create_ucc);
                    quote! {
            ...
            let self_as_postgresql_json_type_create_ts = generate_type_as_postgresql_json_type_create_ts(&self_ucc);
            let ident_standart_not_null_as_postgresql_json_type_create_for_query_ts = generate_type_as_postgresql_json_type_create_for_query_ts(&ident_standart_not_null_ucc);
            let ident_array_not_null_as_postgresql_json_type_create_for_query_ts = generate_type_as_postgresql_json_type_create_for_query_ts(&ident_array_not_null_ucc);
            let ident_array_not_null_as_postgresql_json_type_test_cases_ts = generate_type_as_postgresql_json_type_test_cases_ts(&ident_array_not_null_ucc);
            ...
            let generate_sqlx_types_json_type_declaration_wrapper_ts = |current_ident_ts: &dyn quote::ToTokens| postgresql_crud_macros_common::generate_impl_sqlx_type_sqlx_postgres_for_ident_ts(
                &current_ident_ts,
                &postgresql_crud_macros_common::generate_sqlx_types_json_type_declaration_ts(&self_ucc)
            );
            ...
            let self_as_postgresql_json_type_ts = generate_type_as_postgresql_json_type_ts(&self_ucc);
            let self_as_postgresql_json_type_update_ts = generate_type_as_postgresql_json_type_update_ts(&self_ucc);
            let self_as_postgresql_json_type_create_for_query_ts = generate_type_as_postgresql_json_type_create_for_query_ts(&self_ucc);
            ...
            let ident_standart_not_null_as_postgresql_json_type_select_ts = generate_type_as_postgresql_json_type_select_ts(&ident_standart_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_select_ts = generate_type_as_postgresql_json_type_select_ts(&ident_with_id_array_not_null_ucc);
            ...
            let ident_select_ts = {
                ...
                let impl_ident_select_ts = {
                    let pub_new_ts = {
                        let parameters_ts = {
                            let unique_vec_ident_select_el_standart_not_null_ts = generate_unique_vec_wrapper_ts(&ident_standart_not_null_select_el_ucc);
                            match &pattern {
                                Pattern::Standart => match &not_null_or_nullable {
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    let select_query_part_for_loop_ts = generate_select_query_part_for_loop_ts(
                                        ...
                                        &generate_quotes::double_quotes_ts(&value_sc),
                                        &column_sc
                                    );
                ...
                let impl_sqlx_type_sqlx_postgres_for_ident_select_ts = generate_sqlx_types_json_type_declaration_wrapper_ts(&ident_select_ucc);
                let impl_sqlx_decode_sqlx_postgres_for_ident_select_ts = generate_impl_sqlx_decode_sqlx_postgres_for_ident_wrapper_ts(&ident_select_ucc);
                ...
                let generate_ident_select_el_or_ident_with_id_standart_not_null_select_el_ts = |is_standart_with_id: &IsStandartWithId| {
                    ...
                    let impl_error_occurence_lib_to_std_string_string_for_ident_select_el_or_ident_with_id_standart_not_null_select_el_ts = generate_generate_impl_error_occurence_lib_to_std_string_string_wrapper_ts(&ident_select_el_or_ident_with_id_select_el_ucc);
                    let (
                ...
                let maybe_ident_with_id_standart_not_null_select_ts = if is_standart_not_null {
                    ...
                    let impl_sqlx_type_sqlx_postgres_for_ident_with_id_standart_not_null_select_ts = generate_sqlx_types_json_type_declaration_wrapper_ts(&ident_with_id_standart_not_null_select_ucc);
                    let impl_sqlx_decode_sqlx_postgres_for_ident_with_id_standart_not_null_select_ts = generate_impl_sqlx_decode_sqlx_postgres_for_ident_wrapper_ts(&ident_with_id_standart_not_null_select_ucc);
            ...
            let ident_where_ts = match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                    ...
                    let maybe_impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_where_ts = {
                        let generate_impl_postgresql_type_where_filter_for_ident_ts = |query_part_content_ts: &dyn quote::ToTokens, is_query_bind_mutable: postgresql_crud_macros_common::IsQueryBindMutable, query_bind_content_ts: &dyn quote::ToTokens| generate_impl_postgresql_type_where_filter_ts(&ident_where_ucc, &query_part_content_ts, is_query_bind_mutable, &query_bind_content_ts);
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                            ...
                            Pattern::Array => generate_impl_postgresql_type_where_filter_for_ident_ts(
                                &{
                                    let el_filters_ts = vec_syn_field_with_id.iter().map(|el_7845d48a| {
                                        ...
                                        quote! {
                                            Self::#el_field_ident_ucc(#value_sc) => generate_el_query(
                    ...
                    let maybe_impl_error_occurence_lib_to_std_string_string_for_ident_where_ts = if matches!((&pattern, &not_null_or_nullable), (Pattern::Standart, NotNullOrNullable::Nullable)) {
                        ...
                        generate_generate_impl_error_occurence_lib_to_std_string_string_wrapper_ts(&ident_where_ucc)
                    };
                    ...
                    let maybe_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_for_ident_where_ts = match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => postgresql_crud_macros_common::generate_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(&ident_where_ucc, &generate_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_content_standart_not_null_where(&is_standart_with_id_false)),
                            NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
                        },
                        Pattern::Array => postgresql_crud_macros_common::generate_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(&ident_where_ucc, &{
                    ...
                    let maybe_ident_with_id_standart_not_null_where_ts = if is_standart_not_null {
                        ...
                        let impl_error_occurence_lib_to_std_string_string_for_ident_with_id_standart_not_null_where_ts = generate_generate_impl_error_occurence_lib_to_std_string_string_wrapper_ts(&ident_with_id_standart_not_null_where_ucc);
            ...
            let ident_read_ts = {
                ...
                let ident_standart_not_null_as_postgresql_json_type_read_ts = generate_type_as_postgresql_json_type_read_ts(&ident_standart_not_null_ucc);
                let ident_with_id_array_not_null_as_postgresql_json_type_read_ts = generate_type_as_postgresql_json_type_read_ts(&ident_with_id_array_not_null_ucc);
                ...
                let ident_read_ts = {
                    let (content_ts, derive_serde_deserialize) = match &pattern {
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => (wrap_content_into_scopes_dot_comma_ts(&postgresql_crud_macros_common::generate_std_vec_vec_tokens_declaration_ts(&ident_with_id_standart_not_null_read_ucc)), macros_helpers::DeriveSerdeDeserialize::True),
                    ...
                    generate_ident_read_ts(&ident_read_ucc, &content_ts, derive_serde_deserialize)
                };
                ...
                let maybe_ident_read_try_from_error_named_ts = match &pattern {
                    Pattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_ident_read_try_from_error_named_ts(&ident_read_try_from_error_named_ucc),
                ...
                let generate_ident_read_or_ident_with_id_standart_not_null_read_ucc = |is_standart_with_id: &IsStandartWithId| match &is_standart_with_id {
                ...
                let impl_ident_read_ts = {
                    let pub_new_or_try_new_ts = {
                        let std_vec_vec_ident_with_id_standart_not_null_read_ts = postgresql_crud_macros_common::generate_std_vec_vec_tokens_declaration_ts(&ident_with_id_standart_not_null_read_ucc);
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                ...
                let generate_impl_serde_deserialize_for_ident_read_or_ident_with_id_standart_not_null_read_ts = |is_standart_with_id: &IsStandartWithId| {
                    ...
                    postgresql_crud_macros_common::generate_impl_serde_deserialize_for_struct_ts(
                        &generate_ident_read_or_ident_with_id_standart_not_null_read_ucc(is_standart_with_id),
                ...
                let generate_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_read_or_ident_with_id_standart_not_null_read_ts = |is_standart_with_id: &IsStandartWithId| {
                    postgresql_crud_macros_common::generate_impl_postgresql_crud_default_option_some_vec_one_el_ts(&generate_ident_read_or_ident_with_id_standart_not_null_read_ucc(is_standart_with_id), &proc_macro2::TokenStream::new(), &{
                ...
                let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_read_or_ident_with_id_standart_not_null_read_ts = match &pattern {
                    Pattern::Standart => match &not_null_or_nullable {
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => postgresql_crud_macros_common::generate_impl_postgresql_crud_default_option_some_vec_one_el_ts(&ident_read_ucc, &proc_macro2::TokenStream::new(), &self_some_postgresql_crud_default_option_some_vec_one_el_call_ts),
                    },
                    Pattern::Array => match &not_null_or_nullable {
                ...
                let impl_sqlx_type_sqlx_postgres_for_ident_read_ts = generate_sqlx_types_json_type_declaration_wrapper_ts(&ident_read_ucc);
                ...
                let impl_sqlx_decode_sqlx_postgres_for_ident_read_ts = generate_impl_sqlx_decode_sqlx_postgres_for_ident_wrapper_ts(&ident_read_ucc);
                let maybe_ident_with_id_read_ts = if is_standart_not_null {
                    ...
                    let ident_with_id_standart_not_null_read_try_from_error_named_ts = generate_ident_read_try_from_error_named_ts(&ident_with_id_standart_not_null_read_try_from_error_named_ucc);
                    ...
                    let impl_sqlx_type_sqlx_postgres_for_ident_with_id_standart_not_null_read_ts = generate_sqlx_types_json_type_declaration_wrapper_ts(&ident_with_id_standart_not_null_read_ucc);
                    let impl_sqlx_decode_sqlx_postgres_for_ident_with_id_standart_not_null_read_ts = generate_impl_sqlx_decode_sqlx_postgres_for_ident_wrapper_ts(&ident_with_id_standart_not_null_read_ucc);
                    quote! {
            ...
            let ident_read_only_ids_ts = {
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_std_option_option_ident_with_id_read_only_ids_array_not_null_ts = wrap_into_value_declaration_ts(&postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_ts(
                                        &SelfReadOnlyIdsUcc::from_tokens(&generate_ident_ucc(&IdentPattern::ArrayNotNullWithId))
                                    ));
                ...
                let impl_sqlx_decode_sqlx_postgres_for_ident_read_only_ids_ts = generate_impl_sqlx_decode_ts(&ident_read_only_ids_ucc);
                let impl_sqlx_type_sqlx_postgres_for_ident_read_only_ids_ts = generate_impl_sqlx_type_ts(&ident_read_only_ids_ucc);
                let maybe_ident_with_id_standart_not_null_read_only_ids_ts = if is_standart_not_null {
                    ...
                    let impl_sqlx_decode_sqlx_postgres_for_ident_with_id_standart_not_null_read_only_ids_ts = generate_impl_sqlx_decode_ts(&ident_with_id_standart_not_null_read_only_ids_ucc);
                    let impl_sqlx_type_sqlx_postgres_for_ident_with_id_standart_not_null_read_only_ids_ts = generate_impl_sqlx_type_ts(&ident_with_id_standart_not_null_read_only_ids_ucc);
                    quote! {
                        #ident_with_id_standart_not_null_read_only_ids_ts
            ...
            let ident_read_inner_ts = {
                ...
                let ident_read_inner_ts = {
                    let generate_pub_type_ident_read_inner_alias_ts = |content_ts: &dyn quote::ToTokens| macros_helpers::generate_pub_type_alias_ts(&ident_read_inner_ucc, &content_ts);
                    match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => generate_pub_type_ident_read_inner_alias_ts(&postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_ts(&generate_type_as_postgresql_json_type_read_inner_ts(&ident_standart_not_null_ucc))),
                        },
                        Pattern::Array => generate_pub_type_ident_read_inner_alias_ts(&match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => postgresql_crud_macros_common::generate_std_option_option_tokens_declaration_ts(&generate_type_as_postgresql_json_type_read_inner_ts(&ident_with_id_array_not_null_ucc)),
                        }),
                    }
                };
            ...
            let ident_standart_not_null_as_postgresql_json_type_update_ts = generate_type_as_postgresql_json_type_update_ts(&ident_standart_not_null_ucc);
            let ident_standart_not_null_as_postgresql_json_type_update_for_query_ts = generate_type_as_postgresql_json_type_update_for_query_ts(&ident_standart_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_update_ts = generate_type_as_postgresql_json_type_update_ts(&ident_with_id_array_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_update_for_query_ts = generate_type_as_postgresql_json_type_update_for_query_ts(&ident_with_id_array_not_null_ucc);
            ...
            let (generate_jsonb_set_target_sc, generate_jsonb_set_target_ts) = {
                let generate_jsonb_set_target_sc = GenerateJsonbSetTargetSc;
                let generate_jsonb_set_target_ts = {
                    let format_handle_ts = generate_quotes::double_quotes_ts(&format!("{{{jsonb_set_target_sc}}}->'{{value_12d082b5}}'"));
                    quote! {
                        let #generate_jsonb_set_target_sc = |value_12d082b5: &str|{
                            format!(#format_handle_ts)
                        };
                    }
                };
                (generate_jsonb_set_target_sc, generate_jsonb_set_target_ts)
            };
            ...
            let ident_update_ts = {
                    ...
                    let maybe_pub_new_or_try_new_for_ident_update_ts = match &pattern {
                        Pattern::Standart => macros_helpers::generate_pub_const_new_ts(
                            ...
                            &generate_value_type_ts(&match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_unique_vec_wrapper_ts(&ident_standart_not_null_update_el_ucc),
                ...
                let maybe_impl_serde_deserialize_for_ident_update_ts = match &pattern {
                    ...
                    Pattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            //todo maybe reuse?
                            let tuple_struct_ident_update_double_quotes_ts = generate_quotes::double_quotes_ts(&format!("tuple struct {ident_update_ucc}"));
                            let ident_update_double_quotes_ts = generate_quotes::double_quotes_ts(&ident_update_ucc);
                ...
                let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_update_ts = postgresql_crud_macros_common::generate_impl_postgresql_crud_default_option_some_vec_one_el_ts(&ident_update_ucc, &proc_macro2::TokenStream::new(), &{
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                ...
                                let select_query_part_for_loop_ts = {
                                    let value_double_quotes_ts = generate_quotes::double_quotes_ts(&value_sc);
                    ...
                    &match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote! {
                                        #ident_update_for_query_el_ucc::#variant_ident_ucc_ts(value_3b3fae4c) => {
                                            match #field_type_as_crud_postgresql_json_type_from_field_ts::#update_query_part_sc(
                                                ...
                                                &#object_acc_sc,
                                                &#generate_jsonb_set_target_sc(#field_ident_double_quotes_ts),
                                                #field_ident_double_quotes_ts,
                                                #increment_sc,
                                            ) {
                                                Ok(value_5edc1648) => {
                                ...
                                let some_format_handle_ts = generate_quotes::double_quotes_ts(&format!("case when jsonb_typeof({{{jsonb_set_target_sc}}}) = 'object' then ({{{jsonb_set_target_sc}}})::jsonb else '{{{{}}}}'::jsonb end"));
                                quote! {
                ...
                let generate_dimension_equal_ts = |dimension: &postgresql_crud_macros_common::Dimension|{
                    ...
                    match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => generate_nullable_ts(&ident_standart_not_null_ucc)
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => generate_nullable_ts(&ident_array_not_null_ucc)
                        },
                    }
                };
                (
                    {
                        ...
                        let read_only_ids_into_option_value_read_inner_ts = match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_fields_read_only_ids_into_option_value_read_inner_ts(&is_standart_with_id_false, &value_sc),
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                        ...
                        let read_only_ids_merged_with_create_into_where_equal_ts = match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_ts = {
                                    let current_ident_ts = generate_type_as_postgresql_json_type_test_cases_ts(&generate_ident_ucc(&match &pattern {
    ...
    let generated: proc_macro2::TokenStream = {
        let ident_generate_postgresql_json_object_type_mod =
            SelfGeneratePostgresqlJsonObjectTypeModSc::from_tokens(&syn_derive_input.ident);
        quote! {
