use naming::{
    ...
    PostgresqlJsonTypeTestCasesUcc, PostgresqlJsonTypeUcc, PostgresqlTypeTestCasesUcc,
    PostgresqlTypeUcc, PreviousReadMergedWithOptionUpdateIntoReadSc, QueryPartErrorNamedUcc,
    ...
    parameter::{
        ...
        SelfGenPostgresqlJsonObjectTypeModSc, SelfLastSc, SelfReadInnerUcc,
        SelfReadOnlyIdsHandleUcc, SelfReadOnlyIdsUcc, SelfReadTryFromErrorNamedUcc, SelfReadUcc,
        SelfSelectElementUcc, SelfSelectSc, SelfSelectUcc, SelfTableTypeDeclarationUcc,
        SelfUpdateElementUcc, SelfUpdateForQueryElementUcc, SelfUpdateForQueryUcc,
        SelfUpdateTryNewErrorNamedUcc, SelfUpdateUcc, SelfWhereUcc,
    },
};
use quote::quote;
...
pub fn gen_postgresql_json_object_type(
    ...
    struct GenPostgresqlJsonTypesConfig {
        ...
        whole_content_write_into_gen_postgresql_json_object_type:
            macros_helpers::ShouldWriteTokenStreamIntoFile,
    }
    ...
    let gen_postgresql_json_object_type_config =
        serde_json::from_str::<GenPostgresqlJsonTypesConfig>(
    ...
    let postgresql_json_object_type_record_vec = {
        let postgresql_json_object_type_record = gen_postgresql_json_object_type_config.variant;
    ...
    //     "GenPostgresqlJsonObjectTypeJsonVariants",
    ...
    let (fields_ts, postgresql_json_object_type_array) = postgresql_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let as_ucc = AsUcc;
            let select_query_part_postgresql_type_sc = SelectQueryPartPostgresqlTypeSc;
            ...
            let create_into_postgresql_json_type_option_vec_where_length_equal_sc = CreateIntoPostgresqlJsonTypeOptionVecWhereLengthEqualSc;
            let create_into_postgresql_json_type_option_vec_where_length_greater_than_sc = CreateIntoPostgresqlJsonTypeOptionVecWhereLengthGreaterThanSc;
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_sc = ReadOnlyIdsMergedWithCreateIntoPostgresqlJsonTypeOptionVecWhereGreaterThanSc;
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_between_sc = ReadOnlyIdsMergedWithCreateIntoPostgresqlJsonTypeOptionVecWhereBetweenSc;
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_in_sc = ReadOnlyIdsMergedWithCreateIntoPostgresqlJsonTypeOptionVecWhereInSc;
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_regular_expression_sc = ReadOnlyIdsMergedWithCreateIntoPostgresqlJsonTypeOptionVecWhereRegularExpressionSc;
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_greater_than_sc = ReadOnlyIdsMergedWithCreateIntoPostgresqlJsonTypeOptionVecWhereContainsElGreaterThanSc;
            let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_regular_expression_sc = ReadOnlyIdsMergedWithCreateIntoPostgresqlJsonTypeOptionVecWhereContainsElRegularExpressionSc;
            ...
            let return_err_query_part_error_named_write_into_buffer_ts = postgresql_crud_macros_common::gen_return_err_query_part_error_named_write_into_buffer_ts(import_path);
            ...
            let gen_import_path_value_initialization_ts = |content_ts: &dyn quote::ToTokens|{
                postgresql_crud_macros_common::gen_value_initialization_ts(
                    &import_path,
                    &content_ts
                )
            };
            ...
            let gen_ident_ucc = |ident_pattern: &IdentPattern| {
                ...
                format!("{current_not_null_or_nullable_rust}{rust_part}{as_ucc}{current_not_null_or_nullable}{postgresql_part}").parse::<proc_macro2::TokenStream>().expect("43784dd3-f37a-438d-8bc8-d17f63feac66")
            };
            ...
            let gen_type_as_postgresql_json_type_ts = |type_ts: &dyn quote::ToTokens| {
                gen_type_as_import_path_ts(&type_ts, &postgresql_json_type_ucc)
            };
            let ident_as_import_path_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&ident);
            let ident_standart_not_null_as_import_path_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&ident_standart_not_null_ucc);
            let ident_array_not_null_as_import_path_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&ident_array_not_null_ucc);
            ...
            let uuid_uuid_as_not_null_jsonb_string_as_import_path_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&uuid_uuid_as_not_null_jsonb_string_ts);
            ...
            let gen_type_as_postgresql_type_ts = |type_ts: &dyn quote::ToTokens| {
                gen_type_as_import_path_ts(&type_ts, &PostgresqlTypeUcc)
            };
            let gen_type_as_postgresql_json_type_test_cases_ts = |type_ts: &dyn quote::ToTokens| {
                gen_type_as_import_path_ts(&type_ts, &PostgresqlJsonTypeTestCasesUcc)
            };
            let gen_type_as_postgresql_type_test_cases_ts = |type_ts: &dyn quote::ToTokens| {
                gen_type_as_import_path_ts(&type_ts, &PostgresqlTypeTestCasesUcc)
            };
            let self_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&self_ucc);
            let ident_standart_not_null_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(
                &ident_standart_not_null_ucc
            );
            let ident_standart_not_null_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&ident_standart_not_null_ucc);
            let import_path_postgresql_json_type_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(
            ...
            let ident_ts = {
                ...
                let maybe_ident_with_id_standart_not_null_ts = if is_standart_not_null {
                    ...
                    let cfg_feature_test_utils_impl_ident_with_id_standart_not_null_ts = {
                        let read_only_ids_merged_with_create_into_where_equal_ts = postgresql_crud_macros_common::gen_read_only_ids_merged_with_create_into_where_equal_ts(
                            ...
                            &{
                                ...
                                |{
                                    let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&field_type);
                                    quote!{
                                        #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                                ...
                                quote!{
                                    #ident_with_id_standart_not_null_where_ucc::#equal_ucc(postgresql_crud::PostgresqlJsonTypeWhereEqual {
                        ...
                        let read_only_ids_merged_with_create_into_vec_where_equal_using_fields_ts = postgresql_crud_macros_common::gen_read_only_ids_merged_with_create_into_vec_where_equal_using_fields_ts(
                            &import_path,
                            &ident_with_id_standart_not_null_read_only_ids_ucc,
                            &ident_with_id_standart_not_null_create_ucc,
                            &ident_with_id_standart_not_null_where_ucc,
                                    ...
                                    quote!{
                                        #ident_with_id_standart_not_null_where_ucc::#field_ident_ucc(
                                            postgresql_crud::PostgresqlTypeWhere::new(
                                                ...
                                                #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_vec_where_equal_using_fields_sc(
                                                    #read_only_ids_sc.0.#value_sc.#field_ident,
                                                    #second_argument_ts
                                                ),
                                            ),
                        ...
                        let read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_ts = postgresql_crud_macros_common::gen_read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_ts(
                            import_path,
                            &ident_with_id_standart_not_null_read_only_ids_ucc,
                            &ident_with_id_standart_not_null_create_ucc,
                            &ident_with_id_standart_not_null_where_ucc,
                                    ...
                                    quote!{
                                        #ident_with_id_standart_not_null_where_ucc::#field_ident_ucc(
                                            #import_path::PostgresqlTypeWhere::new(
                                                ...
                                                #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_sc(
                                                    #read_only_ids_sc.0.#value_sc.#field_ident,
                                                    #second_argument_ts
                                                ),
                                            ),
            ...
            let ident_array_not_null_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&ident_array_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&ident_with_id_array_not_null_ucc);
            ...
            let gen_type_as_postgresql_json_type_subtype_ts = |type_ts: &dyn quote::ToTokens, postgresql_json_type_subtype: &PostgresqlJsonTypeSubtype| {
                let type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&type_ts);
                quote! {#type_as_postgresql_json_type_ts::#postgresql_json_type_subtype}
            };
            let gen_type_as_postgresql_type_subtype_ts = |type_ts: &dyn quote::ToTokens, postgresql_type_subtype: &PostgresqlTypeSubtype| {
                let type_as_postgresql_type_ts = gen_type_as_postgresql_type_ts(&type_ts);
                quote! {#type_as_postgresql_type_ts::#postgresql_type_subtype}
            };
            let gen_field_type_as_crud_postgresql_json_type_from_field_ts = |
                syn_field_wrapper: &macros_helpers::SynFieldWrapper
            | gen_type_as_postgresql_json_type_ts(
            ...
            let ident_as_postgresql_json_type_table_type_declaration_ts = gen_type_as_postgresql_json_type_subtype_ts(&ident, &postgresql_json_type_subtype_table_type_declaration);
            let self_value_ts = quote! {Self(#value_sc)};
            let postgresql_type_where_filter_query_bind_value_query_ts = quote!{#import_path::PostgresqlTypeWhereFilter::query_bind(#value_sc, #query_sc)};
            ...
            let gen_ident_table_type_declaration_or_ident_create_common_ts = |postgresql_json_type_subtype_table_type_declaration_or_create: &PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate| {
                let ident_table_type_declaration_or_ident_create_ucc: &dyn StdFmtDisplayPlusQuoteToTokens = match &postgresql_json_type_subtype_table_type_declaration_or_create {
                    PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::TableTypeDeclaration => &ident_table_type_declaration_ucc,
                    PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::Create => &ident_create_ucc,
                };
                ...
                | {
                    let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_42f25108| {
                        ...
                        let type_as_postgresql_json_type_subtype_table_type_declaration_ts = gen_type_as_postgresql_json_type_subtype_ts(
                ...
                let gen_tokens_table_type_declaration_or_create_ts = |tokens: &dyn quote::ToTokens| {
                    let value: &dyn quote::ToTokens = match &postgresql_json_type_subtype_table_type_declaration_or_create {
                        PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::TableTypeDeclaration => &SelfTableTypeDeclarationUcc::from_tokens(&tokens),
                        PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::Create => &SelfCreateUcc::from_tokens(&tokens),
                    };
                    quote!{#value}
                };
                let ident_table_type_declaration_or_ident_create_ts = gen_ident_table_type_declaration_or_create_ts(
                    ...
                    &match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_ident_table_type_declaration_or_create_or_ident_with_id_table_type_declaration_or_create_standart_not_null_content_ts(&is_standart_with_id_false, postgresql_json_type_subtype_table_type_declaration_or_create, &new_type_or_struct_declaration_struct_declaration),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => wrap_into_scopes_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_tokens_table_type_declaration_or_create_ts(ident_standart_not_null_ucc))),
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => wrap_into_scopes_ts(&postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                                &gen_tokens_table_type_declaration_or_create_ts(&ident_with_id_standart_not_null_ucc)
                            )),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => wrap_into_scopes_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_tokens_table_type_declaration_or_create_ts(&ident_with_id_array_not_null_ucc))),
                        },
                    }
                );
                ...
                let impl_pub_new_for_ident_table_type_declaration_or_ident_create_ts = {
                    let parameters_ts = {
                        ...
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_wrap_into_value_parameter_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_tokens_table_type_declaration_or_create_ts(ident_standart_not_null_ucc))),
                            },
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_wrap_into_value_parameter_ts(&postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&gen_tokens_table_type_declaration_or_create_ts(&ident_with_id_standart_not_null_ucc))),
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_wrap_into_value_parameter_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&gen_tokens_table_type_declaration_or_create_ts(
                    ...
                    let content_ts = match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_self_content_for_ident_or_ident_with_id_table_type_declaration_or_create_ts(&is_standart_with_id_false),
                ...
                let gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_ts = |
                    current_ident_ts: &dyn quote::ToTokens,
                    content_ts: &dyn quote::ToTokens
                | postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(
                    &current_ident_ts,
                    &proc_macro2::TokenStream::new(),
                    &quote! {Self #content_ts}
                );
                let gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_standart_not_null_content_ts = |is_standart_with_id: &IsStandartWithId| {
                ...
                let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_standart_not_null_content_ts = gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_standart_not_null_content_ts(&is_standart_with_id_false);
                ...
                let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_ident_create_ts = gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_ts(
                    &ident_table_type_declaration_or_ident_create_ucc,
                ...
                let impl_sqlx_encode_sqlx_postgres_for_ident_table_type_declaration_or_ident_create_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(
                    &ident_table_type_declaration_or_ident_create_ucc,
                    &quote!{sqlx::types::Json(#self_sc)}
                );
                let impl_sqlx_type_sqlx_postgres_for_ident_table_type_declaration_or_ident_create_ts = postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(
                    &ident_table_type_declaration_or_ident_create_ucc,
                ...
                let maybe_ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = if is_standart_not_null {
                    let ident_with_id_table_type_declaration_or_ident_with_id_standart_not_null_create_ucc: &dyn StdFmtDisplayPlusQuoteToTokens = match &postgresql_json_type_subtype_table_type_declaration_or_create {
                        PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::TableTypeDeclaration => &ident_with_id_standart_not_null_table_type_declaration_ucc,
                        PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::Create => &ident_with_id_standart_not_null_create_ucc,
                    };
                    ...
                    let ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = gen_ident_table_type_declaration_or_create_ts(
                        ...
                        &gen_ident_table_type_declaration_or_create_or_ident_with_id_table_type_declaration_or_create_standart_not_null_content_ts(current_is_standart_with_id, postgresql_json_type_subtype_table_type_declaration_or_create, &new_type_or_struct_declaration_struct_declaration),
                    );
                    let impl_pub_const_new_for_ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = macros_helpers::gen_impl_pub_const_new_for_ident_ts(
                        &ident_with_id_table_type_declaration_or_ident_with_id_standart_not_null_create_ucc,
                        &must_use_ts,
                        &gen_ident_table_type_declaration_or_create_or_ident_with_id_table_type_declaration_or_create_standart_not_null_content_ts(current_is_standart_with_id, postgresql_json_type_subtype_table_type_declaration_or_create, &new_type_or_struct_declaration_new_type),
                        &gen_self_content_for_ident_or_ident_with_id_table_type_declaration_or_create_ts(current_is_standart_with_id),
                    );
                    let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_with_id_table_type_declaration_or_ident_with_id_create_standart_not_null_ts = gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_ts(
                        &ident_with_id_table_type_declaration_or_ident_with_id_standart_not_null_create_ucc,
                        &match &postgresql_json_type_subtype_table_type_declaration_or_create {
                            PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::TableTypeDeclaration => gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_table_type_declaration_or_create_standart_not_null_content_ts(&is_standart_with_id_true),
            ...
            let ident_table_type_declaration_ts = {
                let ident_table_type_declaration_common_ts = gen_ident_table_type_declaration_or_ident_create_common_ts(&PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::TableTypeDeclaration);
                quote! {
                    #ident_table_type_declaration_common_ts
                }
            };
            let gen_type_as_postgresql_json_type_create_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_create);
            let gen_type_as_postgresql_json_type_create_for_query_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_create_for_query);
            let ident_create_ts = {
                let ident_create_common_ts = gen_ident_table_type_declaration_or_ident_create_common_ts(&PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate::Create);
            ...
            let self_as_postgresql_json_type_create_ts = gen_type_as_postgresql_json_type_create_ts(&self_ucc);
            let ident_standart_not_null_as_postgresql_json_type_create_for_query_ts = gen_type_as_postgresql_json_type_create_for_query_ts(&ident_standart_not_null_ucc);
            let ident_array_not_null_as_postgresql_json_type_create_for_query_ts = gen_type_as_postgresql_json_type_create_for_query_ts(&ident_array_not_null_ucc);
            let ident_array_not_null_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&ident_array_not_null_ucc);
            let postgresql_crud_path_postgresql_json_type_uuid_uuid_create_for_query_ts = gen_type_as_postgresql_json_type_create_for_query_ts(&uuid_uuid_as_not_null_jsonb_string_ts);
            ...
            let ident_create_for_query_ts = {
                let gen_struct_standart_not_null_content_ts = |is_standart_with_id: &IsStandartWithId|{
                    let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_53c802d8| {
                        ...
                        let type_as_postgresql_json_type_subtype_crate_for_query_ts = gen_type_as_postgresql_json_type_subtype_ts(
                ...
                let impl_std_convert_from_standart_not_null_without_id_content_ts = {
                    let content_ts = vec_syn_field.iter().map(|el_0fc1e145| {
                        ...
                        quote! {#field_ident: #type_as_postgresql_json_type_subtype_crate_for_query_ts::from(#value_sc.#field_ident)}
                    });
                    quote! {#(#content_ts),*}
                };
                let ident_create_for_query_ts = {
                    let ident_create_for_query_ts = gen_debug_clone_partialeq_serialize_pub_struct_ts(
                        ...
                        &match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_struct_standart_not_null_content_ts(&is_standart_with_id_false),
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    wrap_into_scopes_ts(
                                        &postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                                            &gen_type_as_postgresql_json_type_subtype_ts(
                                                &ident_standart_not_null_ucc,
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => wrap_into_scopes_ts(
                                    &postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                    ...
                    let impl_sqlx_encode_sqlx_postgres_for_ident_create_for_query_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(
                        &ident_create_for_query_ucc,
                        &quote!{sqlx::types::Json(#self_sc)}
                    );
                    let impl_sqlx_type_sqlx_postgres_for_ident_create_for_query_ts = postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(
                        &ident_create_for_query_ucc,
                        &quote!{sqlx::types::Json<#self_ucc>}
                    );
                    quote! {
                ...
                let maybe_ident_with_id_standart_not_null_create_for_query_ts = if is_standart_not_null {
                    ...
                    let impl_std_convert_from_ident_with_id_standart_not_null_create_for_ident_with_id_standart_not_null_create_for_query_ts = macros_helpers::gen_impl_std_convert_from_ts(
                        ...
                        &ident_with_id_standart_not_null_create_for_query_ucc,
                        &quote! {Self {
                            #id_sc: #postgresql_crud_path_postgresql_json_type_uuid_uuid_create_for_query_ts::new(
                                uuid::Uuid::new_v4()
                            ),
            ...
            let gen_sqlx_types_json_type_declaration_wrapper_ts = |current_ident_ts: &dyn quote::ToTokens| postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(
                &current_ident_ts,
                &postgresql_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&self_ucc)
            );
            let gen_impl_sqlx_decode_sqlx_postgres_for_ident_wrapper_ts = |current_ident_ts: &dyn quote::ToTokens| postgresql_crud_macros_common::gen_impl_sqlx_decode_sqlx_postgres_for_ident_ts(
                &current_ident_ts,
                &postgresql_crud_macros_common::gen_sqlx_types_json_type_declaration_ts(&self_ucc),
            ...
            let gen_type_as_postgresql_json_type_update_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_update);
            let gen_type_as_postgresql_json_type_update_for_query_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_update_for_query);
            let self_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&self_ucc);
            let self_as_postgresql_json_type_update_ts = gen_type_as_postgresql_json_type_update_ts(&self_ucc);
            let self_as_postgresql_json_type_create_for_query_ts = gen_type_as_postgresql_json_type_create_for_query_ts(&self_ucc);
            let postgresql_crud_path_postgresql_json_type_uuid_uuid_update_ts = gen_type_as_postgresql_json_type_update_ts(&uuid_uuid_as_not_null_jsonb_string_ts);
            let postgresql_crud_path_postgresql_json_type_uuid_uuid_update_for_query_ts = gen_type_as_postgresql_json_type_update_for_query_ts(&uuid_uuid_as_not_null_jsonb_string_ts);
            ...
            let gen_type_as_postgresql_json_type_select_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_select);
            let ident_standart_not_null_as_postgresql_json_type_select_ts = gen_type_as_postgresql_json_type_select_ts(&ident_standart_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_select_ts = gen_type_as_postgresql_json_type_select_ts(&ident_with_id_array_not_null_ucc);
            ...
            |{
                let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_f3a1af0f| {
                    ...
                    let field_type_as_crud_postgresql_json_type_from_field_ts = gen_type_as_postgresql_json_type_ts(&el_f3a1af0f.field_type);
                    ...
                    quote! {
                        #ident_or_ident_with_id_standart_not_null_select_el_ucc::#variant_name_ts(value_3c8acf6a) => match #field_type_as_crud_postgresql_json_type_from_field_ts::#select_query_part_sc(
                            value_3c8acf6a,
            ...
            let ident_select_ts = {
                ...
                let ident_select_ts = match &not_null_or_nullable {
                    ...
                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_pub_struct_ident_select_ts(
                        &allow_clippy_arbitrary_source_item_ordering_ts,
                        &ident_select_ucc,
                        &wrap_content_into_scopes_dot_comma_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&match &pattern {
                ...
                let impl_ident_select_ts = {
                    let pub_new_ts = {
                        let parameters_ts = {
                            ...
                            match &pattern {
                                Pattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_value_type_ts(&unique_vec_ident_select_el_standart_not_null_ts),
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_value_type_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&unique_vec_ident_select_el_standart_not_null_ts)),
                                },
                                Pattern::Array => match &not_null_or_nullable {
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_value_type_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_with_id_array_not_null_as_postgresql_json_type_select_ts)),
                                },
                            }
                        };
                        let content_ts = match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote! {
                                    Self(#value_sc.map(#ident_standart_not_null_as_postgresql_json_type_select_ts::new))
                                },
                            },
                            Pattern::Array => match &not_null_or_nullable {
                    ...
                    let select_query_part_postgresql_type_ts = {
                        let content_ts = match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote! {
                                        ...
                                        match #value_sc.#select_query_part_postgresql_type_sc(#column_sc) {
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    let ident_with_id_array_not_null_as_postgresql_json_type_select_as_default_but_option_is_some_ts = gen_ident_as_default_but_option_is_some_ts(
                                    ...
                                    quote! {
                                        ...
                                        match #value_sc.#select_query_part_postgresql_type_sc(column) {
                        ...
                        quote! {
                            fn #select_query_part_postgresql_type_sc(
                                &self,
                                #column_sc: &str,
                            ) -> Result<#std_string_string_ts, #import_path_query_part_error_named_ts> {
                                #content_ts
                ...
                let (
                    ...
                    let gen_default_some_one_content_ts = |default_some_one_or_default_some_one_with_max_page_size: &postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize|{
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                    ...
                    (
                        postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(
                            &ident_select_ucc,
                            &proc_macro2::TokenStream::new(),
                            &gen_default_some_one_content_ts(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne)
                        ),
                        postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_max_page_size_ts(
                            &ident_select_ucc,
                            &proc_macro2::TokenStream::new(),
                            &gen_default_some_one_content_ts(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize)
                        )
                    )
                };
                let gen_ident_select_el_or_ident_with_id_standart_not_null_select_el_ts = |is_standart_with_id: &IsStandartWithId| {
                        ...
                        .build_enum(
                            ...
                            &{
                                let content_ts_ecc4a666 = get_vec_syn_field(is_standart_with_id).iter().map(|el_840c2253| {
                                    ...
                                    let field_type_as_json_type_select_ts = gen_type_as_postgresql_json_type_select_ts(&el_840c2253.field_type);
                                    quote! {
                    ...
                    let (
                        ...
                        (
                            postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(
                                &ident_select_el_or_ident_with_id_select_el_ucc,
                                &gen_default_some_one_content_ts(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOne)
                            ),
                            postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_max_page_size_ts(
                                &ident_select_el_or_ident_with_id_select_el_ucc,
                                &gen_default_some_one_content_ts(&postgresql_crud_macros_common::DefaultSomeOneOrDefaultSomeOneWithMaxPageSize::DefaultSomeOneWithMaxPageSize)
                            )
                        )
                ...
                let maybe_ident_with_id_standart_not_null_select_ts = if is_standart_not_null {
                    ...
                    let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_with_id_standart_not_null_select_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(
                    ...
                    let impl_postgresql_crud_default_option_some_vec_one_el_max_page_size_for_ident_with_id_standart_not_null_select_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_max_page_size_ts(
                        &ident_with_id_standart_not_null_select_ucc,
                        &proc_macro2::TokenStream::new(),
            ...
            let ident_where_ts = match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                    ...
                    let gen_ident_where_field_variants_ts = |is_standart_with_id: &IsStandartWithId| {
                        let variants_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_622d1e96| {
                            ...
                            let field_type_as_json_type_where_ts = gen_type_as_postgresql_json_type_subtype_ts(
                                &el_622d1e96.field_type,
                                &postgresql_json_type_subtype_where
                            );
                            quote! {
                                #field_ident_ucc_ts(#import_path::PostgresqlTypeWhere<
                    ...
                    let equal_variant_ident_ts = quote! {#equal_ucc(#import_path::PostgresqlJsonTypeWhereEqual<#ident_as_postgresql_json_type_table_type_declaration_ts>)};
                    let equal_variant_query_part_ts = quote!{
                        #self_ucc::#equal_ucc(#value_sc) => #import_path::PostgresqlTypeWhereFilter::query_part(
                            #value_sc,
                            #increment_sc,
                            &#column_sc,
                    ...
                    let equal_variant_query_bind_ts = quote!{
                        #self_ucc::#equal_ucc(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts
                    };
                            ...
                            NotNullOrNullable::NotNull => match &pattern {
                                ...
                                Pattern::Array => gen_ident_where_wrapper_ts(&{
                                    let dimension_one_equal_ts = quote! {
                                        DimensionOneEqual(#import_path::PostgresqlJsonTypeWhereDimensionOneEqual<#ident_with_id_standart_not_null_table_type_declaration_ucc>),
                                    };
                                    ...
                                    let dimension_one_in_ts = quote! {
                                        DimensionOneIn(#import_path::PostgresqlJsonTypeWhereDimensionOneIn<#ident_with_id_standart_not_null_table_type_declaration_ucc>),
                                    };
                                    let contains_all_elements_of_array_ts = quote! {
                                        ContainsAllElementsOfArray(#import_path::PostgresqlJsonTypeWhereContainsAllElementsOfArray<#ident_with_id_standart_not_null_table_type_declaration_ucc>),
                                    };
                                    let overlaps_with_array_ts = quote! {
                                        OverlapsWithArray(#import_path::PostgresqlJsonTypeWhereOverlapsWithArray<#ident_with_id_standart_not_null_table_type_declaration_ucc>),
                                    };
                                    let el_filters_ts = vec_syn_field_with_id.iter().map(|el_3e7f45d9| {
                                        ...
                                        let el_type_as_postgresql_json_type_where_ts = gen_type_as_postgresql_json_type_subtype_ts(
                                            &el_3e7f45d9.field_type,
                                            &PostgresqlJsonTypeSubtype::Where
                                        );
                                        quote! {
                                            #el_field_ident_ucc(#import_path::PostgresqlTypeWhere<
                    ...
                    let gen_impl_postgresql_type_where_filter_ts = |
                        current_ident_ts: &dyn quote::ToTokens,
                    ...
                    let maybe_impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_where_ts = {
                        let gen_impl_postgresql_type_where_filter_for_ident_ts = |query_part_content_ts: &dyn quote::ToTokens, is_query_bind_mutable: postgresql_crud_macros_common::IsQueryBindMutable, query_bind_content_ts: &dyn quote::ToTokens| gen_impl_postgresql_type_where_filter_ts(&ident_where_ucc, &query_part_content_ts, is_query_bind_mutable, &query_bind_content_ts);
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                NotNullOrNullable::NotNull => gen_impl_postgresql_type_where_filter_for_ident_ts(
                                    &{
                            ...
                            Pattern::Array => gen_impl_postgresql_type_where_filter_for_ident_ts(
                                &{
                                    ...
                                    quote! {
                                        let mut gen_el_query = |
                                            ...
                                            #value_sc: &dyn #import_path::PostgresqlTypeWhereFilter<'_>,
                                            field: &str
                                        | -> Result<#std_string_string_ts, #import_path_query_part_error_named_ts> {
                                            let logical_operator_query_part = logical_operator.to_query_part(is_need_to_add_logical_operator);
                                            let elem = "elem";
                                            let value_9696ee60 = match #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                &format!("{elem}->'{field}'"),
                                                false
                                        ...
                                        match &self {
                                            Self::Equal(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::DimensionOneEqual(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::LengthEqual(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::LengthGreaterThan(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::In(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::DimensionOneIn(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::ContainsAllElementsOfArray(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                            ),
                                            Self::OverlapsWithArray(#value_sc) => #import_path::PostgresqlTypeWhereFilter::#query_part_sc(
                                                #value_sc,
                                                #increment_sc,
                                                #column_sc,
                                                #is_need_to_add_logical_operator_sc
                                ...
                                &{
                                    let el_filters_ts = vec_syn_field_with_id.iter().map(|el_9956277c| {
                                        ...
                                        let el_field_ident_ucc = ElementSelfUcc::from_tokens(&field_ident);
                                        quote! {Self::#el_field_ident_ucc(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts}
                                    });
                                    quote! {
                                        match self {
                                            Self::Equal(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::DimensionOneEqual(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::LengthEqual(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::LengthGreaterThan(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::In(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::DimensionOneIn(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::ContainsAllElementsOfArray(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            Self::OverlapsWithArray(#value_sc) => #postgresql_type_where_filter_query_bind_value_query_ts,
                                            #(#el_filters_ts),*
                                        }
                                    }
                                },
                    ...
                    let gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_content_standart_not_null_where = |is_standart_with_id: &IsStandartWithId| {
                    ...
                    let maybe_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_for_ident_where_ts = match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            NotNullOrNullable::NotNull => postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(&ident_where_ucc, &gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_content_standart_not_null_where(&is_standart_with_id_false)),
                            NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
                        },
                        Pattern::Array => postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(&ident_where_ucc, &{
                    ...
                    let maybe_ident_with_id_standart_not_null_where_ts = if is_standart_not_null {
                        let ident_with_id_standart_not_null_where_ts = gen_ident_where_ts(
                            ...
                            &{
                                ...
                                quote!{
                                    #ident_where_field_variants_ts,
                                    #equal_ucc(#import_path::PostgresqlJsonTypeWhereEqual<#ident_with_id_standart_not_null_table_type_declaration_ucc>),//todo maybe reuse? variant generation
                                }
                            }
                        );
                        let impl_postgresql_crud_postgresql_type_postgresql_type_where_filter_for_ident_with_id_standart_not_null_where_ts = gen_impl_postgresql_type_where_filter_ts(
                            &ident_with_id_standart_not_null_where_ucc,
                            &{
                                ...
                                quote!{
                                    match &self {
                                        #fields_content_ts,
                                        Self::#equal_ucc(#value_sc) => postgresql_crud::PostgresqlTypeWhereFilter::query_part(
                                            #value_sc,
                                            #increment_sc,
                                            &#column_sc,
                                            is_need_to_add_logical_operator
                            ...
                            &{
                                ...
                                quote!{
                                    match self {
                                        #fields_content_ts,
                                        Self::#equal_ucc(#value_sc) => postgresql_crud::PostgresqlTypeWhereFilter::query_bind(#value_sc, #query_sc),//todo maybe reuse? variant generation
                                    }
                                }
                            },
                        );
                        ...
                        let impl_postgresql_crud_all_variants_default_option_some_vec_one_el_for_ident_with_id_standart_not_null_where_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(
                            &ident_with_id_standart_not_null_where_ucc,
                            &gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_content_standart_not_null_where(&is_standart_with_id_true)
                        );
                        quote! {
                ...
                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                    let ident_standart_or_ident_with_id_array_as_postgresql_json_type_where_ts = gen_type_as_postgresql_json_type_subtype_ts(
                        &match &pattern {
            ...
            let gen_type_as_postgresql_json_type_read_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_read);
            let gen_type_as_postgresql_json_type_read_inner_ts = |type_ts: &dyn quote::ToTokens| gen_type_as_postgresql_json_type_subtype_ts(&type_ts, &postgresql_json_type_subtype_read_inner);
            ...
            | {
                let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_274293a0| {
                    ...
                    let field_type_as_json_type_read_ts = match &read_with_or_without_annotation_or_inner {
                        ReadWithOrWithoutAnnotationOrInner::Inner => gen_type_as_postgresql_json_type_read_inner_ts(
                            &el_274293a0.field_type
                        ),
                        ReadWithOrWithoutAnnotationOrInner::WithSerdeOptionIsNoneAnnotation |
                        ReadWithOrWithoutAnnotationOrInner::WithoutSerdeOptionIsNoneAnnotation => gen_type_as_postgresql_json_type_read_ts(
                            &el_274293a0.field_type
                        ),
                    };
                    let std_option_option_value_field_type_as_json_type_read_ts = postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
            ...
            let ident_read_ts = {
                ...
                let ident_standart_not_null_as_postgresql_json_type_read_ts = gen_type_as_postgresql_json_type_read_ts(&ident_standart_not_null_ucc);
                let ident_with_id_array_not_null_as_postgresql_json_type_read_ts = gen_type_as_postgresql_json_type_read_ts(&ident_with_id_array_not_null_ucc);
                ...
                let ident_read_ts = {
                    let (content_ts, derive_serde_deserialize) = match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => (wrap_content_into_scopes_dot_comma_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_standart_not_null_as_postgresql_json_type_read_ts)), macros_helpers::DeriveSerdeDeserialize::True),
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => (wrap_content_into_scopes_dot_comma_ts(&postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_with_id_standart_not_null_read_ucc)), macros_helpers::DeriveSerdeDeserialize::True),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => (wrap_content_into_scopes_dot_comma_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_with_id_array_not_null_as_postgresql_json_type_read_ts)), macros_helpers::DeriveSerdeDeserialize::True),
                        },
                    };
                ...
                let maybe_ident_read_try_from_error_named_ts = match &pattern {
                    Pattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_ident_read_try_from_error_named_ts(&ident_read_try_from_error_named_ucc),
                ...
                let impl_ident_read_ts = {
                    let pub_new_or_try_new_ts = {
                        let std_vec_vec_ident_with_id_standart_not_null_read_ts = postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(&ident_with_id_standart_not_null_read_ucc);
                        match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_pub_try_new_for_ident_read_or_ident_with_id_standart_not_null_read_ts(&is_standart_with_id_false),
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => macros_helpers::gen_pub_const_new_ts(
                                    &must_use_ts,
                                    &gen_value_type_ts(
                                        &postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => macros_helpers::gen_pub_const_new_ts(
                                    &must_use_ts,
                                    &gen_value_type_ts(
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => macros_helpers::gen_pub_new_ts(
                                    &must_use_ts,
                                    &gen_value_type_ts(
                                        &postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                                            &std_vec_vec_ident_with_id_standart_not_null_read_ts
                                    ...
                                    &quote! {Self(#value_sc.map(#ident_with_id_array_not_null_as_postgresql_json_type_read_ts::new))},
                                ),
                            },
                        }
                    };
                ...
                let gen_impl_serde_deserialize_for_ident_read_or_ident_with_id_standart_not_null_read_ts = |is_standart_with_id: &IsStandartWithId| {
                    let current_vec_syn_field = get_vec_syn_field(is_standart_with_id);
                    postgresql_crud_macros_common::gen_impl_serde_deserialize_for_struct_ts(
                        ...
                        &|_: &syn::Ident, syn_type: &syn::Type| {
                            let type_read_ts = gen_type_as_postgresql_json_type_read_ts(&syn_type);
                            postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                ...
                let maybe_impl_serde_deserialize_for_ident_read_or_ident_with_id_standart_not_null_read_ts = match &pattern {
                    Pattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_impl_serde_deserialize_for_ident_read_or_ident_with_id_standart_not_null_read_ts(&is_standart_with_id_false),
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => proc_macro2::TokenStream::new(),
                    },
                    Pattern::Array => proc_macro2::TokenStream::new(),
                };
                let gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_read_or_ident_with_id_standart_not_null_read_ts = |is_standart_with_id: &IsStandartWithId| {
                    postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(&gen_ident_read_or_ident_with_id_standart_not_null_read_ucc(is_standart_with_id), &proc_macro2::TokenStream::new(), &{
                ...
                let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_read_or_ident_with_id_standart_not_null_read_ts = match &pattern {
                    Pattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_read_or_ident_with_id_standart_not_null_read_ts(&is_standart_with_id_false),
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(&ident_read_ucc, &proc_macro2::TokenStream::new(), &self_some_postgresql_crud_default_option_some_vec_one_el_call_ts),
                    },
                    Pattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(
                            &ident_read_ucc,
                            &proc_macro2::TokenStream::new(),
                            &quote! {
                ...
                let impl_sqlx_encode_sqlx_postgres_for_ident_read_ts = postgresql_crud_macros_common::gen_impl_sqlx_encode_sqlx_postgres_for_ident_ts(
                    &ident_read_ucc,
                    &quote!{sqlx::types::Json(#self_sc)}
                );
                ...
                let maybe_ident_with_id_read_ts = if is_standart_not_null {
                    ...
                    let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_with_id_standart_not_null_read_ts = gen_impl_postgresql_crud_default_option_some_vec_one_el_for_ident_read_or_ident_with_id_standart_not_null_read_ts(&is_standart_with_id_true);
            ...
            let gen_ident_read_only_ids_or_ident_with_id_read_only_ids_content_ts = |is_standart_with_id: &IsStandartWithId| {
                let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_5f9102af| {
                    ...
                    let field_type_as_postgresql_json_type_read_only_ids_ts = gen_type_as_postgresql_json_type_subtype_ts(
            ...
            let gen_impl_sqlx_decode_ts = |current_ident_ts: &dyn quote::ToTokens|{
                postgresql_crud_macros_common::gen_impl_sqlx_decode_sqlx_postgres_for_ident_ts(
                    &current_ident_ts,
            ...
            let gen_impl_sqlx_type_ts = |current_ident_ts: &dyn quote::ToTokens|{
                postgresql_crud_macros_common::gen_impl_sqlx_type_sqlx_postgres_for_ident_ts(
                    &current_ident_ts,
                    &quote!{sqlx::types::Json<Self>}
                )
            };
            let gen_fields_read_only_ids_into_option_value_read_inner_ts = |is_standart_with_id: &IsStandartWithId, parameters_ts: &dyn quote::ToTokens|{
                ...
                let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_278a1e1d| {
                    ...
                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&field_type);
                    let field_type_as_postgresql_json_type_read_ts = gen_type_as_postgresql_json_type_subtype_ts(&field_type, &PostgresqlJsonTypeSubtype::Read);
                    let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&field_type);
                    let value_content_ts = wrap_into_value_initialization_ts(&{
                    ...
                    .build_struct(
                        ...
                        &match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_std_option_option_ident_read_only_ids_standart_not_null_ts = wrap_into_value_declaration_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let value_std_vec_vec_ident_with_id_standart_not_null_read_only_ids_ts = wrap_into_value_declaration_ts(&postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                                        &ident_with_id_standart_not_null_read_only_ids_ucc
                                    ));
                                    quote! {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_std_option_option_ident_with_id_read_only_ids_array_not_null_ts = wrap_into_value_declaration_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
            ...
            let ident_read_inner_ts = {
                ...
                let ident_read_inner_ts = {
                    ...
                    match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_ident_read_inner_or_ident_with_id_standart_not_null_read_inner_ts(&IsStandartWithId::False),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_pub_type_ident_read_inner_alias_ts(&postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_type_as_postgresql_json_type_read_inner_ts(&ident_standart_not_null_ucc))),
                        },
                        Pattern::Array => gen_pub_type_ident_read_inner_alias_ts(&match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                                &ident_with_id_standart_not_null_read_inner_ucc
                            ),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&gen_type_as_postgresql_json_type_read_inner_ts(&ident_with_id_array_not_null_ucc)),
                        }),
                    }
                };
            ...
            let ident_standart_not_null_as_postgresql_json_type_update_ts = gen_type_as_postgresql_json_type_update_ts(&ident_standart_not_null_ucc);
            let ident_standart_not_null_as_postgresql_json_type_update_for_query_ts = gen_type_as_postgresql_json_type_update_for_query_ts(&ident_standart_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_update_ts = gen_type_as_postgresql_json_type_update_ts(&ident_with_id_array_not_null_ucc);
            let ident_with_id_array_not_null_as_postgresql_json_type_update_for_query_ts = gen_type_as_postgresql_json_type_update_for_query_ts(&ident_with_id_array_not_null_ucc);
            ...
            let ident_update_ts = {
                ...
                let std_vec_vec_ident_with_id_standart_not_null_create_ts = postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                    &ident_with_id_standart_not_null_create_ucc
                );
                let std_vec_vec_postgresql_crud_path_postgresql_json_type_uuid_uuid_update_ts = postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                ...
                let ident_update_ts = {
                    let gen_std_option_option_ident_type_ts = |current_ident_ts: &dyn quote::ToTokens| wrap_content_into_scopes_dot_comma_ts(
                        &postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&current_ident_ts)
                    );
                    let (
                        derive_serde_deserialize,
                        content_ts_975df5c5
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => (
                                macros_helpers::DeriveSerdeDeserialize::True,
                                &gen_std_option_option_ident_type_ts(&ident_standart_not_null_as_postgresql_json_type_update_ts)
                            ),
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => (
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => (
                                macros_helpers::DeriveSerdeDeserialize::True,
                                &gen_std_option_option_ident_type_ts(&ident_with_id_array_not_null_as_postgresql_json_type_update_ts)
                            ),
                        },
                    };
                    ...
                    let maybe_pub_new_or_try_new_for_ident_update_ts = match &pattern {
                        Pattern::Standart => macros_helpers::gen_pub_const_new_ts(
                            ...
                            &gen_value_type_ts(&match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_unique_vec_wrapper_ts(&ident_standart_not_null_update_el_ucc),
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(&ident_standart_not_null_as_postgresql_json_type_update_ts)
                            }),
                            &self_value_ts
                        ),
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => macros_helpers::gen_pub_try_new_ts(
                                ...
                                &{
                                    ...
                                    let check_if_ids_are_unique_ts = {
                                        let (
                                            ...
                                            let gen_uuid_as_postgresql_json_type_update_to_std_string_string_ts = |
                                            ...
                                            (
                                                gen_uuid_as_postgresql_json_type_update_to_std_string_string_ts(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_pub_const_new_value_type_content_self_value_ts(
                                &postgresql_crud_macros_common::gen_std_option_option_tokens_declaration_ts(
                ...
                let maybe_impl_serde_deserialize_for_ident_update_ts = match &pattern {
                    ...
                    Pattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            let match_try_new_in_deserialize_ts = postgresql_crud_macros_common::gen_match_try_new_in_deserialize_ts(
                                &ident_update_ucc,
                ...
                let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_update_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(&ident_update_ucc, &proc_macro2::TokenStream::new(), &{
                    let value = match &pattern {
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote! {{
                                #create_sc: #vec_postgresql_crud_default_option_some_vec_one_el_call_ts,
                                #update_sc: #postgresql_crud_default_option_some_vec_one_el_call_ts,
                                #delete_sc: #vec_postgresql_crud_default_option_some_vec_one_el_call_ts,
                            }},
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote! {
                                (Some(#postgresql_crud_default_option_some_vec_one_el_call_ts))
                            },
                ...
                let maybe_ident_update_el_ts = if is_standart_not_null {
                            ...
                            &{
                                let variants_ts = vec_syn_field.iter().map(|el_092057f6| {
                                    ...
                                    let value_field_type_as_json_type_update_ts = wrap_into_value_declaration_ts(
                                        &gen_type_as_postgresql_json_type_update_ts(&el_092057f6.field_type)
                                    );
                                    quote! {
                    ...
                    let impl_postgresql_crud_all_variants_default_option_some_vec_one_el_for_ident_update_el_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_all_variants_default_option_some_vec_one_el_ts(&ident_standart_not_null_update_el_ucc, &{
                ...
                let maybe_ident_with_id_standart_not_null_update_el_ts = if is_standart_not_null {
                    ...
                    let ident_with_id_standart_not_null_update_el_fields_declaration_ts = quote! {
                        #id_sc: #postgresql_crud_path_postgresql_json_type_uuid_uuid_update_ts,
                        #fields_sc: #ident_standart_not_null_as_postgresql_json_type_update_ts
                    };
                    ...
                    let impl_postgresql_crud_default_option_some_vec_one_el_for_ident_with_standart_not_null_update_el_ts = postgresql_crud_macros_common::gen_impl_postgresql_crud_default_option_some_vec_one_el_ts(
                        &ident_with_id_standart_not_null_update_el_ucc,
                        &proc_macro2::TokenStream::new(),
                        &quote! {Self {
                            #id_sc: #postgresql_crud_default_option_some_vec_one_el_call_ts,
                            #fields_sc: #postgresql_crud_default_option_some_vec_one_el_call_ts,
                        }},
                    );
                    quote! {
            ...
            let ident_update_for_query_ts = {
                let ident_update_for_query_ts = {
                    ...
                    let std_vec_vec_ident_with_id_standart_not_null_create_for_query_ts = postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                        &ident_with_id_standart_not_null_create_for_query_ucc
                    );
                    let std_vec_vec_postgresql_crud_path_postgresql_json_type_uuid_uuid_update_for_query_ts = postgresql_crud_macros_common::gen_std_vec_vec_tokens_declaration_ts(
                        &postgresql_crud_path_postgresql_json_type_uuid_uuid_update_for_query_ts
                    );
                    match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_ident_update_for_query_ts(
                                &wrap_content_into_scopes_dot_comma_ts(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_ident_update_for_query_ts(
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_ident_update_for_query_ts(
                                &gen_std_option_option_ident_type_ts(&ident_with_id_array_not_null_as_postgresql_json_type_update_for_query_ts)
                            ),
                        },
                    }
                };
                            ...
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let match_variants_ts = vec_syn_field.iter().map(|el_bca06812| {
                                        ...
                                        let field_ident_ucc = ToTokensToUccTs::case_or_panic(&field_ident);
                                        let field_ident_double_quotes_ts = gen_quotes::double_quotes_ts(&field_ident);
                                        let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_bca06812.field_type);
                                        ...
                                        quote! {
                                            #ident_standart_not_null_update_for_query_el_ucc::#field_ident_ucc(#value_sc) => {
                                                match #field_type_as_postgresql_json_type_ts::#select_only_updated_ids_query_part_sc(
                                                    &#value_sc.#value_sc,
                                                    #field_ident_double_quotes_ts,
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let match_content_ts = vec_syn_field.iter().map(|el_a8f45572| {
                                        ...
                                        let field_ident_ucc_ts = ToTokensToUccTs::case_or_panic(&field_ident);
                                        let field_ident_double_quotes_ts = gen_quotes::double_quotes_ts(&field_ident);
                                        let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_a8f45572.field_type);
                                        let if_write_is_err_curly_braces_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let match_variants_ts = vec_syn_field.iter().map(|el_74643094| {
                                        ...
                                        let field_ident_ucc = ToTokensToUccTs::case_or_panic(&field_ident);
                                        let field_ident_double_quotes_ts = gen_quotes::double_quotes_ts(&field_ident);
                                        let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_74643094.field_type);
                                        let if_write_is_err_curly_braces_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                                            &quote!{acc_892857b1, "jsonb_build_object({value_33d3b52e})||"},
                                            &return_err_query_part_error_named_write_into_buffer_ts
                                        );
                                        quote! {
                                            #ident_standart_not_null_update_for_query_el_ucc::#field_ident_ucc(#value_sc) => match #field_type_as_postgresql_json_type_ts::#select_only_updated_ids_query_part_sc(
                                                &#value_sc.#value_sc,
                                                #field_ident_double_quotes_ts,
                                                "elem",
                                                #increment_sc
                                    ...
                                    let select_only_created_ids_query_part_content_ts = vec_syn_field_with_id.iter().map(|el_e6d6df84| {
                                        ...
                                        let field_ident_double_quotes_ts = gen_quotes::double_quotes_ts(&field_ident);
                                        let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_e6d6df84.field_type);
                                        let if_write_is_err_curly_braces_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                                            &quote!{acc_57cd0744, "jsonb_build_object({value})||"},
                                            &return_err_query_part_error_named_write_into_buffer_ts
                                        );
                                        quote! {
                                            match #field_type_as_postgresql_json_type_ts::#select_only_created_ids_query_part_sc(
                        ...
                        .build_enum(
                            ...
                            &{
                                let variants_ts = vec_syn_field.iter().map(|el_9d8af887| {
                                    ...
                                    let value_field_type_as_json_type_update_for_query_ts = wrap_into_value_declaration_ts(&gen_type_as_postgresql_json_type_update_for_query_ts(&el_9d8af887.field_type));
                                    quote! {
                                        #[serde(rename(serialize = #field_ident_double_quotes_ts, deserialize = #field_ident_double_quotes_ts))]
                        ...
                        &{
                            let variants_ts = vec_syn_field.iter().map(|el_2a5d6ff3| {
                                ...
                                let value_initialization_ts = gen_import_path_value_initialization_ts(&{
                                    let field_type_as_json_type_update_for_query_ts = gen_type_as_postgresql_json_type_update_for_query_ts(
                ...
                let maybe_ident_with_id_standart_not_null_update_for_query_el_ts = if is_standart_not_null {
                    let ident_with_id_standart_not_null_update_for_query_el_fields_declaration_ts = quote! {
                        #id_sc: #postgresql_crud_path_postgresql_json_type_uuid_uuid_update_for_query_ts,
                        #fields_sc: #ident_standart_not_null_as_postgresql_json_type_update_for_query_ts
                    };
                    ...
                    let impl_std_convert_from_ident_with_id_standart_not_null_update_el_for_ident_with_id_standart_not_null_update_for_query_el_ts = macros_helpers::gen_impl_std_convert_from_ts(
                        ...
                        &ident_with_id_standart_not_null_update_for_query_el_ucc,
                        &quote! {Self {
                            #id_sc: #uuid_uuid_as_not_null_jsonb_string_as_import_path_postgresql_json_type_ts::UpdateForQuery::from(
                                #value_sc.#id_sc
                            ),
            ...
            let (impl_postgresql_crud_postgresql_json_type_for_ident_ts, maybe_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_ts) = {
                ...
                let gen_update_query_part_standart_nullable_ts = |postgresql_type_or_postgresql_json_type: &postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType|{
                    let format_handle_ts = gen_quotes::double_quotes_ts(&match &postgresql_type_or_postgresql_json_type {
                        postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType::PostgresqlType => format!("jsonb_set({{{jsonb_set_accumulator_sc}}},'{{{{{{{jsonb_set_path_sc}}}}}}}',${{value_27b8537f}})"),
                        postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType::PostgresqlJsonType => "${value_27b8537f}".to_owned(),
                    });
                    quote! {
                        match &#value_sc.0 {
                            Some(value_92f34435) => #ident_standart_not_null_as_postgresql_json_type_ts::#update_query_part_sc(
                                value_92f34435,
                    ...
                    quote! {
                            ...
                            if value_58d685d3.#update_sc.is_empty() {
                                ...
                                for el_a0a61823 in value_58d685d3.#update_sc.to_vec() {
                                    let ident_with_id_handle = {
                                        let id_increment = match #uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_object_vec_el_id_ts::increment_checked_add_one(#increment_sc) {
                                            Ok(value_15b44b54) => value_15b44b54,
                                            Err(#error_sc) => {
                                                return Err(#error_sc);
                                            }
                                        };
                                        match #ident_standart_not_null_as_postgresql_json_type_ts::#update_query_part_sc(
                                            &el_a0a61823.fields,
                                            "",
                                            "elem",
                                            "",
                        ...
                        let delete_query_part_acc = {
                            ...
                            for _ in &value_58d685d3.#delete_sc {
                                let increment_cb6ba4a7 = match #uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_object_vec_el_id_ts::increment_checked_add_one(#increment_sc) {
                        ...
                        let create_query_part_acc = {
                            ...
                            for _ in &value_58d685d3.#create_sc {
                                let increment_5bbc4961 = match #uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_object_vec_el_id_ts::increment_checked_add_one(#increment_sc) {
                ...
                let gen_update_query_part_array_not_null_ts = |postgresql_type_or_postgresql_json_type: &postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType|{
                    let content_ts_c75c3cd1 = gen_update_delete_create_array_ts(&gen_quotes::double_quotes_ts(&match &postgresql_type_or_postgresql_json_type {
                ...
                let impl_postgresql_crud_postgresql_json_type_for_ident_ts = postgresql_crud_macros_common::gen_impl_postgresql_json_type_ts(
                    &postgresql_crud_macros_common::ImportPath::PostgresqlCrud,
                    &ident,
                    ...
                    &match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let ident_standart_not_null_as_postgresql_json_type_select_as_default_but_option_is_some_ts = gen_ident_as_default_but_option_is_some_ts(
                                ...
                                quote! {
                                    ...
                                    match #ident_standart_not_null_as_postgresql_json_type_ts::#select_query_part_sc(
                                        &value_46039f0e,
                                        field_ident,
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                ...
                                quote! {
                                    ...
                                    match #ident_with_id_array_not_null_as_postgresql_json_type_ts::#select_query_part_sc(
                                        &value_174d33cd,
                                        field_ident,
                                        column_name_and_maybe_field_getter,
                                        column_name_and_maybe_field_getter_for_error_message,
                            ...
                            let content_ts = {
                                let content_ts = {
                                    let acc_push_ts = get_vec_syn_field(match &pattern {
                                        ...
                                        let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_a6a15738.field_type);
                                        let content_ts = match &pattern {
                                            Pattern::Standart => {
                                        ...
                                        macros_helpers::gen_if_write_is_err_curly_braces_ts(
                                            &quote!{
                                                acc_2912b128,
                                                #format_handle_ts,
                                                match #field_type_as_postgresql_json_type_ts::#select_only_ids_query_part_sc(#content_ts) {
                    ...
                    &{
                        ...
                        let gen_impl_into_inner_for_ident_read_or_ident_with_id_standart_not_null_read_ts = |is_standart_with_id: &IsStandartWithId| {
                            ...
                            let content_ts = get_vec_syn_field(is_standart_with_id).iter().map(|el_d2c28655| {
                                ...
                                let content_ts = wrap_into_value_initialization_ts(&gen_into_inner_ts(
                                    &gen_type_as_postgresql_json_type_ts(&el_d2c28655.field_type),
                        ...
                        match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let current_ident = gen_type_as_postgresql_json_type_ts(&match &pattern {
                                    Pattern::Standart => ident_standart_not_null_ucc,
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                ...
                                let query_part_variants_ts = vec_syn_field.iter().map(|el_ebd92dbf| {
                                    ...
                                    let field_type_as_crud_postgresql_json_type_from_field_ts = gen_field_type_as_crud_postgresql_json_type_from_field_ts(el_ebd92dbf);
                                    quote! {
                                        #ident_update_for_query_el_ucc::#variant_ident_ucc_ts(value_3b3fae4c) => {
                                            match #field_type_as_crud_postgresql_json_type_from_field_ts::#update_query_part_sc(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_update_query_part_standart_nullable_ts(
                                &postgresql_type_or_postgresql_json_type_postgresql_type
                            )
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_update_query_part_array_not_null_ts(
                                &postgresql_type_or_postgresql_json_type_postgresql_type
                            ),
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote! {
                                match &#value_sc.0 {
                                    Some(value_3245b79f) => #ident_array_not_null_as_postgresql_json_type_ts::#update_query_part_sc(
                                        value_3245b79f,
                                        jsonb_set_accumulator,
                                        jsonb_set_target,
                                        jsonb_set_path,
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let update_query_bind_variants_ts = vec_syn_field.iter().map(|el_9968a29b| {
                                    ...
                                    let field_type_as_crud_postgresql_json_type_from_field_ts = gen_field_type_as_crud_postgresql_json_type_from_field_ts(
                                        el_9968a29b
                                    );
                                    quote! {
                                        #ident_update_for_query_el_ucc::#variant_ident_ucc_ts(value_b27f5b09) => {
                                            match #field_type_as_crud_postgresql_json_type_from_field_ts::#update_query_bind_sc(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote! {
                                match #value_sc.0 {
                                    ...
                                    None => if let Err(#error_sc) = #query_sc.try_bind(sqlx::types::Json(#self_as_postgresql_json_type_update_ts::new(None))) {
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let match_content_ts = vec_syn_field.iter().map(|el_e3bd5731| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_e3bd5731.field_type);
                                    let field_ident_ucc = ToTokensToUccTs::case_or_panic(&field_ident);
                                    quote! {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote!{
                                if let Some(value_6334d77d) = &#value_sc.0 {
                                    match #ident_standart_not_null_as_postgresql_json_type_ts::#select_only_updated_ids_query_bind_sc(value_6334d77d, #query_sc) {
                                        Ok(value_0bd3ba6f) => {
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let select_only_created_ids_query_bind_content_ts = vec_syn_field_with_id.iter().map(|el_27e0de74| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_27e0de74.field_type);
                                    quote! {
                                        match #field_type_as_postgresql_json_type_ts::#select_only_created_ids_query_bind_sc(
                                ...
                                quote!{
                                    for el_e5af9b26 in #value_sc.#update_sc.to_vec() {
                                        match #import_path_postgresql_json_type_uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_ts::#select_only_updated_ids_query_bind_sc(
                                            &el_e5af9b26.#id_sc,
                                            #query_sc
                                        ) {
                                            Ok(value_0fd735de) => {
                                        ...
                                        match #ident_standart_not_null_as_postgresql_json_type_ts::#select_only_updated_ids_query_bind_sc(
                                            &el_e5af9b26.fields,
                                            #query_sc
                                        ) {
                                            Ok(value_4b52fa4f) => {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote!{
                                if let Some(value_107e6639) = &#value_sc.0 {
                                    match #ident_array_not_null_as_postgresql_json_type_ts::#select_only_updated_ids_query_bind_sc(value_107e6639, #query_sc) {
                                        Ok(value_ecf1b8de) => {
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_ts = vec_syn_field.iter().map(|el_6bcf3221| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_6bcf3221.field_type);
                                    let field_ident_double_quotes_ts = &gen_quotes::double_quotes_ts(&field_ident);
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_ts = vec_syn_field.iter().map(|el_88c65ca5| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_88c65ca5.field_type);
                                    let field_ident_double_quotes_ts = &gen_quotes::double_quotes_ts(&field_ident);
                                    let column_name_and_maybe_field_getter_field_ident_double_quotes_ts = &gen_quotes::double_quotes_ts(
                                        &format!("{{{column_name_and_maybe_field_getter_sc}}}->'{field_ident}'")
                                    );
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_ts = vec_syn_field_with_id.iter().map(|el_bfecacfd| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_bfecacfd.field_type);
                                    let field_ident_double_quotes_ts = &gen_quotes::double_quotes_ts(&field_ident);
                                    let if_write_is_err_curly_braces_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_ts = vec_syn_field_with_id.iter().map(|el_76f33159| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_76f33159.field_type);
                                    let field_ident_double_quotes_ts = &gen_quotes::double_quotes_ts(&field_ident);
                                    let if_write_is_err_curly_braces_ts = macros_helpers::gen_if_write_is_err_curly_braces_ts(
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_ts = vec_syn_field.iter().map(|el_9d72fe6e| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_9d72fe6e.field_type);
                                    quote! {
                                        match #field_type_as_postgresql_json_type_ts::#select_only_created_ids_query_bind_sc(
                                            &#value_sc.#field_ident,
                                            #query_sc
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                quote!{
                                    if let Some(value_a1ccd526) = &#value_sc.0 {
                                        match #ident_standart_not_null_as_import_path_postgresql_json_type_ts::#select_only_created_ids_query_bind_sc(
                                            value_a1ccd526,
                                            #query_sc
                                        ) {
                                            Ok(value_70ed6013) => {
                        ...
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_ts = vec_syn_field_with_id.iter().map(|el_43b720bb| {
                                    ...
                                    let field_type_as_postgresql_json_type_ts = gen_type_as_postgresql_json_type_ts(&el_43b720bb.field_type);
                                    quote! {
                                        match #field_type_as_postgresql_json_type_ts::#select_only_created_ids_query_bind_sc(&el_9bdcd847.#field_ident, #query_sc) {
                                            Ok(value_ade27463) => {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                quote!{
                                    if let Some(value_0b55a65a) = &#value_sc.0 {
                                        match #ident_array_not_null_as_import_path_postgresql_json_type_ts::#select_only_created_ids_query_bind_sc(value_0b55a65a, #query_sc) {
                                            Ok(value_ad6a1ac5) => {
                ...
                let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_ts = postgresql_crud_macros_common::gen_impl_postgresql_type_ts(
                    &postgresql_crud_macros_common::ImportPath::PostgresqlCrud,
                    &ident,
                    &ident_table_type_declaration_ucc,
                    ...
                    &quote!{
                        if let Err(#error_sc) = #query_sc.try_bind(
                            #self_as_postgresql_json_type_create_for_query_ts::from(#value_sc)
                        ) {
                            return Err(#error_sc.to_string());
                        }
                        Ok(#query_sc)
                    ...
                    &ident_read_only_ids_ucc,
                    &quote! {
                        match #self_as_postgresql_json_type_ts::#select_only_ids_query_part_sc(#column_sc) {
                            Ok(value_e776e9fa) => Ok(format!("{value_e776e9fa} as {column},")),
                            Err(#error_sc) => Err(#error_sc)
                        }
                    },
                    &ident_read_inner_ucc,
                    &quote!{#self_as_postgresql_json_type_ts::into_inner(#value_sc)},
                    &ident_update_ucc,
                    &ident_update_for_query_ucc,
                    ...
                    &match &pattern {
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote!{#self_as_postgresql_json_type_ts::#update_query_part_sc(
                                value,
                                jsonb_set_accumulator,
                                jsonb_set_target,
                                jsonb_set_path,
                    ...
                    &quote!{#self_as_postgresql_json_type_ts::#update_query_bind_sc(
                        #value_sc,
                        #query_sc
                    )},
                    &quote!{
                    ...
                    &quote!{#self_as_postgresql_json_type_ts::#select_only_updated_ids_query_bind_sc(
                        #value_sc,
                        #query_sc
                    )},
                );
            ...
            let self_postgresql_json_type_ts = quote!{#self_ucc::#postgresql_json_type_ucc};
            let (impl_postgresql_json_type_test_cases_for_ident_ts, impl_postgresql_type_test_cases_for_ident_ts) = {
                let gen_dimension_equal_ts = |dimension: &postgresql_crud_macros_common::Dimension|{
                    let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc = dimension.read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc();
                    let gen_nullable_ts = |content_ts: &dyn quote::ToTokens|quote! {
                        match #import_path::NotEmptyUniqueVec::try_new(
                            match (#read_only_ids_sc.0.#value_sc, #create_sc.0) {
                                ...
                                >::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc(
                        ...
                        Pattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_ts = vec_syn_field.iter().map(|el_3a1eac56| {
                                    ...
                                    let field_ident_ucc = &ToTokensToUccTs::case_or_panic(&field_ident);
                                    let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_3a1eac56.field_type);
                                    quote! {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_nullable_ts(&ident_standart_not_null_ucc)
                        },
                        Pattern::Array => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_ts_f0710cd9 = {
                                    let content_ts_57d244f8 = vec_syn_field.iter().map(|el_18682ae5| {
                                        ...
                                        let el_field_ident_ucc = ElementSelfUcc::from_tokens(&field_ident);
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_18682ae5.field_type);
                                        quote! {
                                            if let Some(value_bf84026e) = #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc(
                                    ...
                                    postgresql_crud_macros_common::Dimension::One => {
                                        let dimension_one_ts = {
                                            let content_ts_91a09fe2 = vec_syn_field.iter().map(|el_a83927c8| {
                                                ...
                                                let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_a83927c8.field_type);
                                                quote! {
                                                    #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                                            ...
                                            quote!{
                                                acc_dd377eb1.push(#ident_where_ucc::DimensionOneEqual(#import_path::PostgresqlJsonTypeWhereDimensionOneEqual {
                                                    ...
                                                    #value_sc: #ident_with_id_standart_not_null_table_type_declaration_ucc::new(
                                                        <#uuid_uuid_as_not_null_jsonb_string_ts as #import_path::PostgresqlJsonTypeTestCases>::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_nullable_ts(&ident_array_not_null_ucc)
                        },
                    }
                };
                (
                    {
                        let option_vec_create_ts = {
                            let content_ts = match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &pattern {
                                    Pattern::Standart => {
                                        let content_ts = vec_syn_field.iter().map(|el_4f2f70d2| {
                                            ...
                                            let field_type_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_4f2f70d2.field_type);
                                            ...
                                            quote! {
                                                if let Some(value_0296b347) = #field_type_type_as_postgresql_json_type_test_cases_ts::#option_vec_create_sc() {
                                                    for el_37154498 in value_0296b347 {
                                                        let #value_sc = #self_as_postgresql_json_type_create_ts::new(
                                                            #(#parameters_ts),*
                                                        );
                                    ...
                                    Pattern::Array => {
                                        let content_ts = vec_syn_field.iter().map(|el_ddefdb90| {
                                            ...
                                            let field_type_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_ddefdb90.field_type);
                                            let (
                                            ...
                                            quote! {
                                                if let Some(vec_create) = #field_type_type_as_postgresql_json_type_test_cases_ts::#option_vec_create_sc() {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote! {
                                        if let Some(value_399e6a50) = #current_ident_not_null_as_postgresql_json_type_test_cases_ts::#option_vec_create_sc() {
                                            for el_e2767811 in value_399e6a50 {
                                                let #value_sc = #self_as_postgresql_json_type_ts::Create::new(Some(el_e2767811 #content_ts));
                                                if !acc_ccd79a32.contains(&#value_sc) {
                                                    acc_ccd79a32.push(#value_sc);
                                                }
                                            }
                                        ...
                                        {
                                            let #value_sc = #self_as_postgresql_json_type_ts::Create::new(None);
                                            if !acc_ccd79a32.contains(&#value_sc) {
                                                acc_ccd79a32.push(#value_sc);
                                            }
                                        }
                            ...
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let fields_last_initialization_ts = {
                                        if vec_syn_field.len() == 1 {
                                            ...
                                            let content_ts = vec_syn_field.iter().map(|el_43e09b9b| {
                                                ...
                                                let field_type_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_43e09b9b.field_type);
                                                quote! {
                                                    let mut #field_ident_last_sc = #field_type_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_into_option_value_read_inner_sc(
                                    ...
                                    let content_ts = vec_syn_field.iter().map(|el_9b199f7f| {
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_9b199f7f.field_type);
                                        let value_content_ts = wrap_into_value_initialization_ts(&quote!{el_2720df8a});
                                        quote! {
                                            for el_7bf83754 in #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_to_two_dimensional_vec_read_inner_sc(&#read_only_ids_sc.0.value.#field_ident) {
                                    ...
                                    let content_ts = vec_syn_field.iter().map(|el_bb247316| {
                                        ...
                                        let fields_ts = vec_syn_field.iter().map(|el_value| {
                                            ...
                                            if field_ident == current_field_ident {
                                                ...
                                                let current_field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_value.field_type);
                                                quote! {
                                                    #current_field_ident: #current_field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_into_option_value_read_inner_sc(
                                                        el_49a5bb62.0.#value_sc.#current_field_ident.clone()
                                                    )
                                                }
                                            }
                                        });
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_bb247316.field_type);
                                        let value_content_ts = wrap_into_value_initialization_ts(&quote!{el_49a5bb62.0.#value_sc.#id_sc.0.#value_sc});
                                        quote! {
                                            for el_4b4da5aa in #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_to_two_dimensional_vec_read_inner_sc(
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    quote! {
                                        ...
                                        if let Some(value_6ee5750e) = &#read_only_ids_sc.0.#value_sc {
                                            for el_4a5a4b09 in #ident_array_not_null_as_postgresql_json_type_test_cases_ts::#read_only_ids_to_two_dimensional_vec_read_inner_sc(value_6ee5750e) {
                        ...
                        let read_inner_into_read_with_new_or_try_new_unwraped_ts = match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let self_el_as_postgresql_type_read_ts = gen_type_as_postgresql_type_subtype_ts(&self_postgresql_json_type_ts, &PostgresqlTypeSubtype::Read);
                                    let parameters_ts = vec_syn_field.iter().map(|el_13640e7f| {
                                        let field_ident = &el_13640e7f.field_ident;
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_13640e7f.field_type);
                                        let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                            #field_type_as_postgresql_json_type_test_cases_ts::#read_inner_into_read_with_new_or_try_new_unwraped_sc(value_8ff65e09.#value_sc)
                                        });
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote! {
                                        #self_el_as_postgresql_type_read_ts::new(
                                            #value_sc.map(#ident_standart_not_null_as_postgresql_json_type_test_cases_ts::#read_inner_into_read_with_new_or_try_new_unwraped_sc)
                                        )
                                    }
                                }
                            },
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let content_ts = vec_syn_field_with_id.iter().map(|el_96f7b50a| {
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_96f7b50a.field_type);
                                        let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                            #field_type_as_postgresql_json_type_test_cases_ts::#read_inner_into_read_with_new_or_try_new_unwraped_sc(value_3ac52220.#value_sc)
                                        });
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let content_ts = vec_syn_field_with_id.iter().map(|el_e47b9709| {
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_e47b9709.field_type);
                                        ...
                                        // };
                                        let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                            #field_type_as_postgresql_json_type_test_cases_ts::#read_inner_into_read_with_new_or_try_new_unwraped_sc(
                        ...
                        let read_inner_into_update_with_new_or_try_new_unwraped_ts = match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &pattern {
                                Pattern::Standart => {
                                    let self_el_as_postgresql_type_update_ts = gen_type_as_postgresql_type_subtype_ts(&self_postgresql_json_type_ts, &PostgresqlTypeSubtype::Update);
                                    let parameters_ts = vec_syn_field.iter().map(|el_cefffeeb| {
                                        let field_ident = &el_cefffeeb.field_ident;
                                        let field_ident_ucc = &ToTokensToUccTs::case_or_panic(&field_ident);
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_cefffeeb.field_type);
                                        let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                        ...
                                        #ident_update_ucc::try_new(
                                            ...
                                            #import_path_unique_vec_ident_with_id_standart_not_null_update_el_ts::try_new(
                                                #value_sc.into_iter().map(|el_ffed1bfc| #ident_with_id_standart_not_null_update_el_ucc {
                                                    ...
                                                    fields: #ident_standart_not_null_as_postgresql_json_type_test_cases_ts::#read_inner_into_update_with_new_or_try_new_unwraped_sc(
                                                        #ident_standart_not_null_read_inner_ucc {
                                                            #(#fields_ts),*
                                                        }
                                                    ),
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_ts = gen_type_as_postgresql_type_test_cases_ts(match &pattern {
                                    Pattern::Standart => &ident_standart_not_null_ucc,
                                    Pattern::Array => &ident_with_id_array_not_null_ucc,
                                });
                                let self_el_as_postgresql_type_update_ts = gen_type_as_postgresql_type_subtype_ts(&self_postgresql_json_type_ts, &PostgresqlTypeSubtype::Update);
                        ...
                        let read_only_ids_into_option_value_read_inner_ts = match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => gen_fields_read_only_ids_into_option_value_read_inner_ts(&is_standart_with_id_false, &value_sc),
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                        #value_sc.0.#value_sc.and_then(|value_5d7e3961| match #ident_standart_not_null_as_postgresql_json_type_test_cases_ts::read_only_ids_into_option_value_read_inner(
                                            value_5d7e3961
                                        ) {
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                        #value_sc.0.#value_sc.and_then(|value_f816032d| match #ident_array_not_null_as_postgresql_json_type_test_cases_ts::#read_only_ids_into_option_value_read_inner_sc(
                                            value_f816032d
                                        ) {
                            ...
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    let match_content_ts = vec_syn_field.iter().map(|el_4fb1f3d0| {
                                        ...
                                        let field_ident_ucc_ts = ToTokensToUccTs::case_or_panic(&field_ident);
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_4fb1f3d0.field_type);
                                        quote! {
                                            #ident_update_el_ucc::#field_ident_ucc_ts(value_0f4d677e) => {
                                                #field_ident = Some(#field_type_as_postgresql_json_type_test_cases_ts::#update_to_read_only_ids_sc(&value_0f4d677e.#value_sc));
                                            }
                                        }
                                    });
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_ts = wrap_into_value_initialization_ts(&{
                                        quote!{
                                            #value_sc.0.as_ref().map(#ident_standart_not_null_as_postgresql_json_type_test_cases_ts::#update_to_read_only_ids_sc)
                                        }
                                    });
                            ...
                            Pattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let value_content_ts = wrap_into_value_initialization_ts(&{
                                        ...
                                        let value_content_ts = wrap_into_value_initialization_ts(&{
                                            let uuid_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&uuid_uuid_as_not_null_jsonb_string_ts);
                                            let fields_ts = vec_syn_field.iter().map(|el_134779da| {
                                                let field_ident = &el_134779da.field_ident;
                                                let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_134779da.field_type);
                                                quote! {
                                                    #field_ident: #field_type_as_postgresql_json_type_test_cases_ts::#update_to_read_only_ids_sc(&#field_ident.expect("a3ec7cae-94a0-49c1-b5d1-88f7b2a3dd1d"))
                                                }
                                            });
                                            quote!{
                                                #ident_with_id_standart_not_null_read_only_ids_handle_ucc {
                                                    #id_sc: #uuid_as_postgresql_json_type_test_cases_ts::#update_to_read_only_ids_sc(&el_4634bb8a.#id_sc),
                                                    #(#fields_ts),*
                                                }
                                            }
                                        });
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_ts = wrap_into_value_initialization_ts(&quote!{
                                        #value_sc.0.as_ref().map(#ident_array_not_null_as_postgresql_json_type_test_cases_ts::#update_to_read_only_ids_sc)
                                    });
                                    quote! {#ident_read_only_ids_ucc(#value_content_ts)}
                                }
                            },
                                ...
                                Pattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let parameters_ts = vec_syn_field.iter().map(|el_2b018c89| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_2b018c89.field_type);
                                            quote! {
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote! {
                                        #ident_read_ucc::new(
                                            #value_sc.0.#value_sc.as_ref().and_then(|value_dfa7815e| match #ident_standart_not_null_as_postgresql_json_type_test_cases_ts::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                                                value_dfa7815e
                                            ) {
                                ...
                                Pattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let parameters_ts = vec_syn_field_with_id.iter().map(|el_f4599b96| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_f4599b96.field_type);
                                            quote! {
                                                #field_type_as_postgresql_json_type_test_cases_ts::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote! {
                                        #ident_read_ucc::new(
                                            #value_sc.0.#value_sc.as_ref().and_then(|value_16ab4136| match #ident_array_not_null_as_postgresql_json_type_test_cases_ts::read_only_ids_to_option_value_read_default_option_some_vec_one_el(
                                                value_16ab4136
                                            ) {
                        ...
                        let previous_read_merged_with_option_update_into_read_ts = {
                            ...
                            let gen_struct_initialization_ts = |function: &dyn Fn(&dyn quote::ToTokens) -> proc_macro2::TokenStream|{//content_ts: &dyn quote::ToTokens
                                let ts = vec_syn_field.iter().map(|el_96e0a086| {
                                    ...
                                    let value_initialization_ts = gen_import_path_value_initialization_ts(&{
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_96e0a086.field_type);
                                        quote!{
                            ...
                            let gen_option_ts = |current_pattern: &Pattern|{
                                let current_ident_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(match &current_pattern {
                                    Pattern::Standart => &ident_standart_not_null_ucc,
                                    Pattern::Array => &ident_array_not_null_ucc
                                });
                                quote! {
                            ...
                            match &not_null_or_nullable {
                                                ...
                                                Some(value_47f5a20b) => #ident_read_ucc({
                                                    ...
                                                    for el_377d1bb4 in value_47f5a20b.#update_sc.into_vec() {
                                                        ...
                                                        for el_d2daee30 in &#read_sc.0 {
                                                            if *#uuid_uuid_as_not_null_jsonb_string_as_postgresql_json_type_object_vec_el_id_ts::get_inner(&el_377d1bb4.#id_sc.clone().into())
                                                            ==
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_option_ts(pattern)
                            }
                        };
                        let read_only_ids_merged_with_create_into_read_ts = {
                            let gen_nullable_ts = |current_ident_ts: &dyn quote::ToTokens, content_ts: &dyn quote::ToTokens|{
                                let current_ident_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&current_ident_ts);
                                quote! {
                                    #ident_read_ucc::new(
                                        match (#read_only_ids_sc.0.#value_sc, #create_sc.0) {
                                            (Some(read_only_ids_2b2ab8a1), Some(create_4a1adaa3)) => {
                                                Some(
                                                    #current_ident_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_option_value_read_sc(
                                ...
                                Pattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let parameters_ts = vec_syn_field.iter().map(|el_9bdce5ca| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_9bdce5ca.field_type);
                                            quote! {
                                                #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_option_value_read_sc(
                                                    #read_only_ids_sc.0.#value_sc.#field_ident,
                                                    #create_sc.#field_ident
                                                )
                                            }
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => gen_nullable_ts(
                                        &ident_standart_not_null_ucc,
                                        &proc_macro2::TokenStream::new()
                                    )
                                },
                        ...
                        let read_only_ids_merged_with_create_into_option_value_read_ts = {
                            let value_initialization_ts = gen_import_path_value_initialization_ts(&quote!{
                                <#self_ucc as #import_path::PostgresqlJsonTypeTestCases>::#read_only_ids_merged_with_create_into_read_sc(
                                    #read_only_ids_sc,
                                    #create_sc
                                )
                            });
                                    ...
                                    #ident_table_type_declaration_ucc::new(
                                        match (#read_only_ids_sc.0.#value_sc, #create_sc.0) {
                                            (Some(read_only_ids_fb2ec2e4), Some(create_2f615d4f)) => {
                                                Some(
                                                    #current_ident_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                                ...
                                Pattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let parameters_ts = vec_syn_field.iter().map(|el_ca3a96db| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_ca3a96db.field_type);
                                            quote! {
                                                #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                                                    #read_only_ids_sc.0.#value_sc.#field_ident,
                                                    #create_sc.#field_ident
                        ...
                        let read_only_ids_merged_with_create_into_where_equal_ts = match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &pattern {
                                Pattern::Standart => {
                                    let parameters_ts = vec_syn_field.iter().map(|el_9990b32d| {
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_9990b32d.field_type);
                                        quote! {
                                            #field_type_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                                                #read_only_ids_sc.0.#value_sc.#field_ident,
                                                #create_sc.#field_ident
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_ts = {
                                    let current_ident_ts = gen_type_as_postgresql_json_type_test_cases_ts(&gen_ident_ucc(&match &pattern {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &pattern {
                                    Pattern::Standart => {
                                        let elements_ts = vec_syn_field.iter().map(|el_23a78055| {
                                            ...
                                            let field_ident_ucc_ts = ToTokensToUccTs::case_or_panic(&field_ident);
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_23a78055.field_type);
                                            quote! {
                        ...
                        let read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_ts = match &pattern {
                            Pattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let content_ts = vec_syn_field.iter().map(|el_459c3da8| {
                                        ...
                                        let field_ident_ucc = &ToTokensToUccTs::case_or_panic(&field_ident);
                                        let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_459c3da8.field_type);
                                        quote! {
                                    ...
                                    #import_path::NotEmptyUniqueVec::try_new({
                                        ...
                                        match (#read_only_ids_sc.0.#value_sc, #create_sc.0) {
                                            (Some(read_only_ids_2f024927), Some(create_120c1dad)) => {
                                                for el_a8b181a0 in #ident_standart_not_null_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_sc(
                            ...
                            Pattern::Array => quote!{
                                #self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_vec_where_equal_using_fields_sc(
                                    #read_only_ids_sc,
                                    #create_sc
                                )
                            }
                        };
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_one_equal_ts = gen_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::One);
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_two_equal_ts = gen_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::Two);
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_three_equal_ts = gen_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::Three);
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_four_equal_ts = gen_dimension_equal_ts(&postgresql_crud_macros_common::Dimension::Four);
                                ...
                                match #import_path::NotEmptyUniqueVec::try_new(
                                    match #create_sc.0 {
                                        Some(create_09a81dae) => match <
                                            ...
                                            as
                                            #import_path::PostgresqlJsonTypeTestCases
                                        >::#create_into_postgresql_json_type_option_vec_where_length_equal_sc(create_09a81dae) {
                                            Some(value_3680a4c9) => {
                                ...
                                Pattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_ts = vec_syn_field.iter().map(|el_d41dce84| {
                                            ...
                                            let field_ident_ucc = &ToTokensToUccTs::case_or_panic(&field_ident);
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_d41dce84.field_type);
                                            quote! {
                                ...
                                Pattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_ts = vec_syn_field.iter().map(|el_c776b608| {
                                            ...
                                            let el_field_ident_ucc = ElementSelfUcc::from_tokens(&field_ident);
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_c776b608.field_type);
                                            quote! {
                                                for create_e06a9fe2 in #create_sc.0.clone() {
                                                    if let Some(value_ee015fcc) = #field_type_as_postgresql_json_type_test_cases_ts::#create_into_postgresql_json_type_option_vec_where_length_equal_sc(
                                ...
                                Pattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_ts = vec_syn_field.iter().map(|el_9d0245f1| {
                                            ...
                                            let field_ident_ucc = &ToTokensToUccTs::case_or_panic(&field_ident);
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_9d0245f1.field_type);
                                            quote! {
                                ...
                                Pattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_ts = vec_syn_field.iter().map(|el_47c8f26c| {
                                            ...
                                            let el_field_ident_ucc = ElementSelfUcc::from_tokens(&field_ident);
                                            let field_type_as_postgresql_json_type_test_cases_ts = gen_type_as_postgresql_json_type_test_cases_ts(&el_47c8f26c.field_type);
                                            quote! {
                                                for create_34a1e540 in #create_sc.0.clone() {
                                                    if let Some(value_51fe384b) = #field_type_as_postgresql_json_type_test_cases_ts::#create_into_postgresql_json_type_option_vec_where_length_greater_than_sc(
                        ...
                        let (
                            ...
                            let gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts = |method_name_ts: &dyn quote::ToTokens|match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &pattern {
                                    Pattern::Standart => {
                                                    ...
                                                    for el_3e86d33d in value_a2900ac9.clone().into_vec() {
                                                        match el_3e86d33d {
                                                            #import_path::SingleOrMultiple::Multiple(multiple) => {
                                                                acc_a94bd7fb.push(
                                                                    #import_path::SingleOrMultiple::Single(
                                                                        #ident_where_ucc::#field_ident_ucc(#import_path::PostgresqlTypeWhere::new(
                                                                            and,
                                                                            multiple
                                                                        ))
                                                                    )
                                                            ...
                                                            #import_path::SingleOrMultiple::Single(single) => {
                                                                acc_a94bd7fb.push(
                                                                    #import_path::SingleOrMultiple::Single(
                                                                        #ident_where_ucc::#field_ident_ucc(#import_path::PostgresqlTypeWhere::try_new(
                                                                            and,
                                                                            vec![single]
                                                ...
                                                for (read_only_ids_629675e2, create_82796400) in #read_only_ids_sc.0.#value_sc.into_iter().zip(#create_sc.0.into_iter()) {
                                                    ...
                                                    let #id_sc = #ident_where_ucc::ElementId(
                                                        #import_path::PostgresqlTypeWhere::try_new(
                                                            and,
                                                            vec![
                                                                #uuid_uuid_as_not_null_jsonb_string_where_ucc::Equal(#import_path::PostgresqlJsonTypeWhereEqual {
                                                                    logical_operator: #import_path::LogicalOperator::Or,
                            ...
                            (
                                gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts(
                                    &read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_sc
                                ),
                                gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts(
                                    &read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_between_sc
                                ),
                                gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts(
                                    &read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_in_sc
                                ),
                                gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts(
                                    &read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_regular_expression_sc
                                ),
                                gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts(
                                    &read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_greater_than_sc
                                ),
                                gen_read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_filter_ts(
                                    &read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_regular_expression_sc
                                )
                            )
                        };
                        postgresql_crud_macros_common::gen_impl_postgresql_json_type_test_cases_for_ident_ts(
                    ...
                    {
                        let option_vec_create_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#option_vec_create_sc()};
                        let read_only_ids_to_two_dimensional_vec_read_inner_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_to_two_dimensional_vec_read_inner_sc(#read_only_ids_sc)};
                        let read_inner_into_read_with_new_or_try_new_unwraped_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_inner_into_read_with_new_or_try_new_unwraped_sc(#value_sc)};
                        let read_inner_into_update_with_new_or_try_new_unwraped_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_inner_into_update_with_new_or_try_new_unwraped_sc(#value_sc)};
                        let update_to_read_only_ids_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#update_to_read_only_ids_sc(#value_sc)};
                        let read_only_ids_to_option_value_read_default_option_some_vec_one_el_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_to_option_value_read_default_option_some_vec_one_el_sc(#value_sc)};
                        let previous_read_merged_with_option_update_into_read_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#previous_read_merged_with_option_update_into_read_sc(#read_sc, #option_update_sc)};
                        let read_only_ids_merged_with_create_into_read_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_read_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_option_value_read_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_option_value_read_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_table_type_declaration_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_table_type_declaration_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_where_equal_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_where_equal_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_vec_where_equal_using_fields_ts = quote! {#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_vec_where_equal_using_fields_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_option_vec_where_equal_to_json_field_ts = quote!{Some(#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_sc(
                            #read_only_ids_sc,
                            #create_sc
                        ))};
                        ...
                        let (
                            ...
                            let gen_dimension_equal_handle_ts = |dimension: &postgresql_crud_macros_common::Dimension|{
                                let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc = dimension.read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc();
                                quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_sc(
                                    #read_only_ids_sc,
                                    #create_sc
                                )}
                            };
                            (
                                gen_dimension_equal_handle_ts(&postgresql_crud_macros_common::Dimension::One),
                                gen_dimension_equal_handle_ts(&postgresql_crud_macros_common::Dimension::Two),
                                gen_dimension_equal_handle_ts(&postgresql_crud_macros_common::Dimension::Three),
                                gen_dimension_equal_handle_ts(&postgresql_crud_macros_common::Dimension::Four)
                            )
                        };
                        let create_into_postgresql_json_type_option_vec_where_length_equal_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#create_into_postgresql_json_type_option_vec_where_length_equal_sc(
                            #create_sc
                        )};
                        let create_into_postgresql_json_type_option_vec_where_length_greater_than_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#create_into_postgresql_json_type_option_vec_where_length_greater_than_sc(
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_between_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_between_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_in_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_in_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_regular_expression_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_regular_expression_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_greater_than_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_greater_than_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_regular_expression_ts = quote!{#self_as_postgresql_json_type_test_cases_ts::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_contains_el_regular_expression_sc(
                            #read_only_ids_sc,
                            #create_sc
                        )};
                        postgresql_crud_macros_common::gen_impl_postgresql_type_test_cases_for_ident_ts(
                            &cfg_feature_test_utils,
                            &import_path,
                            &ident_read_inner_ucc,
                            &ident,
            ...
            let impl_postgresql_type_not_primary_key_for_ident_ts = postgresql_crud_macros_common::gen_impl_postgresql_type_not_primary_key_for_ident_ts(&import_path, &ident);
            let gend = quote! {
                #ident_ts
    ...
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_json_object_type_config
            .postgresql_table_columns_content_write_into_postgresql_table_columns_using_postgresql_json_object_types,
    ...
    let gend: proc_macro2::TokenStream = {
        let ident_gen_postgresql_json_object_type_mod =
            SelfGenPostgresqlJsonObjectTypeModSc::from_tokens(&syn_derive_input.ident);
        quote! {
            #[allow(unused_qualifications)]
            #[allow(clippy::absolute_paths)]
            mod #ident_gen_postgresql_json_object_type_mod {
                #(#postgresql_json_object_type_array)*
            }
            pub use #ident_gen_postgresql_json_object_type_mod::*;
        }
    };
    macros_helpers::maybe_write_ts_into_file(
        gen_postgresql_json_object_type_config
            .whole_content_write_into_gen_postgresql_json_object_type,
        "gen_postgresql_json_object_type",
        &gend,
        &macros_helpers::FormatWithCargofmt::True,
    );
    gend
