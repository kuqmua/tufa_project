                ...
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                    ...
                    let maybe_ident_where_element_token_stream = {
                        ...
                        let equal_token_stream = quote::quote! {
                            #equal_upper_camel_case(#import_path::PostgresqlJsonTypeWhereElementEqual<#ident_as_postgresql_json_type_table_type_declaration_token_stream>),
                        };
                        match &not_null_or_nullable {
                    ...
                    let maybe_ident_with_id_standart_not_null_where_element_token_stream = if is_standart_not_null {
                        let ident_with_id_standart_not_null_where_element_token_stream = generate_ident_where_element_token_stream(
                            ...
                            &{
                                ...
                                // todo
                                // let equal_token_stream = quote::quote!{
                                //     #equal_upper_camel_case(#import_path::PostgresqlJsonTypeWhereElementEqual<#ident_with_id_table_type_declaration_upper_camel_case>)
                                // };
                                quote::quote!{
                                    #ident_where_element_field_variants_token_stream,
                                    // #equal_token_stream
                ...
                (
                    postgresql_crud_macros_common::generate_impl_postgresql_json_type_test_cases_for_ident_token_stream(
                        ...
                        &match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&generate_ident_upper_camel_case(&match &postgresql_json_object_type_pattern {
                                    ...
                                    #import_path::NullableJsonObjectPostgresqlTypeWhereFilter(
                                        match (#read_only_ids_snake_case.0.#value_snake_case, #create_snake_case.0) {
                                            (Some(#read_only_ids_snake_case), Some(#create_snake_case)) => Some(#import_path::NotEmptyUniqueEnumVec::try_new(
                                                #content_token_stream::#read_only_ids_merged_with_create_into_where_element_equal_snake_case(
                                                    #read_only_ids_snake_case,
                                                    #create_snake_case
                                                )
