...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let (fields_token_stream, postgresql_json_object_type_array) = postgresql_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let standart_not_null_create_query_bind_content_handle_token_stream = {
                let create_query_bind_fields_token_stream = vec_syn_field.iter().map(|element| {
                    ...
                    let field_type_as_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_crud_postgresql_json_type_from_field_token_stream(element);
                    quote::quote! {
                        match #field_type_as_crud_postgresql_json_type_from_field_token_stream::#create_query_bind_snake_case(#value_snake_case.#element_field_ident, #query_snake_case) {
                            Ok(#value_snake_case) => {
                            ...
                            let content_token_stream = match &postgresql_json_object_type_pattern {
                                ...
                                PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => quote::quote!{(
                                        #value_snake_case.0.into_iter().map(|#element_snake_case|#ident_with_id_standart_not_null_as_postgresql_json_type_create_for_query_token_stream::from(
                                            #element_snake_case
                                        )).collect()
                                    )},
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote!{(
            ...
            let (maybe_impl_postgresql_crud_postgresql_json_type_for_ident_token_stream, maybe_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream) = {
                let impl_postgresql_crud_postgresql_json_type_for_ident_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_json_type_token_stream(
                    ...
                    &match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                generate_standart_not_null_create_query_part_content_token_stream(&is_standart_with_id_false)
                            },
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                ...
                                quote::quote! {
                                    match &#value_snake_case.0 {
                                        Some(#value_snake_case) => #ident_standart_not_null_or_ident_with_id_array_not_null_as_postgresql_json_type_token_stream::#create_query_part_snake_case(
                                            #value_snake_case,
                                            #increment_snake_case
                                        ),
                    ...
                    &match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                standart_not_null_create_query_bind_content_handle_token_stream.clone()
                            },
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                quote::quote! {
                                    match #value_snake_case.0 {
                                        Some(#value_snake_case) => #ident_standart_not_null_as_postgresql_json_type_token_stream::create_query_bind(
                                            #value_snake_case,
                                            #query_snake_case
                                        ),
                                        None => {
