...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let (fields_token_stream, postgresql_json_object_type_array) = postgresql_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let ident_with_id_standart_not_null_as_postgresql_json_type_create_for_query_token_stream = generate_type_as_postgresql_json_type_create_for_query_token_stream(&ident_with_id_standart_not_null_upper_camel_case);
            ...
            let postgresql_crud_path_postgresql_json_type_uuid_uuid_create_for_query_token_stream = generate_type_as_postgresql_json_type_create_for_query_token_stream(&import_path_postgresql_json_type_uuid_uuid_as_not_null_jsonb_string_token_stream);
            ...
            let ident_select_token_stream = {
                        ...
                        let content_token_stream = {
                            ...
                            let array_nullable_token_stream = {
                                let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&match &postgresql_json_object_type_pattern {
                                    PostgresqlJsonObjectTypePattern::Standart => "jsonb_build_object('value',case when jsonb_typeof({column}) = 'null' then 'null'::jsonb else ({}) end)",
                                    PostgresqlJsonObjectTypePattern::Array => "case when jsonb_typeof({column}) = 'null' then jsonb_build_object('value','null'::jsonb) else ({}) end",
                                });
                                let default_but_option_is_always_some_call_token_stream = generate_default_but_option_is_always_some_call_token_stream(&match &postgresql_json_object_type_pattern {
                                    PostgresqlJsonObjectTypePattern::Standart => &ident_standart_not_null_as_postgresql_json_type_select_token_stream,
                                    PostgresqlJsonObjectTypePattern::Array => &ident_with_id_array_not_null_as_postgresql_json_type_select_token_stream,
                ...
                let maybe_ident_with_id_standart_not_null_select_token_stream = if is_standart_not_null {
                    ...
                    let impl_ident_with_id_standart_not_null_select_token_stream = {
                        let impl_new_for_ident_with_id_standart_not_null_select_token_stream = macros_helpers::generate_pub_new_token_stream(
                        ...
                        let select_query_part_token_stream = {
                            ...
                            quote::quote! {
                                fn #select_query_part_snake_case(
                                    &self,
                                    #field_ident_snake_case: &std::primitive::str,
            ...
            let ident_read_only_ids_token_stream = {
                ...
                let maybe_ident_with_id_standart_not_null_read_only_ids_token_stream = if is_standart_not_null {
                    ...
                    let test_utils_impl_ident_with_id_standart_not_null_read_only_ids_token_stream = {
                        let test_cases_token_stream = {
                            let content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                let field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                    panic!("{}", naming::FIELD_IDENT_IS_NONE);
                                });
                                ...
                                quote::quote! {
                                    #field_ident: #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_option_value_read_inner_snake_case(#self_snake_case.0.#value_snake_case.#field_ident.clone())
                                }
                            });
                            let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                #self_snake_case.0.#value_snake_case.#id_snake_case.0.#value_snake_case.clone()
                            });
                            quote::quote! {
                                fn test_cases(&#self_snake_case) -> std::vec::Vec<std::vec::Vec<#ident_with_id_standart_not_null_read_inner_upper_camel_case>> {
                                    vec![
                                        vec![
                        ...
                        let read_only_ids_to_option_value_read_inner_token_stream = {
                            let content_token_stream = generate_fields_read_only_ids_to_option_value_read_inner_token_stream(&is_standart_with_id_true, &self_snake_case);
                            quote::quote! {
                                fn read_only_ids_to_option_value_read_inner(#self_snake_case) -> std::option::Option<postgresql_crud::Value<#ident_with_id_standart_not_null_read_inner_upper_camel_case>> {
                                    #content_token_stream
                                }
                            }
                        };
                        quote::quote! {
                            ...
                            impl #ident_with_id_standart_not_null_read_only_ids_upper_camel_case {
                                #test_cases_token_stream
                    ...
                    quote::quote! {
                        #ident_with_id_standart_not_null_read_only_ids_token_stream
                        #test_utils_impl_ident_with_id_standart_not_null_read_only_ids_token_stream
            ...
            let ident_read_inner_token_stream = {
                ...
                let maybe_ident_with_id_read_inner_token_stream = if is_standart_not_null {
                    ...
                    let test_utils_impl_ident_with_id_read_inner_token_stream = {
                        let read_new_or_try_new_unwraped_for_test_token_stream = {
                            let content_token_stream = get_vec_syn_field(&is_standart_with_id_true).iter().map(|element| {
                                ...
                                quote::quote! {
                                    #field_ident: match #self_snake_case.#field_ident {
                                        Some(#value_snake_case) => Some(#value_content_token_stream),
                                        None => None,
                                    }
                                }
                            ...
                            quote::quote! {
                                fn read_new_or_try_new_unwraped_for_test(#self_snake_case) -> #ident_with_id_standart_not_null_read_upper_camel_case {
                                    #ident_with_id_standart_not_null_read_upper_camel_case {
                                        #(#content_token_stream),*
                                    }
                                }
                        ...
                        quote::quote! {
                            #cfg_feature_test_utils
                            impl #ident_with_id_standart_not_null_read_inner_upper_camel_case {
                    ...
                    quote::quote! {
                        ...
                        #test_utils_impl_ident_with_id_read_inner_token_stream
                    }
                } else {
                    proc_macro2::TokenStream::new()
                };
            ...
            let (maybe_impl_postgresql_crud_postgresql_json_type_for_ident_token_stream, maybe_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream) = {
                        ...
                        match &postgresql_json_object_type_pattern {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote::quote! {
                                        let #ident_with_id_standart_not_null_select_snake_case = #ident_with_id_standart_not_null_select_upper_camel_case::select_query_part(
                        ...
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let match_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                    ...
                                    quote::quote! {
                                        #ident_standart_not_null_update_element_upper_camel_case::#field_ident_upper_camel_case(#value_snake_case) => {
                                            match #field_type_as_postgresql_json_type_token_stream::select_only_updated_ids_query_bind(
                                                &#value_snake_case.#value_snake_case,
                                                #query_snake_case
                                            ) {
                                                Ok(#value_snake_case) => {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                quote::quote!{
                                    if let Some(#value_snake_case) = &#value_snake_case.0 {
                                        match #ident_standart_not_null_as_postgresql_json_type_token_stream::select_only_updated_ids_query_bind(&#value_snake_case, #query_snake_case) {
                                            Ok(#value_snake_case) => {
                                                #query_snake_case = #value_snake_case;
                                            },
                                            Err(#error_snake_case) => {
                ...
                let impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_type_token_stream(
                    ...
                    &quote::quote!{#ident_as_postgresql_json_type_token_stream::#update_query_part_snake_case(
                        value,
                        jsonb_set_accumulator,
                        jsonb_set_target,
                        jsonb_set_path,
            ...
            // println!("{maybe_impl_postgresql_crud_postgresql_json_type_for_ident_with_id_not_null_token_stream}");
                            ...
                            quote::quote!{
                                #ident_read_upper_camel_case::new({
                                    ...
                                    for #element_snake_case in #value_snake_case {
                                        #acc_snake_case.push(
                                            #ident_with_id_standart_not_null_read_inner_upper_camel_case::#read_new_or_try_new_unwraped_for_test_snake_case(#element_snake_case)
                                        );
                                    }
                                    #acc_snake_case
                                })
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                        #value_snake_case.0.#value_snake_case.into_iter().fold(vec![], |mut #acc_snake_case, #element_snake_case| {
                                            //is it right?
                                            if let Some(#value_snake_case) = #ident_with_id_standart_not_null_read_only_ids_upper_camel_case::#read_only_ids_to_option_value_read_inner_snake_case(#element_snake_case) {
