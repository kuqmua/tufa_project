        ...
        .map(|(index, element)| {
            ...
            let (impl_postgresql_crud_postgresql_json_type_for_ident_token_stream, maybe_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream) = {
                ...
                let generate_update_delete_create_array_token_stream = |format_handle_token_stream: &dyn quote::ToTokens|{
                    ...
                    let if_write_is_err_curly_braces_1_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                        &quote::quote!{acc_8554f572, "${increment},"},
                        &return_err_query_part_error_named_write_into_buffer_token_stream
                    );
                    quote::quote! {
                        ...
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                    ...
                                    let if_write_is_err_curly_braces_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                                        &quote::quote!{acc_0fe559fa, "jsonb_build_object({value})||"},
                                        &return_err_query_part_error_named_write_into_buffer_token_stream
                                    );
                                    quote::quote! {
                                        match #field_type_as_postgresql_json_type_token_stream::#select_only_created_ids_query_part_snake_case(
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                    ...
                                    let if_write_is_err_curly_braces_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                                        &quote::quote!{acc_0e9170a3, "jsonb_build_object({value})||"},
                                        &return_err_query_part_error_named_write_into_buffer_token_stream
                                    );
                                    quote::quote! {
                                        match #field_type_as_postgresql_json_type_token_stream::#select_only_created_ids_query_part_snake_case(
                            ...
                            match (#read_only_ids_snake_case.0.#value_snake_case, #create_snake_case.0) {
                                ...
                                >::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_snake_case(
                                    ...
                                    Some(some_value) => {
                                        ...
                                        if !acc_bd78dc08.contains(&whole) {
                                            acc_bd78dc08.push(whole);
                                        }
                                        acc_bd78dc08
                                    },
                                    None => {
                                ...
                                let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                    ...
                                    quote::quote! {
                                        if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_snake_case(
                                            ...
                                            if !acc_2fe1cca8.contains(&whole) {
                                                acc_2fe1cca8.push(whole);
                                            }
                                        }
                                    }
                                });
                                    ...
                                    quote::quote! {
                                        if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_snake_case(
                                            ...
                                            for #element_snake_case in some_value.clone().into_vec() {
                                                ...
                                                if !acc_dd377eb1.contains(&handle) {
                                                    acc_dd377eb1.push(handle);
                                                }
                                            }
                                            ...
                                            if !acc_dd377eb1.contains(&whole) {
                                                acc_dd377eb1.push(whole);
                                            }
                                        }
                                    }
                                });
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote::quote!{
                                        #ident_read_upper_camel_case::new(
                                            #value_snake_case.into_iter().map(|#element_snake_case| #ident_with_id_standart_not_null_read_upper_camel_case {
                                                #(#content_token_stream),*
                                            }).collect()
                                        )
                                    }
                                    ...
                                    let parameters_token_stream = vec_syn_field.iter().map(|current_element| {
                                        ...
                                        quote::quote! {
                                            if let Some(some_value) = #value_snake_case.#field_ident {
                                                acc_ebea163e.push(#ident_standart_not_null_update_element_upper_camel_case::#field_ident_upper_camel_case(#value_content_token_stream));
                                            }
                                        }
                                    });
                                    quote::quote! {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&{
                                        ...
                                        quote::quote!{
                                            #value_snake_case.0.#value_snake_case.into_iter().fold(Vec::new(), |mut acc_cf4743b1, #element_snake_case| {
                            ...
                            let value_initialization_token_stream = generate_import_path_value_initialization_token_stream(&match &postgresql_json_object_type_pattern {
                                ...
                                PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        quote::quote! {
                                            #ident_read_upper_camel_case::new({
                                                let mut acc_5f587d35 = #value_snake_case.0.#value_snake_case.clone().into_iter().map(|#element_snake_case|{
                                    ...
                                    match #create_snake_case.0 {
                                        ...
                                        >::#create_into_postgresql_json_type_option_vec_where_length_equal_snake_case(#create_snake_case) {
                                            Some(some_value) => {
                                                ...
                                                let whole = #import_path::NullableJsonObjectPostgresqlTypeWhereFilter(Some(some_value));
                                                if !acc_5c441d3a.contains(&whole) {
                                                    acc_5c441d3a.push(whole);
                                                }
                                                acc_5c441d3a
                                            },
                                            None => {
                                        ...
                                        let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                            ...
                                            quote::quote! {
                                                if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#create_into_postgresql_json_type_option_vec_where_length_equal_snake_case(
                                                    ...
                                                    if !acc_587bf907.contains(&whole) {
                                                        acc_587bf907.push(whole);
                                                    }
                                                }
                                            }
                                        });
                                                ...
                                                for (index, #create_snake_case) in #create_snake_case.0.clone().into_iter().enumerate() {
                                                    if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#create_into_postgresql_json_type_option_vec_where_length_equal_snake_case(
                                                        ...
                                                        for #element_snake_case in some_value.clone().into_vec() {
                                                            ...
                                                            if !acc_480d72e5.contains(&handle) {
                                                                acc_480d72e5.push(handle);
                                                            }
                                                        }
                                                        let whole = #ident_where_upper_camel_case::#element_field_ident_upper_camel_case(
                                                            #import_path::PostgresqlTypeWhere::new(
                                                        ...
                                                        if !acc_480d72e5.contains(&whole) {
                                                            acc_480d72e5.push(whole);
                                                        }
                                                    }
                                                }
                                            }
                                ...
                                match #create_snake_case.0 {
                                    ...
                                    >::#create_into_postgresql_json_type_option_vec_where_length_greater_than_snake_case(
                                        ...
                                        Some(some_value) => match #import_path::NotEmptyUniqueEnumVec::try_new({
                                            ...
                                            let whole = #import_path::NullableJsonObjectPostgresqlTypeWhereFilter(Some(some_value));
                                            if !acc_87f84b5c.contains(&whole) {
                                                acc_87f84b5c.push(whole);
                                            }
                                            acc_87f84b5c
                                        }) {
                                            Ok(ok_value) => Some(ok_value),
                                        ...
                                        let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                            ...
                                            quote::quote! {
                                                if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#create_into_postgresql_json_type_option_vec_where_length_greater_than_snake_case(
                                                    ...
                                                    if !acc_f5866fb6.contains(&whole) {
                                                        acc_f5866fb6.push(whole);
                                                    }
                                                }
                                            }
                                        });
                                                ...
                                                for (index, #create_snake_case) in #create_snake_case.0.clone().into_iter().enumerate() {
                                                    if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#create_into_postgresql_json_type_option_vec_where_length_greater_than_snake_case(
                                                        ...
                                                        for #element_snake_case in some_value.clone().into_vec() {
                                                            ...
                                                            if !acc_acceb7eb.contains(&handle) {
                                                                acc_acceb7eb.push(handle);
                                                            }
                                                        }
                                                        let whole = #ident_where_upper_camel_case::#element_field_ident_upper_camel_case(
                                                            #import_path::PostgresqlTypeWhere::new(
                                                        ...
                                                        if !acc_acceb7eb.contains(&whole) {
                                                            acc_acceb7eb.push(whole);
                                                        }
                                                    }
                                                }
                                            }
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                    PostgresqlJsonObjectTypePattern::Standart => {
                                        let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&field_type);
                                            quote::quote! {
                                                if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#method_name_token_stream(
                                                    #read_only_ids_snake_case.0.#value_snake_case.#field_ident,
                                                    #create_snake_case.#field_ident
                                                ) {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        match (#read_only_ids_snake_case.0.value, #create_snake_case.0) {
                                            (Some(#read_only_ids_snake_case), Some(#create_snake_case)) => match #current_ident_token_stream::#method_name_token_stream(
                                                #read_only_ids_snake_case,
                                                #create_snake_case
                                            ) {
                                                Some(some_value) => match #import_path::NotEmptyUniqueEnumVec::try_new({
