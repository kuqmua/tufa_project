...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let (fields_token_stream, postgresql_json_object_type_array) = postgresql_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let import_path_postgresql_json_type_uuid_uuid_as_not_null_jsonb_string_read_token_stream = {
                let uuid_uuid_as_not_null_jsonb_string_read_upper_camel_case = naming::parameter::SelfReadUpperCamelCase::from_display(&uuid_uuid_as_not_null_jsonb_string_upper_camel_case);
                quote::quote!{#import_path::#uuid_uuid_as_not_null_jsonb_string_read_upper_camel_case}
            };
                ...
                (
                    postgresql_crud_macros_common::generate_impl_postgresql_json_type_test_cases_for_ident_token_stream(
                        ...
                        &match &element.postgresql_json_object_type_pattern {
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    let parameters_token_stream = vec_syn_field.iter().map(|element| {
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&element.ty);
                                        let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                            #field_type_as_postgresql_json_type_test_cases_token_stream::#update_new_or_try_new_unwraped_for_test_snake_case(#value_snake_case.#value_snake_case)
                                        });
                                        quote::quote! {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        #self_element_as_postgresql_type_update_token_stream::new(match #value_snake_case {
                                            Some(#value_snake_case) => Some(#ident_standart_not_null_as_postgresql_type_test_cases_token_stream::#update_new_or_try_new_unwraped_for_test_snake_case(#value_snake_case)),
                                            None => None
                                        })
                                    }
                                }
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        #self_element_as_postgresql_type_update_token_stream::new(match #value_snake_case {
                                            Some(#value_snake_case) => Some(#ident_with_id_array_not_null_as_postgresql_type_test_cases_token_stream::#update_new_or_try_new_unwraped_for_test_snake_case(#value_snake_case)),
                                            None => None,
                                        })
                                    }
                                }
                        ...
                        &{
                                ...
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                        quote::quote! {
                                            #ident_read_upper_camel_case::new(
                                                match &value.0.value {
                                                    Some(value) => match #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(value) {
                            ...
                            quote::quote!{Some(postgresql_crud::Value {
                                value: #content_token_stream
                            })}
                        },
                        &{
                            let fields_initialization_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                            ...
                            match &element.postgresql_json_object_type_pattern {
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        let ident_read_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            let field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                                panic!("{}", naming::FIELD_IDENT_IS_NONE);
                                            });
                                            let field_type = &element.ty;
                                            quote::quote! {
                                                #field_ident: Some(postgresql_crud::Value {
                                                    #value_snake_case: <#field_type as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(
                                                        #read_snake_case.#field_ident.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").#value_snake_case,
                                                        #field_ident
                                                    )
                                                })
                                            }
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                        ...
                                        //todo maybe use try_new constructor instead?
                                        let fields_check_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            let field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                                panic!("{}", naming::FIELD_IDENT_IS_NONE);
                                            });
                                            let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&format!("error 1a6d1d7e-0a8b-46d2-8e6e-7b9163615f71 {field_ident} is None"));
                                            quote::quote! {
                                                if #field_ident.is_none() {
                                                    panic!(#format_handle_token_stream)
                                                }
                                            }
                                        });
                                        let ident_read_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                ...
                                PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        let ident_with_id_read_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            let field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                                panic!("{}", naming::FIELD_IDENT_IS_NONE);
                                            });
                                            let field_type = &element.ty;
                                            quote::quote! {
                                                #field_ident: Some(postgresql_crud::Value {
                                                    #value_snake_case: <#field_type as postgresql_crud::PostgresqlJsonTypeTestCases>::read_from_previous_read_unwraped_merged_with_update(
                                                        found_read_element.#field_ident.expect("error 2e8229f7-38d6-48c1-93c9-e77631a3e155").#value_snake_case,
                                                        #field_ident
                                                    ),
                                                })
                                            }
                                        ...
                                        quote::quote! {
                                            match #option_update_snake_case {
                                                Some(#value_snake_case) => #ident_read_upper_camel_case({
                                                    let mut #acc_snake_case = vec![];
                                                    for update_element in #value_snake_case.#update_snake_case.0.into_vec() {
                                                        ...
                                                        #acc_snake_case.push({
                                                            #ident_with_id_standart_not_null_read_upper_camel_case {
                                                                ...
                                                                #(#ident_with_id_read_content_token_stream),*
                                                            }
                                                        });
                                                    }
                                                    #acc_snake_case
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                        ...
                                        let fields_check_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            ...
                                            let format_handle_token_stream = generate_quotes::double_quotes_token_stream(&format!("error 060af7f0-df8e-4fc9-ad2d-4fe6a1a1a5ef {field_ident} is None"));
                                            quote::quote! {
                                                if #field_ident.is_none() {
                                                    panic!(#format_handle_token_stream)
                                                }
                    ...
                    postgresql_crud_macros_common::generate_impl_postgresql_type_test_cases_for_ident_token_stream(
                        ...
                        &ident_read_inner_upper_camel_case,
                        &ident,
                        &quote::quote! {#ident_as_postgresql_json_type_test_cases_token_stream::#test_cases_snake_case(&#read_only_ids_snake_case)},
                        &quote::quote! {#ident_as_postgresql_json_type_test_cases_token_stream::#read_new_or_try_new_unwraped_for_test_snake_case(#value_snake_case)},
