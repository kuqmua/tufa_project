...
pub fn generate_postgresql_json_object_type(input_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let (fields_token_stream, postgresql_json_object_type_array) = postgresql_json_object_type_record_vec
        ...
        .map(|(index, element)| {
            ...
            let ident_with_id_standart_not_null_update_upper_camel_case = naming::parameter::SelfUpdateUpperCamelCase::from_tokens(&ident_with_id_standart_not_null_upper_camel_case);
            ...
            let ident_create_token_stream = {
                ...
                let standart_not_null_create_query_bind_content_token_stream = {
                    let create_query_bind_fields_token_stream = vec_syn_field.iter().map(|element| {
                        ...
                        let field_type_as_crud_postgresql_json_type_from_field_token_stream = generate_field_type_as_crud_postgresql_json_type_from_field_token_stream(element);
                        quote::quote! {
                            match #field_type_as_crud_postgresql_json_type_from_field_token_stream::#create_query_bind_snake_case(self.#element_field_ident, #query_snake_case) {
                                Ok(value) => {
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => quote::quote! {
                                for element in self.0 {
                                    match element.#create_query_bind_snake_case(#query_snake_case) {
                                        Ok(value) => {
                                            query = value;
                                        },
                                        Err(error) => {
                ...
                let maybe_ident_with_id_create_standart_not_null_token_stream = if is_standart_not_null {
                    ...
                    let impl_ident_with_id_create_standart_not_null_token_stream = generate_create_query_part_and_create_query_bind_token_stream(&ident_with_id_standart_not_null_create_upper_camel_case, &generate_standart_not_null_create_query_part_content_token_stream(&is_standart_with_id_true), postgresql_crud_macros_common::IsQueryBindMutable::True, &quote::quote! {#standart_not_null_create_query_bind_content_token_stream});
                    quote::quote! {
                ...
                let ident_select_token_stream = match &not_null_or_nullable {
                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                        ...
                        PostgresqlJsonObjectTypePattern::Array => generate_pub_struct_ident_select_token_stream(
                            ...
                            &quote::quote! {{
                                #ident_with_id_standart_not_null_select_snake_case: #ident_with_id_standart_not_null_as_postgresql_json_type_select_token_stream,
                ...
                let impl_ident_select_token_stream = {
                    let select_query_part_postgresql_type_token_stream = {
                        let content_token_stream = {
                            ...
                            match &postgresql_json_object_type_pattern {
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => generate_select_query_part_content_for_ident_select_or_ident_with_id_standart_not_null_select_token_stream(&is_standart_with_id_false),
                                ...
                                PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        quote::quote! {
                                            let #ident_with_id_standart_not_null_select_snake_case = #ident_with_id_standart_not_null_as_postgresql_json_type_token_stream::select_query_part(
                                                &self.#ident_with_id_standart_not_null_select_snake_case,
                                                column,
                                                &"value",
                                                &"value",
                                                true
            ...
            let ident_where_element_token_stream = match &not_null_or_nullable {
                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                ...
                                PostgresqlJsonObjectTypePattern::Array => generate_ident_where_element_wrapper_token_stream(&{
                                    ...
                                    let element_filters_token_stream = vec_syn_field_with_id.iter().map(|element| {
                                        ...
                                        quote::quote! {
                                            #element_ident_upper_camel_case(#import_path::PostgresqlTypeWhere<
                    ...
                    let maybe_ident_with_id_standart_not_null_where_element_token_stream = if is_standart_not_null {
                        let ident_with_id_standart_not_null_where_element_token_stream = generate_ident_where_element_token_stream(&ident_with_id_standart_not_null_where_element_upper_camel_case, &generate_ident_where_element_content_token_stream(&is_standart_with_id_true));
            ...
            let generate_impl_into_inner_for_ident_read_or_ident_with_id_standart_not_null_read_token_stream = |is_standart_with_id: &IsStandartWithId| {
                ...
                let content_token_stream = get_vec_syn_field(&is_standart_with_id).iter().map(|element| {
                    ...
                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                        #field_type_type_as_postgresql_json_type_token_stream::into_inner(#value_snake_case.#value_snake_case)
                    });
                    quote::quote! {
            ...
            let ident_read_token_stream = {
                ...
                let generate_impl_try_new_for_ident_read_try_from_error_named_token_stream = |is_standart_with_id: &IsStandartWithId| {
                    ...
                    quote::quote! {
                        impl #ident_token_stream {
                            pub fn try_new(#fields_declaration_token_stream) -> Result<Self, #ident_read_try_from_error_named_or_ident_with_id_standart_not_null_read_try_from_error_named_upper_camel_case> {
                ...
                let impl_new_or_try_new_for_ident_read_try_from_error_named_token_stream = {
                    let std_vec_vec_ident_with_id_standart_not_null_read_token_stream = postgresql_crud_macros_common::generate_std_vec_vec_tokens_declaration_token_stream(&ident_with_id_standart_not_null_as_postgresql_json_type_read_token_stream);
                    match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                ...
                let maybe_ident_with_id_read_token_stream = if is_standart_not_null {
                    ...
                    let impl_into_inner_for_ident_with_id_standart_not_null_read_token_stream = generate_fn_into_inner_token_stream(&ident_with_id_standart_not_null_read_upper_camel_case, &ident_with_id_standart_not_null_read_inner_upper_camel_case, &generate_impl_into_inner_for_ident_read_or_ident_with_id_standart_not_null_read_token_stream(&IsStandartWithId::True));
                    ...
                    quote::quote! {
                        ...
                        #impl_into_inner_for_ident_with_id_standart_not_null_read_token_stream
            ...
            let ident_read_inner_token_stream = {
                ...
                let maybe_ident_with_id_read_inner_token_stream = if is_standart_not_null { generate_ident_read_inner_or_ident_with_id_standart_not_null_read_inner_token_stream(&IsStandartWithId::True) } else { proc_macro2::TokenStream::new() };
                quote::quote! {
            ...
            let ident_update_token_stream = {
                ...
                let generate_create_update_delete_fields_token_stream = |should_add_serde_skip_serializing_if_vec_is_empty_annotation: &ShouldAddSerdeSkipSerializingIfVecIsEmptyAnnotation| {
                    ...
                    quote::quote! {
                        ...
                        #update_snake_case: #ident_with_id_standart_not_null_update_upper_camel_case,
                        #maybe_serde_skip_serializing_if_vec_is_empty_token_stream
                ...
                let maybe_impl_new_or_try_new_for_ident_update_token_stream = match &postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => macros_helpers::generate_impl_new_for_ident_token_stream(&ident_update_upper_camel_case, &generate_value_type_token_stream(&generate_unique_vec_wrapper_token_stream(&ident_standart_not_null_update_element_upper_camel_case)), &self_value_token_stream),
                                        ...
                                        __D: serde::Deserializer<'de>,
                                    {
                                        ...
                                        impl<'de> serde::de::Visitor<'de> for __Visitor<'de> {
                                                ...
                                                __A: serde::de::SeqAccess<'de>,
                                            {
                                                ...
                                                let __field1 = match serde::de::SeqAccess::next_element::<#ident_with_id_standart_not_null_update_upper_camel_case>(&mut __seq)? {
                                                    serde::__private::Some(__value) => __value,
                                                    serde::__private::None => {
                                                        #ident_with_id_standart_not_null_update_upper_camel_case::default()
                                                    }
                                                };
                                                ...
                                                __A: serde::de::MapAccess<'de>,
                                            {
                                                ...
                                                let mut __field1: serde::__private::Option<#ident_with_id_standart_not_null_update_upper_camel_case> = serde::__private::None;
                                                ...
                                                while let serde::__private::Some(__key) = serde::de::MapAccess::next_key::<__Field>(&mut __map)? {
                                                    match __key {
                                                        ...
                                                        __Field::__field1 => {
                                                            ...
                                                            __field1 = serde::__private::Some(serde::de::MapAccess::next_value::<#ident_with_id_standart_not_null_update_upper_camel_case>(&mut __map)?);
                                                        }
                                                        __Field::__field2 => {
                ...
                let maybe_ident_with_id_standart_not_null_update_element_token_stream = if is_standart_not_null {
                    ...
                    let ident_with_id_update_handle_token_stream = {
                        quote::quote!{
                            #[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, utoipa::ToSchema, schemars::JsonSchema)]
                            pub struct #ident_with_id_standart_not_null_update_upper_camel_case(
                    ...
                    let impl_ident_with_standart_not_null_update_handle_token_stream = {
                        let new_token_stream = {
                            quote::quote!{
                                pub fn new(value: #import_path::UniqueVec<#ident_with_id_standart_not_null_update_element_upper_camel_case>) -> Self {
                                    Self(value)
                                }
                            }
                        };
                    ...
                    let impl_default_for_ident_with_id_standart_not_null_update_handle_token_stream = {
                        quote::quote!{
                            impl std::default::Default for #ident_with_id_standart_not_null_update_upper_camel_case {
                                fn default() -> Self {
                                    Self(#import_path::UniqueVec::default())
                                }
                            }
                        }
                    };
                ...
                let acc_push_token_stream = get_vec_syn_field(&is_standart_with_id).iter().map(|element| {
                    ...
                    quote::quote! {
                        #acc_snake_case.push_str(&format!(
                            ...
                            #field_type_as_postgresql_json_type_token_stream::#select_only_ids_query_part_snake_case(&format!(#select_only_ids_query_part_format_handle_token_stream))
                        ));
                    }
                });
                quote::quote! {
            ...
            let (maybe_impl_postgresql_crud_postgresql_json_type_for_ident_token_stream, maybe_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream) = {
                let select_only_updated_ids_query_bind_token_stream = match &postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            let match_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                ...
                                quote::quote! {
                                    #ident_standart_not_null_update_element_upper_camel_case::#field_ident_upper_camel_case(value) => {
                                        match <#field_type as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(&value.value, query) {
                                            Ok(value) => {
                                                query = value;
                                            },
                                            Err(error) => {
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            quote::quote!{
                                if let Some(value) = &value.0 {
                                    match <#ident_standart_not_null_upper_camel_case as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(&value, query) {
                                        Ok(value) => {
                                            query = value;
                                        },
                                        Err(error) => {
                    ...
                    PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            quote::quote!{
                                match <#ident_with_id_standart_not_null_upper_camel_case as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(
                                    &value.update,
                                    query
                                ) {
                                    Ok(value) => {
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            quote::quote!{
                                if let Some(value) = &value.0 {
                                    match <#ident_array_not_null_upper_camel_case as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(&value, query) {
                                        Ok(value) => {
                                            query = value;
                                        },
                                        Err(error) => {
                        ...
                        let standart_nullable_token_stream = {
                            ...
                            quote::quote! {
                                ...
                                format!("jsonb_build_object('{field_ident}',jsonb_build_object('value',case when jsonb_typeof({column_name_and_maybe_field_getter_field_ident}) = 'null' then 'null'::jsonb else ({}) end))", {
                                    ...
                                    #ident_standart_not_null_as_postgresql_json_type_token_stream::select_query_part(value, field_ident, &column_name_and_maybe_field_getter_field_ident, column_name_and_maybe_field_getter_for_error_message, true)
                                })
                            }
                        };
                        let array_nullable_token_stream = {
                        ...
                        match &postgresql_json_object_type_pattern {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote::quote! {
                                        let #ident_with_id_standart_not_null_select_snake_case = #ident_with_id_standart_not_null_as_postgresql_json_type_token_stream::select_query_part(
                                            &#value_snake_case.#ident_with_id_standart_not_null_select_snake_case,
                                            field_ident,
                                            &"value",
                                            &"value",
                                            true
                        ...
                        match &postgresql_json_object_type_pattern {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote::quote! {format!(
                                        #format_handle_token_stream,
                                        #ident_with_id_standart_not_null_as_postgresql_json_type_token_stream::#select_only_ids_query_part_snake_case("elem"),
                                    )}
                                }
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let ident_with_id_array_not_null_as_postgresql_json_type_token_stream = generate_type_as_postgresql_json_type_token_stream(&ident_with_id_array_not_null_upper_camel_case);
                            ...
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let match_variants_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                        ...
                                        let field_type_as_postgresql_json_type_token_stream = generate_type_as_postgresql_json_type_token_stream(&element.ty);
                                        quote::quote! {
                                            #ident_standart_not_null_update_element_upper_camel_case::#field_ident_upper_camel_case(#value_snake_case) => {
                                    ...
                                    quote::quote! {
                                        ...
                                        let _ = #acc_snake_case.pop();
                                        let _ = #acc_snake_case.pop();
                                        Ok(format!("'{field_ident}',jsonb_build_object('value',{}),", #acc_snake_case))
                                    }
                                }
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let match_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote::quote! {
                                        Ok(format!("'{field_ident}',jsonb_build_object('value',(select jsonb_agg({}) from jsonb_array_elements({column_name_and_maybe_field_getter}->'{field_ident}') as elem)),", {
                                            match #ident_with_id_standart_not_null_as_postgresql_json_type_token_stream::#select_only_updated_ids_query_part_snake_case(
                    ...
                    &{
                        match &postgresql_json_object_type_pattern {
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let ident_as_postgresql_json_type_update_token_stream = generate_type_as_postgresql_json_type_update_token_stream(&ident);
                                    let ident_standart_not_null_as_postgresql_type_token_stream = generate_type_as_postgresql_type_token_stream(&ident_standart_not_null_upper_camel_case);
                                    quote::quote! {
                                        match value.0 {
                                            Some(#value_snake_case) => #ident_standart_not_null_as_postgresql_type_token_stream::update_query_bind(
                                                #value_snake_case,
                                                #query_snake_case
                                            ),
                                            None => if let Err(error) = #query_snake_case.try_bind(sqlx::types::Json(#ident_as_postgresql_json_type_update_token_stream::new(None))) {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        match value.0 {
                                            Some(#value_snake_case) => #ident_array_not_null_as_postgresql_type_token_stream::update_query_bind(
                                                #value_snake_case,
                                                #query_snake_case
                                            ),
                                            None => if let Err(error) = #query_snake_case.try_bind(sqlx::types::Json(#ident_as_postgresql_json_type_update_token_stream::new(None))) {
                            ...
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    quote::quote! {
                                        ...
                                        let _ = #acc_snake_case.pop();
                                        let _ = #acc_snake_case.pop();
                                        Ok(format!("jsonb_build_object('value',{}) as {column},", #acc_snake_case))
                                    }
                                }
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let match_content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
            ...
            let maybe_impl_postgresql_crud_postgresql_json_type_for_ident_with_id_not_null_token_stream = if is_standart_not_null {
                postgresql_crud_macros_common::generate_impl_postgresql_json_type_token_stream(
                    ...
                    &{
                        ...
                        generate_select_query_part_content_for_ident_select_or_ident_with_id_standart_not_null_select_token_stream(&IsStandartWithId::True)
                    },
                    &ident_with_id_standart_not_null_where_element_upper_camel_case,
                    &ident_with_id_standart_not_null_read_upper_camel_case,
                    &ident_with_id_standart_not_null_read_only_ids_upper_camel_case,
                    ...
                    &{
                        let match_variants_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                            ...
                            let field_type_as_postgresql_json_type_token_stream = generate_type_as_postgresql_json_type_token_stream(&element.ty);
                            quote::quote! {
                                #ident_standart_not_null_update_element_upper_camel_case::#field_ident_upper_camel_case(#value_snake_case) => match #field_type_as_postgresql_json_type_token_stream::#select_only_updated_ids_query_part_snake_case(
                                    &#value_snake_case.#value_snake_case,
                                    &#field_ident_double_quotes_token_stream,
                                    &column_name_and_maybe_field_getter,
                                    #increment_snake_case
                    ...
                    &{
                        ...
                        quote::quote!{
                            for element in value.0.to_vec() {
                                match <#import_path_postgresql_json_type_uuid_uuid_as_not_null_jsonb_string_token_stream as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(
                                    &element.id,
                                    #query_snake_case
                                ) {
                                    Ok(value) => {
                                ...
                                match <#ident_standart_not_null_upper_camel_case as postgresql_crud::PostgresqlJsonType>::select_only_updated_ids_query_bind(
                                    &element.fields,
                                    #query_snake_case
                                ) {
                                    Ok(value) => {
            ...
            let (impl_postgresql_type_test_cases_for_ident_token_stream, impl_postgresql_json_type_test_cases_for_ident_token_stream) = {
                    ...
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            let content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                ...
                                quote::quote! {
                                    for element0 in #field_type_as_postgresql_json_type_test_cases_token_stream::test_cases(&#read_only_ids_snake_case.0.value.#field_ident) {
                                        for element1 in element0 {
                                            ...
                                            #acc_snake_case.push(#ident_standart_not_null_read_inner_upper_camel_case {
                                                #(#fields_token_stream),*
                                            });
                                        }
                                    }
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            ...
                            quote::quote! {
                                ...
                                if let Some(#value_snake_case) = &#read_only_ids_snake_case.0.#value_snake_case {
                                    for element0 in #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::test_cases(&#value_snake_case) {
                                        for element1 in element0 {
                                            #acc_snake_case.push(Some(element1));
                                        }
                                    }
                                }
                    ...
                    PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            let content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                ...
                                quote::quote! {
                                    for element1 in #field_type_as_postgresql_json_type_test_cases_token_stream::test_cases(
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            ...
                            quote::quote! {
                                let mut #acc_snake_case = vec![];
                                if let Some(#value_snake_case) = &#read_only_ids_snake_case.0.#value_snake_case {
                                    for element0 in #ident_array_not_null_as_postgresql_json_type_test_cases_token_stream::test_cases(&#value_snake_case) {
                                        for element1 in element0 {
                                            #acc_snake_case.push(Some(element1));
                                        }
                                    }
                ...
                let read_new_or_try_new_unwraped_for_test_token_stream = match &element.postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            let self_element_as_postgresql_type_read_token_stream = generate_type_as_postgresql_type_subtype_token_stream(&quote::quote!{Self::Element}, &PostgresqlTypeSubtype::Read);
                    ...
                    PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            let ident_with_id_standart_not_null_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&ident_with_id_standart_not_null_upper_camel_case);
                            quote::quote!{
                                #ident_read_upper_camel_case::new({
                                    let mut #acc_snake_case = vec![];
                                    for #element_snake_case in #value_snake_case {
                                        #acc_snake_case.push(
                                            #ident_with_id_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#read_new_or_try_new_unwraped_for_test_snake_case(#element_snake_case)
                                        );
                                    }
                                    #acc_snake_case
                                })
                ...
                let update_new_or_try_new_unwraped_for_test_token_stream = match &element.postgresql_json_object_type_pattern {
                    PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            let self_element_as_postgresql_type_update_token_stream = generate_type_as_postgresql_type_subtype_token_stream(&quote::quote!{Self::Element}, &PostgresqlTypeSubtype::Update);
                            let parameters_token_stream = vec_syn_field.iter().map(|element| {
                                let field_ident = element.ident.as_ref().unwrap_or_else(|| {
                                    panic!("{}", naming::FIELD_IDENT_IS_NONE);
                                });
                                ...
                                let field_type_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&element.ty);
                                let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                    #field_type_as_postgresql_json_type_test_cases_token_stream::update_new_or_try_new_unwraped_for_test(#value_snake_case.#value_snake_case)
                                });
                                quote::quote! {
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            ...
                            quote::quote! {
                                #self_element_as_postgresql_type_update_token_stream::new(match #value_snake_case {
                                    Some(#value_snake_case) => Some(#ident_standart_not_null_as_postgresql_type_test_cases_token_stream::update_new_or_try_new_unwraped_for_test(#value_snake_case)),
                                    None => None
                                })
                            }
                        }
                    ...
                    PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    ...
                                    #ident_with_id_standart_not_null_update_upper_camel_case::new(
                                        #import_path::UniqueVec::try_new(
                                            #value_snake_case.into_iter().map(|#element_snake_case| #ident_with_id_standart_not_null_update_element_upper_camel_case {
                                                ...
                                                fields: #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::update_new_or_try_new_unwraped_for_test(
                        ...
                        postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                            ...
                            quote::quote! {
                                #self_element_as_postgresql_type_update_token_stream::new(match #value_snake_case {
                                    Some(#value_snake_case) => Some(#ident_with_id_array_not_null_as_postgresql_type_test_cases_token_stream::update_new_or_try_new_unwraped_for_test(#value_snake_case)),
                                    None => None,
                                })
                            }
                        }
                ...
                let update_to_read_only_ids_token_stream = match &element.postgresql_json_object_type_pattern {
                    ...
                    PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                        postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                            ...
                            let value_content_token_stream = wrap_into_value_initialization_token_stream(&{
                                let uuid_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&import_path_postgresql_json_type_uuid_uuid_as_not_null_jsonb_string_token_stream);
                                let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                ...
                                quote::quote!{
                                    #value_snake_case.#update_snake_case.0.to_vec().iter().map(|#element_snake_case|{
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    ...
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                        #value_snake_case.0.#value_snake_case.into_iter().fold(vec![], |mut #acc_snake_case, #element_snake_case| {
                                            //is it right?
                                            if let Some(#value_snake_case) = #ident_with_id_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_option_value_read_inner_snake_case(#element_snake_case) {
                                                #acc_snake_case.push(#value_snake_case.#value_snake_case);
                                            }
                                            #acc_snake_case
                                        })
                                    });
