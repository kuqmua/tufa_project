...
pub fn generate_postgresql_json_object_type(
    ...
    let postgresql_json_object_type_record_vec = {
        ...
        match generate_postgresql_json_object_type_config {
            GeneratePostgresqlJsonObjectTypeConfig::All => postgresql_crud_macros_common::NotNullOrNullable::into_array().into_iter().fold(Vec::new(), |mut acc, not_null_or_nullable| {
        ...
        .map(|(index, element)| {
            ...
            let vec_syn_field = if let syn::Data::Struct(data_struct) = &syn_derive_input.data {
                if let syn::Fields::Named(fields_named) = &data_struct.fields {
                    ...
                    .iter()
                    .map(|current_element|macros_helpers::SynFieldWrapper {
                        field_visibility: current_element.vis.clone(),
                        field_ident: current_element.ident.clone().expect("3ac7f263-e0bf-4c5b-9d44-57edf50f79b5"),
                        field_type: current_element.ty.clone(),
                    })
            ...
            let generate_ident_table_type_declaration_or_ident_create_common_token_stream = |postgresql_json_type_subtype_table_type_declaration_or_create: &PostgresqlJsonTypeSubtypeTableTypeDeclarationOrCreate| {
                ...
                let generate_self_content_for_ident_or_ident_with_id_table_type_declaration_or_create_token_stream = |is_standart_with_id: &IsStandartWithId| {
                    let content_token_stream = get_vec_syn_field(is_standart_with_id).iter().map(|current_element|&current_element.field_ident);
            ...
            |{
                let content_token_stream = get_vec_syn_field(is_standart_with_id).iter().map(|current_element| {
                    ...
                    quote::quote! {
                        #ident_or_ident_with_id_standart_not_null_select_element_upper_camel_case::#variant_name_token_stream(#value_snake_case) => match #field_type_as_crud_postgresql_json_type_from_field_token_stream::#select_query_part_snake_case(
                            #value_snake_case,
            ...
            let ident_read_token_stream = {
                ...
                let impl_ident_read_token_stream = {
                    ...
                    let into_inner_token_stream = {
                            ...
                            let generate_impl_into_inner_for_ident_read_or_ident_with_id_standart_not_null_read_token_stream = |is_standart_with_id: &IsStandartWithId| {
                                ...
                                let content_token_stream = get_vec_syn_field(is_standart_with_id).iter().map(|current_element| {
                                    ...
                                    let content_token_stream = wrap_into_value_initialization_token_stream(&generate_into_inner_token_stream(
                                        ...
                                        &quote::quote!{some_value.#value_snake_case},
                                    ));
                        ...
                        quote::quote!{
                            fn into_inner(self) -> #ident_read_inner_upper_camel_case {
                                #content_token_stream
                            }
                        }
                    };
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let match_variants_token_stream = vec_syn_field.iter().map(|current_element| {
                                        ...
                                        let if_write_is_err_curly_braces_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                                            &quote::quote!{#acc_snake_case, "jsonb_build_object({value})||"},
                                            &return_err_query_part_error_named_write_into_buffer_token_stream
                                        );
                                        quote::quote! {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let match_variants_token_stream = vec_syn_field.iter().map(|current_element| {
                                        ...
                                        let field_type_as_postgresql_json_type_token_stream = generate_type_as_postgresql_json_type_token_stream(&current_element.field_type);
                                        let if_write_is_err_curly_braces_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                                            &quote::quote!{current_acc, "jsonb_build_object({value})||"},
                                            &return_err_query_part_error_named_write_into_buffer_token_stream
                                        );
                                        quote::quote! {
                                    ...
                                    let if_write_is_err_curly_braces_1_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                                        &quote::quote!{#acc_snake_case, "{current_acc}||"},
                                        &return_err_query_part_error_named_write_into_buffer_token_stream
                                    );
            ...
            let (impl_postgresql_crud_postgresql_json_type_for_ident_token_stream, maybe_impl_postgresql_crud_postgresql_types_postgresql_type_postgresql_type_token_stream) = {
                ...
                let generate_update_query_part_standart_nullable_token_stream = |postgresql_type_or_postgresql_json_type: &postgresql_crud_macros_common::PostgresqlTypeOrPostgresqlJsonType|{
                    ...
                    quote::quote! {
                        match &#value_snake_case.0 {
                            Some(some_value) => #ident_standart_not_null_as_postgresql_json_type_token_stream::#update_query_part_snake_case(
                                some_value,
                ...
                let generate_update_delete_create_array_token_stream = |format_handle_token_stream: &dyn quote::ToTokens|{
                    ...
                    let if_write_is_err_curly_braces_0_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                        &quote::quote!{#acc_snake_case, "{maybe_space_and_space}elem->>'id' <> ${increment}"},
                        &return_err_query_part_error_named_write_into_buffer_token_stream
                    );
                    let if_write_is_err_curly_braces_1_token_stream = macros_helpers::generate_if_write_is_err_curly_braces_token_stream(
                        &quote::quote!{#acc_snake_case, "${increment},"},
                        &return_err_query_part_error_named_write_into_buffer_token_stream
                    );
                    quote::quote! {
                ...
                let impl_postgresql_crud_postgresql_json_type_for_ident_token_stream = postgresql_crud_macros_common::generate_impl_postgresql_json_type_token_stream(
                    ...
                    &match &postgresql_json_object_type_pattern {
                        ...
                        PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                                match &#value_snake_case.0 {
                                    Some(some_value) => #ident_array_not_null_as_postgresql_json_type_token_stream::#update_query_part_snake_case(
                                        some_value,
                                        jsonb_set_accumulator,
                                        jsonb_set_target,
                                        jsonb_set_path,
                    ...
                    &match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                                match #value_snake_case.0 {
                                    Some(some_value) => #ident_standart_not_null_as_postgresql_json_type_token_stream::update_query_bind(
                                        some_value,
                                        #query_snake_case
                                    ),
                        ...
                        PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                                match #value_snake_case.0 {
                                    Some(some_value) => #ident_array_not_null_as_postgresql_json_type_token_stream::update_query_bind(
                                        some_value,
                                        #query_snake_case
                                    ),
                                    None => if let Err(#error_snake_case) = #query_snake_case.try_bind(sqlx::types::Json(#self_as_postgresql_json_type_update_token_stream::new(None))) {
                    ...
                    &match &postgresql_json_object_type_pattern {
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote!{
                                if let Some(some_value) = &#value_snake_case.0 {
                                    match #ident_standart_not_null_as_postgresql_json_type_token_stream::#select_only_updated_ids_query_bind_snake_case(some_value, #query_snake_case) {
                                        Ok(ok_value) => {
                                            #query_snake_case = ok_value;
                                        },
                                        Err(#error_snake_case) => {
                        ...
                        PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote!{
                                if let Some(some_value) = &#value_snake_case.0 {
                                    match #ident_array_not_null_as_postgresql_json_type_token_stream::#select_only_updated_ids_query_bind_snake_case(some_value, #query_snake_case) {
                                        Ok(ok_value) => {
                                            #query_snake_case = ok_value;
                                        },
                                        Err(#error_snake_case) => {
                    ...
                    &match &postgresql_json_object_type_pattern {
                        ...
                        PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                quote::quote!{
                                    if let Some(some_value) = &#value_snake_case.0 {
                                        match #ident_array_not_null_as_import_path_postgresql_json_type_token_stream::#select_only_created_ids_query_bind_snake_case(some_value, #query_snake_case) {
                                            Ok(ok_value) => {
                                                #query_snake_case = ok_value;
                                            }
                                            Err(#error_snake_case) => {
                                        ...
                                        #acc_snake_case.push(
                                            #import_path::NullableJsonObjectPostgresqlTypeWhereFilter(
                                                Some(
                                                    ...
                                                    ).expect("604b888c-923d-4c11-98a6-a5b523f2e91b")
                                                )
                                            )
                                        );
                                    }
                        ...
                        PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                    ...
                                    quote::quote! {
                                        if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_snake_case(
                                            #read_only_ids_snake_case.0.#value_snake_case.#field_ident,
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                    ...
                                    quote::quote! {
                                        if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_dimension_number_equal_snake_case(
                                            ...
                                            for #element_snake_case in some_value.clone().into_vec() {
                                                let handle = #ident_where_upper_camel_case::#element_field_ident_upper_camel_case(
                                                    #import_path::PostgresqlTypeWhere::try_new(
                                                        #import_path::LogicalOperator::And,
                                                        vec![#element_snake_case]
                                ...
                                let maybe_dimension_one_token_stream = match &dimension {
                                    postgresql_crud_macros_common::Dimension::One => {
                                        ...
                                        quote::quote!{
                                            #acc_snake_case.push(#ident_where_upper_camel_case::DimensionOneEqual(#import_path::PostgresqlJsonTypeWhereDimensionOneEqual {
                ...
                (
                    {
                        let option_vec_create_token_stream = {
                            let content_token_stream = match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                    PostgresqlJsonObjectTypePattern::Standart => {
                                        let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                            ...
                                            quote::quote! {
                                                if let Some(some_value) = #field_type_type_as_postgresql_json_type_test_cases_token_stream::#option_vec_create_snake_case() {
                                            ...
                                            quote::quote! {
                                                if let Some(vec_create) = #field_type_type_as_postgresql_json_type_test_cases_token_stream::#option_vec_create_snake_case() {
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        if !#acc_snake_case.contains(&current_value) {
                                                            #acc_snake_case.push(current_value);
                                                        }
                                                    }
                                                    if let Some(some_value) = option_additional {
                                                        if has_len_greater_than_one {
                                                            let current_value = some_value.0;
                                                            if !#acc_snake_case.contains(&current_value) {
                                                                #acc_snake_case.push(current_value);
                                                            }
                                                        }
                                                        if !has_len_greater_than_one {
                                                            let current_value = some_value.1;
                                                            if !#acc_snake_case.contains(&current_value) {
                                                                #acc_snake_case.push(current_value);
                                                            }
                                                        }
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        if let Some(some_value) = #current_ident_not_null_as_postgresql_json_type_test_cases_token_stream::#option_vec_create_snake_case() {
                                            for #element_snake_case in some_value {
                        ...
                        let read_only_ids_to_two_dimensional_vec_read_inner_token_stream = match &postgresql_json_object_type_pattern {
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    quote::quote! {
                                        let mut #acc_snake_case = Vec::new();
                                        if let Some(some_value) = &#read_only_ids_snake_case.0.#value_snake_case {
                                            for element0 in #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_read_inner_snake_case(some_value) {
                                                for element1 in element0 {
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    quote::quote! {
                                        let mut #acc_snake_case = Vec::new();
                                        if let Some(some_value) = &#read_only_ids_snake_case.0.#value_snake_case {
                                            for element0 in #ident_array_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_read_inner_snake_case(some_value) {
                                                for element1 in element0 {
                                                    #acc_snake_case.push(vec![Some(element1)]);
                                                }
                                            }
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let content_token_stream = vec_syn_field_with_id.iter().map(|current_element| {
                                        ...
                                        quote::quote! {#field_ident: #element_snake_case.#field_ident.map(|#value_snake_case|#value_content_token_stream)}
                                    });
                                    quote::quote!{
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                PostgresqlJsonObjectTypePattern::Standart => {
                                    ...
                                    let parameters_token_stream = vec_syn_field.iter().map(|current_element| {
                                        ...
                                        let field_type_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&current_element.field_type);
                                        let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                            #field_type_as_postgresql_json_type_test_cases_token_stream::#read_inner_into_update_with_new_or_try_new_unwraped_snake_case(some_value.#value_snake_case)
                                        });
                                        quote::quote! {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                        match #value_snake_case.0.#value_snake_case {
                                            Some(some_value0) => match #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_into_option_value_read_inner_snake_case(some_value0) {
                                                Some(some_value1) => Some(some_value1.#value_snake_case),
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&{
                                        ...
                                        quote::quote!{
                                            #value_snake_case.0.#value_snake_case.into_iter().fold(Vec::new(), |mut #acc_snake_case, #element_snake_case| {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                        match #value_snake_case.0.#value_snake_case {
                                            Some(some_value0) => match #ident_array_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_into_option_value_read_inner_snake_case(
                                                some_value0
                                            ) {
                                                Some(some_value1) => Some(some_value1.#value_snake_case),
                                                None => None,
                        ...
                        let update_to_read_only_ids_token_stream = match &postgresql_json_object_type_pattern {
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&{
                                        quote::quote!{
                                            match &#value_snake_case.0 {
                                                Some(some_value) => Some(#ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#update_to_read_only_ids_snake_case(some_value)),
                                                None => None
                                            }
                                        }
                                    });
                            ...
                            PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    let value_content_token_stream = wrap_into_value_initialization_token_stream(&quote::quote!{
                                        match &#value_snake_case.0 {
                                            Some(some_value) => Some(#ident_array_not_null_as_postgresql_json_type_test_cases_token_stream::#update_to_read_only_ids_snake_case(some_value)),
                                            None => None,
                                        }
                                    });
                                    quote::quote! {#ident_read_only_ids_upper_camel_case(#value_content_token_stream)}
                            ...
                            let value_initialization_token_stream = generate_import_path_value_initialization_token_stream(&match &postgresql_json_object_type_pattern {
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                                        #ident_read_upper_camel_case::new(
                                            match &#value_snake_case.0.#value_snake_case {
                                                Some(some_value0) => match #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(some_value0) {
                                                    Some(some_value1) => Some(some_value1.#value_snake_case),
                                                    None => None,
                                                }
                                                None => None
                                ...
                                PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote! {
                                        #ident_read_upper_camel_case::new(
                                            match &#value_snake_case.0.#value_snake_case {
                                                Some(some_value0) => match #ident_array_not_null_as_postgresql_json_type_test_cases_token_stream::read_only_ids_to_option_value_read_default_but_option_is_always_some_and_vec_always_contains_one_element(
                                                    some_value0
                                                ) {
                                                    Some(some_value1) => Some(some_value1.#value_snake_case.0),
                                                    None => None,
                                                },
                                                None => None
                                            }
                            ...
                            let generate_option_token_stream = |current_postgresql_json_object_type_pattern: &PostgresqlJsonObjectTypePattern|{
                                ...
                                quote::quote! {
                                    match #option_update_snake_case {
                                        Some(some_value0) => #ident_read_upper_camel_case(
                                            match some_value0.0 {
                                                Some(some_value1) => Some(
                            ...
                            match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                    PostgresqlJsonObjectTypePattern::Standart => {
                                        ...
                                        quote::quote!{
                                            match #option_update_snake_case {
                                                Some(some_value) => {
                                                    #(#fields_initialization_content_token_stream)*
                                                    for #element_snake_case in some_value.0.into_vec() {
                                                        match #element_snake_case {
                                                            #(#match_content_token_stream),*
                                                        }
                                                    }
                                    ...
                                    PostgresqlJsonObjectTypePattern::Array => {
                                        ...
                                        quote::quote! {
                                            match #option_update_snake_case {
                                                Some(some_value) => #ident_read_upper_camel_case({
                                                    let mut #acc_snake_case = Vec::new();
                                                    for update_element in some_value.#update_snake_case.into_vec() {
                            ...
                            let content_token_stream = match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        #import_path::NullableJsonObjectPostgresqlTypeWhereFilter(
                                            match (#read_only_ids_snake_case.0.#value_snake_case, #create_snake_case.0) {
                                                (Some(#read_only_ids_snake_case), Some(#create_snake_case)) => Some(#content_token_stream),
                            ...
                            PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => quote::quote!{
                                    #import_path::NotEmptyUniqueEnumVec::try_new({
                                        ...
                                        match (#read_only_ids_snake_case.0.#value_snake_case, #create_snake_case.0) {
                                            (Some(#read_only_ids_snake_case), Some(#create_snake_case)) => {
                                                for #element_snake_case in #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_vec_where_equal_to_json_field_snake_case(
                                                    #read_only_ids_snake_case,
                                                    #create_snake_case
                                                ).into_vec() {
                                                    #acc_snake_case.push(
                                ...
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&current_element.field_type);
                                            quote::quote! {
                                                if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#create_into_postgresql_json_type_option_vec_where_length_equal_snake_case(
                                                    #create_snake_case.#field_ident
                                                ) {
                                                    for #element_snake_case in some_value.clone().into_vec() {
                                                        #acc_snake_case.push(
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        quote::quote! {
                                            match #import_path::NotEmptyUniqueEnumVec::try_new({
                                                let mut #acc_snake_case = Vec::new();
                                                #(#content_token_stream)*
                                                #acc_snake_case.push(#ident_where_upper_camel_case::LengthEqual(
                                ...
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                            ...
                                            let field_type_as_postgresql_json_type_test_cases_token_stream = generate_type_as_postgresql_json_type_test_cases_token_stream(&current_element.field_type);
                                            quote::quote! {
                                                if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#create_into_postgresql_json_type_option_vec_where_length_greater_than_snake_case(
                                                    #create_snake_case.#field_ident
                                                ) {
                                                    for #element_snake_case in some_value.clone().into_vec() {
                                                        #acc_snake_case.push(
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        quote::quote! {
                                            match #import_path::NotEmptyUniqueEnumVec::try_new({
                                                let mut #acc_snake_case = Vec::new();
                                                #(#content_token_stream)*
                                                #acc_snake_case.push(#ident_where_upper_camel_case::LengthGreaterThan(
                        ...
                        let read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_token_stream = match &not_null_or_nullable {
                            postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                PostgresqlJsonObjectTypePattern::Standart => {
                                    let content_token_stream = vec_syn_field.iter().map(|current_element| {
                                        let field_ident = &current_element.field_ident;
                                        ...
                                        quote::quote! {
                                            if let Some(some_value) = #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_snake_case(
                                                ...
                                                for #element_snake_case in <#import_path::NotEmptyUniqueEnumVec<#field_type_where_upper_camel_case> as Into<Vec<#field_type_where_upper_camel_case>>>::into(some_value.clone()) {
                                                    #acc_snake_case.push(
                                                        #ident_where_upper_camel_case::#field_ident_upper_camel_case(
                                                            #import_path::PostgresqlTypeWhere::try_new(
                                                                #import_path::LogicalOperator::And,
                                ...
                                PostgresqlJsonObjectTypePattern::Array => {
                                    ...
                                    quote::quote! {
                                        // #import_path::NotEmptyUniqueEnumVec::try_new({
                                        //     let mut acc: Vec<Vec<<Self::PostgresqlJsonType as postgresql_crud::PostgresqlJsonType>::Where>> = Vec::new();
                                        //     for (read_only_ids, create) in read_only_ids.0.value.into_iter().zip(create.0.into_iter()) {
                                        //         let option_field_0 = <postgresql_crud::StdPrimitiveI8AsNotNullJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than(
                                        //             read_only_ids.0.value.field_0,
                                        //             create.field_0
                                        //         );
                                        //         let option_field_1 = <postgresql_crud::OptionStdPrimitiveI8AsNullableJsonbNumber as postgresql_crud::PostgresqlJsonTypeTestCases>::read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than(
                                        //             read_only_ids.0.value.field_1,
                                        //             create.field_1
                                        //         );
                                        //         if option_field_0.is_some() || option_field_1.is_some() {
                                        //             let id = VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhere::ElementId(
                                        //                 postgresql_crud::PostgresqlTypeWhere::try_new(
                                        //                     postgresql_crud::LogicalOperator::And,
                                        //                     vec![postgresql_crud::UuidUuidAsNotNullJsonbStringWhere::Equal(postgresql_crud::PostgresqlJsonTypeWhereEqual {
                                        //                         logical_operator: postgresql_crud::LogicalOperator::Or,
                                        //                         value: postgresql_crud::UuidUuidAsNotNullJsonbStringTableTypeDeclaration::new(read_only_ids.0.value.id.0.value),
                                        //                     })],
                                        //                 )
                                        //                 .expect("31db8e1e-28cd-44f7-9f32-a41cc6675660"),
                                        //             );
                                        //             if let Some(some_value) = option_field_0 {
                                        //                 let mut current_acc = vec![];
                                        //                 for element in some_value.clone().into_vec() {
                                        //                     current_acc.push(vec![
                                        //                         id.clone(),
                                        //                         VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhere::ElementField0(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("2ed4dc5e-b893-4bd9-b05c-ffd3bab797cd")),
                                        //                     ]);
                                        //                 }
                                        //                 let whole = vec![id.clone(), VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhere::ElementField0(postgresql_crud::PostgresqlTypeWhere::new(postgresql_crud::LogicalOperator::And, some_value))];
                                        //                 if !current_acc.contains(&whole) {
                                        //                     current_acc.push(whole);
                                        //                 }
                                        //                 for element in current_acc {
                                        //                     acc.push(element);
                                        //                 }
                                        //             }
                                        //             if let Some(some_value) = option_field_1 {
                                        //                 let mut current_acc = vec![];
                                        //                 for element in some_value.clone().into_vec() {
                                        //                     current_acc.push(vec![
                                        //                         id.clone(),
                                        //                         VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhere::ElementField1(postgresql_crud::PostgresqlTypeWhere::try_new(postgresql_crud::LogicalOperator::And, vec![element]).expect("82c0abf5-2727-4773-b5bf-09a4a437b428")),
                                        //                     ]);
                                        //                 }
                                        //                 let whole = vec![id.clone(), VecOfAnimalWithIdAsNotNullArrayOfNotNullJsonbObjectWithIdWhere::ElementField1(postgresql_crud::PostgresqlTypeWhere::new(postgresql_crud::LogicalOperator::And, some_value))];
                                        //                 if !current_acc.contains(&whole) {
                                        //                     current_acc.push(whole);
                                        //                 }
                                        //                 for element in current_acc {
                                        ...
                                        //     }
                                        //     acc
                                        // }).expect("1460138a-8364-4e3e-9986-75fa2829f6c5")
                                        // let acc = vec![];
                            ...
                            postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                ...
                                quote::quote! {
                                    match (#read_only_ids_snake_case.0.value, #create_snake_case.0) {
                                        (Some(#read_only_ids_snake_case), Some(#create_snake_case)) => match #current_ident_token_stream::#read_only_ids_merged_with_create_into_postgresql_json_type_option_vec_where_greater_than_snake_case(
                                            #read_only_ids_snake_case,
                                            #create_snake_case
                                        ) {
                                            Some(some_value) => Some(
                                                #import_path::NotEmptyUniqueEnumVec::try_new(vec![
                                                    #import_path::NullableJsonObjectPostgresqlTypeWhereFilter(Some(some_value))
                                                ]).expect("4155b8a5-7d8e-47d8-b19f-221bf30fca6c")
                                            ),
                                            None => None,
                                        },
