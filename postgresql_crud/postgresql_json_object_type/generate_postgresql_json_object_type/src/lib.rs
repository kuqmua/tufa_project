            ...
            let (impl_postgresql_json_type_test_cases_for_ident_token_stream, impl_postgresql_type_test_cases_for_ident_token_stream) = {
                ...
                (
                        ...
                        postgresql_crud_macros_common::generate_impl_postgresql_json_type_test_cases_for_ident_token_stream(
                            ...
                            &match &not_null_or_nullable {
                                postgresql_crud_macros_common::NotNullOrNullable::NotNull => match &postgresql_json_object_type_pattern {
                                    PostgresqlJsonObjectTypePattern::Standart => {
                                        let content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            ...
                                            quote::quote! {
                                                for #element_snake_case in #field_type_type_as_postgresql_json_type_test_cases_token_stream::#vec_create_snake_case() {
                                            ...
                                            quote::quote! {
                                                {
                                                    ...
                                                    let vec_create = #field_type_type_as_postgresql_json_type_test_cases_token_stream::#vec_create_snake_case();
                                ...
                                postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                    ...
                                    quote::quote! {
                                        let mut #acc_snake_case = vec![];
                                        for #element_snake_case in #current_ident_not_null_as_postgresql_json_type_test_cases_token_stream::#vec_create_snake_case() {
                                ...
                                PostgresqlJsonObjectTypePattern::Standart => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        ...
                                        let content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            ...
                                            quote::quote! {
                                                for element0 in #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_of_read_inner_snake_case(&#read_only_ids_snake_case.0.value.#field_ident) {
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                        quote::quote! {
                                            ...
                                            if let Some(#value_snake_case) = &#read_only_ids_snake_case.0.#value_snake_case {
                                                for element0 in #ident_standart_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_of_read_inner_snake_case(&#value_snake_case) {
                                                    for element1 in element0 {
                                ...
                                PostgresqlJsonObjectTypePattern::Array => match &not_null_or_nullable {
                                    postgresql_crud_macros_common::NotNullOrNullable::NotNull => {
                                        let content_token_stream = get_vec_syn_field(&is_standart_with_id_false).iter().map(|element| {
                                            ...
                                            quote::quote! {
                                                for element1 in #field_type_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_of_read_inner_snake_case(
                                    ...
                                    postgresql_crud_macros_common::NotNullOrNullable::Nullable => {
                                        quote::quote! {
                                            let mut #acc_snake_case = vec![];
                                            if let Some(#value_snake_case) = &#read_only_ids_snake_case.0.#value_snake_case {
                                                for element0 in #ident_array_not_null_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_of_read_inner_snake_case(&#value_snake_case) {
                                                    for element1 in element0 {
                                                        #acc_snake_case.push(vec![Some(element1)]);
                                                    }
                                                }
                    ...
                    postgresql_crud_macros_common::generate_impl_postgresql_type_test_cases_for_ident_token_stream(
                        ...
                        &ident_read_inner_upper_camel_case,
                        &ident,
                        &quote::quote! {#ident_as_postgresql_json_type_test_cases_token_stream::#vec_create_snake_case()},
                        &quote::quote! {#ident_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_to_two_dimensional_vec_of_read_inner_snake_case(&#read_only_ids_snake_case)},
                        ...
                        &quote::quote! {#ident_as_postgresql_json_type_test_cases_token_stream::#read_only_ids_merged_with_create_into_where_element_equal_using_fields_snake_case(
                            #read_only_ids_snake_case,
                            #create_snake_case
                        )},
