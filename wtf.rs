impl Example { pub fn table_name() -> & 'static str { "example" } }
#[derive(Debug, serde :: Serialize, serde :: Deserialize)] pub struct
ExampleOptions
{
    #[serde(skip_serializing_if = "Option::is_none")] pub
    std_primitive_i64_as_postgresql_big_serial_not_null : std :: option ::
    Option < postgresql_crud :: Value <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToRead
    > > , #[serde(skip_serializing_if = "Option::is_none")] pub
    std_primitive_bool_as_postgresql_bool : std :: option :: Option <
    postgresql_crud :: Value <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolToRead
    > > , #[serde(skip_serializing_if = "Option::is_none")] pub
    std_primitive_bool_as_postgresql_bool_not_null : std :: option :: Option <
    postgresql_crud :: Value <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullToRead
    > >
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, PartialEq, Clone,)]
pub enum ExampleColumn
{
    #[serde(rename(serialize = "std_primitive_bool_as_postgresql_bool",
    deserialize = "std_primitive_bool_as_postgresql_bool"))]
    StdPrimitiveBoolAsPostgresqlBool(std :: vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolColumn
    >),
    #[serde(rename(serialize =
    "std_primitive_bool_as_postgresql_bool_not_null", deserialize =
    "std_primitive_bool_as_postgresql_bool_not_null"))]
    StdPrimitiveBoolAsPostgresqlBoolNotNull(std :: vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullColumn
    >),
    #[serde(rename(serialize =
    "std_primitive_i64_as_postgresql_big_serial_not_null", deserialize =
    "std_primitive_i64_as_postgresql_big_serial_not_null"))]
    StdPrimitiveI64AsPostgresqlBigSerialNotNull(std :: vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullColumn
    >)
} impl std :: fmt :: Display for ExampleColumn
{
    fn fmt(& self, formatter : & mut std :: fmt :: Formatter < '_ >) -> std ::
    fmt :: Result
    {
        write!
        (formatter, "{}", serde_json ::
        to_string(&
        self).unwrap_or_else(| e | format!
        ("cannot serialize into json: {e:?}")))
    }
...
for ExampleColumn
{
    ...
    -> std :: vec :: Vec < Self >
    {
        vec!
        [ExampleColumn ::
        StdPrimitiveBoolAsPostgresqlBool(postgresql_crud ::
        AllEnumVariantsArrayStdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
        ::
        all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()),
        ExampleColumn ::
        StdPrimitiveBoolAsPostgresqlBoolNotNull(postgresql_crud ::
        AllEnumVariantsArrayStdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
        ::
        all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()),
        ExampleColumn ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNull(postgresql_crud ::
        AllEnumVariantsArrayStdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
        ::
        all_enum_variants_array_default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element())]
    }
} impl ExampleColumn
{
    fn pick_column(& self) -> std :: string :: String
    {
        match & self
        {
            Self :: StdPrimitiveBoolAsPostgresqlBool(_) =>
            "std_primitive_bool_as_postgresql_bool".to_string(), Self ::
            StdPrimitiveBoolAsPostgresqlBoolNotNull(_) =>
            "std_primitive_bool_as_postgresql_bool_not_null".to_string(), Self
            :: StdPrimitiveI64AsPostgresqlBigSerialNotNull(_) =>
            "std_primitive_i64_as_postgresql_big_serial_not_null".to_string()
        }
    }
} pub const ALLOW_METHODS : [http :: Method; 4] =
[http :: Method :: GET, http :: Method :: POST, http :: Method :: PATCH, http
:: Method :: DELETE]; #[derive(Debug, Clone, Copy)] pub struct
ExampleColumnReadPermission
{
    ...
    std_primitive_i64_as_postgresql_big_serial_not_null : std :: primitive ::
    bool
} pub async fn
create_table_if_not_exists(pool : & sqlx :: Pool < sqlx :: Postgres >)
{
    let create_extension_if_not_exists_pg_jsonschema_query_stringified =
    "create extension if not exists pg_jsonschema"; println!
    ("{create_extension_if_not_exists_pg_jsonschema_query_stringified}"); let
    _ = sqlx ::
    query(create_extension_if_not_exists_pg_jsonschema_query_stringified).execute(pool).await.unwrap();
    ...
    < postgresql_crud :: postgresql_types :: base_wrap ::
    StdPrimitiveI64AsPostgresqlBigSerialNotNull as postgresql_crud ::
    CreateTableQueryPart > :: create_table_query_part(), < postgresql_crud ::
    postgresql_types :: base_wrap :: StdPrimitiveBoolAsPostgresqlBool as
    postgresql_crud :: CreateTableQueryPart > :: create_table_query_part(), <
    postgresql_crud :: postgresql_types :: base_wrap ::
    StdPrimitiveBoolAsPostgresqlBoolNotNull as postgresql_crud ::
    CreateTableQueryPart > :: create_table_query_part()); println!
    ("{create_table_if_not_exists_query_stringified}"); let _ = sqlx ::
    query(&
    create_table_if_not_exists_query_stringified).execute(pool).await.unwrap();
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct CreateManyPayloadElement
{
    pub std_primitive_bool_as_postgresql_bool :
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolToCreate,
    pub std_primitive_bool_as_postgresql_bool_not_null :
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullToCreate
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct
...
TryCreateManyRouteLogicResponseVariants
{
    ...
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToCreate
    >), CheckBodySize
    {
        check_body_size : postgresql_crud :: check_body_size ::
    ...
    {
        serde_json : std :: string :: String, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence,
    }, CheckCommit
    {
        check_commit : postgresql_crud :: check_commit ::
    ...
    {
        row : std :: string :: String, rollback : std :: string :: String,
        code_occurence : error_occurence_lib :: code_occurence ::
        CodeOccurence,
    }, UnexpectedRowsLength
    {
        expected_length : std :: string :: String, got_length : std :: string
...
TryCreateManyRouteLogicResponseVariants
{
    fn from(value : TryCreateManyRouteLogicErrorNamed) -> Self
    {
        match value.into_serialize_deserialize_version()
        {
            ...
            TryCreateManyRouteLogicErrorNamedWithSerializeDeserialize ::
            UnexpectedRowsLength
            { expected_length, got_length, code_occurence } => Self ::
            UnexpectedRowsLength
            { expected_length, got_length, code_occurence },
            TryCreateManyRouteLogicErrorNamedWithSerializeDeserialize ::
            UnexpectedRowsLengthAndRollback
            { expected_length, got_length, rollback, code_occurence } => Self
            :: UnexpectedRowsLengthAndRollback
            { expected_length, got_length, rollback, code_occurence }
        }
    }
...
pub enum TryCreateManyRouteLogicErrorNamed
{
    CheckBodySize
    {
        #[eo_error_occurence] check_body_size : postgresql_crud ::
    ...
    {
        #[eo_to_std_string_string] serde_json : serde_json :: Error,
        code_occurence : error_occurence_lib :: code_occurence ::
        CodeOccurence
    }, CheckCommit
    {
        #[eo_error_occurence] check_commit : postgresql_crud :: check_commit
    ...
    {
        #[eo_to_std_string_string] row : sqlx :: Error,
        #[eo_to_std_string_string] rollback : sqlx :: Error, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence
    }, UnexpectedRowsLength
    {
        #[eo_to_std_string_string] expected_length : std :: primitive ::
        usize, #[eo_to_std_string_string] got_length : std :: primitive ::
        usize, code_occurence : error_occurence_lib :: code_occurence ::
        CodeOccurence
    }, UnexpectedRowsLengthAndRollback
    {
        #[eo_to_std_string_string] expected_length : std :: primitive ::
        usize, #[eo_to_std_string_string] got_length : std :: primitive ::
        usize, #[eo_to_std_string_string] rollback : sqlx :: Error,
        code_occurence : error_occurence_lib :: code_occurence ::
        CodeOccurence
    }
} pub async fn
...
Request,) -> axum :: response :: Response
{
    ...
    body_bytes = match postgresql_crud :: check_body_size ::
    ...
    app_state.get_maximum_size_of_http_body_in_bytes()).await
    {
        Ok(value) => value, Err(error_0) =>
        {
            ...
            {
                check_body_size : error_0, code_occurence :
                error_occurence_lib :: code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
                Some(error_occurence_lib :: code_occurence :: MacroOccurence
                {
                    file : std :: string :: String ::
                    from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                    line : 2545, column : 265,
                }))
    ...
    {
        payload : match serde_json :: from_slice :: < CreateManyPayload >
        (& body_bytes,)
        {
            Ok(value) =>
            { let value = CreateManyPayload :: from(value); value },
            Err(error_0) =>
            {
    ...
    }; println! ("{:#?}", parameters); let error_0 =
    parameters.payload.0.len(); let query_string =
    {
        let mut increment : std :: primitive :: u64 = 0; let mut values = std
        :: string :: String :: default(); for element in &
        parameters.payload.0
        {
            let mut acc = std :: string :: String :: default(); match
            postgresql_crud :: BindQuerySecond ::
            try_generate_bind_increments(&
            element.std_primitive_bool_as_postgresql_bool, & mut increment)
            {
            ...
            } match postgresql_crud :: BindQuerySecond ::
            try_generate_bind_increments(&
            element.std_primitive_bool_as_postgresql_bool_not_null, & mut
            increment)
            {
                Ok(value) => { acc.push_str(& format! ("{value},")); },
                Err(error_0) =>
            ...
            } let _ = acc.pop(); values.push_str(& format! ("({acc}),"));
        } let _ = values.pop(); format!
        ("insert into example (std_primitive_bool_as_postgresql_bool,std_primitive_bool_as_postgresql_bool_not_null) values {values}  returning std_primitive_i64_as_postgresql_big_serial_not_null")
    }; println! ("{}", query_string); let binded_query =
    {
        let mut query = sqlx :: query :: < sqlx :: Postgres >
        (& query_string); for element in parameters.payload.0
        {
            query = postgresql_crud :: BindQuerySecond ::
            bind_value_to_query(element.std_primitive_bool_as_postgresql_bool,
            query); query = postgresql_crud :: BindQuerySecond ::
            bind_value_to_query(element.std_primitive_bool_as_postgresql_bool_not_null,
            query);
        } query
    ...
    }; let executor = match sqlx :: Acquire ::
    ...
    }; let value =
    {
        ...
        {
            let mut rows = binded_query.fetch(executor.as_mut()); let mut acc
            = std :: vec :: Vec :: new(); while let Some(value) = match
            { use postgresql_crud :: TryStreamExt; rows.try_next() }.await
            {
                Ok(value) => match value
                {
                    Some(value) => match sqlx :: Row :: try_get :: <
                    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToCreate,
                    & std :: primitive :: str >
                    (& value,
                    "std_primitive_i64_as_postgresql_big_serial_not_null")
                    {
                        Ok(value) => Some(value), Err(error_0) =>
                        {
                            drop(rows); match executor.rollback().await
                            {
                                Ok(_) =>
                                {
                                    let error = TryCreateManyRouteLogicErrorNamed :: Postgresql
        ...
        {
            let error_1 = value.len(); if error_0 != error_1
            {
                match executor.rollback().await
                {
                    Ok(_) =>
                    {
                        ...
                        UnexpectedRowsLength
                        {
                            expected_length : error_0, got_length : error_1,
                            code_occurence : error_occurence_lib :: code_occurence ::
                            CodeOccurence ::
                            new(file! ().to_owned(), line! (), column! (),
                            Some(error_occurence_lib :: code_occurence :: MacroOccurence
                    ...
                    } Err(error_2) =>
                    {
                        ...
                        UnexpectedRowsLengthAndRollback
                        {
                            expected_length : error_0, got_length : error_1, rollback :
                            error_2, code_occurence : error_occurence_lib ::
                            code_occurence :: CodeOccurence ::
                            new(file! ().to_owned(), line! (), column! (),
                            Some(error_occurence_lib :: code_occurence :: MacroOccurence
                            {
...
> , TryCreateManyErrorNamed >
{
    let payload =
    {
        let value = CreateManyPayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
                ...
                {
                    serde_json_to_string : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
                    Some(error_occurence_lib :: code_occurence :: MacroOccurence
                    {
                        file : std :: string :: String ::
                        from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                        line : 2669, column : 178,
                    }))
                });
            }
        }
    }; let url = format! ("{}/example/create_many", server_location,); let
    future = reqwest :: Client ::
    new().post(&
    ...
    future.await
    {
        Ok(value) => value, Err(error_0) =>
        {
            ...
            {
                reqwest : error_0, code_occurence : error_occurence_lib ::
                code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
                Some(error_occurence_lib :: code_occurence :: MacroOccurence
                {
                    file : std :: string :: String ::
                    from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                    line : 2721, column : 152,
                }))
            });
        }
    }; let error_0 = response.status(); let error_1 =
    response.headers().clone(); let error_2 = match response.text().await
    {
        Ok(value) => value, Err(error_2) =>
        {
            return
            Err(TryCreateManyErrorNamed :: FailedToGetResponseText
            {
                status_code : error_0, headers : error_1, reqwest : error_2,
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
                Some(error_occurence_lib :: code_occurence :: MacroOccurence
                {
                    file : std :: string :: String ::
                    from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                    line : 2738, column : 192,
                }))
            });
        }
    }; let expected_response = match serde_json :: from_str :: <
    TryCreateManyRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
            Err(TryCreateManyErrorNamed :: DeserializeResponse
            {
                status_code : error_0, headers : error_1, response_text :
                error_2, serde : error_3, code_occurence : error_occurence_lib
                :: code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
                Some(error_occurence_lib :: code_occurence :: MacroOccurence
                {
    ...
    = match expected_response
    {
        ...
        { bind_query, code_occurence },
        TryCreateManyRouteLogicResponseVariants :: CheckedAdd
        { code_occurence } =>
        TryCreateManyRouteLogicErrorNamedWithSerializeDeserialize ::
        CheckedAdd { code_occurence }, TryCreateManyRouteLogicResponseVariants
        :: RowAndRollback { row, rollback, code_occurence } =>
        TryCreateManyRouteLogicErrorNamedWithSerializeDeserialize ::
        RowAndRollback { row, rollback, code_occurence },
        TryCreateManyRouteLogicResponseVariants :: UnexpectedRowsLength
        { expected_length, got_length, code_occurence } =>
        TryCreateManyRouteLogicErrorNamedWithSerializeDeserialize ::
        UnexpectedRowsLength { expected_length, got_length, code_occurence },
        TryCreateManyRouteLogicResponseVariants ::
        UnexpectedRowsLengthAndRollback
        { expected_length, got_length, rollback, code_occurence } =>
        TryCreateManyRouteLogicErrorNamedWithSerializeDeserialize ::
...
for CreateManyPayloadElement
{
    ...
    -> Self
    {
        Self
        {
            std_primitive_bool_as_postgresql_bool : postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
            std_primitive_bool_as_postgresql_bool_not_null : postgresql_crud
            ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()
...
} pub async fn create_many_payload_example_route_logic() -> axum :: response
:: Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< CreateManyPayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
    response;
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct CreateOnePayload
{
    ...
    pub std_primitive_bool_as_postgresql_bool_not_null :
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullToCreate
} #[derive(Debug)] pub struct CreateOneParameters
...
} impl std :: convert :: From < TryCreateOneRouteLogicErrorNamed > for
TryCreateOneRouteLogicResponseVariants
{
...
try_create_one_route_logic(app_state : axum :: extract :: State < crate ::
repositories_types :: server :: routes :: app_state ::
DynArcCombinationOfAppStateLogicTraits > , request : axum :: extract ::
Request,) -> axum :: response :: Response
{
    ...
    app_state.get_maximum_size_of_http_body_in_bytes()).await
    {
        Ok(value) => value, Err(error_0) =>
        {
            ...
            IntoResponse ::
            into_response(axum ::
            Json(TryCreateOneRouteLogicResponseVariants :: from(error))); *
            response.status_mut() = axum :: http :: StatusCode :: BAD_REQUEST;
            return response;
        }
    }; let parameters = CreateOneParameters
    {
        payload : match serde_json :: from_slice :: < CreateOnePayload >
        (& body_bytes,)
        {
            Ok(value) =>
            { let value = CreateOnePayload :: from(value); value },
            Err(error_0) =>
            {
    ...
    {
        let mut increment : std :: primitive :: u64 = 0; format!
        ...
        match postgresql_crud :: BindQuerySecond ::
        try_generate_bind_increments(&
        parameters.payload.std_primitive_bool_as_postgresql_bool, & mut
        increment)
        {
            Ok(value) => value, Err(error_0) =>
            {
        ...
        try_generate_bind_increments(&
        parameters.payload.std_primitive_bool_as_postgresql_bool_not_null, &
        mut increment)
        {
            Ok(value) => value, Err(error_0) =>
            {
    ...
    {
        let mut query = sqlx :: query :: < sqlx :: Postgres >
        (& query_string); query = postgresql_crud :: BindQuerySecond ::
        bind_value_to_query(parameters.payload.std_primitive_bool_as_postgresql_bool,
        query); query = postgresql_crud :: BindQuerySecond ::
        bind_value_to_query(parameters.payload.std_primitive_bool_as_postgresql_bool_not_null,
        query); query
    }; let mut pool_connection = match
    app_state.get_postgres_pool().acquire().await
    {
                                ...
                                Ok(_) =>
                                {
                                    let error = TryCreateOneRouteLogicErrorNamed :: Postgresql
                                    {
                                        ...
                                        Some(error_occurence_lib :: code_occurence :: MacroOccurence
                                        {
                                            file : std :: string :: String ::
                                            from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                                            line : 2981, column : 112,
                                        }))
                                    }; eprintln! ("{error}"); let mut response = axum ::
                                    response :: IntoResponse ::
                                    into_response(axum ::
                                    Json(TryCreateOneRouteLogicResponseVariants ::
                                    from(error))); * response.status_mut() = axum :: http ::
                                    StatusCode :: INTERNAL_SERVER_ERROR; return response;
                                } Err(error_1) =>
                                {
    ...
    into_response(axum ::
    Json(TryCreateOneRouteLogicResponseVariants :: Desirable(value))); *
    response.status_mut() = axum :: http :: StatusCode :: CREATED; return
    response;
} #[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
...
try_create_one(server_location : & std :: primitive :: str, parameters :
CreateOneParameters,) -> Result <
postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToCreate,
TryCreateOneErrorNamed >
{
    let payload =
    {
        let value = CreateOnePayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
                return
                Err(TryCreateOneErrorNamed :: SerdeJsonToString
                {
                    serde_json_to_string : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
    ...
    }; let url = format! ("{}/example/create_one", server_location,); let
    future = reqwest :: Client ::
    new().post(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    future.await
    {
        ...
        {
            return
            Err(TryCreateOneErrorNamed :: Reqwest
            {
                reqwest : error_0, code_occurence : error_occurence_lib ::
                code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
    ...
    response.headers().clone(); let error_2 = match response.text().await
    {
        ...
        {
            return
            Err(TryCreateOneErrorNamed :: FailedToGetResponseText
            {
                status_code : error_0, headers : error_1, reqwest : error_2,
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
    ...
    TryCreateOneRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
            Err(TryCreateOneErrorNamed :: DeserializeResponse
            {
                status_code : error_0, headers : error_1, response_text :
                error_2, serde : error_3, code_occurence : error_occurence_lib
                :: code_occurence :: CodeOccurence ::
    ...
    match expected_response
    {
        ...
        { serde_json, code_occurence }, TryCreateOneRouteLogicResponseVariants
        :: CheckCommit { check_commit, code_occurence } =>
        TryCreateOneRouteLogicErrorNamedWithSerializeDeserialize ::
        CheckCommit { check_commit, code_occurence },
        TryCreateOneRouteLogicResponseVariants :: RowAndRollback
        { row, rollback, code_occurence } =>
        TryCreateOneRouteLogicErrorNamedWithSerializeDeserialize ::
        RowAndRollback { row, rollback, code_occurence },
        TryCreateOneRouteLogicResponseVariants :: BindQuery
        { bind_query, code_occurence } =>
        TryCreateOneRouteLogicErrorNamedWithSerializeDeserialize :: BindQuery
        { bind_query, code_occurence }, TryCreateOneRouteLogicResponseVariants
        :: CheckedAdd { code_occurence } =>
        TryCreateOneRouteLogicErrorNamedWithSerializeDeserialize :: CheckedAdd
        { code_occurence }
    };
...
} pub async fn create_one_payload_example_route_logic() -> axum :: response ::
Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< CreateOnePayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
...
{
    pub std_primitive_i64_as_postgresql_big_serial_not_null : std :: option ::
    Option < std :: vec :: Vec < postgresql_crud :: postgresql_types ::
    base_wrap :: StdPrimitiveI64AsPostgresqlBigSerialNotNull >> , pub
    std_primitive_bool_as_postgresql_bool : std :: option :: Option < std ::
    vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolWhere
    >> , pub std_primitive_bool_as_postgresql_bool_not_null : std :: option ::
    Option < std :: vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullWhere
    >> , pub select : std :: vec :: Vec < ExampleColumn > , pub order_by :
    postgresql_crud :: OrderBy < ExampleColumn > , pub limit : postgresql_crud
    :: postgresql_types :: base_wrap ::
    StdPrimitiveI64AsPostgresqlBigSerialNotNull, pub offset : postgresql_crud
    :: postgresql_types :: base_wrap ::
...
{
    Desirable(std :: vec :: Vec :: < ExampleOptions >), CheckBodySize
    {
        check_body_size : postgresql_crud :: check_body_size ::
        CheckBodySizeErrorNamedWithSerializeDeserialize, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence,
    ...
    {
        not_unique_column : ExampleColumn, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence,
    ...
    {
        not_unique_std_primitive_bool_as_postgresql_bool_not_null : std ::
...
pub enum TryReadManyRouteLogicErrorNamed
{
    ...
    }, NotUniquePrimaryKey
    {
        ...
        postgresql_types :: base_wrap ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNull, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence
    }, NotUniqueColumn
    {
        #[eo_to_std_string_string_serialize_deserialize] not_unique_column :
        ExampleColumn, code_occurence : error_occurence_lib :: code_occurence
        :: CodeOccurence
    }, NotUniqueStdPrimitiveBoolAsPostgresqlBool
    {
        #[eo_to_std_string_string]
        not_unique_std_primitive_bool_as_postgresql_bool : postgresql_crud ::
        postgresql_types :: base_wrap :: StdPrimitiveBoolAsPostgresqlBool,
        code_occurence : error_occurence_lib :: code_occurence ::
        CodeOccurence
    }, NotUniqueStdPrimitiveBoolAsPostgresqlBoolNotNull
    {
        ...
        not_unique_std_primitive_bool_as_postgresql_bool_not_null :
        postgresql_crud :: postgresql_types :: base_wrap ::
        StdPrimitiveBoolAsPostgresqlBoolNotNull, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence
    }
} pub async fn
...
Request,) -> axum :: response :: Response
{
    ...
    {
        payload : match serde_json :: from_slice :: < ReadManyPayload >
        (& body_bytes,)
        {
            Ok(value) =>
            {
                let value = ReadManyPayload :: from(value); if let Some(value)
                = & value.std_primitive_i64_as_postgresql_big_serial_not_null
                {
                    let mut acc = std :: vec :: Vec :: new(); for element in
                    value
                    {
                        if ! acc.contains(& element) { acc.push(& element); } else
                        {
                            let error_0 = element.clone(); let error =
                ...
                value.std_primitive_bool_as_postgresql_bool
                {
                    ...
                    value
                    {
                        if ! acc.contains(& element) { acc.push(& element); } else
                        {
                            let error_0 = element.value.clone(); let error =
                ...
                value.select
                {
                    ...
                    {
                        let error_0 = element.clone(); let error =
                        TryReadManyRouteLogicErrorNamed :: NotUniqueColumn
                        {
    ...
    }; println! ("{:#?}", parameters); let query_string =
    {
        ...
        ("select {} from example {}",
        {
            let mut value = std :: string :: String :: default(); for element
            in & parameters.payload.select
            {
                value.push_str(& match element
                {
                    ExampleColumn :: StdPrimitiveBoolAsPostgresqlBool(_) =>
                    "std_primitive_bool_as_postgresql_bool".to_string(),
                    ExampleColumn :: StdPrimitiveBoolAsPostgresqlBoolNotNull(_)
                    =>
                    "std_primitive_bool_as_postgresql_bool_not_null".to_string(),
                    ExampleColumn ::
                    StdPrimitiveI64AsPostgresqlBigSerialNotNull(_) =>
                    "std_primitive_i64_as_postgresql_big_serial_not_null".to_string()
                }); value.push_str(",");
        ...
        {
            let mut increment : std :: primitive :: u64 = 0; let mut
            additional_parameters = std :: string :: String :: default(); if
            let Some(_) = &
            parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null
            {
                ...
                ("{} std_primitive_i64_as_postgresql_big_serial_not_null in (select unnest(${}))",
                prefix, increment));
            } if let Some(value) = &
            parameters.payload.std_primitive_bool_as_postgresql_bool
            {
                ...
                { true => "where", false => " and", },
                {
                    let mut acc = std :: string :: String :: default(); for
                    (index, element) in value.iter().enumerate()
                    {
                        match postgresql_crud :: BindQuerySecond ::
                        try_generate_bind_increments(element, & mut increment)
                        {
                            Ok(value) =>
                            {
                                ...
                                index == 0
                                {
                                    true => { acc.push_str(& handle); }, false =>
                                    {
                                        acc.push_str(& format!
                    ...
                    } if let false = acc.is_empty() { let _ = acc.pop(); } acc
                }));
            } if let Some(value) = &
            parameters.payload.std_primitive_bool_as_postgresql_bool_not_null
            {
                ...
                { true => "where", false => " and", },
                {
                    ...
                    (index, element) in value.iter().enumerate()
                    {
                        ...
                        try_generate_bind_increments(element, & mut increment)
                        {
                            ...
                            {
                                let handle = format!
                                ("std_primitive_bool_as_postgresql_bool_not_null ~ {value} ");
                                match index == 0
                                {
                                    true => { acc.push_str(& handle); }, false =>
                                    {
            ...
            }
            {
                ...
                parameters.payload.order_by; let order = match & value.order
                {
                    Some(value) => value.to_snake_case_stringified(), None =>
                    postgresql_crud :: Order ::
                    default().to_snake_case_stringified(),
                };
                additional_parameters.push_str(& format!
                ("{}order by {} {}", prefix, value.column.pick_column(),
                order,));
            }
            {
                let prefix = match additional_parameters.is_empty()
                { true => "", false => " ", }; let value = match
                postgresql_crud :: BindQuerySecond ::
    ...
    }; println! ("{}", query_string); let binded_query =
    {
        ...
        parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null
        {
            ...
            element.clone()).collect :: < std :: vec :: Vec < postgresql_crud
            :: postgresql_types :: base_wrap ::
            StdPrimitiveI64AsPostgresqlBigSerialNotNull >> ());
        } if let Some(value) =
        parameters.payload.std_primitive_bool_as_postgresql_bool
        ...
        let value =
        {
            ...
            { use postgresql_crud :: TryStreamExt; rows.try_next() }.await
            {
                Ok(value) => match value
                {
                    Some(value) =>
                    Some({
                        let mut std_primitive_i64_as_postgresql_big_serial_not_null
                        : std :: option :: Option < postgresql_crud :: Value <
                        postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToRead
                        > > = None; let mut std_primitive_bool_as_postgresql_bool :
                        std :: option :: Option < postgresql_crud :: Value <
                        postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolToRead
                        > > = None; let mut
                        std_primitive_bool_as_postgresql_bool_not_null : std ::
                        option :: Option < postgresql_crud :: Value <
                        postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullToRead
                        > > = None; for element in & parameters.payload.select
                        {
                            match element
                            {
                                ExampleColumn ::
                                StdPrimitiveI64AsPostgresqlBigSerialNotNull(_) => match sqlx
                                :: Row :: try_get :: <
                                postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToRead,
                                & std :: primitive :: str >
                                (& value,
                                "std_primitive_i64_as_postgresql_big_serial_not_null")
                                {
                                    ...
                                    {
                                        std_primitive_i64_as_postgresql_big_serial_not_null =
                                        Some(postgresql_crud :: Value { value : value });
                                    }, Err(error_0) =>
                                    {
                                        let error = TryReadManyRouteLogicErrorNamed :: Postgresql
                                        {
                                ...
                                StdPrimitiveBoolAsPostgresqlBoolNotNull(_) => match sqlx ::
                                Row :: try_get :: <
                                postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullToRead,
                                & std :: primitive :: str >
                                (& value, "std_primitive_bool_as_postgresql_bool_not_null")
...
ReadManyParameters,) -> Result < std :: vec :: Vec :: < ExampleOptions > ,
TryReadManyErrorNamed >
{
    let payload =
    {
        ...
        parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null
        {
            let mut acc = std :: vec :: Vec :: new(); for element in value
            {
                if ! acc.contains(& element) { acc.push(& element); } else
                {
                    let error_0 = element.clone(); return
                    Err(TryReadManyErrorNamed :: NotUniquePrimaryKey
                    {
                        not_unique_primary_key : error_0, code_occurence :
                        error_occurence_lib :: code_occurence :: CodeOccurence ::
                        new(file! ().to_owned(), line! (), column! (),
        ...
        parameters.payload.std_primitive_bool_as_postgresql_bool
        {
            let mut acc = std :: vec :: Vec :: new(); for element in value
            {
                ...
                { acc.push(& element.value); } else
                {
                    let error_0 = element.value.clone(); return
        ...
        parameters.payload.select
        {
            ...
            {
                let error_0 = element.clone(); return
                Err(TryReadManyErrorNamed :: NotUniqueColumn
                {
                    not_unique_column : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
                    Some(error_occurence_lib :: code_occurence :: MacroOccurence
                    {
                        file : std :: string :: String ::
                        from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                        line : 2050, column : 176,
                    }))
                });
            } else { acc.push(element); }
        } let value = ReadManyPayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
    ...
    }; let url = format! ("{}/example/read_many", server_location,); let
    future = reqwest :: Client ::
    new().post(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    TryReadManyRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
    ...
    -> Self
    {
        Self
        {
            ...
            order_by : postgresql_crud :: OrderBy
            {
                ...
                StdPrimitiveI64AsPostgresqlBigSerialNotNull(vec! []), order :
                Some(postgresql_crud ::
                StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
                ::
                default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()),
            }, limit : postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
            offset : postgresql_crud ::
            StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
            ::
            default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element(),
        }
    }
} pub async fn read_many_payload_example_route_logic() -> axum :: response ::
Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< ReadManyPayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
...
} #[derive(Debug)] pub struct ReadOneParameters
{ pub payload : ReadOnePayload, }
#[derive(Debug, serde :: Serialize, serde :: Deserialize)] pub enum
TryReadOneRouteLogicResponseVariants
{
    Desirable(ExampleOptions), CheckBodySize
    {
        check_body_size : postgresql_crud :: check_body_size ::
        CheckBodySizeErrorNamedWithSerializeDeserialize, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence,
...
} impl std :: convert :: From < TryReadOneRouteLogicErrorNamed > for
TryReadOneRouteLogicResponseVariants
{
...
try_read_one_route_logic(app_state : axum :: extract :: State < crate ::
repositories_types :: server :: routes :: app_state ::
DynArcCombinationOfAppStateLogicTraits > , request : axum :: extract ::
Request,) -> axum :: response :: Response
{
    ...
    {
        payload : match serde_json :: from_slice :: < ReadOnePayload >
        (& body_bytes,)
        {
            Ok(value) =>
            {
                let value = ReadOnePayload :: from(value); let mut acc = std
                :: vec :: Vec :: new(); for element in & value.select
                {
                    if acc.contains(& element)
                    {
                        let error_0 = element.clone(); let error =
    ...
    ("select {} from example where std_primitive_i64_as_postgresql_big_serial_not_null = $1",
    {
    ...
    },); println! ("{}", query_string); let binded_query =
    {
        ...
        let query = postgresql_crud :: BindQuerySecond ::
        bind_value_to_query(parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null,
        query); query
    }; let mut pool_connection = match
    app_state.get_postgres_pool().acquire().await
    {
    ...
    into_response(axum ::
    Json(TryReadOneRouteLogicResponseVariants :: Desirable(value))); *
    response.status_mut() = axum :: http :: StatusCode :: OK; return response;
} #[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
pub enum TryReadOneErrorNamed
{
    ...
    }, TryReadOneRouteLogicErrorNamedWithSerializeDeserialize
    {
        ...
        TryReadOneRouteLogicErrorNamedWithSerializeDeserialize, code_occurence
        : error_occurence_lib :: code_occurence :: CodeOccurence
    }
} pub async fn
try_read_one(server_location : & std :: primitive :: str, parameters :
ReadOneParameters,) -> Result < ExampleOptions, TryReadOneErrorNamed >
{
    let payload =
    {
        let mut acc = std :: vec :: Vec :: new(); for element in &
        parameters.payload.select
        {
            ...
            {
                let error_0 = element.clone(); return
                Err(TryReadOneErrorNamed :: NotUniqueColumn
                {
                    not_unique_column : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
        ...
        } let value = ReadOnePayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
                return
                Err(TryReadOneErrorNamed :: SerdeJsonToString
                {
                    serde_json_to_string : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
    ...
    }; let url = format! ("{}/example/read_one", server_location,); let future
    = reqwest :: Client ::
    new().post(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    future.await
    {
        ...
        {
            return
            Err(TryReadOneErrorNamed :: Reqwest
            {
                reqwest : error_0, code_occurence : error_occurence_lib ::
                code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
    ...
    response.headers().clone(); let error_2 = match response.text().await
    {
        ...
        {
            return
            Err(TryReadOneErrorNamed :: FailedToGetResponseText
            {
                status_code : error_0, headers : error_1, reqwest : error_2,
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
    ...
    TryReadOneRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
            Err(TryReadOneErrorNamed :: DeserializeResponse
            {
                status_code : error_0, headers : error_1, response_text :
                error_2, serde : error_3, code_occurence : error_occurence_lib
                :: code_occurence :: CodeOccurence ::
    ...
    match expected_response
    {
        ...
        { serde_json, code_occurence }, TryReadOneRouteLogicResponseVariants
        :: CheckCommit { check_commit, code_occurence } =>
...
} pub async fn read_one_payload_example_route_logic() -> axum :: response ::
Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< ReadOnePayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
...
{
    pub std_primitive_i64_as_postgresql_big_serial_not_null :
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToUpdate,
    pub std_primitive_bool_as_postgresql_bool : std :: option :: Option <
    postgresql_crud::Value <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolToUpdate
    >> , pub std_primitive_bool_as_postgresql_bool_not_null : std :: option ::
    Option < postgresql_crud::Value <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullToUpdate
    >>
}
#[derive(Debug, serde :: Serialize, serde :: Deserialize, utoipa :: ToSchema)]
pub struct
...
pub enum TryUpdateManyRouteLogicErrorNamed
{
    ...
    }, NonExistingPrimaryKeys
    {
        ...
        :: Vec < postgresql_crud :: postgresql_types :: base_wrap ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNullToUpdate > , code_occurence
        : error_occurence_lib :: code_occurence :: CodeOccurence
    }, NonExistingPrimaryKeysAndRollback
    {
        #[eo_vec_to_std_string_string] non_existing_primary_keys : std :: vec
        :: Vec < postgresql_crud :: postgresql_types :: base_wrap ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNullToUpdate > ,
        #[eo_to_std_string_string] rollback : sqlx :: Error, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence
    }, NotUniquePrimaryKey
    {
    ...
    {
        #[eo_to_std_string_string] no_payload_fields_primary_key :
        postgresql_crud :: postgresql_types :: base_wrap ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNullToUpdate, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence
    }
...
Request,) -> axum :: response :: Response
{
    ...
    {
        payload : match serde_json :: from_slice :: < UpdateManyPayload >
        (& body_bytes,)
        {
            Ok(value) =>
            {
                ...
                } for element in & value.0
                {
                    ...
                    element.std_primitive_bool_as_postgresql_bool_not_null)
                    {
                        let error_0 =
                        element.std_primitive_i64_as_postgresql_big_serial_not_null.clone();
                        let error = TryUpdateManyRouteLogicErrorNamed ::
                        NoPayloadFieldsPrimaryKey
                        {
                            no_payload_fields_primary_key : error_0, code_occurence :
                            error_occurence_lib :: code_occurence :: CodeOccurence ::
                            new(file! ().to_owned(), line! (), column! (),
                            Some(error_occurence_lib :: code_occurence :: MacroOccurence
                            {
    ...
    }; println! ("{:#?}", parameters); let expected_primary_keys =
    parameters.payload.0.iter().map(| element |
    element.std_primitive_i64_as_postgresql_big_serial_not_null.clone()).collect
    :: < std :: vec :: Vec :: <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToUpdate
    > > (); let query_string =
    {
        let mut query = std :: string :: String ::
        from("update example set "); let mut increment : std :: primitive ::
        u64 = 0;
        {
        ...
        {
            let mut
            is_std_primitive_bool_as_postgresql_bool_not_null_update_exist =
            false; for element in & parameters.payload.0
            {
                if
                element.std_primitive_bool_as_postgresql_bool_not_null.is_some()
                {
                    is_std_primitive_bool_as_postgresql_bool_not_null_update_exist
                    = true; break;
                }
            ...
            {
                let mut acc = std :: string :: String ::
                from("std_primitive_bool_as_postgresql_bool_not_null = case ");
                ...
                query.push_str(& format!
                ("{}{}", acc,
                "else std_primitive_bool_as_postgresql_bool_not_null end,"));
            }
        } let _ = query.pop();
        query.push_str(& format!
        (" where std_primitive_i64_as_postgresql_big_serial_not_null in ({}) returning std_primitive_i64_as_postgresql_big_serial_not_null;",
        {
        ...
        (& query_string);
        {
            ...
            } if is_std_primitive_bool_as_postgresql_bool_update_exist
            {
                for element in & parameters.payload.0
                {
                    ...
                    {
                        query =
                        query.bind(element.std_primitive_i64_as_postgresql_big_serial_not_null.clone());
                        query = postgresql_crud :: BindQuerySecond ::
                        bind_value_to_query(value.value.clone(), query);
                    }
                }
            }
        }
    ...
    }; let value =
    {
        ...
        {
            let error_0 =
            expected_primary_keys.into_iter().fold(std :: vec :: Vec :: new(),
            | mut acc, element |
            {
            ...
            }); if let false = error_0.is_empty()
            {
                match executor.rollback().await
                {
                    Ok(_) =>
                    {
                        ...
                        NonExistingPrimaryKeys
                        {
                            non_existing_primary_keys : error_0, code_occurence :
                            error_occurence_lib :: code_occurence :: CodeOccurence ::
                            new(file! ().to_owned(), line! (), column! (),
                            Some(error_occurence_lib :: code_occurence :: MacroOccurence
                            {
                    ...
                    } Err(error_1) =>
                    {
                        ...
                        NonExistingPrimaryKeysAndRollback
                        {
                            non_existing_primary_keys : error_0, rollback : error_1,
                            code_occurence : error_occurence_lib :: code_occurence ::
                            CodeOccurence ::
                            new(file! ().to_owned(), line! (), column! (),
                            Some(error_occurence_lib :: code_occurence :: MacroOccurence
...
> , TryUpdateManyErrorNamed >
{
            ...
            } else
            {
                ...
                Err(TryUpdateManyErrorNamed :: NotUniquePrimaryKey
                {
                    ...
                    Some(error_occurence_lib :: code_occurence :: MacroOccurence
                    {
                        file : std :: string :: String ::
                        from("postgresql_crud/generate_postgresql_crud_second/src/lib.rs"),
                        line : 4548, column : 208,
                    }))
                });
            }
        } let value = UpdateManyPayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
    ...
    }; let url = format! ("{}/example/update_many", server_location,); let
    future = reqwest :: Client ::
    new().patch(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    TryUpdateManyRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
    ...
    = match expected_response
    {
        ...
        TryUpdateManyRouteLogicErrorNamedWithSerializeDeserialize ::
        Postgresql { postgresql, code_occurence },
        TryUpdateManyRouteLogicResponseVariants :: SerdeJson
        { serde_json, code_occurence } =>
        TryUpdateManyRouteLogicErrorNamedWithSerializeDeserialize :: SerdeJson
        { serde_json, code_occurence },
        TryUpdateManyRouteLogicResponseVariants :: CheckCommit
        { check_commit, code_occurence } =>
        TryUpdateManyRouteLogicErrorNamedWithSerializeDeserialize ::
        CheckCommit { check_commit, code_occurence },
        TryUpdateManyRouteLogicResponseVariants :: RowAndRollback
        { row, rollback, code_occurence } =>
        TryUpdateManyRouteLogicErrorNamedWithSerializeDeserialize ::
        RowAndRollback { row, rollback, code_occurence },
...
} pub async fn update_many_payload_example_route_logic() -> axum :: response
:: Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< UpdateManyPayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
...
} impl std :: convert :: From < TryUpdateOneRouteLogicErrorNamed > for
TryUpdateOneRouteLogicResponseVariants
{
...
try_update_one_route_logic(app_state : axum :: extract :: State < crate ::
repositories_types :: server :: routes :: app_state ::
DynArcCombinationOfAppStateLogicTraits > , request : axum :: extract ::
Request,) -> axum :: response :: Response
{
    ...
    app_state.get_maximum_size_of_http_body_in_bytes()).await
    {
        Ok(value) => value, Err(error_0) =>
        {
            ...
            IntoResponse ::
            into_response(axum ::
            Json(TryUpdateOneRouteLogicResponseVariants :: from(error))); *
            response.status_mut() = axum :: http :: StatusCode :: BAD_REQUEST;
            return response;
        }
    }; let parameters = UpdateOneParameters
    {
        payload : match serde_json :: from_slice :: < UpdateOnePayload >
        (& body_bytes,)
        {
            Ok(value) =>
            {
                let value = UpdateOnePayload :: from(value); if let
                (None, None) =
                (& value.std_primitive_bool_as_postgresql_bool, &
                value.std_primitive_bool_as_postgresql_bool_not_null)
                {
                    let error_0 =
                    value.std_primitive_i64_as_postgresql_big_serial_not_null.clone();
                    ...
                    response :: IntoResponse ::
                    into_response(axum ::
                    Json(TryUpdateOneRouteLogicResponseVariants ::
                    from(error))); * response.status_mut() = axum :: http ::
                    StatusCode :: INTERNAL_SERVER_ERROR; return response;
                } value
            }, Err(error_0) =>
    ...
    {
        let mut increment : std :: primitive :: u64 = 0; let mut query = std
        :: string :: String :: from("update example set "); if let Some(value)
        = & parameters.payload.std_primitive_bool_as_postgresql_bool
        {
            match postgresql_crud :: BindQuerySecond ::
            try_generate_bind_increments(& value.value, & mut increment,)
        ...
        } let _ = query.pop(); match postgresql_crud :: BindQuerySecond ::
        try_generate_bind_increments(&
        parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null,
        & mut increment)
        {
            ...
            {
                query.push_str(& format!
                (" where std_primitive_i64_as_postgresql_big_serial_not_null = {value}"));
            }, Err(error_0) =>
            {
                let error = TryUpdateOneRouteLogicErrorNamed :: BindQuery
                {
        ...
        query.push_str(& format!
        (" returning std_primitive_i64_as_postgresql_big_serial_not_null"));
        query
    }; println! ("{}", query_string); let binded_query =
    {
        let mut query = sqlx :: query :: < sqlx :: Postgres >
        ...
        {
            query = postgresql_crud :: BindQuerySecond ::
            bind_value_to_query(value.value, query,);
        } if let Some(value) =
        parameters.payload.std_primitive_bool_as_postgresql_bool_not_null
        {
            query = postgresql_crud :: BindQuerySecond ::
    ...
    into_response(axum ::
    Json(TryUpdateOneRouteLogicResponseVariants :: Desirable(value))); *
    response.status_mut() = axum :: http :: StatusCode :: OK; return response;
} #[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
...
try_update_one(server_location : & std :: primitive :: str, parameters :
UpdateOneParameters,) -> Result <
postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToUpdate,
TryUpdateOneErrorNamed >
{
    let payload =
    {
        let value = UpdateOnePayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
    ...
    }; let url = format! ("{}/example/update_one", server_location,); let
    future = reqwest :: Client ::
    new().patch(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    TryUpdateOneRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
    ...
    match expected_response
    {
        ...
        { serde_json, code_occurence }, TryUpdateOneRouteLogicResponseVariants
        :: CheckCommit { check_commit, code_occurence } =>
        TryUpdateOneRouteLogicErrorNamedWithSerializeDeserialize ::
        CheckCommit { check_commit, code_occurence },
...
} pub async fn update_one_payload_example_route_logic() -> axum :: response ::
Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< UpdateOnePayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
...
pub struct DeleteManyPayload
{
    pub std_primitive_i64_as_postgresql_big_serial_not_null : std :: option ::
    Option < std :: vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete
    >> , pub std_primitive_bool_as_postgresql_bool : std :: option :: Option <
    std :: vec :: Vec <
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolWhere
    >> , pub std_primitive_bool_as_postgresql_bool_not_null : std :: option ::
    ...
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveBoolAsPostgresqlBoolNotNullWhere
    >>
} #[derive(Debug)] pub struct DeleteManyParameters
...
} impl std :: convert :: From < TryDeleteManyRouteLogicErrorNamed > for
TryDeleteManyRouteLogicResponseVariants
{
...
pub enum TryDeleteManyRouteLogicErrorNamed
{
    ...
    }, NonExistingPrimaryKeys
    {
        #[eo_vec_to_std_string_string] non_existing_primary_keys : std :: vec
        :: Vec < postgresql_crud :: postgresql_types :: base_wrap ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete > , code_occurence
        : error_occurence_lib :: code_occurence :: CodeOccurence
    }, NonExistingPrimaryKeysAndRollback
    {
        #[eo_vec_to_std_string_string] non_existing_primary_keys : std :: vec
        :: Vec < postgresql_crud :: postgresql_types :: base_wrap ::
        StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete > ,
        #[eo_to_std_string_string] rollback : sqlx :: Error, code_occurence :
        error_occurence_lib :: code_occurence :: CodeOccurence
    }, NotUniquePrimaryKey
    {
...
try_delete_many_route_logic(app_state : axum :: extract :: State < crate ::
repositories_types :: server :: routes :: app_state ::
DynArcCombinationOfAppStateLogicTraits > , request : axum :: extract ::
Request,) -> axum :: response :: Response
{
    ...
    app_state.get_maximum_size_of_http_body_in_bytes()).await
    {
        Ok(value) => value, Err(error_0) =>
        {
            ...
            IntoResponse ::
            into_response(axum ::
            Json(TryDeleteManyRouteLogicResponseVariants :: from(error))); *
            response.status_mut() = axum :: http :: StatusCode :: BAD_REQUEST;
            return response;
        }
    }; let parameters = DeleteManyParameters
    {
        payload : match serde_json :: from_slice :: < DeleteManyPayload >
        (& body_bytes,)
        {
            Ok(value) =>
            {
                let value = DeleteManyPayload :: from(value); if let
                (None, None, None) =
                (& value.std_primitive_bool_as_postgresql_bool, &
                value.std_primitive_bool_as_postgresql_bool_not_null, &
                value.std_primitive_i64_as_postgresql_big_serial_not_null)
                ...
                value.std_primitive_i64_as_postgresql_big_serial_not_null
                {
                    ...
                    value
                    {
                        ...
                        {
                            let error_0 = element.clone(); let error =
                            TryDeleteManyRouteLogicErrorNamed :: NotUniquePrimaryKey
                            {
                                not_unique_primary_key : error_0, code_occurence :
                                error_occurence_lib :: code_occurence :: CodeOccurence ::
                                new(file! ().to_owned(), line! (), column! (),
                ...
                value.std_primitive_bool_as_postgresql_bool
                {
                    ...
                    value
                    {
                        ...
                        {
                            let error_0 = element.value.clone(); let error =
                            TryDeleteManyRouteLogicErrorNamed ::
                            NotUniqueStdPrimitiveBoolAsPostgresqlBool
                            {
                                not_unique_std_primitive_bool_as_postgresql_bool : error_0,
                                code_occurence : error_occurence_lib :: code_occurence ::
    ...
    parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null.clone();
    let query_string = format!
    ("delete from example where {} returning std_primitive_i64_as_postgresql_big_serial_not_null",
    {
        let mut increment : std :: primitive :: u64 = 0; let mut
        additional_parameters = std :: string :: String :: default(); if let
        Some(value) = &
        parameters.payload.std_primitive_bool_as_postgresql_bool
        {
            for element in value
            {
                ...
                try_generate_bind_increments(element, & mut increment)
                {
                    Ok(value) =>
                    {
                        let handle = format!
                        ("std_primitive_bool_as_postgresql_bool = {value}"); match
                        additional_parameters.is_empty()
                        {
        ...
        } if let Some(std_primitive_i64_as_postgresql_big_serial_not_null) = &
        parameters.payload.std_primitive_i64_as_postgresql_big_serial_not_null
        {
            if let false = additional_parameters.is_empty()
            { additional_parameters.push_str(" and"); }
            additional_parameters.push_str(& format!
            (" std_primitive_i64_as_postgresql_big_serial_not_null in ({})",
            {
    ...
    }); println! ("{}", query_string); let binded_query =
    {
        ...
        parameters.payload.std_primitive_bool_as_postgresql_bool
        {
            ...
            {
                query = postgresql_crud :: BindQuerySecond ::
                bind_value_to_query(element, query);
            }
        } if let Some(value) =
        parameters.payload.std_primitive_bool_as_postgresql_bool_not_null
        {
    ...
    }; let value =
    {
        ...
        };
        {
            ...
            {
                let error_0 =
                error.into_iter().fold(std :: vec :: Vec :: new(), | mut acc,
                element |
                {
                    if let false = value.contains(& element)
                    { acc.push(element); } acc
    ...
    into_response(axum ::
    Json(TryDeleteManyRouteLogicResponseVariants :: Desirable(value))); *
    response.status_mut() = axum :: http :: StatusCode :: OK; return response;
} #[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
...
try_delete_many(server_location : & std :: primitive :: str, parameters :
DeleteManyParameters,) -> Result < std :: vec :: Vec :: <
postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete
> , TryDeleteManyErrorNamed >
{
    let payload =
    {
        let value = DeleteManyPayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
                return
                Err(TryDeleteManyErrorNamed :: SerdeJsonToString
                {
                    serde_json_to_string : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
    ...
    }; let url = format! ("{}/example/delete_many", server_location,); let
    future = reqwest :: Client ::
    new().delete(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    future.await
    {
        ...
        {
            return
            Err(TryDeleteManyErrorNamed :: Reqwest
            {
                reqwest : error_0, code_occurence : error_occurence_lib ::
                code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
    ...
    response.headers().clone(); let error_2 = match response.text().await
    {
        ...
        {
            return
            Err(TryDeleteManyErrorNamed :: FailedToGetResponseText
            {
                status_code : error_0, headers : error_1, reqwest : error_2,
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
    ...
    TryDeleteManyRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
            Err(TryDeleteManyErrorNamed :: DeserializeResponse
            {
                status_code : error_0, headers : error_1, response_text :
                error_2, serde : error_3, code_occurence : error_occurence_lib
                :: code_occurence :: CodeOccurence ::
    ...
    = match expected_response
    {
        ...
        TryDeleteManyRouteLogicErrorNamedWithSerializeDeserialize ::
        Postgresql { postgresql, code_occurence },
        TryDeleteManyRouteLogicResponseVariants :: SerdeJson
        { serde_json, code_occurence } =>
        TryDeleteManyRouteLogicErrorNamedWithSerializeDeserialize :: SerdeJson
        { serde_json, code_occurence },
        TryDeleteManyRouteLogicResponseVariants :: CheckCommit
        { check_commit, code_occurence } =>
        TryDeleteManyRouteLogicErrorNamedWithSerializeDeserialize ::
        CheckCommit { check_commit, code_occurence },
        ...
        TryDeleteManyRouteLogicResponseVariants :: RowAndRollback
        { row, rollback, code_occurence } =>
        TryDeleteManyRouteLogicErrorNamedWithSerializeDeserialize ::
        RowAndRollback { row, rollback, code_occurence },
        TryDeleteManyRouteLogicResponseVariants :: NonExistingPrimaryKeys
        { non_existing_primary_keys, code_occurence } =>
        TryDeleteManyRouteLogicErrorNamedWithSerializeDeserialize ::
        NonExistingPrimaryKeys { non_existing_primary_keys, code_occurence },
        TryDeleteManyRouteLogicResponseVariants ::
...
} pub async fn delete_many_payload_example_route_logic() -> axum :: response
:: Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< DeleteManyPayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
...
pub struct DeleteOnePayload
{
    pub std_primitive_i64_as_postgresql_big_serial_not_null :
    postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete
} #[derive(Debug)] pub struct DeleteOneParameters
...
} impl std :: convert :: From < TryDeleteOneRouteLogicErrorNamed > for
TryDeleteOneRouteLogicResponseVariants
{
...
try_delete_one_route_logic(app_state : axum :: extract :: State < crate ::
repositories_types :: server :: routes :: app_state ::
DynArcCombinationOfAppStateLogicTraits > , request : axum :: extract ::
Request,) -> axum :: response :: Response
{
    ...
    app_state.get_maximum_size_of_http_body_in_bytes()).await
    {
        Ok(value) => value, Err(error_0) =>
        {
            ...
            IntoResponse ::
            into_response(axum ::
            Json(TryDeleteOneRouteLogicResponseVariants :: from(error))); *
            response.status_mut() = axum :: http :: StatusCode :: BAD_REQUEST;
            return response;
        }
    }; let parameters = DeleteOneParameters
    {
        payload : match serde_json :: from_slice :: < DeleteOnePayload >
        (& body_bytes,)
        {
            Ok(value) =>
            { let value = DeleteOnePayload :: from(value); value },
            Err(error_0) =>
            {
    ...
    ("delete from example where std_primitive_i64_as_postgresql_big_serial_not_null = $1 returning std_primitive_i64_as_postgresql_big_serial_not_null");
    println! ("{}", query_string); let binded_query =
    {
        let mut query = sqlx :: query :: < sqlx :: Postgres >
        (& query_string); query = postgresql_crud :: BindQuerySecond ::
                        ...
                        Ok(value) => value, Err(error_0) =>
                        {
                            match executor.rollback().await
                            {
                                Ok(_) =>
                                {
                                    ...
                                    response :: IntoResponse ::
                                    into_response(axum ::
                                    Json(TryDeleteOneRouteLogicResponseVariants ::
                                    from(error))); * response.status_mut() = axum :: http ::
                                    StatusCode :: INTERNAL_SERVER_ERROR; return response;
                                } Err(error_1) =>
                                {
    ...
    into_response(axum ::
    Json(TryDeleteOneRouteLogicResponseVariants :: Desirable(value))); *
    response.status_mut() = axum :: http :: StatusCode :: OK; return response;
} #[derive(Debug, thiserror :: Error, error_occurence_lib :: ErrorOccurence)]
...
try_delete_one(server_location : & std :: primitive :: str, parameters :
DeleteOneParameters,) -> Result <
postgresql_crud::postgresql_types::base_wrap::StdPrimitiveI64AsPostgresqlBigSerialNotNullToDelete,
TryDeleteOneErrorNamed >
{
    let payload =
    {
        let value = DeleteOnePayload :: from(parameters.payload); match
        serde_json :: to_string(& value)
        {
            Ok(value) => value, Err(error_0) =>
            {
                return
                Err(TryDeleteOneErrorNamed :: SerdeJsonToString
                {
                    serde_json_to_string : error_0, code_occurence :
                    error_occurence_lib :: code_occurence :: CodeOccurence ::
                    new(file! ().to_owned(), line! (), column! (),
    ...
    }; let url = format! ("{}/example/delete_one", server_location,); let
    future = reqwest :: Client ::
    new().delete(&
    url).header(& postgresql_crud :: CommitSnakeCase.to_string(), git_info ::
    PROJECT_GIT_INFO.commit,).header(reqwest :: header :: CONTENT_TYPE,
    ...
    future.await
    {
        ...
        {
            return
            Err(TryDeleteOneErrorNamed :: Reqwest
            {
                reqwest : error_0, code_occurence : error_occurence_lib ::
                code_occurence :: CodeOccurence ::
                new(file! ().to_owned(), line! (), column! (),
    ...
    response.headers().clone(); let error_2 = match response.text().await
    {
        ...
        {
            return
            Err(TryDeleteOneErrorNamed :: FailedToGetResponseText
            {
                status_code : error_0, headers : error_1, reqwest : error_2,
                code_occurence : error_occurence_lib :: code_occurence ::
                CodeOccurence ::
    ...
    TryDeleteOneRouteLogicResponseVariants > (& error_2)
    {
        Ok(value) => value, Err(error_3) =>
        {
            return
            Err(TryDeleteOneErrorNamed :: DeserializeResponse
            {
                status_code : error_0, headers : error_1, response_text :
                error_2, serde : error_3, code_occurence : error_occurence_lib
                :: code_occurence :: CodeOccurence ::
    ...
    match expected_response
    {
        ...
        :: SerdeJson { serde_json, code_occurence } =>
        TryDeleteOneRouteLogicErrorNamedWithSerializeDeserialize :: SerdeJson
        { serde_json, code_occurence }, TryDeleteOneRouteLogicResponseVariants
        :: CheckCommit { check_commit, code_occurence } =>
        TryDeleteOneRouteLogicErrorNamedWithSerializeDeserialize ::
        CheckCommit { check_commit, code_occurence },
        TryDeleteOneRouteLogicResponseVariants :: RowAndRollback
        { row, rollback, code_occurence } =>
        TryDeleteOneRouteLogicErrorNamedWithSerializeDeserialize ::
        RowAndRollback { row, rollback, code_occurence }
    };
...
} pub async fn delete_one_payload_example_route_logic() -> axum :: response ::
Response
{
    let mut response = axum :: response :: IntoResponse ::
    into_response(axum ::
    Json(< DeleteOnePayload as postgresql_crud ::
    StdDefaultDefaultButStdOptionOptionIsAlwaysSomeAndStdVecVecAlwaysContainsOneElement
    > ::
    default_but_std_option_option_is_always_some_and_std_vec_vec_always_contains_one_element()));
    * response.status_mut() = axum :: http :: StatusCode :: OK; return
