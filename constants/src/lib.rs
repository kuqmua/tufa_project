...
pub const AST_PARSE_FAILED: &str =
    "let syn_derive_input: syn::DeriveInput = syn::parse(input) failed";
pub const PARSE_PROC_MACRO2_TOKEN_STREAM_FAILED_MESSAGE: &str = ".parse::<Ts2>() failed";
