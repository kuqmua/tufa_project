...
naming_macros::generate_self_upper_camel_and_snake_case_stringified_and_token_stream!([
    ...
    ["std", "option", "option", "generic", "self", "option", "to", "update", "origin"],
    ["std", "option", "option", "generic", "self", "option", "to", "update"],
    ["std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update", "origin"],
    ["std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update"],
    ["std", "option", "option", "std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update", "origin"],
    ["std", "option", "option", "std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update"],
    ["generic", "with", "id", "self", "option", "to", "update"],
    ["std", "vec", "vec", "generic", "with", "id", "self", "options", "to", "update"],
    ["std", "option", "option", "std", "vec", "vec", "generic", "with", "id", "self", "options", "to", "update"],
    ...
    ["generic", "self", "option", "to", "update", "try", "generate", "bind", "increments", "error", "named", "with", "serialize", "deserialize"],
    ...
    ["std", "option", "option", "generic", "self", "option", "to", "update", "try", "generate", "bind", "increments", "error", "named"],
    ["std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update", "try", "generate", "bind", "increments", "error", "named"],
    ["std", "option", "option", "std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update", "try", "generate", "bind", "increments", "error", "named"],
    ["self", "option", "to", "update", "origin"],
    ["self", "json", "array", "change"],
    ["self", "to", "create", "origin"],
    ["self", "options", "to", "update"],
    ["self", "to", "create", "origin", "with", "generated", "id"],
    ["self", "to", "create", "origin", "without", "generated", "id"],
    ["self", "json", "array", "change", "try", "generate", "bind", "increments", "error", "named"],
    ["std", "vec", "vec", "generic", "with", "id", "self", "json", "array", "change", "try", "generate", "bind", "increments", "error", "named"],
    ["std", "option", "option", "std", "vec", "vec", "generic", "with", "id", "self", "json", "array", "change", "try", "generate", "bind", "increments", "error", "named"],
    ...
    // ,
    // ["std", "vec", "vec", "generic", "with", "id", "self", "json", "array", "change", "try", "new", "error", "named", "with", "serialize", "deserialize"],
    // ["std", "vec", "vec", "generic", "with", "id", "self", "option", "to", "update", "try", "generate", "bind", "increments", "error", "named", "with", "serialize", "deserialize"]
]);
